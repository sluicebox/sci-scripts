			...
			((> (gEgo y:) 160)
				(cond
					(
						...
						(gMessager say: 0 77 35 0) ; "Don't run off, Detective. Continue your investigation."
					)
					((!= gDay 6)
...
(instance afterDreamScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 3 0 34 0 self) ; "Pl... please go! I... I... have to... to get re... ready for the ne... next show. Yo... you fa... falling a... asleep pu... put me behind in..in mmm... my schedule."
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gMessager say: 3 4 13 0) ; "Ah... ah... ah... Am... am I... I un... under arest? Oh... oh..."
			)
			(1
				(mitchell loop: 1 cel: 0 setCycle: End self)
			)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(32 ; pretzels
				...
				(gMessager say: 6 32 0 0) ; "It's about time you threw these pretzels away. All that salt was starting to itch."
			)
			(74 ; candyBar
			...
			(45 ; matches
				...
				(gMessager say: 6 45 0 0) ; "Since you're not going camping anytime soon, Detective, you might as well dispose of these."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance mitchTalkerHead of Prop ; UNUSED
	(properties
		x 169
		y 92
	)
...
(instance mitchell of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(4 ; Do
				(if local0
					(gMessager say: 3 4 16 0) ; "Better not, Detective. He'll probably just start crying again."
				else
