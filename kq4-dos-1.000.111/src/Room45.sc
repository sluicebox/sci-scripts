				...
				(cond
					...
					((Said 'give/amulet[/genesta]')
						(if (gEgo has: 2) ; Talisman
							...
							(fairyMusic dispose:)
							(Print 45 14 #at 0 20 #font gSmallFont) ; "You give the magic talisman to the dying fairy. Almost instantly, the color returns to her cheeks and her green eyes begin to sparkle. She sits up in bed, stretches, and smiles at you."
...
(instance ChaseEgo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Print 45 36 #at -1 20) ; "Genesta's tiny fairy helpers flit furiously about, trying to keep you from disturbing the dying fairy."
				(client
					yStep: 2
					illegalBits: 0
...
(instance closer of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(Print 45 37 #at 20 20) ; ""You have saved my life, Rosella!" the beautiful fairy says gratefully."
				(Print 45 38 #at 100 160) ; "And you have saved Tamir from the persecution of Lolotte. We are deeply indebted to you."
				(local6 loop: 2 setCycle: End self)
			)
			(5
				(Print 45 39 #at -1 160) ; "I want to go outside; I need to feel the warm sun on my face!"
				(= local5 (Print 45 40 #at -1 20 #dispose)) ; "Exuberantly, she waves her magic wand and ..."
