...
(instance Room21 of Rm
	...
	(method (init)
		...
		(if ((Inv at: 5) ownedBy: 21) ; Gold_Ball
			(= local0 (View new:))
			(local0 view: 518 loop: 1 cel: 0 x: 164 y: 130 stopUpd: init:)
		)
		(switch gPrevRoomNum
			(0
				(gEgo posn: 160 185)
...
(instance egoActions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(gEgo setMotion: MoveTo 141 133 self)
			)
			(1
				(= local4 (gEgo viewer:))
				(gEgo viewer: 0)
				(gEgo loop: 0 view: 21 cel: 0 setCycle: End self)
			)
			(2
				(gEgo view: 23 loop: 0 cel: 0 setCycle: End self)
			)
			(3
				(if ((Inv at: 5) ownedBy: 21) ; Gold_Ball
					(local0 dispose:)
