...
(instance Room692 of Rm
	...
	(method (init)
		...
		(= local0 (Prop new:))
		(local0 view: 807 loop: 3 cel: 0 posn: 162 94 setPri: 5 init:)
		(gEgo
			view: 808
			loop: 0
			cel: 0
		...
		(weddingMarch number: 69 loop: 2 play:)
	)
...
(instance egoActions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(= global120 (Print 692 1 #at -1 20 #dispose)) ; "Fainting isn't going to help, Rosella. There's no getting out of this one. You're stuck being Mrs. Edgar for the rest of your life."
				(= seconds 15)
			)
			(14
				(cls)
			...
			(15
				(= global120 (Print 692 2 #at -1 20 #dispose)) ; "Not to mention having old Lolotte for a mother-in-law! Good luck...you're going to need it!"
				(= seconds 15)
			)
			(16
				(cls)
