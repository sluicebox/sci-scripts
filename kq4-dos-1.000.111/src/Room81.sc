...
(instance Room81 of Rm
	...
	(method (init)
		...
		(= local7 0)
		(= local8 0)
		(theMusic number: 43 loop: 0 init:)
		((= local3 (Prop new:))
			view: 604
			posn: 83 154
			cel: 0
...
(instance lockUp of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(12
				(Print 81 35 #at -1 20 #width 260) ; "It looks like you're destined to be...Mrs. Edgar!"
				(= seconds 12)
			)
			(13
				(HandsOn)
...
(instance lockUpLast of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(Print 81 36 #at -1 20 #width 260 #time 10) ; "The henchmen have taken your rose and you no longer have the gold key! It looks like you're destined to be...Mrs. Edgar!"
