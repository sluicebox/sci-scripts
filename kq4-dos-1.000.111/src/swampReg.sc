...
(instance swamp of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(Print 513 21 #at -1 20) ; "Oh, boy! I sure love frog legs!"
...
(instance drinking of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= global120 (Print 513 22 #at -1 20 #dispose)) ; "You kneel down and drink the mucky swamp water. Yech!! It tastes AWFUL!"
				(Timer setReal: self 4)
			)
			(2
