...
(instance Room17 of Rm
	...
	(method (init)
		...
		(door view: 610 loop: 0 cel: 0 posn: 161 146 stopUpd: init:)
		(switch gPrevRoomNum
			(16
				(if (<= (gEgo y:) 120)
					(gEgo x: 1 y: 120)
			...
			(68
				(gEgo loop: 2 x: 161 y: 152)
			)
			(0
				(gEgo x: 290 y: 160)
			)
		)
		(gEgo setPri: -1 view: 2 xStep: 2 yStep: 1 init:)
	)
...
(instance z6Actions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(local0 show: setLoop: 0 cel: 0 setCycle: End self)
			)
			(2
				(local0 hide:)
				(zTheme number: 21 play: self)
				(gEgo view: 35 cel: 0 setCycle: End self)
			)
			(3
