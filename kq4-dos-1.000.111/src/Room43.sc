...
(instance Room43 of Rm
	...
	(method (init)
		...
		((View new:) view: 670 posn: 50 143 setPri: 0 ignoreActors: addToPic:)
		((View new:)
			view: 670
			loop: 1
			cel: 2
...
(instance dolphActions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gSounds eachElementDo: #dispose)
				(dolphinTheme number: 35 loop: 1 play:)
				(local6
					posn: 284 72
					view: 310
					loop: 0
...
(instance waveScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(local16 loop: 0 cel: 0 posn: 50 143 setCycle: End self)
				(= state 6)
			)
			(2
				(local16 loop: 1 cel: 2 posn: 151 175 setCycle: End self)
				(= state 6)
			)
			(3
				(local16 loop: 2 cel: 0 posn: 284 184 setCycle: End self)
				(= state 6)
			)
			(4
				(local16 loop: 3 cel: 2 posn: 301 146 setCycle: End self)
				(= state 6)
			)
			(5
				(local16 loop: 4 cel: 0 posn: 24 75 setCycle: End self)
				(= state 6)
			)
			(6
				(local16 loop: 5 cel: 1 posn: 258 78 setCycle: End self)
			)
			(7
