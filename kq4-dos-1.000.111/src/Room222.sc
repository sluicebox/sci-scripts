	...
	(method (changeState newState &tmp [temp0 20])
		(switch (= state newState)
			...
			(3
				...
				(= local25
					(Print 222 1 #title {Genesta} #at 100 161 #width 200 #dispose) ; "The lovely fairy speaks. "I am the fairy, Genesta. Welcome to Tamir!""
				)
			...
			(6
				...
				(= local25
					(Print 222 3 #title {Rosella} #at 1 161 #width 200 #dispose) ; "Finally, Rosella speaks. "I know you would like me to help you in some way, but I don't know how I could help a fairy.""
				)
				(Timer setReal: self 12)
			)
			(7
				...
				(= local25
					(Print 222 4 #title {Genesta} #at 100 140 #width 200 #dispose) ; "Genesta looks sadder than ever. "You're wrong, Rosella. You see, I'm losing my magical powers. Yesterday as I was strolling through the woods, Lolotte, the evil fairy, caught me unawares and stole my magic talisman.""
				)
			...
			(8
				(cls)
				(= local25
					(Print 222 5 #title {Genesta} #at 70 140 #width 239 #dispose) ; "The fairy sighs, "She yanked it from my neck and raced away screeching with laughter. Immediately I felt my powers diminishing and my body weakening. I will die in 24 hours if my talisman is not returned.""
				)
				(Timer setReal: self 11)
			)
			(9
			...
			(11
				(cls)
				(= local25
					(Print 222 6 #title {Genesta} #at 100 140 #width 200 #dispose) ; "Intently, Genesta looks at Rosella. "Lolotte is very evil and will use the talisman to bring more evil to Tamir. Now I fear it will contaminate my whole country!""
				)
			...
			(12
				(cls)
				(= local25
					(Print 222 7 #title {Genesta} #at 100 140 #width 200 #dispose) ; "Further, I cannot send you home without my talisman."
				)
				(Timer setReal: self 9)
			)
			(13
				...
				(= local25
					(Print 222 8 #title {Rosella} #at 1 140 #width 200 #dispose) ; "Rosella is unsure as to what SHE can do. Meekly, she asks, "I want to help you, but how?""
				)
				(Timer setReal: self 9)
			)
			(14
				...
				(= local25
					(Print 222 9 #title {Genesta} #at 100 140 #width 200 #dispose) ; "You can do more than you think, Rosella," Genesta assures her. "I believe you will be able to penetrate Lolotte's domain."
				)
				(Timer setReal: self 14)
			)
			(15
				...
				(cls)
				(= local25
					(Print 222 10 #title {Rosella} #at 1 140 #width 200 #dispose) ; "Suddenly, Rosella remembers the tiny tree. "Can you tell me where to find the magic fruit?""
				)
				(Timer setReal: self 9)
			)
			(16
				...
				(local6 hide:)
				(= local25
					(Print 222 11 #title {Genesta} #at 100 140 #width 200 #dispose) ; "Remorsefully, Genesta looks at Rosella. "It will not be easy to reach the tree. It grows on a tiny island within a vast swamp on the other side of the great mountains.""
				)
				(Timer setReal: self 12)
			)
			(17
				...
				(local6 show:)
				(= local25
					(Print 222 12 #title {Rosella} #at 1 140 #width 200 #dispose) ; "Bravely fighting back tears, Rosella says, "I will help you in any way I can, Genesta. How can I find Lolotte?""
				)
				(Timer setReal: self 14)
			)
			(18
			...
			(19
				(cls)
				(= local25
					(Print 222 13 #title {Genesta} #at 100 161 #width 200 #dispose) ; "The beautiful fairy points eastward. "Lolotte's castle overlooks Tamir from the great mountains.""
				)
			...
			(21
				(cls)
				(= local25
					(Print 222 14 #title {Genesta} #at 80 161 #width 220 #dispose) ; "Genesta looks weaker as she says, "There is not much more I can do, Rosella. As it is, it will be difficult for me to fly home again.""
				)
			...
			(22
				(cls)
				(= local25
					(Print 222 15 #title {Genesta} #at 80 161 #width 220 #dispose) ; "One thing I must do for you, though. I shall disguise you as a peasant girl so as not to attract attention."
				)
			...
			(26
				...
				(cls)
				(= local25
					(Print 222 16 #title {Rosella} #at 1 161 #width 200 #dispose) ; ""Th-thank-you, Genesta...I think," Rosella stammers."
				)
			...
			(27
				(cls)
				(= local25
					(Print 222 17 #title {Genesta} #at 80 161 #width 220 #dispose) ; "It will be better for you," the fairy says. "Well, I must be off while I can still fly. I KNOW you can do it!"
				)
				(Timer setReal: self 9)
			)
			(28
