...
(instance dock of Rm
	...
	(method (doit)
		...
		(if (and (== (skiff x:) 30) (== (skiff y:) 147))
			...
			(= local0 (Display 781 2 dsCOORD 11 12 dsWIDTH 240 dsCOLOR 0 dsBACKGROUND -1 dsFONT 41 dsSAVEPIXELS)) ; "Atari ST Version   John Rettig   Corey Cole"
			(= local1
				(Display 781 2 dsCOORD 10 10 dsWIDTH 240 dsCOLOR 15 dsBACKGROUND -1 dsFONT 41 dsSAVEPIXELS) ; "Atari ST Version   John Rettig   Corey Cole"
			)
		)
