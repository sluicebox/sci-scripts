				...
				(cond
					...
					((Said 'look>')
						(cond
							((Said '[<around,at][/room]')
								(if global164
									(Print 3 1) ; "A short rope dangles down from the tower while a ladder runs up the tower's side. Behind a weathered fence, you also notice the remnants of the old plantation's fields."
								else
									(Print 3 0) ; "You see a rusted, iron bell at the top of an old, bell tower. A rope dangles a short distance beneath the bell while a ladder runs up the tower's side. Behind a weathered fence, you also notice the remnants of the old plantation's fields."
								)
							)
							...
							((Said '/tower[<bell]')
								(if global164
									...
									(Print 3 10) ; "You see a rusted iron bell at the top of an old bell tower. A short rope dangles beneath the bell while a ladder runs up the tower's side."
								)
							)
						)
					)
