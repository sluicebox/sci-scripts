...
(procedure (proc303_2 &tmp [temp0 50] temp50 temp51)
	...
	(Format @global550 303 5 (global303 playerName:) (global304 playerName:)) ; "SCORECARD  %10s  %10s"
	(StrCat @global550 (Format @temp0 303 6)) ; "------------------------------------"
	(StrCat
		@global550
		(Format @temp0 303 7 (global303 totalPts:) (global304 totalPts:)) ; "Total Points %10d  %10d"
	)
	(StrCat
		@global550
		(Format @temp0 303 8 (global303 gamesWon:) (global304 gamesWon:)) ; "Games Won  %10d  %10d"
	)
	(StrCat
		@global550
		(Format @temp0 303 9 (global303 gammons:) (global304 gammons:)) ; "Gammons   %10d  %10d"
	)
	(StrCat
		@global550
		(Format @temp0 303 10 (global303 backgammons:) (global304 backgammons:)) ; "Backgammons %10d  %10d"
	)
	(StrCat
		@global550
		(Format @temp0 303 11 (global303 count:) (global304 count:)) ; "Pip Count  %10d  %10d"
	)
...
(procedure (proc303_1)
	(switch (Print 303 12 #button { Play Game } 1 #button { Setup Board } 2) ; "Backgammon"
		(1
			(if global338
				(switch (Print 303 13 #button { No } 1 #button { Yes } 2) ; "Show generated moves?"
					(1
						(= global340 0)
					)
					(2
...
(class DieList of List
	...
	(method (whoFirst &tmp temp0)
		...
		(if (!= global179 2)
			...
			(Printf 303 4 (global178 playerName:)) ; "%s wins the dice roll."
		)
...
(class DoubleCube of TrackingView
	...
	(method (accept &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10)
		(if (!= ((= temp2 (global178 otherPlayer:)) type:) 2)
			(gChar1 say: (Random 12 14) 0 441 2)
			(switch
				(Print
					(Format @global550 303 14 (temp2 playerName:)) ; "%s, do you accept the double?"
					81
					{ Yes }
					1
					81
			...
			(= temp6 (= temp7 0))
			(for ((= temp10 1)) (< temp10 6) ((++ temp10))
				(cond
					((not (global178 validMove: temp10))
						(++ temp6)
					)
					(((global178 at: temp10) closed:)
						(++ temp7)
					)
				)
			)
			(for ((= temp10 1)) (< temp10 25) ((++ temp10))
				(if
					(and
						(==
							((= temp8 (temp2 at: temp10)) whose:)
							(global178 myColor:)
						)
						(temp8 blot:)
						(> (temp8 hitProb:) 6)
	...
	(method (handleEvent event)
		(if (and (== (global178 type:) 1) (super handleEvent: event))
			...
			(switch
				(Print
					(Format @global550 303 15 (global178 playerName:)) ; "%s, do you want to Double?"
					81
					{ Yes }
					1
					81
