...
(procedure (localproc_5 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9)
	...
	(if
		(and
			(<
				(- (= temp9 ((localproc_9) percentHome:)) 49)
...
(procedure (localproc_7 param1 &tmp temp0) ; UNUSED
	(Printf ; "%s: %s, rank= %d, freq= %d"
		401
		2
		((param1 piece:) name:)
		((param1 aSquare:) name:)
...
(procedure (localproc_8 param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7)
...
(class TheShells of EventHandler
	...
	(method (account param1 param2 &tmp temp0)
		(if (== (= temp0 (self calcMove: param1 param2)) (self total:))
			(self eachElementDo: #taken 1)
			(self eachElementDo: #hilite 1)
		else
			(Print 401 0) ; "Error: move not accounted for"
		)
	)
