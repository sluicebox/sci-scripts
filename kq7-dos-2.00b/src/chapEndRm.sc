...
(instance chapEndRm of KQRoom
	...
	(method (init &tmp temp0)
		...
		(if (and (== gPrevRoomNum 20) (not (gGame smallSave: global333))) ; nameGameRoom
			(Prints
				{Your Hard Disk is full. You will be unable to play the game until you free up some hard disk space.}
			)
			(= gQuit 1)
		)
	)
