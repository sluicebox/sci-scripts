	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(gKqSound1 number: 824 setLoop: 1 play:)
			)
			(4
				(SetFlag 43)
		...
		(switch (= state newState)
			...
			(7
				(if (IsFlag 325)
					...
					(Load 140 1212) ; WAVE
					(Load 140 830) ; WAVE
					(gKqSound1 number: 1210 setLoop: 1 play: self)
				else
					(gKqSound1 number: 1215 setLoop: 1 play: self)
				)
			)
			(8
				(if (IsFlag 325)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(specs init:)
				(jack dispose:)
				(soundFX number: 1212 setLoop: 1 play: self)
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(1
				...
				(gKqSound1 number: local3 setLoop: 1 play:)
			)
			(2
				(jack dispose:)
				(if (== gValOrRoz -4) ; Val
