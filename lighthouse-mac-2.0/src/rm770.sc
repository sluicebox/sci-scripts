...
(instance doorFeat2772 of Feature
	...
	(method (init)
		(super init: &rest)
		(self
			createPoly: 37 33 98 39 131 83 140 112 141 145 122 188 21 207 -1 194 2 46
		)
	)
...
(instance armThree2774Feat of Feature
	...
	(method (init)
		...
		(if (not (IsFlag 194))
			(self
				createPoly: 244 44 264 46 268 83 260 90 260 149 265 158 264 160 244 160 244 153 249 147 249 85 240 73
			)
		else
			(self
				createPoly: 264 81 280 90 288 104 276 125 266 128 261 147 264 159 244 160 244 155 253 146 259 124 248 107 249 98 256 91
			)
		)
...
(instance armFour2774Feat of Feature
	...
	(method (init)
		...
		(if (not (IsFlag 195))
			(self
				createPoly: 285 65 300 73 313 110 287 160 269 168 265 157 275 142 262 120 279 95 275 69
			)
		else
			(self
				createPoly: 229 46 244 49 253 68 276 83 252 92 251 116 257 124 275 130 278 141 266 160 258 149 263 130 257 128 249 130 233 122 232 115 244 108 243 89 247 81 229 96 222 77
			)
		)
		(if (IsFlag 194)
			(approachX hotVerbs: 5)
