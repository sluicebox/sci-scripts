	...
	(method (init)
		...
		(InvCast
			add:
				...
				(ScriptID 9 80) ; invBoltCutter
				(ScriptID 9 38) ; invBottleNote
				(ScriptID 9 64) ; invCannon
				(ScriptID 9 76) ; invCannonBall
				(ScriptID 9 78) ; invCannonFuse
				(ScriptID 9 77) ; invCannonPowder
