...
(instance pfLantern of PanelFeature
	...
	(method (init)
		(self
			createPoly: 91 200 73 184 73 47 64 43 64 37 114 14 115 4 129 4 131 14 180 35 174 45 170 47 164 200
		)
		(super init: &rest)
		(approachX hotVerbs: 5)
	)
		...
		(switch theVerb
			(5 ; Do
				...
				(if (ppShedKey cel:)
					...
					(self setPolygon: 0)
					(self
						createPoly: 25 184 20 39 65 46 64 38 112 15 114 4 129 4 130 15 180 34 177 44 170 48 163 199 93 199 76 179 81 172 57 172
					)
