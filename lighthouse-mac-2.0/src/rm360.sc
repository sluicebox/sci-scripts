...
(instance ppModulators of PanelProp
	...
	(method (cue)
		(if (IsFlag 97)
			...
			(((plCooler bitmap:) approachX:) hotVerbs: 0)
		)
		(gGame handsOn:)
	)
)
			...
			(25 ; invCrowbar
				...
				(cond
					...
					(else
						...
						((pTrapDoor approachX:) hotVerbs: 5)
					)
				)
			)
			(else
