...
(class InvPrint of ScrollPrint
	...
	(method (BAD_SELECTOR param1 param2 param3 param4 &tmp temp0)
		...
		(= temp0 (self addIcon: param1 param2 param3 BAD_SELECTOR BAD_SELECTOR))
		(temp0 value: param4)
		(BAD_SELECTOR add: temp0)
		(= BAD_SELECTOR (+ margin (temp0 nsRight:)))
		(if (> BAD_SELECTOR width)
			(= BAD_SELECTOR 50)
			(= BAD_SELECTOR (+ margin (temp0 nsBottom:)))
		)
		(return temp0)
	)
)
...
(class GK2Inventory of InvI
	...
	(method (BAD_SELECTOR)
		...
		(invPlane picture: (+ 13000 BAD_SELECTOR 999 (* number 10)))
		(if (and (!= BAD_SELECTOR -1) (<= BAD_SELECTOR BAD_SELECTOR))
	...
	(method (handleEvent &tmp temp0 temp1)
		...
		(if (!= noun -1)
			(= temp0 (if BAD_SELECTOR BAD_SELECTOR else 0))
			(cond
				(
					(or
	...
	(method (doVerb theVerb)
		(cond
			((== theVerb 75) ; invMagazine
				...
				(Load rsVIEW 9943)
				(gMessager say: 113 62 0 1 0 2000) ; MISSING MESSAGE
			...
			((== theVerb 117) ; invVonZellTape
				(if (IsFlag 678)
					(gMessager say: 186 62 0 1 0 2010) ; MISSING MESSAGE
				else
					(gMessager say: 185 62 0 1 0 2010) ; MISSING MESSAGE
				)
			)
			(else
...
(instance invEvidenceReport of GK2Inventory
	...
	(method (handleEvent)
		(gMessager say: noun 62 0 0 0 2000) ; MISSING MESSAGE
		(return 1)
	)
)
...
(instance invVictorJournal of GK2Inventory
	...
	(method (handleEvent event)
		(if (== gEgo GabeEgo)
			(gMessager say: 158 62 0 0 0 2000) ; MISSING MESSAGE
			(return 1)
		)
		(switch BAD_SELECTOR
			(1
				(if event
					(gMessager say: noun 62 0 3 0 2000) ; MISSING MESSAGE
				else
					(gMessager sayRange: noun 62 0 1 2 0 2000) ; MISSING MESSAGE
				)
			)
			(2
				(if event
					(gMessager sayRange: noun 62 0 6 7 0 2000) ; MISSING MESSAGE
				else
					(gMessager sayRange: noun 62 0 4 5 0 2000) ; MISSING MESSAGE
				)
			)
		)
	)
...
(instance invChristianJournal of GK2Inventory
	...
	(method (handleEvent event)
		...
		(switch BAD_SELECTOR
			(1
				(if event
					(gMessager say: noun 62 0 2 0 2000) ; MISSING MESSAGE
				else
					(gMessager say: noun 62 0 1 0 2000) ; MISSING MESSAGE
				)
			)
		)
	)
...
(instance invLudwigLetter of GK2Inventory
	...
	(method (handleEvent)
		...
		(switch BAD_SELECTOR
			...
			(2
				(if (IsFlag 881)
					(gMessager sayRange: noun 62 0 3 4 0 2000) ; MISSING MESSAGE
				else
					(gGame changeScore: 881)
					(if (IsFlag 897)
						(SetFlag 36)
						(gMessager sayRange: noun 62 0 3 5 0 2000) ; MISSING MESSAGE
					else
						(gMessager sayRange: noun 62 0 3 4 0 2000) ; MISSING MESSAGE
					)
				)
...
(instance invGraceLetter2 of GK2Inventory
	...
	(method (handleEvent)
		(if (or (IsFlag 550) (== gEgo GraceEgo))
			(gMessager sayRange: noun 62 0 1 5 0 2000) ; MISSING MESSAGE
		else
			(SetFlag 550)
			(gMessager sayRange: noun 62 0 1 7 0 2000) ; MISSING MESSAGE
		)
	)
)
...
(instance invGabeLetter2 of GK2Inventory
	...
	(method (handleEvent)
		(if (and (== BAD_SELECTOR 2) (== gChapter 4))
			(gMessager sayRange: noun 62 0 2 3 0 2000) ; MISSING MESSAGE
		else
			(super handleEvent: &rest)
		)
	)
...
(instance invLudwigBio of GK2Inventory
	...
	(method (handleEvent event &tmp temp0)
		(switch BAD_SELECTOR
			(1
				(= temp0 (if (IsFlag 281) 159 else 117))
				(gMessager say: temp0 62 0 0 0 2000)
			)
			(2
				(gMessager sayRange: 118 62 0 1 3 0 2000) ; MISSING MESSAGE
			)
			(3
				(gMessager sayRange: 119 62 0 1 2 0 2000) ; MISSING MESSAGE
			)
			(4
				(if event
					(if (and (IsFlag 288) (not (IsFlag 575)))
						(SetFlag 575)
						(gMessager sayRange: 120 62 0 4 5 cueScript 2000) ; MISSING MESSAGE
					else
						(gMessager say: 120 62 0 4 cueScript 2000) ; MISSING MESSAGE
					)
				else
					(gMessager sayRange: 120 62 0 1 3 0 2000) ; MISSING MESSAGE
				)
			)
			(5
				(gMessager sayRange: 122 62 0 1 2 0 2010) ; MISSING MESSAGE
			)
		)
	)
)
...
(instance cueScript of Script
	...
	(method (cue)
		(gMessager say: 121 62 0 0 0 2010) ; MISSING MESSAGE
	)
)
...
(instance invGraceLetter3 of GK2Inventory
	...
	(method (handleEvent)
		(if (IsFlag 683)
			(gMessager sayRange: noun 62 0 1 3 0 2010) ; MISSING MESSAGE
		else
			(gGame changeScore: 1057)
			(SetFlag 683)
			(gMessager sayRange: noun 62 0 1 4 0 2010) ; MISSING MESSAGE
		)
	)
)
	...
	(method (doVerb theVerb)
		(cond
			...
			((== theVerb 21) ; invMatches
				(gMessager say: 192 62 0 1 0 2010) ; MISSING MESSAGE
				(return 0)
			)
			(else
				(super doVerb: theVerb)
...
(instance invVonGlowerLetter of GK2Inventory
	...
	(method (handleEvent)
		(switch BAD_SELECTOR
			(1
				(gMessager sayRange: noun 62 0 1 3 0 2020) ; MISSING MESSAGE
			)
			(2
				(gMessager sayRange: noun 62 0 4 5 0 2020) ; MISSING MESSAGE
			)
			(3
				(gMessager sayRange: noun 62 0 6 8 0 2020) ; MISSING MESSAGE
			)
			(4
				(gMessager sayRange: noun 62 0 9 10 0 2020) ; MISSING MESSAGE
			)
			(5
				(gMessager sayRange: noun 62 0 11 12 0 2020) ; MISSING MESSAGE
			)
			(6
				(if (IsFlag 705)
					(gMessager sayRange: noun 62 0 13 14 0 2020) ; MISSING MESSAGE
				else
					(SetFlag 705)
					(gMessager sayRange: noun 62 0 13 15 0 2020) ; MISSING MESSAGE
				)
			)
		)
	)
...
(instance invOperaProgram of GK2Inventory
	...
	(method (handleEvent event)
		(switch BAD_SELECTOR
			(1
				(if (not event)
					(gMessager sayRange: 164 62 0 1 4 0 2020) ; MISSING MESSAGE
				else
					(gMessager sayRange: 165 62 0 1 4 0 2020) ; MISSING MESSAGE
				)
			)
			(2
				(if (not event)
					(gMessager sayRange: 166 62 0 1 3 0 2020) ; MISSING MESSAGE
				else
					(gMessager sayRange: 167 62 0 1 3 0 2020) ; MISSING MESSAGE
				)
			)
			(3
				(if (not event)
					(gMessager sayRange: 168 62 0 1 5 0 2020) ; MISSING MESSAGE
				else
					(gMessager sayRange: 169 62 0 1 3 0 2020) ; MISSING MESSAGE
				)
			)
			(4
				(if (not event)
					(gMessager sayRange: 170 62 0 1 4 0 2020) ; MISSING MESSAGE
				else
					(gMessager sayRange: 171 62 0 1 4 0 2020) ; MISSING MESSAGE
				)
			)
			(5
				(gMessager sayRange: 172 62 0 1 4 0 2020) ; MISSING MESSAGE
			)
		)
	)
)
...
(instance invSeatingChart of GK2Inventory
	...
	(method (handleEvent)
		...
		(gMessager say: noun 62 0 0 0 2020) ; MISSING MESSAGE
	)
)
