...
(instance fMagazine of GKFeature
	...
	(method (init)
		(self
			createPoly: 138 198 134 191 141 177 135 164 115 148 98 156 107 270 199 257 258 201 255 149 225 138 198 146 201 198 184 203 168 193
		)
		(super init: &rest)
	)
...
(instance fFirePlace of GKFeature
	...
	(method (init)
		(self
			createPoly: 83 261 35 244 32 124 61 120 74 49 100 47 164 62 176 128 200 131 197 238
		)
		(super init: &rest)
	)
