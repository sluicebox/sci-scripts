	...
	(switch gChapter
		(1
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage sel_749: {Capitolo 1: Scena Iniziale})
				)
				(else
		...
		(2
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage sel_749: {Capitolo 2: Scena Iniziale})
				)
				(else
		...
		(3
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage sel_749: {Capitolo 3: Scena Iniziale})
				)
				(else
		...
		(4
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage sel_749: {Capitolo 4: Scena Iniziale})
				)
				(else
		...
		(5
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage sel_749: {Capitolo 5: Scena Iniziale})
				)
				(else
		...
		(6
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage sel_749: {Capitolo 6: Scena Iniziale})
				)
				(else
