	...
	(switch gChapter
		(1
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage BAD_SELECTOR: {Capitolo 1: Scena Iniziale})
				)
				(else
		...
		(2
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage BAD_SELECTOR: {Capitolo 2: Scena Iniziale})
				)
				(else
		...
		(3
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage BAD_SELECTOR: {Capitolo 3: Scena Iniziale})
				)
				(else
		...
		(4
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage BAD_SELECTOR: {Capitolo 4: Scena Iniziale})
				)
				(else
		...
		(5
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage BAD_SELECTOR: {Capitolo 5: Scena Iniziale})
				)
				(else
		...
		(6
			(switch (gGame printLang:)
				...
				(39
					(gTopMessage BAD_SELECTOR: {Capitolo 6: Scena Iniziale})
				)
				(else
...
(procedure (proc11_19 param1)
	(return
		(cond
			...
			((OneOf param1 100 130 210 2320 2330 40 50 5480) 210)
