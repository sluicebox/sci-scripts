...
(instance fDesk of GKFeature
	...
	(method (init)
		(self
			createPoly: 257 324 257 182 249 182 249 177 269 172 394 171 394 180 383 180 384 327
		)
		(super init: &rest)
	)
...
(instance fStreet of ExitFeature
	...
	(method (handleEvent event)
		(cond
			((and (self onMe: event) (gTimers contains: tProof))
				(tProof dispose: delete:)
			)
			((and (self onMe: event) (gTimers contains: (ScriptID 4599 2))) ; xGoneTimer
				((ScriptID 4599 2) dispose: delete:) ; xGoneTimer
			)
			((and (self onMe: event) (gTimers contains: (ScriptID 4599 1))) ; cuckooTimer
