			...
			(switch (event message:)
							...
							(if (temp3 onMeCheck:)
								(if ((temp3 onMeCheck:) isKindOf: List)
									(for
										...
										(PEditor BAD_SELECTOR: temp9)
									)
								else
									(PEditor BAD_SELECTOR: (temp3 onMeCheck:))
								)
					...
					(if (PEditor size:)
						...
						(for
							...
							(for
								...
								(temp12 BAD_SELECTOR: temp4)
								(if (< (temp12 BAD_SELECTOR:) temp13)
									(= temp13 (temp12 BAD_SELECTOR:))
								)
								(if (> (temp12 BAD_SELECTOR:) temp14)
									(= temp14 (temp12 BAD_SELECTOR:))
								)
								(if (< (temp12 BAD_SELECTOR:) temp15)
									(= temp15 (temp12 BAD_SELECTOR:))
								)
								(if (> (temp12 BAD_SELECTOR:) temp16)
									(= temp16 (temp12 BAD_SELECTOR:))
								)
							)
				...
				(KEY_ALT_p
					...
					(if (gCurRoom obstacles:)
						(PEditor BAD_SELECTOR: (gCurRoom obstacles:))
					)
					(PEditor doit:)
					(= temp3 (Str new: 13))
					(= temp12 (Str new: 13))
					...
					(if (PEditor size:)
						(PEditor eachElementDo: #BAD_SELECTOR poly_pol)
						(if (gCurRoom obstacles:)
