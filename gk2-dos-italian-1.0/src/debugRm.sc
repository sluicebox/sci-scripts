			...
			(switch (event message:)
							...
							(if (temp3 onMeCheck:)
								(if ((temp3 onMeCheck:) isKindOf: List)
									(for
										...
										(PEditor sel_808: temp9)
									)
								else
									(PEditor sel_808: (temp3 onMeCheck:))
								)
					...
					(if (PEditor size:)
						...
						(for
							...
							(for
								...
								(temp12 sel_793: temp4)
								(if (< (temp12 sel_786:) temp13)
									(= temp13 (temp12 sel_786:))
								)
								(if (> (temp12 sel_786:) temp14)
									(= temp14 (temp12 sel_786:))
								)
								(if (< (temp12 sel_787:) temp15)
									(= temp15 (temp12 sel_787:))
								)
								(if (> (temp12 sel_787:) temp16)
									(= temp16 (temp12 sel_787:))
								)
							)
				...
				(KEY_ALT_p
					...
					(if (gCurRoom obstacles:)
						(PEditor sel_809: (gCurRoom obstacles:))
					)
					(PEditor doit:)
					(= temp3 (Str new: 13))
					(= temp12 (Str new: 13))
					...
					(if (PEditor size:)
						(PEditor eachElementDo: #sel_799 poly_pol)
						(if (gCurRoom obstacles:)
