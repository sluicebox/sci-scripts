...
(instance fSink of Feature
	...
	(method (init)
		...
		(super init: &rest)
		(self
			createPoly: 170 254 137 231 137 166 162 166 162 221 174 221 174 165 198 165 198 220 244 241
		)
	)
)
...
(instance fCabinets of Feature
	...
	(method (init)
		...
		(super init: &rest)
		(self
			createPoly: 321 80 341 77 547 102 545 172 416 186 404 182 401 166 390 158 386 144 367 144 366 164 369 177 381 180 380 185 367 187 365 192 350 196 350 253 321 245
		)
	)
)
