...
(instance fMargarite of GKFeature
	...
	(method (init)
		(super init: &rest)
		(self
			createPoly: 186 237 222 117 212 91 186 77 172 1 614 -1 616 263 588 247 582 275 584 333 484 333 484 289 458 253 442 223 378 211 306 259 258 285 230 275 184 237
		)
	...
	(method (doVerb theVerb)
		(if (== theVerb 62) ; Do
			(if (not (IsFlag 839))
				(gMessager say: 6 62 0 1 pTags 230) ; "(O.S. TO THOMAS, WITH WOLF MARGARITE)She's wearing a tag."
			else
				(PlayScene 30)
...
(instance pTags of Prop
	...
	(method (doVerb)
		(gMessager say: 6 62 0 2 self 230) ; "(O.S. STILL LOW)All the zoo wolves wear them."
	)
)
