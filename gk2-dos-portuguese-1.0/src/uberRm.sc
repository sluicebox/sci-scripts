...
(instance pUbergrau of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(else
				(gMessager say: 3 0 0 0 0 420) ; "(USE DORN'S ACCOUNT BOOK PAGE ON UBERGRAU)I don't think Harry could make any more sense of Grossberg's notations than I can."
			)
		)
	)
)
