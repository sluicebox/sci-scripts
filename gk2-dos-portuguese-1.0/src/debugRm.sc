			...
			(switch (event message:)
							...
							(if (temp3 onMeCheck:)
								(if ((temp3 onMeCheck:) isKindOf: List)
									(for
										...
										(PEditor sel_779: temp9)
									)
								else
									(PEditor sel_779: (temp3 onMeCheck:))
								)
					...
					(if (PEditor size:)
						...
						(for
							...
							(for
								...
								(temp12 sel_764: temp4)
								(if (< (temp12 sel_757:) temp13)
									(= temp13 (temp12 sel_757:))
								)
								(if (> (temp12 sel_757:) temp14)
									(= temp14 (temp12 sel_757:))
								)
								(if (< (temp12 sel_758:) temp15)
									(= temp15 (temp12 sel_758:))
								)
								(if (> (temp12 sel_758:) temp16)
									(= temp16 (temp12 sel_758:))
								)
							)
				...
				(KEY_ALT_p
					...
					(if (gCurRoom obstacles:)
						(PEditor sel_780: (gCurRoom obstacles:))
					)
					(PEditor doit:)
					(= temp3 (Str new: 13))
					(= temp12 (Str new: 13))
