...
(instance efForwardLeft of ExitFeature
	...
	(method (init)
		(self
			createPoly: 106 136 84 136 84 119 109 119 108 78 107 64 26 64 25 144 107 144 106 141
		)
		(super init: &rest)
	)
)
...
(instance efForwardRight of ExitFeature
	...
	(method (init)
		(self
			createPoly: 214 106 214 81 202 77 190 77 161 77 160 58 189 58 189 45 243 45 243 106
		)
		(super init: &rest)
	)
)
