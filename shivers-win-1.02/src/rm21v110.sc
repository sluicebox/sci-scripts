...
(instance efExitForwardBook of ExitFeature
	...
	(method (init)
		(self
			createPoly: 85 131 117 118 137 129 139 131 137 133 120 139 103 143 85 132
		)
		(super init: &rest)
	)
)
...
(instance efExitLion of ExitFeature
	...
	(method (init)
		(self
			createPoly: 43 60 43 74 58 77 58 95 180 95 190 83 202 68 202 57 199 53 204 53 215 40 216 37 214 35 194 14 189 4 155 3 133 31 133 43 68 43 43 57
		)
		(super init: &rest)
	)
)
