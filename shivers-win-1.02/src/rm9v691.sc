...
(instance rm9v691 of ShiversRoom
	...
	(method (init &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7)
		...
		(if (or (== gPrevRoomNum 990) (== gPrevRoomNum 992)) ; shiversOptions, viewingInv
			...
			(PrintDebug {name:%s} (temp7 name:))
			(temp7 open: 1)
			(for ((= temp0 0)) (< temp0 18) ((++ temp0))
				(= temp3 0)
				(= temp2 (temp7 readWord:))
				(PrintDebug {placing: %d at %d} temp0 temp2)
				(= temp4 (/ temp2 8))
				(= temp5 (mod (/ temp2 4) 2))
				(= temp6 (mod temp2 4))
			...
			(for ((= temp0 0)) (< temp0 18) ((++ temp0))
				...
				(PrintDebug {placing: %d at %d} temp1 temp2)
				(= temp4 (/ temp2 8))
				(= temp5 (mod (/ temp2 4) 2))
				(= temp6 (mod temp2 4))
	...
	(method (newRoom newRoomNumber &tmp temp0 temp1 temp2)
		(if (or (== newRoomNumber 990) (== newRoomNumber 992)) ; shiversOptions, viewingInv
			...
			(for ((= temp0 0)) (< temp0 18) ((++ temp0))
				...
				(PrintDebug {saving %d at %d} temp0 (temp1 pos:))
...
(instance efExitBack of ExitFeature
	...
	(method (init)
		(self
			createPoly: 0 0 20 20 243 20 243 135 20 135 20 20 0 0 0 143 263 143 263 0
		)
		(super init: &rest)
	)
)
				...
				(if (== (temp2 type:) evMOUSERELEASE)
					...
					(if temp6
						(if (and temp3 (>= (local2 indexOf: temp3) 0))
							...
							(PrintDebug {b:%d,c:%d,r:%d} temp9 temp11 temp10)
