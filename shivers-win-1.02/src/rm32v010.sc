...
(instance efExitForward of ExitFeature
	...
	(method (init)
		(self
			createPoly: 86 110 104 88 104 66 76 41 55 41 35 47 20 65 18 76 23 91 32 105 34 110 86 110
		)
		(super init: &rest)
	)
)
			...
			(1
				...
				(if (IsFlag 39)
					(= local0
						(Str
							format:
								{ Man has taken it upon himself to penalize his fellow man for every conceivable offense, many trivial. Historically, singing insulting songs in Rome, injuring a cat in Egypt, and even selling bad beer in Babylon could________bring the death penalty. }
						)
					)
