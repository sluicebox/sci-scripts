...
(instance efBack of ExitFeature
	...
	(method (init)
		(self
			createPoly: 0 0 0 143 21 143 25 81 60 14 83 0 180 0 197 13 212 75 240 83 246 143 264 144 264 0
		)
		(super init: &rest)
	)
)
...
(instance hsBack of HotSpot
	...
	(method (init)
		(self
			createPoly: 0 0 52 95 218 95 218 111 52 111 52 95 0 0 0 143 263 143 263 0
		)
		(super init: &rest)
	)
)
