...
(procedure (proc951_0 param1 &tmp temp0 temp1)
	...
	(PrintDebug {%d in %d} param1 [global118 temp1])
)
...
(procedure (proc951_1 param1 &tmp temp0 temp1 temp2 temp3)
	...
	(cond
		((== temp1 0)
			(PrintDebug {%s is dead} temp3)
		)
		(temp0
			(= [global164 (* 2 param1)] temp0)
			(PrintDebug {%s goes to %d} temp3 temp0)
		)
		(else
			(PrintDebug {%s stays in %d} temp3 temp0)
		)
	)
)
...
(procedure (proc951_12)
	(if global105
		...
		(++ global547)
		(PrintDebug {%d captured} global547)
		(= global105 0)
		(gNormalCursor show:)
	)
)
...
(procedure (proc951_15 param1)
	...
	(if global349
		(PrintDebug {score:%3d%.3d} global349 gScore)
	else
		(PrintDebug {score:%6d} gScore)
	)
)

(procedure (proc951_16 param1)
	(if [global350 param1]
		(PrintDebug {scored event:%d} param1)
