...
(instance efExitRight of ExitFeature
	...
	(method (init)
		(self
			createPoly: 263 143 243 143 243 107 263 107 263 40 243 40 243 0 263 0
		)
		(super init: &rest)
	)
)
...
(instance efExitCannisters of ExitFeature
	...
	(method (init)
		(self
			createPoly: 263 107 252 108 243 107 231 101 239 82 235 74 235 60 237 58 234 50 238 40 243 40 262 40
		)
		(super init: &rest)
	)
)
