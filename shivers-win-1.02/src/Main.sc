...
(instance SHIVERS of Game
	...
	(method (replay &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6)
		(PrintDebug {REPLAY#%d} gCurRoomNum)
		(for
	...
	(method (save &tmp temp0 temp1 temp2 temp3 temp4 temp5)
		(PrintDebug {SAVE#%s} (global528 data:))
		(if
			(not
				(= temp0
					(Save
	...
	(method (restore param1 &tmp [temp0 4] temp4 temp5 temp6 temp7 temp8 temp9 temp10)
		(PrintDebug {RESTORE#%d} param1)
		(for
		...
		(if (Save 3 {SHIVER} param1 (KString 9 gVersion)) ; CheckSaveGame, StrGetData
			(self getDisc: (CD 1)) ; GetSaveCD
			(Save 1 {SHIVER} param1 gVersion) ; RestoreGame
		else
			(for
				((= temp8 (KList 3 (gPlanes elements:)))) ; FirstNode
				temp8
