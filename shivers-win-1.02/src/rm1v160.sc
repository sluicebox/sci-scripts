...
(instance efExitBack of ExitFeature
	...
	(method (init)
		(self
			createPoly: 48 44 43 59 28 66 21 98 39 118 102 118 102 123 259 123 259 45 50 45 50 0 261 0 262 141 0 141 0 0 48 0 48 44
		)
		(super init: &rest)
	)
)
...
(instance crank of ShiversProp
	...
	(method (onMe &tmp temp0)
		...
		(if local0
			...
			(if (and temp0 (not (box0 onMe: &rest)))
				(PrintDebug {can't turn yet})
			)
			(return 0)
		)
	)
