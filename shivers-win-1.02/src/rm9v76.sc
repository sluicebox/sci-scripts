...
(instance rm9v76 of ShiversRoom
	...
	(method (newRoom newRoomNumber)
		...
		(if (== 1 local1)
			(PrintDebug {Prop closing sfx:10915})
			(gSounds stop: 10914)
			(if (> (spSkull cel:) 0)
...
(instance spTopLeft of ShiversProp
	...
	(method (doVerb)
		(if (< local0 0)
			...
			(= local0 0)
			(= local1 1)
			(PrintDebug {Top Left Open})
			(gCurRoom setScript: sMaskOpen)
		else
			(= local1 0)
			(PrintDebug {Top Left Close})
...
(instance spTopRight of ShiversProp
	...
	(method (init)
		(self
			setPri: 15
			createPoly: 197 34 187 25 186 12 186 5 193 2 216 3 226 9 225 21 216 37 205 37
		)
		(super init: &rest)
	)
	...
	(method (doVerb)
		(if (< local0 0)
			...
			(= local1 1)
			(= local0 1)
			(PrintDebug {Top Right Open})
			(gCurRoom setScript: sMaskOpen)
		else
			(= local1 0)
			(PrintDebug {Top Right Close})
			(gCurRoom setScript: sMaskClose)
		)
	)
)
...
(instance spCenter of ShiversProp
	...
	(method (init)
		(self
			setPri: 18
			createPoly: 118 91 102 70 100 55 107 47 125 45 143 50 146 65 140 76 138 80 124 92
		)
		(super init: &rest)
	)
	...
	(method (doVerb)
		(if (< local0 0)
			...
			(= local1 1)
			(= local0 4)
			(PrintDebug {Center Open})
			(gCurRoom setScript: sMaskOpen)
		else
			(= local1 0)
			(PrintDebug {Center Close})
			(gCurRoom setScript: sMaskClose)
		)
	)
)
...
(instance spBottomLeft of ShiversProp
	...
	(method (init)
		(self
			setPri: 20
			createPoly: 46 139 28 115 28 102 34 97 46 95 55 95 64 101 66 110 65 119 50 139
		)
		(super init: &rest)
	)
	...
	(method (doVerb)
		(if (< local0 0)
			...
			(= local1 1)
			(= local0 2)
			(PrintDebug {Bottom Left Open})
			(gCurRoom setScript: sMaskOpen)
		else
			(= local1 0)
			(PrintDebug {Bottom Left Close})
			(gCurRoom setScript: sMaskClose)
		)
	)
)
...
(instance spBottomRight of ShiversProp
	...
	(method (init)
		(self
			setPri: 20
			createPoly: 194 142 185 122 188 99 206 95 220 98 225 104 226 116 206 130 201 132 198 142
		)
		(super init: &rest)
	)
	...
	(method (doVerb)
		(if (< local0 0)
			...
			(= local1 1)
			(= local0 3)
			(PrintDebug {Bottom Right Open})
			(gCurRoom setScript: sMaskOpen)
		else
			(= local1 0)
			(PrintDebug {Bottom Right Close})
			(gCurRoom setScript: sMaskClose)
		)
	)
)
			...
			(0
				...
				(cond
					...
					((== local0 4)
						(spCenter
							init:
							createPoly: 106 49 93 58 92 70 97 83 65 77 59 79 57 88 55 67 58 60 67 53 74 51 83 51 88 50 93 47 106 49 134 50 142 47 152 47 163 52 165 55 166 56 180 58 185 62 185 90 180 79 174 77 157 81 139 81 150 73 151 64 148 55 137 50
							setCycle: End self
						)
						(spSkull
							show:
							createPoly: 107 52 104 61 103 70 106 78 112 81 137 81 142 72 142 65 140 59 137 53 108 53
							priority: 21
						)
					)
				)
