...
(instance efExitLeft of ExitFeature
	...
	(method (init)
		(if (IsFlag 9)
			(self
				createPoly: 41 0 53 33 55 55 51 61 51 82 27 121 29 130 28 135 23 142 77 142 92 142 92 0 41 0
			)
		else
...
(instance efExitForward of ExitFeature
	...
	(method (init)
		(self
			createPoly: 135 31 101 47 78 104 41 142 222 142 182 104 178 50 135 30
		)
		(super init: &rest)
	)
)
...
(instance efExitBimini of ExitFeature
	...
	(method (init)
		(self
			createPoly: 123 111 135 108 152 108 159 110 159 136 148 139 133 139 122 136 123 129 123 112
		)
		(super init: &rest)
	)
)
