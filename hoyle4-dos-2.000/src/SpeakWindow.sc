...
(class SpeakWindow of SysWindow
	...
	(method (open &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11)
		...
		(DrawCel 990 (+ temp11 1) 0 brLeft brTop priority)
		(DrawCel 990 (+ temp11 1) 1 (- (- brRight 1) 10) brTop priority)
		(DrawCel 990 (+ temp11 1) 2 brLeft (- brBottom 10) priority)
		(DrawCel 990 (+ temp11 1) 3 (- brRight 10) (- brBottom 10) priority)
		...
		(DrawCel 990 temp11 temp3 tailLeft tailTop priority)
