...
(instance heartsGame of HoyleRoom
	...
	(method (init)
		...
		(gChar3 posn: 264 120 view: (gChar3 view:) show: init:)
		(Characters init:)
		...
		(switch (= state newState)
			...
			(11
				(if (and (hand1 passTo:) (not (Random 0 5)))
					(if (Random 0 1)
						(Characters say: 1000 1 23 0 (Random 1 3) 462 1 self)
					else
						(Characters say: 1000 1 23 0 (Random 3 5) 464 1 self)
					)
				else
					(= ticks 1)
				)
			...
			(16
				(for ((= temp2 0)) (< temp2 (global117 size:)) ((++ temp2))
					(if (== ((global117 at: temp2) tempTotal:) 26)
						...
						(if (== ((global117 at: temp2) type:) 0)
							(Characters
								say: 1000 1 23 0 (Random 4 5) 464 1 self
							)
						else
							(Characters
