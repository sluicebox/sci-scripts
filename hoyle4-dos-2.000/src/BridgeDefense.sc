...
(class BridgeDefense of Code
	...
	(method (checkTopTricks &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9)
		...
		(if (> temp2 (Max ((curPlyr partner:) hearts:) (curPlyr hearts:)))
			(= temp2 (Max ((curPlyr partner:) hearts:) (curPlyr hearts:)))
		)
		(if (> temp3 (Max ((curPlyr partner:) spades:) (curPlyr spades:)))
			(= temp3 (Max ((curPlyr partner:) spades:) (curPlyr spades:)))
		)
		(self topCl: temp0)
		(self topDi: temp1)
		(self topHt: temp2)
	...
	(method (play param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7)
		...
		(for ((= temp4 0)) (< temp4 (curPlyr size:)) ((++ temp4))
			(if (or (== temp1 6) (== ((curPlyr at: temp4) suit:) temp1))
				(workingList add: (curPlyr at: temp4))
			)
		)
		(Sorts workingList sortedList descendingCode)
		(workingList release: dispose:)
		(++ temp0)
		(cond
			((< argc temp0)
				(= temp6 0)
