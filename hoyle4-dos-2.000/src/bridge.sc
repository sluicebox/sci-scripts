...
(instance bridge of HoyleRoom
	...
	(method (init)
		...
		(gChar3 posn: 290 151 view: (gChar3 view:) show: init:)
		(Characters init:)
					...
					(if (>= global433 (+ global434 6))
						...
						(if (== global434 6)
							...
							(if (== (global429 location:) 1)
								((global429 owner:) say: 1000 1 23 0 1 462 1)
							else
								(((global429 partner:) owner:)
									say: 1000 1 23 0 1 462 1
								)
							)
							(= temp12 1)
						...
						(if (not temp12)
							...
							(if (not (Random 0 4))
								(if (== (global429 location:) 1)
									((global429 owner:) say: 1000 1 23 0 2 462)
								else
									(((global429 partner:) owner:)
										say: 1000 1 23 0 2 462
									)
								)
							)
						)
