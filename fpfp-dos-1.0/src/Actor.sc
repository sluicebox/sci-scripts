...
(class Actor of Prop
	...
	(method (setDirection dir &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9)
		(= temp0
		...
		(if (and (= temp7 (gCurRoom obstacles:)) gUseObstacles)
			(= temp6
				(AvoidPath
					x
					y
			...
			(= temp8 (WordAt temp6 2))
			(= temp9 (WordAt temp6 3))
			(= temp2 (- temp8 x))
			(= temp3 (- temp9 y))
			...
			(if gAltPolys
				...
				(if
					(or
						(!= (WordAt temp6 2) (+ x temp2))
						(!= (WordAt temp6 3) (+ y temp3))
					)
