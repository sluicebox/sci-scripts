...
(instance sFreddyDropsGuns of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager say: 20 4 5 0 self) ; "You resignedly unbuckle your holsters, letting your guns slip to the floor."
			)
			(3
				(gEgo
					view: 724
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(gMessager say: 17 0 0 1 3 self) ; "When Freddy stepped inside, Penelope wuz standin' at the desk, packin' in a hurry. She didn't even notice him come in."
			)
			(3
				(penelope
					view: 802
			...
			(4
				(gMessager say: 17 0 0 4 10 self) ; "HEY, PENELOPE!"
			)
			(5
			...
			(7
				...
				(gMessager say: 17 0 0 11 14 self) ; "...you're wounded. Here, I'll just tear this strip off my petticoat."
				(penelope view: 721 loop: 0 cel: 0 setCycle: End self)
				(UnLoad 128 802)
			)
			(8)
			(9
				(gMessager say: 17 0 0 15 19 self) ; "She slowly slipped her hands under the fabric."
				(penelope
					view: 721
					loop: 1
					cel: 0
			...
			(10)
			(11
				(gMessager say: 17 0 0 20 22 self) ; "And before Freddy knew it, Penelope yanked a Derringer from her bosom and aimed it at him!"
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gMessager say: 18 0 0 1 self) ; "You grab for the slate, and whip it around just in the nick of time!"
			)
			(1
				(gGame points: 10)
				(gEgo
			...
			(8
				...
				(gEgo view: 728 setLoop: 0 setCel: 0 setCycle: End)
			)
			(9
				(pistol
					init:
...
(instance droppedThemTimer of Timer
	...
	(method (cue)
		(gMessager say: 50 0 0) ; "Ignoring Penelope turns out to be a bad idea."
		(gCurRoom setScript: sFreddyDies)
	)
)
...
(instance getSlateTimer of Timer
	...
	(method (cue)
		(gMessager say: 49 0 0) ; "You fool, you've deliberately tried to ruin all my plans."
		(gCurRoom setScript: sFreddyDies)
	)
)
