...
(instance sStopFreddy of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gMessager say: 17 4 1) ; "You slyly attempt to swipe the apple pie from under Hop Singh's nose!"
				(= cycles 2)
			)
			(1
			...
			(5
				...
				(gMessager say: 17 4 2) ; "Nice try, Freddy Pharkas! You want me remove your hands with Ginfu Knife? I happy to accommodate!"
...
(instance elixir of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(gEgo get: 17 self 2 self) ; Elixir
				(SetFlag 65)
				(gGame points: 1)
			)
			(else
