	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				...
				(gMessager say: 1 0 0 1 6 self) ; "FREDDY! You?!"
			)
			(10
				(gGameMusic1 pause: 0)
			)
			...
			(14
				(gMessager say: 1 0 0 7 9 self) ; "I had just finished my education back in western Pennsylvania at the local Meadville Normal School when I saw a small ad on the school bulletin board seeking teachers "...for a lovely little village, way out West.""
			)
			(15
			...
			(18
				(gMessager say: 1 0 0 10 11 self) ; "But I could never afford to buy mineral rights on the meager pittance they pay a single unwed female teacher, so I made a little arrangement with Mr. Balance."
			)
			(19
			...
			(21
				(gMessager say: 1 0 0 12 self) ; "But Penelope! You seemed to be such a sweet, innocent young woman. How could you be such a SLEAZEBAG?"
			)
			(22
			...
			(27
				(gMessager say: 3 0 0 5 7 self) ; "Well, if it's YOU, then I'm doing the town a favor by disposing of you, aren't I?"
			)
			(28
				(= cycles 100)
			)
