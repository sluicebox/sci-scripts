		...
		(switch (= state newState)
			...
			(9
				...
				((ScriptID 40) ; DyingScript
					caller: 814
					register: (Format @string 535 11) ; "If only you had some way to secure yourself to the rope. Your hands have certain skills, but rope grasping is not one of them!"
					next: (Format @string2 535 12) ; "Remember Christopher Reeves"
				)
			)
		)
	)
