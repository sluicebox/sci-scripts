...
(instance sPutMummy of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(sFX number: 700 flags: 5 loop: 1 play:) ; sPushMummyAgainstDoor
				(gEgo setCycle: End self)
			)
			(3
...
(instance sUnlockCase of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(sFX number: 49 loop: 1 flags: 5 play:) ; sDoorUnlatch
				(gEgo setCycle: End self)
			)
			(4
...
(instance sKillRileyKill of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(sFX number: 80 flags: 5 loop: 1 play:) ; sThud
...
(instance sListen of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gGameMusic2 number: 701 loop: -1 flags: 5 setVol: 63 play:) ; sEgyptianChantSoft
				(= cycles 1)
			)
			(1
...
(instance mummyDoor of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(cond
					((self cel:)
						(sFX number: 453 loop: 1 flags: 5 play:) ; sCreakingMummyClose
						(self setCycle: Beg self)
						(snake init:)
					)
					(local0
						(sFX number: 452 loop: 1 flags: 5 play:) ; sCreakingMummyOpen
	...
	(method (cue)
		(if (self cel:)
			...
			(sFX number: 455 loop: 1 flags: 5 play:) ; sMummyShut
