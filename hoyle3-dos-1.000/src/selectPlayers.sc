...
(procedure (localproc_2 param1)
	(switch param1
		(0
			(Format @local44 3 2) ; "M. Goose"
		)
		(1
			(Format @local44 3 3) ; "Roger"
		)
		(2
			(Format @local44 3 4) ; "Rosella"
		)
		(3
			(Format @local44 3 5) ; "Graham"
		)
		(4
			(Format @local44 3 6) ; "Laura"
		)
		(5
			(Format @local44 3 7) ; "Larry"
		)
		(6
			(Format @local44 3 8) ; "Patty"
		)
		(7
			(Format @local44 3 9) ; "Jones"
		)
		(8
			(Format @local44 3 10) ; "Sonny"
		)
		(9
			(Format @local44 3 11) ; "Adavis"
		)
		(10
			(Format @local44 3 12) ; "Lillian"
		)
		(11
			(Format @local44 3 13) ; "Mr. Big"
		)
		(12
			(Format @local44 3 14) ; "Arnoid"
		)
		(13
			(Format @local44 3 15) ; "Vohaul"
		)
		(14
			(Format @local44 3 16) ; "Baba Yaga"
		)
		(15
			(Format @local44 3 17) ; "Mordack"
		)
		(16
			(Format @local44 3 18) ; "Lolotte"
		)
		(17
			(Format @local44 3 19) ; "Sheriff"
		)
	)
	(return @local44)
)
		...
		((== local0 0)
			(if [local1 param1]
				(if (== local34 global189)
					(gSound play: 902)
					(Print 3 39) ; "That would make too many players."
				else
					(gSound play: 901)
					(= [local1 param1] 0)
					(++ local34)
				...
				(gSound play: 902)
				(Print 3 40) ; "There is nobody here."
			)
		)
		([local10 param1]
			(if (== local34 global189)
	...
	(method (handleEvent event)
		(if (super handleEvent: event)
			...
			(if (== local34 global189)
				...
				(gSound play: 902)
				(Print 3 1) ; "You must select more players"
			)
		)
		(event claimed:)
	)
	...
	(method (handleEvent event)
		(if (super handleEvent: event)
			...
			(if occupied
				...
				(Print 3 20) ; "Select an opponent from above."
			)
		)
		(event claimed:)
	)
...
(instance name1 of NamePlate
	...
	(method (goodText &tmp [temp0 30] [temp30 400])
		(Format @temp30 3 21) ; "Mother Goose"
		(switch global187
			(100
				(StrCat @temp30 {BEGINNER})
			)
			(200
				(StrCat @temp30 {BEGINNER})
			)
			(300
				(StrCat @temp30 {AVERAGE})
			)
			(500
				(StrCat @temp30 {EXPERT})
			)
			(400
				(StrCat @temp30 {AVERAGE})
			)
	...
	(method (badText &tmp [temp0 30] [temp30 400])
		(Format @temp30 3 22) ; "Adavis"
		(switch global187
			(100
				(StrCat @temp30 {EXPERT})
			)
