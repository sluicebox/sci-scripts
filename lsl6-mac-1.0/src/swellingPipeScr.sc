...
(instance swellingPipeScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager say: 2 4 6 0 self) ; "(Hmm. There seems to be a problem with that hose. Perhaps I should investigate more closely!)"
			)
			(3
				((ScriptID 330 12) setCycle: Fwd) ; arc
				(= ticks 30)
			)
			(4
