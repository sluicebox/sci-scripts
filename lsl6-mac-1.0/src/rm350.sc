...
(local
	local0
	[local1 20] = [104 125 149 171 192 98 121 149 172 198 91 118 149 175 204 84 114 149 178 210]
	[local21 20] = [97 96 96 97 97 107 107 107 106 106 118 117 117 117 118 130 130 130 130 130]
	[local41 20]
	[local61 10]
	local71
	local72
...
(instance rm350 of LarryRoom
	...
	(method (init)
		...
		(if (Random 0 1)
			(showerGuy1 init: setPri: 4 setScript: shower1)
			(towel1 init: addToPic:)
			(water1 init: setPri: 5 setCycle: Fwd)
			(sFx3 number: 352 play: 127 setLoop: -1)
		)
		(if (Random 0 1)
			(showerGuy2 init: setPri: 4 setScript: shower2)
			(water2 init: setPri: 5 setCycle: Fwd)
			(sFx3 number: 352 play: 127 setLoop: -1)
		)
		(showerHandle init:)
		(switch gPrevRoomNum
...
(instance toMudBath of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(sFx number: 1032 loop: 1 play: 127)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				(showerWater init: setPri: 14 setCycle: Fwd)
				(gEgo loop: 2 setCel: 0 setCycle: End self)
			)
			(7
				(gEgo loop: 3 setCel: 0 setCycle: Fwd)
				(= seconds 5)
			)
			(8
			...
			(0
				...
				(if (== local0 900)
					(gEgo
						...
						setPri: (if (and (< temp0 226) (> temp0 89)) 9 else 5)
						setCel: 0
						setCycle: End self
					)
				else
...
(instance enterFromBath of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(sFx number: 1033 loop: 1 play: 127)
				(mudBathDoor stopUpd:)
				(gGame handsOn:)
				(self dispose:)
			)
...
(instance nozzles of Feature
	...
	(method (onMe param1)
		(return
			(or
				(AvoidPath (param1 x:) (param1 y:) local73)
				(AvoidPath (param1 x:) (param1 y:) local74)
				(AvoidPath (param1 x:) (param1 y:) local75)
				(AvoidPath (param1 x:) (param1 y:) local76)
				(AvoidPath (param1 x:) (param1 y:) local77)
				(AvoidPath (param1 x:) (param1 y:) local78)
			)
		)
	)
)
...
(instance knobs of Feature
	...
	(method (onMe param1)
		(return
			(or
				(AvoidPath (param1 x:) (param1 y:) local79)
				(AvoidPath (param1 x:) (param1 y:) local80)
				(AvoidPath (param1 x:) (param1 y:) local81)
			)
		)
	)
