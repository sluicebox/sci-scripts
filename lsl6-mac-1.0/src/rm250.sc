...
(instance rm250 of LarryRoom
	...
	(method (init)
		(gGame handsOn:)
		((ScriptID 0 11) init: 240) ; iconExit
		(super init: &rest)
		(SetFlag 27)
		(SetFlag 102)
		(leftBreast init:)
	...
	(method (doVerb theVerb &tmp temp0)
		(switch theVerb
			...
			(52 ; randomKey [ filed ]
				...
				(gMessager say: 1 52 10 1 3 self) ; "Look what I have for you, Merr. Your own personal copy of the key to the bungee jumping tower!"
				(return 1)
			)
			(else
