...
(instance rm560 of LarryRoom
	...
	(method (init)
		...
		(super init: &rest)
		(gEgo init: normalize: setScale: Scaler 100 82 122 63)
		...
		(frige init:)
		(cleaver init:)
		(frigeDoor approachVerbs: 4 5 36 init: stopUpd:) ; Do, Take, washCloth [ wet ]
		(garbage init:)
		...
		(if (>= (gGame detailLevel:) 3)
			...
			(projector setCycle: 0 setPri: -1 addToPic:)
		)
	...
	(method (doit)
		(cond
			(script 0)
			((AvoidPath (gEgo x:) (gEgo y:) fixPriPoly)
				(if (or (not local0) (!= (gEgo priority:) 3))
					(= local0 1)
					(gEgo setPri: 3)
				)
			)
	...
	(method (newRoom newRoomNumber)
		(if (and (IsObject local3) (local3 isKindOf: Timer))
			(local3 dispose:)
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(waiterDoor2 setCycle: End self)
			)
			(2
				(if (gCast contains: waiterDoor2)
					(waiterDoor2 dispose:)
				)
				(= ticks 40)
			)
			(3
				(gEgo setPri: 3 setCycle: Beg self)
			)
			(4
				(gEgo
					normalize: 900 8
			...
			(6
				(gEgo setPri: -1 setHeading: 0 self)
			)
			(7
				(= ticks 45)
			)
	...
	(method (onMe param1)
		(if (super onMe: param1)
			(if (== (param1 message:) 32)
				...
				(self approachX: 56 approachY: 113)
			)
			(return 1)
		else
			(return 0)
...
(instance fixPriPoly of Polygon
	...
	(method (init)
		(super init: 94 59 154 62 100 125 57 117)
	)
)
...
(instance cleanFilterScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(gEgo setPri: 2 setMotion: MoveTo 97 81 self)
			)
			(14
				(gEgo view: 568 loop: 5 cel: 0 setCycle: 0 setScale: 0)
			...
			(16
				(gEgo normalize: 900 8 cel: 2 setScale: Scaler 100 82 122 63)
				(gGame handsOn:)
				(gInventory curObj: ((gTheIconBar curIcon:) select: yourself:))
				(self dispose:)
			)
		)
	)
...
(instance wetWashclothScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gGlobalSound2 stop:)
				(gEgo loop: 1 cel: register setCycle: Beg self)
			)
			(4
				(= ticks 20)
			)
