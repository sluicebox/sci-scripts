...
(instance takeOffShirtScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(gMessager say: 6 4 1 4 self 460) ; "(CRY OF ANGUISH) Doh!"
			)
			(8
				(SetFlag 6)
		...
		(switch (= state newState)
			...
			(1
				...
				(Print
					...
					addButton: 230 5 0 7 1 133 0 440 ; "Air for the G-String"
					addButton: 380 5 0 9 1 0 15 440 ; "Shock Your Booty"
					addButton: 440 5 0 10 1 133 15 440 ; "2 Rump 2 Pump"
				)
				(= temp30
					(Print
						addButton: 442 5 0 11 1 0 30 440 ; "Switch Hitt'n Kitt'n"
						addButton: 511 5 0 12 1 133 30 440 ; "Harry Palm Blues"
						addButton: 514 5 0 13 1 0 45 440 ; "Cell Block Love"
						addButton: 560 5 0 14 1 133 45 440 ; "Un Noche en Parlier"
						addButton: 860 5 0 15 1 0 60 440 ; "Samba de Hooters"
						addButton: 320 5 0 16 1 133 60 440 ; "Spanish Surprise"
						addButton: 420 5 0 18 1 0 75 440 ; "Larry Be Bad!"
						addButton: 580 5 0 20 1 133 75 440 ; "Muskrat Lust"
						addButton: 430 5 0 19 1 0 90 440 ; "No Pain, No Gain"
						addButton: 840 5 0 21 1 133 90 440 ; "Twist Till It Hurts"
						addButton: 310 5 0 8 1 0 105 440 ; "Hard is Good, Right?"
						addButton: 337 5 0 22 1 133 105 440 ; "Not Ravel's Bolero"
						init:
					)
				)
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(17
				...
				(cav stopUpd:)
				(upperSpeaker stopUpd:)
				(lowerSpeaker stopUpd:)
			)
			(18
