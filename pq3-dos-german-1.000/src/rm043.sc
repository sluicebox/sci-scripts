...
(instance attorneyChair of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(if (== (gEgo view:) 460)
					(Print 43 45) ; "You're happy with the seat you're in."
				else
					(Print 43 44) ; "You'll need to sit up front at the prosecutor's table."
				)
			)
...
(instance door of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 43 46) ; "You can't go in there while court is in session."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance calendar of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 43 47) ; "You don't need the calendar."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance gavel of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 43 48) ; "If you want a nice gavel like that, you'll just have to go to law school."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance witnessBox of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(if local5
					(Print 43 49) ; "You're already in the witness box."
				else
					(Print 43 50) ; "The court will call you when your testimony is needed."
				)
			)
			(else
				(super doVerb: theVerb)
