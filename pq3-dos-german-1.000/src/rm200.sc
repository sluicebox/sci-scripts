...
(instance rm200 of Rm
	...
	(method (init)
		...
		(Dmv view: (LangSwitch 197 1971) x: (LangSwitch 26 30) init:)
		(Homicide view: (LangSwitch 197 1971) x: (LangSwitch 88 94) init:)
		(Personnel view: (LangSwitch 197 1971) x: (LangSwitch 166 146) init:)
		(Tools view: (LangSwitch 197 1971) x: (LangSwitch 234 209) init:)
		(Quit view: (LangSwitch 197 1971) x: (LangSwitch 289 307) init:)
		(drawFace view: (LangSwitch 197 1971) x: (LangSwitch 75 80) init: hide:)
		(cityMap view: (LangSwitch 197 1971) x: (LangSwitch 203 166) init: hide:)
		(gTheIconBar disable:)
		(gGame setCursor: 999)
		...
		(if (not (& signal $0080))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (LangSwitch 100 119))
							(== (event message:) (LangSwitch 68 87))
							(and
		...
		(if (not (& signal $0080))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (LangSwitch 116 107))
							(== (event message:) (LangSwitch 84 75))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
		...
		(if (not (& signal $0080))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (LangSwitch 104 109))
							(== (event message:) (LangSwitch 72 77))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
		...
		(if (not (& signal $0080))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (LangSwitch 100 112))
							(== (event message:) (LangSwitch 68 80))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
		...
		(if (not (& signal $0080))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (LangSwitch 99 115))
							(== (event message:) (LangSwitch 67 83))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
