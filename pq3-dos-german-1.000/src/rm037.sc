				...
				(switch invItem
					(19 ; wallet
						(if (IsFlag 195)
							...
							(Print 37 33) ; "May I help you, Sir?"
						)
					)
					(1 ; gun
						(Print 37 34) ; "That's right! Torture Marie's room number out of her!"
					)
					(2 ; handcuff
						(Print 37 34) ; "That's right! Torture Marie's room number out of her!"
					)
					(else
						(Print 37 35) ; "The receptionist isn't interested in that."
					)
				)
			)
			(else
...
(instance elevatorUpper of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 37 36) ; "Just press the button. Trying to pry those doors open with your hands will only give you a hernia."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance computer of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 37 38) ; "If you want something, why don't you ask the receptionist?"
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance frontDesk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 37 39) ; "If you want something, why don't you ask the receptionist?"
			)
			(else
				(super doVerb: theVerb)
			)
