	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				...
				(cond
					...
					((not (IsFlag 33))
						(= save1 1)
						(captInset init:)
						(Say captInset 21 50) ; "You may want to get that description on the air."
						(= seconds 4)
					)
				)
			)
			...
			(11
				...
				(captInset init:)
				(= save1 1)
				(Say captInset 21 51) ; "Bonds! I want you to get over to the 200 block of River Road, now!"
				(= seconds 7)
			)
			(12
				(if gModelessDialog
...
(instance drawerTimerScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(door stopUpd:)
				(Print 21 52) ; "You feel a warm flushed feeling comes over you as Morales walks in and catches you in her drawer."
				(= cycles 1)
			)
			(6
				(patInset init:)
				(Say patInset 21 53) ; "HEY! You mind telling me what the hell you're doing in my desk? That's breaking and entering. Your going to hang for this, Bonds!"
				(= seconds 7)
			)
			(7
				(if gModelessDialog
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(= save1 1)
				(captInset init:)
				(Say captInset 21 54) ; "Hey Bonds, you better quit leaving department equipment lying around. That baglady had a fit not being able to move her shopping cart."
				(= seconds 6)
			)
			(5
				(captInset dispose:)
				...
				(Print 21 55) ; "You turn bright red as the captain hands back your cuffs you forgot at the warehouse."
				(gEgo get: 2) ; handcuff
				(HandsOn)
				(self dispose:)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(= save1 1)
				(captInset init:)
				(Say captInset 21 56) ; "Bonds, the coroner called and said he has something important for you."
				(= seconds 6)
			)
			(4
				(= save1 1)
				(Say captInset 21 57) ; "Something he found on the fatal crash victim last night. Better get over to see him,.. pronto!"
				(= seconds 6)
			)
			(5
				(captInset dispose:)
			...
			(8
				...
				(= save1 1)
				(captInset init:)
				(Say captInset 21 58) ; "Your partner should be back from her physical testing any second."
				(= seconds 6)
			)
			(9
				(captInset dispose:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(= save1 1)
				(sonnyInset init:)
				(Say sonnyInset 21 60) ; "I'm also beginning to suspect that she may be in league with this cult."
				(= seconds 4)
			)
			(5
				(sonnyInset dispose:)
				(captInset init:)
				(Say captInset 21 61) ; "Alright Bonds, I'll have the Internal Affairs boys check it out and keep an eye on her. Play it straight but be careful."
				(= seconds 6)
			)
			(6
				(if gModelessDialog
...
(instance door of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 62) ; "The door leads back into the hallway."
			)
			(3 ; Do
				(HandsOff)
			...
			(2 ; Look
				(cond
					(
						...
						(Print 21 63) ; "You're not in the homicide division."
					)
					(global150
						(switch global150
							(1
								(if (and (== gDay 5) global143)
									(Print 21 64) ; "You have messages on your computer."
								else
									(Print 21 65) ; "This is your computer."
								)
							)
							(2
								(Print 21 64) ; "You have messages on your computer."
			...
			(3 ; Do
				(cond
					...
					((gCast contains: cInset)
						(Print 21 66) ; "Your computer is already turned on."
					)
					(else
						(HandsOff)
...
(instance chair of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					(Print 21 68) ; "The chairs are for officers assigned to Homicide."
				else
					(Print 21 69) ; "Your chair isn't exactly a lazy boy, but you like it."
				)
			)
			(3 ; Do
				(cond
					...
					((not (gEgo normal:))
						(Print 21 70) ; "You are already sitting down."
					)
					(else
						(HandsOff)
		...
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					...
					(Print 21 71) ; "That's where Pat sits."
				)
			)
			(3 ; Do
				(if (== gDay 1)
					...
					(Print 21 72) ; "Sit in your own chair, Sonny."
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance pDrawer of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(if (> gDay 1)
					(Print 21 73) ; "It's Pat's desk drawer."
				else
					(Print 21 74) ; "The desks are for officers assigned to Homicide."
				)
			)
			(3 ; Do
				(Print 21 75) ; "It's locked."
			)
			(4 ; Inventory
				(switch invItem
					(3 ; theKeys
						(cond
							((not (proc882_2 8))
								(Print 21 76) ; "You don't have the key."
							)
							(
								(or
									(gCast contains: pat)
								...
								(Print 21 77) ; "Better not while people are in the room."
							)
							(else
								(HandsOff)
...
(instance drawerInset of View
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 21 78) ; "You find a piece of paper with a series of numbers on it..."386.""
				(SetFlag 34)
				(SetScore 171 10)
			)
			(3 ; Do
				(Print 21 79) ; "Carefully you close and relock the drawer."
				(self dispose:)
			)
			(4 ; Inventory
				(switch invItem
					(28 ; noteBook
						(Print 21 80) ; "You jot the numbers down in your notebook."
						(SetFlag 34)
					)
					(else
						(super doVerb: theVerb)
...
(instance pat of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 81) ; "Your partner, Pat Morales, is an attractive, but tough-looking woman."
			)
			(5 ; Talk
				(if (== local1 4)
					(Print 21 82) ; "Pat is busy at her desk right now."
				else
					(HandsOff)
			...
			(3 ; Do
				(Print 21 83) ; "She doesn't want to shake hands, Bonds."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance cChair of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 84) ; "The captain's chair."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance captain of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 85) ; "Captain Tate runs the Homicide division for L.P.D."
			)
			(5 ; Talk
				(switch gDay
					(1
					...
					(6
						(cond
							...
							((IsFlag 175)
								(Print 21 86) ; "You've already informed the captain of Morales' activities."
							)
							(else
								(Print 21 87) ; "The captain doesn't have time for idle chit chat."
							)
						)
					)
					(else
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(switch gDay
					(3
						(Print 21 89) ; "You have a phone message from the captain in your basket."
					)
					(4
						(cond
							((IsFlag 80)
								(Print 21 90) ; "There is a note in your basket."
							)
							(
								(and
									(not (IsFlag 221))
							...
							((not (IsFlag 28))
								(Print 21 91) ; "There's a subpoena in your basket."
							)
						)
					)
					(5
...
(instance cInset of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 93) ; "It's a computer."
			)
			(3 ; Do
				(Print 21 94) ; "You need your Computer Access card."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance computebutton of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 95) ; "That's the power switch."
			)
			(3 ; Do
				(cInset dispose:)
			)
...
(instance screen of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 96) ; "That's the computer monitor."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance card of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 21 97) ; "That's the computer access card slot."
			)
			(4 ; Inventory
				(switch invItem
					(21 ; compCard
		...
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					...
					(Print 21 98) ; "That's where Earl sits."
				)
			)
			(3 ; Do
				(if (== gDay 1)
...
(instance captDesk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 99) ; "Captain Tate's desk is well organized - as usual."
			)
			(3 ; Do
				(Print 21 100) ; "Messing with Captain Tate could get you fired, Bonds."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance patDesk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					(Print 21 101) ; "The desks are for officers assigned to Homicide."
				else
					(Print 21 102) ; "That desk belongs to Pat Morales - your partner."
				)
			)
			(3 ; Do
				(if (== gDay 1)
					(Print 21 103) ; "You are not assigned to Homicide right now."
				else
					(Print 21 104) ; "There's nothing of interest on Pat's desk."
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance earlDesk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					(Print 21 105) ; "The desks are for officers assigned to Homicide."
				else
					(Print 21 106) ; "Earl Hank's desk is cluttered and covered with scuff marks from his shoes."
				)
			)
			(3 ; Do
				(if (== gDay 1)
					...
					(Print 21 107) ; "Leave Earl's stuff alone."
				)
			)
			(else
				(super doVerb: theVerb)
		...
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					...
					(Print 21 108) ; "Your desk is near the filing cabinet."
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance roomWindow of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 109) ; "The window looks out into the hallway."
			)
			(3 ; Do
				(Print 21 110) ; "The window doesn't open and the blinds are fine."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance graphChart of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 111) ; "The graph on the wall charts homicides for the past three years. Like inflation, the crime-rate rises steadily."
			)
			(3 ; Do
				(Print 21 112) ; "You can't stop crime by ripping up the graph."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance bookCase of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 113) ; "The bookcase has old paperbacks and phone books in it. Nothing interests you."
			)
			(3 ; Do
				(Print 21 114) ; "None of the books interest you."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance bulletin of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 21 115) ; "The messages are public - leave them up."
			)
			(2 ; Look
				(cond
					((== gDay 5)
						(Print 21 116) ; "The memo advises of a mandatory attendance of all female officers for physical performance testing at the beginning of shift tomorrow."
						(SetScore 161 3)
					)
					((< (Random 0 100) 5)
						(Print 21 117) ; "Herein lies the names of the programmers who without undo fanfare brought you this game. Doug Oldfield, Chris Hoyt, Kim Bowdish and Mike Larsen."
					)
					(else
						(Print 21 118) ; "Rarely do you find anything of interest on the bulletin board."
					)
				)
			)
			(else
...
(instance cabinet of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 119) ; "The file cabinet belongs to the captain. He always keeps it locked."
			)
			(3 ; Do
				(Print 21 120) ; "It's locked."
			)
			(else
				(super doVerb: theVerb)
			)
