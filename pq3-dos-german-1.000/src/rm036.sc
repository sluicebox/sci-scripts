...
(instance ekgMonitor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (>= (mariesEyes cel:) 1)
					(Print 36 60) ; "Words cannot discribe the joy you feel seeing Marie awake from her coma."
				else
...
(instance ekg of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (>= (mariesEyes cel:) 1)
					(Print 36 60 #at 40 115) ; "Words cannot discribe the joy you feel seeing Marie awake from her coma."
				else
					(Print 36 61 #at 40 115) ; "The EKG monitor registers your wife's vital signs.  Its steady beep in response to her pulse gives you some small comfort."
				)
			)
			(3 ; Do
				(if (>= (mariesEyes cel:) 1)
					(Print 36 75) ; "You shouldn't mess with things you know nothing about."
				else
					(Print 36 63) ; "Leave the monitor alone. It will alert the staff if Marie goes into distress."
				)
			)
...
(instance light of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 36 76) ; "There's no reason to turn off the light."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance nurseButton of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(if (IsFlag 41)
					(Print 36 77) ; "You don't need the nurse now."
				else
					(Print 36 78 #at 40 115) ; "You press the call button and hope that the nurse is on the way."
...
(instance roseInset of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 36 79) ; "Let Marie keep her rose."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance musicboxInset of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 36 80) ; "Let Marie keep her music box."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance locketInset of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 36 81) ; "Let Marie keep her locket."
			)
			(else
				(super doVerb: theVerb &rest)
			)
