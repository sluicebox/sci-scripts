		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(16 ; nightStick
						(Print 54 36) ; "The recruiter is career army. He's not interested in seeing your puny weapons."
					)
					(else
						(Print 54 37) ; "The recruiter isn't interested."
					)
				)
			)
			(else
...
(instance desk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 54 38) ; "The desk is not yours."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance computer of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 54 39) ; "The recruiter would no doubt flatten your face if you tried to walk out with his computer."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance fileCab of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 54 40) ; "The recruiting officer might be upset if you starting rifling through his files uninvited."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance trash of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 54 41) ; "You're not a janitor."
			)
			(else
				(super doVerb: theVerb)
			)
