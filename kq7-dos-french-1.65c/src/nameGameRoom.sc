...
(local
	[local0 36] = [84 166 133 117 116 134 151 169 196 188 200 218 199 181 208 224 80 131 102 147 179 150 96 116 162 101 220 86 100 114 129 144 159 174 189 204]
	[local36 36] = [105 121 121 105 90 105 106 106 91 106 106 105 122 121 90 90 90 91 106 91 91 122 91 122 91 121 74 74 75 74 73 73 74 74 75 75]
	local72 = 95
	local73 = 62
	[local74 8]
	[local82 36]
...
(instance nameGameRoom of Room
	...
	(method (init &tmp temp0 temp1 temp2 [temp3 2])
		...
		(= local119 (Str newWith: 9 {}))
		(gKeyDownHandler add: self)
		(facePlate init:)
		(for ((= temp0 0)) (< temp0 26) ((++ temp0))
			(alphaGameControls
				add:
					((= [local82 temp0] (LetterIcon new:))
						view: (+ 906 (/ temp0 16))
						setLoop: (mod temp0 16)
						setCel: 0
						x: [local0 temp0]
						y: [local36 temp0]
						value: temp0
