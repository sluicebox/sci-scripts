	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(mySound1 number: -35 setLoop: -1 play:)
			)
			(4
			...
			(5
				...
				(mySound1 stop: number: 6551 setLoop: 1 play: self)
			)
			(6
				(= ticks 240)
			)
...
(instance touchMab of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if register
					(mySound1 number: 6552 setLoop: 1 play:)
				)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				(mySound1 number: 6555 setLoop: 1 play:)
			)
			(7
				(gEgo normalize: 6)
			...
			(20
				(mySound1 number: 6556 setLoop: 1 play: self)
				((= register (Prop new:))
					view: 6554
					loop: 4
					cel: 0
