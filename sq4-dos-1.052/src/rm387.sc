...
(instance lettuceBay of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 5) ; "Uhmm! Lettuce. Real old lettuce."
			)
			(11 ; Smell
				(Print 387 6) ; "Smells like lettuce."
			)
			(else
...
(instance pickleBay of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 7) ; "Tastes like pickelene slices"
			)
			(11 ; Smell
				(Print 387 8) ; "Smells like pickles."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance bunBay of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 9) ; "They almost taste fresh."
			)
			(11 ; Smell
				(Print 387 10) ; "Must be PermaBuns. They have no smell."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance mayo of Condiment
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 11) ; "It tastes white."
			)
			(11 ; Smell
				(Print 387 12) ; "It has an oily smell."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance must of Condiment
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 13) ; "Tastes a little spicey."
			)
			(11 ; Smell
				(Print 387 14) ; "Smells a little spicey."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance cats of Condiment
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 15) ; "It tastes wet. Otherwise, it's tasteless."
			)
			(11 ; Smell
				(Print 387 16) ; "It has no smell."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance pickle of Condiment
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 17) ; "Tastes like pickle slices"
			)
			(11 ; Smell
				(Print 387 8) ; "Smells like pickles."
			)
...
(instance burger of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(10 ; Taste
				(Print 387 18) ; "Hey! This belongs to someone else!"
			)
			(11 ; Smell
				(Print 387 19) ; "There's that Monolith Burgers Secret Smell(tm)."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance grabber of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 20) ; "That's a good way to put your tongue out, buddy."
			)
			(11 ; Smell
				(Print 387 21) ; "Smells greasy."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance rejectSign of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 22) ; "It tastes greasy."
			)
			(11 ; Smell
				(Print 387 23) ; "It smells greasy."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance belt of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 24) ; "Essence of Monolith Burger now coats your tongue - forever!"
			)
			(11 ; Smell
				(Print 387 25) ; "It smells like the essence of Monolith Burger."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance topCounter of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 26) ; "You must be bored. Maybe we should turn up the speed."
			)
			(11 ; Smell
				(Print 387 26) ; "You must be bored. Maybe we should turn up the speed."
			)
...
(instance upperPipes of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 27) ; "Don't mess with it."
			)
			(11 ; Smell
				(Print 387 28) ; "Smells like a pipe!"
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance hood of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 387 29) ; "It definitely hasn't been cleaned in awhile. Maybe later when you get time you could give it a buff."
			)
			(11 ; Smell
				(Print 387 30) ; "It smells likes escaping air."
			)
			(else
				(super doVerb: theVerb invItem)
			)
