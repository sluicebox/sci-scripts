...
(instance astro of SQRoom
	...
	(method (init)
		(Load rsVIEW 290)
		(Load rsPIC 291)
		(LoadMany rsSOUND 55 140 56 122 131 147 144 146)
		(self drawPic: 290 overlay: 291 0 setScript: startScript)
		(super init:)
		(= picture 290)
		(= local11 (gGame masterVolume:))
		(musicToggle init:)
		(gWalkHandler add: gCast gFeatures)
		(gNarrator disable:)
	)

	(method (dispose)
		(gWalkHandler delete: gCast gFeatures)
		(gNarrator enable:)
