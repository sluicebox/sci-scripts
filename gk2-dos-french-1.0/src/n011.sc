...
(procedure (InitChapter &tmp temp0 temp1)
	...
	(switch gChapter
		(1
			(gTopMessage newText: {Chapitre Un: Film d'Ouverture})
			(= gEgo GabeEgo)
		...
		(2
			(gTopMessage newText: {Chapitre Deux: Film d'Ouverture})
			(= gEgo GraceEgo)
		...
		(3
			(gTopMessage newText: {Chapitre Trois: Film d'Ouverture})
			(= gEgo GabeEgo)
			(gEgo
				get: 5 ; invTalisman
		...
		(4
			(gTopMessage newText: {Chapitre Quatre: Film d'Ouverture})
			(= gEgo GraceEgo)
		...
		(5
			(gTopMessage newText: {Chapitre Cinq: Film d'Ouverture})
			(= gEgo GabeEgo)
			(gEgo
				get: 5 ; invTalisman
				get: 15 ; invSpliceTape
		...
		(6
			(gTopMessage newText: {Chapitre Six: Film d'Ouverture})
			(= gEgo GraceEgo)
