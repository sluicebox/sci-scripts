			...
			(evSAID
				(cond
					...
					((Said 'eat,blow,fuck/couple,customer,cafe,customer,man')
						(Print 30 61 #at -1 135) ; "Golly gee!" the customer declares. "It must be one of them there preeverts that you read about in the papers. Go on, buddy! Get away! Shoo! Shoo!"
					)
...
(instance waiterScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(local0 stopUpd: (Print 30 105 #at 68 160)) ; ""Please find a table, Sir, and we'll be right with you," says the waiter."
				(self cue:)
				(User canControl: 1)
			)
			(3
			...
			(10
				...
				(if local36
					...
					(Print 30 106 #at 59 160 #time 6) ; "Good day sir," says the waiter..."Our specials of the day are meatloaf, prime rib, and lobster."
					(Print 30 107 #at 59 170) ; "Continuing he says, "Which would you prefer?""
					(= local34 1)
				)
			)
			(11
...
(instance sonnyScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 30 135 #at 69 150 #time 5 #draw) ; "Oh, Sonny....you're WONDERFUL!!!"
			)
		)
	)
)
