...
(instance fallInHole of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(EgoDead 64 36 82 800 1 5 80 { Watch your step! }) ; "You stepped into a hole whose depth is unfathomable. As you fall ever downward, you feel icy fingers clutching at you, and you think: "How could I be so careless?""
			)
		)
	)
)
