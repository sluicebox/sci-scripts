...
(instance egoToPlant of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				(EgoDead 76 74 80 {Plant it, fella!} 82 79 2 6) ; "Well, it looks like the Dryad really made you eat dirt. You're the spitting image of a Spirea plant, and you'll be hanging around for a long, long time."
			)
		)
	)
)
