...
(instance bearFreed of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(16
				(HighPrint 171 19) ; "You have the honor of meeting the Baronet Barnard von Spielburg. We are pleased that you broke our enchantment. Perhaps our father the Baron will reward you should you ever visit our castle."
				(= cycles 3)
			)
			(17
...
(instance baronHeadSmall of Prop ; UNUSED
	(properties
		y 140
		x 130
		z 25
