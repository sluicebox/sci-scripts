...
(class Script of Obj
	...
	(method (sel_57 &tmp temp0)
		...
		(cond
			...
			((and sel_139 (<= (-= sel_139 (Abs (- gGameTime sel_140))) 0))
				(= sel_139 0)
				(self sel_145:)
			)
		)
	...
	(method (sel_111 &tmp temp0)
		...
		(if (and (IsObject sel_143) (== gNewRoomNum gCurRoomNum))
			(sel_143 sel_145: sel_141)
		)
		(= sel_142 (= sel_135 (= sel_42 (= sel_65 (= sel_143 0)))))
		(super sel_111:)
	)
