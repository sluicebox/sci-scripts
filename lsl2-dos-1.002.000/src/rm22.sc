...
(instance rm22 of Rm
	...
	(method (init)
		...
		(Load rsVIEW 235)
		(super init:)
		((View new:) view: 252 loop: 1 cel: 1 posn: 287 76 setPri: 4 addToPic:)
		((View new:)
			view: 252
			loop: 1
			cel: 2
		...
		((View new:) view: 235 loop: 1 posn: 182 156 setPri: 11 addToPic:)
		((View new:) view: 252 loop: 2 posn: 54 84 setPri: 12 addToPic:)
