...
(class PV of Feature
	...
	(method (doit)
		(AddToPic view loop cel x y priority (if (& signal $4000) -1 else 15))
	)
...
(class Act of Prop
	...
	(method (setDirection dir &tmp temp0 temp1 temp2 temp3 temp4)
		(if (== dir 0)
			(self setMotion: 0)
			(return)
		)
		(= temp0 (* 45 (- dir 1)))
		(= temp1 (gCurRoom xTiltTop:))
		(= temp2 (gCurRoom xTiltBottom:))
		(= temp3 (gCurRoom yTiltLeft:))
		(= temp4 (gCurRoom yTiltRight:))
		(self
			setMotion:
				MoveTo
				(+
