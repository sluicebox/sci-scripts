	...
	(method (handleEvent event &tmp msg i [string2 100])
		(switch (= msg (super handleEvent: event))
			(257
				...
				(Print
					(Format @gString 997 1 gVersion) ; "Sierra's Creative Interpreter developed by Jeff Stephenson, Bob Heitman, Pablo Ghenis, and Stuart Goldstein Graphics Systems by Bob Heitman Music composed and performed by Al Lowe Atari ST Translation by Corey Cole Version %s, January 11, 1989"
					#font
					gSmallFont
					#mode
					1
