...
(instance day of Prop
	...
	(method (init)
		(= x (proc13_6 136 42 35 31 31))
		(= y (proc13_6 40 68 50 68 68))
		(super init:)
	)
)
...
(instance one of Prop
	...
	(method (init)
		(= x (proc13_6 46 230 250 195 195))
		(= y (proc13_6 120 110 52 40 40))
		(super init: &rest)
	)
)
...
(instance zero of Prop
	...
	(method (init)
		(= x (proc13_6 81 270 275 265 265))
		(= y (proc13_6 43 50 52 27 27))
		(super init: &rest)
	)
)
