...
(procedure (localproc_4)
	...
	(if (> local18 1)
		...
		(= local18 (proc13_6 9 7 9 9 7))
		(= local16 (proc13_6 271 260 271 271 260))
...
(instance rm302 of Room
	...
	(method (init)
		(= local8 (IDArray new: (proc13_6 54 36 54 54 35)))
		(= local9 (Str new: (proc13_6 54 36 54 54 35)))
		(switch (gGame printLang:)
			...
			(34
				(= local11 (Str with: {XDJCUSTODIARAGKYNOMALTRATARLO}))
				(= local12 (Str with: {XDJESTANOCHECONCLAVETRAEFWETKASH}))
				(= local13 (Str with: {DJTRAESEKEYMADOULE}))
				(= local14 (Str with: {DJESTANOCHECONCLAVETRAESEKEYMADOULE}))
			)
			(else
		...
		(= local10 0)
		(= local16 (proc13_6 135 140 135 135 140))
		(= local17 (proc13_6 23 30 23 23 30))
		(= local18 1)
		(gGame handsOn:)
		(super init:)
		(= local1 gTheCursor)
	...
	(method (doit)
		(if
			(and
				...
				(<
					(- gMouseY 10)
					(+ (* (proc13_6 20 20 20 20 24) (proc13_6 6 5 6 6 5)) 22)
				)
			)
...
(instance messageView of View
	...
	(method (doVerb)
		(if
			...
			(if (<= local10 (- (proc13_6 54 36 54 54 35) 1))
				(gCurRoom setScript: selectChar)
			else
				(switch (gGame printLang:)
					(34
						(Printf {No queda sitio en la pared})
					)
					(49
