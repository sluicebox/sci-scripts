		...
		(switch (= state newState)
			(0
				...
				(gEgo
					...
					setSpeed: 4
					ignoreActors: 1
					setMotion: MoveTo 20 82 self
				)
				((ScriptID 231 24) setCel: 0 init:) ; extDoor
			)
			(1
				(Face gEgo 20 90 0)
				((ScriptID 231 24) setCycle: CT 3 1 self) ; extDoor
			)
			(2
				(gEgo setMotion: MoveTo 22 97)
				((ScriptID 231 24) cycleSpeed: 15 setCycle: End self) ; extDoor
			)
			(3
				(= cycles 6)
			)
			(4
				((ScriptID 231 24) setCycle: Beg self) ; extDoor
				(gEgo setPri: -1 ignoreActors: 0)
			)
			(5
				(gGkSound1 stop:)
				(gGkSound2 number: 374 loop: 1 play:)
				((ScriptID 231 24) cycleSpeed: 8) ; extDoor
...
(instance moselyLeaves of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(12
				((ScriptID 231 24) setCycle: End self) ; extDoor
			)
			(13
		...
		(switch (= state newState)
			...
			(2
				(gEgo
					setMotion:
						PolyPath
						((ScriptID 231 24) approachX:) ; extDoor
						((ScriptID 231 24) approachY:) ; extDoor
						self
				)
			)
			(3
				(gCurRoom setScript: (ScriptID 231 25)) ; leaveStation
				(self dispose:)
			)
		)
	)
		...
		(switch (= state newState)
			...
			(1
				(if (and (gEgo has: 16) (not (IsFlag 3)) local0) ; policeVeve
					...
					(if (== ((ScriptID 231 24) script:) sExitDoorFromOffice) ; extDoor
						((ScriptID 231 24) setScript: 0) ; extDoor
					)
					(gGame handsOn:)
					(self dispose:)
				else
...
(instance beignetManShows of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(17
				((ScriptID 231 24) setCycle: CT 4 1) ; extDoor
...
(instance comeBackIn of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 231 24) setCel: 4 show: setCycle: Beg self) ; extDoor
				(deskSarg
					setCel: 0
					view: 2302
					setLoop: 2
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				((ScriptID 231 24) setCel: 5 show: setCycle: Beg self) ; extDoor
			)
			(3
				(gGkSound2 number: 374 loop: 1 play:)
			...
			(7
				((ScriptID 231 24) setCel: 0 setCycle: CT 3 1 self) ; extDoor
