...
(instance sGetChange of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(5
				(TPrint 260 10) ; "You feel around in the cigarette vending machine's change slot and find..."
				(if
					(and
						(not (IsFlag 34))
						(not (IsFlag 11))
					...
					(Points 5 34)
					(TPrint 260 11) ; "...a pair of quarters!"
					(= gQuarters 2)
				else
					(TPrint 260 12) ; "...nothing. Someone must have taken whatever change was left here!"
				)
