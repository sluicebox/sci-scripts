...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(TPrint 460 0 #dispose self #at -1 20) ; "What an honor for you, Patti! Just look at all the dignitaries here to hear you perform."
			)
			(2
				(= ticks 30)
			)
			...
			(11
				...
				(Say gEgo 460 6 #at -1 20) ; "Larry!" you shout. "It's you!!"
			...
			(30
				(Say gEgo 460 13 #at -1 20) ; "Come on, Inspector Desmond," you say, "we're gonna sit at the head table!"
			...
			(32
				(TPrint 460 14 #title {Larry} #at -1 20) ; "Uh, Patti, er, well, I meant..." Larry stutters, then finally gives up. "Hi, Inspector. My name is Larry; Larry Laffer."
				(TPrint 460 15 #at -1 185 #title {Inspector Desmond}) ; ""Charmed," grunts Desmond."
			...
			(34
				...
				(gEgo normalize: setMotion: MoveTo -10 142)
			...
			(87
				...
				(TPrint 460 32 #at -1 20) ; "What is that song," you think. "It sounds so familiar."
				(= seconds 3)
			)
			(88
			...
			(96
				(TPrint 460 41 #at -1 20) ; ""JULIUS!" you think, your mind racing!"
				(= seconds 3)
			)
			(97
				(gEgo show:)
...
(instance sCartoon2 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(24
				(TPrint 460 57 #at 15 -1 #width 280 #title {Mr. Vice President}) ; "Assuming you are talking to him, the Vice President whispers carefully, so as not to let his wife overhear, "Er, uh, well, yes. Perhaps I could set up a little excursion to Camp David...""
				(= cycles 1)
			)
			(25
				(larry setCycle: Beg self)
