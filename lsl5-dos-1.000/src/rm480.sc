...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say gEgo 480 0 #dispose self #at -1 20) ; "Larry? What's that bulge in your leisure suit?"
			)
			(2
				(TPrint 480 1 #title {Larry} #dispose self #at -1 20) ; "Oh, Patti! Oh. I know what you mean. Why those are just some miniature video tapes I recorded while on the road."
			)
			(3
				(Say gEgo 480 2 #dispose self #at -1 20) ; "Hey, fun! That'll give us something to watch at Camp David!"
			)
			(4
				(TPrint 480 3 #title {The Vice President} #dispose self #at -1 20) ; ""I just love home movies!" chimes in the Vice President."
			)
			(5
				(TPrint 480 4 #title {Larry} #dispose self #at -1 20) ; "Uh, Patti, er, Sir, ah, I don't think... Oh, never mind," Larry says. "Grab your glasses everyone. Patti, I propose a toast to us--and to our wonderful future together!"
			)
			(6
				(Say gEgo 480 5 #dispose self #at -1 20) ; "Excellent, Larry. Yes--to a great week-end!!"
			)
			(7
			...
			(13
				(TPrint 480 6 #at -1 20) ; "And so, all's well that ends well?"
			...
			(34
				(gCurRoom drawPic: 1 13)
				(if (DoSound sndGET_AUDIO_CAPABILITY)
					(TPrint 480 23 #title {AL says} #at -1 20) ; "Now would be an excellent time for you to save your game. We have a little surprise in store for you."
				)
				(= seconds 5)
			)
			(35
