	...
	(method (init)
		...
		(self
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 0 0 127 0 126 116 77 116 77 118 126 118 70 156 55 157 41 163 9 165 9 169 166 169 310 169 309 166 231 162 55 162 55 160 72 158 131 118 230 118 231 116 130 116 130 0 319 0 319 189 0 189
					yourself:
				)
		)
