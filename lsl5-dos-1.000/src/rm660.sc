...
(instance sEnterBooth of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(15
				(HandsOff)
				(Say Reverse_Biaz 660 20 108) ; "Well, Patti," Reverse says, "I've got another session starting soon. You're going to have to go now; I've got to get to work!"
				(keyboard dispose:)
...
(instance reverseBiaz of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(if didSession
					(Say Reverse_Biaz 660 57 108) ; "Oooh! Now that feels nice, Patti."
				else
			...
			(5 ; Talk
				(if didSession
					...
					(Say Reverse_Biaz 660 59 108) ; "Patti, I can see your lips moving, but I don't have an open mike out there. Just go ahead and play, and we can talk later, okay?"
				)
			)
			(4 ; Inventory
				(switch invItem
					...
					(else
						(Say Reverse_Biaz 660 61 108) ; "I don't know why you're offering me that, Patti. Did you come to play or come to bargain?"
					)
				)
			)
			(10 ; Zipper
