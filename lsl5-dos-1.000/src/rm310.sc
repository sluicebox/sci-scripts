	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(TPrint 310 1 #at -1 20 #title {You} #dispose) ; ""YEOW!" you scream!"
				(= cycles 2)
			)
			(5
			...
			(25
				(TPrint 310 7 #at -1 20 #title {You} #dispose) ; "This is it," you think, "I've got to make it this time!"
				(= seconds 2)
			)
			(26
				(plane
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(TPrint 310 11 #at -1 20 #dispose self) ; "Your visit to the East Coast finished, your airplane heads back to Los Angeles."
