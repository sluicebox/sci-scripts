	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(TPrint 310 1 67 -1 20 80 {You} 108) ; ""YEOW!" you scream!"
				(= cycles 2)
			)
			(5
			...
			(25
				(TPrint 310 7 67 -1 20 80 {You} 108) ; "This is it," you think, "I've got to make it this time!"
				(= seconds 2)
			)
			(26
				(plane
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(TPrint 310 11 67 -1 20 108 self) ; "Your visit to the East Coast finished, your airplane heads back to Los Angeles."
