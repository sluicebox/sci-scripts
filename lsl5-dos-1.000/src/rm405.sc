	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(Say the_Piano_Pit_Manager 405 1 #dispose #caller self) ; "Funny you'd mention that, Patti."
			)
			(3
				(= ticks 30)
			)
			(4
				(Say the_Piano_Pit_Manager 405 2 #dispose #caller self) ; "I was just getting ready to talk to you."
			)
			(5
				(= ticks 123)
			)
			...
			(7
				(Say the_Piano_Pit_Manager 405 4 #dispose #caller self) ; "Oh, Patti, it ain't me. You know I like you just fine. It's just my boss that don't."
			)
			(8
				(= ticks 60)
			)
			(9
				(Say the_Piano_Pit_Manager 405 5 #dispose #caller self) ; "Julius doesn't much care for small audiences."
			)
			(10
				(= ticks 60)
			)
			(11
				(Say the_Piano_Pit_Manager 405 6 #dispose #caller self) ; "He says your fans listen too much and drink too little."
			)
			(12
				(= ticks 60)
			)
			(13
				...
				(Say the_Piano_Pit_Manager 405 8 #dispose #caller self) ; "He can't see how he and his 'backers' can be expected to make a profit like that."
			)
			(14
				(= ticks 30)
			)
			(15
				(Say the_Piano_Pit_Manager 405 9 #dispose #caller self) ; "Patti, I'm just going to have to let you go."
			)
			(16
				(= ticks 123)
			)
			(17
				...
				(Say the_Piano_Pit_Manager 405 11 #dispose #caller self) ; "It's not me, Honey," he says, "you treated me jus' fine. I'll be sorry to see you go."
			)
			(18
				(= ticks 123)
			)
			(19
				...
				(Say the_Piano_Pit_Manager 405 13 #dispose #caller self) ; "Ah, er," he stutters, "I guess that's the other thing: I can't do that."
			)
			(20
				(= ticks 60)
			)
			(21
				(Say the_Piano_Pit_Manager 405 14 #dispose #caller self) ; "Julius says your contract was never valid, so he doesn't have to pay."
			)
			(22
				(= ticks 123)
			)
			(23
				...
				(Say the_Piano_Pit_Manager 405 16 #dispose #caller self) ; "Not exactly shaking, he replies, "Do what you have to do, Patti, but if you ever want to work anywhere in this town again...""
			)
			(24
				(= ticks 60)
			)
			(25
				...
				(Say the_Piano_Pit_Manager 405 18 #dispose #caller self) ; "Patti, take my advice: play more commercial. Give 'em what they like! A broad as good lookin' as you could really pull 'em in, if you'd just get smart!"
			)
			(26
				(= ticks 123)
			)
