		...
		(switch theVerb
			(2 ; Look
				(switch cel
					...
					(4
						(TPrint 740 8) ; "It's her head! Grab it!"
					)
					(5
						(TPrint 740 9) ; "It's her... WHOA! Yeah, grab that!"
					)
					(6
						(TPrint 740 10) ; "You'd love to grab her there!"
					)
				)
			)
			(3 ; Do
...
(instance findWhere of Code
	...
	(method (doit who &tmp theX theY)
		...
		(= partCounter (Random 60 360))
		(= partCounter (* missTime (Random 5 30)))
	)
)
...
(instance larry of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(TPrint 740 18) ; "Don't grab you and Lana. Grab those flying body parts instead!"
			)
			(else
