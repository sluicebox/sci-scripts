				...
				(switch invItem
					(17 ; Silver_Dollar
						(cond
							...
							((> payoff gSilvDollars)
								(Format @str 730 26 gSilvDollars) ; "Excuse me, sir," you say to the hopefully friendly bouncer. "Would it be okay if I only paid you $%d.00? I seem to be a little short!"
								(Say gEgo @str)
