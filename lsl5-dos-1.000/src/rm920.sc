	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				...
				(Say gEgo 920 2 #at -1 20 #dispose) ; "UGH!"
			...
			(20
				(TPrint 920 4 #at -1 20 #title {Chi Chi}) ; "Larry! Watch out for my trampoline!"
			...
			(22
				(gTheMusic2 number: 913 loop: 1 play:)
				(Say gEgo 920 5 #title {You} #at -1 20 #dispose) ; "ARGGHH!"
				(gEgo hide:)
				(crack
					show:
					view: 920
			...
			(38
				...
				(Say gEgo 920 7 #title {You} #at -1 20 #dispose) ; "AAWWWH!"
