	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				...
				(Say gEgo 920 2 67 -1 20 108) ; "UGH!"
			...
			(20
				(TPrint 920 4 67 -1 20 80 {Chi Chi}) ; "Larry! Watch out for my trampoline!"
			...
			(22
				(gTheMusic2 number: 913 loop: 1 play:)
				(Say gEgo 920 5 80 {You} 67 -1 20 108) ; "ARGGHH!"
				(gEgo hide:)
				(crack
					show:
					view: 920
			...
			(38
				...
				(Say gEgo 920 7 80 {You} 67 -1 20 108) ; "AAWWWH!"
