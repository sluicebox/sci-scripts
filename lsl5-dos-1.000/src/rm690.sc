...
(instance sFBI of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gTheIconBar enable:)
				(TPrint 690 1 67 -1 20 80 {Inspector Desmond} 108 self) ; "What's she doing now, Agent Smith?"
			)
			(3
				(= seconds 3)
			)
			(4
				(if (IsFlag 20) ; fChampagneSolution
					(TPrint 690 2 67 -1 20 80 {Agent Smith} 108 self) ; "Well, I dunno, Inspector Desmond, it's kinda hard to figure out. Either I'm picking up a lot of RF interference, or she's consuming way too much fluid!"
				else
					(TPrint 690 3 67 -1 20 80 {Agent Smith} 108 self) ; "Well, I dunno, Inspector Desmond, it's kinda hard to figure out. Either she's in a tunnel somewhere near Baltimore, or she's dilated 3 cm!"
				)
			)
			(5
				(= seconds 3)
