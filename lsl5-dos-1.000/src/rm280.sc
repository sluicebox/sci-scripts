	...
	(method (changeState newState &tmp [temp0 2] [temp2 80])
		(switch (= state newState)
			...
			(10
				...
				(TPrint 280 55 #at -1 20) ; "Hello, Checker Limo. Wearya? Weardjawannago?"
				(= ticks 30)
			)
			(11
			...
			(12
				(TPrint 280 57 #at -1 20) ; "Waddaya deff? Wearya? Weardjawannago?"
				(= ticks 30)
			)
			(13
			...
			(14
				(TPrint 280 59 #at -1 20) ; "Weardjawannago?"
				(= ticks 30)
			)
			(15
			...
			(16
				(TPrint 280 61 #at -1 20) ; "Gotcha. Mee'cha ou'side."
				(= ticks 30)
			)
			(17
			...
			(20
				(Points 3 1)
				(SetFlag 38) ; fLimoParked
				(TPrint 280 63 #at -1 20) ; "Good afternoon, and welcome to lovely Miami," a pleasant voice answers the telephone. "How may North Beach Limousine Service assist you today?"
				(= ticks 30)
			)
			(21
			...
			(22
				(TPrint 280 65 #at -1 20) ; "Very well, Sir. And how will you be paying today?"
				(= ticks 30)
			)
			(23
			...
			(24
				(TPrint 280 67 #at -1 20) ; "Ahhh, but of course, sir! Your limousine will be outside in a few seconds!"
				(TPrint 280 68 #at -1 20) ; "He concludes, "And thank you for thinking of us!""
				(= ticks 30)
			)
			(25
				(TPrint 280 62 #at -1 185) ; "(And he hangs up the phone.)"
			...
			(30
				(Points 3 1)
				(SetFlag 38) ; fLimoParked
				(TPrint 280 69 #at -1 20) ; "Good day. Tramp Limousine at your service."
				(= ticks 30)
			)
			(31
			...
			(32
				(TPrint 280 71 #at -1 20) ; "Yes sir!" he replies, "I'll send one of my best girls right over!"
				(= ticks 30)
			)
			(33
				(TPrint 280 62 #at -1 185) ; "(And he hangs up the phone.)"
