...
(instance sJetWay of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(TPrint 295 0 67 -1 20 108) ; "HIP, HIP,"
			...
			(7
				(TPrint 295 3 67 -1 20 108) ; "It's him!"
				(gEgo
					normalize:
					posn: 152 123
					loop: 2
			...
			(10
				(TPrint 295 5 67 -1 20 108 self) ; "It's Larry Laffer!"
			)
			(11
				(= ticks 60)
			)
			(12
				(TPrint 295 6 67 -1 20 108 self) ; "HUZZAH!!"
			)
			(13
				(= ticks 30)
			)
			...
			(21
				(TPrint 295 7 67 -1 20 108 self) ; "So tell us, Mr. Laffer," asks a reporter, "how does it feel to save the lives of hundreds of people?"
			)
			(22
				(= ticks 30)
			)
			...
			(25
				(TPrint 295 9 67 -1 20 108 self) ; ""What is the secret of your amazing rescue technique?" asks a third."
			)
			(26
				(= ticks 30)
			)
			...
			(29
				(TPrint 295 11 67 -1 20 108 self) ; "Before you can answer any questions, you hear a telephone ring."
			)
			(30
				(= seconds 3)
			)
