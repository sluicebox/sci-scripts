...
(instance sJetWay of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(TPrint 295 0 #at -1 20 #dispose) ; "HIP, HIP,"
			...
			(7
				(TPrint 295 3 #at -1 20 #dispose) ; "It's him!"
				(gEgo
					normalize:
					posn: 152 123
					loop: 2
			...
			(10
				(TPrint 295 5 #at -1 20 #dispose self) ; "It's Larry Laffer!"
			)
			(11
				(= ticks 60)
			)
			(12
				(TPrint 295 6 #at -1 20 #dispose self) ; "HUZZAH!!"
			)
			(13
				(= ticks 30)
			)
			...
			(21
				(TPrint 295 7 #at -1 20 #dispose self) ; "So tell us, Mr. Laffer," asks a reporter, "how does it feel to save the lives of hundreds of people?"
			)
			(22
				(= ticks 30)
			)
			...
			(25
				(TPrint 295 9 #at -1 20 #dispose self) ; ""What is the secret of your amazing rescue technique?" asks a third."
			)
			(26
				(= ticks 30)
			)
			...
			(29
				(TPrint 295 11 #at -1 20 #dispose self) ; "Before you can answer any questions, you hear a telephone ring."
			)
			(30
				(= seconds 3)
			)
