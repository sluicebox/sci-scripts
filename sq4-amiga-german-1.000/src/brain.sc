...
(procedure (localproc_1 &tmp temp0)
	(switch (= temp0 (brain formatting:))
		(5000
			(StrCpy @local112 (LangSwitch {EXCELLENT} {AUSGEZEICHNET}))
			(= local11 global137)
		)
		(3000
			(StrCpy @local112 (LangSwitch {VERY GOOD} {SEHR GUT}))
		)
		(2000
			(StrCpy @local112 (LangSwitch {GOOD} {GUT}))
		)
		(1500
			(StrCpy @local112 (LangSwitch {FAIR} {GEN\9aGEND}))
		)
		(1000
			(StrCpy @local112 (LangSwitch {DANGER} {GEF\8eHRLICH}))
			(= local11 global135)
		)
		(500
			(StrCpy @local112 (LangSwitch {CRITICAL} {KRITISCH}))
			(= local11 global143)
		)
	)
