		...
		(switch (= state newState)
			...
			(4
				...
				(Graph
					...
					local1
					local3
					(proc0_18 global133 global132 global132)
					4
					-1
				)
...
(instance bush2 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; Smell
				(Print 370 15) ; "They have a minty-fresh smell that keeps you refreshed."
			)
			(10 ; Taste
				(Print 370 16) ; "You know that eating plastic plants places pressure on your plumbing. You learned that reading JANITORIAL DIGEST."
			)
			(else
				(super doVerb: theVerb &rest)
			)
