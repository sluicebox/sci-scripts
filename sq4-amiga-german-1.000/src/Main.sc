...
(procedure (proc0_14 param1 &tmp temp0 [temp1 100] [temp101 200] [temp301 4] temp305)
		...
		(4
			(StrCat
				...
				(LangSwitch
					...
					{\1a - Roger Wilco und die Zeitspringer}
				)
			)
		)
		(10
	...
	(DrawStatus @temp101 0 (proc0_18 global158 global155 global155))
)
