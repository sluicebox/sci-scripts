			...
			(1
				(= local14
					(proc0_12
						...
						global132
						29
						(proc0_18 global139 global149 global139)
					)
				)
				(gEgo setMotion: 0)
			...
			(3
				(if (< (gEgo distanceTo: sp2) 50)
					...
					(Graph
						...
						local4
						local3
						(proc0_18 global133 global132 global143)
						(- (gEgo priority:) 1)
						-1
					)
...
(instance zapMsChickenS of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(Print 376 1) ; "Whoa! This game's circuits have melted into a mass of molten silicon. But the fireworks sure were pretty!"
...
(instance pod of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; Smell
				(Print 376 2) ; "It smells scorched."
			)
			(10 ; Taste
				(Print 376 3) ; "It tastes scorched. Oxidized materials now coat your tongue."
			)
			(2 ; Look
				(Print 376 4) ; "You give the Time Pod a long glance. It's not the most attractive vehicle you've ever seen. It resembles an overgrown titanium tennis shoe."
			)
			(else
...
(instance sp1 of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 376 5) ; "It's one of Vohaul's Sequel Policemen!"
			)
			(5 ; Talk
				(Print 376 6) ; "That would be most unwise!"
			)
			(11 ; Smell
				(Print 376 7) ; "Seeing as how these guys are trying to kill you, your best line of defense would be a straight one out of here."
			)
			(10 ; Taste
				(Print 376 8) ; "You'd best stay of sight out this guy!"
			)
			(3 ; Do
				(Print 376 7) ; "Seeing as how these guys are trying to kill you, your best line of defense would be a straight one out of here."
			)
			(4 ; Inventory
				(switch invItem
					(0 ; buckazoid
						(Print 376 9) ; "The Sequel Police are closely monitored by Vohaul. Bribing them would be out of the question."
					)
					(1 ; rope
						(Print 376 10) ; "Even if you were to lasso a Sequel Policeman, what would you do with him?"
					)
					(3 ; rabbit
						(Print 376 11) ; "Ooooo! Don't throw the bunny at Sequel Policeman! He may have a hare trigger. (Sorry!)"
					)
					(4 ; battery
					...
					(9 ; pen
						(Print 376 14) ; "He's gonna SHOOT you, not write you a ticket!"
					)
					(10 ; atmCard
						(Print 376 9) ; "The Sequel Police are closely monitored by Vohaul. Bribing them would be out of the question."
					)
					(else
						(Print 376 15) ; "You'd better not. You might need that later."
					)
				)
			)
			(else
...
(instance screen1 of Prop
	...
	(method (doVerb theVerb invItem)
		(if (or (== theVerb 3) (and (== theVerb 4) (== invItem 0))) ; Do, Inventory, buckazoid
			(cond
				((>= global191 5)
					(Print 376 16) ; "The Ms. Astro Chicken machine looks as though it's taken its last buckazoid and given its last "BACOCK!"."
				)
				(gBuckazoidCount
				...
				(else
					(Print 376 17) ; "You seem to be fresh out of buckazoids. Darn the luck!"
				)
			)
		else
			(switch theVerb
				(11 ; Smell
					(Print 376 18) ; "Gooey, greasy little fingers, and various other types of appendages have left a coating of something that smells like a cross between cotton candy and dead gerbils."
				)
				(10 ; Taste
					(Print 376 19) ; "Auugghh! You had to taste it! This is going to linger for awhile. That coating of something that smells like a cross between cotton candy and dead gerbils tastes more like the latter!"
				)
				(2 ; Look
					(Print 376 20) ; "The sign says "Ms. Astro Chicken". You wonder why nobody is playing it."
				)
				(else
...
(instance screen2 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 21) ; "Your best score on Cap'n Zappo was 251. This kid has... 15,290,912 !?"
			)
			(3 ; Do
				(Print 376 22) ; "Back off. It's not your turn."
			)
			(4 ; Inventory
				(Print 376 22) ; "Back off. It's not your turn."
			)
...
(instance screen3 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 23) ; "The GHETTO BLASTER game is completely socially irredeemable, gratuitously violent, and without a doubt the most popular arcade game EVER!"
			)
			(3 ; Do
				(Print 376 22) ; "Back off. It's not your turn."
			)
...
(instance screen4 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 24) ; "Boy! You'd think after all these years, they'd come up with something more sophisticated than frogs jumping from log to log."
			)
			(3 ; Do
				(Print 376 22) ; "Back off. It's not your turn."
			)
...
(instance screen5 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 25) ; "This SLIME FLYER machine has seen better days. It looks like a leftover from your misspent youth."
			)
			(3 ; Do
				(Print 376 22) ; "Back off. It's not your turn."
			)
...
(instance screen6 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 26) ; "It's some sort of video art form. Looks like a computer-generated fractal simulation of somebody's laundry machine."
			)
			(3 ; Do
				(Print 376 27) ; "That's too high for you to reach."
			)
			(11 ; Smell
				(Print 376 28) ; "That's too high for you to smell."
			)
			(10 ; Taste
				(Print 376 29) ; "That's too high for you to taste."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance screen7 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 30) ; "It's some sort of video art form. Looks like a hand throwing a pizza."
			)
			(3 ; Do
				(Print 376 27) ; "That's too high for you to reach."
			)
			...
			(10 ; Taste
				(Print 376 31) ; "That's too high for you to taste."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance screen10 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 32) ; "This game; "DWEEB HUNTER" reminds you too much of your present predicament. And guess who the dweeb is!"
			)
			(3 ; Do
				(Print 376 22) ; "Back off. It's not your turn."
			)
...
(instance basket of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 33) ; "Gazing at the wastebasket, your impulse - nay, your very instinct - nay, the very fibres of your being - scream out for you to pick up the refuse and empty the basket of its waste. But you're much too busy for that right now."
			)
			(3 ; Do
				(Print 376 34) ; "Resist those inbred custodial tendencies to collect garbage. You have much more important garbage to tend to!"
			)
			(5 ; Talk
				(Print 376 35) ; "You're quite startled to hear the wastebasket respond..."
				(Print 376 36) ; "Max, is that you? Agent 99? I always get these lousy disguises. Would you put a word in with the Chief for me? I wouldn't mind, but all these kids eat is ice cream and candy bars. Do you know how many Big Chewies I've eaten in the last hour? Not to mention the wad of Big Bang BubbleGum I've got stuck to my shoe phone... (sigh!)"
			)
			(11 ; Smell
				(Print 376 37) ; "Give your nose a break! It's a garbage can!"
			)
			(10 ; Taste
				(Print 376 38) ; "A garbage can?!"
			)
			(4 ; Inventory
				(Print 376 39) ; "You'd better not throw that away. It'll probably come in handy later. I know it doesn't seem likely, but trust me on this one."
			)
			(else
...
(instance kid of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 40) ; "Watching this fine youngster brings back fond memories of your youth. Little did you know that all of those hours playing "BLAZIN' PADDLES" were in preparation for being a space-guy-hero-type."
			)
			(3 ; Do
				(Print 376 41) ; "Leave the kid alone. He's totally engrossed in his game."
			)
			(5 ; Talk
				(Print 376 42) ; "Talking to a kid in the middle of an arcade game is almost as interesting as talking to the wall. Give it up."
			)
			(11 ; Smell
				(Print 376 43) ; "Perhaps you haven't been around a young, active being lately. I can tell you that walking up to one and giving it a sniff could be considered unstable and even dangerous behaviour."
			)
			(10 ; Taste
				(Print 376 44) ; "Perhaps you haven't read the nose message."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance changeMachine of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 376 45) ; "The change machine looks like a time machine more than a time machine looks like a time machine... for a change."
			)
			(3 ; Do
				(cond
					((not (gEgo inRect: 116 102 206 124))
						(Print 376 46) ; "You're not close enough to the change machine to touch it."
					)
					((OneOf (gEgo view:) 373 374)
						(Print 376 47) ; "A real lady wouldn't try to break a change machine."
					)
					((and local6 (not (gCurRoom script:)))
						(gCurRoom setScript: changeMachineDeathS)
					)
					(else
						(Print 376 48) ; "Banging on the change machine will only activate its self-defense mechanisms."
						(= local6 1)
					)
				)
			)
			(4 ; Inventory
				(if (== invItem 0) ; buckazoid
					(Print 376 49) ; "In all the known universe, the lowly buckazoid is the lowest denomination of all. You can't get change for it."
				else
					(super doVerb: theVerb invItem)
				)
			)
...
(instance sushiBar of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 376 50) ; "The dead fish in the sushi bar machine appear to have been dead far longer than they were fish. The sushi bar wasn't one of Buckazoid Bill's greatest ideas."
			)
			(3 ; Do
				(Print 376 51) ; "Rocking the sushi bar machine is impossible. It's bolted to the floor."
			)
			(4 ; Inventory
				(if (== invItem 0) ; buckazoid
					(Print 376 52) ; "In all the known universe, the lowly buckazoid is the lowest denomination of all. You can't even get a dead fish for it."
				else
					(super doVerb: theVerb invItem)
				)
			)
			(11 ; Smell
				(Print 376 53) ; "It smells like old dead fish."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance arcadeRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 376 54) ; "As you look around the arcade, you're delighted to see that some of your old favorites are still in operation: MONACO PRINCESS STUNT DRIVIN'; CHOKE 'N CROAK; GHETTO BLASTER; and DWEEB HUNTER. The air is filled with smoke, sweat and ozone, reminding you of your favorite cologne: "Night in Programming.""
			)
			(3 ; Do
				(Print 376 55) ; "Touching anything in here might be dangerous to your health."
			)
			(11 ; Smell
				(Print 376 56) ; "The aroma of the sushi bar dominates the air in here. However, you can also detect the smell of smoke, sweat and ozone, reminding you of your favorite cologne: "Night in Programming.""
			)
			(else
				(super doVerb: theVerb)
			)
