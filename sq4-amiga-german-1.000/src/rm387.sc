...
(procedure (localproc_1 param1 param2 param3 param4 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 [temp11 5])
	...
	(= temp8 14)
	(= temp4 (proc0_18 global130 global130 global130))
...
(instance restoreCode of Code
	...
	(method (doit &tmp [temp0 15] [temp15 5])
		...
		(localproc_1 170 168 184 312)
		(= local6 (proc0_12 387 2 67 170 173 28 global135 29 global129 30 0))
	)
)
...
(instance lettuce of Condiment
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(11 ; Smell
				(Print 387 27) ; "Smells like lettuce."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance bun of Condiment
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(11 ; Smell
				(Print 387 31) ; "Must be PermaBuns. They have no smell."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance burger of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 387 32) ; "Beef at its finest(?)."
			)
			(3 ; Do
				(cond
					((== (lettuce followWho:) 1)
			...
			(10 ; Taste
				(Print 387 33) ; "Hey! This belongs to someone else!"
			)
			(11 ; Smell
				(Print 387 34) ; "There's that Monolith Burgers Secret Smell(tm)."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance grabber of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 387 35) ; "BurgerMation Grabitron unit."
			)
			(10 ; Taste
				(Print 387 36) ; "That's a good way to put your tongue out, buddy."
			)
			(11 ; Smell
				(Print 387 37) ; "Smells greasy."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance rejectSign of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 387 38) ; "If this is flashing, you've just blown it."
			)
			(10 ; Taste
				(Print 387 39) ; "It tastes greasy."
			)
			(11 ; Smell
				(Print 387 40) ; "It smells greasy."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance belt of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 387 41) ; "This conveys the burgers from the nucleo-carbonic cooking chamber to you for construction and then on to the box grabber for transport out to the customer, or rejection if you've blown it."
			)
			(10 ; Taste
				(Print 387 42) ; "Essence of Monolith Burger now coats your tongue - forever!"
			)
			(11 ; Smell
				(Print 387 43) ; "It smells like the essence of Monolith Burger."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance topCounter of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 387 44) ; "It's more unimportant counter space."
			)
			(10 ; Taste
				(Print 387 45) ; "You must be bored. Maybe we should turn up the speed."
			)
			(11 ; Smell
				(Print 387 45) ; "You must be bored. Maybe we should turn up the speed."
			)
...
(instance upperPipes of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 387 46) ; "More pipes"
			)
			(10 ; Taste
				(Print 387 47) ; "Don't mess with it."
			)
			(11 ; Smell
				(Print 387 48) ; "Smells like a pipe!"
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance redTube of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 387 49) ; "It's red tubing. You have no idea what it does."
			)
			(10 ; Taste
				(Print 387 50) ; "Don't mess with it."
			)
			(11 ; Smell
				(Print 387 51) ; "Smells like a pipe!"
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance hood of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 387 53) ; "This sucks most of the noxious gases from the room."
			)
			(10 ; Taste
				(Print 387 54) ; "It definitely hasn't been cleaned in awhile. Maybe later when you get time you could give it a buff."
			)
			(11 ; Smell
				(Print 387 55) ; "It smells likes escaping air."
			)
			(else
				(super doVerb: theVerb invItem)
			)
