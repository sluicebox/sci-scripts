...
(instance flashScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGlobalAudio number: 8875 loop: 1 play: self)
			)
			(1
				(gGlobalAudio number: 8876 loop: -1 play:)
			...
			(4
				...
				(glow3a init:)
				(gGlobalAudio number: 8869 loop: 1 play:)
			)
			(5
				(if (> (++ local54) 1)
					(= cycles 1)
			...
			(6
				...
				(gGlobalAudio number: 8871 loop: 1 play:)
			)
			(7
				(glow2 dispose:)
			...
			(16
				(gGlobalAudio number: 8877 loop: 1 play:)
				(glow0 dispose:)
				(glow1 dispose:)
				(= seconds 1)
			)
			...
			(18
				(gGlobalAudio number: 8865 loop: -1 playBed:)
				(glow9 dispose:)
				(glow10 dispose:)
				(glow11 dispose:)
				(glow12 dispose:)
