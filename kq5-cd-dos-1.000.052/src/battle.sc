	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(global388 setCycle: MouthSync 918)
				(Say 918 self)
			)
			(6
				(global388 setCycle: 0 setCel: 0)
				(= seconds 4)
			)
			(7
			...
			(11
				...
				(gGlobalAudio number: 8138 loop: 1 play:)
			)
			(12
				(gMordObj
					view: 714
				...
				(if (IsFlag 55)
					...
					(gGlobalAudio number: 8897 loop: 1 play:)
				)
			)
			(13
				(if (IsFlag 55)
...
(instance stingScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(localproc_1)
				(gGame setCursor: gNormalCursor yourself:)
				(= seconds 10)
			)
			(6
				(HandsOff)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				...
				(gGlobalAudio number: 8200 loop: 1 play:)
			...
			(14
				...
				(global388 setCycle: MouthSync 923)
				(Say 923 0 1)
				(= seconds 10)
			)
			(15
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(21
				...
				(gEgo cycleSpeed: 0)
				(if (== gHowFast 0)
					(gCurRoom newRoom: 612) ; endingSlide
				else
								...
								(for
									...
									(cond
										...
										(
											...
											(gInventory disable: temp1)
										)
									)
								)
								(gInventory
									heading: {Select spell to cast}
									showScore: 0
								)
