...
(instance rm047 of KQ5Room
	...
	(method (init)
		...
		(if (not (IsFlag 107))
			...
			(gGlobalAudio number: 7057 doNotStop: 1 loop: -1 play:)
		)
		(LoadMany rsVIEW 259)
		(switch gPrevRoomNum
			(45
...
(instance drownHim of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gGlobalAudio number: 7056 loop: 1 play: self)
...
(instance killEgo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(HandsOff)
				(gGlobalAudio number: 7069 loop: 1 play:)
				(seaMonsterHead
					loop: (+ 4 register)
					cel: 0
					x: (seaMonster x:)
			...
			(6
				...
				(gGlobalAudio number: 7070 loop: 1 play:)
