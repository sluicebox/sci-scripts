...
(instance rm605 of Room
	...
	(method (init)
		...
		(gEgo
			...
			setScaler: Scaler 100 72 140 116
			init:
			normalize: 9797
			origStep: 1539
		)
...
(instance soundScript of Script ; UNUSED
	(properties)
		...
		(switch theVerb
			(20 ; wallet
				(if (gPqFlags test: 102)
					...
					(gMessager say: 5 20 13 0) ; "I... I'm n... not selling tickets yet. We... we're not ooo... open."
				)
			)
			(29 ; coins
				(if (gPqFlags test: 102)
					...
					(gMessager say: 5 29 13 0) ; "Wa... we're not o... open yet. Be... besides a... a ticket is tw... two-fifty."
				)
			)
			(27 ; badge
				(if (gPqPointFlags test: 31)
					(gMessager say: 5 27 3 0) ; "You've already identified yourself, No need to do so again."
				else
					(gGame points: 2 31)
...
(instance shootScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				((ScriptID 32 0) doit: 5 22 22 0 605 0 shootScript) ; ShootHandgun
			)
			(1
				(gGame handsOn:)
				(self dispose:)
...
(instance showBadge of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				((ScriptID 38 1) init: self 9797) ; BadgeIn
			)
			(4
				(= cycles 2)
			)
...
(instance lPrograms of Feature
	...
	(method (doVerb theVerb)
		(if (< gDay 5)
			(gMessager say: 6 0 20 0) ; "The date on these reads March 4, 1989. They're old, they won't do you any good."
		else
			(switch theVerb
				(1 ; Look
					(if (gCast contains: mitchell)
						(if (not global136)
							(gMessager say: 6 1 16 0) ; "Weather-worn movie programs. They look like they've been out here a long time."
						else
			...
			(4 ; Do
				(cond
					((or (gPqFlags test: 101) (< gDay 5))
						(gMessager say: 0 4 4 0) ; "It appears the theater is closed. The doors are locked."
					)
			...
			(5
				(cond
					...
					(
						...
						(gMessager say: 0 4 4 0 self) ; "It appears the theater is closed. The doors are locked."
					)
					((or local1 (gPqFlags test: 101) (< gDay 5))
						(gMessager say: 0 4 4 0 self) ; "It appears the theater is closed. The doors are locked."
					)
