...
(instance records of Feature
	...
	(method (init)
		(self
			createPoly: 0 153 0 113 40 110 41 101 79 100 115 106 115 100 142 100 166 102 167 109 206 120 208 135 228 143 229 153
		)
		(super init: &rest)
	)
)
...
(instance rightCounter of Feature
	...
	(method (init)
		(self
			createPoly: 230 96 229 144 209 135 207 119 168 109 167 101 141 100 206 93
		)
		(super init: &rest)
	)
)
...
(instance theWindow of Feature
	...
	(method (init)
		(self
			createPoly: 158 10 255 10 252 152 229 146 231 96 148 99 147 24 159 23
		)
		(super init: &rest)
	)
)
...
(instance man of Feature
	...
	(method (init)
		(self
			createPoly: 144 81 145 72 157 64 161 53 165 53 172 59 168 70 180 85 203 94 202 97 164 97 162 80
		)
		(super init: &rest)
	)
...
(instance raginLogo of Feature
	...
	(method (init)
		(self
			createPoly: 98 16 106 19 112 19 112 30 106 30 94 37 81 38 75 33 67 34 68 23 75 23 86 16 93 16
		)
		(super init: &rest)
	)
)
