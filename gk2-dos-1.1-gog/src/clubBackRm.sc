...
(instance fPlant of GKFeature
	...
	(method (init)
		(self
			createPoly: 416 323 410 273 421 252 397 233 386 213 406 193 397 177 397 153 426 126 443 92 449 83 445 65 471 41 487 48 493 62 492 86 486 98 500 122 495 133 522 145 512 163 521 173 506 193 507 222 469 239 455 251 472 275 466 324 454 332 436 333
		)
		(super init: &rest)
	)
		...
		(switch theVerb
			...
			(39 ; invXaverKeys
				(if (IsFlag 527)
					...
					(SetFlag 527)
					(PlayScene 329)
					(gEgo posn: 350 300 heading: 315 normalize:)
				)
			)
			(else
