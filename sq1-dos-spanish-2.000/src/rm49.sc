...
(instance openingScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(EgoDead 1 3 2 49 1) ; "In the face of danger you decide to turn and run, leaving Xenon and the rest of the universe to fend for themselves against those bad boys of the universe, the Sariens. When things get tough, the cream rises to the top. I guess you know which stratum you occupy."
				(self dispose:)
			)
		)
	)
