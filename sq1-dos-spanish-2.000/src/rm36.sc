...
(procedure (localproc_2)
	(if
		(= local7
			(Print 36 0 #button { Play } 0 #button { Skip } 1) ; "This section is an Arcade sequence. Would you like to Play or Skip this sequence."
		)
		(= local10 (= local11 100))
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(damageGauge
					init:
					view: (proc0_19 136 1136 136 136 136)
					stopUpd:
				)
				(HandsOn)
				(= local6 1)
