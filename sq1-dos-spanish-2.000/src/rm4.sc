...
(instance rm4 of SQRoom
	...
	(method (init &tmp [temp0 90])
		(LoadMany rsVIEW (proc0_19 104 1104 104 104 104) 4 400)
		(Load rsSOUND 311)
		...
		(alertSign view: (proc0_19 104 1104 104 104 104) init: setCycle: Fwd)
		(switch gPrevRoomNum
			(3
				(= style 12)
			)
			...
			(else
				...
				(alertSign
					view: (proc0_19 104 1104 104 104 104)
					cel: 0
					setCycle: 0
				)
	...
	(method (doit)
		...
		(cond
			...
			((and (& (gEgo onControl: 0) $0002) (not local1))
				(= local1 1)
			)
			(
				(and
					(gEgo inRect: 50 40 150 99)
...
(instance beginGame of Script
	...
	(method (changeState newState &tmp [temp0 150])
		(switch (= state newState)
			...
			(7
				(Format @temp0 4 4 (/ global172 60) (/ global172 60)) ; "You hear the overly cheerful voice of the ship's computer say: "Destruct sequence is engaged! %d minutes till detonation.""
