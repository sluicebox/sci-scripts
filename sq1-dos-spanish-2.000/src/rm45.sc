...
(instance mugger of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print
					{That's not possible from up here.}
				)
			)
			(5 ; Talk
				(Print
		...
		(switch theVerb
			(3 ; Do
				(if (IsFlag 26)
					...
					(Print 45 18) ; "There's a saying in these parts: "You don't touch a ship that isn't yours, you don't die.""
				)
			)
			(else
				(super doVerb: theVerb &rest)
...
(instance radar1 of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 45 19) ; "I wouldn't mess with them if I were you."
			)
			(5 ; Talk
				(Print 45 20) ; "No answer is forthcoming."
			)
			(12 ; Smell
				(Print 45 19) ; "I wouldn't mess with them if I were you."
			)
			(11 ; Taste
				(Print 45 21) ; "I wouldn't mess with them if I were you."
			)
			(else
				(super doVerb: theVerb invItem)
			)
