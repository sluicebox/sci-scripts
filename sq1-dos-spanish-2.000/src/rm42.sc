		...
		(switch (= state newState)
			...
			(6
				(if (>= global176 3)
					...
					(Printf 42 5 temp0 temp0) ; "Searching through the pile of dust, you find %u buckazoids!"
				else
...
(instance egoGivesMoney of Script
	...
	(method (changeState newState &tmp [temp0 160])
		(switch (= state newState)
			(0
				(ClearFlag 40)
				(SetFlag 41)
			...
			(2
				(muggerTalker
					say: (Format @temp0 42 8 gBuckazoidCount gBuckazoidCount) 0 0 0 self ; "%d buckazoids? I guess it's better than nothing. Here, keep five for yourself. I gotta admit you look like you need it."
				)
			)
			(3
