...
(instance egoGivesMoney of Script
	...
	(method (changeState newState &tmp [temp0 160])
		(switch (= state newState)
			...
			(2
				(muggerTalker
					say: (Format @temp0 42 8 global165 global165) 0 0 0 self ; "%d buckazoids? I guess it's better than nothing. Here, keep five for yourself. I gotta admit you look like you need it."
				)
			)
			(3
