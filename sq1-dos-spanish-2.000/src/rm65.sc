...
(class PadButton of Prop
	...
	(method (init param1)
		(self view: (proc0_19 165 1165 165 165 165))
		(super init:)
		(self setPri: 0)
		(= theString param1)
	...
	(method (flash)
		...
		(if strToCat
			...
			(= local5
				(Display theString dsCOORD 196 42 dsCOLOR global142 dsALIGN alLEFT dsFONT 2 dsSAVEPIXELS)
			)
		)
	)
)
		...
		(switch (= state newState)
			(0
				(if register
					...
					(= local5
						(Display 65 2 dsCOORD 100 42 dsCOLOR global136 dsALIGN alLEFT dsFONT 2 dsSAVEPIXELS) ; "Self Destruct Engaged"
					)
					(SetScore 10 172)
				else
					(gLongSong2 number: 521 loop: 1 play:)
					(= local5
						(Display 65 3 dsCOORD 100 42 dsCOLOR global136 dsALIGN alLEFT dsFONT 2 dsSAVEPIXELS) ; "Invalid Code Entered"
					)
				)
				(= cycles 15)
			)
			...
			(3
				(if register
					...
					(= local5
						(Display 65 4 dsCOORD 100 42 dsCOLOR global136 dsALIGN alLEFT dsFONT 2 dsSAVEPIXELS) ; "Have a nice day"
					)
					(= cycles 15)
				else
					(self dispose:)
