...
(instance viewGoals of Dialog
	...
	(method (init &tmp temp0 temp1 temp2)
		...
		(playerNumber1 cel: (((ScriptID 1 2) at: 0) whatNum:)) ; players
		(if (> ((ScriptID 1 2) size:) 1) ; players
			(self add: therm2 fineTherm2 playerNumber2 percent2)
			(playerNumber2 cel: (((ScriptID 1 2) at: 1) whatNum:)) ; players
		...
		(if (> ((ScriptID 1 2) size:) 2) ; players
			...
			(playerNumber3 cel: (((ScriptID 1 2) at: 2) whatNum:)) ; players
		...
		(if (> ((ScriptID 1 2) size:) 3) ; players
			...
			(playerNumber4 cel: (((ScriptID 1 2) at: 3) whatNum:)) ; players
		...
		(switch ((ScriptID 1 2) size:) ; players
			...
			(2
				...
				(if (((ScriptID 1 2) at: 1) playJones:) ; players
					(playerNumber2 cel: 4)
				)
			)
			(3
