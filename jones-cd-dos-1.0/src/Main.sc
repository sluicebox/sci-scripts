...
(procedure (proc0_18 param1 param2 param3)
	(DoAudio audWPLAY param1)
	(if (and (>= argc 2) param2)
		(param2 cel: 0 init: 16 MouthSync param1 (if (>= argc 3) param3 else 0))
	)
...
(instance aSoundEffect2 of Sound
	(properties
		number 6
		priority 2
		owner -1
