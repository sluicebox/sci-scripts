...
(class Place of Obj
	...
	(method (handleEvent event)
		(if (and global502 (& (event type:) evKEYBOARD))
			(SetCursor gTheCursor 1 160 100)
		)
		(if
			(and
				(not (event claimed:))
				...
				(or
					...
					(and (not global502) (& (event type:) evKEYBOARD))
				)
...
(instance players of List
	...
	(method (init &tmp temp0)
		...
		(for ((= temp0 0)) (<= temp0 (- size 1)) ((++ temp0))
			((players at: temp0) whatNum: temp0)
			(if (== ((players at: temp0) playing:) 29)
				((players at: temp0) whatNum: 4)
			)
		)
	...
	(method (doit &tmp temp0 temp1 temp2 temp3 [temp4 10])
		(if global448
			(= global448 0)
			(global302 playing: 3)
		else
...
(instance marble of Act
	...
	(method (cue &tmp temp0 temp1 temp2 temp3)
		...
		(gTheWalker forceUpd:)
		(proc0_16 (global302 whichBody:))
		(number1 cel: (global302 whatNum:) addToPic:)
		(number2 cel: (global302 whatNum:) addToPic:)
		(number3 cel: (global302 whatNum:) addToPic:)
		(number4 cel: (global302 whatNum:) addToPic:)
		(proc0_1)
		(Display
			(Format @global100 1 2 global372) ; "Week #%2d"
			dsCOLOR
			0
			dsBACKGROUND
...
(instance calc of DIcon
	...
	(method (doit &tmp [temp0 7] temp7)
		(if (or (!= value (global302 cash:)) (!= global456 (global302 cashHi:)))
			...
			(Display
				(Format @temp0 1 3 (proc115_0 global456 value)) ; "%6s"
				dsCOORD
				(+ nsLeft 22)
				(+ nsTop 6)
				dsCOLOR
