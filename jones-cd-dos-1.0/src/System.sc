...
(class Event of Obj
	...
	(method (new mask &tmp temp0 temp1)
		...
		(if (or (& (temp0 type:) $0002) (& (temp0 type:) $0001))
			(= global447 0)
		)
		(if (or (& (temp0 type:) $0004) (& (temp0 type:) $0040))
			(= global447 1)
		)
		(return temp0)
	)
...
(class Timer of Obj
	...
	(method (init caller)
		(= client caller)
		(gTimers add: self)
		(if (and (IsObject caller) (caller respondsTo: #timer))
