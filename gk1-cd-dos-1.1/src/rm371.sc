...
(instance rm371 of Room
	...
	(method (init)
		...
		(cond
			...
			((== gDay 2)
				(gCurRoom setScript: dayOneAVI)
			)
			((== gDay 3)
				(gCurRoom setScript: dayTwoAVI)
			)
			((== gDay 6)
				(gCurRoom setScript: dayFiveAVI)
			)
		)
