...
(instance startOfDay3 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(16
				(gEgo setCel: 0 setLoop: 1 setCycle: CT 2 1 self)
			)
			(17
...
(instance getTheDrumBook of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(100
				(if (gKeyDownHandler contains: getTheVeve)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(UpdateScreenItem (ScriptID 210 14)) ; maliasNote
				(if (IsFlag 389)
					(gEgo normalize: 1 901)
					(self dispose:)
				else
			...
			(6
				(gGkMusic2 number: 299 setLoop: 1 play:)
				(ClearFlag 409)
