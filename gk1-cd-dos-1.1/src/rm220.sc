...
(instance doTheTattoo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(gMessager sayRange: 23 0 32 1 3 self) ; "(GETTING READY TO DO TATTOO ON HIS CHEST. BUSINESS-LIKE.)All right. Let's go. The shirt please."
			)
			(5
			...
			(10
				...
				(= local4 0)
				(gEgo hide:)
				(gGkSound1 number: 221 setLoop: 1 play:)
				(grace
					view: 2202
					setCel: 0
					setLoop: 1
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				(SetFlag 352)
				(gEgo normalize: 1 901 posn: 107 124)
				(gGame handsOn:)
				(gGame setCursor: local7 1)
				(gTheIconBar curIcon: local8)
				(self dispose:)
			)
		)
	)
...
(instance getTheFlashLight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gGame handsOff:)
				(gEgo setMotion: PolyPath 221 113 self)
			)
			(2
