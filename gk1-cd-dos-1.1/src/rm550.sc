...
(instance doTheDream of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(25
				(fire setCycle: Fwd)
				(gGkSound1 number: 555 setLoop: -1 flags: 5 play:)
			...
			(50
				(egoFace cycleSpeed: 20 setCycle: End)
				(gGkSound1 number: 553 setLoop: 1 play: self)
