	...
	(method (doit)
		...
		(if local7
			...
			(switch local8
				...
				(17
					(firstName setLoop: 6 cel: 2)
					(lastName setLoop: 6 cel: 4)
					(localproc_0 2 self)
				)
				(21
					(Title1 setLoop: 2 cel: 2)
					(Title2 setLoop: 1 cel: 3 show:)
					(firstName setLoop: 6 cel: 2)
					(lastName setLoop: 6 cel: 4)
					(localproc_0 2 self)
				)
