				...
				(if (== (cardList size:) 20)
					...
					(switch cardsTaken
						(1
							...
							(proc0_4 380 playerNum)
						)
						(2
							((self altrEgo:) upset: 1)
							(proc0_4 381 playerNum)
						)
						(3
							((self altrEgo:) shock: 1)
							(proc0_4 378 playerNum)
						)
						(else
			...
			(13
				...
				(if global509
					(if (!= global509 gPlayer0)
						...
						(proc0_3 17 1)
						(proc0_4 384 (global509 playerNum:))
						(gIntroSong number: 27 play:)
					)
					(gPlayerList eachElementDo: #gamePoints 0)
					(= global509 0)
