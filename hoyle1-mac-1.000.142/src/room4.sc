...
(instance cardRoom of CardRoom
	...
	(method (init &tmp temp0)
		...
		(AddMenu { Gin Rummy } {Rules `#0:Game Limit [now 0] `#0})
		(MenuBar draw:)
		(SetMenu 1538 110 (Format @local20 {Game Limit [now %3d]} global511))
					...
					(if (== global426 player0)
						(cond
							((> (global426 bestDeadWood:) 10)
								...
								(Print
									(Format @temp1 4 3 (global426 bestDeadWood:)) ; "Illegal Knock of %d"
									#at
									90
									120
								)
							...
							((global426 bestDeadWood:)
								(Print
									(Format @temp1 4 4 (global426 bestDeadWood:)) ; "KNOCKING with %d"
									#at
									95
									120
								)
							...
							(else
								(Print (Format @temp1 4 5) #at 134 120) ; "G I N !"
