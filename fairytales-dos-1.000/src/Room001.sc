...
(procedure (localproc_1)
	(Display @global110 dsCOORD 120 0 dsFONT gUserFont dsCOLOR 14)
	(= local0 (proc10_24 gUserFont @global110))
	(Graph grDRAW_LINE 13 120 13 (+ local0 120) 64 -1 -1)
...
(instance alphabet of GameControls
	...
	(method (init &tmp temp0 temp1 temp2 temp3 temp4)
		...
		(self add: iconBack iconForward iconOk)
		(super init: &rest)
...
(instance iconBack of CodeIcon
	...
	(method (select)
		(if (super select: &rest)
			(Graph grDRAW_LINE 13 120 13 230 36 -1 -1)
