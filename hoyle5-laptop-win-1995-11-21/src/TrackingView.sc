...
(class HoyleTrackingView of TrackingView
	(properties
		disabled 0
	)
...
(class DragableActor of Actor
	...
	(method (track &tmp temp0 temp1 temp2 [temp3 2] temp5 temp6)
		...
		(temp2 dispose:)
		(if (!= gCardGameScriptNumber 1200)
			(self setPri: global291)
		)
		(proc0_9 (gAniList elements:) 0)
		(gAniList release:)
		(return temp5)
	...
	(method (dim param1)
		...
		(if
			...
			(self view: prevView cel: prevCel signal: prevSignal)
		)
	)
