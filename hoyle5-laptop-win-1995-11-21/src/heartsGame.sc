...
(class HeartsHand of Hand
	...
	(method (makeSuitList param1 param2 &tmp temp0 temp1 temp2 temp3 temp4)
		...
		(for ((= temp0 2)) (<= temp0 14) ((++ temp0))
			(for ((= temp1 0)) (< temp1 size) ((++ temp1))
				(if
					...
					(= temp3 ((self at: temp1) x:))
					(= temp4 ((self at: temp1) y:))
					(temp2 add: (self at: temp1) 0 0 self)
					((temp2 at: (- (temp2 size:) 1)) x: temp3)
					((temp2 at: (- (temp2 size:) 1)) y: temp4)
					(break)
				)
			)
		)
	...
	(method (changeState newState &tmp [temp0 2] temp2 [temp3 3])
		(switch (= state newState)
			...
			(11
				...
				(if (hand1 passTo:)
					(if (Random 0 1)
						(Characters sayPN: 1000 2 82 0 (Random 1 5) 718 1 self)
					else
						(Characters sayPN: 1000 2 83 0 (Random 1 5) 720 1 self)
					)
				else
					(= cycles 1)
				)
			...
			(16
				(for ((= temp2 0)) (< temp2 (global117 size:)) ((++ temp2))
					(if (== ((global117 at: temp2) tempTotal:) 26)
						...
						(if (== ((global117 at: temp2) type:) 0)
							(Characters
								sayPN: 1000 2 83 0 (Random 1 5) 720 1 self
							)
						else
							(Characters
								sayPN: 1000 2 82 0 (Random 1 5) 718 1 self
							)
						)
						(= temp2 10)
					)
			...
			(17
				...
				(cond
					(
						...
						(gChar1 sayPN: 1000 2 82 0 (Random 1 5) 718 1 self)
					)
					(
						(or
							(== (hand3 tempTotal:) 0)
						...
						(gChar2 sayPN: 1000 2 82 0 (Random 1 5) 718 1 self)
					)
					(
						(or
							(== (hand4 tempTotal:) 0)
						...
						(gChar3 sayPN: 1000 2 82 0 (Random 1 5) 718 1 self)
					)
					(else
						(= cycles 1)
					)
