		...
		(cond
			(global111
				...
				(if local3
					...
					(= temp3 [local37 0])
					(+= temp2 [local28 0])
					(proc0_10 480 1 0 158 25 15 ginRummyScoreWindow)
					(if (not [local37 0])
						(*= temp2 2)
						(localproc_0 (/ temp2 2) 233 75 1)
						(localproc_0 0 313 75 1)
					)
				else
					(= temp2 [local28 0])
					...
					(if (not [local28 0])
						(*= temp3 2)
						(localproc_0 (/ temp3 2) 313 75 1)
						(localproc_0 0 233 75 1)
					)
				)
				(cond
					((> temp1 0)
						(localproc_0 temp1 233 99 1)
						(localproc_0 0 313 99 1)
						(+= temp2 temp1)
					)
					((< temp1 0)
						(localproc_0 (* temp1 -1) 313 99 1)
						(localproc_0 0 233 99 1)
						(+= temp3 (* temp1 -1))
					)
					(else
						(localproc_0 0 233 99 1)
				...
				(localproc_0 temp2 233 147 1)
				(localproc_0 temp3 313 147 1)
				(if local3
					(localproc_0 100 233 123 1)
					(localproc_0 0 313 123 1)
					(localproc_0 [local28 0] 233 51 1)
					(localproc_0 [local37 0] 313 51 1)
					(localproc_0 (- temp2 temp3) 233 171 1)
				else
					(localproc_0 0 233 123 1)
					(localproc_0 100 313 123 1)
					(localproc_0 [local28 0] 233 51 1)
					(localproc_0 [local37 0] 313 51 1)
					(localproc_0 (- temp3 temp2) 313 171 1)
				)
				(proc0_10 480 7 0 238 140 15 ginRummyScoreWindow)
				(proc0_10 480 7 0 316 140 15 ginRummyScoreWindow)
				(proc0_10 480 7 0 238 168 15 ginRummyScoreWindow)
				(proc0_10 480 7 0 316 168 15 ginRummyScoreWindow)
				(= local1 0)
				(= local2 0)
				(= [local28 8] 0)
				(= [local28 7] 0)
			...
			(global244
				...
				(= local8 4)
				(localproc_0 local2 230 92 1)
				(localproc_0 local1 310 92 1)
				(= local8 8)
				(cond
					(local5
						(if (and (== gGinRummyOptionIsVariant 1) local9)
							(localproc_0 (- local6 50) 170 115 1)
							(localproc_0 50 170 138)
						else
							(localproc_0 (- local6 25) 170 115 1)
							(localproc_0 25 170 138)
						)
						(proc0_10 480 2 1 106 137 15 ginRummyScoreWindow)
					...
					((not local4)
						...
						(proc0_10 480 2 2 110 137 15 ginRummyScoreWindow)
						(localproc_0 local6 170 169 1)
					)
					(else
						(localproc_0 local6 170 115 1)
						(localproc_0 0 170 138 1)
						(localproc_0 local6 170 169 1)
					)
				)
			)
			(else
				...
				(= temp5 local8)
				(= local8 4)
				(localproc_0 local2 230 170 1)
				(localproc_0 local1 310 170 1)
				(= local8 temp5)
			)
		)
	)
