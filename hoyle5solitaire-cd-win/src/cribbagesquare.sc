...
(procedure (localproc_1 &tmp temp0 temp1 temp2)
	...
	(for ((= temp0 0)) (< temp0 4) ((++ temp0))
		(for ((= temp1 0)) (< temp1 4) ((++ temp1))
			...
			(if
				(and
					(not local18)
					(== (((gTheHands at: (- temp2 1)) at: 0) rank:) 11)
					(== (((gTheHands at: (- temp2 1)) at: 0) suit:) local13)
				)
				(+= global928 1)
			)
		)
		(if (not local18)
			(tempList add: local14)
		)
		(KList 22 (tempList elements:) 792 1) ; Sort
	...
	(for ((= temp0 0)) (< temp0 4) ((++ temp0))
		...
		(for ((= temp1 0)) (< temp1 4) ((++ temp1))
			(+= temp2 4)
			(tempList add: ((gTheHands at: (- temp2 4)) at: 0))
		)
		(if (not local18)
			(tempList add: local14)
		)
...
(procedure (localproc_2 param1)
	(++ local2)
	(+= global928 (localproc_3 param1))
	(localproc_4 param1)
	(+= global928 (localproc_5 param1))
)

(procedure (localproc_3 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9)
	(= temp8 0)
	(= temp2 1)
	(= temp3 0)
	(= temp4 1)
	...
	(for ((= temp1 1)) (< temp1 temp9) ((++ temp1))
		(cond
			((== ((param1 at: temp1) rank:) (- temp0 1))
				(++ temp6)
				(if (and (> temp4 1) (== temp5 0))
					(= temp5 1)
				)
				(if (and (== temp6 3) (== temp4 3))
					(= temp2 3)
				)
				(if (and (== temp6 3) (== temp4 2) (== temp8 0))
					(= temp2 2)
				)
				(if (and (== temp6 3) (== temp4 2) (== temp5 2))
					(= temp2 4)
				)
			)
	...
	(if (or (and (== temp4 2) (== temp5 3)) (and (== temp4 3) (== temp5 2)))
		(return 8)
	)
	(if (== temp4 3)
		(return 6)
	)
	(if (and (== temp4 2) (== temp5 2))
		(return 4)
	)
	(if (== temp4 2)
		(return 2)
...
(procedure (localproc_4 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9)
	(= temp0 (localproc_6 (param1 at: 0)))
	(= temp3 0)
	(= temp1 0)
	(= temp2 1)
	(= temp4 0)
	...
	(while (< temp3 temp9)
		(for ((= temp1 temp2)) (< temp1 temp8) ((++ temp1))
			(cond
				((< (+ temp0 (localproc_6 (param1 at: temp1))) 15)
					(if (!= temp1 temp9)
						(+= temp0 (localproc_6 (param1 at: temp1)))
						(if (and temp5 (not temp6))
							(= temp6 (+ temp1 1))
						)
						(if (== temp5 0)
							(= temp5 (+ temp1 1))
		...
		(if (and temp6 (< temp6 4))
			(= temp4 temp5)
			(= temp0 0)
			(for ((= temp1 0)) (< temp1 temp4) ((++ temp1))
				(+= temp0 (localproc_6 (param1 at: temp1)))
			)
			(+= temp0 (localproc_6 (param1 at: temp6)))
			(= temp2 (+ temp6 1))
			(= temp7 temp6)
			(= temp6 0)
			(continue)
		...
		(if (and temp5 temp6)
			(= temp0
				(+
					(= temp0
						(-
							(-= temp0 (localproc_6 (param1 at: (- temp5 1))))
							(localproc_6 (param1 at: (- temp6 1)))
						)
					)
					(localproc_6 (param1 at: temp5))
				)
			)
			(= temp2 (+ temp5 1))
			(= temp5 0)
		...
		(if temp5
			...
			(= temp2 (+ (++ temp3) 1))
			(= temp0 (localproc_6 (param1 at: temp3)))
			(= temp5 0)
			(= temp6 0)
		)
	)
...
(procedure (localproc_5 param1 &tmp temp0 temp1)
	...
	(if (and (== temp1 local13) (not local18))
		(return 5)
	else
		(return 4)
	)
...
(procedure (proc6028_4 param1) ; UNUSED
	(if argc
		(= local11 param1)
	else
		(return local11)
...
(instance cribbagesquare of HoyleRoom
	(properties
		style 14
	)
		...
		(cond
			((and argc (== param1 3))
				(if (self open: 2)
					...
					(self
						writeString:
							(temp0 format: {%d%d%4d} local11 global927 local15)
						close:
					)
					(temp0 dispose:)
					(return 1)
...
(instance roomScript of Script
	...
	(method (doit &tmp temp0 temp1 temp2 temp3 [temp4 2] temp6 [temp7 4])
		...
		(if global525
			...
			(proc6022_6 local15 90 20 1 {high} highScoreWindow)
		)
		...
		(if (not local12)
			...
			(for ((= temp2 0)) (< temp2 4) ((++ temp2))
				...
				(for ((= temp1 0)) (< temp1 4) ((++ temp1))
					(+= temp3 4)
					(if ((gTheHands at: (- temp3 4)) size:)
						(tempList add: ((gTheHands at: (- temp3 4)) at: 0))
					)
				)
				(cond
					((== (tempList size:) 4)
			...
			(if (!= local20 local19)
				(proc6022_7 {score} highScoreWindow)
				(proc6022_6 local19 90 4 1 {score} highScoreWindow)
				(= local20 local19)
			)
		)
	)
...
(instance highScoreWindow of InvisibleWindow
	...
	(method (init &tmp [temp0 2])
		...
		(proc6022_6 local19 90 4 1 {score} self)
		(proc6022_6 local15 90 20 1 {high} self)
	)
)
