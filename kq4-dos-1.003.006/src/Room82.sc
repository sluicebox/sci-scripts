						...
						(cond
							...
							((Said 'awaken/lolotte,fairies')
								(if global169
									...
									(Print 82 19 #font gSmallFont #at 15 20 #time 4) ; "Waking the dead is a little more than even a princess can do!"
								)
							)
...
(instance lolotteDead of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Print 82 51 #font gSmallFont #width 135 #at 2 20) ; "Lolotte sits straight up in bed, a look of agony upon her face. "What did you do to me?!" she shrieks. "I'm melting...melting!" No, wait! That's another story. Ahem! Let's try again."
				(Print 82 52 #font gSmallFont #width 135 #at 2 20) ; "It hurts! It hurts! Stop the pain! Stop it!"
				(local2
					loop: 2
					cel: 0
					show:
			...
			(3
				(Print 82 53 #at -1 20 #font gSmallFont #width 250) ; "You cringe as you watch the evil fairy die a painful death. What happened?, you wonder. How could Cupid's arrow have done that? You thought that those arrows were harmless, and contained only LOVE."
				(local0 loop: 1 cel: 0 cycleSpeed: 3 setCycle: End self)
			)
			(4
				(Print 82 54 #at -1 20 #width 250 #font gSmallFont) ; "Wait! That must be it! LOVE! Lolotte was so evil that when all that pure love entered her body, it acted as a poison to her system! In spite of yourself, you feel a sense of sweet revenge."
				((= local1 (View new:))
					view: 123
					loop: 3
					posn: 172 91
				...
				(Print 82 55 #at -1 20 #font gSmallFont #width 250) ; "As she breathes her last, Lolotte manages to gasp, "I don't know how...but I'll get you for this...""
				(gGame changeScore: 8)
				(local0 stopUpd:)
				(= global169 0)
				(if (< global160 30)
			...
			(5
				(Print 82 56 #at -1 20 #font gSmallFont) ; "A bright, new day is dawning!"
...
(instance shootLolotte of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Print 82 57 #at -1 20 #font gSmallFont) ; "You aim the golden arrow toward Lolotte. You let go of the bow string. ZING! A direct hit!"
				(= seconds 1)
			)
			(2
...
(instance egoZapped of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 82 58 #at 15 15 #font gSmallFont) ; "You stupidly wake Lolotte up! "VIPER!" she screams, as she quickly sits up, points a gnarled finger at you, and zaps you into oblivion!"
