...
(instance Room47 of Rm
	...
	(method (init)
		...
		(if (or (== gPrevRoomNum 37) (== gPrevRoomNum 0))
			(gEgo posn: 156 176 view: 4 xStep: 4 yStep: 2 init:)
		)
		(if (== gPrevRoomNum 46)
			(gEgo posn: 72 141 view: 4 xStep: 4 yStep: 2 init:)
		)
		((View new:) view: 632 loop: 0 cel: 3 posn: 38 105 setPri: 14 addToPic:)
		((View new:)
			view: 632
			loop: 0
			cel: 4
