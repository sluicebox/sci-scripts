...
(instance nightWin of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(4 ; Inventory
				(Print 19 9) ; "That won't get you anywhere."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance briefWindow of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 10) ; "The window is in the Vice Office."
			)
			(3 ; Do
				(Print 19 8) ; "You don't need to open the window."
			)
...
(instance psychWindow of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 11) ; "The window is in the Psychologist's Office. The blinds are shut."
			)
			(3 ; Do
				(Print 19 8) ; "You don't need to open the window."
			)
...
(instance smokeAlarm of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 12) ; "It's a smoke detector! A small label on the side reads: "For best results, hold directly over flame"."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theCarpet of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 13) ; "Hmm, 'policeman blue'."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 14) ; "You're in the hallway of the second level of the Lytton Police Station. Several office doors line the hallway."
			)
			(else
				(super doVerb: theVerb)
			)
