...
(procedure (localproc_3 &tmp [temp0 250] [temp250 40] [temp290 40] [temp330 40] [temp370 40] [temp410 45])
	...
	(Display @temp0 dsCOORD 30 60 dsALIGN alLEFT dsFONT 0 dsCOLOR 7 dsWIDTH 285)
	...
	(Display @temp0 dsCOORD 30 100 dsALIGN alLEFT dsFONT 0 dsCOLOR 7 dsWIDTH (LangSwitch 100 150))
)
...
(procedure (localproc_5)
	...
	(Graph grDRAW_LINE 15 (LangSwitch 170 176) 165 (LangSwitch 170 176) 54 -1 -1)
	...
	(Graph grDRAW_LINE 165 20 165 (LangSwitch 170 175) 54 -1 -1)
	(Graph grUPDATE_BOX 0 0 170 (LangSwitch 175 177) 1)
	(localproc_0 204 4 (LangSwitch 50 32) 20 (LangSwitch 100 160) global125) ; "NOTICE TO APPEAR"
	(localproc_0 204 5 (LangSwitch 25 21) 37 100 (proc0_15 global122 global121)) ; "Name -"
	(localproc_0 501 local3 (LangSwitch 60 57) 37 100 global125)
	(localproc_0 204 6 (LangSwitch 25 21) 52 100 (proc0_15 global122 global121)) ; "Street -"
	(localproc_0 501 (+ 1 local3) (LangSwitch 70 44) 52 100 global125)
	(localproc_0 204 7 (LangSwitch 25 21) 67 100 (proc0_15 global122 global121)) ; "City -"
	(localproc_0 501 (+ 2 local3) (LangSwitch 55 52) 67 100 global125)
	(localproc_0 204 8 (LangSwitch 25 21) 82 100 (proc0_15 global122 global121)) ; "DL -"
	(localproc_0 501 (+ 3 local3) (LangSwitch 47 46) 82 200 global125)
	(localproc_0 204 9 (LangSwitch 86 79) 82 100 (proc0_15 global122 global121)) ; "Sex -"
	(localproc_0 501 (+ 5 local3) (LangSwitch 111 104) 82 100 global125)
	(localproc_0 ; "Eye -"
		204
		10
		(LangSwitch 125 112)
	...
	(localproc_0 501 (+ 7 local3) (LangSwitch 152 134) 82 100 global125)
	(localproc_0 204 11 (LangSwitch 25 21) 97 100 (proc0_15 global122 global121)) ; "Hair -"
	(localproc_0 501 (+ 6 local3) (LangSwitch 55 42) 97 100 global125)
	(localproc_0 204 12 74 97 100 (proc0_15 global122 global121)) ; "WT -"
	(localproc_0 501 (+ 9 local3) (LangSwitch 96 98) 97 100 global125)
	(localproc_0 204 13 117 97 100 (proc0_15 global122 global121)) ; "HT -"
	(localproc_0 501 (+ 8 local3) (LangSwitch 142 134) 97 100 global125)
	(localproc_0 ; "D.O.B. -"
		204
		14
		(LangSwitch 25 21)
	...
	(localproc_0 501 (+ 4 local3) (LangSwitch 50 47) 112 50 global125)
	...
	(localproc_0 501 (+ 10 local3) (LangSwitch 50 42) 127 50 global125)
	(localproc_0 204 17 83 127 100 (proc0_15 global122 global121)) ; "Reg Exp -"
	(localproc_0 501 (+ 11 local3) (LangSwitch 130 117) 127 50 global125)
	(localproc_0 ; "Year -"
		204
		18
		(LangSwitch 25 21)
	...
	(localproc_0 501 (+ 12 local3) (LangSwitch 63 40) 142 50 global125)
	(localproc_0 204 19 95 142 100 (proc0_15 global122 global121)) ; "Make -"
	(localproc_0 501 (+ 12 local3) (LangSwitch 133 125) 142 50 global125)
	(localproc_0 ; "Vehicle Code -"
		204
		20
		(LangSwitch 25 21)
		157
...
(procedure (localproc_6)
	...
	(Graph grUPDATE_BOX 0 0 170 (LangSwitch 175 177) 1)
	(localproc_0 204 4 (LangSwitch 50 32) 20 (LangSwitch 100 160) global125) ; "NOTICE TO APPEAR"
	(localproc_0 204 21 (LangSwitch 25 21) 37 100 (proc0_15 global122 global121)) ; "Name -"
	(localproc_0 204 6 (LangSwitch 25 21) 52 100 (proc0_15 global122 global121)) ; "Street -"
	(localproc_0 204 7 (LangSwitch 25 21) 67 100 (proc0_15 global122 global121)) ; "City -"
	(localproc_0 204 8 (LangSwitch 25 21) 82 100 (proc0_15 global122 global121)) ; "DL -"
	...
	(localproc_0 204 23 200 100 100 global125) ; "You must first insert the violator's license into the computer."
)
...
(instance rmDmv of Rm
	...
	(method (init)
		...
		(quitBut
			...
			x: (proc0_20 307 256 289 289 289)
			init:
		)
		(driverBut
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 41 5 39 39 39)
			init:
		)
		(vinBut
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 132 47 99 99 99)
			init:
		)
		(plateBut
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 188 112 155 155 155)
			init:
		)
		(gGame setCursor: 999)
		(if (== gPrevRoomNum 25)
			(formBut
				view: (proc0_20 1971 199 197 197 197)
				x: (proc0_20 247 170 221 221 221)
				init:
			)
		)
		(gTheIconBar disable:)
...
(instance runVin of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local0 5)
				(localproc_0 204 24 20 170 200 global125) ; "Enter vehicle ID:"
				(= local24 210)
				(= local25 170)
			...
			(2
				(cond
					...
					(else
						(localproc_0 204 25 20 170 200 global125) ; "Invalid Entry"
					)
				)
				(self dispose:)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(= local24 210)
				(= local25 170)
				(localproc_0 204 26 20 170 200 global125) ; "Enter vehicle license number:"
				(self setScript: enterCode self)
			)
			(2
				(cond
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(= local24 210)
				(= local25 170)
				(localproc_0 204 27 20 170 200 global125) ; "Enter driver's ID:"
				(self setScript: enterCode self)
			)
			(2
				(cond
		...
		(switch (= state newState)
			...
			(1
				(cond
					...
					((< register 10)
						(++ local1)
						(StrCat @local4 (Format @temp0 204 28 register)) ; "%d"
						(localproc_1)
						(self register: -1)
						(= state 0)
						(= cycles 1)
			...
			(2
				...
				(if local26
					...
					(localproc_0 204 29 20 170 200 global125) ; "searching..."
				)
				(= seconds 1)
			)
			(3
				...
				(Graph grUPDATE_BOX 170 20 (LangSwitch 180 187) (LangSwitch 160 200) 1)
				(if (< local2 3)
					(= state 1)
					(++ local2)
				)
		...
		(switch (= state newState)
			...
			(1
				(switch ((gInventory at: 23) state:) ; license
					...
					(4
						(Print 204 30) ; "You can't give this guy a traffic citation. He wasn't driving a car."
						(gEgo get: 23) ; license
			...
			(2
				...
				(= local24 125)
				(= local25 112)
				(localproc_0 204 31 205 50 100 global125) ; "Enter Military Time"
				(self setScript: enterCode self)
			)
			(3
				(if (< (StrCmp {24} @local4) 1)
					...
					(localproc_0 204 25 205 90 100 global125) ; "Invalid Entry"
					(= state 1)
					(= seconds 3)
				else
					(if (not (StrCmp @local4 (Format @temp0 204 28 global105))) ; "%d"
						(++ local27)
					)
					(= cycles 3)
				)
			...
			(5
				(if (< (StrCmp {60} @local4) 1)
					...
					(if (not (StrCmp @local4 (Format @temp0 204 28 global106))) ; "%d"
						(++ local27)
					)
					(= cycles 3)
				)
			...
			(6
				...
				(localproc_0 204 32 205 80 100 global125) ; "Enter vehicle code:"
				(self setScript: enterCode self)
			)
			(7
				(switch ((gInventory at: 23) state:) ; license
				...
				(evKEYBOARD
					(if
						(or
							(==
								(event message:)
								(proc0_20 119 105 118 118 118)
							)
							(== (event message:) (proc0_20 87 73 86 86 86))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
		...
		(if (not (gCurRoom script:))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (proc0_20 97 99 100 100 100))
							(== (event message:) (proc0_20 65 67 68 68 68))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
				...
				(evKEYBOARD
					(if
						(or
							(==
								(event message:)
								(proc0_20 107 109 112 112 112)
							)
							(== (event message:) (proc0_20 75 77 80 80 80))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
