...
(instance labTech of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 24 39) ; "Mike Downs is the head technician. He runs the computer facilities."
			)
			(5 ; Talk
				(HandsOff)
			...
			(3 ; Do
				(Print 24 40) ; "Yeah, he's a nerd, but he knows his stuff."
			)
			(4 ; Inventory
				(switch invItem
					(0 ; compRequest
					...
					(else
						(Print 24 41) ; "The lab tech doesn't have time to look at your stuff, Bonds."
					)
				)
			)
			(else
...
(instance reqCard of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 42) ; "Your computer access card is on Mike's desk."
			)
			(3 ; Do
				(HandsOff)
				(labTech setScript: 0)
...
(instance dispatch1 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 43) ; "Behind their glass wall, dispatch is busy monitoring the police band."
			)
			(5 ; Talk
				(Print 24 44) ; "Trying to project your voice through glass proves to be futile."
			)
			(3 ; Do
				(Print 24 45) ; "Yep! There's been times when you've wanted to get your hands around the neck of a dispatcher."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance screen1 of escProp
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 24 46) ; "The dispatch center is equipped with the latest audio, visual equipment."
			)
			(else
...
(instance screen3 of escProp
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 24 47) ; "Law enforcement has certainly gone high tech hasn't it?"
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance monitor2 of escProp
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 24 48) ; "The dispatch center is equipped with the latest audio, visual equipment."
			)
			(else
				(super doVerb: theVerb invItem)
			)
...
(instance tracker of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 50) ; "It is a tracking device."
			)
			(3 ; Do
				(HandsOff)
...
(instance cabinet of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 51) ; "That's Mike's cabinet."
			)
			(3 ; Do
				(Print 24 52) ; "Don't look through Mike's cabinet."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance deskD of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 53) ; "That's Mike's desk."
			)
			(3 ; Do
				(HandsOff)
...
(instance banks of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 54) ; "The size of the department's main computer banks always astounds you."
			)
			(3 ; Do
				(Print 24 55) ; "You're not qualified to screw around with the mainframe."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance desk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(3 ; Do
				(Print 24 56) ; "There's nothing for you on the desk right now."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance computer of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 57) ; "That's Mike's computer."
			)
			(3 ; Do
				(Print 24 58) ; "Mike's very protective of his computers."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance table of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 59) ; "The table holds various computer magazines - none of which interest you."
			)
			(3 ; Do
				(Print 24 60) ; "The computer magazines are of little interest."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance glass of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 61) ; "The glass wall divides dispatch from the computer facilities."
			)
			(3 ; Do
				(Print 24 62) ; "Don't rap on the window and disturb dispatch!"
			)
			(4 ; Inventory
				(Print 24 63) ; "You have an evil mind."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance floor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 64) ; "The elevated floor consists of individual movable tiles. All the computer cables run underneath the tiles."
			)
			(3 ; Do
				(Print 24 65) ; "You don't need to get at the computer cables and Mike wouldn't let you anyway."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance inOut of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 66) ; "That is Mike's In\Out basket."
			)
			(3 ; Do
				(Print 24 67) ; "It is empty."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theRoom of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 24 68) ; "The third floor is home to the computer facilities and dispatch."
			)
			(else
