...
(instance door of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 61) ; "The door leads back into the hallway."
			)
			(3 ; Do
				(HandsOff)
			...
			(2 ; Look
				(cond
					(
						...
						(Print 21 62) ; "You're not in the homicide division."
					)
					(global150
						(switch global150
							(1
								(if (and (== gDay 5) global143)
									(Print 21 63) ; "You have messages on your computer."
								else
									(Print 21 64) ; "This is your computer."
								)
							)
							(2
								(Print 21 63) ; "You have messages on your computer."
			...
			(3 ; Do
				(cond
					...
					((gCast contains: cInset)
						(Print 21 65) ; "Your computer is already turned on."
					)
					(else
						(HandsOff)
...
(instance chair of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					(Print 21 67) ; "The chairs are for officers assigned to Homicide."
				else
					(Print 21 68) ; "Your chair isn't exactly a lazy boy, but you like it."
				)
			)
			(3 ; Do
				(cond
					...
					((not (gEgo normal:))
						(Print 21 69) ; "You are already sitting down."
					)
					(else
						(HandsOff)
...
(instance pChair of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					(Print 21 70) ; "The chairs are for officers assigned to Homicide."
				else
...
(instance eChair of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (== gDay 1)
					(Print 21 98) ; "The chairs are for officers assigned to Homicide."
				else
					(Print 21 99) ; "That's where Earl sits."
				)
			)
			(3 ; Do
				(if (== gDay 1)
...
(instance captDesk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 21 100) ; "Captain Tate's desk is well organized - as usual."
			)
			(3 ; Do
				(Print 21 101) ; "Messing with Captain Tate could get you fired, Bonds."
			)
			(else
				(super doVerb: theVerb)
			)
