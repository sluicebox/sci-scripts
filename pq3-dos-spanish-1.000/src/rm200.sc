...
(instance rm200 of Rm
	...
	(method (init)
		...
		(Dmv
			...
			x: (proc0_20 30 11 26 26 26)
			init:
		)
		(Homicide
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 94 42 88 88 88)
			init:
		)
		(Personnel
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 146 106 166 166 166)
			init:
		)
		(Tools
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 209 165 234 234 234)
			init:
		)
		(Quit
			view: (proc0_20 1971 199 197 197 197)
		...
		(drawFace
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 80 10 75 75 75)
			init:
			hide:
		)
		(cityMap
			view: (proc0_20 1971 199 197 197 197)
			x: (proc0_20 166 138 203 203 203)
			init:
			hide:
		)
		(gTheIconBar disable:)
		...
		(if (not (& signal $0080))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (proc0_20 115 112 99 99 99))
							(== (event message:) (proc0_20 83 80 67 67 67))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
