...
(instance closingCartoon of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(= save1 1)
				(Say egoTalk 300 1) ; "I don't think I'll ever be able to look at you again without feeling what I feel right now - without rememberingwhat a miracle it is just to hold you."
