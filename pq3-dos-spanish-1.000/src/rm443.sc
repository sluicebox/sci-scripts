		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(17 ; knife
						(Print 443 8) ; "Get real Bonds!"
					)
					(19 ; wallet
						(Print 443 9) ; "Yes Officer, can I help you?"
					)
					(else
						(Print 443 10) ; "She really isn't interested in that."
					)
				)
			)
			(else
...
(instance egoChair of View
	(properties
		x 128
		y 133
		lookStr {This chair is for the prosecution.}
		view 461
		loop 6
		priority 9
		signal 16401
...
(instance attorneyChair of View
	(properties
		x 106
		y 120
		lookStr {That chair for the prosecution.}
		view 461
		loop 6
		priority 10
		signal 16401
...
(instance judgeBench of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 443 12) ; "You're not allowed up there."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance witnessBox of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 443 13) ; "Quit fooling around and stick to the matter at hand."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance flag of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 443 14) ; "You patriotically salute the flag."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance spectatorArea of Feature
	(properties
		...
		onMeCheck 8
		lookStr {This is the spectator area. It is usually open for the public to observe the court's proceedings.}
	)
)
...
(instance wall of Feature
	(properties
		...
		onMeCheck 32
		lookStr {The three foot wall divides the council from the spectator area of the courtroom.}
	)
)
