...
(instance truck of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 41 40) ; "Use your car if you want to leave."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance pipe of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 41 41) ; "What do you want to do with the pipe?"
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance trash of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 41 42) ; "Nice thought, but you don't have time to clean up the place."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance trashBin of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 41 43) ; "There's nothing you need in the trash bin. Leave that stuff for the garbage collector."
			)
			(else
				(super doVerb: theVerb &rest)
			)
