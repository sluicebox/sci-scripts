...
(instance rm003 of PQRoom
	...
	(method (init)
		(LoadMany
			rsVIEW
			(proc0_20 107 1071 107 107 107)
			(proc0_20 106 1061 106 106 106)
			(proc0_20 108 1081 108 108 108)
		)
		(super init:)
		(head1 view: (proc0_20 107 1071 107 107 107) init:)
		(head2 view: (proc0_20 107 1071 107 107 107) init:)
...
(instance creditScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(credit0
					view: (proc0_20 107 1071 107 107 107)
					init:
					loop: 2
					cel: 0
					posn: 218 61
			...
			(7
				...
				(head3 view: (proc0_20 106 1061 106 106 106) init:)
				(= cycles 2)
			)
			(8
				(credit0
					init:
					view: (proc0_20 106 1061 106 106 106)
					loop: 2
					cel: 0
					posn: 114 59
				)
			...
			(15
				(car
					view: (proc0_20 108 1081 108 108 108)
					init:
					setCycle: End self
				)
			)
