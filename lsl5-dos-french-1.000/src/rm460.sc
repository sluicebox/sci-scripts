...
(instance rm460 of LLRoom
	...
	(method (init)
		...
		(bigg init: stopUpd:)
		(pattiChair init: stopUpd:)
		(patDaisChair init:)
		(desDaisChair init:)
		(marilyn init: stopUpd:)
		(roger init:)
		(humphrey init: stopUpd:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(15
				...
				(pattiChair dispose:)
				(desmond dispose:)
				(patDaisChair dispose:)
				(desDaisChair dispose:)
				(quayle dispose:)
				(bigg dispose:)
				(marilyn dispose:)
				(roger dispose:)
			...
			(78
				(Say You_FToi 460 23 108 139 self) ; ""Oh, really?" you say, feigning interest."
			)
			(79
			...
			(84
				(Say You_FToi 460 29 108 139 self) ; ""My name is Passionate Patti," you reply."
			)
			(85
			...
			(94
				(Say You_FToi 460 39 108 139 self) ; "Really, Mr. Bigg, your offer is not interest..."
			)
			(95
