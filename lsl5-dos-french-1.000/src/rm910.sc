...
(instance mouthPic of Feature
	(properties
		...
		nsBottom 63
		nsRight 221
		description {the happy tooth poste}
		sightAngle 40
...
(instance sBringInChiChi of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(8
				(Say Chi_Chi_Lambada_FChi_Chi_Lambada 910 10 108 139 self) ; "Well, Mr. Laffer, shall we get started?"
			)
			(9
			...
			(11
				(Say Chi_Chi_Lambada_FChi_Chi_Lambada 910 12 108 139 self) ; "Well, make up your mind," says Chi Chi. "I've gotta adjust the chair!"
			...
			(16
				(Say Chi_Chi_Lambada_FChi_Chi_Lambada 910 13 108 139 self) ; "Say, Larry. Have you ever considered dental floss as an aphrodisiac?"
			)
			(17
				(gCurRoom setScript: sWorkOnTeeth)
			)
...
(instance chiChi of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(10 ; Zipper
				(Say Chi_Chi_Lambada_FChi_Chi_Lambada 910 17 108) ; "Well, I might be interested, Larry," says Chi Chi. "But what about a little conversation first?"
			)
			(1 ; Walk
				(gCurRoom doVerb: 1)
			)
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(2
				...
				(Points 40 165)
				(Say Chi_Chi_Lambada_FChi_Chi_Lambada 910 18 108 139 self) ; "Why don't we go downstairs to my apartment behind the gymnastics studio where I'll be able to express my appreciation in a more acceptable manner?"
			)
			(3
				(= ticks 90)
			)
