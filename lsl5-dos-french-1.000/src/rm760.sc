...
(instance Lana_Luscious_FLana_Luscious_a of Talker
	(properties
		name {Lana Luscious}
		x 80
		y 160
...
(instance Lana_Luscious_FLana_Luscious_b of Talker
	(properties
		name {Lana Luscious}
		nsTop 100
		nsLeft 5
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(Say Lana_Luscious_FLana_Luscious_b 760 35 108) ; "Yes," she replies, hesitantly. "Who are you?"
				(= ticks 30)
			)
			(3
				(Say gEgo 760 36) ; "My name is Larry; Larry Laffer," you purr. "I've come a long way to meet you!"
				(Say Lana_Luscious_FLana_Luscious_b 760 37 108) ; "And meet me you have, Larry," says Lana. "Whaddaya say we sit down on that bench over there? These skates are killing me!"
				(= ticks 30)
			)
			(4
...
(instance sLanaTalks of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say Lana_Luscious_FLana_Luscious_a 760 40 108) ; ""Only when I'm trying to find a man," she says with a smile."
				(= ticks 60)
			)
			(2)
			(3
			...
			(4
				(Say Lana_Luscious_FLana_Luscious_a 760 42 108) ; ""Only when I'm here skating," she says with a smile."
				(= ticks 60)
			)
			(5)
			(6
			...
			(7
				(Say Lana_Luscious_FLana_Luscious_a 760 44 108) ; ""If you like that, you should drop by the `Tramp This! Mud Wrestling' Show. I go on in just a few minutes!" she says with a wink."
				(= ticks 60)
			)
			(8)
			(9
			...
			(10
				(Say Lana_Luscious_FLana_Luscious_a 760 46 108) ; "Why, it's in the Tramp Ballroom. The entrance is at the rear of the casino!" she says. "And if you bring a few hundred dollars with you, I'll make sure it's an experience you'll never forget!"
				(= ticks 60)
			)
			(11
			...
			(14
				(Say Lana_Luscious_FLana_Luscious_a 760 49 108) ; "Okay, Larry; I'll look forward to it!" she concludes, standing up. "Gotta go get out of my makeup!"
				(= ticks 60)
			)
			(15
...
(instance lanaFtr of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(3 ; Do
				(Say Lana_Luscious_FLana_Luscious_a 760 52 108) ; "Oh, Larry! You know that just drives me crazy!"
			)
			(10 ; Zipper
				(Say Lana_Luscious_FLana_Luscious_a 760 53 108) ; "Larry! Here?" says Lana. "Why don't you come by the Casino later when I'm mud wrestling?"
			)
			(4 ; Inventory
				(Say Lana_Luscious_FLana_Luscious_a 760 54 108) ; "Oh, I have no use for anything you could possibly offer me, Larry," says Lana. "Why, when I have total access to this sun-drenched boardwalk, the fresh ocean breezes caressing my hair, my smell of the salt water and ready access to all the mud I can roll in!"
			)
			(else
				(super doVerb: theVerb &rest)
			)
