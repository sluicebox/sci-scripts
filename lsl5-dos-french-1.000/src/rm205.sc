		...
		(switch (= state newState)
			...
			(2
				(Say ; "Well, thank you, gentlemen. I promise your CONSIDERABLE contribution will not be wasted!"
					President_of_C_A_N_E__FLe_Pr_sident_de_C_C_T_T_
					205
					17
					108
					139
...
(instance sCaneWorksCongress of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(Say A_C_A_N_E__er_FUn_C_C_T_Tien 205 27 108 139 self) ; "Yeah, okay, Senator, we've got it. Here's the deal: there's plenty more where this comes from, as long as we see some progress on that bill to tighten regulation of the airwaves."
			)
			(7
				(= ticks 45)
			)
			(8
				(Say A_C_A_N_E__er_FUn_C_C_T_Tien 205 28 108 139 self) ; "We want that smut off the air--and we're willing to back up our beliefs in the `traditional' American way. So? Do you want it or don't you?"
			)
			(9
				(= ticks 45)
			)
...
(instance President_of_C_A_N_E__FLe_Pr_sident_de_C_C_T_T_ of Talker
	(properties
...
(instance A_C_A_N_E__er_FUn_C_C_T_Tien of Talker
	(properties
		name {A C.A.N.E.-er}
		x 1
		y 140
