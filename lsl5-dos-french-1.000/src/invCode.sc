	...
	(method (doit param1)
		(switch param1
			(23
				(Inv
					add:
						Camcorder_FCam_ra_vid_o
						Battery_Charger_FChargeur_de_Piles
						A_Blank_Videotape_FUne_Cassette_Vid_o_Vierge_a
						A_Blank_Videotape_FUne_Cassette_Vid_o_Vierge_b
						A_Blank_Videotape_FUne_Cassette_Vid_o_Vierge_c
						Michelle_Milken_s_Resume_FLe_CV_de_Michelle_Milken
						Hard_Disk_Cafe_Napkin_FServiette_Du_Hard_Disk_Caf_
						AeroDork_Gold_Card_FCarte_Gold_AeroDork
						Boarding_Pass_FCarte_d_Embarquement
						AeroDork_s_In_Flight_Magazine_FMagazine_de_Vol_d_aeroDork
						Some_Change_FDe_La_Monnaie
						DayTrotter__FDayTrotter_
						Money_FArgent
						Credit_Cards_FCartes_de_Cr_dit
						Membership_Tape_FBande_Perfor_e_de_Membre_du_Club
						Lana_Luscious__Resume_FCV_de_Lana_Luscious
						Tramp_Casino_Matchbook_FBoite_d_Allumettes
						Silver_Dollar_FDollar_en_Argent
						Roller_skates_FPatins___Roulettes
						Chi_Chi_Lambada_s_Resume_FCV_de_Chi_Chi_Lambada
						Doc_Pulliam_s_Card_FCarte_de_Doc_Pulliam
						Green_Card_FCarte_de_R_sidence
						Doily_FNapperon
						invLook
						invHand
						invSelect
			...
			(24
				(Inv
					add:
						DataMan_FDataMan
						Reverse_Biaz_DataPak_FDataPack_de_Reverse_Biaz
						P__C__Hammer_DataPak_FDataPack_de_P__C__Hammer
						Reverse_Biaz_Fax_FT_l_copie_Reverse_Biaz
						Champagne_FChampagne
						Gold_Record_FDisque_d_Or
						Cassette_Tape_FCassette_Audio
						P__C__Hammer_Fax_FT_l_copie_P__C__Hammer
						Letter_Opener_FCoupe_Papier
						Desk_Key_FCl__du_Bureau
						Folder_Of_Evidence_FDossier_des_Preuves
						Photocopied_Evidence_FPhotocopies_des_Preuves
						Reel_To_Reel_Tape_FMagn_tophone___Bandes
						Hooter_Shooter_FSoutien_Flingue
						invLook
						invHand
						invSelect
						invHelp
...
(instance Camcorder_FCam_ra_vid_o of InvI
	(properties
		name {Camcorder}
		view 931
		cursor 931
			...
			(4 ; Inventory
				(if (OneOf invItem 2 3 4) ; A_Blank_Videotape_a, A_Blank_Videotape_b, A_Blank_Videotape_c
					...
					(if (!= ((Inv at: invItem) state:) 1)
						...
						(= state invItem)
						((Inv at: invItem) owner: Camcorder_FCam_ra_vid_o)
...
(instance Battery_Charger_FChargeur_de_Piles of InvI
	(properties
...
(instance A_Blank_Videotape_FUne_Cassette_Vid_o_Vierge_a of InvI
	(properties
...
(instance A_Blank_Videotape_FUne_Cassette_Vid_o_Vierge_b of InvI
	(properties
		name {A Blank Videotape}
		view 934
		cursor 934
...
(instance A_Blank_Videotape_FUne_Cassette_Vid_o_Vierge_c of InvI
	(properties
		name {A Blank Videotape}
		view 934
		cursor 934
...
(instance Michelle_Milken_s_Resume_FLe_CV_de_Michelle_Milken of InvI
	(properties
...
(instance Hard_Disk_Cafe_Napkin_FServiette_Du_Hard_Disk_Caf_ of InvI
	(properties
...
(instance AeroDork_Gold_Card_FCarte_Gold_AeroDork of InvI
	(properties
...
(instance Boarding_Pass_FCarte_d_Embarquement of InvI
	(properties
		name {Boarding Pass}
		view 940
		cursor 940
...
(instance AeroDork_s_In_Flight_Magazine_FMagazine_de_Vol_d_aeroDork of InvI
	(properties
...
(instance Some_Change_FDe_La_Monnaie of InvI
	(properties
		name {Some Change}
		view 942
		cursor 942
...
(instance DayTrotter__FDayTrotter_ of InvI
	(properties
		name {DayTrotter\05}
		view 943
		cursor 943
...
(instance Money_FArgent of InvI
	(properties
		name {Money}
		view 944
		cursor 944
...
(instance Credit_Cards_FCartes_de_Cr_dit of InvI
	(properties
		name {Credit Cards}
		view 945
		cursor 945
...
(instance Membership_Tape_FBande_Perfor_e_de_Membre_du_Club of InvI
	(properties
...
(instance DataMan_FDataMan of InvI
	(properties
		name {DataMan}
		view 948
		cursor 948
...
(instance Reverse_Biaz_DataPak_FDataPack_de_Reverse_Biaz of InvI
	(properties
...
(instance P__C__Hammer_DataPak_FDataPack_de_P__C__Hammer of InvI
	(properties
...
(instance Lana_Luscious__Resume_FCV_de_Lana_Luscious of InvI
	(properties
...
(instance Tramp_Casino_Matchbook_FBoite_d_Allumettes of InvI
	(properties
...
(instance Silver_Dollar_FDollar_en_Argent of InvI
	(properties
		name {Silver Dollar}
		view 953
		cursor 953
...
(instance Roller_skates_FPatins___Roulettes of InvI
	(properties
		name {Roller-skates}
		view 954
		cursor 954
...
(instance Reverse_Biaz_Fax_FT_l_copie_Reverse_Biaz of InvI
	(properties
...
(instance Champagne_FChampagne of InvI
	(properties
		name {Champagne}
		view 956
		cursor 956
...
(instance Gold_Record_FDisque_d_Or of InvI
	(properties
		name {Gold Record}
		view 957
		cursor 957
...
(instance Cassette_Tape_FCassette_Audio of InvI
	(properties
		name {Cassette Tape}
		view 958
		cursor 958
...
(instance Chi_Chi_Lambada_s_Resume_FCV_de_Chi_Chi_Lambada of InvI
	(properties
...
(instance Doc_Pulliam_s_Card_FCarte_de_Doc_Pulliam of InvI
	(properties
...
(instance Green_Card_FCarte_de_R_sidence of InvI
	(properties
		name {Green Card}
		view 961
		cursor 961
...
(instance Doily_FNapperon of InvI
	(properties
		name {Doily}
		view 962
		cursor 962
...
(instance P__C__Hammer_Fax_FT_l_copie_P__C__Hammer of InvI
	(properties
		name {P. C. Hammer Fax}
		view 955
		cursor 955
...
(instance Letter_Opener_FCoupe_Papier of InvI
	(properties
		name {Letter Opener}
		view 964
		cursor 964
...
(instance Desk_Key_FCl__du_Bureau of InvI
	(properties
		name {Desk Key}
		view 965
		cursor 965
...
(instance Folder_Of_Evidence_FDossier_des_Preuves of InvI
	(properties
...
(instance Photocopied_Evidence_FPhotocopies_des_Preuves of InvI
	(properties
...
(instance Reel_To_Reel_Tape_FMagn_tophone___Bandes of InvI
	(properties
...
(instance Hooter_Shooter_FSoutien_Flingue of InvI
	(properties
		name {Hooter Shooter}
		view 969
		cursor 969
