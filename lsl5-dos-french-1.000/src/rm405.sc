	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(Say Andy_FAndy 405 1 108 139 self) ; "Funny you'd mention that, Patti."
			)
			(4
				(= ticks 30)
			)
			(5
				(Say Andy_FAndy 405 2 108 139 self) ; "I was just getting ready to talk to you."
			)
			(6
				(= ticks 123)
			)
			...
			(8
				(Say Andy_FAndy 405 4 108 139 self) ; "Oh, Patti, it ain't me. You know I like you just fine. It's just my boss that don't."
			)
			(9
				(= ticks 60)
			)
			(10
				(Say Andy_FAndy 405 5 108 139 self) ; "Julius doesn't much care for small audiences."
			)
			(11
				(= ticks 60)
			)
			(12
				(Say Andy_FAndy 405 6 108 139 self) ; "He says your fans listen too much and drink too little."
			)
			(13
				(= ticks 60)
			)
			(14
				...
				(Say Andy_FAndy 405 8 108 139 self) ; "He can't see how he and his 'backers' can be expected to make a profit like that."
			)
			(15
				(= ticks 30)
			)
			(16
				(Say Andy_FAndy 405 9 108 139 self) ; "Patti, I'm just going to have to let you go."
			)
			(17
				(= ticks 123)
			)
			(18
				...
				(Say Andy_FAndy 405 11 108 139 self) ; "It's not me, Honey," he says, "you treated me jus' fine. I'll be sorry to see you go."
			)
			(19
				(= ticks 123)
			)
			(20
				...
				(Say Andy_FAndy 405 13 108 139 self) ; "Ah, er," he stutters, "I guess that's the other thing: I can't do that."
			)
			(21
				(= ticks 60)
			)
			(22
				(Say Andy_FAndy 405 14 108 139 self) ; "Julius says your contract was never valid, so he doesn't have to pay."
			)
			(23
				(= ticks 123)
			)
			(24
				...
				(Say Andy_FAndy 405 16 108 139 self) ; "Not exactly shaking, he replies, "Do what you have to do, Patti, but if you ever want to work anywhere in this town again...""
			)
			(25
				(= ticks 60)
			)
			(26
				...
				(Say Andy_FAndy 405 18 108 139 self) ; "Patti, take my advice: play more commercial. Give 'em what they like! A broad as good lookin' as you could really pull 'em in, if you'd just get smart!"
			)
			(27
				(= ticks 123)
			)
