...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Say You_FToi 415 1 108 139 self) ; "But, of course, Inspector," you reply. "Nice trench coat!"
			)
			(3
				(= ticks 123)
			)
			...
			(6
				(Say You_FToi 415 3 108 139 self) ; "Go ahead, Inspector, but I don't usually grant favors on a first date! Besides, I'm not the private-eye type."
			)
			(7
				(= ticks 123)
			)
			...
			(20
				...
				(Say You_FToi 415 11 108 139 self) ; "But, of course I'll help you, Inspector Desmond!" you hear yourself say, "after all, I recently learned I'm taking next week off."
			)
			(21
				(= ticks 123)
			)
			(22
				(Say You_FToi 415 12 108 139 self) ; "So, how do we start?"
			)
			(23
				(= ticks 123)
			)
