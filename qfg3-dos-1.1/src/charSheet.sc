...
(instance charSheet of Code
	...
	(method (doit &tmp [temp0 6] temp6 temp7 temp8 temp9)
		...
		(localproc_0 93 34 0 0)
		(localproc_0 93 50 1 0)
		(localproc_0 93 67 2 0)
		(localproc_0 93 83 3 0)
		(localproc_0 93 99 4 0)
		(localproc_0 93 115 12 0)
		(localproc_1 93 130 0)
		(localproc_0 286 35 5 0)
		(localproc_0 286 48 6 0)
		(localproc_0 286 60 7 0)
		(localproc_0 286 72 8 0)
		(localproc_0 286 84 9 0)
		(localproc_0 286 96 10 0)
		(localproc_0 286 108 11 0)
		(localproc_0 286 120 13 0)
		(localproc_0 286 132 14 0)
		(localproc_0
			58
			171
			16
		...
		(Display @temp0 dsCOORD 98 156 dsCOLOR temp7 dsWIDTH 60 dsALIGN alLEFT dsFONT 123)
		(Display @temp0 dsCOORD 97 156 dsCOLOR temp6 dsWIDTH 60 dsALIGN alLEFT dsFONT 123)
		(User input: 1)
