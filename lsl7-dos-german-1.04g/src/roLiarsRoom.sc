	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(voBabeMoney draw: {%d DM} local33)
				(voPotMoney draw: {Topf: %d DM} local34)
				(gGame handsOn:)
				(self dispose:)
			)
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(voLarryMoney draw: {%d DM} local32)
				(voPotMoney draw: {Topf: %d DM} local34)
				(gGame handsOn:)
				(self dispose:)
			)
