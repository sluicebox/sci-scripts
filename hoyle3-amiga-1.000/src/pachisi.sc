...
(procedure (proc400_2 &tmp [temp0 40] temp40 temp41)
	...
	(Format @global550 499 0) ; "SCORECARD   Percent Home --------------------------------"
	(if (player1 type:)
		(StrCat
			@global550
			(Format @temp0 400 0 (player1 playerName:) (player1 percentHome:)) ; "%-10s     %=3d"
		)
	)
	(if (player2 type:)
		(StrCat
			@global550
			(Format @temp0 400 0 (player2 playerName:) (player2 percentHome:)) ; "%-10s     %=3d"
		)
	)
	(if (player3 type:)
		(StrCat
			@global550
			(Format @temp0 400 0 (player3 playerName:) (player3 percentHome:)) ; "%-10s     %=3d"
		)
	)
	(if (player4 type:)
		(StrCat
			@global550
			(Format @temp0 400 0 (player4 playerName:) (player4 percentHome:)) ; "%-10s     %=3d"
		)
	)
	(gSong play: 806)
