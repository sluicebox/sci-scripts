...
(procedure (proc200_2 &tmp [temp0 80] [temp80 80] temp160 temp161)
	...
	(Format @global550 299 7 (player2 playerName:) (player1 playerName:)) ; "SCORECARD  %=10s %=9s --------------------------------"
	(StrCat @global550 (Format @temp80 299 8 (player2 wins:) (player1 wins:))) ; "Wins      %=3d    %=3d"
	(StrCat @global550 (Format @temp80 299 9 (player2 losses:) (player1 losses:))) ; "Losses     %=3d    %=3d"
	(StrCat @global550 (Format @temp80 299 10 (player2 draws:) (player1 draws:))) ; "Draws      %=3d    %=3d"
...
(instance checkers of Rm
	...
	(method (init)
		...
		(switch local52
			...
			(2
				(Print (Format @global550 299 0 (player2 playerName:))) ; "%s moves first"
			)
			(3
				(Print (Format @global550 299 0 (player1 playerName:))) ; "%s moves first"
			)
		)
		...
		(if (== temp0 23)
			...
			(cond
				...
				((== global188 2)
					(if (== global259 -1)
						(Print
							(Format @global550 299 0 (player2 playerName:)) ; "%s moves first"
						)
					else
						(Print
							(Format @global550 299 0 (player1 playerName:)) ; "%s moves first"
						)
					)
				)
			)
