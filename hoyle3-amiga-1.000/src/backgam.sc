			...
			(0
				...
				(if (global178 readPoints: 0)
					...
					(cond
						((== (global178 type:) 2)
							(gChar1
								say: (Format @global550 399 21) 0 443 -32768 ; "I have no possible moves and must pass."
							)
						)
						((== global179 2)
							(gChar1
						...
						(if (global178 count:)
							(if (not register)
								(if
									...
									(repeat
										(StrCpy @temp0 {})
										(Print 399 0 #edit @temp0 2) ; "Which doubles do you want?"
		...
		(cond
			((and argc (== param1 3))
				(if (self open: 2)
					(self
						writeString:
							(Format @temp0 300 0 global317 global315 global324) ; "%3d%d%d"
						close:
					)
					(return 1)
				else
