...
(instance KQ5 of Game
	...
	(method (init &tmp [temp0 270] temp270)
		...
		((= gMyWindow myWindow)
			color: (if temp270 8 else 0)
			back: (if temp270 23 else 7)
			lineColor: (if temp270 19 else 4)
		)
		...
		(cls)
		(TheIconBar
			barColor: (if temp270 41 else 3)
			shadowColor: (if temp270 0 else 0)
			selBoxColor: (if temp270 7 else 31)
		...
		(Inv
			...
			back: (if temp270 23 else 7)
			lineColor: (if temp270 19 else 4)
			textColor: (if temp270 17 else 1)
		)
		(= global103 0)
