...
(instance a2s5Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(57
				(gEgo setLoop: 3 setCycle: CT 3 1 self)
				(gEgo get: 28) ; Wand
			)
			(58
	...
	(method (doit)
		...
		(self
			setCel:
				(cond
					(local3 6)
					((and (== (crispin loop:) 4) (== (crispin cel:) 5)) 0)
					((and (== (crispin loop:) 4) (== (crispin cel:) 6)) 1)
					((and (== (crispin loop:) 4) (== (crispin cel:) 7)) 2)
					((and (== (crispin loop:) 4) (== (crispin cel:) 8)) 3)
					((and (== (crispin loop:) 4) (== (crispin cel:) 9)) 4)
