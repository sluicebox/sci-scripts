...
(local
	...
	[local21 42] = [0 87 24 100 119 112 143 107 148 113 107 119 111 125 145 122 153 129 185 128 187 108 247 104 274 119 193 134 201 147 262 143 307 122 272 102 319 102 319 0 0 0]
	[local63 8] = [233 159 246 155 260 159 245 163]
	[local71 8] = [105 150 118 145 129 150 117 154]
	[local79 10] = [0 120 39 119 46 116 36 111 0 112]
	[local89 12] = [63 115 76 115 100 124 111 142 90 142 61 126]
	[local101 16] = [42 119 31 132 37 142 82 142 93 143 113 143 99 122 72 115]
	local117 = 1
	local118
	local119
	local120
...
(instance rm216 of Rm
	...
	(method (init)
		...
		(poly1 points: @local21 size: 21)
		(poly2 points: @local63 size: 4)
		(poly3 points: @local71 size: 4)
		(poly4 points: @local79 size: 5)
		(poly5 points: @local89 size: 6)
		(poly6 points: @local101 size: 8)
	)
...
(instance walkToJug of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(cond
					((and local117 (!= local118 0) (< local118 3))
						(++ local118)
						(-= state 5)
					)
					(local118
