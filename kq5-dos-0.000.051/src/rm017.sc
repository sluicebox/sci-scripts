...
(local
	...
	[local11 36] = [139 189 129 151 95 135 93 123 129 112 150 103 208 108 220 120 207 129 220 136 241 137 243 151 193 152 192 189 319 189 319 7 0 7 0 189]
	[local47 8] = [94 123 154 124 154 112 130 112]
)
...
(instance rm017 of Rm
	...
	(method (doit &tmp temp0)
		(cond
			...
			((and (& (gEgo onControl: 0) $0002) (IsFlag 33))
				(HandsOff)
