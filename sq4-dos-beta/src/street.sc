...
(local
	...
	local1
	local2
	[local3 74] = [0 0 0 0 314 -74 278 120 214 195 152 321 152 321 314 -72 314 -72 240 178 210 333 210 333 314 -72 314 -72 220 165 327 320 327 320 -73 -83 -73 -83 76 183 6 296 6 296 -65 94 -65 94 55 191 133 320 133 320 -24 14 -24 14 70 191 164 298 164 298 -24 235 -24 235 160 210 100 298 100 298]
	[local77 129] = [32767 30 100 500 200 500 32767 35 0 132 24 76 79 57 46 108 100 250 32767 50 0 65 220 75 218 73 25 128 -5 250 32767 65 0 100 15 100 103 125 145 151 -5 173 32767 60 319 157 239 175 239 181 -5 150 32767 55 319 100 238 100 295 -1 32767 40 221 250 195 97 79 78 278 35 302 -1 32767 25 91 219 210 145 297 250 32767 40 319 55 270 150 305 250 32767 55 319 65 228 68 109 163 125 145 140 163 242 83 325 83 32767 60 0 140 325 140 32767 65 0 170 60 160 -5 95 32767 50 101 219 90 96 101 92 -5 103 -32768]
...
(class street of Rgn
	...
	(method (newRoom newRoomNumber)
		...
		(if (== (gLongSong prevSignal:) -1)
			(gLongSong number: 801 loop: -1 vol: 0 playBed: fade: 127 15 10 0)
		)
	...
	(method (doit)
		...
		(if (and (> local1 0) (not (deathDroid script:)))
			...
			(if
				...
				(gLongSong2 number: 21 vol: 127 loop: -1 play:)
				(gLongSong stop:)
			)
		)
	)
	...
	(method (nextRoom)
		(if
			(or
				...
				(and (IsObject (ScriptID 705 1)) ((ScriptID 705 1) script:)) ; theBunny, theBunny
			)
			(repeat
				(-= value 2)
		...
		(switch (= state newState)
			...
			(4
				...
				(gunFire1
					...
					setPri: (if (< 2 (deathDroid cel:) 7) 15 else 13)
					setCycle: End
				)
...
(instance cyborgScreams of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(mouth setCycle: ForwardCounter 20 self)
			)
			(5
				(mouth
					posn: 142 106
			...
			(6
				(mouth posn: 152 104 setLoop: 2 setCycle: ForwardCounter 5 self)
			)
			(7
				(streetSoundFX number: 114 loop: 1 play:)
				(hand init:)
				(mouth posn: 151 127 setLoop: 3 setCycle: Fwd)
			)
			(8
				(gIconBar disable:)
				(= cycles 1)
