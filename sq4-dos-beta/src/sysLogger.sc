...
(instance sysLogger of Code
	...
	(method (doit param1 param2 &tmp temp0 temp1 [temp2 200] [temp202 10] [temp212 10] temp222 [temp223 9] [temp232 30] [temp262 30])
		(if (not (StrLen param1))
			(StrCpy @temp232 {})
			(StrCpy @temp262 {})
			(GetInput @temp232 30 {Enter drive & directory...})
			(StrCpy param1 @temp232)
			(StrCpy @temp262 param1)
		)
		(StrCpy @temp232 {})
		(GetInput @temp232 30 {Enter your name...})
		(StrCat @temp232 {.log})
		(StrCat param1 {\5c})
		(StrCat param1 @temp232)
