...
(instance rm520 of SQRoom
	...
	(method (init)
		...
		(switch (brain level:)
			(1
				(brain
					makePolygon: 0 160 60 160 95 180 208 180 246 162 246 105 210 121 210 156 96 156 96 118 63 106 63 136 0 136 0 0 319 0 319 189 0 189
				)
			)
			(2
				(brain
				...
				(brain
					makePolygon: 0 0 319 0 319 110 250 110 207 128 104 128 58 109 0 109
				)
			)
			(3
				(brain
					makePolygon: 0 98 61 98 93 109 206 109 246 97 319 97 319 189 0 189
				)
				...
				(brain
					makePolygon: 94 81 94 61 90 52 119 40 204 40 226 51 226 65 230 81 214 87 108 87
				)
			)
		)
	)
