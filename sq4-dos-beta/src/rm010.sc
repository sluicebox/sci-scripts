...
(procedure (localproc_0 param1 param2 param3 param4 param5 &tmp temp0 temp1)
	...
	(Graph grDRAW_LINE param1 param2 param3 param4 param5 -1 -1)
...
(instance rm010 of SQRoom
	...
	(method (init &tmp [temp0 50])
		(Load rsVIEW 11)
		(Load rsVIEW 10)
		(gLongSong number: 13 loop: 1 playBed:)
		(super init:)
		(blip init:)
...
(instance planetScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(grid setCel: 0 setLoop: 2 setCycle: ForwardCounter 4 self)
			)
			(14
			...
			(23
				(if (< register 8)
					...
					(localproc_0 1 85 10 85 global136)
					(= seconds 8)
				)
			)
			(24
			...
			(25
				...
				(localproc_0 1 230 10 230 global153)
				(= seconds 8)
			)
			(26
				(proc0_12 local0)
