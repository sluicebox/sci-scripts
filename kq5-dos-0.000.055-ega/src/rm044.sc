...
(local
	...
	local4
	[local5 2]
	[local7 34] = [174 0 173 40 188 42 81 52 92 58 121 65 147 65 96 76 179 96 179 109 87 126 89 136 170 152 230 124 236 93 198 73 235 0]
	[local41 30] = [155 38 155 0 0 0 0 189 90 189 118 179 54 132 20 76 78 75 102 64 65 61 64 66 9 58 108 47 110 42]
	[local71 10] = [76 94 85 104 139 104 156 94 132 91]
	[local81 8] = [319 176 233 176 242 186 319 186]
)
...
(instance rm044 of Rm
	...
	(method (init)
		(super init:)
		(= global325 {"Come on, Graham! Let's explore the beach!"})
		(= global320 15)
		(= global321 72)
		...
		(if (and (IsFlag 106) (!= gCurRoom global361) (not (gCurRoom script:)))
...
(instance flyIn of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(eagle dispose:)
				(Say 75 44 0 67 10 90 25 5) ; "Graham, where have you been? I've been looking all over for you!"
				(= cycles 1)
			)
			(10
				(cls)
				(Say 160 44 1 67 130 90 25 5) ; "You'd never believe it, Cedric. You'd never believe it."
				(= cycles 1)
			)
			(11
				(HandsOn)
...
(instance getBar of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(gEgo ignoreActors: 1 setMotion: PolyPath 150 170 self)
			)
			(1
				((gEgo head:) hide:)
			...
			(4
				...
				(gEgo view: 0 normal: 1 setCycle: Walk cycleSpeed: 0)
				((gEgo head:) show:)
				(SetScore 2)
				(= cycles 1)
			)
