...
(instance intro9 of Rm
	...
	(method (init)
		(HandsOff)
		(SetFlag 34)
		(proc0_24 128 752 770 139 762 140 2 773)
		(gEgo
			view: 752
			posn: 205 -2
			signal: 16384
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(gEgo setCycle: Fwd setMotion: MoveTo 207 150 self)
			)
			(3
			...
			(5
				...
				(PrintDC 108 0 #at 10 10 #dispose) ; "Looks like the fairy dust just wore off."
				(= seconds 3)
			)
			(6
			...
			(8
				(PrintDC 108 1 #at 100 10 #dispose) ; "Cedric! Where have you been? I've been calling for you!"
			...
			(14
				...
				(PrintDC 108 2 #at 100 10 #dispose) ; "Well, well, what have we here?"
				(= seconds 5)
			)
			(15
				(cls)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 108 3 #at 10 110 #dispose) ; "A bit clumsy, are you? Well, come on in the house and dry off. No sense sitting around like a wet dog."
				(= seconds 10)
			)
			(2
				(cls)
	...
	(method (changeState newState &tmp [temp0 100])
		(switch (= state newState)
			...
			(2
				...
				(PrintDC 108 4 #at 100 10 #dispose) ; "Cedric, go on in the house and pour each of us a nice hot cup of tea."
				(= seconds 5)
			)
			(3
				(cls)
				(wizHead hide: dispose:)
				(crispin setCycle: 0)
				(owlMouth setCycle: Fwd)
				(PrintDC 108 5 #at 10 120 #dispose) ; "Aye, aye, Crispin."
				(= seconds 4)
			)
			(4
				(cls)
			...
			(7
				(crispin setLoop: 1 moveSpeed: 2 setMotion: MoveTo 165 101 self)
			)
			(8
				(crispin dispose:)
				(self dispose:)
