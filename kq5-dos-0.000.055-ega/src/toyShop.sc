...
(instance greet of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Say 192 204 18 67 10 10 25 7) ; "Come on in! Look around! Let me know if you're interested in anything."
				(HandsOn)
				(cls)
				(client setScript: 0)
...
(instance lookSled of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say 192 204 19 67 10 10 25 7) ; "That's a fine sled, isn't it? Any child would love to have it."
				(proc0_7 gEgo toyMaker 5)
				(= cycles 3)
			)
			(2
				(Say 160 204 20 67 10 10 25 6) ; "Yes. I was just admiring the workmanship."
				(RedrawCast)
				(Say 192 204 21 67 10 10 25 7) ; "Thank you. If you'd like to buy it, let me know."
				(= local5 0)
				(= local6 0)
				(mouth dispose:)
				(HandsOn)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Say 160 204 27 67 10 10 25 8) ; "This is a fine little toyshop you have here. You must be very proud."
				(RedrawCast)
				(Say 192 204 28 67 10 10 25 10) ; "Thank you, son. I've worked very hard at it over the years. But you know, you need to really love it... and I do."
				(RedrawCast)
				(Say 160 204 29 67 10 10 25 5) ; "Are most of these toys your creations?"
				(RedrawCast)
				(Say 192 204 30 67 10 10 25 10) ; "Yes, most of them. But not all. Some my son made, some I bought, some I traded for."
				(RedrawCast)
				(Say 160 204 31 67 10 10 25 5) ; "You're very talented."
				(RedrawCast)
				(Say 192 204 32 67 10 10 25 8) ; "Thank you, thank you. Well, let me know if I can help you."
				(= local5 0)
				(= local6 0)
				(HandsOn)
				(mouth dispose:)
...
(instance getSled of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4)
			(5
				(gEgo normal: 1 view: 0 loop: 3 cycleSpeed: 0 setCycle: Walk)
				((gEgo head:) show:)
				(= cycles 3)
			)
			(6
				(switch local4
					(0
						(Say 192 204 33 67 10 10 25 8) ; "Where did you get this wonderful marionette? The craftmanship is excellent!"
						(gEgo put: 12 204) ; Marionette
						(RedrawCast)
						(Say 160 204 34 67 10 10 25 8) ; "Well, I don't know if you'll believe me or not, but I got it from a little gnome."
						(RedrawCast)
						(Say 192 204 35 67 10 10 25 6) ; "I must have it! Can I buy it from you?"
						(RedrawCast)
						(Say 160 204 36 67 10 10 25 6) ; "Actually, you may have it...IF you'll give me the sled in trade."
						(RedrawCast)
						(Say 192 204 37 67 10 10 70 210 25 14) ; "Why, of course! But I must tell you...I think I'm getting the better deal. I can always make another sled, but finding another marionette of this quality...I don't know."
						(RedrawCast)
						(Say 160 204 38 67 10 10 25 5) ; "So, I can have the sled?"
						(RedrawCast)
						(Say 192 204 39 67 10 10 25 5) ; "Yes, yes! Take it. It's yours."
					)
					(1
						(gEgo put: 3 204) ; Golden_Needle
						(Say 160 204 40 67 10 10 25 5) ; "Will you take a golden needle in trade for the sled?"
						(RedrawCast)
						(Say 192 204 41 67 10 10 25 10) ; "This is an awfully small needle, but... I'm in a generous mood today. Okay, why not! Go ahead and take the sled. It's all yours!"
					)
					(2
						(gEgo put: 9 204) ; Heart
						(Say 160 204 42 67 10 10 25 7) ; "Will you take a golden heart in trade for the sled?"
						(RedrawCast)
						(Say 192 204 43 67 10 10 25 10) ; "This beautiful golden heart is worth MUCH more than the little sled! Are you sure about this?"
						(RedrawCast)
						(Say 160 204 44 67 10 10 25 7) ; "Yes, I'm sure. I would like to have the sled."
						(RedrawCast)
						(Say 192 204 45 67 10 10 25 10) ; "Well...okay. But I'm getting the MUCH better deal. Go ahead and take the sled."
					)
					(3
						(gEgo put: 11 204) ; Gold_Coin
						(Say 160 204 46 67 10 10 25 7) ; "Will you take a gold coin in trade for the sled?"
						(RedrawCast)
						(Say 192 204 47 67 10 10 25 10) ; "This gold coin is worth MUCH more than the little sled! Are you sure about this?"
						(RedrawCast)
						(Say 160 204 48 67 10 10 25 7) ; "Yes, I'm sure. I would like to have the sled."
						(RedrawCast)
						(Say 192 204 49 67 10 10 25 10) ; "Well...okay. But I'm getting the MUCH better deal. Go ahead and take the sled."
					)
				)
			...
			(9
				...
				(sled dispose:)
				(gEgo get: 29) ; Sled
				(Say 160 204 50 67 10 100 25 5) ; "Thank you very much. I think I'll find this sled very useful."
				(RedrawCast)
				(switch local4
					(0
						(Say 192 204 51 67 10 10 25 7) ; "Well, you enjoy it. And thank YOU for the marionette."
					)
					(else
						(Say 192 204 52 67 10 10 25 4) ; "Well, you enjoy it."
					)
				)
				(= local5 0)
				(= local6 0)
					...
					(switch global69
						...
						(4 ; Coin
							(if (not (gEgo has: 29)) ; Sled
								...
								(RedrawCast)
								(Say 160 204 57 67 10 10 25 6) ; "Can I buy the sled with a silver coin?"
								(Say 192 204 58 67 10 10 25 8) ; "No, I'm sorry. I'd love to sell it to you, but I'm afraid I need a bit more than that."
							else
								(PrintDC 204 56) ; "Graham sees nothing else of interest in the toyshop."
							)
							(event claimed: 1)
