...
(local
	[local0 18] = [0 142 97 142 113 151 96 160 115 168 108 179 95 182 95 189 0 189]
	...
	[local50 40] = [0 93 27 85 35 93 56 90 69 100 119 96 121 88 137 90 142 98 180 98 200 96 204 93 205 90 240 88 242 53 250 26 161 29 127 34 128 0 0 0]
	local90
	local91
	local92
)
...
(instance giveWheel of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(Say 81 10 0 67 10 10 25 8) ; "Where did you git this? I thought I had lost it."
				(RedrawCast)
				(Say 160 10 1 67 10 90 25 8) ; "Oh, is it yours? I found it in the old witch's house in the Dark Forest."
				(RedrawCast)
				(Say 81 10 2 67 10 10 25 12) ; "So that's where it got to...the old hag took it, eh? You know, this ain't no ordinary spinning wheel."
				(RedrawCast)
				(Say 160 10 3 67 10 90 25 7) ; "It's not? What's so special about it?"
				(RedrawCast)
				(Say 81 10 4 67 10 10 25 12) ; "Why, this spinning wheel can spin straw into GOLD, that's what! 'Cept...you gotta know how to use it."
				(RedrawCast)
				(Say 81 10 5 67 10 10 25 12) ; "I doubt even the witch could figger that out. Thankee for bringin' it back to me."
				(RedrawCast)
				(Say 160 10 6 67 10 80 25 15) ; "Wait! Not so fast! How about that marionette? Don't you think the price of the spinning wheel is worth at least twice that of the puppet? I'd love to have it."
				(youngGnome setScript: 0 loop: 4 cel: 0 setCycle: End self)
			)
			(6
				(Say 81 10 7 67 10 10 25 10) ; "Yeah...I guess so. Boy! Give that there marionette to the man here. I'll make ya a new one."
			...
			(11
				(Say 81 10 8 67 10 10 25 9) ; "Come on, boy. Let's go gather up some wood for a new puppet."
				(youngGnome
					view: 282
					cycleSpeed: 0
					setCycle: Walk
...
(instance converse of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Say 160 10 9 67 10 90 25 3) ; "Excuse me, sir..."
				(RedrawCast)
				(Say 81 10 10 67 10 10 25 8) ; "What're you doin' here? Don't you know this is private property?"
				(RedrawCast)
				(Say 160 10 11 67 10 80 25 8) ; "Oh! I'm terribly sorry to bother you. I was just noticing your son's marionette. It's very interesting. Where did you get it?"
				(RedrawCast)
				(Say 81 10 12 67 10 10 25 8) ; "It's grandson, not son...and I made it fer him. Why d'ya care?"
				(RedrawCast)
				(Say 160 10 13 67 10 90 25 9) ; "I just wanted to comment on its artistry. It's very well done. I don't suppose it could be bought?"
				(RedrawCast)
				(Say 81 10 14 67 10 10 25 14) ; "If it could, the price would be very steep; I reckon you couldn't afford it. Now...leave me and my grandson be!"
				(cls)
				(HandsOn)
				(gnomeHead dispose:)
			...
			(switch (event message:)
				...
				(5 ; Inventory
					(switch global69
						...
						(else
							(Say 81 10 28) ; "I don't take charity, young man. I got everythin' I need."
							(event claimed: 1)
						)
					)
				)
