...
(local
	...
	local5
	local6
	[local7 28] = [109 138 104 155 0 155 0 0 319 0 319 155 158 155 162 141 214 141 246 127 162 120 149 125 140 129 120 133]
)
...
(instance rm023 of Rm
	...
	(method (init)
		(super init:)
		(gGlobalSound number: 42 loop: -1 vol: 127 priority: 15 playBed:)
		...
		(switch (= state newState)
			...
			(1
				(if (not (drawer cel:))
					...
					(gGlobalSound3 number: 793 loop: 1 vol: 127 play:)
					(SetFlag 76)
				else
					(+= state 1)
					(self cue:)
