...
(local
	local0
	local1
	[local2 10] = [148 124 164 127 233 127 229 123 171 119]
	[local12 34] = [185 115 242 112 278 115 319 120 319 0 0 0 0 109 11 107 36 113 64 112 68 108 85 112 142 111 98 58 110 6 194 6 199 48]
)
...
(instance rm213 of Rm
	...
	(method (init)
		(super init:)
		(gEgo view: 2 offset: 2 setPri: -1 setStep: 2 1 init:)
		...
		(proc0_24 128 364 366 378 376)
		(cond
			((and (IsFlag 53) (not (IsFlag 33)) (== gPrevRoomNum 214))
