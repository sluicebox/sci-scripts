...
(local
	[local0 18] = [0 170 25 170 84 143 89 133 173 137 191 122 218 85 69 0 0 0]
...
(instance toad of Act
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 20 2) ; "It seems to Graham that there are an unusual amount of toads in this forest."
					(event claimed: 1)
				)
				(3 ; Do
