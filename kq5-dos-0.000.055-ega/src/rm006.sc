...
(instance rm006 of Rm
	...
	(method (init)
		...
		(= global320 46)
		(= global321 121)
		(gEgo normal: 1 setStep: 2 1 view: 2 offset: 2 init:)
		(smoke init:)
		(if (== global81 3)
			(smoke setCycle: Fwd)
		...
		(= global325 {"I'm getting bored, Graham. Let's move on."})
		(self
			setFeatures: bakeSign river road wind logs house
			setRegions: 202 ; owl
		...
		(if (and (or (gEgo has: 8) (gEgo has: 16)) (not (IsFlag 84))) ; Shoe, Stick
	...
	(method (doit &tmp temp0)
		(cond
			...
			(
				...
				(gEgo setMotion: 0)
				(SetFlag 84)
				(gGlobalSound3 number: 882 loop: -1 vol: 127 play:)
...
(instance openDoor of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gEgo cel: 1)
				(Say 75 6 0 67 50 20 25 4) ; "I'll wait for you out here, Graham."
...
(instance drownHim of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Load rsSOUND 68)
				(Say 75 6 1 67 20 20 25 3) ; "No, don't...!"
				((gEgo head:) hide:)
				(gEgo
					normal: 0
					view: 71
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(PrintDC 6 2 #at 10 10 #dispose) ; "Frantic squeakings alert Graham to a mangy cat chasing a terrified rat."
			...
			(6
				...
				(gGlobalSound3 number: 857 loop: 1 vol: 127 play:)
			)
			(7
				(rat setLoop: 8)
			...
			(9
				(mouth init: setCycle: Fwd)
				(gGlobalSound4 number: 63 loop: 1 vol: 127 play:)
				(PrintDC 6 3 #at 20 120 #width 270 #dispose) ; "Oh, thank you, thank you, good sir! You saved my life! My children and I will never forget your kindness. Maybe someday I will be able to return the favor. Oh! I hear my children calling! Good-bye...until we meet again."
				(= seconds 15)
			)
			(10
				(gGlobalSound4 fade:)
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 6 4 #at 10 10) ; "The cold river courses swiftly by the town bakehouse."
					(event claimed: 1)
				)
				(3 ; Do
