				...
				((Said 'read,look/epitaph,gravestone,boulder')
					(cond
						((& (gEgo onControl: 0) $0008)
							(Print 16 1 #width 255) ; "1643 Here lies Newberry Will, His life was finished 'cause he took ill, But none'll miss him, he should've been wiser, 'Tis his own fault, for bein' such a miser."
						)
						((& (gEgo onControl: 0) $0020)
							(Print 16 2 #width 240) ; "Here lies the body of Mary Ann Lowder, She burst while drinking a seidlitz powder, Called from this world to her heavenly rest, She should have waited till it effervesced."
						)
						((& (gEgo onControl: 0) $0100)
							(Print 16 3 #width 240) ; "To the ever living memory of Hiram Bennet, baby son of Edward and Sarah Bennet, who by a sudden-surprize fell asleep, the 11th day of November, 1553. Aged 6 months."
						)
						((& (gEgo onControl: 0) $0200)
							(Print 16 4) ; "Six feet beneath This funeral wreath Is laid upon the shelf One Jerry Jones, Who dealt in bones, And now he's bones himself."
						)
						((& (gEgo onControl: 0) $0004)
							(Print 16 5) ; "Lord Coningsby 1559 to 1626 Sleepeth here in peace: an honorable man, a valiant soldier. He served his country well."
						)
						((& (gEgo onControl: 0) $0002)
							(Print 16 6 #width 280) ; "I plant these shrubs upon your grave, dear wife, That something on this spot may boast of life. Shrubs must whither and all earth must rot; Shrubs may revive: but you, thank heaven, will not."
						)
						((& (gEgo onControl: 0) $0080)
							(Print 16 7 #width 190) ; "Beneath this stone, a lump of clay, Lies Uncle Peter Dan'els, Who, early in the month of May, Took off his winter flannels."
						)
						((& (gEgo onControl: 0) $0040)
							(Print 16 8 #width 220) ; "Dr. I Letsome When people's ill they come to I, I physics, bleeds, and sweats 'em; Sometimes they live, Sometimes they die; What's that to I? I Letsome."
						)
						((& (gEgo onControl: 0) $0010)
							(Print 16 9 #width 220) ; "Here I lie with my three daughters, Who died drinking Chelt'nam waters. If we had stuck to Epsom Salt, We should not sleep in this cold vault."
						)
						((& (gEgo onControl: 0) $0400)
							(Print 16 10 #width 210) ; "Strong and athletic was my frame; Far from my native home I came, And manly fought with Simon Byrne; Alas! but liv'd not to return. Reader, take warning by my fate, Lest you should rue your case too late; If you have ever fought before, Determine now to fight no more."
						)
						((& (gEgo onControl: 0) $1000)
							(Print 16 11) ; "Thorp's Corpse."
						)
						(else
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= global189 1)
				(= local8 (Sound new:))
				(local8 number: 20 loop: 30000 play:)
			...
			(4
				...
				(if (and (== (-- global186) 0) (gSounds contains: local8))
					(local8 dispose:)
				)
...
(instance z2Actions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (not (gSounds contains: local8))
					(= local8 (Sound new:))
					(local8 number: 20 loop: 30000 play:)
				)
				(++ global186)
