...
(instance Castle of Rm
	...
	(method (init)
		(super init:)
		(= local1 (View new:))
		(local1 view: 767 loop: 0 cel: 3 posn: 270 138 setPri: 15 init:)
		((View new:) view: 768 loop: 0 cel: 0 posn: 158 65 init: addToPic:)
		((View new:) view: 769 loop: 3 cel: 0 posn: 48 140 init: addToPic:)
