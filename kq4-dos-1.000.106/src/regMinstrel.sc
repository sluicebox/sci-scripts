...
(instance regMinstrel of Rgn
	...
	(method (init)
		...
		(if
			(or
				(and (== gCurRoomNum 13) (== gMinstrelRoom 1)) ; R13
				(and (== gCurRoomNum 14) (== gMinstrelRoom 2)) ; Room_14
			...
			(= local2 (Sound new:))
			(local2 number: 19 play: minstrelActions)
						...
						(((Inv at: 9) ownedBy: 203) ; Lute
							...
							(switch local1
								(1
									...
									(= local2 (Sound new:))
									(local2 number: 17 play: minstrelActions)
								)
								(2
									...
									(= local2 (Sound new:))
									(local2 number: 16 play: minstrelActions)
								)
								(3
									...
									(= local2 (Sound new:))
									(local2 number: 15 play: minstrelActions)
								)
								(4
									...
									(= local2 (Sound new:))
									(local2 number: 18 play: minstrelActions)
								)
							)
							(minstrelActions changeState: 1)
						)
