...
(instance Room77 of Rm
	...
	(method (init)
		...
		(switch gPrevRoomNum
			(east
				(gEgo view: 2 posn: 301 162 loop: 1)
				(= local0 10)
				(= local1 20)
				(= global105 12)
...
(instance egoCrawlOut of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gEgo view: 2 xStep: 2 yStep: 1 setLoop: -1 setCycle: Walk)
				(HandsOn)
				(gEgo setScript: 0)
				(= global105 12)
			)
...
(instance egoCrawlIn of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= global105 0)
				(gEgo view: 21 setLoop: 1 cel: 0 setCycle: End self)
				(gEgo setAvoider: Avoid)
			)
			(2
				(gEgo view: 49 setLoop: 1 cel: 0 setCycle: End self)
			)
			(3
				(gEgo
					setLoop: 3
			...
			(4
				(HandsOn)
				(gEgo xStep: 2 yStep: 1 setLoop: -1 setScript: 0)
				(= global205 1)
				(gCurRoom newRoom: 73) ; TrollCave73
			)
		)
	)
)
...
(instance jump of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(if (== (gEgo loop:) 4)
					(gEgo view: 2 loop: 0 cel: 0 xStep: 2 yStep: 2)
				else
