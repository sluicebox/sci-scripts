...
(instance theKeyhole of Script
	...
	(method (init param1)
		...
		((= local3 (Prop new:)) view: 251 loop: 1 posn: 175 66 init: hide:)
		((= local4 (View new:))
			view: 251
			loop: 0
			cel: 0
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(= global166 1)
				(if gNight
					((View new:) view: 647 loop: 3 posn: 184 88 addToPic:)
				)
				(local2 show:)
				(local3
				...
				(local4 show: stopUpd:)
				(= local7 (Print 51 9 #font gSmallFont #at -1 15 #time 12)) ; "The ogre roars, "Fe, fi, fo, fum! I smell the blood of a...""
				(= seconds 2)
			)
			(3
				(local3 setCycle: 0 stopUpd:)
				(Print 51 10 #font gSmallFont #at 7 15 #width 290 #dispose) ; "Quiet, you old goat!" interrupts the ogress. "That's just a deer you smell! You know how you get when you're hungry. Here! Eat!"
				(local3 dispose:)
				(local2 view: 252 loop: 0 cel: 0 posn: 152 89 setCycle: End)
				(= seconds 2)
			)
			(4
			...
			(6
				(local2 loop: 1 cel: 0 setCycle: End self)
			)
			(7
				(local2 loop: 0 cel: 0)
			...
			(8
				(Print 51 11 #font gSmallFont #at -1 20 #time 10) ; "Wife!" shouts the ogre. "Bring me my hen!"
				(= seconds 3)
			)
			(9
				(local5 loop: 1 cel: 0 setCycle: End)
				((gInventory at: 33) moveTo: 49) ; Magic_Hen
				(= seconds 3)
			)
			(10
				(Print 51 12 #font gSmallFont #at -1 20 #draw #time 5) ; ""Lay!" orders the ogre."
				(Print 51 13 #font gSmallFont #at 7 15 #width 290 #dispose) ; "With excitement, you watch the hen lay a golden egg, which the ogre takes. He yawns, then falls asleep on the table. Soon, his snoring rattles the walls."
				(= seconds 5)
			)
			(11
				(local5 dispose:)
		...
		(switch (= state newState)
			...
			(2
				...
				(if (== global165 3)
					...
					(= local7 (Print 51 15 #at -1 20 #draw #dispose)) ; "He's still there..."
				)
				(= seconds 5)
			)
			(3
