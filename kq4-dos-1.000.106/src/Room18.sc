...
(instance Room18 of Rm
	...
	(method (init)
		...
		(switch gPrevRoomNum
			...
			(69
				(gEgo x: 275 y: 153 xStep: 2 yStep: 1 ignoreControl: 16384)
				(door
					posn: 273 149
					view: 611
					loop: 0
					...
					(cond
						...
						((Said 'open')
							(if (gEgo inRect: 262 149 292 157)
								(cond
									((== global174 1)
										(if (not (gSounds contains: local9))
											((Sound new:)
												number: 300
												loop: 1
												play: door
				...
				((Said 'read,look/epitaph,gravestone,boulder')
					(cond
						((& (gEgo onControl: 0) $0004)
							(Print 18 30 #width 215) ; "Betty Cowden 1650 to 1669   Here lieth the body of Betty Cowden Who would live longer but she couden; Sorrow and grief made her decay When she lost her lover at sea one day."
						)
						((& (gEgo onControl: 0) $0080)
							(Print 18 31 #width 245) ; "Whoe'er you are, tread softly, I entreat you, For if he chance to wake, be sure he'll eat you."
						)
						((& (gEgo onControl: 0) $0008)
							(Print 18 32 #width 250) ; "At length, my friends, the feast of life is o'er, I've eat sufficient, and I'll drink no more; My night is come, I've spent a jovial day, 'Tis time to part, but oh!--what is to pay?"
						)
						((& (gEgo onControl: 0) $0020)
							(Print 18 33) ; "1546 Reader, here lies--but forbear To read more without a tear, One--I cannot speak the rest, You may weep. I'll smite my breast, Grief preventing, and this stone, Too small to be written on. Only this--a little boy, Willy--in Abram's bosom's laid."
						)
						((& (gEgo onControl: 0) $1000)
							(Print 18 34 #width 220) ; "Rebecca Freeland 1598 She drank good ale, good punch and wine And lived to the age of 99."
						)
						((& (gEgo onControl: 0) $0002)
							(Print 18 35) ; "1634 to 1672 She done her best."
						)
						((& (gEgo onControl: 0) $0010)
							(Print 18 36 #width 300) ; "Here lies a poor woman who was always tired, She lived in a house where help wasn't hired: Her last words on earth were: "Dear friends, I am going To where there's no cooking, or washing, or sewing, For everything there is exact to my wishes, For where they don't eat there's no washing of dishes, I'll be where loud anthems will always be ringing, But having no voice I'll be quit of the singing, Don't mourn for me now, don't mourn for me never, I am going to do nothing for ever and ever.""
						)
						((& (gEgo onControl: 0) $0100)
							(Print 18 37 #width 220) ; "Dentist Brown Stranger! Approach this spot with gravity! John Brown is filling his last cavity."
						)
						(else
							(Print 800 1) ; "You're not close enough."
						)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= global189 1)
				(= local9 (Sound new:))
				(local9 number: 20 loop: 30000 play:)
				(++ global186)
			...
			(4
				...
				(if (and (== (-- global186) 0) (gSounds contains: local9))
					(local9 dispose:)
				)
			)
			(5
