...
(instance FishermanShack of Rm
	...
	(method (init)
		...
		(if (gEgo has: 1) ; Diamond_Pouch
			((View new:) view: 513 loop: 0 cel: 2 posn: 181 94 addToPic:)
			((= local4 (Act new:))
				view: 241
				loop: 0
				setCycle: Fwd
			...
			((View new:) view: 513 loop: 3 cel: 0 posn: 82 155 addToPic:)
		else
		...
		(if (== global116 3)
			...
			((View new:) view: 513 loop: 3 cel: 1 posn: 138 162 addToPic:)
		)
	)
