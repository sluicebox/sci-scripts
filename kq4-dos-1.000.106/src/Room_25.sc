		...
		(switch global105
			(0
				(switch gPrevRoomNum
					...
					(else
						(gEgo posn: 229 126 setMotion: 0 loop: 1)
					)
				)
			)
			(1
					...
					(if (gEgo inRect: 185 150 319 180)
						(cond
							...
							(
								...
								(gEgo setScript: River_Related_Actions)
							)
							(else
...
(instance River_Related_Actions of Script
	(properties
		name {River Related Actions}
	)
