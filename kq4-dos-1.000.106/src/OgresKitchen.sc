...
(instance OgresKitchen of Rm
	...
	(method (init)
		...
		(super init:)
		(if gNight
			((View new:) view: 647 loop: 2 posn: 244 96 addToPic:)
		)
		((= local2 (Prop new:))
			view: 540
			loop: 0
		...
		(gEgo posn: 77 133 view: 2 setStep: 2 1 init:)
	)
...
(instance ogressChase of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				((= local5 (Sound new:)) number: 10 loop: 1 play:)
				(= global167 1)
				(local0
					view: 245
					cycleSpeed: 0
			...
			(4
				((= local5 (Sound new:)) number: 11 loop: 1 play:)
