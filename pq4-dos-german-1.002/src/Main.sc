...
(procedure (proc0_5 param1 param2 param3 param4 param5)
	(return
...
(class pq4 of Game
	...
	(method (fade param1 param2 param3 &tmp temp0)
		(if (< gHowFast 7)
			(cond
				((< param1 param2)
					(for
	...
	(method (play &tmp temp0 temp1 temp2 temp3)
		...
		(= temp1
			(Str
				newWith:
					(= temp3
						(+ (Message msgSIZE 0 12 0 0 temp0) (Message msgSIZE 0 12 0 7 1)) ; "Copyright (c) 1993 Sierra On-Line Inc.  Thank you for playing Police Quest IV: Open Season."
					)
					{}
			)
		)
		...
		(Message msgGET 0 12 0 7 1 (temp2 data:)) ; "Copyright (c) 1993 Sierra On-Line Inc.  Thank you for playing Police Quest IV: Open Season."
		(temp2 cat: temp1)
	...
	(method (init)
		...
		(= gNarrator Narrator)
		((= gGlobalSound0 globalSound0) owner: self flags: 1 init:)
		((= gGlobalSound1 globalSound1) owner: self flags: 1 init:)
		(Narrator fore: 13)
	...
	(method (quitGame)
		(while 1
			(switch
				(Print
					addBitmap: 64994 1 0
					font: (proc0_5 999 4 999 4 4)
					addText: 14 0 0 1 (proc0_5 0 5 20 5 5) 2 0 ; "Request Code Seven"
					addButtonBM: ; "Continue Patrol"
						64994
						0
						0
						0
...
(instance pqHandsOff of Code
	...
	(method (doit)
		...
		(gTheIconBar disable: 0 1 2 3 4 5 7 6)
		(if (not (HaveMouse))
