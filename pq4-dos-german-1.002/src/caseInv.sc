...
(instance caseInvLook of PQIconItem
	...
	(method (init)
		(self setCursor: 992 0 0 x: 9 y: 5)
		(super init: &rest)
	)
)
...
(instance caseInvHand of PQIconItem
	...
	(method (init)
		(self setCursor: 993 0 0 x: 47 y: 5)
		(super init: &rest)
	)
)
...
(instance caseInvSelect of PQIconItem
	...
	(method (init)
		(self setCursor: 999 0 0 x: 85 y: 5)
		(super init: &rest)
	)
)
...
(instance caseInvHelp of PQIconItem
	...
	(method (init)
		(self setCursor: 989 0 0 x: 122 y: 5)
		(super init: &rest)
	)
)
...
(instance caseOk of PQIconItem
	...
	(method (init)
		(self setCursor: 999 0 0 x: 159 y: 5)
		(super init: &rest)
	)
)
...
(instance caseInvUpArrow of PQIconItem
	...
	(method (init)
		(self setCursor: 999 0 0 x: 183 y: 41)
		(super init: &rest)
	)
...
(instance caseInvDownArrow of PQIconItem
	...
	(method (init)
		(self setCursor: 999 0 0 x: 183 y: 107)
		(super init: &rest)
	)
