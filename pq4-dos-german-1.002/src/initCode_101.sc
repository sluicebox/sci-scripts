	...
	(method (changeState newState)
		(switch (= state newState)
				...
				(switch register
					...
					(2
						(cond
							...
							((== local0 1)
								(= local0 2)
								(gMessager say: 23 2 27 0 self) ; "Well, Raymond, if this is your neighborhood, then you must know what goes on around here. What happened here tonight?"
							)
							(else
								(= local0 1)
			...
			(2
				(switch register
					(0
						(gMessager say: 23 52 0 0 self) ; "The young man's interest appears a bit suspicious. Always"
					)
					(1
...
(instance holster of Feature
	...
	(method (doVerb theVerb)
		(if (OneOf theVerb 1 52) ; Look, notebook
			...
			(gMessager say: 29 1 0 0) ; "An empty holster can mean only one thing,"
		else
			(super doVerb: theVerb)
		)
	)
...
(instance getReportScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(gEgo view: 9033 setLoop: 0 cel: 0 setCycle: CT 6 1 self)
			)
			(8
		...
		(switch theVerb
			(52 ; notebook
				(if (gPqPointFlags test: 1)
					...
					(gGame points: 3 1)
					(gPqPointFlags set: 1)
					(gMessager say: 27 52 0 0) ; "Recording information at the crime scene"
				)
			)
			(38 ; caseChalk
				(if (gPqPointFlags test: 3)
		...
		(switch theVerb
			...
			(52 ; notebook
				(if (gPqPointFlags test: 2)
					...
					(gGame points: 3 2)
					(gPqPointFlags set: 2)
					(gMessager say: 36 52 0 0) ; "Noting that a cigarette lay near the body could"
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance chalkBodyScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gMessager say: 25 38 0 0 self) ; "(Chalking the body is something they only do on"
			)
			(6
				(gGame handsOn:)
				(self dispose:)
...
(instance bodyInsetScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 27 0 14 0 self) ; "The tortured and tormented body of Bob Hickman, LAPD,"
			)
			(2
				(self dispose:)
			)
...
(instance washInset of Inset
	...
	(method (dispose)
		...
		(super dispose:)
		(cop1 setCycle: 0)
		(cop1 view: 1011 setLoop: 2 setCel: 0 x: 244 y: 152)
...
(instance womanScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(cop2 setLoop: 1 cel: 0 setCycle: End self)
			)
			(4
				(cop2Legs
					view: 1005
				...
				(cop2 view: 1005 setLoop: 0 cel: 0 posn: 55 80)
				(= ticks 90)
			)
			(5
				(woman setLoop: 2 setCel: 0 posn: 108 148 setCycle: End self)
			)
			(6
				(woman
					setLoop: 3
			...
			(7
				(gGlobalSound0 number: 100 loop: -1 play:)
				(woman dispose:)
				(gMessager say: 10 0 1 0 self) ; "Monday 3:30 A.M. South Central, Los Angeles"
			...
			(9
				...
				((ScriptID 100 8) x: 10) ; careyTalker
				(coroner view: 107 setCel: 0 setLoop: 1)
				(= cycles 2)
			)
			(10
				(gGame handsOn:)
...
(instance jackScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(jack view: 103 setLoop: 0 setCel: 0 setCycle: End self)
			)
			(2
				(jack setLoop: 1 setCel: 0 setCycle: End self)
			)
			(3
				(cop1 view: 1009 setLoop: 0 cel: 0 setCycle: End self)
			)
			(4
				(cop1 setLoop: 1 cel: 0 setCycle: End self)
			)
			(5
			...
			(8
				(jack setLoop: 0 setCel: 0 setCycle: End self)
			)
			(9
				(cop1
					view: 1010
			...
			(14
				(= local3 1)
				(jack view: 104 setLoop: 0 setCel: 0 setPri: 171)
				(= ticks 15)
			)
			(15
				(jack
...
(instance spiffScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(spiff view: 1000 setLoop: 0 cel: 0 setCycle: End self)
			)
			(2
				(= seconds 10)
			)
			...
			(7
				(spiff view: 1002 setLoop: 1 cel: 0 setCycle: End self)
			)
			(8
				(spiffLegs dispose:)
				(spiff view: 1003 setLoop: 0 setCel: 0 posn: 303 170)
			...
			(10
				(spiff setLoop: 1 cel: 0 setCycle: End self)
			)
			(11
				(= seconds 10)
			)
...
(instance cop2Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(cop2 view: 1005 setLoop: 1 cel: 0 setCycle: End self)
			)
			(5
				(= seconds 3)
			)
			(6
				(cop2 view: 1005 setLoop: 2 cel: 0 setCycle: End self)
				(= state 0)
			)
		)
	)
...
(instance getCigScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(crim view: 1026 setLoop: 0 cel: 0 setCycle: End self)
			)
			(1
				(crim setLoop: 1 cel: 0 setCycle: End self)
			)
			(2
				(self dispose:)
			)
