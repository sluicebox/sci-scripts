				...
				(while 1
					(switch
						(Print
							...
							addText: 14 0 1 1 15 10 725 ; "Think tactics! Think survival!"
			...
			(52 ; notebook
				(cond
					((gPqPointFlags test: 35)
						(gMessager say: noun theVerb 5 0) ; "The gruesome details have already been recorded."
					)
					((gPqFlags test: 153)
						(gGame points: 2 35)
						(gMessager say: noun theVerb 3 0) ; "You record the grisly details of what you've just seen."
					)
					(else
						(gMessager say: noun theVerb 4 0) ; "There is nothing noteworthy to record. Wait on the paperwork!"
					)
				)
			)
			(else
...
(instance openFridge of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo view: 9126 loop: 1 cel: 0 setCycle: End self)
			)
			(1
				(gMessager say: 1 4 0 0 self) ; "You open the refrigerator."
			)
			(2
			...
			(4
				(gEgo view: 9120 heading: 270 normalize: 9120)
				(gGame handsOn:)
				(self dispose:)
			)
		)
		...
		(switch theVerb
			(52 ; notebook
				(if (gPqPointFlags test: 35)
					(gMessager say: 1 theVerb 5 0) ; "The gruesome details have already been recorded."
				else
					(gPqFlags set: 153)
					(gGame points: 2 35)
					(gMessager say: noun theVerb 0 0) ; "You record the gruesome details."
				)
			)
			(else
				(super doVerb: theVerb)
