		...
		(switch (event type:)
			(evSAID
				(cond
					...
					((Said 'talk,look/man,folk,bystander,accountant,programmer')
					...
					(
						(Said
							'sit,explore,get,hit,hit,get,feel/chart,passenger,calendar,board,chair,man,desk,paper,partition'
						)
