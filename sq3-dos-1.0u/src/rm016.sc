	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(localproc_0 {USING STORED POWER\n___BELOW 10%} 1 155 14)
				(= seconds 5)
			)
			(1
				(= global159 0)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(10
				...
				(localproc_1 {UNIT NOT INSTALLED} 89 173 14)
				(= seconds 7)
			)
			(11
				(= global159 0)
