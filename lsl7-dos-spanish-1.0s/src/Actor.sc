...
(class View of Feature
	...
	(method (setScaleDirect param1)
		(self setScale:)
		(if argc
			(= scaleY (= scaleX param1))
		)
	)
...
(class Actor of Prop
	...
	(method (approach param1 param2)
		...
		(cond
			(
				(>
					(GetDistance x y (param1 approachX:) (param1 approachY:))
					(param1 approachDist:)
				)
				(self
					setMotion:
	...
	(method (approachThenFace param1 param2)
		...
		(= facer (FaceCue new:))
		(facer whoToTurn: self whatToFace: param1 whoToCue: param2)
	...
	(method (face param1 param2)
		...
		(self setHeading: (GetAngle x y (param1 x:) (param1 y:)) param2)
	)
