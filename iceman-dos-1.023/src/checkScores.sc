					...
					(
						...
						(if (== ((ScriptID 39 0) notify: 2) 1) ; diceRm
							...
							(switch (Random 0 2)
								...
								(2
									(Print 379 4) ; "The rugged Old Salt chortles, "My, my, my lad! It appears as though yer wings have been clipped again!""
								)
							)
						else
							(if ((ScriptID 39 0) notify: 0) ; diceRm
								(switch (Random 0 1)
									(0
										(Print 379 5) ; ""Ya thought ya had me that time," Flanagan retorts"
									)
									(1
								...
								(switch (Random 0 2)
									...
									(1
										(Print 379 8) ; "The old man exclaims happily, "One more win and the bet'll be mine!""
									)
									(2
										(Print 379 9) ; ""If I win again it'll be a horse for me." chuckles the old sailor"
									)
								)
							)
					...
					(
						...
						(if (== ((ScriptID 39 0) notify: 1) 1) ; diceRm
							...
							(if ((ScriptID 39 0) notify: 5) ; diceRm
								...
								(switch (Random 0 2)
									(0
										(Print 379 10) ; ""All right, that's a horse! The bet's mine." you say."
									)
									(1
										(Print 379 11) ; ""Great, the win gives me the pot," you say as you stare into his eyes."
									)
									(2
							...
							(if ((ScriptID 39 0) notify: 0) ; diceRm
								(switch (Random 0 2)
									(0
										(Print 379 14) ; ""And that's a leg for me. One more will get me a horse," you exclaim."
									)
									(1
										(Print 379 15) ; ""That's one for my side," you reply to no one in particular."
									)
									(2
										(Print 379 16) ; "Your response to the win is, "Let's play!""
									)
								)
							else
								(switch (Random 0 1)
									(0
										(Print 379 17) ; ""Gotcha there on that one, old man! Thought you had me, though." you elaborate."
									)
									(1
										(Print 379 18) ; ""Whew, came from behind on that roll," you sigh."
									)
								)
							)
