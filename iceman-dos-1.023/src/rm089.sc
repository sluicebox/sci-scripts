...
(instance RoomScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				(Print 89 8 #at -1 140 #dispose) ; "The skills you so expertly demonstrated when taking emergency command of the USS Blackhawk have earned you the coveted "Gold Dolphins!"
			...
			(41
				...
				(aCredit2 setLoop: 1 setCel: 1 posn: 240 35 init:)
				(aCredit3 setLoop: 1 setCel: 2 posn: 90 46 init:)
				(aCredit4 setLoop: 1 setCel: 3 posn: 220 46 init:)
				(= seconds 8)
			)
			(42
				(Display 89 15 dsRESTOREPIXELS local0)
