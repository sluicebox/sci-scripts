...
(instance pearl2Script of Script
	...
	(method (changeState newState param2)
		(switch (= state newState)
			...
			(2
				(proc396_0 5 384 1) ; "LEVEL OFF AT 200 FT... CONFIRM WHEN DEPTH ATTAINED."
	...
	(method (handleEvent event)
		(cond
			...
			(
				...
				(cond
					((> state 2)
						(Print 384 9) ; "You already confirmed your depth, Johnny."
					)
					((< state 2)
						(Print 384 10) ; "That is not appropriate now."
					)
					((< 190 (Submarine depth:) 210)
						(self cue: 1)
					)
					(else
						(proc373_7 384 11)
