...
(procedure (localproc_3 param1 &tmp temp0 temp1)
	(= temp0 (+ (/ param1 (proc13_6 7 7 7 7 6)) 1))
	(if (== (= temp1 (mod param1 (proc13_6 7 7 7 7 6))) 0)
		(= temp1 (proc13_6 7 7 7 7 6))
		(-- temp0)
	)
	(= local3 (- (+ (* (- temp1 1) (proc13_6 17 17 17 17 20)) 3) 1))
	(= local4 (+ (* (- temp0 1) (proc13_6 20 20 20 20 24)) 24))
...
(procedure (localproc_4)
	...
	(if (> local18 1)
		(-- local18)
		(-= local16 (proc13_6 17 17 17 17 20))
	else
		(= local18 (proc13_6 9 9 9 9 7))
		(= local16 (proc13_6 271 271 271 271 260))
		(-= local17 (proc13_6 20 20 20 20 24))
	)
)
...
(instance rm302 of Room
	...
	(method (init)
		(= local8 (IDArray new: (proc13_6 54 54 54 54 35)))
		(= local9 (Str new: (proc13_6 54 54 54 54 35)))
		(switch (gGame printLang:)
			(49
				(= local11 (Str with: {XDJBEWACHEGKTUIHMLIEBERNICHTWEH}))
				(= local12
					(Str with: {XDJGEHEIMTREFFENHEUTENACHTBRINGEFWETKASH})
				)
				(= local13 (Str with: {DJBRINGESEKEMADULE}))
				(= local14
					(Str with: {DJGEHEIMTREFFENHEUTENACHTBRINGESEKEMADULE})
				)
			)
			(33
				(= local11 (Str with: {XDJOBSERVEGKMAISEVITEVIOLENCE}))
				(= local12 (Str with: {XDJREUNIONSECRETECESOIRAPPORTEFWETKASH}))
				(= local13 (Str with: {DJAPPORTESEKEMADOULE}))
				(= local14
					(Str with: {DJREUNIONSECRETECESOIRAPPORTESEKEMADOULE})
				)
			)
			(else
		...
		(= local10 0)
		(= local16 (proc13_6 135 135 135 135 140))
		(= local17 (proc13_6 23 23 23 23 30))
		(= local18 1)
		(gGame handsOn:)
		(super init:)
		(= local1 gTheCursor)
	...
	(method (doit)
		(if
			(and
				...
				(<
					gMouseX
					(+ (* (proc13_6 17 17 17 17 20) (proc13_6 7 7 7 7 6)) 3)
				)
				(>= (- gMouseY 10) 22)
				(<
					(- gMouseY 10)
					(+ (* (proc13_6 20 20 20 20 24) (proc13_6 6 6 6 6 5)) 22)
				)
			)
...
(instance messageView of View
	...
	(method (doVerb)
		(if
			...
			(if (<= local10 (- (proc13_6 54 54 54 54 35) 1))
				(gCurRoom setScript: selectChar)
			else
				(switch (gGame printLang:)
					(49
						(Printf {Kein platz mehr zum schreiben})
					)
					(33
						(Printf {Il n'y a plus assez de place sur le mur})
					)
					(else
...
(instance getButton of Code
	...
	(method (doit)
		(= local2
			(+
				(/ (- gMouseX 3) (proc13_6 17 17 17 17 20))
				1
				(*
					(/ (- (- gMouseY 10) 22) (proc13_6 20 20 20 20 24))
					(proc13_6 7 7 7 7 6)
				)
			)
		)
...
(class codeBar of GKIconbar
	...
	(method (drawScore)
		(cond
			((< gScore 10)
				(eFour view: 959 setLoop: 4 cel: gScore posn: 233 3)
				(UpdateScreenItem eFour)
			)
			((< gScore 100)
				(eFour view: 959 setLoop: 4 cel: (/ gScore 10) posn: 231 3)
				(UpdateScreenItem eFour)
				(eFive
					view: 959
					setLoop: 4
			...
			(else
				(eFour view: 959 setLoop: 4 cel: (/ gScore 100) posn: 227 3)
				(UpdateScreenItem eFour)
				(eFive
					view: 959
					setLoop: 4
