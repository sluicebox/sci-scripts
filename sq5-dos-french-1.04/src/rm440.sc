...
(instance rm440 of Rm
	...
	(method (init)
		...
		(gTheIconBar disable: 0 3 4 5 6 1)
		(switch gPrevRoomNum
			(420
	...
	(method (doit)
		(if (== (gTheIconBar curIcon:) (gTheIconBar at: 2))
			(cond
				((InRect 0 25 174 163 gMouseX gMouseY)
					(gGame setCursor: 3270)
				)
				((InRect 175 22 315 162 gMouseX gMouseY)
	...
	(method (handleEvent event &tmp temp0 temp1)
		(if (User controls:)
			(cond
				...
				((and (= temp0 (event message:)) (& (event type:) $0040)) ; direction
					(switch temp0
						(JOY_RIGHT
							(SetCursor 250 100)
							(= gMouseX 250)
...
(instance sInitRoom of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager say: 2 0 0 1 self) ; "Well, well, aren't you an ugly one?"
			)
			(3
				(rogHead stopUpd:)
				(= cycles 2)
			...
			(4
				(gMessager say: 2 0 0 2 self) ; "I was once ugly like you, but look at me now!"
			)
			(5
				(pukoidHead stopUpd:)
				(= cycles 2)
			...
			(6
				(gMessager say: 2 0 0 3 self) ; "Perhaps I can make you pretty like me, hmmm?"
			)
			(7
				(rogHead stopUpd:)
				(= cycles 2)
			...
			(8
				(gMessager say: 2 0 0 4 self) ; "Now try and dodge my death loogies, monkey boy!"
			)
			(9
				(pukoidHead stopUpd:)
				(= cycles 2)
			...
			(10
				(gMessager say: 2 0 0 5 self) ; "Haawwkkkk!"
			)
			(11
				(pukoidHead stopUpd:)
				(= cycles 2)
			...
			(12
				(gMessager say: 2 0 0 6 self) ; "You know, a little hemorrhoidal ointment will clear that rash on your face right up! Now get off me!!"
			)
			(13
				(gGame handsOn:)
				(= cycles 1)
