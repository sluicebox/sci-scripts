	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Display @local213 dsCOORD 40 10 dsCOLOR 254 dsFONT 1307 dsWIDTH 250)
			...
			(2
				(= seconds 0)
				(Display @local213 dsCOORD 40 10 dsCOLOR 0 dsFONT 1307 dsWIDTH 250)
