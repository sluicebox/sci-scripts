...
(instance sFallOff of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 3 0 0 1 self) ; "Help me, Wilco. I'm slipping! If only you had something for me to grab on to!"
			)
			(2
				(= seconds 5)
			)
			...
			(4
				(gMessager say: 14 0 0 1 self) ; "Oh! Those pukoid mutants found me! Do something Wilco!"
			)
			(5
			...
			(7
				(gMessager say: 3 0 0 2 self) ; "Give me your hand or something and I'll climb over you and pull you up after me..."
			)
			(8
				(self dispose:)
			)
...
(instance sByeBea of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gMessager say: 3 0 0 3 self) ; "Wilco!! I can't hold on much longer!"
			)
			(1
				(BeasHead dispose:)
				(BeasArm dispose:)
			...
			(8
				(EgoDead 31) ; "Bea is dead. In an alternate future she would've borne your son. In the future past of Space Quest 4, your son would've saved your life. But she didn't so he couldn't--therefore you aren't."
			)
		)
	)
)
...
(instance sDoOids of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(24
				(EgoDead 40) ; "Looks like you hung around too long. Don't worry, you'll make great compost for some baby mushrooms."
			)
		)
	)
)
