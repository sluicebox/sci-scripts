	...
	(method (init)
		(gCurRoom
			addObstacle:
				((Polygon new:)
					...
					init: 0 75 0 90 153 95 178 90 192 99 208 139 218 139 197 94 292 88 292 80 146 78 121 67 87 39 80 39 88 51 100 73 90 77 0 77
					yourself:
				)
		)
		(super init: &rest)
		(gGlobalSound1 stop:)
		(gGlobalSound2 number: 820 play: 50 setLoop: -1 fade: 127 10 10 0)
		(cardSlot init: approachVerbs: 4 10 stopUpd:) ; Do, badge
		(frontFlowers init:)
		(stairs init:)
		(otherStairs init:)
		(leftTree init:)
		...
		(switch gPrevRoomNum
			...
			(830
				...
				(gEgo posn: 131 91 init: view: 85 loop: 2 setCel: 4)
...
(instance gimmeMyLight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gMessager say: 6 2 7 11 14 self) ; "Here you go. That sure is a powerful flashlight."
			)
			(4
...
(instance helpCurtis of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager say: 6 2 7 1 4 self) ; "Excuse me, sir. May I be of assistance?"
			)
			(3
				(curtis setCycle: 0)
			...
			(5
				(gMessager say: 6 2 7 5 7 self) ; "Does that help?"
			)
			(6
				(= seconds 5)
			)
...
(instance curtisNTheTram of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(20
				(thatOldTram view: 80 ignoreActors: 1 stopUpd:)
				(curtis
					show:
					setCycle: Walk
					setPri: 4
		...
		(switch (= state newState)
			(0
				...
				(if (not (IsFlag 36))
					...
					(gTheIconBar
						disable: (ScriptID 0 3) (ScriptID 0 5) (ScriptID 0 6) ; icon0, icon2, icon3
					)
					((ScriptID 825 1) ; tram
						setCycle: Walk
...
(instance goForSmoke of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(cardSlot setCycle: End self)
				(sFx number: 821 loop: 1 play: 127)
			)
			(8
...
(instance checkOutTram of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo setMotion: PolyPath 131 91 self)
			)
			(1
				(if (not (IsFlag 265))
...
(instance fromTramCU of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(sFx number: 345 loop: 1 play:)
				(gEgo normalize: 900 setMotion: PolyPath 135 78 self)
			)
			(3
				(gEgo setHeading: 180 self)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(sFx number: 823 loop: 1 play: 127)
			)
			(2
				(gMessager say: 2 10 0 0 self) ; "Breathlessly, you insert Cavirrichi Varnet's employee ID card into the slot on the electronic lock and hope there's no careful photo checking required."
			)
			(3
...
(instance grabFence of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(sFx number: 403 play: 127 setLoop: -1)
				(gEgo setCycle: End self)
			)
			(4
			...
			(6
				(sFx number: 520 loop: 1 play: 127)
				(gEgo setCycle: End self)
			)
			(7
				(= seconds 3)
