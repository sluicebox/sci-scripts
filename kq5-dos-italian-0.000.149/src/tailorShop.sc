			...
			(switch (event message:)
				...
				(4 ; Inventory
					(switch (gInventory indexOf: (gTheIconBar curInvIcon:))
						...
						(26
							(proc0_28 105 203 47 67 20 20 25 7) ; "I hope you enjoy your fine cloak."
							(event claimed: 1)
						)
						(else
							(proc0_28 105 203 48 67 20 20 25 10) ; "No, that doesn't even begin to cover the cost of the material."
							(event claimed: 1)
						)
					)
				)
