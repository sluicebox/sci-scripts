	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(PrintDC 6 3 #at 10 10 #dispose) ; "Frantic squeakings alert Graham to a mangy cat chasing a terrified rat."
			...
			(9
				...
				(PrintDC 6 4 #at 20 120 #width 270 #dispose) ; "Oh, thank you, thank you, good sir! You saved my life! My children and I will never forget your kindness. Maybe someday I will be able to return the favor. Oh! I hear my children calling! Good-bye...until we meet again."
				(= seconds 15)
			)
			(10
				(gGlobalSound4 fade:)
