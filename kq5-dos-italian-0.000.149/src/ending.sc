...
(instance cartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(PrintDC 120 0 #at (LangSwitch 120 110) 160 #dispose) ; "NOW why won't you work?!"
				(= seconds 3)
			)
			(7
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(15
				...
				(cls)
				(PrintDC 120 8 #at (LangSwitch 120 115) 150 #dispose) ; "Valanice! My children! My joy knows no limits!"
				(= seconds 4)
			)
			(16
				((gEgo head:) setCel: 0)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				...
				(PrintDC 120 11 #at 115 140 #dispose) ; "All right! Now that we're done with the formalities, let's get on with business, shall we?"
				(= seconds 7)
			)
			(12
				(crispin setLoop: 7)
			...
			(49
				...
				(crispin setLoop: 9)
				(crispin setCycle: RandCycle)
				(PrintDC 120 23 #at 110 (LangSwitch 160 150) #dispose) ; "Cedric, it sure is good to see YOU again!"
				(= seconds 5)
			)
			(50
				(cls)
				(cedricHead show:)
				(crispin setCycle: 0)
				(PrintDC 120 24 #at (LangSwitch 180 175) 80 #dispose) ; "Likewise, I'm sure."
				(= seconds 3)
			)
			(51
				(cls)
			...
			(60
				...
				(crispin setLoop: 9)
				(crispin setCycle: RandCycle)
				(PrintDC 120 30 #at 110 145 #dispose) ; "All in a day's work, my boy. All in a day's work. Right, Cedric?"
				(= seconds 7)
			)
			(61
				(crispin setCycle: Beg self)
