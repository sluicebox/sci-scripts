...
(instance sceneOneScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local1 (Display 100 0 dsCOORD 80 100 dsWIDTH 320 dsALIGN alCENTER dsFONT 8 dsCOLOR 0)) ; "CASTELLO DI DAVENTRY"
				(= local0
					(Display ; "CASTELLO DI DAVENTRY"
						100
						0
						dsCOORD
						79
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(PrintDC 100 1 #at 10 10 #dispose) ; "Avanti! Buttati!"
			...
			(7
				(PrintDC 100 2 #at 10 10 #dispose) ; "Seguimiii...!"
