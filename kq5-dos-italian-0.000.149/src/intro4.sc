	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 103 0 #at 10 10 #dispose) ; "So cosa \8a accaduto al tuo castello. Ho visto tutto. Credimi."
			...
			(2
				...
				(= global380 1)
				(PrintDC 103 1 #at 80 20 #dispose) ; "Hai visto tutto? Bene, allora ...cosa \8a successo?"
				(= seconds (LangSwitch 5 8))
			)
			(3
...
(instance sceneSevenScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(egoMouth setCycle: Fwd)
				(PrintDC 103 2 #at 10 130 #dispose) ; "Perch\8a? Perch\8a questo mago... Mordack... dovrebbe desiderare il mio castello? Cosa potrebbe avere contro me e la mia famiglia?"
			...
			(2
				...
				(owlFace setCycle: Fwd)
				(= global380 1)
				(PrintDC 103 3 #at 10 10 #width (LangSwitch 200 285) #dispose) ; "Questo non lo so. So solo che \8a stato Mordack a prendere il tuo castello...e la tua famiglia."
