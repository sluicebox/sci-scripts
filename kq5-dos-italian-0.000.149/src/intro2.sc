	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(= local5 1)
				(= local3
					(Display 101 0 dsCOORD 70 10 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Produttore Esecutivo"
				)
				(= local2
					(Display 101 1 dsCOORD 70 26 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Ken Williams"
				)
				(= local1
					(Display ; "Produttore Esecutivo"
						101
						0
						dsCOORD
						69
			...
			(2
				(= local3
					(Display 101 3 dsCOORD 11 75 dsWIDTH 120 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Direttore Creativo"
				)
				(= local2
					(Display 101 4 dsCOORD 11 91 dsWIDTH 120 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Bill Davis"
				)
				(= local1
					(Display ; "Direttore Creativo"
						101
						3
						dsCOORD
						10
			...
			(4
				(= local3
					(Display 101 5 dsCOORD 70 10 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Disegnato e prodotto da"
				)
				(= local2
					(Display 101 6 dsCOORD 70 26 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Roberta Williams"
				)
				(= local1
					(Display ; "Disegnato e prodotto da"
						101
						5
						dsCOORD
						69
			...
			(6
				(= local3
					(Display 101 7 dsCOORD 121 24 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Direttore Artistico"
				)
				(= local2
					(Display 101 8 dsCOORD 121 40 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Andy Hoyos"
				)
				(= local1
					(Display ; "Direttore artistico"
						101
						9
						dsCOORD
						120
			...
			(8
				(= local3
					(Display 101 10 dsCOORD 21 11 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Capo programmatore"
				)
				(= local2
					(Display 101 11 dsCOORD 21 27 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Chris Iden"
				)
				(= local1
					(Display ; "Capo Programmatore"
						101
						12
						dsCOORD
						20
			...
			(10
				(= local3
					(Display 101 13 dsCOORD 11 75 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Direttore musicale"
				)
				(= local2
					(Display 101 14 dsCOORD 11 91 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Mark Seibert"
				)
				(= local1
					(Display ; "Direttore musicale"
						101
						13
						dsCOORD
						10
