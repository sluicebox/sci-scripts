	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 104 0 #at 140 100 #width 150 #dispose) ; "E' stato il potente e cattivo mago Mordack a farlo. Stavo proprio facendo visita ad un vecchio amico quando l'ho visto materializzarsi dal nulla. Grazie al cielo non MI ha visto!"
			...
			(3
				...
				(= global380 1)
				(gEgo setCycle: Fwd)
				(PrintDC 104 1 #at 10 30 #dispose) ; "Non fermarti ora! Vai avanti!"
				(= seconds 11)
			)
			(4
