...
(instance sceneThreeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(PrintDC 102 0 #at 100 100 #dispose) ; "Il mio castello! Cosa \8a successo?"
			...
			(8
				(PrintDC 102 1 #at 10 10 #dispose) ; "Te lo dico io cosa \8a successo."
			...
			(12
				(cls)
				(= global380 1)
				(PrintDC 102 2 #at 100 100 #dispose) ; "Cosa?!"
