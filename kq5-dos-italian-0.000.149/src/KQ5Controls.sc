...
(instance gcWin of BorderWindow
	...
	(method (open &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 [temp14 45] [temp59 4])
		...
		(= back (KQ5Window back:))
		(super open:)
		(DrawCel 944 0 0 1 0 -1)
		(DrawCel 944 0 1 1 (localproc_0 127 127 127 127 138) -1)
		(DrawCel 944 0 2 (localproc_0 224 230 230 230 184) 0 -1)
		(DrawCel
			944
			0
			3
			(localproc_0 224 230 230 230 184)
			(localproc_0 127 127 127 127 138)
			-1
		)
		(Graph
			grDRAW_LINE
		...
		(Graph
			grDRAW_LINE
			(+ (CelHigh 944 0 0) (localproc_0 124 124 124 124 135))
			11
			(+ (CelHigh 944 0 0) (localproc_0 124 124 124 124 135))
			(localproc_0 224 230 230 230 184)
			(KQ5Window lineColor:)
		...
		(Graph
			grDRAW_LINE
			(+ (CelHigh 944 0 0) (localproc_0 126 126 126 126 137))
			11
			(+ (CelHigh 944 0 0) (localproc_0 126 126 126 126 137))
			(localproc_0 224 230 230 230 184)
			(KQ5Window lineColor:)
		...
		(Graph
			...
			10
			1
			(+ (CelWide 944 0 0) (localproc_0 126 126 126 126 138))
			1
			(KQ5Window lineColor:)
			temp12
			-1
		...
		(Graph
			grDRAW_LINE
			10
			(+ (CelWide 944 0 0) (localproc_0 221 227 227 227 181))
			(localproc_0 126 126 126 126 138)
			(+ (CelWide 944 0 0) (localproc_0 221 227 227 227 181))
			(KQ5Window lineColor:)
			temp12
			-1
		...
		(Graph
			grDRAW_LINE
			10
			(+ (CelWide 944 0 0) (localproc_0 223 229 229 229 183))
			(localproc_0 126 126 126 126 138)
			(+ (CelWide 944 0 0) (localproc_0 223 229 229 229 183))
			(KQ5Window lineColor:)
			temp12
		...
		(Graph grUPDATE_BOX 0 11 3 (localproc_0 224 231 231 231 184) 1)
		(Graph
			grUPDATE_BOX
			(+ (CelHigh 944 0 0) (localproc_0 124 124 124 124 135))
			11
			(+ (CelHigh 944 0 0) (localproc_0 127 127 127 127 138))
			(localproc_0 224 231 231 231 184)
			1
		)
		(Graph grUPDATE_BOX 10 1 (localproc_0 127 127 127 127 138) 4 1)
		(Graph
			grUPDATE_BOX
			10
			(+ (CelWide 944 0 0) (localproc_0 221 227 227 227 181))
			138
			(+ (CelWide 944 0 0) (localproc_0 223 229 229 229 184))
			1
		)
		(DrawCel
			(localproc_1)
		...
		(DrawCel
			...
			1
			0
			(+ 67 (localproc_0 -2 4 4 1 0) (localproc_0 42 41 41 41 27) 10)
			48
			-1
		)
		(DrawCel
			...
			(+
				67
				(localproc_0 -2 4 4 1 0)
				(- (+ 40 (localproc_0 10 15 15 15 0)) (localproc_0 3 8 8 -4 0))
		...
		(DrawCel
			...
			0
			4
			(+ (- (+ 67 (localproc_0 -2 4 4 1 0)) (localproc_0 -2 0 0 0 4)) 10)
		...
		(= temp5
			(+
				(= temp2
					(+
						(localproc_0 6 3 3 3 9)
						37
						(CelHigh (localproc_1) 0 1)
						10
					)
				)
				13
		...
		(Format @temp14 755 1 gScore gPossibleScore gScore gPossibleScore) ; "Score: %d/%d"
...
(instance detailSlider of Slider
	...
	(method (init)
		(= view (localproc_1))
		(= nsLeft (+ 67 (localproc_0 -2 4 4 1 0) 10))
		(= nsTop 47)
	...
	(method (show)
		...
		(= nsLeft
			(localproc_0
				(+ 67 (localproc_0 -2 4 4 1 0) 20)
				(+ 67 (localproc_0 -2 4 4 1 0) 20)
				(+ 67 (localproc_0 -2 4 4 1 0) 20)
				(+ 67 (localproc_0 -2 4 4 1 0) 20)
				(+ 67 (localproc_0 -2 4 4 1 0) 10)
			)
		)
		(= sliderView (localproc_1))
		(= nsTop 47)
