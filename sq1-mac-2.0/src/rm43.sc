			...
			(2 ; Look
				(Printf ; "This is a seedy little place. Galactic riff-raff are seated at the bar. %s. There is a slot machine standing near the bar. You notice a sweeper in the corner of the room. It must get messy here. No one seems to notice or care that you have entered the bar."
					...
					(switch global170
						...
						(else {On stage, a strangely attired woman performs her act (if that's what you want to call it). You haven't had a girlfriend for a long time (more like forever), but even that's not enough to make her attractive.})
					)
				)
			)
			(12 ; Smell
...
(instance fenris of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(5 ; Talk
				(Print 43 72 #at 100 68) ; ""Can I offer you a Milk-Bone?" you inquire in an attempt to be friendly."
			...
			(4 ; Inventory
				(switch invItem
					...
					(2 ; Gadget
						(Print 43 79) ; "Since he isn't inclined to talk to you, there's not much point trying to translate."
					)
					(4 ; Knife
					...
					(11 ; Jetpack
						(Print 43 82) ; "You wonder why you're offering this giant hairball your new jetpack and are forced to admit you don't know."
					)
					(17 ; Bar_Coupon
		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(5 ; Dehydrated_Water
						(Print 43 89) ; "No, dummy - he's supposed to give YOU drinks."
					)
					(11 ; Jetpack
						(Print 43 90) ; "The bartender does not recognize your jetpack as currency. He wants to see Buckazoids."
					)
					(else
		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(5 ; Dehydrated_Water
						(Print 43 101) ; "He doesn't seem to be thirsty."
					)
					(11 ; Jetpack
