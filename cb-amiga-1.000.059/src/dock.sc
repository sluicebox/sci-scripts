...
(instance dock of Rm
	...
	(method (doit)
		...
		(if (and (== (skiff x:) 30) (== (skiff y:) 147))
			...
			(= local0 (Display 781 2 dsCOORD 11 12 dsWIDTH 240 dsCOLOR 0 dsBACKGROUND -1 dsFONT 41 dsSAVEPIXELS)) ; "Amiga Version   Robert W. Lindsley   John Rettig   Steve Coallier"
			(= local1
				(Display 781 2 dsCOORD 10 10 dsWIDTH 240 dsCOLOR 15 dsBACKGROUND -1 dsFONT 41 dsSAVEPIXELS) ; "Amiga Version   Robert W. Lindsley   John Rettig   Steve Coallier"
			)
		)
...
(instance Heads of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Print 781 3 #at 10 65 #font 4 #width 100 #mode 1 #draw #dispose) ; "We're here, Laura!"
				(= cycles 1)
			)
			(2
