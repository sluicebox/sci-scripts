...
(instance rm340 of GloryRm
	...
	(method (init)
		...
		(torch1 init: setPri: 130 setCycle: Fwd)
		(torch2 init: setPri: 130 setCycle: Fwd)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(= local6 1)
				(SetFlag 241)
				(gEgo solvePuzzle: 512 2 4 get: 24 get: 5 3 useSkill: 9 400) ; theToolkit, theThrowdagger, pick locks
				(SetFlag 512)
...
(instance heroTeller of Teller
	...
	(method (showCases)
		(super showCases: 100 (IsFlag 389) 101 (IsFlag 71)) ; Old Man's House, Burgomeister's Office
	)
)
