		...
		(switch theVerb
			...
			(81 ; detectMagicSpell
				(if (IsFlag 115)
					...
					(gMessager say: 0 81 0 0) ; "You sense magic radiating from the staff and protecting this area."
				)
			)
			(else
...
(instance sChildSacrifice of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(gMessager say: 5 6 16 0 self) ; "The voice again is heard within your head."
			)
			(10
				(aStaff
					setLoop: 4 1
			...
			(11
				(gMessager sayRange: 5 6 17 1 2 self) ; "The voice in your head is now faint."
			)
			(12
				(pToby setLoop: 0 1 setCel: 0 cycleSpeed: 18 setCycle: End self)
			)
			(13
				(gMessager sayRange: 5 6 17 3 9 self) ; "You see Toby silently nod his head."
			)
			(14
			...
			(22
				(pToby hide: dispose:)
				(gMessager say: 5 6 18 0 self) ; "You hear the Voice of the Staff faintly in your head: "So is the Sacrifice complete! I am again the Staff of Erana.""
			)
			(23
		...
		(switch (= state newState)
			...
			(6
				...
				(switch local0
					...
					(6
						(gMessager say: 1 6 6 0 self) ; "There is a woman who sorrows, whose heart cannot bare the loss of one so dear."
					)
					(7
