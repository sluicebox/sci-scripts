...
(class hero of Actor
		...
		(return
			(if (== theVerb 10) ; Jump
				...
				(switch theVerb
					...
					(1 ; Look
						(= temp4 (Str new:))
						(Message msgGET 28 2 1 0 1 (temp4 data:)) ; "My, %s, you're looking heroic today!"
						(= temp5 (Str new:))
	...
	(method (addHonor param1 &tmp temp0 temp1)
		(/= param1 5)
		(= temp0
			(if global394
				(- (+ global394 [gEgoStats 14]) global361) ; honor
	...
	(method (castSpell param1 param2 &tmp temp0)
		...
		(if (< [gEgoStats 19] [global367 (- param1 20)]) ; mana
			...
			(return
				(self useMana: [global367 (- param1 20)] trySkill: param1 0)
			)
		)
	)
