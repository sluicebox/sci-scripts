...
(class InvIcon of DIcon
	...
	(method (onMe param1)
		(return (and (< 2 (param1 y:) 110) (super onMe: param1 &rest)))
	)
	...
	(method (handleEvent &tmp temp0 temp1)
		...
		(if (!= noun -1)
			...
			(cond
				(
					(or
						(OneOf noun 140 246 247 249 87 228 229 88)
						(OneOf noun 89 90 230 230 91 92 173 93)
						(OneOf noun 94 95 96 97 98 99 100 253)
						(OneOf noun 254 136 137 138 139 163 106 239)
						(OneOf noun 107 232 235 252 234 236 237 109)
						(OneOf noun 110 111 112 114 116 118)
						(OneOf noun 174 158 117 159)
					)
					(gMessager say: noun 62 0 temp0 0 2000)
				)
				(
					(or
						(OneOf noun 121 122 162 127 128 181 185 186)
						(OneOf noun 123 124 125 141 142 143 144 145)
						(OneOf noun 146 126 182 183 184 188 189 175)
						(OneOf noun 190 238 191 147 148 149 150 201)
						(OneOf noun 161 202 203)
					)
					(gMessager say: noun 62 0 temp0 0 2010)
				)
				(
					(or
						(OneOf noun 204 205 206 207 208 209 244 211)
						(OneOf noun 212 155 156 214 217 157 164 165)
						(OneOf noun 166 167 168 169 170 171 172)
						(OneOf noun 213 220 223 226 233 248 250 151)
						(OneOf noun 152 153 154 251)
					)
					(gMessager say: noun 62 0 temp0 0 2020)
				)
				(else
	...
	(method (doVerb theVerb)
		(cond
			((== theVerb 75) ; invMagazine
				...
				(Load rsVIEW 9943)
				(gMessager say: 113 62 0 1 0 2000) ; "(CLICK TAPE RECORDER ON MAGAZINE, SLY)Hmmm. That's a thought."
			...
			((== theVerb 117) ; invVonZellTape
				(if (IsFlag 678)
					(gMessager say: 186 62 0 1 0 2010) ; "\9abergrau told me what the tape says."
				else
					(gMessager say: 185 62 0 1 0 2010) ; "I'm sure whatever they said is in German. I need a translator."
				)
			)
			(else
...
(instance invEvidenceReport of GK2Inventory
	...
	(method (handleEvent)
		(gMessager say: noun 62 0 0 0 2000) ; "(LOOK AT EVIDENCE ANALYSIS REPORT FROM MICHAEL)So much for the old zoo wolves theory. Unfortunately, the report doesn't exactly reek of another solution."
		(return 1)
	)
)
...
(instance invWerewolfBook of GK2Inventory
	...
	(method (handleEvent event)
		(switch pageNum
			(1
				(gMessager say: noun 62 0 1 0 2010) ; MISSING MESSAGE
			)
			(2
				(gMessager sayRange: noun 62 0 2 4 0 2010) ; MISSING MESSAGE
			)
			(3
				(if (not event)
					(gMessager sayRange: noun 62 0 5 6 0 2010) ; MISSING MESSAGE
				else
					(gMessager sayRange: noun 62 0 7 8 0 2010) ; MISSING MESSAGE
				)
			)
			(4
				(if (not event)
					(gMessager sayRange: noun 62 0 9 10 0 2010) ; MISSING MESSAGE
				else
					(gMessager sayRange: noun 62 0 11 12 0 2010) ; MISSING MESSAGE
				)
			)
			(5
				(cond
					((not event)
						(gMessager sayRange: noun 62 0 13 14 0 2010) ; MISSING MESSAGE
					)
					((and (== gEgo GraceEgo) (not (IsFlag 452)))
						(SetFlag 452)
						(gMessager sayRange: noun 62 0 15 16 0 2010) ; MISSING MESSAGE
					)
					(else
						(gMessager say: noun 62 0 15 0 2010) ; MISSING MESSAGE
					)
				)
			)
		)
...
(instance invVictorJournal of GK2Inventory
	...
	(method (handleEvent event)
		(if (== gEgo GabeEgo)
			(gMessager say: 158 62 0 0 0 2000) ; "(PLAYER TRIES TO READ HISTORICAL JOURNALS SENT BY GRACIE)I don't have time to worry about this historical stuff at the moment. I don't think it's got much to do with what's goin' on here in Munich."
			(return 1)
		)
		(switch pageNum
			(1
				(if event
					(gMessager say: noun 62 0 3 0 2000) ; "(VICTOR RITTER'S JOURNAL CONT'D)It was a newling lamb we loosed in the thicket as a lure. We awaited down-wind. For two night, the lamb bleated to no purpose and once we had to fend off a hungry fox. But, at last, the beast himself took the bait. I might have missed him -- the night was so dark and the wolf himself was black, but my assistant saw the light of his eyes, and I heard the lamb's cries turn fearful. He had the poor dumb lamb by the throat when we sprang."
				else
					(gMessager sayRange: noun 62 0 1 2 0 2000) ; "(READING VICTOR RITTER'S JOURNAL)Numerous deaths at the hands of a marauding wolf being recorded in a neighboring county, I set out to see if I could determine the cause. There had been rumors of a werewolf, and the dark signs did indeed seem to be present."
				)
			)
			(2
				(if event
					(gMessager sayRange: noun 62 0 6 7 0 2000) ; "(VICTOR RITTER'S JOURNAL CONT'D)God be praised for aiding his servant. From his hand came the strength and wisdom to end the killing."
				else
					(gMessager sayRange: noun 62 0 4 5 0 2000) ; "(VICTOR RITTER'S JOURNAL CONT'D)He was swift and might have escaped, but his fatal mistake was to attack rather than run. My dagger struck through his chest and into his right lung."
				)
			)
		)
	)
...
(instance invLudwigLetter of GK2Inventory
	...
	(method (handleEvent)
		...
		(switch pageNum
			(1
				(gMessager sayRange: noun 62 0 1 2 0 2000) ; "(READING LETTER TO LUDWIG FROM CHRISTIAN RITTER)4, Marz. 1864 To King Ludwig II, most gracious ruler of all Bavaria:  I beg your forgiveness for my forthrightness in this letter, but I fear terribly for your Majesty's safety and thus have no time for subtlety."
			)
			(2
				(if (IsFlag 881)
					(gMessager sayRange: noun 62 0 3 4 0 2000) ; "(LETTER TO LUDWIG CONT'D)I BEG your Highness only this--please do not see this man alone nor even with your servants only to guard you. I promise you, all will be made clear very shortly when my investigation is complete. For now, only keep yourself safe."
				else
					(gGame changeScore: 881)
					(if (IsFlag 897)
						(SetFlag 36)
						(gMessager sayRange: noun 62 0 3 5 0 2000) ; "(LETTER TO LUDWIG CONT'D)I BEG your Highness only this--please do not see this man alone nor even with your servants only to guard you. I promise you, all will be made clear very shortly when my investigation is complete. For now, only keep yourself safe."
					else
						(gMessager sayRange: noun 62 0 3 4 0 2000) ; "(LETTER TO LUDWIG CONT'D)I BEG your Highness only this--please do not see this man alone nor even with your servants only to guard you. I promise you, all will be made clear very shortly when my investigation is complete. For now, only keep yourself safe."
					)
				)
...
(instance invGraceLetter2 of GK2Inventory
	...
	(method (handleEvent)
		(if (or (IsFlag 550) (== gEgo GraceEgo))
			(gMessager sayRange: noun 62 0 1 5 0 2000) ; "March 18, 1994  Gabriel: You might as well know, I'm in Rittersberg. I wasn't about to sit in New Orleans and let you have all the fun. Besides, if it goes anything like last time, you're going to need my help."
		else
			(SetFlag 550)
			(gMessager sayRange: noun 62 0 1 7 0 2000) ; "March 18, 1994  Gabriel: You might as well know, I'm in Rittersberg. I wasn't about to sit in New Orleans and let you have all the fun. Besides, if it goes anything like last time, you're going to need my help."
		)
	)
)
	...
	(method (handleEvent event &tmp temp0)
		(switch pageNum
			(1
				...
				(gMessager say: temp0 62 0 0 0 2000)
			)
			(2
				(gMessager sayRange: 118 62 0 1 3 0 2000) ; "(READING BIOGRAPHY)Ludwig remained throughout his life both very bright and very naive. He was an introvert who seemed to be constantly out-of-sync with traditional views of rulership, money, and human relationships. The world ever failed to match his ideals. Perhaps this was the fault of his sheltered upbringing as future king. He never was introduced to the real world, and the real world failed to interest him as an adult."
			)
			(3
				(gMessager sayRange: 119 62 0 1 2 0 2000) ; "(READING BIO)Other than his long-standing friendship with the Empress Elizabeth of Austria and with his mother, the relationships Ludwig attempted with others were nearly always a disappointment for him and a bewilderment for his partners. He would become obsessed with someone -- a singer, an artist, a nobleman, or a peasant, and would bombard them with gifts, praise and favors."
			)
			(4
				(if event
					(if (and (IsFlag 288) (not (IsFlag 575))) ; "The Black Wolf" in rm8412Topic
						(SetFlag 575)
						(gMessager sayRange: 120 62 0 4 5 cueScript 2000) ; "(READING BIO)His Majesty has been in the thick of it ever since and, while I welcome his good temper, I grow tired of fetching letters back and forth to 'Louis' (so called by His Majesty -- that should tell you who the young man looks like) at all hours of the night!""
					else
						(gMessager say: 120 62 0 4 cueScript 2000) ; "(READING BIO)His Majesty has been in the thick of it ever since and, while I welcome his good temper, I grow tired of fetching letters back and forth to 'Louis' (so called by His Majesty -- that should tell you who the young man looks like) at all hours of the night!""
					)
				else
					(gMessager sayRange: 120 62 0 1 3 0 2000) ; "(READING BIO)A good example of the king's obsessive behavior in relationships is the following letter from the K\94niglich Bayerische Archives, which this author was priviledged to access. It is dated 1864 and it was written by Ludwig's manservant, Paul, to a friend."
				)
			)
			(5
				(gMessager sayRange: 122 62 0 1 2 0 2010) ; "(READING BIO)The king, especially later in life, felt a great deal of guilt about his sensual nature. His diaries are full of repentant entries begging God for forgiveness and swearing to remain pure."
			)
		)
	)
)
...
(instance cueScript of Script
	...
	(method (cue)
		(gMessager say: 121 62 0 0 0 2010) ; "(READING BIO)This author has not been able to learn much about 'Louis,' but he was known to have been a seemingly high-bred foreigner and he was involved with Ludwig as late as 1880, when he fell into disfavor."
	)
)
	...
	(method (doVerb theVerb)
		(cond
			...
			((== theVerb 21) ; invMatches
				(gMessager say: 192 62 0 1 0 2010) ; "(TRY TO LIGHT LANTERN SOMEWHERE EXCEPT CAVE)I don't need the light here."
				(return 0)
			)
			(else
				(super doVerb: theVerb)
...
(instance invVonGlowerLetter of GK2Inventory
		...
		(switch pageNum
			...
			(1
				(if (not (gEgo has: 5)) ; invTalisman
					...
					(gMessager say: 161 62 0 1 0 2020) ; MISSING MESSAGE
	...
	(method (handleEvent)
		(switch pageNum
			(1
				(gMessager sayRange: noun 62 0 1 3 0 2020) ; "(LETTER TO GABE, CH 6)Gabriel. I know you are very ill right now. The change is always painful. I went through it myself when I was only twelve, and I did not even know what was happening to me."
			)
			(2
				(gMessager sayRange: noun 62 0 4 5 0 2020) ; "You will need me then and, I think, you will WANT me then. It is for hope of this that I did not have you destroyed the night you were bitten by von Zell. I could have done. You were passed out for hours at the lodge."
			)
			(3
				(gMessager sayRange: noun 62 0 6 8 0 2020) ; "I have even, very rarely, taken the risk and Changed others. But the Blood was always too much for the brain, and my Chosen One ended up dead. Or mad."
			)
			(4
				(gMessager sayRange: noun 62 0 9 10 0 2020) ; "But you are different. You're a Ritter. Your blood is ALREADY supernatural. Yes, I know of your family. I have studied much over these long years. When we met, I felt somehow that you would not be destroyed by the Gift. You have an enormous streak of the beast in you, and you are innately strong in the Occult."
			)
			(5
				(gMessager sayRange: noun 62 0 11 12 0 2020) ; "He had to be taken care of and you obligingly showed up. What was I to do? I am too old not to have learned at least this much about the light -- you cannot shut it out. Better to let it in and let it simply dim to adjust to the relative brightness INSIDE."
			)
			(6
				(if (IsFlag 705)
					(gMessager sayRange: noun 62 0 13 14 0 2020) ; "You can feel the night wind on your face, taste the heartbeat of the kill beneath your jaws. It is glorious -- much more so than the priestly life the Schattenjager offers."
				else
					(SetFlag 705) ; enable "Von Glower's Letter" in smithTopicCh6
					(gMessager sayRange: noun 62 0 13 15 0 2020) ; "You can feel the night wind on your face, taste the heartbeat of the kill beneath your jaws. It is glorious -- much more so than the priestly life the Schattenjager offers."
				)
			)
		)
	)
...
(instance invOperaProgram of GK2Inventory
	...
	(method (handleEvent event)
		(switch pageNum
			(1
				(if (not event)
					(gMessager sayRange: 164 62 0 1 4 0 2020) ; "(PICKUP, READING OPERA PROGRAM IN INVENTORY)The Curse of Englehart by Richard Wagner. Act I."
				else
					(gMessager sayRange: 165 62 0 1 4 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)The other villagers, assuming that the blacksmith's behavior toward Engelhart must be deserved, followed suit. Now in the same town there lived a rich Baron. The Baron maintained a patronly and righteous face with the villagers, but it was rumored that he was actually unspeakably cruel and wicked."
				)
			)
			(2
				(if (not event)
					(gMessager sayRange: 166 62 0 1 3 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)Hildegunde -- overcome by her fear and anger at the betrothal -- casts the jewelry box into the fire. She is immediately remorseful and pulls it out, but it is too late. The delicate silver has been badly marred."
				else
					(gMessager sayRange: 167 62 0 1 3 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)Act 2. The Baron learns of Hildegunde and Engelhart's disappearance. He is so furious that he hires hunters to track the pair down. Hildegunde and Engelhart are found and arrested. In a public trial, Hildegunde pleads their case in a stirring aria."
				)
			)
			(3
				(if (not event)
					(gMessager sayRange: 168 62 0 1 5 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)By the rights of the injured, the Baron announces, he is empowered to set a curse. The Baron curses Engelhart with a terrible and ancient malady -- that whenever the moon shines in the night, Engelhart will become a marauding wolf."
				else
					(gMessager sayRange: 169 62 0 1 3 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)In fact, he even does some good for the villagers. He scares away bandits and he keeps the renegade wolf at bay. No more children are lost to the fangs of the night. Engelhart's kindness shines through even the dire nature of his curse."
				)
			)
			(4
				(if (not event)
					(gMessager sayRange: 170 62 0 1 4 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)Act 3. The final act begins with the wedding feast for Hildegunde and the Baron. Hildegunde has "cooperated," due to her fear for her parent's lives, but now that the service is over, she is horrified to find herself that Baron's wife, and is mourning her final separation from Engelhart."
				else
					(gMessager sayRange: 171 62 0 1 4 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)The Baron protests, preferring the comedy, but he's reassured by Hildegunde's father. The minstrels gather in a circle around the frowning minstrel. They whirl around him, and he slowly sinks form sight. The music grows more frantic."
				)
			)
			(5
				(gMessager sayRange: 172 62 0 1 4 0 2020) ; "(PICKUP, OPERA PROGRAM CONT'D)The villagers rally in a cry of horror and fury. One of the men grabs an axe from the wall and entreats the others to follow. They will stalk and kill the murderous wolf! The villagers storm through the archway. Hildegunde follows."
			)
		)
	)
)
...
(instance invSeatingChart of GK2Inventory
	...
	(method (handleEvent)
		...
		(gMessager say: noun 62 0 0 0 2020) ; "(LOOK AT SEATING CHART)It's a seating chart for the theater."
	)
)
