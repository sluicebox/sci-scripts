...
(instance rm2212 of ExitRoom
	...
	(method (init)
		...
		(switch gPrevRoomNum
			...
			(else
				(gEgo posn: 45 315 normalize: 45)
			)
		)
		(gEgo normalize: setScale: 0 init:)
...
(instance fLog of GKFeature
	...
	(method (init)
		(super init: &rest)
		(self
			createPoly: 195 178 334 182 344 192 503 192 524 182 588 193 583 269 360 265 326 245 191 249
		)
	)
...
(instance fPawPrint of GKFeature
	(properties
		...
		x 100
		y 300
		nextRoomNum 2242 ; rm2242
	)

	(method (init)
		(super init:)
		(self
			createPoly: 196 276 174 278 116 278 108 285 152 295 192 295 214 292 218 288 218 280
		)
	)
