...
(instance fTableLinen of GKFeature
	...
	(method (init)
		(super init: &rest)
		(self
			createPoly: 77 219 206 210 241 219 244 261 151 277 151 304 130 328 127 293 64 292 85 273 78 268
		)
		(if (IsFlag 732)
			(= noun 15)
		)
...
(instance painting of GKFeature
	(properties
		x 90
		y 95
		nextRoomNum 9540 ; neuLRPainting
	)
