...
(instance farmIntRm of ExitRoom ; "Huber Farm Interior"
	...
	(method (init)
		...
		(fStationary init:)
		(fNote init:)
		(if (not (gEgo has: 8)) ; invHuberKeys
			(vKeys init:)
		else
			(fMirror init:)
		)
...
(instance fMirror of GKFeature
	...
	(method (init)
		(super init: &rest)
		(self
			createPoly: 178 104 230 106 230 169 244 169 244 176 238 176 238 187 227 179 219 183 202 185 184 182 174 188 174 175 170 175 170 169 178 169
		)
	)
