...
(class Game of Obj
	...
	(method (init)
		(Platform 0 0 999 997 998 996 993)
		Motion
		Sound
	...
	(method (save &tmp temp0 temp1 [temp2 4])
		(= temp0 gStr)
		(= temp1 0)
		(Save 0 name 0 (temp0 data:) (KString 9 gVersion)) ; SaveGame, StrGetData
	)

	(method (restore &tmp temp0 [temp1 4] temp5 temp6 temp7 temp8 temp9 temp10 temp11)
		(Sound pause: 1)
		(for
		...
		(= temp0 0)
		(Save 1 name 0 gVersion) ; RestoreGame
		(for
			((= temp9 (KList 3 (gPlanes elements:)))) ; FirstNode
			temp9
			((= temp9 (gPlanes nextNode:)))
	...
	(method (getDisc n &tmp temp0 temp1 temp2)
		(= gNumCD n)
		(while (!= temp0 n) ; UNINIT
			(= temp0 (CD 0 n 1)) ; Check
