...
(instance symbol_J_V_______a of TextIcon
	(properties
		name {symbol}
		view 384
		loop 1
...
(instance symbol_J_V_______b of TextIcon
	(properties
		name {symbol}
		view 384
		loop 2
...
(instance cabinetLock of PuzzleBar
	...
	(method (init &tmp temp0)
		...
		(for ((= temp0 0)) (< temp0 10) ((++ temp0))
			(self
				add:
					((= [local18 temp0] (symbol_J_V_______a new:))
						value: temp0
			...
			((== (= temp0 (event type:)) evKEYBOARD)
				(cond
					...
					((or (== temp1 KEY_e) (== temp1 KEY_E))
						(cabinetLock select: symbol_J_V_______b 0)
					)
				)
			)
