		...
		(if param1
			...
			(if (not local48)
				...
				(if 1
					...
					(= global410 (Memory memALLOC_CRIT (StrLen temp0)))
					(= global411 (Memory memALLOC_CRIT (StrLen temp0)))
					(StrSplitInTwo global408 global409 temp1)
					(StrSplitInTwo global410 global411 temp0)
					(Format @temp2 190 7 global408 global410 global409 global411) ; "The %s card has previously been used at: %s"
