			...
			(switch (event message:)
				(2 ; Look
					(if (== (gCurRoom curPic:) 210)
						...
						(PrintDC 15 13) ; "A small oasis! It's tantalizing water, so sparkling in the desert sun! Graham's hot, thirsty body is irresistibly drawn to it."
					)
					(event claimed: 1)
				)
				(3 ; Do
