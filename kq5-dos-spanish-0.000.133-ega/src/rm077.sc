	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(theMouth cycleSpeed: 3 setScript: (mouthMove new:) init:)
			...
			(8
				(cls)
				(PrintDC 77 5 #at 20 120 #width 270 #dispose) ; "But YOU can do something about it. Since you're the one that did this to him you're the only one who can turn him back again...back to the wizard Manannan."
				(= seconds 10)
			)
			(9
				(cls)
			...
			(12
				...
				(mHand show:)
				(cat show:)
				(PrintDC 77 9 #at 20 120 #width 270 #dispose) ; "You're holding out on me, little man! You're taking advantage of my good nature...but not for long! If I don't get a change of tune from you soon, I'll feed your family to the cat...starting with your dear mother!"
				(= seconds 15)
			)
			(13
				(cls)
			...
			(14
				...
				(gEgo show:)
				(smallMouth init: setScript: mouthMove)
			...
			(18
				...
				(wArm show:)
				(eArm show:)
				(theMouth setScript: (mouthMove new:))
