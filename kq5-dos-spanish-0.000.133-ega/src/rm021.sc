...
(local
	...
	[local35 24] = [0 0 319 0 319 189 190 189 190 186 298 186 303 155 263 155 242 134 251 121 221 111 0 114]
	[local59 68] = [0 189 0 0 319 0 319 189 194 189 308 179 268 153 233 107 215 107 223 132 241 155 213 165 178 164 141 163 126 158 140 142 193 130 202 110 157 84 121 84 104 111 139 106 148 91 179 107 183 122 156 130 70 139 41 135 40 139 78 147 72 153 77 160 55 177 94 189]
)
		...
		(switch (= state newState)
			...
			(3
				(if register
					...
					(gGlobalSound3 number: 122 loop: 1 play: 100)
				)
			)
			(4
				(gEgo
...
(instance falling of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gEgo cel: 3)
				(gGlobalSound3 number: 78 loop: 1 play:)
				(= seconds 1)
			)
			(3
				(gEgo
