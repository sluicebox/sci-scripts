...
(instance intro2 of Rm
	...
	(method (newRoom newRoomNumber)
		...
		(gEgo moveSpeed: 0 setStep: 3 2 setLoop: -1 setCycle: SyncWalk)
	)
)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(= local5 1)
				(= local3
					(Display 101 0 dsCOORD 70 10 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Productor Ejecutivo"
				)
				(= local2
					(Display 101 1 dsCOORD 70 26 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Ken Williams"
				)
				(= local1
					(Display ; "Productor Ejecutivo"
						101
						0
						dsCOORD
						69
			...
			(2
				(= local3
					(Display 101 3 dsCOORD 11 75 dsWIDTH 120 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Director Creativo"
				)
				(= local2
					(Display 101 4 dsCOORD 11 91 dsWIDTH 120 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Bill Davis"
				)
				(= local1
					(Display ; "Director Creativo"
						101
						3
						dsCOORD
						10
			...
			(4
				(= local3
					(Display 101 5 dsCOORD 70 10 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Dise\a4ado y Producido por"
				)
				(= local2
					(Display 101 6 dsCOORD 70 26 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Roberta Williams"
				)
				(= local1
					(Display ; "Dise\a4ado y Producido por"
						101
						5
						dsCOORD
						69
			...
			(6
				(= local3
					(Display 101 7 dsCOORD 121 24 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Dise\a4o Art\a1stico"
				)
				(= local2
					(Display 101 8 dsCOORD 121 40 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Andy Hoyos"
				)
				(= local1
					(Display ; "Dise\a4o Art\a1stico"
						101
						7
						dsCOORD
						120
			...
			(8
				(= local3
					(Display 101 9 dsCOORD 21 11 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Jefe de Programaci\a2n"
				)
				(= local2
					(Display 101 10 dsCOORD 21 27 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Chris Iden"
				)
				(= local1
					(Display ; "Jefe de Programaci\a2n"
						101
						9
						dsCOORD
						20
			...
			(10
				(= local3
					(Display 101 11 dsCOORD 11 75 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Director Musical"
				)
				(= local2
					(Display 101 12 dsCOORD 11 91 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Mark Seibert"
				)
				(= local1
					(Display ; "Director Musical"
						101
						11
						dsCOORD
						10
