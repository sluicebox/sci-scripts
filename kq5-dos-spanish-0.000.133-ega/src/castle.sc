	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(2
				...
				(SetScore 3)
				(SetFlag 63)
				((gInventory at: 24) cel: (+ 1 ((gInventory at: 24) cel:)) cursor: 54) ; Bag_of_Peas, Bag_of_Peas
		...
		(switch (= state newState)
			(0
				...
				(if (== global332 4)
					...
					(= global332 5)
					(proc0_28 549 550 23 67 10 10 25 6) ; "You! How did you get here?"
					(proc0_28 160 550 24 67 30 10 25 6) ; "I have journeyed far; over land and sea..."
					(proc0_28 549 550 25 67 10 10 25 6) ; "Never mind! Your journey is now over!"
				)
				(= cycles 1)
			)
			(1
...
(instance theWizardScript of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(2
				(proc0_28 73 550 26 67 30 10 25 6) ; "Good-bye, KING Graham of Daventry...heh, heh, heh!"
				(= cycles 1)
			)
			(3
			...
			(104
				(proc0_28 73 550 27 67 30 10 25 6) ; "Good-bye, KING Graham of Daventry...heh, heh, heh!"
				(= cycles 1)
			)
			(105
				(if (== global351 90)
