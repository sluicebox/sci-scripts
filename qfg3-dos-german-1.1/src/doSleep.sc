...
(instance doSleep of Code
	...
	(method (init &tmp temp0 temp1 temp2 temp3 temp4 [temp5 60])
		...
		(if (OneOf gCurRoomNum 150 160 170 180)
			...
			(= local3 (proc0_21 160 120 120 120 120))
			((= local1 (GameControls new:))
				window:
					((GloryWindow new:)
						top: 40
			...
			(temp4 nsLeft: (proc0_21 20 40 40 40 40) nsTop: 28 cursor: 1)
			(local1 add: temp4)
			(= temp4 (sleepIcon new: 2 0 0 2))
			(temp4 nsLeft: (proc0_21 20 40 40 40 40) nsTop: 45 cursor: 2)
			(local1 add: temp4)
			(= temp4 (sleepIcon new: 2 0 0 3))
			(temp4 nsLeft: (proc0_21 20 40 40 40 40) nsTop: 62 cursor: 3)
			(local1 add: temp4)
			(if gNight
				(= temp4 (sleepIcon new: 2 0 0 4))
				(temp4 nsLeft: (proc0_21 20 40 40 40 40) nsTop: 79 cursor: 4)
				(local1 add: temp4)
			else
			...
			(temp4
				nsLeft: (proc0_21 20 40 40 40 40)
