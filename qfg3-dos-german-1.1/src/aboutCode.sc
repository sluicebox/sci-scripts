...
(instance aboutCode of Code
	...
	(method (doit &tmp [temp0 300])
		...
		(cond
			...
			((not (Print font: 0 mode: 1 addText: 2 0 0 11 0 0 19 init:)) 0) ; "HERO'S THEME MUSIC: Mark Seibert  ADDITIONAL MUSIC: Aubrey Hodges  SPECIAL THANKS: Guruka Singh Khalsa Doug Herring Barry T. Smith Ruben Huante Gloria Garland Tom DeSalvo Mike Pickhinke Steve Joseph"
			((not (Print font: 0 mode: 1 addText: 2 0 0 12 0 0 19 init:)) 0) ; MISSING MESSAGE
			((not (Print font: 0 mode: 1 addText: 2 0 0 13 0 0 19 init:)) 0) ; MISSING MESSAGE
			((not (Print font: 0 mode: 1 addText: 2 0 0 14 0 0 19 init:)) 0) ; MISSING MESSAGE
			((not (Print font: 0 mode: 1 addText: 2 0 0 15 0 0 19 init:)) 0) ; MISSING MESSAGE
