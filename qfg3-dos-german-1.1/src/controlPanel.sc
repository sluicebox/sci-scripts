...
(instance gcWin of GloryWindow
	...
	(method (open &tmp [temp0 2] temp2 temp3 temp4 temp5 temp6 temp7 [temp8 4] temp12 temp13 [temp14 25] [temp39 4])
		...
		(DrawCel
			...
			1
			0
			(+ 8 (CelWide 933 1 1) (CelWide 933 0 1) 4)
			(+
				9
				(CelHigh 933 0 4)
				(/ (- (CelHigh 933 0 1) (CelHigh 933 1 0)) 2)
			)
			temp12
		)
		(DrawCel
		...
		(DrawCel
			...
			(-
				...
				(/ (- (CelWide 933 0 2) (CelWide 933 0 1)) 2)
			)
			6
			temp12
		)
		(DrawCel
			...
			3
			(-
				(+ 8 (CelWide 933 1 1) (CelWide 933 0 1) (CelWide 933 1 0) 4)
				(/ (- (CelWide 933 0 3) (CelWide 933 0 1)) 2)
			)
			(+ 9 (CelHigh 933 0 4) (CelHigh 933 0 1) 3)
			temp12
		)
		(DrawCel
			933
			...
			(-
				(+ 8 (CelWide 933 1 1))
				(/ (- (CelWide 933 0 4) (CelWide 933 0 1)) 2)
			)
			6
			temp12
		)
		(DrawCel
			...
			(-
				...
				(/ (- (CelWide 933 0 5) (CelWide 933 0 1)) 2)
			)
			(+ 9 (CelHigh 933 0 4) (CelHigh 933 0 1) 3)
			temp12
		)
		(= temp5 (+ (= temp2 (+ 7 9 (CelHigh 933 0 4) (CelHigh 933 0 1))) 20))
		(= temp4
			(+
		...
		(Display
			...
			dsCOORD
			(+ 4 (CelWide 933 1 1))
			(+ 9 (CelHigh 933 0 4) (CelHigh 933 0 1) 3 (CelHigh 933 0 4) 3)
			dsALIGN
			alCENTER
		)
		(Display
...
(instance detailSlider of Slider
	...
	(method (show)
		(= nsLeft (+ 8 (CelWide 933 1 1)))
		(= nsTop (+ 9 (CelHigh 933 0 4)))
		(super show: &rest)
	)
...
(instance volumeSlider of Slider
	...
	(method (show)
		(= nsLeft (+ 8 (CelWide 933 1 1) (CelWide 933 0 1) (CelWide 933 1 0) 4))
		(= nsTop (+ 9 (CelHigh 933 0 4)))
		(super show: &rest)
	)
)
