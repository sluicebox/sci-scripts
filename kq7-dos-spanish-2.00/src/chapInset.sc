...
(instance chapInset of Inset
	...
	(method (init param1 param2 param3)
		...
		(quitButton
			nsLeft: (proc11_8 113 140 140 140 140)
			nsRight: (proc11_8 176 167 167 167 167)
			nsTop: (proc11_8 80 77 77 77 77)
			nsBottom: (proc11_8 95 88 88 88 88)
			init:
		)
		(volumeUp init:)
		(volumeDown init:)
		...
		(marker6 init:)
		(playButton
			nsLeft: (proc11_8 26 30 30 30 30)
			nsRight: (proc11_8 74 55 55 60 55)
			nsTop: (proc11_8 80 76 76 76 76)
			nsBottom: (proc11_8 95 86 86 86 86)
			init:
		)
	...
	(method (dispose &tmp [temp0 3] temp3)
		(ClearFlag 572)
		(if (not local8)
			(= local8 1)
...
(instance bigMovie of Feature
	...
	(method (init)
		(= nsLeft (proc11_8 85 85 85 71 85))
		(= nsRight (proc11_8 98 98 98 86 98))
		(= nsTop (proc11_8 57 57 57 56 57))
		(= nsBottom (proc11_8 64 64 64 63 64))
		(super init:)
		(if (not (IsFlag 538))
			(halfMovie z: 0)
		)
