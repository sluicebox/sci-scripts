...
(instance hideEgoInStore of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(Print 390 0) ; "These guys mean bussiness, alright. But they sure aren't Harvard graduates."
				(HandsOn)
...
(instance store of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Do
				(Print 390 1) ; "It feels just like a wall with hot dogs and pickles stuck to it."
			)
			(11 ; Smell
