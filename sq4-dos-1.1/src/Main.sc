...
(procedure (HandsOn)
	...
	(if (not (HaveMouse))
		(gGame setCursor: ((gNarrator curIcon:) cursor:) 1 global192 global193)
	else
...
(procedure (proc0_17 param1 param2 param3 &tmp [temp0 500]) ; UNUSED
	...
	(babbleIcon view: param1 cycleSpeed: (* (+ global101 1) 4))
	(if (u< param2 1000)
...
(instance sq4 of Game
	...
	(method (init &tmp temp0)
		...
		(super init:)
		(StrCpy @gSysLogPath {})
		(= gInputFont sq4DoVerbCode)
		(= gFastCast sq4FtrInit)
		((= gPrints sq4KeyDownHandler) add:)
		((= gWalkHandler sq4MouseDownHandler) add:)
		((= gTextSpeed sq4DirectionHandler) add:)
		(= global97 PseudoMouse)
	...
	(method (quitGame)
		(babbleIcon view: 946 cycleSpeed: (* (+ global101 1) 4))
		(super
			quitGame:
