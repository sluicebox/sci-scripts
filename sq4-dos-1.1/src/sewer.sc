...
(instance theSlime of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(10 ; Taste
				(Print 702 18) ; "You can't do that here. Perhaps in another sequel."
			)
			(11 ; Smell
...
(instance theConduit of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 702 26) ; "The rough floor tastes strangely like blood. Oh, that IS blood. You shredded your tongue. Your mother should have warned you about floor licking."
			)
			(11 ; Smell
				(switch (Random 0 1)
					(0
