...
(instance rm900 of SQRoom
	...
	(method (init)
		...
		(localproc_1
			(switch global187
				(0 {We're glad you could play SQIV.__As usual, you've been a real pantload.})
				...
				(8 {Oh, well. Just think proudly of your accomplishmen... On second thought, just think - it happens to even IMPORTANT people!})
				(9 {Why'd you just STAND there?! I guess you just enjoy a laser buzz once in awhile.})
				(10 {Now, you KNEW he was coming, didn't you?!})
				(11 {Well, that's just great!__Now Vohaul's on the loose again, disguised as your SON!__You lose 3 out of 2.})
				...
				(15 {Were you looking for trouble?__Maybe you thought you could beat them senseless with your pink bunny rabbit?})
				(16 {This is Roger.\n\nThis is Roger on Ortega.\n\n\nAny questions?})
				(17 {Zap zap, you're dead.})
				(18 {Well... maybe.__It's worth a try.})
				(19 {As you leave the laser tunnel, you hear a metallic voice announce that the formatting program is beginning, erasing all data in the super computer and dashing all hopes of regaining your son!})
				...
				(23 {While you were busy staring blankly at your PocketPal(tm) screen, a droid clumsily snuck up to you and tapped you on the shoulder. "Zap," it said in its droning metallic voice, "you're it."})
				(24 {It's not over 'till the fat lady Orat spits... EEE-UCK! Well, I guess it's over. All over. All over everything!})
				(25 {Boy, these guys manage to be in the most inconvenient places! They seem to have this area secured. Your extra crispy parts surely will provide no threat.})
	...
	(method (cue)
		(super cue:)
		(gNarrator curIcon: (gNarrator at: 7))
