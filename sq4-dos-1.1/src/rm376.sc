...
(instance screen1 of Prop
	...
	(method (doVerb theVerb invItem)
		(if (or (== theVerb 2) (and (== theVerb 3) (== invItem 0))) ; Do, Inventory, buckazoid
			(cond
				((>= global191 5)
...
(instance kid of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; Smell
				(Print 376 17) ; "Perhaps you haven't been around a young, active being lately. I can tell you that walking up to one and giving it a sniff could be considered unstable and even dangerous behaviour."
			)
			(10 ; Taste
