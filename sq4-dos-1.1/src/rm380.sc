...
(instance tallGuy of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(4 ; Talk
				(Print 380 2) ; "After thinking hard, you remember an off-color tall joke. But, just as you begin to open your mouth, your strong will to live overcomes your juvenile impulse (ie. you keep your trap shut)."
			)
			(else
