			...
			(4 ; Talk
				(if (not (gCurRoom script:))
					(if (gEgo inRect: 198 64 239 86)
						...
						(Print 395 14) ; "No one can hear you from over there."
					)
				)
			)
			(11 ; Smell
...
(instance bush1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(11 ; Smell
				(Print 395 19) ; "This plant was provided courtesy of Shapier Florists."
			)
			(10 ; Taste
...
(instance bush2 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(11 ; Smell
				(Print 395 21) ; "This plant was provided courtesy of Shamir Florists."
			)
			(10 ; Taste
				(Print 395 20) ; "This plant tastes like another cheap plug for other Sierra products."
			)
