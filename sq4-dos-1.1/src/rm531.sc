...
(instance hand of Actor
	...
	(method (doit &tmp temp0 temp1)
		(cond
			((and (not script) (== ((gNarrator curIcon:) message:) 2))
				(= temp0 (User curEvent:))
...
(instance ILoveLunacyScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(Print 531 19 #at -1 140) ; "It was the "I Love Lunacy" show! You must've briefly tuned into the electronic entrails of some long-lost civalization."
				(User canInput: 1)
				(gNarrator enable: 2)
				(gNarrator enable: 3)
				(gNarrator enable: 1)
