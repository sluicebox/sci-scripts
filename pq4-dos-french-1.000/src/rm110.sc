...
(instance rm110 of Room
	...
	(method (init)
		...
		(gEgo
			...
			setScaler: Scaler 83 63 152 125
			normalize: 0
			init:
		)
		(if (< gDay 3)
...
(instance jack of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(29 ; coins
				(if (== global155 4)
					(gMessager say: 1 29 19 0) ; "You've offered enough assistance. Any more change"
				else
					(gGame handsOff:)
					(gGame points: 2)
					(++ global155)
...
(instance doPhoneScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo setMotion: PolyPath 295 129 self)
			)
			(1
			...
			(11
				(gMessager say: 3 4 11 0 self) ; "No dial tone, and no change in the coin return! Useless!"
			)
			(12
				(gGame handsOn:)
				(self dispose:)
...
(instance openDoorScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gMessager say: 5 4 0 0 self) ; "Upon opening, the smell of stale air wafts toward you."
			)
			(1
...
(instance awning of Feature
	...
	(method (init)
		(self
			createPoly: 91 35 248 24 248 38 236 38 231 41 148 48 132 48 80 49 77 52 65 53 71 45
		)
		(super init:)
	)
)
...
(instance sidewalk of Feature
	...
	(method (init)
		(self
			createPoly: 0 118 194 128 289 130 319 126 319 142 269 152 170 152 1 136
		)
		(super init:)
	)
)
...
(instance store of Feature
	...
	(method (init)
		(self
			createPoly: 13 39 88 35 69 44 63 54 79 53 81 50 157 49 234 42 238 39 251 38 251 23 280 22 319 24 319 125 272 129 200 126 157 125 12 116
		)
		(super init:)
	)
)
