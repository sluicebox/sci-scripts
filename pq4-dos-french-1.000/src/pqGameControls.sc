...
(instance speedBox of IconI
	...
	(method (init)
		(= nsLeft (proc0_5 89 89 121 89 89))
		(= nsRight (+ nsLeft 24))
		(= x (- (+ (proc0_5 89 89 121 89 89) 1) (proc0_5 0 0 8 0 0)))
		(super init: &rest)
		(self
			nsTop: 18
			nsLeft: (proc0_5 89 89 121 89 89)
...
(instance volumeBox of IconI
	...
	(method (init)
		(= nsLeft (proc0_5 124 124 156 124 124))
		(= nsRight (+ nsLeft 24))
		(= x (+ (- (proc0_5 124 124 156 124 124) 8) (proc0_5 0 0 2 0 0)))
		(super init: &rest)
		(self
			nsTop: 18
			nsLeft: (proc0_5 124 124 156 124 124)
...
(instance detailBox of IconI
	...
	(method (init)
		(= nsLeft (proc0_5 158 158 190 158 158))
		(= nsRight (+ nsLeft 24))
		(= x (+ (- (proc0_5 158 158 190 158 158) 2) (proc0_5 0 0 3 0 0)))
		(super init: &rest)
		(self
			nsTop: 18
			nsLeft: (proc0_5 158 158 190 158 158)
...
(instance increaseSpeed of LevelIcon
	...
	(method (init)
		(= x (proc0_5 89 89 121 89 89))
		(super init: &rest)
		(if (not local0)
			(= local0 (LEDCast new:))
			(local0 init: (proc0_5 99 99 131 99 99) 87 (- 15 global112))
...
(instance increaseVolume of LevelIcon
	...
	(method (init)
		(= x (proc0_5 124 124 156 124 124))
		(super init: &rest)
		(if (not local2)
			(= local2 (LEDCast new:))
			(local2
				init: (proc0_5 134 134 166 134 134) 87 (gGame masterVolume:)
			)
...
(instance increaseDetail of LevelIcon
	...
	(method (init)
		(= x (proc0_5 158 158 190 158 158))
		(super init: &rest)
		(if (not local1)
			(= local1 (LEDCast new:))
			(local1
				init: (proc0_5 169 169 201 169 169) 87 (gGame detailLevel:)
			)
