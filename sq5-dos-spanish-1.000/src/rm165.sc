...
(instance sDoAll of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gMessager say: 1 0 0 1 self) ; "And so, having undergone an intensive weekend captain's training seminar on the planet Oakhurst, Roger is shuttled to his new command--the SCS Eureka."
			)
			(4
