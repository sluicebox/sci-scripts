	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(17
				...
				(= temp0 (Localize 116 110 116 116 116))
				(= temp1 (Localize 74 74 74 74 74))
				(Display @local4 dsCOORD temp0 temp1 dsFONT 1605 dsCOLOR 14)
				(= temp0 (Localize 163 147 136 153 136))
				(= temp1 (Localize 76 74 76 74 74))
			...
			(18
				...
				(= temp0 (Localize 116 117 116 116 116))
				(= temp1 (Localize 84 84 84 84 84))
				(Display @local4 dsCOORD temp0 temp1 dsFONT 1605 dsCOLOR 14)
				(= temp0 (Localize 163 164 163 163 186))
				(= temp1 (Localize 84 84 84 84 84))
				(Display @local34 dsCOORD temp0 temp1 dsFONT 1605 dsCOLOR 14)
				(= ticks 40)
			)
			(19
				(Message msgGET 133 1 0 0 4 @local4) ; "Gordon, F."
				(= temp0 (Localize 116 116 116 116 116))
				(= temp1 (Localize 94 94 94 94 94))
				(Display @local4 dsCOORD temp0 temp1 dsFONT 10 dsCOLOR 5)
				(= local1 (Graph grSAVE_BOX 90 163 102 211 1))
				(= ticks 40)
			)
			(20
				(Message msgGET 133 1 0 0 5 @local4) ; "Processing"
				(= temp0 (Localize 163 163 173 163 173))
				(= temp1 (Localize 94 94 94 94 94))
				(Display @local4 dsCOORD temp0 temp1 dsFONT 10 dsCOLOR 19)
				(= ticks 20)
			)
			(21
				(= temp0 (Localize 163 163 163 163 173))
				(= temp1 (Localize 94 94 94 94 94))
			...
			(24
				...
				(Graph grUPDATE_BOX 90 163 102 211 1)
				(Message msgGET 133 1 0 0 6 @local34) ; "Fail"
				(= temp0 (Localize 163 163 163 163 186))
				(= temp1 (Localize 94 94 94 94 94))
			...
			(25
				...
				(= temp0 (Localize 116 116 116 116 116))
				(= temp1 (Localize 104 104 104 104 104))
				(Display @local34 dsCOORD temp0 temp1 dsFONT 10 dsCOLOR 5)
				(= local1 (Graph grSAVE_BOX 100 163 112 211 1))
				(= ticks 40)
			)
			(26
				(= temp0 (Localize 163 163 163 163 173))
			...
			(30
				(Graph grRESTORE_BOX local1)
				(Graph grUPDATE_BOX 100 163 112 211 1)
				(Message msgGET 133 1 0 0 6 @local34) ; "Fail"
				(= temp0 (Localize 163 163 163 163 186))
				(= temp1 (Localize 104 104 104 104 104))
				(Display @local34 dsCOORD temp0 temp1 dsFONT 10 dsCOLOR 9)
			...
			(31
				...
				(= temp0 (Localize 116 116 116 116 116))
				(= temp1 (Localize 114 114 114 114 114))
				(Display @local34 dsCOORD temp0 temp1 dsFONT 10 dsCOLOR 5)
				(= ticks 40)
			)
			(32
