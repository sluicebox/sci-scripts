...
(instance logo of View
	...
	(method (init)
		(= y (Localize 118 100 118 118 118))
		(super init: &rest)
	)
...
(instance doDirections of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(1
				(gMessager say: 2 0 0 0 self) ; "Battle Cruiser Objective: To seek out and destroy all four of your enemy's cloaked ships before yours are destroyed."
			)
			(2
				(= local31 0)
