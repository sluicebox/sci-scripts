...
(instance asteroid1 of Actor
	...
	(method (doit)
		(self x: (+ ((ScriptID 201 9) x:) 40)) ; bigPlanet
		(super doit: &rest)
	)
)
...
(instance asteroid2 of Actor
	...
	(method (doit)
		(self x: (+ ((ScriptID 201 9) x:) 185)) ; bigPlanet
		(super doit: &rest)
	)
...
(instance asteroid3 of Actor
	...
	(method (doit)
		(self x: (+ ((ScriptID 201 9) x:) 118) cel: (asteroid2 cel:)) ; bigPlanet
		(super doit: &rest)
	)
)
...
(instance asteroid4 of Actor
	...
	(method (doit)
		(self x: (+ ((ScriptID 201 9) x:) 160) cel: (asteroid1 cel:)) ; bigPlanet
		(super doit: &rest)
	)
)
