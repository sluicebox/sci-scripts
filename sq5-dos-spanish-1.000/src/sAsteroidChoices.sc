		...
		(switch (= state newState)
			...
			(2
				...
				(if ((ScriptID 201 12) whichSelect:) ; drooleTalker
					...
					(switch ((ScriptID 201 12) whichSelect:) ; drooleTalker
						(1
							((ScriptID 201 12) talkWidth: 127) ; drooleTalker
			...
			(2
				...
				(if ((ScriptID 201 13) whichSelect:) ; floTalker
					...
					(switch ((ScriptID 201 13) whichSelect:) ; floTalker
						...
						(3
							(gMessager say: 12 0 54 0 self 202) ; "Starcon has ordered us to proceed to Klorox II for an auxiliary garbage pickup, Captain."
						)
						(else
							(= cycles 1)
						)
