...
(instance sShipBlow of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(EgoDead 22) ; "Looks like you took a little too long getting out of there, but thanks for playing Space Quest 5. You've been a real blast."
			)
		)
	)
)
...
(instance sRogSitAndFry of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(theMusic3 fade:)
				(EgoDead 20) ; "Zowie! The electromatic security system has reduced you to a stick of hero jerky."
				(self dispose:)
			)
		)
	)
