...
(instance sq5StatusLineCode of Code
	...
	(method (doit &tmp [temp0 50] [temp50 50] temp100)
		...
		(Format @temp50 {%s} @temp0)
		(Display @temp50 dsCOORD 4 (Localize 1 0 1 0 1) dsFONT gUserFont dsCOLOR 6)
		(Display @temp50 dsCOORD 6 (Localize 3 2 3 2 3) dsFONT gUserFont dsCOLOR 4)
		(Display @temp50 dsCOORD 5 (Localize 2 1 2 1 2) dsFONT gUserFont dsCOLOR 0)
		(Message msgGET 0 29 0 0 2 @temp0)
