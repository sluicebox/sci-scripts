...
(instance sArgument of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(19
				(gMessager say: 1 0 0 5 self) ; "If the sludge bandits continue to illegally dump toxic waste whenever and wherever they choose, the environmental consequences could be staggering."
			)
			(20
