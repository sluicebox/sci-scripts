...
(instance rm3200 of KQRoom
	...
	(method (init)
		(if (IsFlag 206)
			(gKqMusic1 number: 3213 loop: -1 play:)
		...
		(if (IsFlag 104)
			(waterSound number: 894 loop: -1 play: 64 0)
			(river init:)
		)
		(cond
			...
			(
				...
				(gKqMusic1 number: 3209 loop: -1 play:)
			)
			((and (IsFlag 104) (not (IsFlag 206)) (IsFlag 105))
				(if (!= gChapter 4)
					...
					(gKqMusic1 number: 3208 loop: -1 play:)
				)
			)
			((and (IsFlag 104) (not (IsFlag 206)))
				...
				(gKqMusic1 number: 3200 loop: -1 play:)
			)
			((not (IsFlag 104))
				(if (!= gChapter 4)
					(stag init:)
	...
	(method (changeState newState)
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(6
					(mySound number: 3210 loop: 1 play:)
					(branch setCycle: End)
					(gEgo
						normalize:
				...
				(11
					...
					(gKqMusic1 number: 3211 loop: -1 play:)
				)
				(12
					(= ticks 60)
				)
				...
				(19 0)
				(20
					(mySound number: 3212 loop: 1 play:)
			...
			(switch (= state newState)
				(0
					...
					(branch dispose:)
					(attis dispose:)
					(ceres view: 3211 loop: 0)
					(ceres cel: (ceres lastCel:) init: posn: 149 96)
					(gKqMusic1 number: 3211 loop: -1 play:)
					(mySound stop:)
					(SetFlag 206)
					(ceresTalker
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(gKqSound1 number: 3202 loop: 1 play: self)
			)
			(3 0)
			(4
			...
			(8
				...
				(gKqSound1 number: 3202 loop: 1 play:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(gKqSound1 number: 3204 loop: 1 play: self)
			)
			(5
		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(6
					...
					(mySound number: 3203 loop: 1 play: self)
				)
				(7 0)
				(8
		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(1
					...
					(mySound number: 3205 loop: 1 play: self)
				)
				(2 0)
				(3
				...
				(4
					...
					(mySound number: 3206 play: self)
				)
				(5 0)
				(6
					(mySound number: 3207 play:)
					(sap setCycle: 0)
					(= seconds 4)
				)
				(7
...
(instance flyIn of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(mySound number: 865 loop: 1 play: self)
		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				(0
					...
					(proc11_3 gEgo stag self)
					(stag loop: 2 cel: 0 setCycle: End self)
					(mySound number: 3202 loop: 1 play:)
				)
				(1 0)
				(2
					(SetFlag 116)
