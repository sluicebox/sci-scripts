...
(instance aboutCode of Code
	...
	(method (doit &tmp [string 200])
		...
		(TPrint @string 33 gSmallFont 30 1 70 222 80 {Sierra Presents})
		(cycleIcon loop: 2)
		...
		(TPrint @string 33 gSmallFont 30 1 82 cycleIcon 70 252 80 {The Hackers})
		...
		(TPrint 15 6 33 gSmallFont 30 1 70 266 80 {More Laffer Laughs}) ; "You'll also want to order spare copies of all these other lovable Larry Laffer mis-adventures: "Leisure Suit Larry In the Land of the Lounge Lizards," "Leisure Suit Larry 4: The Missing Floppies." (Well, maybe you shouldn't order your copies of Larry4 just yet; we seem to have misplaced our master disks.)"
