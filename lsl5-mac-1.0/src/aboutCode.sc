...
(instance aboutCode of Code
	...
	(method (doit &tmp [string 200])
		(Load rsVIEW 993)
		(Format @string 15 0 gVersion gVersionDate) ; ""Leisure Suit Larry 5: Passionate Patti Does A Little Undercover Work" Executive Producer Ken Williams Creative Director Bill Davis Director Al Lowe Producer Guruka Singh Khalsa Version %s %s"
		(TPrint @string #font gSmallFont #mode 1 #width 222 #title {Sierra Presents})
		(cycleIcon loop: 2)
		...
		(TPrint 15 6 #font gSmallFont #mode 1 #width 266 #title {More Laffer Laughs}) ; "You'll also want to order spare copies of all these other lovable Larry Laffer mis-adventures: "Leisure Suit Larry In the Land of the Lounge Lizards," "Leisure Suit Larry 4: The Missing Floppies." (Well, maybe you shouldn't order your copies of Larry4 just yet; we seem to have misplaced our master disks.)"
