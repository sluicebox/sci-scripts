	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				...
				(TPrint 320 20 #at -1 185 #title {The Stewardess} #dispose self) ; "Why, Mr. Laffer! Is there a problem with your nuts?"
				(arm setScript: 0)
			)
			(8
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			(0
				...
				(dreamProp2 init: view: 375 setLoop: 0 posn: 197 141 setPri: 14)
				(patti
					init:
					view: 377
					setLoop: 0
