	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(switch gLarryLoc
					(0
						(TPrint 280 48) ; "BIG-R'S CREDIT CARNIVAL Need credit? Need a loan? Or just want to talk to someone who really understands what "deep in debt" really means? Call Roger H at Big R's Credit Carnival! Applications accepted over the phone. $10.00 non-refundable service charge might even be tax deductible!"
					)
					(1
