...
(instance debugHandler of Feature
	...
	(method (handleEvent event &tmp [temp0 150] [temp150 10] temp160 temp161 temp162 temp163 [temp164 8])
		(switch (event type:)
			(evKEYBOARD
				(event claimed: 1)
			...
			(evMOUSEBUTTON
				(switch (event modifiers:)
					...
					($000c ; emALT | emCTRL
						(event claimed: 1)
						(Format @temp0 10 7 (event x:) (event y:)) ; "%d/%d"
