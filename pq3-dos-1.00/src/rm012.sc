	...
	(method (init)
		...
		(self
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 0 118 0 0 319 0 319 131 278 116 294 97 269 86 290 56 274 51 247 79 249 79 232 74 207 92 176 82 164 75 120 60 110 63 100 72 68 95 66 104 45 118 22 116
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
		...
		(switch (= state newState)
			...
			(1
				...
				(if (or (IsFlag 5) (IsFlag 16))
					...
					(gEgo ignoreActors: 0 setMotion: MoveTo 270 69 self)
					(+= state 2)
				)
			)
			(2
		...
		(switch theVerb
			(3 ; Do
				...
				(cond
					...
					((not (IsFlag 85))
						(Print 12 25) ; "Don't you think you should checkin at Homicide first?"
					)
					(else
						(HandsOff)
						(= local2 1)
