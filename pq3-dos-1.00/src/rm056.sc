...
(local
	...
	[local15 16] = [110 113 164 147 127 163 100 145 71 150 53 134 65 119 85 124]
	[local31 38] = [75 99 22 117 76 182 286 183 274 146 239 150 211 119 224 114 221 112 211 115 193 106 211 95 244 0 319 0 319 189 0 189 0 0 55 0 55 78]
	[local69 10] = [212 135 184 150 164 137 175 123 198 124]
)
...
(instance rm056 of PQRoom
	...
	(method (init)
		...
		(poly2 points: @local15 size: 8)
		(poly3 points: @local31 size: 19)
		(poly4 points: @local69 size: 5)
		...
		(if (not (IsFlag 50))
			...
			(badGuy posn: 88 142 loop: 3 cel: 8 stopUpd: 1 init:)
		)
		(super init:)
	)
...
(instance shootSonny of Script ; UNUSED
	(properties)
