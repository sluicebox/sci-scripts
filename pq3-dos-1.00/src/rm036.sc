...
(instance rm036 of PQRoom
	...
	(method (init)
		...
		(if (== gPrevRoomNum 37)
			...
			(gEgo loop: 1 x: 164 y: 103 setLoop: -1 setPri: -1)
		)
		(gEgo
			setStep: 3 2
			normal: 1
		...
		(self
			addObstacle:
				((Polygon new:)
					...
					init: 0 138 0 189 318 189 319 126 228 126 244 100 175 76 166 80 168 93 157 93 155 93 148 95 158 102 202 112 159 131 114 113 86 124 92 138
					yourself:
				)
		)
		(if (== gDay 1)
	...
	(method (doit &tmp temp0)
		(cond
			...
			((and (& (gEgo onControl: 0) $0800) (== gDay 1))
		...
		(switch theVerb
			(3 ; Do
				(if (> gDay 1)
					...
					(Print 36 68) ; "Marie is resting gently. You do not to disturb her."
					(localproc_1)
					(localproc_2)
				)
			)
