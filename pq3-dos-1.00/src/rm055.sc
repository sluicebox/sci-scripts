	...
	(method (init)
		...
		(self
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 0 63 0 0 319 0 319 23 262 113 231 130 163 113 138 122 128 115 143 105 132 102 149 94 139 89 120 99 102 96 87 106 73 103 52 107 35 95 55 87
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
					init: 329 149 265 184 219 173 199 177 191 165 205 161 216 160 275 120 275 111 319 40 329 148
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
				...
				((Polygon new:)
					type: PBarredAccess
					init: 163 153 185 137 212 148 211 154 204 159 195 161 186 159 178 158
					yourself:
				)
		)
		(barrel init:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				...
				(handler loop: 3)
				(pDog setCycle: Walk setMotion: MoveTo 157 96 self init:)
				(dogSniff play:)
			)
			(8
				(dogSniff dispose:)
