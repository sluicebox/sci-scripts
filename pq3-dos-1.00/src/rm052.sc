	...
	(method (init)
		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 0 0 319 0 319 43 223 43 156 76 134 71 140 87 76 109 66 106 0 106
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
		...
		(if (== gPrevRoomNum 53)
			(gEgo posn: 188 62 init: setScript: enterStageRight)
		else
			(gEgo posn: 80 125 init: setScript: enterStageLeft)
		)
	)

	(method (doit &tmp temp0)
		(if (and (& (gEgo onControl: 1) $4000) (== (gEgo script:) 0))
			(gEgo setScript: exitStageRight)
		)
		(if (and (& (gEgo onControl: 1) $1000) (== (gEgo script:) 0))
			(gEgo setScript: exitStageLeft)
		)
		(super doit:)
	)
)
...
(instance exitStageLeft of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(client setMotion: PolyPath 56 110 self)
			)
			(1
				(mBurning fade: self)
...
(instance exitStageRight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(client setMotion: PolyPath 188 62 self)
			)
			(1
				(mBurning fade: self)
				(sAfterFire fade: self)
...
(instance enterStageLeft of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(client setMotion: MoveTo 90 115 self)
			)
			(1
				(HandsOn)
				(self dispose:)
...
(instance enterStageRight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(HandsOff)
				(client setMotion: MoveTo 154 97 self)
			)
			(2
				(HandsOn)
				(self dispose:)
