...
(class SpeakWindow of SysWindow
	...
	(method (open &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10)
		...
		(= priority 15)
		(= color global119)
		(= back (proc0_15 global124 global125))
		(if (not speakObj)
		...
		(DrawCel 997 1 0 brLeft brTop priority -1)
		(DrawCel 997 1 1 (- (- brRight 1) 10) brTop priority -1)
		(DrawCel 997 1 2 brLeft (- brBottom 10) priority -1)
		(DrawCel 997 1 3 (- brRight 10) (- brBottom 10) priority -1)
		(Graph
			grDRAW_LINE
			brTop
			(+ brLeft 10)
		...
		(Graph
			...
			(- brBottom 2)
			(- brRight 10)
			(proc0_15 global122 global119)
			-1
			-1
		)
		(DrawCel 997 0 temp3 tailLeft tailTop priority -1)
