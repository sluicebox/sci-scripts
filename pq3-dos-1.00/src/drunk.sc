	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(= save1 1)
				(sonnyInset dispose:)
				(Print 885 1 #dispose #at 20 20) ; "As he fumbles through his wallet getting his license, you think to yourself..."
				(= seconds 6)
			)
			(4
				(= save1 1)
...
(instance drunkInCar of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gEgo setMotion: PolyPath 124 191)
			...
			(10
				(closeCarDoor play:)
				(gEgo setMotion: MoveTo 182 189 self)
			)
			(11
				(= global113 0)
				(= global134 3)
