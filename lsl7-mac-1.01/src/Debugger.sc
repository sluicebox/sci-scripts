...
(procedure (proc64014_1 param1 param2 &tmp temp0 temp1)
	(= temp0 (Str new:))
	(if (> argc 1)
...
(procedure (localproc_0 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14 temp15 temp16 temp17 temp18 temp19 temp20 temp21 temp22 temp23 temp24 temp25 temp26)
	...
	(if (= temp0 (Print init:))
		...
		(if (param1 isKindOf: Actor)
			(localproc_5 param1 (temp20 asInteger:))
		)
		(param1
			view: temp9
			setLoop: temp11
...
(procedure (localproc_2 param1 param2 param3 param4)
	(if
		(and
			...
			(= local3 (localproc_3 param1 param2 param3 param4))
		)
		(localproc_1 local3)
	)
	(return local3)
...
(procedure (localproc_3 param1 param2 param3 param4 &tmp temp0 temp1 temp2 temp3 temp4)
	(= temp2 32764)
	(= temp1 0)
...
(procedure (localproc_7 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8)
			...
			(evKEYBOARD
				(switch (event message:)
					...
					(KEY_MENU
						...
						(if
							(and
								(> (= temp7 (proc64014_1 {Robot #?} local4)) 0)
