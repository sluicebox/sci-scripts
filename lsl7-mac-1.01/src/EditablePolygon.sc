...
(class EditablePolygon of Polygon
	...
	(method (show param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5)
		(if lines
			(self hide:)
		)
		(= lines (Set new:))
	...
	(method (dragPoint param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13)
		...
		(= temp9 0)
		(= temp10 (local0 plane:))
		(= temp13 (local0 lineColor:))
		(while (not (& ((= temp0 ((gUser curEvent:) new:)) type:) $0002))
...
(class PEditor of Set
	...
	(method (dropAnchor param1 param2 &tmp temp0 temp1)
		(= temp1
			(AddLine plane param1 param2 param1 param2 1000 lineColor 0 0 1)
		)
		(FrameOut)
		(= currentX param1)
		(= currentY param2)
		(while (!= ((= temp0 ((gUser curEvent:) new:)) type:) 1)
	...
	(method (constructPolygon param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8)
		...
		(FrameOut)
		(currentPolygon name: (temp6 data:) type: 0)
		(temp7 dispose:)
		...
		(while (not depressType)
			...
			(if (and (== depressType 3) (> (currentPolygon size:) 0))
				(= temp8 (- (currentPolygon size:) 1))
				(currentPolygon deletePoint: temp8 1 1)
				(currentPolygon indexToCoor: (- temp8 1))
