...
(instance RoomScript of Script
	...
	(method (changeState newState)
		...
		(switch (= state newState)
			...
			(14
				(Printf 640 9 (if (>= gFilthLevel 3) {on } else {})) ; "I don't know, Larry, but that girl certainly seems tired of going down %sthat tongue!"
				(aRosella setLoop: 1)
				(= seconds 2)
			)
			(15
			...
			(32
				(Print 640 28 #time 4 #dispose) ; "And so it ends."
				(= seconds 5)
			)
			(33
				(Print 640 29) ; "Larry and Patti move in together, sharing a simple programmer's shack in the mountains. Patti gives up her musician's life on the road for the one man she found able to match her passion. Larry begins to tell the world his life story through software..."
				(= seconds 3)
			)
			(34
