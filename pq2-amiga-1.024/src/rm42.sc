...
(procedure (localproc_0)
	(gAddToPics add: deadHijacker1 deadHijacker2)
	(pilotDoor
		view: 82
		posn: 271 55
		loop: 8
...
(procedure (localproc_1 &tmp temp0 temp1 temp2 temp3)
	...
	(if (!= local108 temp0)
		...
		(local115 posn: 244 36 cel: temp1)
		(local116 posn: 254 36 cel: temp2)
		(local117 posn: 264 36 cel: temp3)
	)
)
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(HandsOff)
				(gEgo setMotion: 0)
				(bathroomDoor setCycle: End self)
			)
			(2
			...
			(10
				(HandsOff)
				(blackWall posn: 100 1000)
				(bathroomDoor startUpd:)
				(gEgo
					ignoreActors:
					posn: 69 155
					illegalBits: 0
			...
			(11
				(bathroomDoor setCycle: Beg self)
			)
			(12
				(HandsOn)
				(bathroomDoor stopUpd:)
...
(instance TowelDispenser of Script
	...
	(method (doit)
		...
		(if (== local120 6)
			...
			(bombTimer seconds: -1)
			(gContinuousMusic stop:)
			(local115 posn: 244 36 cel: 10)
			(local116 posn: 254 36 cel: 10)
			(local117 posn: 264 36 cel: 10)
			(= local120 7)
			(= local100 1)
		)
		(if (and local118 (>= (bombTimer seconds:) 0))
			(localproc_1)
		)
		(super doit:)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(local109 loop: 1 posn: 155 103)
				(local114 posn: 235 40)
				(localproc_1)
				(SetScore 2 99)
				(= local118 1)
			)
			(10
				(local109 setLoop: 0 posn: 154 103)
				(= seconds 2)
			)
			(11
				(= local118 0)
