			...
			((Said 'look>')
				(cond
					...
					((Said '[<down,below,at][/dirt,deck]')
						(Print 8 71) ; "The floor is composed of a mosaic of overlapping welded steel plates. The melange of used metal plates appear to have been cut from a variety of sources. There is a small round object lying nearby."
					)
				)
			)
			(
