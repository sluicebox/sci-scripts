				...
				(cond
					...
					((>= (captureScript state:) 16)
						(cond
							(
								(Said
									'look/pane,man,guard,folk,programmer,accountant'
								)
...
(instance captureScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(Print 95 30) ; "You successfully free the two guys from their slimy confines and they begin to speak:"
...
(instance machineSound of Sound ; UNUSED
	(properties
		number 50
		loop -1
	)
