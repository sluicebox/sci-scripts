					...
					((Said 'look>')
						(cond
							...
							(
								...
								(Print 700 19) ; "The floor is composed of a mosaic of overlapping welded steel plates. The melange of used metal appears to have been cut from a variety of sources."
							)
							((Said '/console')
