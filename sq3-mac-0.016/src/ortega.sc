				...
				(cond
					((Said '[/area,around,moon,dirt,ortega]')
						(if (== gCurRoomNum 70)
							...
							(Print 600 3) ; "The planet Ortega is truly a lava-lovers paradise.  Volcanic activity constantly reshapes its surface, so if you have any maps older than last week, throw 'em out."
						)
					)
					((Said '/volcano')
