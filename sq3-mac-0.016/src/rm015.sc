			...
			((Said 'look>')
				(cond
					...
					((or (Said '<down[/deck,!*]') (Said '[<down]/deck'))
						(Print 15 18) ; "The floor is composed of a mosaic of overlapping welded steel plates. The melange of used metal appears to have been cut from a variety of sources."
					)
