	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				...
				(mMouth setCycle: Fwd)
				(Print 116 0 #title {Mark} #dispose #at -1 156 #width 308) ; "Greetings Earthling. We are the Two Guys From Andromeda, Universally famous software authors."
				(= seconds 8)
			)
			(12
				(cls)
				...
				(Print 116 1 #title {Roger} #dispose #at -1 156 #width 308) ; "And I am Roger Wilco, Space age swashbuckler and all around nice guy."
				(= seconds 8)
			)
			(13
				(cls)
				...
				(rMouth setCel: 0)
				(kMouth setCycle: Fwd)
				(Print 116 2 #title {Ken Williams} #dispose #at -1 156 #width 308) ; "Hello, I'm Ken Williams, President and founder of Sierra On-line. Sooo... You two guys are software authors heh? What are your credits?"
				(= seconds 10)
			)
			(14
				(cls)
			...
			(18
				...
				(mMouth setCycle: Fwd)
				(sMouth setCycle: Fwd)
				(Print 116 7 #title {Scott and Mark} #dispose #at -1 156 #width 308 #mode 1) ; "Sounds great! How many buckazoids does it pay?"
				(= seconds 5)
			)
			(19
				(cls)
			...
			(30
				...
				(Print 116 11 #at -1 10 #width 310 #time 12) ; "The Two Guys from Andromeda go on to create the Space Quest series of adventure games reaping fame and fortune. They grow fat on their success and soon become burnt out and begin a drunken tailspin into obscurity."
