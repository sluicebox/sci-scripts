...
(local
	...
	local4
	local5 = 30
	[local6 12] = [27 35 43 51 59 67 99 107 131 139 147 155]
	[local18 12] = [32 40 48 56 64 72 104 112 136 144 152 160]
)
...
(instance rm280 of Rm
	...
	(method (init &tmp [temp0 50])
		...
		(if (== gPrevRoomNum 25)
			(Display {CHOOSE NUMBER TO ORDER} dsCOORD 10 175 dsWIDTH 200 dsCOLOR 0 dsFONT 681)
			(Display {CHOOSE NUMBER TO ORDER} dsCOORD 10 175 dsWIDTH 200 dsCOLOR 15 dsFONT 680)
		)
		(Display {PRESS Q TO QUIT} dsCOORD 200 175 dsWIDTH 200 dsCOLOR 0 dsFONT 681)
		(Display {PRESS Q TO QUIT} dsCOORD 200 175 dsWIDTH 200 dsCOLOR 15 dsFONT 680)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(Print 280 0 #at -1 95 #width 50 #font 600 #dispose) ; "Thank You"
				(= cycles 30)
			)
			(1
				(cls)
