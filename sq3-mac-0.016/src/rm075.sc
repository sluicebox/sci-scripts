		...
		(cond
			((Said 'look>')
				(cond
					((Said '[/area,around]')
						(if global256
							(Print 75 0) ; "While trying to catch your breath you take in the panoramic view. Below, you can see your ship off in the distance, and volcanoes stretching out over the horizon. There is a large circular opening here at the top of this building. This is where the beam originated, but you blew it up. Nice going Wilco."
						else
							(Print 75 1) ; "While trying to catch your breath you take in the panoramic view. Below, you can see your ship off in the distance, and volcanoes stretching out over the horizon. There is a large circular opening here at the top of the generator. This must be where the beam originates. Watch your step up here."
						)
					)
