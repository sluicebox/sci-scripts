...
(instance rm007 of Rm
	...
	(method (handleEvent event)
		...
		(cond
			((Said 'look>')
				(cond
					...
					(
						...
						(Print 7 8) ; "The floor is composed of a mosaic of overlapping welded steel plates. The melange of used metal appears to have been cut from a variety of sources. The floor drops off near the large robot."
					)
					((Said '/down,(edge[<deck])')
			...
			((Said 'manipulate,press,pull,hoist/head,android,helmet')
		...
		(cond
			((Said 'look>')
				(cond
					...
					((Said '[<down,below,at][/dirt,deck]')
						(Print 7 22) ; "The floor is composed of a mosaic of overlapping welded steel plates. The melange of used metal appears to have been cut from a variety of sources. There is a small round object lying nearby."
					)
				)
			)
			(
				(Said
					'remove,get,manipulate,press,roll,pull/motivator,artifact,device'
				)
			...
			((Said 'remove,press,pull,get/plug[<modular,8,eightprong]')
