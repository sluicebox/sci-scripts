...
(procedure (localproc_1)
	(if (gEgo has: 8) ; Buckazoids
		...
		(Display 290 17 dsCOORD 52 180 dsWIDTH 91 dsCOLOR 15 dsBACKGROUND 0 dsFONT 600)
		(Display 290 18 dsCOORD 50 180 dsWIDTH 55 dsCOLOR 15 dsBACKGROUND 0 dsFONT 600) ; "Feed:"
		(Display 290 12 dsCOORD 148 180 dsFONT 600 dsWIDTH 90 dsCOLOR 0 dsBACKGROUND 15) ; "CLICK HERE TO EXIT"
		(guysLeft init:)
		(localproc_0)
		(= local3 22)
		(= local0 local2)
				...
				(switch (event message:)
					...
					(KEY_F2
						(if local17
							...
							(SetMenu 1538 113 0 110 {Turn on})
						else
							(= local17 1)
							(DoSound sndSET_SOUND 1)
							(SetMenu 1538 113 1 110 {Turn off})
						)
					)
					(KEY_F6
						(event claimed: 1)
