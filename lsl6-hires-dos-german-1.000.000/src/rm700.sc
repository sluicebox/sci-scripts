...
(instance rm700 of LarryRoom
	...
	(method (init)
		(gCurRoom
			addObstacle:
				((Polygon new:)
					...
					init: 0 139 319 139 319 97 288 97 268 85 242 85 242 71 286 71 310 89 319 89 319 76 235 49 229 45 212 47 202 45 146 45 130 43 82 63 73 70 26 49 0 49
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
		...
		(super init: &rest)
		(gEgo normalize: 900 2 setScaler: Scaler 100 80 121 47 init:)
		(switch gPrevRoomNum
			(570
		...
		(if (!= gPrevRoomNum 710)
			(gGlobalSound1 number: 700 loop: -1 setVol: 50 play: fade: 127 10 10 0)
		)
		(dumbWaiter init:)
	...
	(method (doit)
		...
		(cond
			(script 0)
			((and (not local1) (gEgo inRect: 282 67 328 93))
				(gEgo setPri: 73)
				(= local1 1)
			)
			((and local1 (not (gEgo inRect: 282 67 328 93)))
				(gEgo setPri: -1)
				(= local1 0)
			)
		)
...
(instance tryDoorScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gGlobalSound2 number: 34 loop: 1 play: self)
			)
			(3
				(gEgo setCycle: Beg self)
			)
