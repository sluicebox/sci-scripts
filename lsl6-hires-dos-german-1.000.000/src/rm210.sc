...
(instance rm210 of LarryRoom
	...
	(method (init)
		...
		(if (and (not (gGlobalSound2 handle:)) (!= gPrevRoomNum 200))
			(gGlobalSound2 number: 200 loop: -1 setVol: 80 play:)
		)
		(UnLoad 128 80)
		(theEyes init:)
		(lArm init:)
	...
	(method (newRoom newRoomNumber)
		(gGlobalSound2 fade: 127 10 10 0 client: 0)
...
(instance happyGammieScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager sayRange: 4 2 4 1 2 self) ; "So? Did you do it, Larry?"
			)
			(2
			...
			(3
				(gMessager sayRange: 4 2 4 4 5 self) ; "Would you like to be my first vic-, err, uh, suck-, ah, err, patient?!"
			)
			(4
				(= global171 2)
				(gCurRoom newRoom: 200)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(SetFlag 21)
				(gMessager sayRange: 4 2 11 1 3 self) ; "Say, Gam baby. I've got an idea! What if I, your friend Larry Laffer, could repair this little machine of yours, fix it up, make it right?"
			)
			(1
				(gGame changeScore: 3 162)
				(gMessager sayRange: 4 2 11 4 5 self) ; "(SQUEALS) OH, LARRY! If you could do that, I'd be the happiest woman on Earth."
			)
			(2
				(gGame handsOn:)
				(self dispose:)
