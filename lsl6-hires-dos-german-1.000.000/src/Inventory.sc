...
(class Inv of IconBar
	...
	(method (drawInvItems &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 [temp7 2] temp9 temp10 temp11 temp12)
		(= temp4 0)
		(= temp0 colMargin)
		(= temp1 (+ iconBottom 15))
		(= temp10 0)
		...
		(for ((= temp3 temp3)) temp3 ((= temp3 (self next: temp3)))
			(if
				...
				(= temp12 (+ temp0 (- (temp2 x:) (temp2 nsLeft:))))
				(= temp6 (CelWide (temp2 view:) (temp2 loop:) (temp2 cel:)))
				(temp2
					x: (+ temp12 (/ (- itemWide temp6) 2))
					y: (+ temp1 (- (temp2 y:) (temp2 nsTop:)))
				)
	...
	(method (setCurIndex param1 param2 &tmp temp0 temp1 temp2 temp3 temp4)
		...
		(if (or (== argc 1) (and (> argc 1) param2))
			(self drawInvItems:)
		)
	)

	(method (setCurIndexTo param1 param2)
		(for
			((= curIndex param1))
