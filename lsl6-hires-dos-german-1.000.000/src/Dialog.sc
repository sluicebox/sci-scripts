...
(class Dialog of Set
	...
	(method (doBox &tmp temp0 temp1 temp2 temp3)
		(if makeBorder
			...
			(= tl2 (AddLine (self plane:) 0 temp1 temp2 temp1 200 0 0 0 1))
			(= tl3 (AddLine (self plane:) temp2 temp0 temp2 temp1 200 0 0 0 1))
	...
	(method (updateBox &tmp temp0 temp1 temp2 temp3)
		(if makeBorder
			...
			(UpdateLine tl2 (self plane:) 0 temp1 temp2 temp1 200 0 0 0 1)
			(UpdateLine tl3 (self plane:) temp2 temp0 temp2 temp1 200 0 0 0 1)
