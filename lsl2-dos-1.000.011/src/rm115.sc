...
(instance rm115 of Rm
	...
	(method (init)
		...
		(Load rsVIEW 222)
		(super init:)
		((View new:) view: 221 loop: 2 cel: 3 posn: 225 64 addToPic:)
		((View new:) view: 221 loop: 2 cel: 4 posn: 267 88 addToPic:)
		((View new:) view: 221 loop: 2 cel: 5 posn: 149 46 addToPic:)
		((View new:) view: 221 loop: 3 cel: 4 posn: 102 100 addToPic:)
		((View new:) view: 221 loop: 3 cel: 4 posn: 120 97 addToPic:)
		((View new:) view: 221 loop: 3 cel: 3 posn: 134 101 addToPic:)
		((View new:) view: 221 loop: 3 cel: 3 posn: 145 101 addToPic:)
		((View new:) view: 221 loop: 2 cel: 0 posn: 162 102 addToPic:)
		((View new:) view: 221 loop: 2 cel: 0 posn: 186 102 addToPic:)
		((View new:) view: 221 loop: 2 cel: 0 posn: 156 110 addToPic:)
		((View new:) view: 221 loop: 2 cel: 0 posn: 191 110 addToPic:)
		((View new:) view: 221 loop: 2 cel: 0 posn: 90 102 addToPic:)
		((View new:)
			view: 221
			loop: 3
			cel: 0
		...
		((View new:) view: 221 loop: 3 cel: 2 posn: 23 104 addToPic:)
		((View new:) view: 221 loop: 3 cel: 2 posn: 0 114 addToPic:)
		((View new:) view: 221 loop: 3 cel: 1 posn: 31 80 addToPic:)
		((View new:) view: 221 loop: 3 cel: 1 posn: 41 87 addToPic:)
		((View new:) view: 221 loop: 2 cel: 1 posn: 172 78 setPri: 6 addToPic:)
		((View new:) view: 221 loop: 2 cel: 2 posn: 89 105 setPri: 7 addToPic:)
		((View new:)
			view: 221
			loop: 3
			cel: 5
		...
		((View new:) view: 221 loop: 3 cel: 7 posn: 140 71 addToPic:)
		((View new:)
			view: 221
			loop: 3
			cel: 6
		...
		(if (Said 'look>')
			(cond
				...
				((Said '[/airport,building,rack,rack,new,music]')
					...
					(Print 115 7 #at -1 152) ; "(You wonder which ethnic subculture makes such extensive use of electric amplifiers and drum sets!)"
				)
			)
		)
		...
		(if (Said 'talk/woman,children,agent')
			(cond
				...
				((== gLAhaircut 0)
					...
					(Print 115 14 #at -1 152) ; "(Apparently she doesn't speak English.)"
				)
				(else
					(self changeState: 1)
				)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(Print 115 17 #at -1 152 #font gSmallFont) ; "("Good day, Sir. How may I help you?")"
				(cls)
				(= seconds 3)
			)
			(3
			...
			(4
				...
				(Print 115 25 #at -1 152 #font gSmallFont) ; "("Your ears remind me of whale breasts.")"
				(cls)
				(aClerk setLoop: 2 setCycle: Fwd)
				(= seconds 3)
			)
			(5
				...
				(Print 115 28 #at -1 152 #font gSmallFont) ; "("Yes, but the moon is full, and you are a chihuahua.")"
				(cls)
				(= seconds 3)
			)
			(6
				...
				(Print 115 32 #at -1 152 #font gSmallFont) ; "("My pencil is long, hard and yellow.")"
				(cls)
				(aClerk setLoop: 2 setCycle: Fwd)
				(= seconds 3)
			)
			(7
				...
				(Print 115 34 #at -1 152 #font gSmallFont) ; "("So you're finally here! I thought you'd never show up. By the way, who writes these secret phrases, anyway?")"
				(cls)
				(Print 115 35 #at -1 20 #font gUserFont #dispose) ; "La microfiche la enigm big dealo onklunk no touche, Dr. Nonookee el commie."
				(Print 115 36 #at 20 130 #width 270 #font gSmallFont) ; "("The microfiche containing the secrets to the recent United States' superconductor research breakthrough is hidden inside this rare, Peruvian onklunk. Don't let anyone touch it before you personally deliver it to Dr. Nonookee. And (I don't need to tell you) be careful: he, and he alone, has the authority to deliver it to the USSR agents!")"
				(cls)
			...
			(9
				...
				(Print 115 38 #at -1 152 #font gSmallFont) ; "("Thanks, I guess.")"
				(cls)
				(= seconds 3)
			)
			(10
