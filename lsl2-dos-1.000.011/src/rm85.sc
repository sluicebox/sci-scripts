...
(instance rm85 of Rm
	...
	(method (init)
		...
		((View new:) view: 829 loop: 7 posn: 33 69 setPri: 1 addToPic:)
		((View new:) view: 829 loop: 7 posn: 58 69 setPri: 1 addToPic:)
		((View new:) view: 829 loop: 9 setPri: 5 posn: 214 106 addToPic:)
		((= aDoor (Act new:))
			view: 829
			ignoreActors:
			illegalBits: 0
...
(instance rm85Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(aDoor setMotion: MoveTo 35 138 self)
			)
			(6
