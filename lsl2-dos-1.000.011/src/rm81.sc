		...
		(switch (= state newState)
			...
			(8
				...
				(gEgo
					illegalBits: 0
					ignoreActors:
					setMotion: MoveTo 156 134 self
				)
			)
			(9
				(aCoil posn: 153 119 cel: 0 setCycle: End self show:)
			...
			(11
				...
				(gEgo view: 183 cel: 0 posn: 156 118 setCycle: End self)
			)
			(12
				(aCoil posn: 153 103 cel: 0 setCycle: End self show:)
			...
			(13
				...
				(gEgo view: 183 cel: 0 posn: 156 102 setCycle: End self)
			)
			(14
				(aCoil posn: 153 87 cel: 0 setCycle: End self show:)
				(gEgo view: 182 setCycle: Fwd)
			)
			(15
				(aCoil hide:)
				...
				(gEgo view: 183 cel: 0 posn: 156 86 setCycle: End self)
			)
			(16
				(aCoil posn: 153 71 cel: 0 setCycle: End self show:)
				(gEgo view: 182 setCycle: Fwd)
			)
			(17
				(aCoil hide:)
				...
				(gEgo view: 183 cel: 0 posn: 156 70 setCycle: End self)
			)
			(18
