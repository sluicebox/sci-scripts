...
(instance rm53 of Rm
	...
	(method (init)
		...
		(Load rsVIEW 511)
		(super init:)
		((View new:) view: 513 loop: 1 cel: 0 posn: 25 158 setPri: 12 addToPic:)
		((View new:) view: 513 loop: 1 cel: 1 posn: 73 58 setPri: 10 addToPic:)
		((View new:)
			view: 513
			loop: 6
			cel: 0
...
(instance rm53Script of Script
	...
	(method (handleEvent event &tmp obj)
		...
		(if (Said 'look>')
			...
			(if (Said '/art')
				(Print 53 9) ; "Those raisins are EVERYWHERE!"
			)
