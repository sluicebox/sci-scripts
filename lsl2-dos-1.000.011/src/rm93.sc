...
(instance rm93 of Rm
	...
	(method (init)
		...
		(super init:)
		(theSound play:)
		((View new:) view: 816 loop: 5 cel: 0 posn: 39 86 addToPic:)
		((View new:)
			view: 816
			ignoreActors:
			loop: 5
		...
		((View new:) view: 816 loop: 5 cel: 3 posn: 253 74 setPri: 5 addToPic:)
		((View new:)
			view: 816
			ignoreActors:
			loop: 5
...
(instance rm93Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(gEgo setMotion: MoveTo 243 93 self)
			)
			(9
