...
(instance rm50 of Rm
	...
	(method (init)
		...
		(Load rsVIEW 502)
		(super init:)
		((View new:) view: 500 loop: 0 cel: 0 posn: 155 63 setPri: 2 addToPic:)
		((View new:) view: 500 loop: 0 cel: 1 posn: 11 64 setPri: 3 addToPic:)
		((View new:) view: 500 loop: 0 cel: 2 posn: 308 63 setPri: 2 addToPic:)
		((= aRadar (Prop new:))
			view: 500
			setLoop: 2
			setPri: 0
		...
		(if (== gCurrentEgoView 151)
			...
			((View new:) view: 501 loop: 2 posn: 22 165 addToPic:)
			((View new:) view: 502 loop: 2 posn: 298 165 addToPic:)
