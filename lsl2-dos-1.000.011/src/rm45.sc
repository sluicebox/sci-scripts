...
(instance rm45Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(15
				(aBarber setLoop: 1 setCel: 0 setPri: -1 posn: 167 92)
			...
			(25
				(aBarber setLoop: 3 cel: 0 posn: 165 82 setCycle: CT 1 1 self)
				(aChair view: 431 setLoop: 7 cel: 0 posn: 167 116 show:)
			)
			(26
				(= seconds 3)
			)
			...
			(35
				(gEgo hide:)
				(aChair hide:)
				(aBarber view: 431 setLoop: 2 setCel: 5 posn: 167 116)
				(= seconds 3)
			)
			(36
			...
			(38
				(aBarber view: 430 setLoop: 1 setCel: 0 setPri: -1 posn: 167 92)
