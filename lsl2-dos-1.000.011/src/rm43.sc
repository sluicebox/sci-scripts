...
(instance rm43 of Rm
	...
	(method (init)
		...
		((View new:) view: 433 posn: 22 135 setPri: 6 ignoreActors: addToPic:)
		((View new:)
			view: 433
			cel: 1
			posn: 63 122
		...
		(= MDatPodium 1)
		(NormalEgo 3)
		(gEgo posn: 195 179 observeControl: 16384 init:)
...
(instance rm43Script of Script
	...
	(method (handleEvent event)
		...
		(if (Said 'look<below/buffet')
			...
			(Print 43 1 #at -1 152) ; "(You see nothing you wish to share at this time!)"
		)
		(if (Said 'look>')
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(101
				...
				(Print 43 55 #at -1 152) ; "(Sure, now that there are no tables left!)"
			...
			(106
				(gEgo setScript: (toLarryScript new:))
			)
			(107
			...
			(115
				...
				(Print 43 61 #at -1 152 #draw) ; "(Choice location, Larry.)"
				(NormalEgo)
				(= preventInput 0)
			)
			(121
...
(instance toLarryScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(client setMotion: MoveTo 241 115 self)
			)
			(2
				(rm43Script cue:)
				(client setScript: 0)
