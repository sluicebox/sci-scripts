...
(instance rm62 of Rm
	...
	(method (init)
		...
		(theSound init:)
		(super init:)
		((= aBore (Prop new:)) view: 602 setCel: 0 setPri: 5 posn: 175 86)
		(if (== gBoreStatus 255)
...
(instance rm62Script of Script
		...
		(if (Said 'get/bag')
			(cond
				...
				(else
					...
					(Print 62 15 #at -1 152) ; "(If you didn't need it before, you need it now!)"
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(aStewardess posn: 11 102 setMotion: MoveTo 50 102 self)
			)
			(10
			...
			(15
				...
				(aStewardess setLoop: 1 setCycle: Walk setMotion: MoveTo 11 102 self)
			)
			(16
				(aStewardess dispose:)
				(= seconds 5)
			...
			(19
				...
				(Print 62 28 #at -1 152) ; "(Pretty fast takeoff, wasn't it?)"
			...
			(22
				...
				(Print 62 35 #at -1 152) ; "(That was even faster than the takeoff!)"
...
(instance cartLeftScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(aCartLeft posn: 20 104 setMotion: MoveTo 140 104 self)
			)
			(2
...
(instance cartRightScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(aCartRight posn: 308 104 show: setMotion: MoveTo 210 104 self)
			...
			(2
				(switch (++ gBoreStatus)
					...
					(2
						...
						(Print 62 50) ; "Oh."
						(Print 62 51 #at -1 152) ; "(Well, that's one way to stifle him, Larry!)"
					)
					(3
					...
					(5
						...
						(Print 62 62 #at -1 152) ; "(Why is this creep staring above your eyes?)"
					)
					(6
						(HandsOff)
