...
(instance rm178 of Rm
	...
	(method (init)
		...
		(gEgo posn: 171 162 illegalBits: 0 ignoreActors: init:)
...
(instance rm178Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(10
				(aChair view: 232 loop: 1 cel: 0 posn: 164 119 show:)
				(gEgo
					view: 196
					posn: 157 121
					setLoop: 0
			...
			(13
				(aBarber view: 711 setLoop: 2 posn: 159 122)
			...
			(27
				...
				(gEgo stopUpd:)
				(aThoughtBalloon posn: 160 128 stopUpd:)
				(aHandle posn: 160 129 stopUpd:)
				(aThought posn: 161 120)
				(= seconds 2)
			)
			(28
			...
			(33
				...
				(aThought posn: 154 92 setLoop: 2 cel: 0 setCycle: End self)
			)
			(34
