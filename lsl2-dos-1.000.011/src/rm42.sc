...
(instance rm42Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gEgo setLoop: 2 posn: 84 112 cel: 0 setCycle: End self)
			)
			(6
				(gEgo
					cycleSpeed: 1
			...
			(14
				...
				(Print 42 8 #at -1 152) ; "(But boy, is your suit a mess!!)"
				(= seconds 3)
			)
			(15
			...
			(17
				(Print 42 9 #at -1 152) ; "(Don't you just love a good polyester?)"
				(= seconds 3)
			)
			(18
