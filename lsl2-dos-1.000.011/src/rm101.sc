	...
	(method (handleEvent event)
		...
		(if (Said 'give,finger,look/ticket')
			(cond
				...
				((not (gEgo inRect: 134 145 185 152))
		...
		(if (Said 'look>')
			...
			(if (Said '/woman,skylight,buffet')
				(aBigClerk posn: 223 42 stopUpd:)
				(aBigMouth posn: 223 42)
...
(instance guyScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(aGuy posn: 33 118 setMotion: MoveTo 72 118 self)
			)
			(3
...
(instance dollScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(aDoll posn: 288 118 setMotion: MoveTo 258 118 self)
			)
			(3
