...
(instance rm74 of Rm
	...
	(method (init)
		...
		(NormalEgo)
		(if (== gPrevRoomNum 75)
			(gEgo posn: 288 77 observeControl: 2 16)
		else
			(gEgo posn: 2 77)
		)
		(gEgo init:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(aBigEgo posn: (gEgo x:) 88 stopUpd:)
				(aBigEgoFace posn: (gEgo x:) 88 cel: 0 setCycle: End self)
			)
			(5
				(= cycles 7)
			)
			...
			(12
				(gEgo setLoop: 4 posn: 106 104 cel: 0 setCycle: End self)
			)
			(13
			...
			(16
				(gEgo setLoop: 4 posn: 131 104 cel: 0 setCycle: End self)
			)
			(17
