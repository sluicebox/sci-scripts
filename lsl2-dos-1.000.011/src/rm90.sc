...
(instance rm90 of Rm
	...
	(method (init)
		...
		(super init:)
		(mThemeSong play:)
		((View new:) view: 800 ignoreActors: posn: 159 48 setPri: 8 addToPic:)
		((= aGirl (Act new:))
			view: 809
			ignoreActors:
			illegalBits: 0
	...
	(method (changeState newState &tmp bx by ex ey)
		(switch (= state newState)
			...
			(8
				...
				(gEgo loop: 1 cel: 0 posn: 148 107 show: setCycle: End self)
			)
			(9
				(gEgo setCycle: Beg self)
			)
			...
			(11
				...
				(gEgo loop: 2 cel: 0 posn: 199 58 show: setCycle: End self)
			)
			(12
			...
			(22
				...
				(aName setLoop: 4 setCel: 0 posn: 159 47 show:)
			)
			(23
