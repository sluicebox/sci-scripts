...
(instance NoQuorum of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				((ScriptID 2 0) init: 13 1 self) ; Delphineus, "We don't have enough citizens for the meeting yet, Adam. Why don't you see if you can round up some more?  Try the apartments that still have the lights on."
			)
			(5
