...
(instance whoDares of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Print (proc932_8 5 gCurRoomNum 1 @local3))
			...
			(2
				(Print (proc932_8 5 gCurRoomNum 2 @local3))
				(= seconds 30)
			)
			(3
				(= local2 55)
...
(instance senatorSpeech of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print (proc932_8 5 gCurRoomNum 3 @local3))
				(= cycles 1)
			)
			(4
			...
			(5
				(Print (proc932_8 5 gCurRoomNum 4 @local3))
				(= cycles 1)
			)
			(6
			...
			(7
				(Print (proc932_8 5 gCurRoomNum 5 @local3))
				(= cycles 1)
			)
			(8
				(Print (proc932_8 5 gCurRoomNum 31 @local3))
				(= cycles 1)
			)
			(9
			...
			(10
				(Print (proc932_8 5 gCurRoomNum 6 @local3))
				(= cycles 1)
			)
			(11
				(Print (proc932_8 5 gCurRoomNum 32 @local3))
				(= cycles 1)
			)
			(12
			...
			(13
				(Print (proc932_8 5 gCurRoomNum 7 @local3))
				(= cycles 1)
			)
			(14
			...
			(15
				(Print (proc932_8 5 gCurRoomNum 36 @local3))
				(= cycles 1)
			)
			(16
				(Print (proc932_8 5 gCurRoomNum 33 @local3))
				(SetFlag 3)
				(= cycles 1)
			)
			(17
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(Display
					(proc932_8 99 gCurRoomNum 61 @local3)
					dsCOORD
					104
					85
					dsCOLOR
...
(instance doRiddle of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Print (proc932_8 5 160 36 @local3))
				(= cycles 1)
			)
			(2
				(HandsOn)
