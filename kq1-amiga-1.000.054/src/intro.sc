...
(instance songScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 0 23) number: 81 init: playBed: self) ; backSound
			)
			(1
				((ScriptID 0 23) number: 82 playBed: self) ; backSound
			)
			(2
				(self dispose:)
			)
