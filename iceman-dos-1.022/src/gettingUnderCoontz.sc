...
(instance didntGetUnderCoontz_a of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(EgoDead 7 0 0 341 5) ; "By not getting the Blackhwak under the USS Coontz in time, you lost your cover. Mission aborted."
			)
		)
	)
)
...
(instance didntGetUnderCoontz_b of Script ; UNUSED
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(EgoDead 7 0 0 341 6) ; "By not getting the Blackhwak under the USS Coontz, you lost your cover. Mission aborted."
			)
		)
	)
)
