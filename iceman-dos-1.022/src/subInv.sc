...
(instance Metal_Cylinder of InvI
	...
	(method (showSelf)
		(switch (subMarine invStatus1:)
			(1
				(Print 372 8 #icon view loop cel) ; "A 3" long metal cylinder."
			)
			(2
				(Print 372 9 #icon view loop cel) ; "A 4" long metal cylinder."
			)
			(3
				(Print 372 10 #icon view loop cel) ; "A 6" long metal cylinder."
			)
			(4
				(Print 372 11 #icon view loop cel) ; "A sheared-off metal cylinder."
			)
		)
	)
)
...
(instance sheared_cylinder of InvI
	(properties
