			...
			(= temp5
				(Print
					...
					addEdit:
						@temp0
						3
						(proc79_4 32 152 32 152 152)
						(proc79_4 20 10 10 10 10)
						@temp0
					addButton: 200 10 0 3 1 150 (proc79_4 40 30 30 30 30) 0 ; "Done"
					addButton: 100 10 0 2 1 32 (proc79_4 40 30 30 30 30) 0 ; "Cancel"
					init:
				)
			)
			-1
