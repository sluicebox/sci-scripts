...
(instance menuBar of Class_912_0
	...
	(method (init)
		...
		(AddMenu
			...
			(switch (gGame printLang:)
				(49 {Oberfl\84che :Tastatur Spass :Kundendienst :-! :-! :Weitere Spiele :\9aber Larry 6 })
				(33 {Interface :Dr\93les de Touches :Service Conseil :-! :-! :Vous Appr\82ciez :A Propos de Larry 6 })
