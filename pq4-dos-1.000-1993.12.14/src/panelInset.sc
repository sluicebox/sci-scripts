	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently in the lobby."
			else
				(= cel 1)
...
(instance button2 of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently on the second floor."
			else
				(= cel 1)
...
(instance button3 of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently on the third floor."
			else
				(= cel 1)
...
(instance button4 of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently on the fourth floor."
			else
				(= cel 1)
...
(instance button5 of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently on the fifth floor."
			else
				(= cel 1)
...
(instance button6 of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently on the sixth floor."
			else
				(= cel 1)
...
(instance button7 of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently on the seventh floor."
			else
				(= cel 1)
...
(instance button8 of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently on the eighth floor."
			else
				(= cel 1)
...
(instance buttonG of View
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(if (== gCurRoomNum yStep)
				(gMessager say: noun theVerb 1 0 0 31) ; "You're currently in the basement."
			else
				(= cel 1)
