		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					...
					init: 103 140 130 140 130 127 103 127
					yourself:
				)
		)
		(tweets play:)
		...
		(cond
			...
			((== theVerb 22) ; handgun
				(cond
					...
					(((ScriptID 32 0) doit: 10 22 10 785) ; ShootHandgun
						(val setScript: 0)
						0
					)
				)
...
(instance knockDoor1Scr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(gGame handsOn:)
				(gMessager say: 1 0 4 0) ; "Valerie opens the door. What a cute kid!"
...
(instance knockSubScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gMessager say: 1 4 0 1) ; "Knocking seems less intrusive than ringing the doorbell."
