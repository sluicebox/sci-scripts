...
(instance rm625 of Room
	...
	(method (init)
		...
		(gEgo
			...
			posn: 145 146
			setHeading: 0
			setScaler: Scaler 118 94 150 124
			init:
			normalize: 0
		)
			...
			(if (gPqFlags test: 170)
					...
					(switch theVerb
						...
						(52 ; notebook
							(if (gPqFlags test: 172)
								...
								(gPqFlags set: 172)
								(gMessager say: 6 theVerb 1) ; "You notate your discovery."
							)
						)
						(else
							(super doVerb: theVerb)
				...
				(switch theVerb
					(80 ; skeletonKey
						(gPqFlags set: 170)
						(gGame points: 3 77)
						(gMessager say: noun 80 1) ; "The skeleton key fits into the keyhole and unlocks the dispenser."
					)
					(else
						(if (Message msgSIZE 625 noun theVerb 1 1)
							(gMessager say: noun theVerb 1)
