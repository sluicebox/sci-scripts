	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gGlobalSound0 number: 756 loop: -1 play:)
			)
			(1
				(= ticks 120)
			)
			...
			(12
				(gGame handsOff:)
				(gGlobalSound0 number: 1001 loop: 1 play:)
				(gGlobalSound1 number: 1019 loop: 1 play:)
				(gEgo
					view: 9755
					setLoop: 0
					cel: 0
			...
			(13
				(EgoDead 4 4 0 1 755) ; "A risky move for your final approach!"
			)
		)
	)
)
...
(instance torchHim of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gEgo setCycle: End)
				(gGlobalSound1 number: 1014 loop: 1 play:)
				(mitchell posn: 202 133 view: 7553 cel: 0 setCycle: End self)
				(= cycles 3)
			)
			(3
				(gGlobalSound1 stop:)
			...
			(4
				(gGlobalSound0 number: 1001 loop: -1 play:)
				(gGlobalSound1 number: 1016 loop: -1 play:)
				(mitchell view: 7554 cel: 0 setCycle: End self)
			)
			(5
				(mitchell
					view: 7555
			...
			(7
				(mitchell cycleSpeed: 10 setCycle: ForwardCounter 4 self)
			)
			(8
				(mitchell setCycle: End self)
			)
			(9
				(mitchell setCycle: Beg self)
			)
			(10
...
(instance lookUnderBed of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(gMessager say: 11 49 0 0 self) ; "You look underneath the bed and discover... no one."
			)
			(5
...
(instance mirrorDoor of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(gMessager say: 1 49 0 0 self) ; "The coast is clear."
			)
			(5
				(gEgo setCycle: Beg self)
			)
...
(instance closet of Feature
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(gMessager say: noun theVerb 0 1) ; "You open the closet doors..."
...
(instance bed of Feature
	...
	(method (doVerb theVerb)
		(cond
			...
			((== theVerb 22) ; handgun
				(gMessager say: noun theVerb 4 0) ; "Holster your weapon! There is no visible threat."
			)
			((== theVerb 52) ; notebook
				(if (gPqPointFlags test: 34)
					(gMessager say: noun theVerb 3 0) ; "You've already recorded your findings."
				else
