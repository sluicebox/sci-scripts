	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(global109 loop: 2 cel: 0 cycleSpeed: 9 setCycle: End self)
			...
			(11
				...
				(global109 loop: 3 cel: 0 cycleSpeed: 9 setCycle: End)
				(= cycles 1)
			)
			(12
			...
			(14
				(fiddler1 setLoop: 4 cycleSpeed: 8 setCycle: Fwd)
				(fiddler2 setLoop: 5 cycleSpeed: 8 setCycle: Fwd)
				(fiddler3 setLoop: 6 cycleSpeed: 8 setCycle: Fwd)
				(= cycles 1)
			)
			(15
				(proc0_16 0)
