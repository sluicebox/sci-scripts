...
(instance rhymeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(10
				(global109 cycleSpeed: 4 setCycle: Beg self)
			)
			(11
				(global109 setLoop: 13 setCycle: Fwd)
				(gEgo setMotion: 0 setLoop: -1)
				(if (== gScore gPossibleScore)
					(gEgo setAvoider: PAvoider setMotion: MoveTo 139 146)
				)
...
(instance jackEat of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(global109 setLoop: 7 setCel: 2 cycleSpeed: 3 stopUpd:)
				(global109
					setCycle: Walk
					moveSpeed: 12
					setMotion: MoveTo 77 101 self
				)
			)
			(1
				(if (< (rhymeSync prevSignal:) 10)
