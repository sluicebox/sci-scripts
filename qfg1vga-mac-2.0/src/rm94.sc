...
(instance rm94 of Rm
	...
	(method (init)
		...
		(LoadMany rsSOUND 73 2035 2081 2006 2004 2009 2004)
		...
		(super init:)
		(onWire1 init: setOnMeCheck: 26505)
		(onWire2 init: setOnMeCheck: 26505)
		(onSacks init: setOnMeCheck: 26505)
		(onKegs init: setOnMeCheck: 26505)
		(onChasm init: setOnMeCheck: 26505)
		(onWindow init: setOnMeCheck: 26505)
		(lumber1 init: setOnMeCheck: 26505)
		(lumber2 init: setOnMeCheck: 26505)
		(unknown_94_1 init:)
		(onChasm init:)
		(SolvePuzzle 705 8)
		(NormalEgo)
		...
		(switch theVerb
			...
			(78 ; dazzleSpell
				(if (not (rm94 notify: 0))
					...
					(CastDazzle)
					(rm94 notify: 0)
					(unknown_94_1 setScript: unknown_94_2)
					(= local2 0)
				)
			)
			(81 ; flameDartSpell
...
(instance unknown_94_2 of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 15 80 0 1 self) ; "That was a useless gesture."
			)
			(2
				(self dispose:)
			)
