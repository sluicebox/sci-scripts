...
(local
	...
	local12
	local13
	[local14 11] = [{Mighty careless of you to walk right in front of that knife!  Or did the Chief Thief hit you on purpose?  Or did you just discover an obscure bug in the program???  Maybe you'll never really know. } {You can't believe the Chief Thief's reflexes as he instantly reacts to your intention to pull a fast one.  A dagger flies like lightning and.... } {Trouble with sharp, pointy objects} {These guys are MEAN!} 250 40 75 30 25 100 35]
		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					...
					init: 80 123 84 130 149 130 156 174 61 174 63 152 56 148 51 116 14 155 0 179 149 174 192 180 179 158 284 158 189 111 146 111 133 123
					yourself:
				)
		)
		(LoadMany rsVIEW 332 338 509 503)
		(LoadMany rsSOUND 2031 2029 2030)
		(super init:)
		(SolvePuzzle 638 5 2)
		(dagMusic number: 2031 init:)
		(SL enable:)
		(= local5 100)
		(= local6 7)
		(= gPerspective 70)
		(onBoard init: setOnMeCheck: 26505)
		(onLadder init: setOnMeCheck: 26505)
		(onLightFixture1 init: setOnMeCheck: 26505)
		(onLightFixture2 init: setOnMeCheck: 26505)
		(onBoxes init: setOnMeCheck: 26505)
		(onTrap init: setOnMeCheck: 26505)
		(onDaggers init: setOnMeCheck: 26505)
		(onPottery init: setOnMeCheck: 26505)
		(onOneKnife init: setOnMeCheck: 26505)
		(onCrock init: setOnMeCheck: 26505)
		(onTable init: setOnMeCheck: 26505)
		(onCeiling init: setOnMeCheck: 1 8)
		(onTrunk init: setOnMeCheck: 1 4)
...
(instance knifeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(dagMusic stop:)
				(dagMusic number: (if (Random 0 1) 2030 else 2029) play:)
				(= local4 0)
				(if (< local10 12)
					(++ local0)
					((= local2 (Knife new:))
