...
(instance rm87 of Rm
	...
	(method (init)
		...
		(super init:)
		(water init: setOnMeCheck: 1 2)
		(rocks init: setOnMeCheck: 1 4)
		(trees init: setOnMeCheck: 1 8)
		(deadTree init: setOnMeCheck: 1 16)
		(formation init: setOnMeCheck: 1 32)
		(falls init: setOnMeCheck: 1 16384)
		(SolvePuzzle 703 1)
