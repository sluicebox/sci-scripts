...
(instance rm330 of Rm
	...
	(method (init)
		...
		(HandsOn)
		(super init:)
		(onAlley init: setOnMeCheck: 26505)
		(butcherWindow init: setOnMeCheck: 26505)
		(breadWindow init: setOnMeCheck: 26505)
		(onWorkShop init: setOnMeCheck: 1 4)
		(onTavern init: setOnMeCheck: 1 2)
		(onButcherShop init: setOnMeCheck: 1 8)
		(onPots init: setOnMeCheck: 1 512)
		(onBakery init: setOnMeCheck: 1 256)
		(butcherSign init: setOnMeCheck: 1 64)
		(bakerySign init: setOnMeCheck: 1 128)
		(onBakeryDoor
			init:
			approachVerbs:
				4 ; Do
