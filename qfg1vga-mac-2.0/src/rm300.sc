...
(instance rm300 of Rm
	...
	(method (init &tmp temp0)
		...
		(super init: &rest)
		(= local4 gUseSortedFeatures)
		(= gUseSortedFeatures 0)
		(onBarberNote init: setOnMeCheck: 26505)
		(onInnSign init: setOnMeCheck: 26505)
		(tubOSuds init: setOnMeCheck: 26505)
		(onJailSign init: setOnMeCheck: 26505)
		(sheriffsDoor init: setOnMeCheck: 26505)
		(statue1 init: setOnMeCheck: 26505)
		(statue2 init: setOnMeCheck: 26505)
		(innWindow init: setOnMeCheck: 26505)
		(jailCell init: setOnMeCheck: 26505)
		(jailWindow init: setOnMeCheck: 26505)
		(onScissors init: setOnMeCheck: 26505)
...
(instance sheriff of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Talk
				(gMessager say: 14 57 25 1 self) ; "The sheriff doesn't want to talk right now."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance sheriffTeller of Teller
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(4 ; Do
				(gMessager say: 14 4) ; "The sheriff is no push-over!"
			)
			(2 ; Talk
				(SolvePuzzle 718 1)
				(super doVerb: theVerb)
			...
			(53 ; paper
				(gMessager say: 14 0 26 1) ; "Good idea, but how are you going to be a hero if you have the Sheriff figure everything out? A good hero knows when to keep information to himself."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance otto of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(gMessager say: 18 4) ; "Are you crazy? That goon would tear you limb from limb if you tried to steal his yoyo!"
			)
			(else
				(super doVerb: theVerb)
			)
