...
(instance rm334 of Rm
	...
	(method (init)
		...
		(gFeatures add: onBricks marksOnWall2 marksOnWall eachElementDo: #init)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(knifeSound number: 2031 play:)
			)
			(2
				(knifeSound number: 2029 play:)
				(knife2 setCycle: 0)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(knifeSound number: 2031 loop: 1 play:)
			)
			(3
				(knifeSound number: 2030 play:)
