...
(instance rm83 of Rm
	...
	(method (init)
		...
		(|= global425 $0006)
		(onSeat init: setOnMeCheck: 26505)
		(straw init: setOnMeCheck: 26505)
		(theFire init: setOnMeCheck: 26505)
		(table init: setOnMeCheck: 26505)
		(skull init: setOnMeCheck: 26505)
		(chair init: setOnMeCheck: 1 64)
		(cot init: setOnMeCheck: 1 16)
		(pot1 init: setOnMeCheck: 1 8)
		(pot2 init: setOnMeCheck: 1 128)
		(pot3 init: setOnMeCheck: 1 256)
		(pot4 init: setOnMeCheck: 1 512)
		(pot5 init: setOnMeCheck: 1 1024)
		(pot6 init: setOnMeCheck: 1 2048)
		(pot7 init: setOnMeCheck: 1 4096)
		(water init: setOnMeCheck: 1 4)
		(unknown_83_17 init: setOnMeCheck: 1 8192)
		(bows init: setOnMeCheck: 1 32)
		(unknown_83_19 init: setOnMeCheck: 1 16384)
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(51 ; openSpell
				(Print addText: 17 51 0 1 0 0 83 y: 10 ticks: -1 init:) ; "There is no need to use magic to open anything here."
			)
			(50 ; detectMagicSpell
				(Print addText: 17 50 0 1 0 0 83 y: 10 ticks: -1 init:) ; "You can detect a faint aura of magic here."
			)
			(52 ; Sleep
				(cond
					(local0
...
(instance unknown_83_17 of Feature
	(properties
		x 197
		y 33
		noun 23
...
(instance unknown_83_19 of Feature
	(properties
		x 168
		y 44
		noun 25
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; rations
				(cond
					(local0
						(gMessager say: 17 52 23 1) ; "Try sleeping in the bed or on the floor -- this chair just doesn't make it."
					)
					...
					(else
						(gMessager say: 8 11 20) ; "'Enry isn't hungry and is wide awake, that makes it impossible for you to sleep."
					)
				)
			)
			(16 ; dagger
				...
				(gMessager say: 8 16 0) ; "You seem to have made the 'ermit un'appy."
				(SetFlag 240)
			...
			(34 ; acorn
				(gMessager say: 8 34 0) ; "No thanks. I'm not much o' one for those tree snacks."
			)
			(else
				(super doVerb: theVerb)
			)
