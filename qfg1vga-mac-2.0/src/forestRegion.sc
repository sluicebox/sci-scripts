...
(instance forestRegion of Rgn
	...
	(method (init &tmp temp0 temp1)
		...
		(forestFloor init:)
		(forestTrees init: setOnMeCheck: 1 64)
		(forestRocks init: setOnMeCheck: 1 128)
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(51 ; openSpell
				(gCurRoom setScript: unknown_804_4)
				(return 1)
			)
			(50 ; detectMagicSpell
				(gCurRoom setScript: unknown_804_5)
				(return 1)
			)
			(78 ; dazzleSpell
				(if
					...
					(gCurRoom setScript: unknown_804_8)
					(return 1)
				else
					(super doVerb: theVerb &rest)
				)
			...
			(70 ; ???
				(if
					...
					(gCurRoom setScript: unknown_804_7)
					(return 1)
				else
					(super doVerb: theVerb &rest)
				)
			...
			(81 ; flameDartSpell
				(if
					...
					(gCurRoom setScript: unknown_804_6)
					(return 1)
				else
					(super doVerb: theVerb &rest)
				)
			...
			(79 ; zapSpell
				...
				(if (or (gEgo has: 6) (gEgo has: 2)) ; dagger, sword
					(gCurRoom setScript: unknown_804_2)
				else
					(gCurRoom setScript: unknown_804_3)
				)
				(return 1)
			)
			(82 ; fetchSpell
				(if
					...
					(gCurRoom setScript: unknown_804_1)
					(return 1)
				else
					(super doVerb: theVerb &rest)
				)
...
(instance unknown_804_1 of Script
	(properties)
...
(instance unknown_804_2 of Script
	(properties)
...
(instance unknown_804_3 of Script
	(properties)
...
(instance unknown_804_4 of Script
	(properties)
...
(instance unknown_804_5 of Script
	(properties)
...
(instance unknown_804_6 of Script
	(properties)
...
(instance unknown_804_7 of Script
	(properties)
...
(instance unknown_804_8 of Script
	(properties)
