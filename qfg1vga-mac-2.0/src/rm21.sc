...
(instance rm21 of Rm
	...
	(method (init)
		...
		(gLongSong fade:)
		(teleport number: 2028 init:)
		(ClearFlag 287)
		(bubbleMusic init: play:)
		(NormalEgo)
		(= global111 0)
		(telephone init: setOnMeCheck: 26505)
		(murial init: setOnMeCheck: 26505)
		(brokenGate init: setOnMeCheck: 26505)
		(hutWindow init: setOnMeCheck: 26505)
		(web init: setOnMeCheck: 1 2)
		(table init: setOnMeCheck: 1 4)
		(bucket init: setOnMeCheck: 1 8)
		(note init: setOnMeCheck: 1 16)
		(firePlace init: setOnMeCheck: 1 32)
		(broom init: setOnMeCheck: 1 64)
		(cauldron init: setOnMeCheck: 1 128)
		(skull init: setOnMeCheck: 1 256)
