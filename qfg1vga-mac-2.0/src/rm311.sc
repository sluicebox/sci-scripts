	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(switch (Random 1 2)
					(1
						(gMessager say: 6 1 5) ; "On the table is an old but ornate leather-bound book. There is a quill pen in the ink bottle next to it."
					)
					(2
			...
			(6
				...
				(if local624
					(switch (Random 21 25)
						...
						(24
							(gMessager say: 18 0 11 1 self) ; "You fiendish witch! I will have you... Oh, it is you, my friend!"
						)
						(25
...
(instance youGotPoints of Script
	...
	(method (changeState newState &tmp [temp0 300])
		(switch (= state newState)
			(0
				(HandsOff)
			...
			(3
				(switch (++ local628)
					...
					(2
						(gMessager say: 3 1 2) ; "This entry was made several years ago. It says: 'Baronet Barnard von Spielburg killed a Troll near the Flying Falls on this 43rd day of Octember'."
						(HandsOn)
						(self dispose:)
					)
					(3
