...
(instance rm28 of Rm
	...
	(method (init)
		...
		(rocks init: setOnMeCheck: 26505)
		(postPile init: setOnMeCheck: 26505)
		(road init: setOnMeCheck: 26505)
		(longShot init: setOnMeCheck: 26505)
		(gLongSong fade:)
		(SL enable:)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gEgo setPri: 12 setMotion: MoveTo 190 (gEgo y:) self)
			)
			(1
				(gEgo hide:)
				(= ticks 240)
			...
			(3
				...
				(magicMount init: setOnMeCheck: 26505)
				(farPavilions init: setOnMeCheck: 26505)
				(castle init: setOnMeCheck: 26505)
				(= local3 1)
				(= ticks 260)
			)
			(4
