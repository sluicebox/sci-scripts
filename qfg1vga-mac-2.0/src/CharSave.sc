...
(instance saveHero of Script
	...
	(method (changeState newState &tmp temp0 temp1 temp2 temp3)
		(switch (= state newState)
			(0
				0
				(Format @local52 601 0) ; "glory1.sav"
				(if (>= gScore 500)
			...
			(5
				5
				(gMessager say: 1 0 1) ; "The save character file has been created. Save this disk for use with "Quest for Glory IV: Shadows of Darkness" from Sierra On-Line."
				(= local468 1)
				(= cycles 2)
			)
			(6
				...
				(switch
					...
					(0
						(= state 7)
						(gMessager say: 1 0 7 1 self) ; "Thank you for playing "Quest for Glory I: So You Want To Be A Hero," and congratulations again on winning. We'll see you again soon in "Quest for Glory IV: Shadows of Darkness.""
					)
					(1
						(= temp3 2)
						(= local36 121)
