...
(instance rm41 of Rm
	...
	(method (init &tmp temp0)
		...
		(theGround init: setOnMeCheck: 1 128)
		(SL enable:)
...
(instance unknown_41_17 of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(rDoor setCycle: End)
				(doorSnd number: 2090 loop: 1 play:)
			)
			(4
				(doorSnd stop:)
				(lDoor stopUpd:)
			...
			(7
				(gEgo setLoop: -1 setMotion: MoveTo 112 114 self)
			)
			(8
...
(instance doTheOpen of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				((= local53 (Sound new:)) number: 2028 priority: 6 init: play:)
