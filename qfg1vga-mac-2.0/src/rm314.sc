...
(instance rm314 of Rm
	...
	(method (init)
		...
		(shopMusic init: play:)
		(= local9 1)
		(onClouds init: setOnMeCheck: 26505)
		(onScroll init: setOnMeCheck: 26505)
		(onBat init: setOnMeCheck: 26505)
		(onBottles init: setOnMeCheck: 26505)
		(onBooks init: setOnMeCheck: 26505)
		(onCrystalBall init: setOnMeCheck: 26505)
		(onMagicBall init: setOnMeCheck: 26505)
		(onBalanceScale init: setOnMeCheck: 26505)
		(onPentagon init: setOnMeCheck: 26505)
		(onBrownJar init: setOnMeCheck: 26505)
		(onGreenJar init: setOnMeCheck: 26505)
		(onAGreenJar init: setOnMeCheck: 26505)
		(onRedJar init: setOnMeCheck: 26505)
		(onBlueBottle init: setOnMeCheck: 26505)
		(onCeiling init: setOnMeCheck: 26505)
		(onMortar init: setOnMeCheck: 26505)
		(onFloor init: setOnMeCheck: 1 2)
...
(instance familiarScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(if (not local4)
					(theThunder number: 2045 init: play:)
