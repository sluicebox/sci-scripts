...
(procedure (localproc_2 param1)
	...
	(NormalEgo)
	(EgoGait 0 0) ; walking
	(local4 setScript: unknown_210_18)
)
	...
	(cond
			...
			(switch local1
				(1
					(if
						...
						(local4 setScript: unknown_210_15)
					else
			...
			(switch local1
				(1
					...
					(if
						...
						(local4 setScript: unknown_210_13)
					else
						(= param1 (= global280 0))
						(local4 dispose:)
						(= global279 0)
				...
				(3
					...
					(if
						...
						(local4 setScript: unknown_210_14)
					else
		...
		((== temp2 10)
			(switch (= temp2 (if (< (Random 0 1000) 500) 8 else 2))
				(2
					(param2 setScript: unknown_210_12)
				)
				(8
					(param2 setScript: unknown_210_11)
				)
			)
		)
		(temp3
...
(procedure (localproc_6 &tmp [temp0 190])
	(switch global262
		(0
		...
		(switch theVerb
			(80 ; calmSpell
				(if (or local68 (== global279 435))
					...
					(gCurRoom setScript: unknown_210_8)
					(return 1)
				)
			)
			(51 ; openSpell
				(gCurRoom setScript: unknown_210_9)
				(return 1)
			)
			(50 ; detectMagicSpell
				(gCurRoom setScript: unknown_210_7)
				(return 1)
			)
			(78 ; dazzleSpell
				(if (or local68 (== global279 435))
					...
					(gCurRoom setScript: unknown_210_6)
				)
				(return 1)
			)
			(79 ; zapSpell
				...
				(if (or (gEgo has: 6) (gEgo has: 2)) ; dagger, sword
					(gCurRoom setScript: unknown_210_4)
				else
					(gCurRoom setScript: unknown_210_5)
				)
				(return 1)
			)
			(82 ; fetchSpell
				(if local6
					(gCurRoom setScript: unknown_210_2)
				else
					(gCurRoom setScript: unknown_210_3)
				)
				(return 1)
			)
			(else
...
(instance unknown_210_2 of Script
	(properties)
...
(instance unknown_210_3 of Script
	(properties)
...
(instance unknown_210_4 of Script
	(properties)
...
(instance unknown_210_5 of Script
	(properties)
...
(instance unknown_210_6 of Script
	(properties)
...
(instance unknown_210_7 of Script
	(properties)
...
(instance unknown_210_8 of Script
	(properties)
...
(instance unknown_210_9 of Script
	(properties)
...
(instance unknown_210_11 of Script
	(properties)
...
(instance unknown_210_12 of Script
	(properties)
...
(instance unknown_210_13 of Script
	(properties)
...
(instance unknown_210_14 of Script
	(properties)
...
(instance unknown_210_15 of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(if global251
					(gMessager say: 2 0 8 1 0 210) ; "You retrieve the daggers that found their target."
					(gEgo get: 6 global251) ; dagger
					(= global251 0)
				)
...
(instance unknown_210_18 of Script
	(properties)
		...
		(switch (= state newState)
			(0
				...
				(if (!= global279 435)
					...
					(if (== local4 450)
						(local4 setLoop: 0 cel: 0)
					)
					(if (!= global279 445)
						(if (== global279 450)
							(gMessager say: 2 0 15 0 0 210) ; "Your attacks have taken a terrible troll!"
						)
