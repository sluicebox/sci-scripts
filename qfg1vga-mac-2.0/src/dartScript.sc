...
(procedure (CastDart param1 param2 param3 param4 &tmp temp0 temp1 temp2 temp3)
	...
	((= local9 (Sound new:)) number: 2033 priority: 15 init:)
	(= local0 param1)
	((= temp2 (Actor new:))
		view: 522
		setLoop: 2
			...
			(5
				(if local11
					(if (not (TakeDamage 100))
						...
						(= [gEgoStats 1] (Max 0 (- [gEgoStats 1] 1))) ; intelligence, intelligence
					)
				)
				(cond
					((IsObject register)
