...
(procedure (CastCalm param1 param2)
	(if (== gCurRoomNum 45)
		(Print addText: 1 0 1 1 0 0 558 y: 10 ticks: -1 init:) ; "The goblin is charging wildly. He will not be calmed! Maybe you're violating his turf?"
	else
		(if (not global102)
			(= local5 1)
		)
...
(instance castCalm of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				((= local4 (Sound new:)) number: 39 priority: 6 init:)
				(= local0 (gEgo signal:))
