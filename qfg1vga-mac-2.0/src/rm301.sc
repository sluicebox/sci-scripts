...
(instance rm301 of Rm
	...
	(method (init)
		...
		(super init:)
		(|= global425 $0006)
		(onSleepDoor init: setOnMeCheck: 26505)
		(onLargeTable init: setOnMeCheck: 26505)
		(onFireplace init: setOnMeCheck: 26505)
		(onKitchenDoor init: setOnMeCheck: 26505)
		(onPlates init: setOnMeCheck: 26505)
		(onPots init: setOnMeCheck: 26505)
		(onGenieLamp init: setOnMeCheck: 26505)
		(onMask init: setOnMeCheck: 26505)
		...
		(shema init: stopUpd: actions: shemaTeller)
		(switch gPrevRoomNum
			(302
...
(instance rentARoom of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(HandsOff)
				(unknown_301_52 setScript: unknown_301_53)
				(shameen setCycle: Beg self)
			)
			(3
				(ClearFlag 300)
...
(instance unknown_301_52 of Prop
	(properties
		x 500
		y 500
		view 0
...
(instance unknown_301_53 of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 17 0 26 1 self) ; "May you dream of all the rewards you deserve."
			)
			(2
				(self dispose:)
			)
		...
		(switch (= state newState)
			...
			(4
				(if (and (== local141 0) (== local142 0))
					(HandsOn)
					(User canControl: 0)
					(unknown_301_52 setScript: unknown_301_55)
				else
					(unknown_301_52 setScript: unknown_301_56)
					(cond
						((== local141 1)
							(= local141 2)
...
(instance unknown_301_55 of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 18 0 44 1 self) ; "I am Shema. Do you wish food or drink?"
			)
			(2
				(HandsOn)
				(self dispose:)
...
(instance unknown_301_56 of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 18 0 43 1 self) ; "I bring you that which you ordered. May it please and satisfy you."
			)
			(2
				(self dispose:)
			)
...
(instance unknown_301_57 of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 18 0 45 1 self) ; "Permit me to clear the table for you."
			)
			(2
				(self dispose:)
			)
...
(instance comingToClear of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(unknown_301_52 setScript: unknown_301_57)
				(= cycles 1)
			)
			(6
