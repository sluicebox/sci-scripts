...
(instance sceneThreeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(PrintDC 102 0 #at 100 100 #dispose) ; "\adMi castillo! \a8Qu\82 ha pasado?"
			...
			(8
				(PrintDC 102 1 #at 10 10 #dispose) ; "Yo te puedo contar lo que ha pasado."
			...
			(12
				(cls)
				(= global380 1)
				(PrintDC 102 2 #at 100 100 #dispose) ; "\ad\a8Qu\82?!"
