...
(instance talkToWitch of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(cls)
				(proc0_28 77 200 2 67 50 8 70 160 25 7) ; "What are you doing in my forest, young man! Don't you know you're trespassing?"
				(= cycles 1)
			)
			(1
				(proc0_28 160 200 3 67 8 8 70 160 25 6) ; "Oh, I didn't know this was a PRIVATE forest. Do you own it?"
				(= cycles 1)
			)
			(2
				(proc0_28 77 200 4 67 50 8 70 160 25 8) ; "Of COURSE I own it! It's mine! And what did you do to my magic?!"
				(= cycles 1)
			)
			(3
				(proc0_28 160 200 5 67 8 8 25 8 70 160) ; "I don't think you need to know. Now tell me something...how does one leave this terrible forest?"
				(= cycles 1)
			)
			(4
				(proc0_28 77 200 6 67 50 8 25 7 70 160) ; "I'll never tell. I'm afraid you're stuck, dearie. Now you're my prisoner."
				(= cycles 1)
			)
			(5
				(proc0_28 160 200 7 67 8 8 25 5 70 160) ; "We'll see about that!"
				(= cycles 1)
			)
			(6
				(proc0_28 77 200 8 67 50 8 25 4 70 160) ; "Yes, won't we."
				(= cycles 1)
			)
			(7
				(HandsOn)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(= global110 (gEgo x:))
				(= global111 (gEgo y:))
				(proc0_28 77 200 9 25 4 67 50 8 70 160) ; "What's this?"
	...
	(method (doit)
		...
		(if
			...
			(if
				...
				(++ local2)
				(proc0_28 77 200 10 25 6 67 50 8 70 160) ; "You're not crossing my bridge, little man!"
			)
		)
	)
			...
			(switch (event message:)
				...
				(4 ; Inventory
					(switch (gInventory indexOf: (gTheIconBar curInvIcon:))
						...
						(else
							(proc0_28 77 200 15 25 9 67 50 8 70 160) ; "Don't try to bribe me with THAT, dearie!  I'm not DUMB, ya know!"
							(event claimed: 1)
						)
					)
				)
