	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 103 0 #at 10 10 #dispose) ; "S\a1, yo s\82 que le ha pasado a tu castillo. Lo v\a1 todo."
			...
			(2
				...
				(= global380 1)
				(PrintDC 103 1 #at 80 20 #dispose) ; "\ad\a8S\a1?! \ad\a8Bueno, entonces...qu\82 pas\a2?!"
				(= seconds (LangSwitch 5 8))
			)
			(3
...
(instance sceneSevenScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(egoMouth setCycle: Fwd)
				(PrintDC 103 2 #at 10 130 #dispose) ; "\a8Por qu\82? \a8Por qu\82 ese brujo... Mordack... quiere mi castillo? \a8Qu\82 puede tener contra m\a1 y mi familia?"
			...
			(2
				...
				(owlFace setCycle: Fwd)
				(= global380 1)
				(PrintDC 103 3 #at 10 10 #dispose) ; "Eso no lo s\82. S\a2lo s\82 que fue Mordack quien se llev\a2 tu castillo... y tu familia."
