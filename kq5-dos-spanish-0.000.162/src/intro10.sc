	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 109 0 #at 10 10 #dispose #width 270) ; "...La Sociedad de Brujos siempre ha tenido una mala opini\a2n de Mordack y de sus abusos de poder. Por eso ha sido suspendido varias veces. Parece que Mordack nunca hizo nada bueno."
				(= cycles 1)
			)
			(2
			...
			(5
				...
				(owl setScript: owlDrinkingTea)
				(gEgo setCycle: Fwd)
				(PrintDC 109 1 #at 100 120 #dispose) ; "Crispin \a8Por qu\82 querr\a1a Mordack llevarse a mi familia o mi castillo? \a8Qu\82 le hemos hecho?"
				(= cycles 1)
			)
			(6
			...
			(9
				...
				(PrintDC 109 2 #at 10 10 #dispose) ; "Creo que no tengo respuesta para eso. Mordack es un brujo impredecible. NUNCA entend\a1 su diab\a2lica mente."
				(= cycles 1)
			)
			(10
			...
			(12
				...
				(PrintDC 109 3 #at 10 120 #dispose) ; "Pens\82 que quizas podr\a1as ayudar a su Majestad, Crispin. Por eso le he traido aqu\a1."
				(= cycles 1)
			)
			(13
				(if
			...
			(15
				...
				(PrintDC 109 4 #at 10 10 #dispose) ; "Bueno, d\82jame ver..."
				(= cycles 1)
			)
			(16
				(if
			...
			(17
				(cls)
				(PrintDC 109 5 #at 10 10 #dispose) ; "Sabes ..., hace tiempo yo era un brujo muy poderoso pero \a3ltimamente me he oxidado un poco."
				(= cycles 1)
			)
			(18
				(if
			...
			(21
				(gEgo setScript: egoDrinkTea)
				(owlMouth show: setCycle: Fwd)
				(PrintDC 109 6 #at 10 120 #dispose) ; "\ad\a8Oxidado un POCO?!"
				(= seconds 3)
			)
			(22
			...
			(25
				...
				(crispinMouth setCycle: Fwd)
				(PrintDC 109 7 #at 10 10 #dispose) ; "\adCedric, ya esta bien!"
				(= cycles 1)
			)
			(26
				(if
			...
			(27
				...
				(PrintDC 109 8 #at 10 120 #dispose) ; "SI, SE\a5OR."
				(= seconds 3)
			)
			(28
				(cls)
			...
			(30
				...
				(PrintDC 109 9 #at 10 10 #dispose #width 270) ; "No s\82 si lo que tengo te ser\a0 \a3til. La mayor\a1a de mis cosas est\a0n bastante viejas y gastadas. Pero d\82jame ver qu\82 puedo encontrar."
				(= seconds 12)
			)
			(31
				(cls)
			...
			(39
				(PrintDC 109 10 #at 100 10 #dispose) ; "Mmmmm. Esto puede que funcione."
				(= seconds 4)
			)
			(40
				(cls)
			...
			(43
				...
				(PrintDC 109 11 #at 100 10 #dispose) ; "Toma, come esto."
				(= seconds 3)
			)
			(44
				(crispin
			...
			(48
				...
				(PrintDC 109 12 #at 10 10 #dispose) ; "\a8Qu\82 ES esto?"
				(= seconds 4)
			...
			(49
				...
				(crispinMouth setCycle: Fwd)
				(PrintDC 109 13 #at 10 10 #dispose #width 270) ; "Es un trozo de serpiente blanca m\a0gica que me queda del a\a4o pasado."
				(= seconds 7)
			)
			(50
				(cls)
				(PrintDC 109 14 #at 10 10 #dispose #width 270) ; "Con esto podr\a0s comunicarte con el mundo animal y vegetal. Ver\a0s que \a3til es."
				(= seconds 9)
			)
			(51
				(cls)
			...
			(53
				...
				(crispinMouth setCycle: Fwd)
				(PrintDC 109 15 #at 10 10 #dispose #width 270) ; "Toma, mi vieja varita. No s\82 si sigue funcionando. La mayor parte de sus poderes pueden haber desaparecido. Deber\a1as saber que las varitas son como los animales dom\82sticos."
				(= seconds 10)
			)
			(54
				(cls)
				(PrintDC 109 16 #at 10 10 #dispose #width 270) ; "Deben acostumbrarse a ti antes de obedecerte. Tr\a0tala con cuidado y respeto y quiz\a0s haga algo por ti."
				(= seconds 10)
			)
			(55
				(crispinMouth hide:)
			...
			(62
				...
				(PrintDC 109 17 #at 10 10 #dispose) ; "Mejor que te vayas. Nunca se sabe que podr\a1a hacer ese sorprendente Mordack."
				(= seconds 7)
			)
			(63
				(cls)
				(PrintDC 109 18 #at 10 10 #dispose) ; "Cedric, ve con \82l y mu\82strale el camino."
				(= seconds 5)
			)
			(64
				(cls)
				...
				((gEgo head:) hide:)
				(owlMouth setCycle: Fwd)
				(PrintDC 109 19 #at 10 120 #dispose) ; "\a8Y-o-o?"
				(= seconds 3)
			)
			(65
				(cls)
				...
				(owlMouth setCycle: 0 setCel: 0)
				(crispinMouth show:)
				(PrintDC 109 20 #at 10 10 #dispose) ; "S\a1, \adTU! No seas tan cobarde."
				(= seconds 4)
			)
			(66
				(cls)
			...
			(67
				...
				(PrintDC 109 21 #at 10 10 #dispose) ; "\adV\a0monos! \adMejor que empecemos ya!"
				(= seconds 4)
			)
			(68
				(cls)
				(egoHead show:)
				(crispinMouth hide:)
				(PrintDC 109 22 #at 100 120 #dispose) ; "Gracias, se\a4or. Te agradezco todo lo que has hecho por m\a1."
				(= seconds 6)
			)
			(69
				(cls)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(crispin setCycle: 0)
				(PrintDC 109 23 #at 100 10 #dispose) ; "No, esto no lo har\a0."
				(= cycles 10)
			)
			(1
			...
			(2
				(cls)
				(crispin setCycle: 0)
				(PrintDC 109 24 #at 100 10 #dispose) ; "Todo eso est\a0 usado."
				(= cycles 10)
			)
			(3
				(crispin setCycle: Fwd)
