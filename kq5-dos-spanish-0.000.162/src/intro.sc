...
(instance sceneOneScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local1 (Display 100 0 dsCOORD 10 100 dsWIDTH 300 dsALIGN alCENTER dsFONT 8 dsCOLOR 0)) ; "CASTILLO DE DAVENTRY"
				(= local0
					(Display ; "CASTILLO DE DAVENTRY"
						100
						0
						dsCOORD
						9
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 100 1 #at 10 10 #dispose) ; "\adVen! \adAqu\a1 Arriba!"
			...
			(6
				(PrintDC 100 2 #at 10 10 #dispose) ; "Siguemeee...!"
