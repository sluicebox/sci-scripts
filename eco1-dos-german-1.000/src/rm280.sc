...
(instance rm280 of EcoRoom
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				((ScriptID 2 0) init: 1 1) ; Delphineus, "This seaweed forest might be a pain to navigate but the plants are alive. Let's be careful not to disturb anything in here."
			)
			(4 ; Inventory
				((ScriptID 2 0) init: 1 1) ; Delphineus, "This seaweed forest might be a pain to navigate but the plants are alive. Let's be careful not to disturb anything in here."
			)
			(10 ; Recycle
				(Narrator init: 9) ; "The seaweed cannot be cleared away with Adam's garbage bag."
			)
			(else
