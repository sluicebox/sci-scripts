...
(instance gelHair of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(gGkSound1 number: 272 setLoop: 1 play:)
				(gEgo setCel: 2 setLoop: 3 setCycle: End self)
			)
			(5
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(for ((= local10 100)) (>= local10 0) ((-= local10 1))
					(Palette 2 0 255 local10) ; PalIntensity
				)
				(= cycles 15)
			)
			(4
				(gGkSound1 number: 271 setLoop: 1 play: self)
				(if local5
					(gEgo normalize: 2 278)
				else
			...
			(5
				(for ((= local10 0)) (<= local10 100) ((+= local10 1))
					(Palette 2 0 255 local10) ; PalIntensity
				)
				(= cycles 1)
			)
