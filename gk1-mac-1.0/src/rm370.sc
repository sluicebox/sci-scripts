...
(instance rm370 of Room
	...
	(method (init)
		...
		(switch gDay
			(1
				(dayNumber setCel: 0 setLoop: 1 posn: 243 46)
			)
			(2
				(dayNumber setCel: 0 setLoop: 2 posn: 229 53)
			)
			(3
				(dayNumber setCel: 0 setLoop: 3 posn: 238 39)
			)
			(4
				(dayNumber setCel: 0 setLoop: 4 posn: 263 32)
			)
			(5
				(dayNumber setCel: 0 setLoop: 5 posn: 254 30)
			)
			(6
				(dayNumber setCel: 0 setLoop: 6 posn: 283 27)
			)
			(7
				(dayNumber setCel: 0 setLoop: 7 posn: 252 31)
			)
		)
		(if (IsFlag 15)
			(cond
...
(instance startTheDay of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(gGkSound1 number: 371 setLoop: 3 play:)
				(kidOnBike init: cycleSpeed: 12 setCycle: End self)
			...
			(9
				(gGkSound1 stop:)
				(gGkSound2 number: 372 setLoop: 1 play: self)
			)
			(10
				(paper init:)
				(kidOnBike dispose:)
...
(instance phoneCall of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(17
				(dayNumber setCel: 0 setLoop: gDay posn: 254 30)
				(self setScript: startTheDay)
			)
		)
	)
