...
(instance rm380 of Room
	...
	(method (dispose)
		...
		(gEgo normalize: setPri: -1 setScale: 0)
		(if (not (IsFlag 203))
			(SetFlag 203)
		)
...
(instance egoEnters of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(granny view: 386 setCel: 0 setLoop: 0 setCycle: CT 1 1 self)
			)
			(5
				(gGkSound1 number: 373 setLoop: 1 play:)
				(granny view: 386 setCel: 2 setLoop: 0 setCycle: End self)
			)
			(6
				(if (IsFlag 203)
			...
			(14
				(if (IsFlag 203)
					(gMessager say: 20 0 (local2 at: local3) 3 self)
				else
					(gMessager say: 20 0 2 3 self) ; "Not at all! Give us a kiss."
				)
				(granny view: 382 setLoop: 0 setCycle: StopWalk -1)
			)
			(15
