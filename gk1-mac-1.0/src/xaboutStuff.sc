...
(instance xaboutStuff of Code
	...
	(method (doit &tmp temp0)
		(if (not (Platform 0 2 1))
			(Platform 0 2 1)
		)
		(= temp0 (gGame setCursor: aboutArrowCurs 1))
		(Print addText: 29 0 8 1 0 0 0 init:) ; "GABRIEL KNIGHT: SINS OF THE FATHERS This entire work Copyright (c) 1994 Sierra On-Line, Inc. Contains technologies described in U.S. patent applications including 598,172 and 658,297."
		((= local0 (Print new:))
			addText: {About:} 66 0
		...
		(switch (= local1 (local0 init:))
			(1
				(if
					(and
						(Print addText: 29 0 8 2 0 0 0 init:) ; "Gabriel Knight development team:  Designer/Director: Jane Jensen  Producer/Composer: Robert Holmes  Macintosh Development:    Keith Nemitz    Krishnan Shankar    Jason Hickingbottom  Lead Programmer: Tom DeSalvo  Programmers:    Bob Andrews, Sean Mooney,    Greg Tomko-Pavia, Jerry Shaw  Illustration Director: John Shroades  Animation Director: Michael Hutchison  Backgrounds/Illustrations:    Darlou Gams, John Shroades,    Chris Willis, Deanna Yhalkee  Animation:    Michael Hutchison, Chris Willis,    Deanna Yhalkee, Darlou Gams,    John Shroades"
					...
					(Print addText: 29 0 8 9 0 0 0 init:) ; "QA Configuration:   Team Lead: Jon Meek   Dave Clingman, Daryle Smith,   Roger Clendenning, Lynne Dayton,   Doug Wheeler, John Trauger,   Leonard Salas, Ken Eaton,   Sharon Simmons, Mike Jones,   Catie Andrews Special Thanks:   Woodholly Productions,   Dan Kehler, Stuart Moulder,   Sabine Duvall, Mark Hood,   Jim Thomas, Bil Skirvin,   Lesa Spravka, Tony Caudill,   Terese Nielsen, Nathan Gams,   the GK beta testers Napolean House Music:   Vivaldi    From "Lute Concerto in D""
				)
			)
			(2
				(if
