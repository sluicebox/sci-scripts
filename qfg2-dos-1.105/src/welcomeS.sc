		...
		(switch (= state newState)
			...
			(6
				(switch gDay
					...
					(15
						(HighPrint 163 28) ; "At nightfall tonight, go to the door at the end of 'Saif Darb,' off 'Askeri Darb.' Obey, or you'll regret it."
					)
				)
				(self cue:)
			)
...
(instance enterCongrats of HandsOffScript
	...
	(method (changeState newState &tmp [str 100])
		(switch (= state newState)
			(0
				(Face gEgo (ScriptID 160 2)) ; rakeesh
				(Say (ScriptID 160 2) self 163 36) ; "So, Hero, not being content with having merely saved the city, I see that you are about to attempt to save the land of Shapeir as well.", rakeesh
			)
			(1
				(cond
					((== gHeroType 3) ; Paladin
						(Say (ScriptID 160 2) self 163 37) ; "The light shines brightly within you. You have so far managed to walk the narrow line between Honor and Necessity. May your deeds continue to shine, and not be dulled by the darkness you will soon encounter.", rakeesh
					)
					((== gHeroType 0) ; Fighter
						(Say (ScriptID 160 2) self 163 38) ; "You have proven yourself both brave and resourceful by your actions.", rakeesh
					)
					((== gHeroType 2) ; Thief
						(Say (ScriptID 160 2) self 163 39) ; "When first we met, I could feel there was dark within you. Now I can see that the light is stronger, if you will only let it be so. It is a narrow path between darkness and light, and you will always walk that tightrope in your soul.", rakeesh
					)
					((== gHeroType 1) ; Magic User
						(Say (ScriptID 160 2) self 163 40) ; "I have seldom met one with such Power and so much wisdom and courage as you have shown. Few users of Magic dare face what you have faced to protect this city.", rakeesh
					)
				)
			)
			(2
				(Say (ScriptID 160 2) self 163 41 163 42) ; "The journey you are about to make is to a very dark and dangerous place. The foe you will face is very powerful in the ways of magic.", rakeesh
			)
			(3
				(Say (ScriptID 160 2) self (Format @str 163 43 @gUserName)) ; rakeesh, "All of us in this city will be hoping for your safety, for all know of the seriousness of your mission. May fortune smile upon you, %s."
			)
			(4
				(Face gEgo (ScriptID 160 3)) ; uhuraBody
				(Say (ScriptID 160 1) self 163 44) ; "Keep your weapon handy, Hero, and don't let your enemies get you. You and I maybe practice some more when you get back.", uhura
			)
			(5
				(if (== gOrigHeroType 0)
					(Face gEgo (ScriptID 160 2)) ; rakeesh
					(Say (ScriptID 160 2) self 163 45) ; "If you will permit it, my friend, perhaps you and I could practice with weapons before you go. I happen to know some skills with weapons that might help you on your mission.", rakeesh
				else
					(self cue:)
				)
			)
