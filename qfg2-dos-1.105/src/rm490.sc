		...
		(cond
			...
			((Said 'throw/dirt')
				...
				(cond
					...
					((and (not (gEgo has: 52)) (not gClumpsLeft)) ; MagicEarth
...
(instance avisDead of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(21
				(CenterPrint 490 62 80 {Djinni:} 70 315) ; "One thousand years and a Year,  so shall Iblis be caught, In the tombstones of the City,  where he and I once fought. Until moonlight has been captured,  twixt the Scorpion and Drake, Then comes a Hero from the North,  and ancient powers wake."
				(= cycles 2)
			)
			(22
				(CenterPrint 490 63 80 {Djinni:} 70 315 35 aWin) ; "Led and followed by a Dark one,  guide to deceit and despair, Passing through the Trial by Fire,  Trials of Water, Earth, and Air; Passing through the Door unopened,  barrier that yields to none, By my name of Suleiman,  So shall this be done!"
				(= cycles 2)
			)
			(23
