...
(instance aboutCode of Code
	...
	(method (doit)
		...
		(Print 811 2) ; "ADDITIONAL MATERIAL/SPECIAL CONTRIBUTIONS - Bridget McKenna, Gano Haine, Doug Herring, Jerry Shaw. THE NEARLY INCREDIBLE PROGRAMMERS - Jerry Shaw, Randy MacNeil, Dave Jamriska, Hugh Diedrichs, Christopher Carr."
	)
)
