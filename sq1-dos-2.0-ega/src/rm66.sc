...
(local
	local0
	local1
	[local2 38] = [0 189 0 0 319 0 319 104 0 104 0 110 13 110 2 119 2 134 128 134 101 147 91 147 33 176 91 176 147 134 169 134 186 142 319 142 319 189]
	[local40 48] = [0 189 0 0 319 0 319 102 308 105 304 110 286 110 280 104 0 104 0 110 13 110 2 119 2 134 128 134 104 149 88 149 39 175 91 175 112 158 144 134 169 134 186 142 319 142 319 189]
)
...
(instance rm66 of SQRoom
	...
	(method (init)
		...
		(withG points: @local40 size: 24)
		(withoutG points: @local2 size: 19)
		(if (not (IsFlag 58))
