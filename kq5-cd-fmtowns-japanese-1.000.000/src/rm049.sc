...
(local
	...
	[local105 20] = [0 0 225 0 225 91 166 107 113 89 109 108 70 112 48 132 21 144 0 156]
	[local125 14] = [86 189 171 176 142 158 179 158 211 108 319 95 319 189]
	local139
	[local140 9] = [1000 145 70 4 11 24 19 23 30]
	[local149 9] = [1003 105 71 4 11 25 23 31 31]
)
...
(instance captureScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(proc762_1 @local140 3074)
				(harpy1 setMotion: getEgo2 self)
			)
			(2
				(proc762_1 @local149 7028)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(gEgo setLoop: 1 setCycle: SyncWalk)
				(= cycles 1)
			)
			(3
				(self dispose:)
