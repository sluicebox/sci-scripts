...
(instance a2s3Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(owlMouth setCycle: MouthSync 887)
				(Say 887 self)
			)
			(6
			...
			(8
				...
				(wizHead setCycle: MouthSync 888)
				(Say 888 self)
			)
			(9
			...
			(14
				(wizHead setCycle: MouthSync 889)
				(Say 889 self)
			)
			(15
				(cls)
				(wizHead hide: setCycle: 0)
				(crispin
					setLoop: 0
					setCycle: Walk
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(cEyes init:)
				(cEyeBrows init:)
				(cmouth init: setCycle: MouthSync 890)
				(Say 890 self)
			)
			(2
				(cls)
	...
	(method (changeState newState &tmp [temp0 100])
		(switch (= state newState)
			...
			(2
				...
				(wizHead setCycle: MouthSync 891)
				(Say 891 self)
			)
			(3
				(cls)
				...
				(crispin setCycle: 0)
				(owlMouth setCycle: MouthSync 892)
				(Say 892 self)
			)
			(4
				(cls)
