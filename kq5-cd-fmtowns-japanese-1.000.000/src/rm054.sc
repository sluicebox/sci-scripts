...
(local
	...
	[local34 9] = [1000 173 8 4 11 24 19 23 30]
	[local43 9] = [1003 115 113 4 11 25 23 31 31]
	[local52 6] = [0 3086 1 7033 0 0]
	[local58 12] = [0 3087 1 7034 0 3088 1 7035 0 3089 0 0]
)
...
(instance conversation of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(proc762_0 @local34 @local43 @local52 self)
			)
			(2
				(HandsOn)
				(self dispose:)
...
(instance enterGrate of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(if (not (IsFlag 55))
					(proc762_0 @local34 @local43 @local58 self)
				else
					(= cycles 1)
				)
			)
