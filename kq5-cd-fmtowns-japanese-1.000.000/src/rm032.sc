...
(local
	...
	local40
	[local41 9] = [1028 5 70 3 9 26 24 32 32]
	[local50 9] = [1000 75 60 4 11 24 19 23 30]
)
...
(instance rm032 of KQ5Room
	...
	(method (doit &tmp temp0)
		(cond
			...
			((and (not (IsFlag 16)) (>= (gEgo x:) 30) (== local1 0))
				(Say 444)
				(= local1 1)
			)
			((and (not (IsFlag 16)) (>= (gEgo x:) 105) (== local1 1))
...
(instance catchCedric of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(cls)
				(proc762_1 @local41 7021)
				(gEgo normal: 1 view: 10 loop: 0 setCycle: SyncWalk)
				((gEgo head:) show:)
				(= global322 0)
				(cls)
				(HandsOn)
