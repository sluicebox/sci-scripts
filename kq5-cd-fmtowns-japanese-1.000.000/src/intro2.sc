...
(instance creditsScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(= local3
					(Display 101 9 dsCOORD 21 11 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Lead Programmers"
				)
				(= local2
					(Display 101 10 dsCOORD 21 27 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Chris Iden Robert Lindsley"
				)
				(= local1
					(Display ; "Lead Programmers"
						101
						9
						dsCOORD
						20
				...
				(= local0
					(Display ; "Chris Iden Robert Lindsley"
						101
						10
						dsCOORD
						20
