	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(cond
					((== (self cel:) 0)
						(sFX number: 44 flags: 5 setLoop: 1 play:) ; sSqueakyDoorOpen
						(self setCycle: End)
					)
					((== (safeDoor cel:) 0)
						(sFX number: 45 flags: 5 setLoop: 1 play:) ; sSqueakyDoorClose
						(self setCycle: Beg)
					)
				)
			)
			...
			(4 ; Do
				...
				(cond
					(local0
						(if (== (self cel:) 0)
							(= local3 0)
							(sFX number: 560 flags: 5 setLoop: 1 play:) ; sOpenSafe
...
(instance sCloseSafe of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(sFX number: 561 flags: 5 play: setLoop: 1) ; sCloseSafe
				(= local1 0)
				(self dispose:)
			)
		)
