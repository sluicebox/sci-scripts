	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(= local1 1)
				(= local0 (Print 22 0 #at 210 25 #width 100 #font 600 #dispose)) ; "Gosh Rog, we really appreciate you saving us and all."
				(= seconds 12)
			)
			(2
				(= local1 0)
			...
			(3
				...
				(= local2 1)
				(= local0 (Print 22 1 #at 210 25 #width 100 #font 600 #dispose)) ; "Yeah, we were really scared. We didn't know what Pug was gonna do to us."
				(= seconds 12)
			)
			(4
				(= local2 0)
			...
			(5
				(localproc_0 MarkHead 1)
				(= local1 1)
				(= local0 (Print 22 2 #at 210 25 #width 100 #font 600 #dispose)) ; "Hey, uh, don't you think we better get outta here? Pug's really sore and he probably sent some ships after us."
				(= seconds 12)
			)
			(6
				(= local1 0)
