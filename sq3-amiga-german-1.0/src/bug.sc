	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(HandsOff)
				(gEgo setMotion: 0)
				(zap number: 90 priority: 10 playBed:)
			...
			(4
				...
				(RedrawCast)
				(Print 511 1) ; "The Scorpazoid's stinger hits it's mark sending electro-plasmatic venom into your system. Death comes quickly."
				(= seconds 5)
			)
			(5
