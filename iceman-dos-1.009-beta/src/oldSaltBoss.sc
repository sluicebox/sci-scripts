		...
		(switch (= state newState)
			...
			(3
				...
				(if
					...
					(switch (Random 0 2)
						(0
							(Print 378 3) ; "Mercy mercy lad!" he says, "Show me what you have."
						)
						(1
							(Print 378 4) ; ""Let me see em Commander." the old guy says."
						)
						(2
							(Print 378 5) ; "He looks you in the eye and says, "Come on up!""
						)
					)
					(= register 0)
					...
					(switch (Random 0 2)
						(0
							(Print 378 6) ; "The dice aren't working for me!" he says, "I'll be havin' to ask ye to roll again."
						)
						(1
							(Print 378 7) ; ""Start a new round!" He scowls."
						)
						(2
							(Print 378 8) ; "Sure now, tis my bad luck that'l be causin me ta lose all me money. Let's roll again."
						)
					)
					(= register 1)
...
(instance johnnyRoll2 of Script
	...
	(method (handleEvent event)
		...
		(cond
			...
			((MousedOn (ScriptID 39 12) event) ; rButton
