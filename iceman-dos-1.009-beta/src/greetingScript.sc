	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(Print 390 2) ; "Your credentials are admirable!" he says, "We're proud to have you as part of this team."
			...
			(4
				(Print 390 4) ; "Commander Westland" he says, "By now you have reviewed the documentation and have familiarized yourself with the operation of the control board."
				...
				(gEgo setMotion: MoveTo 182 82 self)
			)
			(5)
			(6
