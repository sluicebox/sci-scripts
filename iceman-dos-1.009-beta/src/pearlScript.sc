...
(instance pearlScript of Script
	...
	(method (doit)
		...
		(checkHeading doit:)
		(super doit: &rest)
		(if (and (> (Submarine depth:) 25) (& (Submarine flags:) $0008))
			(proc373_7 373 3)
		)
		(switch state
			(3
...
(instance checkSpeed of Monitor
	...
	(method (warn)
		(proc396_0 3 373 6) ; "WATCH YOUR SPEED, JOHNNY!"
	)
...
(instance checkRudder of Monitor
	...
	(method (warn)
		(proc396_0 3 373 8) ; "WATCH THE HELM, JOHNNY!"
	)
...
(instance checkDive of Monitor
	...
	(method (warn)
		(proc396_0 3 373 10) ; "WATCH THAT PITCH, JOHNNY!"
	)
...
(instance checkHeading of Monitor
	...
	(method (warn)
		(proc396_0 4 373 12) ; "WATCH YOUR HEADING."
	)
		...
		(cond
			...
			((!= register 200)
				(if (> (Abs (- (Submarine depth:) register)) 10)
					(proc396_0 3 373 15) ; "WATCH YOUR DEPTH!"
					(= cycles 1)
				)
			)
			((> (Submarine depth:) 220)
			...
			((> (Submarine depth:) 190)
				(checkDive value: 0)
				(proc396_0 3 373 17) ; "REPORT WHEN DEPTH ATTAINED!"
				(= cycles 1)
			)
		)
		(super doit:)
