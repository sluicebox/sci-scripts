...
(instance flyToWashingtonScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= local0 (Display 44 1 dsALIGN alLEFT dsCOORD 20 10 dsWIDTH 300 dsCOLOR 15 dsSAVEPIXELS)) ; "As you climb to 45,000 feet above the South Pacific on your way to Washington DC, you sit back and begin to relax for the long flight."
				(= seconds 10)
			)
			(1
				(Display 44 0 dsRESTOREPIXELS local0)
...
(instance flyToHawaiiScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= local0 (Display 44 4 dsALIGN alLEFT dsCOORD 20 10 dsWIDTH 300 dsCOLOR 15 dsSAVEPIXELS)) ; "You board the plane for Pearl Harbor. After finding your seat, you settle back and begin drifting into deep thought."
				(= seconds 10)
			)
			(1
				(Display 44 0 dsRESTOREPIXELS local0)
				(= local0 (Display 44 5 dsALIGN alLEFT dsCOORD 10 10 dsWIDTH 300 dsCOLOR 15 dsSAVEPIXELS)) ; "You begin to ponder the mission ahead of you. Unbelievable! you think to yourself, The magnitude of this operation is overwhelming."
				(= seconds 10)
			)
			(2
				(Display 44 0 dsRESTOREPIXELS local0)
				(= local0 (Display 44 6 dsALIGN alLEFT dsCOORD 10 10 dsWIDTH 300 dsCOLOR 15 dsSAVEPIXELS)) ; "As the big 747 soars westward at 480 knots, you continue in thought, I'm amazed. you think, How one cowardly act of kidnapping an Ambassador has brought two super powers to each other's throats."
				(= seconds 10)
			)
			(3
				(Display 44 0 dsRESTOREPIXELS local0)
			...
			(5
				...
				(if (gEgo has: 0) ; Envelope
					...
					(= local0 (Display 44 9 dsALIGN alLEFT dsCOORD 40 10 dsWIDTH 300 dsCOLOR 15 dsSAVEPIXELS)) ; "Thinking of the enormous load you now feel resting on your shoulders tires you, and you fall off to sleep."
				)
				(= seconds 10)
			)
			(6
...
(instance ordersScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local0 (Display 44 12 dsALIGN alLEFT dsCOORD 40 10 dsWIDTH 300 dsCOLOR 15 dsSAVEPIXELS)) ; "You carefully look over the orders temporarily assigning you to the USS Blackhawk."
				(= seconds 10)
			)
			(2
