...
(instance cprScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(proc3_7 354 11) ; "You place your ear close to the victim's mouth trying to listen and feel for a breath. At the same time you look to see if the chest is moving."
				(localproc_0)
			)
			(9
				(gEgo setLoop: 0 setCel: 2 setCycle: End self)
				(proc3_7 354 12) ; "You pinch the nostrils closed, open your mouth wide and take a deep breath. You make a tight seal over the victim's mouth and breath into her mouth."
			)
			(10
				(gEgo setCycle: Beg)
