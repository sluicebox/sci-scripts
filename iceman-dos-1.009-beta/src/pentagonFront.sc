...
(instance pentagonFront of Rm
	...
	(method (handleEvent event)
		(cond
			...
			((Said 'look[<at]/building,pentagon')
				(Print 18 0) ; "The Pentagon is a very impressive edifice, with its 600,000 square feet of office space."
			)
			((Said 'look[<at]/driver,man')
				(Print 18 1) ; "The driver is a stern looking man. All business, his attention is devoted to driving. Every few seconds he glances in the rear view mirror, making sure that no one is following."
			)
			((Said 'look[<at]/car')
				(Print 18 2) ; "The inside of the car is very comfortable. There is a glass partition separating you from the driver."
			)
			((Said 'talk')
				(Print 18 3) ; "You can not be heard by the driver."
			)
		)
	)
