...
(instance stacyInScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(if register
					(Print 369 2) ; "We must work fast!" says the agent, "I just received word the Ambassador is going to be moved."
					(Print 369 3) ; "I have to leave now." she says, "I must contact my superior and arrange for the helecopter."
					(Print 369 4) ; "She advises you to take the caterers van and begin the rescue."
			...
			(3
				(if register
					...
					(EgoDead 918 0 0 369 8) ; "Faster action may have saved the Ambassador. You have caused the mission to fail."
				)
			)
		)
	)
