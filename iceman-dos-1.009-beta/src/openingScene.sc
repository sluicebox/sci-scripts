...
(instance openingScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(localproc_0 8 1 2) ; "We find our man, Lieutenant Commander John B. Westland of the United States Navy, enjoying a well deserved leave from his recent assignment."
				(= seconds 8)
			)
			(4
