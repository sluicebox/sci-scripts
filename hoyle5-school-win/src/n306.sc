...
(procedure (proc306_1 &tmp temp0 temp1)
	...
	(if
		(and
			(!= (gTheHands at: 1) global501)
			(== ((gTheHands at: 1) tempTotal:) global237)
		)
		(= temp0 (gTheHands at: 1))
	)
	(if
		(and
			(!= (gTheHands at: 2) global501)
			(== ((gTheHands at: 2) tempTotal:) global237)
		)
		(= temp0 (gTheHands at: 2))
	)
	(if
		(and
			(!= (gTheHands at: 3) global501)
			(== ((gTheHands at: 3) tempTotal:) global237)
		)
		(= temp0 (gTheHands at: 3))
	)
	(if (== ((gTheHands at: 0) tempTotal:) global237)
		(= temp0 (gTheHands at: 0))
	)
	(cond
		((< global237 13)
			(= temp1 global237)
