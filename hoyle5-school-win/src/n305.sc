...
(procedure (localproc_8 &tmp temp0 temp1 temp2 temp3 temp4 temp5)
	...
	(for
		((= temp1 (+ (= temp4 (gTheHands indexOf: (Dealer curPlayer:))) 1)))
		(<= temp1 (+ temp4 temp2))
		((++ temp1))
		...
		(if
			(and
				((= temp5 (gTheHands at: temp3)) outOf: global528)
				(temp5 outOf: 3)
...
(procedure (localproc_14 &tmp temp0 temp1 temp2 temp3)
	...
	(for
		((= temp0 (+ (= temp3 (gTheHands indexOf: (Dealer curPlayer:))) 1)))
		(<= temp0 (+ temp3 temp1))
		((++ temp0))
		...
		(if (not ((gTheHands at: temp2) outOf: global528))
			(return 0)
		)
	)
	(return 1)
...
(procedure (localproc_20 &tmp temp0 temp1)
	...
	(if (and (== temp0 1) global530)
		(cond
			((localproc_16 temp1)
				(if (== global525 (gTheHands indexOf: temp1))
					(return 1)
				)
			)
			(
