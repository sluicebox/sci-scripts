...
(instance intro of Room
	...
	(method (init &tmp temp0)
		...
		(if (not global119)
			(tradeMark view: 919 loop: 8 cel: 0 setPri: 8 posn: 162 132 init:)
		)
	...
	(method (changeState newState &tmp temp0 temp1 temp2)
		(switch (= state newState)
			...
			(5
				...
				(proc0_10 920 0 local0 temp0 temp1 1)
				(= ticks 1)
			)
			(6
				(if (== (++ local0) 8)
			...
			(7
				...
				(proc0_10 920 1 local0 temp0 temp1 1)
				(= ticks 1)
			)
			(8
				(if (== (++ local0) 6)
			...
			(9
				...
				(proc0_10 920 2 local0 temp0 temp1 1)
				(= ticks 1)
			)
			(10
				(if (== (++ local0) 9)
			...
			(11
				...
				(proc0_10 920 3 local0 temp0 temp1 1)
				(= ticks 1)
			)
			(12
				(if (== (++ local0) 4)
			...
			(13
				...
				(proc0_10 920 4 local0 temp0 temp1 1)
				(= ticks 1)
			)
			(14
				(if (== (++ local0) 6)
...
(instance panel of View
	...
	(method (init)
		(self setLoop: loop posn: 75 41 setPri: priority)
		(super init:)
	)
)
