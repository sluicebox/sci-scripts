		...
		(if (and (!= suitLead -1) (!= (param1 suit:) suitLead))
			(for ((= temp0 0)) (< temp0 (param2 size:)) ((++ temp0))
				(if (== ((param2 at: temp0) suit:) suitLead)
					(param1 stopUpd:)
					(gSound play: 905)
					(Message msgGET 702 1 43 0 1 gStr) ; "You must follow suit since you have a valid play."
					(Print addText: gStr init:)
					(param1 startUpd:)
					(return 0)
				)
			)
		...
		(switch (= state newState)
			...
			(5
				...
				(switch (gTrick highPlayer:)
					((gTrick northPlayer:)
						(if global460
							(global460 doit: (gTrick northPlayer:))
						)
						(gTheCard1
					...
					((gTrick southPlayer:)
						(if global460
							(global460 doit: (gTrick southPlayer:))
						)
						(gTheCard1
					...
					((gTrick eastPlayer:)
						(if global460
							(global460 doit: (gTrick eastPlayer:))
						)
						(gTheCard1
					...
					((gTrick westPlayer:)
						(if global460
							(global460 doit: (gTrick westPlayer:))
						)
						(gTheCard1
