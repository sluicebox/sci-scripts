...
(class Crazy8sStrategy of Code
	...
	(method (think param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8)
		(= cardList param1)
		(= skill [global195 (- (gTheHands at: cardList) 1)])
	...
	(method (doQueenCode param1 &tmp temp0)
		...
		(switch skill
			...
			(else
				(if
					(or
						(and (<= (gTheHands size:) 2) (<= (prePlayer size:) 2))
						(and
							(== temp0 1)
							(or
								(and
	...
	(method (returnHand param1 &tmp temp0 temp1)
		...
		(if
			(and
				(>
					(= temp0
						(+
							(= temp0 (gTheHands indexOf: (Dealer curPlayer:)))
							(* temp1 -2)
							1
						)
					)
		...
		(if (and (< temp0 0) (== temp1 1))
			(= temp0 (- (gTheHands size:) 1))
		)
		(gTheHands at: temp0)
	)

	(method (find2ndToNextSize &tmp temp0 temp1)
		(if (<= (= temp0 (gTheHands indexOf: (Dealer curPlayer:))) 1)
			(= temp1 ((gTheHands at: (+ temp0 2)) size:))
		else
			(= temp1 ((gTheHands at: (- temp0 2)) size:))
		)
		(return temp1)
	...
	(method (checkCardCount &tmp temp0 temp1 temp2 temp3)
		...
		(while (< temp0 (gTheHands size:))
			(if
				(and
					(!= (= temp1 (gTheHands at: temp0)) cardList)
					(<= (temp1 size:) 2)
				)
				(++ temp3)
	...
	(method (checkHighScore param1 &tmp temp0 temp1 temp2 temp3)
		...
		(for ((= temp0 0)) (< temp0 (gTheHands size:)) ((++ temp0))
			(if (== temp1 -1)
				((= temp1 (gTheHands at: 0)) tempTotal:)
			)
			(if
				(>
					((= temp3 (gTheHands at: temp0)) tempTotal:)
					(temp1 tempTotal:)
				)
				(= temp1 temp3)
			)
	...
	(method (checkSize param1 &tmp temp0 temp1)
		(= temp1 0)
		(for ((= temp0 0)) (< temp0 (gTheHands size:)) ((++ temp0))
			(if (<= ((gTheHands at: temp0) size:) param1)
				(++ temp1)
			)
		)
		(return temp1)
