				...
				(cond
									...
									(local3
										(if local5
											(if (IsFlag 70)
												...
												(Print 23 40 #at -1 135) ; "Bains jumped your little rookie while being moved. It looked like he was holding some sort of knife to the jailer's throat."
												(Print 23 41 #at -1 135) ; "It looked so easy!" Saxton says, "I mean, he just grabbed the jailer, put a knife to his throat, and sashayed right out of the jail. Unbelievable!"
												(= local4 1)
												(= local3 0)
											)
										else
					...
					(
						...
						(if (< global100 1)
							...
							(Print 23 51 #at -1 135) ; "You'll have your second chance at him in court, Sonny, but for the moment, you'll have to wait. He's not allowed to see anyone, including you."
						else
...
(instance jailerScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (== global100 1)
					(Print 23 81 #at -1 135 #draw) ; "Obviously excited, the jailer says..."Bonds! I can't believe what's happened. I can't get over it! We've never had an officer kidnapped before.""
					(Print 23 82 #at -1 135 #draw) ; "Continuing..."Bains took Pate and escaped in Pate's car. I sure hope he's OK. Poor kid...he's just a rookie, you know.""
					(Print 23 83 #at -1 135 #draw) ; "Heck, we just put together the file on Bains this morning, and he's gone already."
					(= local7 1)
					(= global138 0)
			...
			(3
				(if (gEgo has: 10) ; field_kit
					(Print 23 89 #at -1 135) ; "While I'm at it," the jailer continues, " give me your field kit to put behind the counter. You're not supposed to bring it in here, you know."
				...
				(cond
					((>= global100 2)
						(Print 23 92 #at -1 135 #draw) ; "I hate to be rude, Bonds" he says, "but I'm really busy. Unless you have important business, just show yourself out."
						(= local7 1)
					)
					((< global100 1)
