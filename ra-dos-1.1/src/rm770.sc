...
(instance sRunIt of Script
	...
	(method (doit)
		...
		(if (and (not local1) (== (murderer cel:) 4) (== (murderer loop:) 0))
			(gGameMusic2 number: 770 flags: 5 loop: 1 play: murderer) ; sBreakingRocks
			(= local1 1)
		)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gGameMusic2 number: 770 flags: 5 loop: 1 play:) ; sBreakingRocks
...
(instance sRandomScr of Script
	...
	(method (doit)
		...
		(if (and (not local2) (== (client cel:) 4) (!= (client loop:) 5))
			(gGameMusic2 number: 770 flags: 5 loop: 1 play: badguy1) ; sBreakingRocks
			(= local2 1)
		)
	)
...
(instance sRandomScr2 of Script
	...
	(method (doit)
		...
		(if (and (not local3) (== (client cel:) 4))
			(gGameMusic2 number: 770 flags: 5 loop: 1 play: badguy2) ; sBreakingRocks
			(= local3 1)
		)
	)
