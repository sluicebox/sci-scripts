...
(procedure (proc323_1 param1 &tmp temp0 temp1)
	(if
		...
		(= temp0 (temp1 at: 0))
		(temp1 giveUpCards:)
		(gTheCardToss init: temp0 param1 425)
	)
)
		...
		(cond
			((== global319 1)
				(if (not temp0)
					...
					(gTheCardToss init: (gTheTransferList at: 0) temp1 425)
				else
					(gTheTransferList empty: add: (param1 at: 0))
					(param1 delete: (param1 at: 0))
					(gTheCardToss
...
(procedure (proc323_4 &tmp temp0 temp1 temp2 temp3 temp4)
	(if (localproc_0)
		...
		(temp4 giveUpCards:)
		(gTheCardToss init: temp3 (gTheReserves at: 1) 425)
		(= temp4 ((global423 at: temp1) at: local2))
		((= temp3 (temp4 at: 0)) dim: changed: 1)
		(temp4 giveUpCards: gTheTransferList2)
		(gTheAutoCardToss init: temp3 (gTheReserves at: 1) 425)
		(= temp4 ((global423 at: temp2) at: local2))
		((= temp3 (temp4 at: 0)) dim: changed: 1)
		(temp4 giveUpCards: gTheTransferList3)
		(gTheAutoCardToss2 init: temp3 (gTheReserves at: 1) 425)
	)
)
...
(class Slider of Obj
	...
	(method (handleEvent event &tmp temp0 temp1)
		(if
			...
			(temp0 giveUpCards:)
			(gTheCardToss init: temp1 ((global423 at: row) at: (* cel 5)) 425)
		)
	)
)
