		...
		(switch (= state newState)
			(0
				...
				(if (>= gScore gPossibleScore)
					...
					(Message msgGET 52 2 0 4 1 (local66 data:)) ; "Congratulations! You have successfully completed "Quest for Glory: Shadows of Darkness" with a final score of %d out of a possible %d points."
			...
			(3
				(if (!= (glory4_sav open: 1) 0)
					(Message msgGET 52 2 0 13 1 (local66 data:)) ; "You already have a file called "%s." Do you wish to overwrite it?"
			...
			(4
				(if (glory4_sav open: 2)
					...
					(Message msgGET 52 2 0 2 1 (local66 data:)) ; "Could not create file "%s.""
					(local65 format: (local66 data:) (glory4_sav name:))
