	...
	(method (init)
		(= local2
			(cond
				...
				((and (>= gTime 6) (IsFlag 138) (not (IsFlag 163))) 15)
		...
		(gnomeDoor init: approachVerbs: 4) ; Do
...
(instance sUpStairs of Script
	...
	(method (doit)
		(super doit: &rest)
		(if (and (not (gEgo mover:)) ((gEgo cycler:) isKindOf: StopWalk))
			(= register 1)
...
(instance cabinet of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(4 ; Do
				(if (and (>= gTime 6) (IsFlag 139) (not (IsFlag 163)))
