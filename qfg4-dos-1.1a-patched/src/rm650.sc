...
(instance sComeIn of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(if (not (IsFlag 143))
					(aToby setPri: 141 setCel: 7 setCycle: CT 13 1)
					(closeDoorSound play:)
...
(instance sStayOut of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(aToby setPri: 141 setLoop: 1 1 setCel: 0 setCycle: CT 7 1 self)
			)
			(3
				(closeDoorSound play:)
				(aToby setCel: 7 setCycle: CT 13 1 self)
			...
			(6
				(if (not (IsFlag 145))
					(aToby setCel: 0 setCycle: CT 7 1 self)
				else
					(self cue:)
				)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(aToby setPri: 100 setLoop: 0 1 setCycle: CT 10 1 self)
			)
			(2
				(aToby setCycle: 0)
