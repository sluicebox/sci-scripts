...
(instance rockScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(theView view: 365 setLoop: 5 setCel: 1 posn: 150 194)
				(= ticks 55)
			)
			(10
				(= ticks 10)
...
(instance cloudScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(cloud setLoop: 1 setCel: 0 setCycle: CT 2 1 self)
				(Load rsSOUND 926)
			)
			(3
			...
			(7
				(cloud setLoop: 1 setCycle: CT 7 1 self)
				(mySound number: 926 setLoop: 1 play:)
			)
			(8
				(mySound number: 988 setLoop: 1 play:)
...
(instance aWord3 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 370 setLoop: 3 posn: 126 172 init:)
	)
)
...
(instance aWord6 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1123 setLoop: 1 play: rm3)
		(theView view: 370 setLoop: 6 posn: 245 172 init:)
	)
)
...
(instance aWord15 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1071 setLoop: 1 play: rm3)
		(theView view: 370 setLoop: 4 posn: 49 194 init:)
	)
)
...
(instance aWord18 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1069 setLoop: 1 play: rm3)
		(theView view: 370 setLoop: 1 posn: 159 194 init:)
	)
)
...
(instance aWord19 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1072 setLoop: 1 play: rm3)
		(theView view: 370 setLoop: 7 posn: 197 194 init:)
	)
)
...
(instance aWord20 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1061 setLoop: 1 play: rm3)
		(theView view: 370 setLoop: 3 posn: 228 194 init:)
	)
)
...
(instance aWord21 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1071 setLoop: 1 play: rm3)
		(theView view: 370 setLoop: 4 posn: 271 194 init:)
	)
)
