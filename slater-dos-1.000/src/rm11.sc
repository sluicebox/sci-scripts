		...
		(switch (= state newState)
			...
			(20
				...
				(suctionBushes
					...
					setCel: 0
					setCycle: Fwd
					setMotion: MoveTo 73 120 self
				)
				(suctionBushes2
					setLoop: 1
					setCel: 0
					setCycle: Fwd
					setMotion: MoveTo 50 120 self
				)
			)
			(21 0)
			(22
...
(instance sCloud of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(local2 view: 1115 loop: 0 setCel: 0 setCycle: CT 3 1 self)
			)
			(2
				(switch local2
					(cloud
			...
			(3
				...
				(local2 loop: 1 setCel: 0 setCycle: End self)
			)
			(4
				(droplet
					posn: local6 local7
					...
					moveSpeed: 0
					init:
					setMotion: MoveTo local6 local8 self
				)
			)
			(5
				(droplet hide: dispose:)
				(local2 view: 1101 loop: 0 setCel: 3 stopUpd:)
				(gGame handsOn:)
				(self dispose:)
			)
		)
...
(instance sRocketShipFlys of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(rocketShip loop: 1 setCel: 0 posn: 147 0)
				(= ticks 2)
			)
			(8
...
(instance sBaseballDino of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(baseball setLoop: 1 init: setMotion: JumpTo 150 63 self)
				(baseballDino setCel: 0 setCycle: CT 3 1)
			)
			(4
				(baseball hide: dispose:)
			...
			(7
				...
				(baseballDino loop: 0 setCel: 0 setMotion: MoveTo 177 144 self)
			)
			(8
				(baseballDino
					view: 1101
