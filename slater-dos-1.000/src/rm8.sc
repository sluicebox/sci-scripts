...
(instance aWord1 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 860 setLoop: 1 posn: 149 177 init:)
	)
)
...
(instance aWord2 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 860 setLoop: 2 posn: 183 177 init:)
	)
)
...
(instance aWord4 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 860 setLoop: 4 posn: 229 177 init:)
	)
)
...
(instance aWord7 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 860 setLoop: 7 posn: 176 189 init:)
	)
)
...
(instance aWord8 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 860 setLoop: 8 posn: 214 189 init:)
	)
)
...
(instance aWord9 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 860 setLoop: 9 posn: 244 189 init:)
	)
)
...
(instance pineappleScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(my2Sound number: 928 play: setLoop: 1)
				(register setCycle: End self)
			)
			(8
				(register
...
(instance mountainScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(mySound number: 978 play: setLoop: 1)
