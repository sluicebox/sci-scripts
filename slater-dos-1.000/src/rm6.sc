...
(instance rm6 of Rm
	...
	(method (init)
		...
		(bucket init:)
		(aCharlie init:)
		(aSky init: setOnMeCheck: 1 16384)
...
(instance aSky of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(gCurRoom setScript: tarzanScript)
	)
)
...
(instance aWord1 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 680 setLoop: 1 posn: 116 176 init:)
	)
)
...
(instance aWord8 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 680 setLoop: 7 posn: 78 188 init:)
	)
)
...
(instance aWord9 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 680 setLoop: 8 posn: 98 188 init:)
	)
)
...
(instance aWord12 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1058 loop: 1 play: rm6)
		(theView view: 680 setLoop: 10 posn: 203 188 init:)
	)
)
...
(instance rockScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(theView view: 675 setLoop: 2 setCel: 1 posn: 76 188 show:)
				(= ticks 75)
			)
			(6
				(theProp hide:)
			...
			(7
				(theProp view: 675 setLoop: 3 setCel: 1 posn: 216 188 show:)
				(= ticks 75)
			)
			(8
				(theView hide: dispose:)
...
(instance tarzanScript of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(mySound number: 1007 loop: -1 play:)
				(tarzan init: setCycle: CT 4 1 self)
			)
			(1
				(tarzan posn: 184 68 cel: 7 setCycle: CT 12 1 self)
			)
			(2
				(tarzan setLoop: 1 cel: 0 posn: 283 54)
				(= cycles 2)
			)
			(3
				(tarzan cel: 1)
			...
			(6
				(mySound number: 915 loop: 1 play:)
				(= cycles 1)
			)
			(7
				(tarzan
			...
			(8
				(mySound number: 951 loop: 1 play:)
				(tarzan moveSpeed: 2 setMotion: MoveTo 272 164 self)
			)
			(9
			...
			(10
				(tarzan setCycle: End self)
			)
			(11
				(mySound number: 941 loop: 1 play:)
				(tarzan setLoop: 0 cel: 0 posn: 7 65 setPri: 4 dispose:)
				(= cycles 2)
			)
			(12
				(gGame handsOn:)
