	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(16
				...
				(wingedDino view: 591 init: setCel: 7 posn: 230 120 stopUpd:)
...
(instance aWord8 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 585 setLoop: 8 posn: 117 188 init:)
	)
)
...
(instance aWord9 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 585 setLoop: 9 posn: 140 188 init:)
	)
)
...
(instance aWord12 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1078 setLoop: 1 play: rm5)
		(theView view: 585 setLoop: 12 posn: 222 188 init:)
	)
)
...
(instance aWord13 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 585 setLoop: 13 posn: 244 188 init:)
	)
)
