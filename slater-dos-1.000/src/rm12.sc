...
(local
	...
	[local13 6] = [90 100 101 88 66 114]
)
...
(instance rm12 of Rm
	...
	(method (dispose)
		...
		(gKeyDownHandler delete: lampScript)
		(mySound dispose:)
		(my2Sound dispose:)
		(super dispose:)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gKeyDownHandler addToFront: lampScript)
				(= ticks 75)
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(slater view: 1230 loop: 0 setCel: 1 posn: 135 125)
			)
			(2)
			(3
...
(instance sSuckThumb of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(my2Sound stop:)
				(charlie view: 1200 loop: 0 setCel: 1 posn: 198 76 stopUpd:)
				(gGame handsOn:)
				(self dispose:)
			)
		)
