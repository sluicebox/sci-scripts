...
(instance aWord1 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 970 setLoop: 1 posn: 86 172 init:)
	)
)
...
(instance aWord3 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 970 setLoop: 3 posn: 149 172 init:)
	)
)
...
(instance aWord5 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 970 setLoop: 5 posn: 220 172 init:)
	)
)
...
(instance aWord6 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 970 setLoop: 6 posn: 264 172 init:)
	)
)
...
(instance aWord11 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1061 setLoop: 1 play: rm9)
		(theView view: 970 setLoop: 11 posn: 225 183 init:)
	)
)
...
(instance aWord13 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 970 setLoop: 12 posn: 108 194 init:)
	)
)
...
(instance aWord14 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 970 setLoop: 13 posn: 132 194 init:)
	)
)
...
(instance aWord15 of InterFeature
	...
	(method (doVerb)
		(gGame handsOff:)
		(mySound number: 1109 setLoop: 1 play: rm9)
		(theView view: 970 setLoop: 13 posn: 161 194 init:)
	)
)
...
(instance aWord16 of InterFeature
	...
	(method (doVerb)
		...
		(theView view: 970 setLoop: 14 posn: 193 194 init:)
	)
)
...
(instance rockScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(theProp view: 965 setLoop: 3 setCel: 1 posn: 74 183 show:)
				(= ticks 50)
			)
			(7
				(oddView hide:)
			...
			(8
				(theView view: 965 setLoop: 4 setCel: 1 posn: 161 183 show:)
				(= ticks 59)
			)
			(9
			...
			(12
				(theView view: 965 setLoop: 7 setCel: 1 posn: 185 194 show:)
				(= ticks 25)
			)
			(13
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(footEffect dispose:)
				(mySound number: 1024 setLoop: 1 play:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(cow setPri: 1 setCycle: CT 9 1 self)
			)
			(3
				(cow setCel: 10)
