...
(instance rockScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gGame handsOff:)
				(theView view: 270 setLoop: 0 setCel: 1 posn: 77 181 init:)
...
(instance drawerScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(mySound number: 1155 setLoop: 1 play: self)
...
(instance bottleScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gLongSong stop:)
				(mySound number: 965 setLoop: 1 play: self)
			)
			(3
				(gLongSong play:)
...
(instance charlieScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(charlie view: 205 setLoop: 0 setCel: 0 setCycle: CT 2 1 self)
			)
			(1
...
(instance pop3Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(pop3 view: 255 setLoop: 1 setCel: 0 setCycle: CT 1 1 self)
			)
			(1
