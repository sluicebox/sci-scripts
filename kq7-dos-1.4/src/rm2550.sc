...
(instance sUpInBucket of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(gKqSound1 number: 837 loop: 1 play: self)
				(proc98_15)
				(proc98_14)
				(proc98_15)
			)
			(10
				(gKqSound1 number: 4364 setLoop: 1 play: self)
				(proc98_15)
			)
			(11
				(gGame handsOn:)
