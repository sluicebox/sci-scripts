	...
	(method (init)
		...
		(cond
			((and (gEgo has: 34) (not (IsFlag 363))) ; Wet_Sulfur
				...
				(Load 140 2058) ; WAVE
				(Load 140 836) ; WAVE
				(forger view: 20521 loop: 0 cel: 0 posn: 216 107 setPri: 99)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(forger view: 20513 cel: 5 setCycle: End self)
			)
			(3
				(gKqSound1 stop:)
				(self dispose:)
...
(instance jewelerLeave of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(jeweler setLoop: 4 cel: 0 setCycle: End self)
			)
			(1
				(jeweler
					setLoop: 5 1
