...
(instance rm400 of Room
	...
	(method (init)
		...
		(if (== (GK detailLevel:) 3)
			(gGkSound1 flags: 5 setLoop: -1 number: 443 play:)
		)
		(if (or (== gPrevRoomNum 200) (== gPrevRoomNum 372))
			(gGkMusic1
				number: 442
				setLoop: -1
				stop:
				play:
				setVol: 0
				fade: (gGkMusic1 musicVolume:) 50 10 0
			)
		)
	...
	(method (newRoom newRoomNumber)
		(if (or (== newRoomNumber 200) (== newRoomNumber 372))
			(gGkMusic1 fade:)
		)
