...
(procedure (localproc_0)
	(switch local11
		(0
			...
			(RedrawCast)
			(Display 3 68 dsCOORD 120 10 dsWIDTH 180 dsFONT 0) ; "CASE#: N5553232 Name: Donald J. Colby. ALIAS: none. ADDRESS: As of 4/2/86       23110 Union St.       Steelton, USA"
			(Display 3 69 dsCOORD 20 65 dsWIDTH 280) ; "SCARS/TATTOOS: none  DOB: 2/19/48. PHYS: wht/male, 5'7", green, green, 145. ASSIGNED TO: Watts, Laura A/O: Bonds & Watts ARREST RECORD: Narcotics for sale  CONVICTED: 10/5/83  INCARCERATED: none.  LOCATION: none.  SENTENCE: 1 year suspended sentence         1 year probation  PAROLE DATE: None. CASE STATUS: Closed. NOTE: Provided testimony in murder trial    against Jessie Bains."
		...
		(1
			...
			(RedrawCast)
			(Display 3 71 dsCOORD 120 10 dsWIDTH 180 dsFONT 0) ; "CASE#: N5550001 Name: Moffet Dickey ALIAS: none ADDRESS: 329 E. Peach St.       Lytton City, USA"
			(Display 3 72 dsCOORD 20 65 dsWIDTH 300) ; "SCARS/TATTOOS: none  DOB: 3/20/28. PHYS: wht/male, 6'0", bln, purple, 150. ASSIGNED TO: Pratt A/O: Pratt ARREST RECORD:  Narcotics possession  CONVICTED: 10/3/86  INCARCERATED: none.  LOCATION: none  SENTENCE: 1 year suspended sentence         with 6 mo probation  PAROLE DATE: none. CASE STATUS: Closed"
			(if (gGame subtitleLang:)
				(Print 3 73)
			)
		)
		(2
			...
			(RedrawCast)
			(Display 3 74 dsCOORD 120 10 dsWIDTH 180 dsFONT 0) ; "CASE#: N5554999 Name: Robin Jones. ALIAS: none. ADDRESS:302 Parkway Drive      Lytton City, USA."
			(Display 3 75 dsCOORD 20 65 dsWIDTH 300) ; "SCARS/TATTOOS: 3" scar left forehead. DOB: 2/26/67. PHYS: blk/male, 6'3", purple, hzl, 225. ASSIGNED TO: Jones A/O: Pratt & Jones ARREST RECORD:  Narcotics possession  CONVICTED: 6/6/87  INCARCERATED: none.  LOCATION: none.  SENTENCE: 1 year suspended sentence.         3 years probation. PAROLE DATE: None. CASE STATUS: Closed."
			(if (gGame subtitleLang:)
				(Print 3 76)
			)
		)
		(3
			...
			(RedrawCast)
			(Display 3 77 dsCOORD 120 10 dsWIDTH 180 dsFONT 0) ; "CASE#: N555J212. NAME: Victor Simms. ALIAS: none. ADDRESS: 304 Second St.        Lytton City, USA."
			(Display 3 78 dsCOORD 20 65 dsWIDTH 300) ; "SCARS/TATTOOS: none DOB: 4/14/66. PHYS: wht/male, 5'7", blk, brn, 145. ASSIGNED TO: Watts, Laura A/O: Bonds & Watts ARREST RECORD:  Narcotics for sale   CONVICTED: 10/5/83 Juvenile Court   INCARCERATED: none. LOCATION: none.   SENTENCE: 1 year suspended sentence.   PAROLE DATE: None.   PROBATION: 1 yr. CASE STATUS: Closed"
			(if (gGame subtitleLang:)
				(Print 3 79)
			)
		)
		(4
			...
			(RedrawCast)
			(Display 3 80 dsCOORD 120 10 dsWIDTH 200) ; "CASE#: N5553339 Name: Wilma Snider. ALIAS: Big Snort Snider. ADDRESS: 203 Oak St.       Lytton City, USA."
			(Display 3 81 dsCOORD 20 65 dsWIDTH 300) ; "SCARS/TATTOOS: none DOB: 7/19/60. PHYS: blk/fem, 5'7", blk, brn, 145. ASSIGNED TO: Pratt A/O: Pratt ARREST RECORD:  Narcotics for sale  CONVICTED: 8/5/85  INCARCERATED: local  LOCATION: Lytton Jail  SENTENCE: 1 year suspended sent.         3 year probation.  PAROLE DATE: None. CASE STATUS: Closed"
			(if (gGame subtitleLang:)
				(Print 3 82)
			)
		)
		(5
			...
			(RedrawCast)
			(Display 3 83 dsCOORD 120 10 dsWIDTH 200) ; "CASE#: N5555678 Name: George Snow. ALIAS: Ice Man ADDRESS: transient"
			(Display 3 84 dsCOORD 20 65 dsWIDTH 300) ; "SCARS/TATTOOS: tattoo of panther on back DOB: 3/15/56. PHYS: wht/male, 6'0", blk, grn, 206. ASSIGNED TO: Jones A/O: Pratt ARREST RECORD:  Narcotics for sale  CONVICTED: 6/6/86  INCARCERATED: State Pen.  LOCATION: Foolsum  SENTENCE: 1 year with 3 years probation.  PAROLE DATE: 12/6/86. CASE STATUS: Closed"
			(if (gGame subtitleLang:)
				(Print 3 85)
			)
		)
		(6
			...
			(RedrawCast)
			(Display 3 86 dsCOORD 120 10 dsWIDTH 180 dsFONT 0) ; "CASE#: N5554657 NAME: Jose Valencia ALIAS: none ADDRESS: 25112 Staton Court      Century, USA"
			(Display 3 87 dsCOORD 20 65 dsWIDTH 300) ; "SCARS/TATTOOS: none  DOB: 3/15/63. PHYS: mex/male, 6'0", blk, brn, 190. ASSIGNED TO: Pratt A/O: Pratt, Jones ARREST RECORD: Narcotics for sale           Poss of paraphernalia           Assault on police officer  CONVICTED: 5/5/82  INCARCERATED: State Pen.  LOCATION: Foolsum  SENTENCE: 2 year with 5 year probation  PAROLE DATE: none. CASE STATUS: Closed Update: 3/2/87 probation. violation pending."
			(if (gGame subtitleLang:)
				(Print 3 88)
			)
		)
...
(instance Poet of Feature
	...
	(method (handleEvent event)
		(cond
			...
			(
				(or
					(and (== local0 1) (Said 'yes,ash'))
					(Said 'ask,talk,listen,ask/poem,4,steve')
				)
				(switch (Random 0 3)
					(0
			...
			((Said 'ask')
				(Print 3 38) ; "I'm sorry, but I can't help you with that."
			)
			((Said 'yes,ash')
				(Print 3 39) ; "What are you talking about, Sonny?"
			)
			((Said 'no')
				(if (== local0 1)
					(Print 3 40) ; "OK. Fine, Sonny. I won't. Leave me alone."
					(= local0 0)
				else
					(Print 3 39) ; "What are you talking about, Sonny?"
				)
...
(instance Dooley of Feature
	...
	(method (handleEvent event)
		(cond
			...
			((Said 'look/desk')
				(Print 3 41) ; "This is Lieutenant Dooley's desk."
			)
			((Said 'look/dooley,man,cop')
				(Print 3 42) ; "Lieutenant Dooley looks like he is in deep thought."
			)
			((or (Said 'talk/dooley,man,cop') (Said '/hello'))
				(switch (Random 0 2)
					(0
						(Print 3 43) ; "I'm busy, Bonds."
					)
					(1
						(Print 3 44) ; "It sure is nice weather we're having."
					)
					(else
						(Print 3 45) ; "You should join the narcotics division. It sure beats dead bodies."
					)
				)
			)
			((Said 'ask')
				(Print 3 46) ; "I'm sorry, but I'm too busy for your questions."
			)
			((Said 'aid')
				(if (Said '/cabinet,file')
					(Print 3 47) ; "Be my guest."
				else
					(Print 3 48) ; "Shaking his head, Dooley says..."I'm sorry, but I can't help you with that.""
				)
			)
		)
	)
...
(instance Computer of Feature
	...
	(method (handleEvent event)
		(cond
			...
			((Said 'look/desk')
				(Print 3 49) ; "A computer sits on the desk."
			)
			((Said '(turn<on),japaneseturnon/computer')
				(Print 3 50) ; "Look at it first."
			)
		...
		(switch (= state newState)
			(0
				...
				(if (and (>= global100 8) (not (IsFlag 57)))
					(SetFlag 57)
					(if (IsFlag 85)
						(Print 3 51) ; "Steve tells you..."
						(Print 3 52) ; "Lloyd has taken some time off...I guess he has problems at home or something."
					else
						(Print 3 53) ; "You're saddened as Steve tells you..."
						(Print 3 54) ; "Well they fired poor old Pratt!"
						(Print 3 55) ; "Continuing he says..."I guess Internal Affairs had a file open on him for illegal use of drugs. They just gave him his walking papers today.""
					)
				)
			)
		)
				...
				(cond
					((Said '(look,frisk)/(coat,pocket)')
						(if (gEgo inRect: 200 150 270 170)
							(Print 3 56) ; "You do not find anything of interest in the coat on the coatrack."
						else
							(event claimed: 0)
						)
					)
					((Said 'look>')
						(cond
							((Said '[<at,around][/(!*,chamber,office)]')
								(Print 3 57) ; "The Narcotics office is equipped with five desks, a file cabinet, and various items hanging on the wall. On one of the desks is a computer."
							)
							((Said '/coatrack,coatrack<coat')
								(Print 3 58) ; "The coatrack has a coat and hat on it."
							)
							((Said '/hat')
								(Print 3 59) ; "You see nothing special."
							)
						)
					)
					((Said 'get/coat,hat')
						(Print 3 60) ; "It's not yours."
					)
				...
				(cond
					(
						(or
							...
							(Said '[turn,go,look]/page<next,2')
							(Said 'read,look,see,turn/page[<next,2]')
						)
						(Print 3 61 #at -1 150) ; "There is no second page in this file."
					)
					((Said 'look[<in,around][/(drawer,cabinet)]')
						(if local12
							(Print 3 62) ; "Right now, you need to concentrate on this file."
						else
							(Print 3 63) ; "You are looking into the file drawer which you just opened. It is an ordinary file drawer, with folders organized in alphabetical order."
						)
					)
					(
						(or
						...
						(cond
							(local12
								(event claimed: 1)
								(Print 3 64 #at -1 150 #time 7) ; "You'd better put this file away first. You know how picky they are here in Narcotics."
							)
							...
							(else
								(event claimed: 1)
								(Print 3 65 #at -1 150) ; "Which file do you want to see?"
							)
						)
					)
					(
						(Said
							'exit,close,exit,japaneseclimbdown,close[/drawer,cabinet]'
						)
						(if local12
							(Print 3 64 #at -1 150 #time 7) ; "You'd better put this file away first. You know how picky they are here in Narcotics."
						else
					...
					(
						(or
							...
							(Said 'drop,japaneseput[<back,away]/file')
						)
						(if local12
							(Print 3 66) ; "You replace the file."
							(= local12 0)
							(self changeState: 3)
						else
							(Print 3 67 #at -1 150) ; "You don't have a file open now."
						)
					)
				)
			)
