...
(instance IntroScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gContinuousMusic number: 1 loop: 1 play:)
				(if (< global110 30)
					((= [local10 9] (View new:))
						view: 901
						loop: 0
...
(instance everyoneElseScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(10
				(localproc_0 200 11) ; "One Year has passed since Detective Sonny Bonds successfully brought Jessie Bains (The Death Angel) to justice. Bains' world of rampant drugs and open violence, the world he controlled so well, has been silenced."
				(localproc_0 200 12) ; "As the memory of this animal slowly fades, the city of Lytton once again lives in the peace and serenity of its past."
				(localproc_0 200 13) ; "Officer Sonny Bonds has been promoted to the position of Homicide Detective. The day begins with Detective Bonds arriving for another routine work day, or so it seems..."
				(gCurRoom newRoom: 701)
			)
		)
	)
