...
(synonyms
	(talk talk interrogate ask talk)
)
...
(procedure (localproc_2 param1 &tmp temp0)
	...
	(cond
		((<= temp0 40)
			(localproc_1)
			(Print 12 105) ; "The phone is busy."
			(Busy stop:)
		)
		((<= temp0 95)
			(localproc_0 5)
			(Print 12 106) ; "You suspect no one is there and hang up."
			(Ring stop:)
		)
		(else
			(Print 12 107) ; "....We're sorry. That number cannot be completed as dialed. Please try again."
		)
	)
...
(procedure (localproc_6 param1)
	...
	(if (> (param1 message:) 32)
		(Format @local11 12 109 (param1 message:)) ; "%c"
	)
	(repeat
		(if (Print 12 110 #at 20 120 #edit @local11 35) ; "Enter input: (ESC to disconnect)"
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(= local11 0)
				(repeat
					(if (not (Print 12 3 #at 20 120 #edit @local11 18)) ; "Number to dial: (ESC to hang up) (xxx-xxxx) or (xxx-xxx-xxxx) Information is 411."
...
(instance Information of Script
	...
	(method (init param1)
		...
		(local3 loop: 6 cel: 0 posn: 75 65 setCycle: End)
		(RedrawCast)
		(self changeState: 1)
	)
				...
				(switch local351
					...
					(1
						(cond
							(
								(Said
									'/police,lpd,(department,japanesedep<police)'
								)
								(localproc_5 12 28)
							)
							((Said '/park<burt')
					...
					(3
						(if
							(Said
								'/sierra,(online<sierra),(line,1000<on<sierra)'
							)
							(localproc_5 12 30)
							(localproc_5 12 31)
							(self changeState: 999)
...
(instance talkingToColby of Script
	...
	(method (init param1)
		...
		(local3 setLoop: 2 cel: 0 posn: 66 66 setCycle: End)
		(RedrawCast)
		(= local6 0)
		(self changeState: 1)
	)
	...
	(method (handleEvent event)
		...
		(cond
			...
			(
				(or
					(Said 'talk/bains,escape,187,(list<hit)')
					(Said 'talk//bains,escape,187,(list<hit)')
					(Said 'warn/man,colby/bains')
...
(instance talkingToMarie of Script
	...
	(method (init param1)
		...
		(local3 loop: 1 cel: 0 posn: 71 65 setCycle: End)
		(RedrawCast)
		(self changeState: 1)
	)
	...
	(method (handleEvent event)
		...
		(cond
			((Said '/hello,bonds,cheeks')
				(localproc_4 12 50)
				(self changeState: 2)
			)
			((or (Said 'talk') (Said 'yes,yes,ash'))
				(if (== state 2)
					(self changeState: 999)
				else
					(localproc_4 12 50)
...
(instance steeltonPD of Script
	...
	(method (init param1)
		...
		(local3 loop: 4 cel: 0 posn: 63 67 setCycle: End)
		(= local7 0)
		(= local5 0)
		(RedrawCast)
		(self changeState: 1)
	...
	(method (handleEvent event)
		...
		(cond
			...
			(
				(or
					(Said '(talk,warn)[/bains,colby,187]')
					(Said '(talk,warn)/*[/bains,colby,187]')
				)
				(= local5 0)
				(switch state
...
(instance lyttonPD of Script
	...
	(method (init param1)
		...
		(local3 loop: 5 cel: 0 posn: 73 68 setCycle: End)
		(RedrawCast)
		(self changeState: 1)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(Print 12 73) ; "You have a feeling that somehow you were forgotten."
				(-- state)
				(= seconds 15)
			)
			(999
	...
	(method (handleEvent event)
		...
		(cond
			((or (== state 3) (== state 4))
				(event claimed: 1)
				(Print 12 74) ; "No one is listening to you."
			)
...
(instance sierra of Script
	...
	(method (init param1)
		...
		(local3 loop: 8 cel: 0 posn: 74 60 setCycle: End)
		(RedrawCast)
		(self changeState: 1)
	)
...
(instance alLowe of Script
	...
	(method (init param1)
		...
		(local3 loop: 7 cel: 0 posn: 64 65 setCycle: End)
		(RedrawCast)
		(self changeState: 1)
	)
...
(instance sicko of Script
	...
	(method (init param1)
		...
		(local3 loop: 9 cel: 0 posn: 67 65 setCycle: End)
		(= local8 (Random 0 2))
		(RedrawCast)
		(self changeState: 1)
	)
	...
	(method (changeState newState &tmp [temp0 4] temp4 temp5 temp6)
		(switch (= state newState)
			...
			(2
				...
				(switch local9
					(0
						(Print @local11 #width temp6 #font 1)
					)
					(else
						(Print @local11 #width temp6 #font 1)
					)
