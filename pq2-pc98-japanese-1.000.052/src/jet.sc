...
(procedure (proc154_1)
	(Print &rest #at 10 15 #font gSmallFont)
)
		...
		(switch (event type:)
			...
			(evSAID
				(cond
					...
					(
						(Said
							'use,go/crapper,bathroom,bathroom,(chamber<(bath,pause))'
						)
