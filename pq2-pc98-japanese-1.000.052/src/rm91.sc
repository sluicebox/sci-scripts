...
(instance airportScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= local5 (Print 91 16 #at 25 20 #time 8)) ; "The three piece band strikes it up, as Captain Fletcher Hall presents you with the "Silver Commendation Award"."
				(= seconds 1)
			)
			(1
				(clr)
				(= local5 (Print 91 17 #at 25 20 #time 8)) ; "Marie stands proudly by your side as the band plays on."
				(= seconds 1)
			)
			(2
				(clr)
				(= local5 (Print 91 18 #at 25 20 #time 8)) ; "Although you know it's a lie, Keith vows to quit smoking by the time you return from the Island paradise."
				(= seconds 1)
			)
			(3
				(clr)
				(= local5 (Print 91 19 #at 25 20 #time 8)) ; "Since this is a special occasion, you wonder why the Captain can't quit slurping, licking and smacking ice cream long enough to get you out of here."
				(= seconds 1)
			)
			(4
				(clr)
				(= local5 (Print 91 20 #at 25 20 #time 8)) ; "Oh well" you think..."I guess it's better than the old habit he used to have...dipping and spitting snuff."
				(= seconds 1)
			)
			(5
				(eatIceCream dispose:)
				(clr)
				(= local5 (Print 91 21 #at 25 20 #time 8)) ; "With congratulations over, and the awards ceremony out of the way, you board the plane. Then..."
				(= seconds 1)
			)
			(6
...
(instance flyingIntoSunsetScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(clr)
				(Print 91 22) ; "You and your high school sweetheart, Marie Wilkans, fly away into the sunset..."
...
(instance finaleScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local5 (Print 91 23)) ; "While high in the sky, bound for the warm, emerald clear waters of the Bahamas..."
				(= seconds 1)
			)
			(2
				((View new:)
			...
			(3
				(clr)
				(= local5 (Print 91 24)) ; "You ask Marie..."
				(= seconds 1)
			)
			(4
				(clr)
				(= local5 (Print 91 25)) ; "Marie," you say... "Will you marry me?"
				(= seconds 1)
			)
			(5
				(local8 setCel: 2)
				...
				(Extro stop:)
				(WedBells play:)
				(= local5 (Print 91 26)) ; "With tears of joy flowing, Marie answers..."
				(= seconds 1)
			)
			(6
				(clr)
				(= local5 (Print 91 27)) ; "YES"
				(local8 setCycle: End)
				(= seconds 1)
			)
			(7
			...
			(10
				(= local5 (Print 91 28)) ; "Thank you for playing "Police Quest 2.""
				(= seconds 1)
			)
			(11
				(clr)
				(= local5 (Print 91 29)) ; "THE END"
			)
		)
	)
)
