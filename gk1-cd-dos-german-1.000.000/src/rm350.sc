	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				2
				(if local9
					(gMessager say: 4 8 9 1 self) ; "(RRCC. STUCK-UP ACCENT)Ah, Officer Mosely. I'll see if Ms. Gedde wishes to speak with you again."
				else
					(= cycles 1)
				)
			)
			...
			(9
				9
				(butler setCel: 0 setLoop: 3 setCycle: End self)
				(gEgo cycleSpeed: local15 getPoints: 161 3)
			)
			(10
				10
				(SetFlag 243)
