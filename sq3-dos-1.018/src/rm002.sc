		...
		(switch (event type:)
			(evSAID
				(cond
					...
					((Said 'look>')
						(cond
							((Said '<in,through/craft,chute,pane[<escape]')
					...
					((Said 'fix,open,pry/craft,chute,door[<escape]')
