				...
				(cond
					((Said 'look>')
						(cond
							...
							(
								(Said
									'[<in,in,through,at]/craft,pane,port,jup,2,chute'
								)
					...
					((Said 'climb[<on,up]/craft,chute,jup,2')
						(Print 4 12) ; "You are not skilled in ship climbing."
					)
					((Said 'hoist,manipulate,press,pull/craft,chute,jup,2')
					...
					(
						(Said
							'get,manipulate,pull,press,hoist[<up]/box,pulley,dome,pole'
						)
...
(instance motivator of Act
	...
	(method (handleEvent event)
		...
		(cond
			...
			((Said 'pull,press,remove,get/plug[<modular,8,spaceware]')
