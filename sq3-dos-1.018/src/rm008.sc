...
(instance rm008 of Rm
	...
	(method (handleEvent event param2 &tmp [temp0 50])
		...
		(cond
			...
			(
				(Said
					'hoist,manipulate,press,pull/craft,chute,aluminum[<escape,big,little]'
				)
			...
			((Said 'use,get,climb/debris,scrap,iron,artifact,domino,pole,blade')
...
(instance motivator of Act
	...
	(method (handleEvent event)
		...
		(cond
			...
			((Said 'remove,pull,press,get/plug[<modular,8,spaceware]')
