	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3 temp4)
		...
		(switch (= temp0 (super handleEvent: event))
			(257
				...
				(Print
					(Format @global100 997 1) ; "DEVELOPMENT SYSTEM BY:   Jeff Stephenson  Robert E. Heitman  Pablo Ghenis  John Hartin  Dan Foy  John Rettig  Corinna Abdul  Corey Cole Version 1.000.014"
					81
					{ OK }
					70
					180
			...
			(1026
				(= temp3
					((Gauge new:)
						...
						higher: {Slower}
						lower: {Faster}
						doit: (- 7 (KeyMouse cursorSpeed:))
					)
				)
				(KeyMouse cursorSpeed: (- 7 temp3))
				(DisposeScript 987)
				(event claimed: 1)
			)
			(1027
