	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(PrintDC 108 0 #at 10 10 #dispose) ; "Sieht so aus, als ob der Feenstaub nicht mehr wirke."
				(= seconds 3)
			)
			(6
			...
			(8
				...
				(PrintDC 108 1 #at 100 10 #dispose) ; "Cedric! Wo warst Du? Ich habe Dich gesucht!"
			)
			(9
			...
			(14
				(wizHead setCycle: Fwd)
				(PrintDC 108 2 #at 100 10 #dispose) ; "Nun, nun, was haben wir denn hier?"
				(= seconds 5)
			)
			(15
				(cls)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 108 3 #at 10 110 #dispose) ; "Ein Bi\e1chen plump, nicht? Nun, komm ins Haus und trockne Dich ab. Es gibt keinen Grund wie ein nasser Hund dazusitzen."
				(= seconds 10)
			)
			(2
				(cls)
	...
	(method (changeState newState &tmp [temp0 100])
		(switch (= state newState)
			...
			(2
				...
				(wizHead setCycle: Fwd)
				(PrintDC 108 4 #at 100 10 #dispose) ; "Cedric, geh ins Haus und mache uns allen eine hei\e1e Tasse Tee."
				(= seconds 5)
			)
			(3
				(cls)
				...
				(crispin setCycle: 0)
				(owlMouth setCycle: Fwd)
				(PrintDC 108 5 #at 10 120 #dispose) ; "O.K., Crispin."
				(= seconds 4)
			)
			(4
				(cls)
