	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 109 0 #at 10 10 #dispose #width 270) ; "...die Gesellschaft der Zauberer hat immer mit Mi\e1fallen zugesehen wie Mordack seine Kr\84fte eingesetzt hat. Ja, er wurde sogar zeitweise ausgeschlossen. Es hat allerdings nichts gen\81tzt."
				(= cycles 1)
			)
			(2
			...
			(5
				...
				(owl setScript: owlDrinkingTea)
				(gEgo setCycle: Fwd)
				(PrintDC 109 1 #at 100 120 #dispose) ; "Crispin, wieso sollte Mordack meine Familie oder mein Schlo\e1 nehmen? Was haben WIR Ihm denn getan?"
				(= cycles 1)
			)
			(6
			...
			(9
				...
				(PrintDC 109 2 #at 10 10 #dispose) ; "Es tut mir leid, aber ich kenne die Antwort nicht. Mordack ist ein sehr unberechenbarer Zauberer. Ich habe seine teuflische Seele NIE verstanden."
				(= cycles 1)
			)
			(10
			...
			(12
				...
				(PrintDC 109 3 #at 10 120 #dispose) ; "Ich habe mir gedacht, da\e1 Du vielleicht Seiner Majest\84t helfen k\94nntest, Crispin. Deshalb habe ich Ihn hier hergebracht."
				(= cycles 1)
			)
			(13
				(if
			...
			(15
				...
				(PrintDC 109 4 #at 10 10 #dispose) ; "Nun, la\e1 mich mal nachdenken..."
				(= cycles 1)
			)
			(16
				(if
			...
			(17
				(cls)
				(PrintDC 109 5 #at 10 10 #dispose) ; "Ich war einmal ein sehr machtvoller Zauberer, wei\e1t Du...aber ich bin in letzter Zeit etwas eingerostet."
				(= cycles 1)
			)
			(18
				(if
			...
			(21
				(gEgo setScript: egoDrinkTea)
				(owlMouth show: setCycle: Fwd)
				(PrintDC 109 6 #at 10 120 #dispose) ; "ETWAS eingerostet!"
				(= seconds 3)
			)
			(22
			...
			(25
				...
				(crispinMouth setCycle: Fwd)
				(PrintDC 109 7 #at 10 10 #dispose) ; "Ich glaube, das reicht, Cedric!"
				(= cycles 1)
			)
			(26
				(if
			...
			(27
				...
				(PrintDC 109 8 #at 10 120 #dispose) ; "Ja, Chef, Crispin...Chef."
				(= seconds 3)
			)
			(28
				(cls)
			...
			(30
				...
				(PrintDC 109 9 #at 10 10 #dispose #width 270) ; "Ich wei\e1 nicht, was ich habe, da\e1 Dir helfen k\94nnte. Die meisten meiner Zaubersachen sind ziemlich alt und ausgeleiert. Aber lasse mich nachsehen, was ich finden kann."
				(= seconds 12)
			)
			(31
				(cls)
			...
			(39
				(PrintDC 109 10 #at 100 10 #dispose) ; "Hmmmm. Das k\94nnte gehen."
				(= seconds 4)
			)
			(40
				(cls)
			...
			(43
				...
				(PrintDC 109 11 #at 100 10 #dispose) ; "Hier, i\e1 das."
				(= seconds 3)
			)
			(44
				(crispin
			...
			(48
				...
				(PrintDC 109 12 #at 10 10 #dispose) ; "Was IST das?"
				(= seconds 4)
			...
			(49
				...
				(crispinMouth setCycle: Fwd)
				(PrintDC 109 13 #at 10 10 #dispose #width 270) ; "Das ist ein altes St\81ck einer verzauberten wei\e1en Schlange, das noch vom letztem Jahr \81briggeblieben ist."
				(= seconds 7)
			)
			(50
				(cls)
				(PrintDC 109 14 #at 10 10 #dispose #width 270) ; "Mit ihm wird es Dir m\94glich sein mit Pflanzen und Tieren zu sprechen. Ich glaube, da\e1 das ziemlich n\81tzlich sein k\94nnte."
				(= seconds 9)
			)
			(51
				(cls)
			...
			(53
				...
				(crispinMouth setCycle: Fwd)
				(PrintDC 109 15 #at 10 10 #dispose #width 270) ; "Hier ist mein alter Zauberstab. Ich bin nicht sicher, ob er noch funktioniert. Das meiste seiner Kraft ist wahrscheinlich verbraucht. Du solltest wissen, da\e1 Zauberst\84be wie Tiere sind."
				(= seconds 10)
			)
			(54
				(cls)
				(PrintDC 109 16 #at 10 10 #dispose #width 270) ; "Sie m\81ssen Dich zuerst kennenlernen, bevor sie etwas f\81r Dich tun. Behandle ihn mit Respekt, und er wird Dir hoffentlich helfen."
				(= seconds 10)
			)
			(55
				(crispinMouth hide:)
			...
			(62
				...
				(PrintDC 109 17 #at 10 10 #dispose) ; "Du gehst jetzt besser, mein Junge. Ich m\94chte mir lieber nicht verstellen WAS Mordack vorhat."
				(= seconds 7)
			)
			(63
				(cls)
				(PrintDC 109 18 #at 10 10 #dispose) ; "Du gehst mit Ihm, Cedric. Zeige Ihm den Weg."
				(= seconds 5)
			)
			(64
				(cls)
				...
				((gEgo head:) hide:)
				(owlMouth setCycle: Fwd)
				(PrintDC 109 19 #at 10 120 #dispose) ; "I-i-ich?"
				(= seconds 3)
			)
			(65
				(cls)
				...
				(owlMouth setCycle: 0 setCel: 0)
				(crispinMouth show:)
				(PrintDC 109 20 #at 10 10 #dispose) ; "Ja, Du! Sei kein Feigling!"
				(= seconds 4)
			)
			(66
				(cls)
			...
			(67
				...
				(PrintDC 109 21 #at 10 10 #dispose) ; "Jetzt, geht! Ihr fangt gescheiter sofort an!"
				(= seconds 4)
			)
			(68
				(cls)
				(egoHead show:)
				(crispinMouth hide:)
				(PrintDC 109 22 #at 100 120 #dispose) ; "Danke, Crispin. Ich wei\e1 es zu sch\84tzen, da\e1 Sie mir geholfen haben."
				(= seconds 6)
			)
			(69
				(cls)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(crispin setCycle: 0)
				(PrintDC 109 23 #at 100 10 #dispose) ; "Nein, das geht nicht."
				(= cycles 10)
			)
			(1
			...
			(2
				(cls)
				(crispin setCycle: 0)
				(PrintDC 109 24 #at 100 10 #dispose) ; "Er ist aufgebraucht."
				(= cycles 10)
			)
			(3
				(crispin setCycle: Fwd)
