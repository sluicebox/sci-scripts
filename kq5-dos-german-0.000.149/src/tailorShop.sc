				...
				(4 ; Inventory
					(switch (gInventory indexOf: (gTheIconBar curInvIcon:))
						...
						(4
							...
							(RedrawCast)
							(proc0_28 160 203 47 67 20 20 25 8) ; "I would like to buy that fine cloak hanging in the corner. Will you take a silver coin for it?"
							(proc0_28 105 203 40 67 20 20 25 8) ; "A silver coin! You MUST be joking! That beautiful cloak is worth MUCH more than that!"
							(event claimed: 1)
						)
						(11
							(= local6 1)
