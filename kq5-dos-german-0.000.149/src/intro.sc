...
(instance sceneOneScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local1 (Display 100 0 dsCOORD 10 100 dsWIDTH 300 dsALIGN alCENTER dsFONT 8 dsCOLOR 0)) ; "SCHLOSS DAVENTRY"
				(= local0
					(Display ; "SCHLOSS DAVENTRY"
						100
						0
						dsCOORD
						9
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 100 1 #at 10 10 #dispose) ; "Komm! Hier oben bin ich!"
			...
			(6
				(PrintDC 100 2 #at 10 10 #dispose) ; "Folge miiiii...!"
