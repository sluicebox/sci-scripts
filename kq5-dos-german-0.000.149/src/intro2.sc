	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(= local5 1)
				(= local3
					(Display 101 0 dsCOORD 70 10 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Gesamtleitung"
				)
				(= local2
					(Display 101 1 dsCOORD 70 26 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Ken Williams"
				)
				(= local1
					(Display ; "Gesamtleitung"
						101
						0
						dsCOORD
						69
			...
			(2
				(= local3
					(Display 101 3 dsCOORD 11 75 dsWIDTH 120 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Regie"
				)
				(= local2
			...
			(4
				(= local3
					(Display 101 5 dsCOORD 70 10 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Idee und Produktion"
				)
				(= local2
					(Display 101 6 dsCOORD 70 26 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Roberta Williams"
				)
				(= local1
					(Display ; "Idee und Produktion"
						101
						5
						dsCOORD
						69
			...
			(6
				(= local3
					(Display 101 7 dsCOORD 121 24 dsWIDTH 195 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "K\81nstlerische Leitung"
				)
				(= local2
					(Display 101 8 dsCOORD 121 40 dsWIDTH 195 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Andy Hoyos"
				)
				(= local1
					(Display ; "K\81nstlerische Leitung"
						101
						7
						dsCOORD
						120
			...
			(8
				(= local3
					(Display 101 9 dsCOORD 21 11 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Leitender Programmierer"
				)
				(= local2
					(Display 101 10 dsCOORD 21 27 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Chris Iden"
				)
				(= local1
					(Display ; "Leitender Programmierer"
						101
						9
						dsCOORD
						20
			...
			(10
				(= local3
					(Display 101 11 dsCOORD 11 75 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Musik Direktor"
				)
				(= local2
					(Display 101 12 dsCOORD 11 91 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Mark Seibert"
				)
				(= local1
					(Display ; "Musik Direktor"
						101
						11
						dsCOORD
						10
