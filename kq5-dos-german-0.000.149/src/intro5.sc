	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 104 0 #at 140 100 #width 150 #dispose) ; "Es war der m\84chtige und b\94se Zauberer Mordack, der das getan hat. Ich habe gerade eine alten Freund besucht als er pl\94tzlich erschienen ist. Gottlob, er hat MICH noch nicht gesehen!"
			...
			(3
				...
				(= global380 1)
				(gEgo setCycle: Fwd)
				(PrintDC 104 1 #at 10 30 #dispose) ; "H\94re nicht auf! Erz\84hle weiter!"
				(= seconds 11)
			)
			(4
