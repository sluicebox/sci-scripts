	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(PrintDC 114 0 #at 140 100 #dispose #width 150) ; "Vielleicht kann ich Dir helfen. Mein Chef ist ebenfalls Zauberer, deshalb habe ich Mordack erkannt. Aber im Gegensatz zu Mordack, ist mein Chef ein guter Zauberer."
				(= seconds (LangSwitch 10 15))
			)
			(3
				(cls)
				(PrintDC 114 1 #at 140 100 #dispose #width 150) ; "Sein Name ist Crispinophur...aber wir nennen Ihn alle Crispin. Das einzige Problem ist, nur....,"
			...
			(5
				...
				(rWing hide:)
				(lWing hide:)
				(PrintDC 114 2 #at 140 10 #dispose) ; "Hi-Hiiilfeee...!"
			...
			(18
				...
				(PrintDC 114 3 #at 140 100 #dispose #width 150) ; "\8e\84\84hhem! Jedenfalls...wo war ich? Ah, ja."
				(= seconds (LangSwitch 4 6))
			)
			(19
				(cls)
				(PrintDC 114 4 #at 140 100 #dispose #width 150) ; "Das einzige Problem ist, da\e1 Crispin relativ alt und vergesslich ist."
			...
			(21
				(cls)
				(gEgo setCycle: Fwd)
				(PrintDC 114 5 #at 10 10 #dispose) ; "Ich wei\e1 nicht. Das t\94nt nicht gerade verhei\e1ungsvoll."
				(= seconds (LangSwitch 6 9))
			)
			(22
			...
			(23
				...
				(PrintDC 114 6 #at 140 100 #dispose #width 150) ; "Oh, sicher tut es das! Crispin ist ein ausgezeichneter Zauberer...einer der Besten. Er ist ab und zu nur etwas vergesslich, das ist alles."
				(= seconds (LangSwitch 10 15))
			)
			(24
				(intro_mouth setCycle: End self)
			...
			(26
				(PrintDC 114 7 #at 140 100 #dispose #width 150) ; "Wo ist er jetzt wieder? Ich wei\e1, da\e1 ich ihn mitgenommen habe. Aha! Hier ist er!"
				(intro_eyes hide:)
				(= local0 0)
				(intro_mouth hide:)
				(rWing hide:)
			...
			(30
				(cls)
				(gEgo setCycle: Fwd)
				(PrintDC 114 8 #at 10 10 #dispose) ; "Was ist das?"
			...
			(32
				...
				(cls)
				(intro_mouth show: setCycle: Fwd cycleSpeed: 2)
				(PrintDC 114 9 #at 140 100 #dispose #width 150) ; "Nun! Aus meiner Sicht hast Du keine Chance gegen einen Kerl wie Mordack."
				(= seconds (LangSwitch 6 9))
			)
			(33
				(cls)
				(PrintDC 114 10 #at 140 100 #dispose #width 150) ; "Entschuldigen Sie mich, wenn ich Ihnen sage, Majest\84t...aber Du hast keine Wahl. Du MUSST mitkommen. Ich bin sicher, da\e1 Dir Crispin helfen kann!"
			...
			(42
				(gEgo setCycle: Fwd)
				(PrintDC 114 11 #at 129 51 #dispose) ; "Was ist denn das?"
			...
			(45
				(PrintDC 114 12 #at 140 10 #width 150 #dispose) ; "Oh, nur etwas alter, \81briggebliebener Feenstaub den ich herumgetragen habe. Er wird Dir helfen zu fliegen."
				(= seconds (LangSwitch 6 9))
			)
			(46
				(cls)
				(= global380 1)
				(PrintDC 114 13 #at 170 10 #dispose #width 100) ; "Du kannst mir nach Serenia folgen, wo Crispin und ich leben. Zum Gehen ist es VIEL zu weit, wei\e1t Du. Ich glaube, da\e1 der Feenstaub immer noch wirksam ist."
