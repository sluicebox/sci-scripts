...
(class KQ5Window of SysWindow
	...
	(method (open &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6)
		...
		(= underBits (Graph grSAVE_BOX temp1 temp2 (+ temp3 2) (+ temp4 2) 1))
		(if (!= priority -1)
			(= pUnderBits (Graph grSAVE_BOX temp1 temp2 (+ temp3 2) (+ temp4 2) 2))
		)
		(Graph
			grFILL_BOX
			(+ temp1 2)
	...
	(method (dispose)
		...
		(if eraseOnly
			...
			(Graph grREDRAW_BOX top left bottom right)
		)
		(if window
