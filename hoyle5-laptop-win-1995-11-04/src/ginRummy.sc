		...
		(if bestDeadWood
			(if (<= (- bestDeadWood highestDeadWood) local22)
				...
				(if (= temp3 (- bestDeadWood highestDeadWood))
					(gChar1 sayReg: 1000 2 97 0 (Random 1 2) 718 1)
					(DisableCursor)
					(= local11 1)
				else
					(gChar1 sayReg: 1000 2 118 0 (Random 1 2) 718 1)
					(DisableCursor)
					(= local11 1)
				)
			...
			(10
				(if (or local11 (and local5 (knockCheck doit:)))
					...
					(if (== (global419 size:) 2)
						(= global920 1)
						(if gAttitudeSetting
							(gChar1 sayReg: 400 15 75 0 (Random 1 2) 718 1)
						else
							(gChar1 say: 400 15 75 0 2 718 1)
						)
						(= global244 1)
						(clearTable doit:)
						(= local6 0)
