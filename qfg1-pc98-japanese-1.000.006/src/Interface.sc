...
(procedure (Print args &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 [temp12 6] temp18 temp19 temp20 [temp21 1001] temp1022 temp1023 temp1024 temp1025 temp1026 temp1027 temp1028 temp1029 temp1030 temp1031 temp1032 temp1033)
	(= temp1028 0)
	(= temp1029 0)
	(= temp6 (= temp7 -1))
	...
	(= temp1033
		(= temp9
			(= temp8
				(= temp18
					(= temp2 (= temp3 (= temp1023 (= temp1031 (= temp19 0)))))
				)
			)
		)
	)
	...
	(if temp2
		...
		(temp1024
			moveTo: (+ 4 (temp2 nsRight:) temp1031) (temp1024 nsTop:)
			setSize:
		)
		(if temp1025
	...
	(method (handleEvent event &tmp ret)
		(if
			(or
				(event claimed:)
				(== (event type:) evNULL)
				(not (OneOf (event type:) evMOUSEBUTTON evKEYBOARD $0040 evJOYDOWN)) ; direction
			)
