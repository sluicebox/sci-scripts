			...
			(evSAID
				(cond
					...
					(
						(or
							(Said
								'cast,use,throw,splash,splash/disenchant,disenchant,potion[<disenchant,disenchant]'
							)
							(Said 'disenchant,disenchant')
						)
...
(instance elsaIsBack of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				(EgoDead ; "Thinking about all that treasure cost you time and more. Some folks just don't know when to leave."
					97
					46
					82
					516
...
(instance elsaKillsEgo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(EgoDead ; "The brigand leader is deadly with a sword.  The magic spell that possesses her makes her an invincible warrior."
					97
					48
					82
					503
