...
(procedure (localproc_1)
	(switch local12
		...
		(3
			(local14 setCel: 0 posn: 252 127 stopUpd:)
			(fighterScript changeState: 0)
			(mageScript changeState: 0)
...
(instance selChar of Rm
	...
	(method (init)
		...
		(Load rsVIEW (LangSwitch 506 526))
		(User canInput: 0)
		((= local14 (View new:))
			view: 506
			setLoop: 0
		...
		((= local4 (View new:))
			view: (LangSwitch 506 526)
			setLoop: 1
			setCel: 0
			posn: (LangSwitch 83 130) 25
			init:
			ignoreActors:
			stopUpd:
		)
	...
	(method (doit)
		(cond
			...
			((and local16 (== (gContMusic prevSignal:) 3))
				(gContMusic prevSignal: 0)
				(if (== local12 3)
					(= local12 1)
				else
...
(instance selScript of Script
	...
	(method (doit)
		(if (and (== state 3) (not local16) (== (gContMusic prevSignal:) 3))
			(gContMusic prevSignal: 0)
			(= local15 1)
			(= local16 1)
			(fighterScript changeState: 1)
