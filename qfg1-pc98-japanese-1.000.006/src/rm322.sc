				...
				(cond
					...
					((Said 'look,look>')
						(cond
							...
							((Said '/odds,ends,stuff,stuff,item')
						...
						(cond
							...
							(else
								...
								(cond
									...
									((Said '//book')
										(HighPrint 322 25) ; "Oh, this book? It's about an adventurer who is trying to become a Hero. The title is 'Quest for Glory:  A Hero's Death'."
									)
									(
										(Said
									...
									(
										(Said
											'//bandit,baron,barnard,lady,woman,zara,ermit,baba,barnard,elsa,hamlet,erasmus,erana,monster,brauggi,giant,meep,healer,bouncer,master,ermit'
										)
