...
(instance baron of Act
	...
	(method (handleEvent event)
		(cond
			...
			((or (Said 'look,look/baron,dad') (MouseClaimed self event 3))
...
(instance son of Act
	...
	(method (handleEvent event)
		(cond
			...
			(
				(or
					(Said 'look,look/barnard,barnard,bear,barnard')
...
(instance onCupboard of RFeature
	...
	(method (handleEvent event)
		(cond
			((super handleEvent: event))
			((or (Said 'look,look/cabinet') (MouseClaimed self event 3))
...
(instance onArms of RFeature
	...
	(method (handleEvent event)
		(cond
			...
			(
				(or
					(Said 'look,look/(arm[<coat,coat]),design,crest')
					(MouseClaimed self event 3)
				)
...
(instance onGrate of RFeature
	...
	(method (handleEvent event)
		(cond
			((super handleEvent: event))
			((or (Said 'look,look/grate,fire,chimney') (MouseClaimed self event 3))
...
(instance onDoor of RFeature
	...
	(method (handleEvent event)
		(cond
			((super handleEvent: event))
			((or (Said 'look,look/door') (MouseClaimed self event 3))
		...
		(cond
			...
			((== (event type:) evSAID)
				(cond
					...
					((Said 'kill,attack,cut,hit,damage,cast')
					...
					((Said 'look,look[<at,around][/!*,room,building,hall]')
