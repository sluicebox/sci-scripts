		...
		(switch (event type:)
			(evSAID
				(cond
					...
					((Said 'look,look[/!*,forest,greenery,clearing]')
						(if (> (gCast size:) 2)
					...
					(
						(Said
							'capture,kill,hit,get,get,attack,attack,attack,play/antwerp,baby,baby'
						)
						(if (> (gCast size:) 2)
...
(instance splat of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(a1 ignoreActors: 0 illegalBits: $8000 setMotion: Wander)
				(a2 ignoreActors: 0 illegalBits: $8000 setMotion: Wander)
				(a3 ignoreActors: 0 illegalBits: $8000 setMotion: Wander)
				(if (> gHowFast 0)
					(a4 ignoreActors: 0 illegalBits: $8000 setMotion: Wander)
					(a5 ignoreActors: 0 illegalBits: $8000 setMotion: Wander)
				)
				(NormalEgo)
