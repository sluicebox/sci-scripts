...
(local
	...
	[local100 4] = [{\89\ca\95\a8\90\94\8c\c2} {\83~\81[\83v\82\cc\90\d4\82\f1\96V} {\97\ce\82\cc\96\d1\94\e7\8f\ad\81X} {\96\82\96@\82\cc\83X\83y\83\8b\82\cc\8d\da\82\c1\82\bd\8a\aa\95\a8}]
	[local104 200]
	local304
	local305
)
			...
			(evSAID
				(cond
					(
						(or
							(Said
								'cut,hit,attack,kill,damage[/meep,creature,boulder]'
							)
							(Said 'use,draw/blade')
						)
						(cond
					...
					(
						(Said
							'lift,lift,(pick,lockpick<up),get,get,capture/boulder,meep'
						)
					...
					((Said 'ask>')
						...
						(cond
							...
							((Said '//apple,apple,stuff,stuff,junk')
