...
(instance intro of Rm
	...
	(method (init)
		...
		(LoadMany rsVIEW 906 907 913 5 7 430 460 462 908)
		(LoadMany rsVIEW (LangSwitch 918 921))
		(LoadMany rsVIEW (LangSwitch 919 922))
		(super init: &rest)
		(HandsOff)
		(cond
			((== global212 1)
