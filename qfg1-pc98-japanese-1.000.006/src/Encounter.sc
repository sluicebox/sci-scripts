...
(procedure (localproc_6 &tmp [temp0 120])
	(switch global284
		(0
		...
		(else
			(HighPrint (Format @temp0 210 38 global284 global284)) ; "You find %d silver coins, and carefully place them in your pouch.%"
