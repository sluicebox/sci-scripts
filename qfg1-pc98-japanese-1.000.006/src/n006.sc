	...
	(cond
		...
		((Said '/carrot')
			(if (gEgo has: 12) ; carrot
				...
				(HighPrint 6 13) ; "You eat some vegetables. You think they would have been better saved for cows or horses. Real Heroes eat preserved dry rations."
				(= haveEaten 1)
			else
				(HighPrint 6 14) ; "You don't have any vegetables."
			)
		)
		((or (Said '/ration,food') (Said 'eat,eat[/!*]'))
			(if (gEgo has: 3) ; food
				(gEgo use: 3 1) ; food
