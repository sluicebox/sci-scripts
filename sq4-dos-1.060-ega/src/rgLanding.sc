...
(instance fallScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Print 709 0) ; "Watch out for that first step..."
				(HandsOff)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(switch gCurRoomNum
					(530
						(Print 709 1) ; "You are in the Super Computer's landing bay. Here you see the Sequel police dispatch terminal."
					)
					(535
						(Print 709 2) ; "This is the middle section of the Super Computer's Landing Bay. The ship you hitched a ride on rests here."
					)
					(540
						(Print 709 3) ; "There's a tunnel leading into the middle of the structure."
					)
				)
			)
			(else
