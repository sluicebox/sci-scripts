		...
		(switch (= state newState)
			...
			(22
				...
				(self
					save1:
						(proc0_12
							{"When it seemed there was no hope, we thought of one last longshot effort. That was to find the only person in history ever to defeat Vohaul. We had to go back in time to find that person - you. We got there just in time."}
							67
							2
							2
							28
