...
(instance rm387 of SQRoom
	...
	(method (init)
		...
		(gNarrator enable: 0 1 2 3 4 5 6 7)
...
(instance readSignCode of Code
	...
	(method (doit)
		...
		(Print 387 4) ; "Keyboard: Up & down arrows switch between condiments and burger. When on condiment level, left & right arrows move cursor between the condiments. When on burger level, cursor follows burger. Mouse: Click on condiment to pick it up. Click it again on top of burger to install it. If you're carrying a condiment and you cycle to another cursor, the condiment drops back into its bay."
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(4
				...
				(gEgo setMotion: 0)
				(= temp0 (gNarrator curIcon:))
				(gNarrator disable: 0 1 2 3 4 5 6 7)
				(gNarrator curIcon: temp0)
