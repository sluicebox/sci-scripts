	...
	(method (changeState newState &tmp temp0 temp1 temp2 temp3 temp4 temp5 [temp6 5] [temp11 50])
		(switch (= state newState)
			...
			(3
				...
				(= temp5 (* gDifficulty 3))
				(if (not (jigsaw shown:))
					(Say jigsaw 23 9 0 0 0 180) ; "This is the animated jigsaw puzzle. You'll find all the pieces to it in the chest. If you wish to quit this puzzle before solving it, just click on the Exit button (on the front of the chest). To see what the jigsaw puzzle looks like, just click the right mouse button."
					(jigsaw shown: 1)
				)
