	...
	(method (init)
		...
		(cond
			...
			((and (not (IsFlag 23)) (not (IsFlag 29))) ; fOpenedDoor, fPuncturedDoll
				(door cycleSpeed: (+ 3 gHowFast) init:)
			)
		)
		(super init:)
	)
...
(instance sEveDoesLarry of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(aEve cycleSpeed: (+ 3 gHowFast) setCycle: ForwardCounter 7)
...
(instance sKenSpeaks of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(16
				(Print 370 17 #at -1 20) ; "Oh, wait. I almost forget to tell you how well you played."
