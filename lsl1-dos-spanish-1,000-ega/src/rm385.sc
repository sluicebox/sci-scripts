...
(procedure (JetsOn)
	(chestBubbles init: cycleSpeed: gHowFast setCycle: Fwd)
	(leftRim init: cycleSpeed: gHowFast setCycle: Fwd)
	(bubble1 init: cycleSpeed: gHowFast setCycle: Fwd)
	(bubble2 init: cycleSpeed: gHowFast setCycle: Fwd)
	(bubble3 init: cycleSpeed: gHowFast setCycle: Fwd)
	(smallBubble init: cycleSpeed: gHowFast setCycle: Fwd)
)
...
(instance rm385 of Rm
	...
	(method (init)
		...
		(herEyes init: cycleSpeed: (+ 1 gHowFast))
		(eyeRight init: cycleSpeed: (+ 1 gHowFast))
		(eyeLeft init: cycleSpeed: (+ 1 gHowFast))
		(herMouth init: cycleSpeed: (+ 1 gHowFast))
		(fEveHead init:)
		(fBoobs init:)
		(fEveArms init:)
		(fTowel init:)
