...
(instance rm310 of LLRoom
	...
	(method (init &tmp i)
		...
		(oldlady cycleSpeed: gHowFast init: setScript: sGamble 0 0)
		(man1 cycleSpeed: gHowFast init: setScript: (sGamble new:) 0 2)
		(man1eyes cycleSpeed: gHowFast init: setScript: (sBlink new:))
		(shortman cycleSpeed: gHowFast init: setScript: (sGamble new:) 0 0)
		(babe cycleSpeed: gHowFast init: setScript: (sGamble new:) 0 7)
		(jane cycleSpeed: gHowFast init: setScript: (sGamble new:) 0 0)
		(rodney cycleSpeed: gHowFast init: setScript: (sGamble new:) 0 0)
		(if (gGame detailLevel:)
			(lightBulb cycleSpeed: gHowFast setCycle: Fwd init:)
			(flashball cycleSpeed: gHowFast setCycle: Fwd init:)
			(flashers cycleSpeed: gHowFast setCycle: Fwd init:)
			(flashingballs2 cycleSpeed: gHowFast setCycle: Fwd init:)
			(flashingsteps cycleSpeed: gHowFast setCycle: Fwd init:)
			(siren cycleSpeed: gHowFast setCycle: Fwd init:)
			(chaser1 cycleSpeed: gHowFast setCycle: Fwd init:)
			(chaser2 cycleSpeed: gHowFast setCycle: Fwd init:)
			(chaser3 cycleSpeed: gHowFast setCycle: Fwd init:)
			(chaser4 cycleSpeed: gHowFast setCycle: Fwd init:)
			(screen1 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen2 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen3 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen4 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen5 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen6 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen7 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen8 cycleSpeed: gHowFast setCycle: RandCycle init:)
			(screen9 cycleSpeed: gHowFast setCycle: RandCycle init:)
		)
		...
		(switch theVerb
			(3 ; Do
				(if (< gLarryDollars 10000)
					(Printf 310 3 gLarryDollars gLarryDollars) ; "You insert your $%d into the machine and brace yourself for an invigorating round of electronic blackjack."
					(gTheMusic fade:)
		...
		(switch theVerb
			(3 ; Do
				(if (< gLarryDollars 10000)
					...
					(Print 310 6) ; "Sorry, Larry. You've already made the big bucks."
				)
			)
			(4 ; Inventory
				(switch invItem
