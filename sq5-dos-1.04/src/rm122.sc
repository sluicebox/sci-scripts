			...
			(3 ; Walk
				(cond
					...
					((== (closetDoor cel:) (closetDoor lastCel:))
						(gMessager say: 2 4 1 0) ; "Though the tantalizing scents of pine and non-abrasive cleansers beckon you to explore the dark reaches of the janitorial closet, you fight back the urge."
					)
					(else
