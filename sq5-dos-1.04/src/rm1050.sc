...
(instance rm1050 of Rm
	...
	(method (init)
		...
		(super init:)
		(theMusic3 number: 101 owner: self flags: 1 init: setLoop: -1 play: 80)
...
(instance sPukoidsTransformed of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(17
				(gMessager say: 3 0 0 1 self) ; "That's got her, Cap'n. I've beamed all the pukoid material from the crew out into space."
			)
			(18
