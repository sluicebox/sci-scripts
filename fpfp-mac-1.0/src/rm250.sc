...
(instance rm250 of FPRoom
	...
	(method (init)
		...
		(cond
			((== gCurPuzzle 14) 0)
			((== gPrevRoomNum 710) 0)
			((OneOf gPrevRoomNum 240)
				(gGameMusic1 number: 710 flags: 1 loop: -1 play: setVol: 80)
			)
			((== gPrevRoomNum 260)
				(gGameMusic1 number: 600 flags: 1 loop: -1 play: setVol: 80)
			)
	...
	(method (doit &tmp temp0 temp1 [temp2 2])
		...
		(cond
			...
			((<= (gEgo x:) 159)
				...
				(if (== (gGameMusic1 number:) 600)
					(gGameMusic1 number: 710 play:)
				)
				(cond
					(
						(<
			...
			((>= (gEgo x:) 160)
				...
				(if (== (gGameMusic1 number:) 710)
					(gGameMusic1 number: 600 play:)
				)
				(cond
					(
						(<
