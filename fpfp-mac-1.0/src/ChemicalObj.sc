									...
									(9
										(if
											...
											(if
												...
												(gGame points: 5 154)
												(= global143 1)
												(gMessager say: 34 0 26 0 self) ; "You carefully label the jar, 'Aminophyllic Citrate.' Congratulations. You've just created your first batch of "Pharkas' Deflatulizer.""
											else
