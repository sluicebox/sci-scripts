		...
		(if (and (event type:) (== gCurRoomNum gNewRoomNum))
			...
			(switch
				(Print
					...
					addButton: 2 3 0 0 2 54 0 170 ; "Restart"
					addButton: 0 3 0 0 3 108 0 170 ; "Continue"
					addButton: 3 3 0 0 4 178 0 170 ; "Quit"
					init:
				)
				(0
					(gGameMusic1 pause: 0)
