	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(12
				...
				(gEgo view: 741 loop: 3 cel: 0 setSpeed: 7 setCycle: Walk)
			)
			(13
				(= next sStartTheFight)
				(self dispose:)
			...
			(0
				...
				(switch
					(Print
						...
						addButton: 2 24 0 0 2 0 30 740 ; "Hmmm. I dunno. That was a pretty   impressive half-gainer."
						addButton: 3 24 0 0 3 0 60 740 ; "Oh, my God. I'm going to die. Give me a break!"
						init:
					)
					(0
						(= local7 1)
