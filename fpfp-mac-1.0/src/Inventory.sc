...
(class Inv of IconBar
	...
	(method (doit &tmp temp0 temp1 temp2 temp3 temp4 [temp5 2] temp7 temp8 temp9 [temp10 200] temp210)
		...
		(while (& state $0020)
			...
			(if (and (= temp210 (gGame script:)) (temp210 isKindOf: Tutorial))
				(temp210 doit:)
			)
			(if gFastCast
