...
(instance sDunkPlop of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6 0)
			(7
				(gMessager say: 36 0 0 0 self) ; "LOOK WHAT YOU'VE DONE!! Freddy Pharkas, I'll see you run out of town for this!!"
			)
			(8
				(hopSingh
					view: 664
		...
		(switch theVerb
			(4 ; Do
				(if (== gCurPuzzle 3)
					...
					(gMessager say: 21 theVerb 4) ; "Nobody goes into my kitchen without my permission. Nobody, do you hear?"
				)
			)
			(else
				(super doVerb: theVerb &rest)
		...
		(switch theVerb
			(4 ; Do
				(if (== gCurPuzzle 3)
					...
					(gMessager say: noun theVerb 4) ; "Nobody goes into my kitchen without my permission. Nobody, do you hear?"
				)
			)
			(else
				(super doVerb: theVerb &rest)
