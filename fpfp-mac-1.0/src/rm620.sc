...
(instance rm620 of FPRoom
	...
	(method (doit &tmp temp0)
		...
		(if script
			...
			(= temp0 (gCast firstTrue: #onMe gMouseX gMouseY))
							...
							(if (== amount 6)
								...
								(cond
									...
									((== gCurPuzzle 8)
										(ClearFlag 104)
										(= global143 1)
										(gMessager say: 34 0 33 0 self) ; "You attempt to make something that will cure the horses' flatulence. But until you find a way to "breathe easier," you won't be able to get near enough to those horses to use it!"
									)
									(else
										(gEgo get: -1 26) ; Incorrect_Med2
										(= global143 1)
			...
			((== (global142 objType:) 3)
				(cond
					...
					(
						...
						(gMessager say: noun 73) ; "To make pills, you need a mixture which contains at least one solid."
					)
