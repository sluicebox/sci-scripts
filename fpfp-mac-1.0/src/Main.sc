...
(class FP of Game
	...
	(method (restore &tmp temp0 temp1 temp2 temp3)
		(= temp1 gNormalCursor)
		(= gNormalCursor 999)
		(gGame setCursor: 999 1 242 68)
		(= temp0 gSystemWindow)
		(= gSystemWindow SysWindow)
		(if (IsObject (gTheIconBar curIcon:))
			(Platform 0 4 4 6 (gInventory indexOf: (gInventory curIcon:)))
		else
			(Platform 0 4 4 6 -1)
		)
		(super restore: &rest)
	...
	(method (replay &tmp temp0 temp1 temp2 temp3)
		(Platform 0 4 2 -1)
		(for
			((= temp2 (FirstNode (gTheIconBar elements:))))
			temp2
			((= temp2 temp3))
	...
	(method (restart)
		(if (OneOf gCurRoomNum 29 99) ; whereTo, deathRoom
		...
		(switch (event type:)
			(evKEYBOARD
				(switch (event message:)
					(KEY_1
						(oneSound number: 2919 play:)
					)
					(KEY_2
						(oneSound number: 2953 play:)
					)
					(KEY_3
						(oneSound number: 2954 play:)
					)
					(KEY_4
						(oneSound number: 2946 play:)
					)
					(KEY_5
						(oneSound number: 2912 play:)
					)
					(KEY_6
						(oneSound number: 2205 play:)
					)
					(KEY_7
						(oneSound number: 2122 play:)
					)
					(KEY_8
						(oneSound number: 2121 play:)
					)
					(KEY_9
						(oneSound number: 2939 play:)
					)
					(KEY_0
						(oneSound number: 2116 play:)
					)
					(KEY_TAB
	...
	(method (handsOff)
		...
		(gTheIconBar disable: 0 1 2 3 5 6 7 9)
		(if (not (HaveMouse))
			(gGame setCursor: 996)
		else
			(gGame setCursor: gWaitCursor)
	...
	(method (handsOn param1)
		...
		(Platform 0 4 2 -1)
		(gTheIconBar enable: 0 1 2 3 5 6 7 9)
...
(instance icon5 of IconI
	...
	(method (select)
		...
		(Print
			window: SysWindow
			addTextF: {Your current score is: %d out of %d} gScore gPossibleScore
			addTitle: {Your score}
			init:
		)
		(gTheIconBar enable:)
