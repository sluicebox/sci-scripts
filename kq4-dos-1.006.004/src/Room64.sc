...
(instance Room64 of Rm
	...
	(method (init)
		...
		(super init:)
		((View new:) view: 536 loop: 3 cel: 0 posn: 153 81 setPri: 15 addToPic:)
		((View new:) view: 536 loop: 3 cel: 0 posn: 166 81 setPri: 15 addToPic:)
		((View new:) view: 536 loop: 3 cel: 0 posn: 178 81 setPri: 15 addToPic:)
		(if gNight
			((View new:)
				view: 648
				loop: 3
		...
		(if (== gPrevRoomNum 68)
			(gEgo posn: 51 130 view: 4 xStep: 4 yStep: 2 init:)
		)
		(if (== gPrevRoomNum 65)
			(gEgo posn: 210 117 view: 4 xStep: 4 yStep: 2 init:)
		)
