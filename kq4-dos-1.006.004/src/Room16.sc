	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(local0 setMotion: 0 view: 260 cel: 0 setCycle: Beg self)
			)
			(5
...
(instance z2Actions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(local1 setMotion: 0 view: 262 cel: 0 setCycle: Beg self)
				(Print 16 20 #at -1 20) ; "The terrifying zombie senses your obsidian scarab. It immediately retreats and goes back to whence it came."
				(if (== (-- global186) 0)
					(zTheme loop: 1 changeState:)
				)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(local2 setMotion: 0 view: 264 cel: 0 setCycle: Beg self)
			)
			(5
