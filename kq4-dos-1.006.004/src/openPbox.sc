...
(instance openPbox of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Print 307 0 #at -1 10 #time 6) ; "Ok, but you'll be sorry!"
				(gEgo viewer: 0)
				(if gIndoors
					(gEgo view: 40)
				else
			...
			(1
				...
				(Print 307 1 #font gSmallFont #at 5 10 #width 120 #dispose) ; "That was very foolish, Rosella! Now look what you've gone and done! You've loosed the terrible demons...and killed yourself in the process!!"
			)
			(2
				(smokeFirst
					posn: (aBox x:) (- (aBox y:) 5)
			...
			(4
				...
				(smokeFirst hide:)
				((ScriptID 0 6) setReal: self 10) ; timer3
			)
			(5
				(gEgo
					loop: (if gIndoors 1 else 3)
