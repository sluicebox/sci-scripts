...
(instance askForParti of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(14
				(myConv add: -1 5 5 4 9 add: -1 5 5 4 10 init: self) ; "Don't mind Oxymoron and Dipthong. They're fairly limited grammatical principles, you know.", "Hmm, let's see. A marsh pig that does taxes?"
			)
			(15
				(bookworm setLoop: 2 cel: 0 setCycle: End self)
			)
