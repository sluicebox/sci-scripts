...
(local
	[local0 100]
	[local100 250]
	[local350 26] = [1 1 1 2 3 4 1 2 3 4 4 1 3 4 1 3 3 4 1 2 3 4 1 2 1 -1]
	[local376 26] = [98 100 380 240 150 480 650 520 450 580 160 490 730 690 790 770 260 750 220 470 410 510 210 290 660 -1]
	local402
	local403 = 1
	local404
	local405
...
(instance creditsScript of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(DrawPic [local376 local402] 9)
				(if (== [local376 local402] 98)
					(= cycles 2)
				else
					(setUpRoom doit: self)
				)
			...
			(1
				(if (and (== [local376 local402] 98) local406)
					(= local406 0)
			...
			(3
				(if local404
					(Message msgGET 94 1 0 0 local403 @local0)
					(Message msgGET 94 1 0 0 (++ local403) @local100)
				else
					(Message msgGET 94 0 0 0 local403 @local0)
					(Message msgGET 94 0 0 0 (++ local403) @local100)
				)
				(if (>= (++ local403) 32)
					(= local404 1)
					(= local403 1)
				)
				(switch [local350 local402]
					(1
