			...
			(not
				(= gQuit
					(Print
						posn: 59 85
						font: 4
						addButton: 1 4 0 12 0 115 18 0 ; "Yes! I've had it!"
						addButton: 0 4 0 11 0 115 36 0 ; "NO! I must quest on!"
						font: 1
						addText: 4 0 0 0 0 0 0 ; "Taking off your adventurer's cap so soon?"
						init:
					)
				)
			)
			...
			(if
				(= temp0
					(Print
						...
						font: 4
						width: 210
						addButton: 1 5 0 13 0 115 26 0 ; "Yes. Restart already."
						addButton: 0 5 0 14 0 155 26 0 ; "Oops. Cancel restart."
						font: 1
						addText: 5 0 0 0 0 0 0 ; "Are you sure you want to clear your game and restart?"
						init:
					)
				)
				(super restart: &rest)
...
(instance icon6 of Kq6IconItem
	...
	(method (doit)
		(if (>= (MemoryInfo 0) 1500) ; LargestPtr
