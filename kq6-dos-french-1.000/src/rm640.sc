				...
				(repeat
					(switch
						(Print
							...
							addText: 0 0 global160 1 0 40 916
							addButton: 1 {R\82tablir} 0 70
							addButton: 2 {Ressortir} 67 70
							addButton: 3 {Sortir} 134 70
							init:
						)
						(1
							(gGame restore:)
