...
(instance rm170 of Room
	...
	(method (init &tmp temp0)
		...
		(proc0_4 1)
		(gPqFlags set: 27)
		(gGlobalSound1 number: 130 setLoop: -1 setVol: 0 play: fade: 127 4 2 0)
		(sFx1 init:)
		(sFx2 init:)
		(sFx3 init:)
		(sFx4 init:)
		...
		(gEgo get: 32) ; keys
		(sFx1 number: 917 setLoop: 1 play:)
		...
		(switch (= state newState)
			...
			(1
				(if (= temp0 ((gInventory at: 11) state:)) ; handgun
					...
					(if register
						(sFx5 number: 926 setLoop: 1 play:)
...
(instance run of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(sFx5 number: 934 setLoop: 1 play: self)
			)
			(1
			...
			(3
				(sFx5 number: 930 setLoop: 1 play:)
				(gGlobalSound1 fade: 0 4 2 1)
				(gGlobalSound0 number: 170 setLoop: -1 setVol: 127 play:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				2
				(gGame handsOn:)
				(sFx1 number: 933 setLoop: 1 play:)
				(gGlobalSound1 setLoop: 1 fade: 0 4 2 1)
				(gGlobalSound0 number: 102 setLoop: 1 setVol: 127 play:)
				(emo setScript: run)
				(= seconds 3)
			)
			(3
						...
						(cond
							((== (gTheIconBar curInvIcon:) (gInventory at: 11)) ; handgun
								(if (= temp1 ((gInventory at: 11) state:)) ; handgun
									...
									(if temp0
										(gGlobalSound1 setLoop: 1 number: 930 play:)
									else
										(gGlobalSound1 setLoop: 1 number: 926 play:)
									)
								else
									(gGlobalSound1 setLoop: 1 number: 12 play:)
							...
							((= temp1 ((gInventory at: 12) state:)) ; shotgun
								...
								(if temp0
									(gGlobalSound1 setLoop: 1 number: 931 play:)
								else
									(gGlobalSound1 setLoop: 1 number: 932 play:)
								)
								((= temp14 (View new:))
									view: 174
									loop: (sight loop:)
...
(instance copPopAndFire of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(sFx5 init: number: 935 setLoop: 1 play:)
				(= cycles 5)
			)
			(3
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gGame handsOff:)
				(SetCursor -2)
				(gGlobalSound0 setLoop: 1 number: 930 setVol: 127 play: self)
			)
			(1
				(gTheCursor show:)
				(EgoDead 0 0 4 1 170) ; "You're hit and killed. You have now become a statistic."
...
(instance sForward of Fwd
	...
	(method (dispose)
		(switch client
			(window1
				(sFx1 setLoop: 1 number: 901 setVol: (Random 25 127) play:)
			)
			(window2
				(sFx2 setLoop: 1 number: 901 setVol: (Random 25 127) play:)
			)
			(window3
				(sFx3 setLoop: 1 number: 901 setVol: (Random 25 127) play:)
			)
			(else
				(sFx4 setLoop: 1 number: 901 setVol: (Random 25 127) play:)
			)
		)
		(= local22 0)
		(super dispose:)
	...
	(method (init)
		...
		(switch client
			(window1
				(sFx1 setLoop: -1 setVol: 127 number: 900 play:)
			)
			(window2
				(sFx2 setLoop: -1 setVol: 127 number: 900 play:)
			)
			(window3
				(sFx3 setLoop: -1 setVol: 127 number: 900 play:)
			)
			(else
				(sFx4 setLoop: -1 setVol: 127 number: 900 play:)
			)
		)
	)
)
