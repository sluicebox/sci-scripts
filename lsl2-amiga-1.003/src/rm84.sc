	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(15
				...
				(Print 84 7 #at -1 130) ; "(But, it's too late!)"
			...
			(63
				...
				(Print 84 20 #at -1 130) ; "(You often slip back into the 70's without even trying!)"
				...
				(Print 84 22 #at -1 130) ; "(Do you realize how stupid you sound?)"
			...
			(65
				...
				(Print 84 25 #at -1 20) ; "Crackle."
				(Print 84 26 #at -1 20) ; "Pop."
				(Print 84 27 #at -1 130) ; "(You almost receive a breakfast cereal commercial.)"
				(= seconds 3)
			)
			(66
			...
			(79
				(Print 84 41 #at -1 130) ; "(You ignore this blatant plug.)"
