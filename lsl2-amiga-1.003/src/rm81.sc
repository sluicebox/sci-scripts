...
(instance rm81 of Rm
	...
	(method (init)
		...
		(aYellowName setPri: 11 setCycle: Fwd cycleSpeed: 2 init: hide:)
		(NormalEgo)
...
(instance rm81Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(17
				(aCoil hide:)
				(gAddToPics add: aCoil4 doit:)
				(gEgo view: 183 cel: 0 posn: 156 69 setCycle: End self)
			)
			(18
				(Print 81 18 #draw) ; "You made it!"
				(Print 81 19 #at -1 130) ; "(If you keep this up, you're going to be a hero yet, Larry!)"
