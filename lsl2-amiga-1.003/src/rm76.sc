	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				...
				(Print 76 10 #at -1 130) ; "(villagers go ooooooh)"
				(= seconds 3)
			)
			(9
			...
			(17
				...
				(Print 76 16 #at -1 130) ; "(villagers gasp)"
				(aMouth hide:)
				(= cycles 20)
			)
			(18
			...
			(22
				(aBigEgo posn: 275 39)
				(aBigScreen posn: 275 39 cel: 0 setCycle: End self)
				(= cycles 10)
			)
			(23
				(aBigScreen setLoop: 2 setCycle: Fwd)
				(cls)
				(Print 76 18 #at -1 130 #dispose) ; "INT   21 JB   0103"
				(= cycles (Random 20 30))
			)
			(24
				(cls)
				(Print 76 19 #at -1 130 #dispose) ; "MOV   AH,4D INT   21 CS:"
				(= cycles (Random 20 30))
			)
			(25
				(cls)
				(Print 76 20 #at -1 130 #dispose) ; "MOV   [0BEA],AX JMP   02B2 JMP   1451"
				(= cycles (Random 20 30))
			)
			(26
				(cls)
				(Print 76 21 #at -1 130 #dispose) ; "CS: TEST  BYTE PTR [0C59],01 JZ   0150"
				(= cycles (Random 20 30))
			)
			(27
				(cls)
				(Print 76 22 #at -1 100 #dispose) ; "CS: TEST  BYTE PTR [0C59],02 JZ   014F IRET"
				(= cycles (Random 20 30))
			)
			(28
				(cls)
			...
			(29
				(cls)
				(Print 76 23 #at -1 100 #dispose) ; "TEST  BYTE PTR [0C59],04 JZ   0169 CMP   AH,01 JA   014F"
				(= cycles (Random 20 30))
			)
			(30
				(cls)
			...
			(38
				...
				(Print 76 31 #at -1 130) ; "(villagers go aaaahhhh)"
				(aMouth hide:)
