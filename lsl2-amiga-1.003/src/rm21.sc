...
(instance rm21 of Rm
	...
	(method (init)
		(Load rsVIEW 241)
		(super init:)
		(aView1 loop: 1 cel: 0 setPri: 10 ignoreActors: addToPic:)
		(aView2 loop: 1 cel: 1 setPri: 9 ignoreActors: addToPic:)
		(aSign setLoop: 0 setPri: 5 setCycle: Fwd cycleSpeed: 3 init:)
		(cond
			((== gPrevRoomNum 25)
				(gEgo posn: 222 187)
			)
