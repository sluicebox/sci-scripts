...
(instance rm91 of Rm
	...
	(method (init)
		...
		(aMouth setCycle: Fwd init:)
		(aCar illegalBits: 0 init:)
		(aDog illegalBits: 0 init: hide:)
		(gEgo
			view: 192
			ignoreActors:
			illegalBits: 0
...
(instance rm91Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gEgo loop: 1 posn: 179 147 setMotion: MoveTo 116 147 self)
			)
			(2
				(gEgo loop: 0 posn: 110 151 setMotion: MoveTo 167 151 self)
			)
			(3
				(gEgo setLoop: 1 posn: 155 155 setCel: 0 stopUpd:)
			...
			(15
				(Print 91 10 #at -1 130 #time 3) ; "(Sigh.)"
				(= cycles 30)
			)
			(16
				(aDog setLoop: 1 setCycle: Walk setMotion: MoveTo 123 161 self)
			)
			(17
