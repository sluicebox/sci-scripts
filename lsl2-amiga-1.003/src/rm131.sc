...
(instance rm131 of Rm
	...
	(method (init)
		...
		(aBoat0 cycleSpeed: 5 setPri: 14 init:)
		(aBoat1 setPri: 14 cycleSpeed: 5 init:)
		(aBoat2 cycleSpeed: 5 setPri: 14 init:)
		(aBoat3 setPri: 14 cycleSpeed: 5 init:)
		(aBoat4 setPri: 14 cycleSpeed: 5 init:)
		(aBoat5 cycleSpeed: 5 setPri: 14 init:)
		(aEgoBoat
			setLoop: 2
			setPri: 14
			setCycle: Fwd
...
(instance rm131Script of Script
	...
	(method (handleEvent event)
		...
		(if
			...
			(Print 131 3 #at -1 130) ; "(Which is not really that far.)"
