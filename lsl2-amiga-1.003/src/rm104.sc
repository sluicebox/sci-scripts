...
(instance rm104 of Rm
	...
	(method (init)
		...
		(aSign init: stopUpd:)
		(aMC setCycle: Fwd init:)
		(aCameraMonitor ignoreActors: isExtra: 1 setCycle: Fwd init:)
		(aTV ignoreActors: setCycle: Fwd init:)
		(aWheel ignoreActors: stopUpd: init:)
		(aCameraman moveSpeed: 1 cycleSpeed: 1 init:)
		(lana setCycle: Walk illegalBits: 0 init:)
		(gEgo
			view: 100
			setLoop: -1
			posn: 33 91
...
(instance rm104Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Print 104 2 #at -1 130) ; "(a little applause)"
				(StopMC)
			...
			(16
				...
				(Print 104 7 #at -1 130) ; "(applause)"
				(Print 104 8 #at -1 130) ; "(tons o' applause)"
				(= seconds 3)
			)
			(17
			...
			(22
				...
				(lana setCel: 0 cycleSpeed: 1 setCycle: End)
				(gEgo
					view: 215
					setLoop: 2
					setCel: 0
			...
			(26
				...
				(Print 104 14 #at -1 130) ; "(even more applause)"
				(aTV setLoop: 5 setCycle: Fwd)
				(= seconds 3)
			)
			(27
			...
			(32
				(Print 104 20 #at -1 130) ; "(Something tells you this is too good to last!)"
