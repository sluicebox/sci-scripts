...
(instance rm79 of Rm
	...
	(method (init)
		...
		(aWater1 setLoop: 2 setPri: 8 cycleSpeed: 1 setCycle: Fwd init:)
...
(instance rm79Script of Script
	...
	(method (handleEvent event)
		...
		(if (Said 'hop')
			...
			(Print 79 8 #at -1 130) ; "(Heh, heh, heh.)"
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 79 10 #at -1 130) ; "(The old boy's got some sense of balance!)"
				(aMouth posn: (+ (aChief x:) -1) (+ (aChief y:) -26))
				(= seconds 3)
			)
			(4
				(Print 79 11) ; "Here we are, son," says Chief Keneewauwau, "this is the secret of my people; the way to our sacred volcano; right across this chasm!"
				(= seconds 3)
			)
			(5
				(Print 79 12 #at -1 130) ; "(Some secret?! Any fool could see that!)"
				(Print 79 13) ; "Keneewauwau continues, "Of course, any fool could see that; what's important is: you must cross this chasm, climb the recent icy glacier, walk the treacherous paths, and penetrate the impenetrable fortress of the evil Dr. Nonookee!""
			...
			(16
				...
				(Print 79 26 #at -1 130) ; "(Will you stop asking all these questions and get on with the game?!)"
