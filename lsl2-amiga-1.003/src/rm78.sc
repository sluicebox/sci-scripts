...
(instance rm78Script of Script
	...
	(method (handleEvent event)
		...
		(if (Said 'talk/man,children')
			(if (gEgo inRect: 0 0 91 120)
				(Print 78 5) ; "Grunt."
				(Print 78 6 #at -1 130) ; "(Not very talkative, this one!)"
			else
	...
	(method (changeState newState &tmp i)
		(switch (= state newState)
			...
			(11
				(aKalalau hide:)
				(gEgo view: 822 setLoop: 0 cel: 0 posn: 172 151)
			...
			(25
				(Print 78 22 #at -1 130) ; "(Is this really necessary?)"
				(= cycles 22)
			)
			(26
				(aKalalau
			...
			(31
				(Print 78 24 #at -1 130) ; "(villagers go aaaaahhh)"
			...
			(37
				...
				(aCupidWest view: 822 setLoop: 4 posn: 154 105 setCycle: Fwd)
				(aCupidEast view: 822 setLoop: 5 posn: 186 105 setCycle: Fwd)
				(= cycles 30)
			)
			(38
				(aFlash
			...
			(43
				...
				(gEgo view: 100 setPri: -1 setLoop: -1 loop: 2 posn: 165 151)
