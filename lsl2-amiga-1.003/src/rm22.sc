...
(instance rm22 of Rm
	...
	(method (init)
		...
		(Load rsVIEW 235)
		(super init:)
		(gAddToPics add: aView1 aView2 aView3 aView4 aView5 aView6 aView7 doit:)
		(aSpudsSign1 setPri: 12 cycleSpeed: 4 setCycle: Fwd init:)
		(aSpudsSign2 setPri: 12 cycleSpeed: 4 setCycle: Fwd init:)
		(aSpudsSign3 setPri: 12 cycleSpeed: 4 setCycle: Fwd init:)
		(aBoat
			setPri: 7
			illegalBits: 0
			ignoreHorizon:
