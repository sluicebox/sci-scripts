	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				(Print 45 13 #at -1 130) ; "(Too late to leave now, Larry. He's got you!)"
				(= seconds 3)
			)
			(7
				(aBarber
			...
			(22
				...
				(Print 45 32 #at -1 130) ; "(Once again, he's got you trapped in the chair. You hope this time will turn out better!)"
				(= seconds 3)
			)
			(23
			...
			(31
				(Print 45 35 #at -1 130 #draw) ; "Yeeeeee yoooowwwwww!"
