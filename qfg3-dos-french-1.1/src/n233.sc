...
(instance quest of GameControls
	...
	(method (init)
		...
		((= window (GloryWindow new:))
			top: 60
			left: (proc0_21 50 50 50 50 80)
			bottom: 145
			right: (proc0_21 270 270 270 270 240)
			priority: 15
			yourself:
		)
...
(instance moneyIcon of IconI
	...
	(method (show &tmp [temp0 30] [temp30 30] [temp60 40] [temp100 30] [temp130 30])
		(Graph grDRAW_LINE 13 1 13 (proc0_21 220 220 220 220 160) 58 -1 -1)
		(Graph grUPDATE_BOX 12 1 14 (proc0_21 220 220 220 220 160) 1)
