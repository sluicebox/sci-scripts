...
(instance rm30 of Rm
	...
	(method (doit)
		...
		(cond
			...
			((and (not (gEgo inRect: 95 99 215 109)) local31)
				(local5 posn: 0 0)
				(= local31 0)
			)
			((> (local2 x:) 0)
				...
				(cond
					((Said 'look>')
						(cond
							...
							((Said '/wall')
								(Print 30 6 #at -1 135) ; "There are some limited edition prints on the wall. There is a partition which separates the rear of the restaurant from the front."
							)
							...
							((Said '/man,crowd,customer,cafe,customer')
								(cond
									((> (gEgo x:) 105)
										(switch (Random 0 5)
											(0
												(Print 30 41 #at -1 135) ; "Thinking you're the waiter, the diner says..."I'll take the #3 medium well, with baked potato and... oh yes, a side order of mushrooms, please.""
											)
											(1
					...
					(
						...
						(cond
							...
							(local34
								(localproc_0 30 58) ; ""Not in front of the waiter, Sonny!" Marie says."
							)
							(else
								(localproc_0 30 59) ; "Not now, Sonny!" Marie says. "The waiter'll be here any minute."
							)
						)
					)
					((Said 'eat,blow,fuck/couple,customer,cafe,customer,man')
						(Print 30 60 #at -1 135) ; "Golly gee!" the customer declares. "It must be one of them there preeverts that you read about in the papers. Go on, buddy! Get away! Shoo! Shoo!"
					)
					((Said 'fuck,eat,blow/woman,cheeks,cheeks')
						(if (> (local2 x:) 0)
							(switch (Random 0 3)
								(0
									(localproc_0 30 61) ; "Embarrassed, she says..."Oh Sonny, you shouldn't talk like that.""
								)
								(1
									(localproc_0 30 62) ; ""WOW!" she says."
								)
								(2
									(localproc_0 30 63) ; "Have a drink of water, Sonny. You must be getting warm."
								)
								(3
									(localproc_0 30 64) ; "Without saying anything, Marie blushes, but her eyes remain fixed on yours."
								)
							)
						else
							(localproc_0 30 65) ; "Here??? In the restaurant???"
						)
					)
					(
						(or
						...
						(if (and local34 (not local27))
							(localproc_0 30 66) ; "He answers..."Meatloaf is $5.00, prime rib is $8.00, and the lobster is $16.00""
							(= local37 1)
						else
							(localproc_0 30 67) ; "Better ask the waiter, if you can get his attention."
						)
					)
					(
						(or
							(Said 'read,ask/chow,choice,menu')
							(Said 'give,show,get/menu[/me]')
							(Said 'ask/waiter/menu,chow,choice')
						)
						(if local34
							(localproc_0 30 66) ; "He answers..."Meatloaf is $5.00, prime rib is $8.00, and the lobster is $16.00""
						else
							(localproc_0 30 68) ; "This restaurant has no menus. You must ask the waiter."
						)
					)
					((Said 'show/badge')
						(cond
							((and local24 local37 (not local27))
								(localproc_0 30 69) ; "He answers..."Meatloaf is $3.00, prime rib is $4.00, and the lobster is $8.00""
								(= local41 8)
								(= local42 4)
								(= local43 3)
							)
							((or (gEgo inRect: 170 111 223 120) local23)
								(localproc_0 30 70) ; "With a tear in her eye, Marie says, "S-S-S-Sonny! Are you BUSTING me????""
							)
							((> (gEgo x:) 105)
								(switch (Random 0 3)
									(0
										(localproc_0 30 71) ; "You whip out the ole badge, and the customer says... "Now what??""
									)
									(1
										(localproc_0 30 72) ; "After you have displayed your badge, the patron says: "So what?""
									)
									(2
										(localproc_0 30 73) ; "You show your badge and the customer lashes out..."Whatsa matter, am I holding my fork wrong or something?""
									)
									(3
										(localproc_0 30 74) ; ""Good day officer." he says, after you have displayed your badge."
									)
								)
							)
							(else
								(localproc_0 30 75) ; "Quit flashing your badge at the wall!"
							)
						)
					)
					((or (Said '[exit]/info[/waiter]') (Said 'info[/waiter]'))
						(if local36
							(if (> global107 5)
								(localproc_0 30 76) ; "Being the big tipper you are, you throw down $5.00."
								(-= global107 5)
							else
								(localproc_0 30 77) ; "Oops! You're down to your last cash...better not leave a tip!"
							)
						else
							(localproc_0 30 78) ; "Most people wait until they've finished eating."
						)
					)
					(
						(or
						...
						(if local36
							...
							(localproc_0 30 79) ; "You might as well eat your food before paying for it."
						)
					)
					((Said '[order]/chow')
						(if (not local27)
							(= local40 3)
							(= local39 (+ local41 local41))
						)
					...
					((or (Said 'get,get/chow') (Said '[call,get]/waiter'))
						(cond
							...
							((and local27 (> local18 0))
								(localproc_0 30 80) ; "Good food takes a little time."
							)
							((and (not local23) (not local27))
								(localproc_0 30 81) ; "So...go sit down and order some food, first!"
							)
							((and local23 (not local27))
								(localproc_0 30 82) ; "Have some patience! The waiter will take your order."
							)
							((and local30 (not local36))
								(localproc_0 30 83) ; "There's food on your plate...eat it if you're hungry."
							)
							((not local28)
								(localproc_0 30 84) ; "Have some patience with the poor waiter!"
							)
							((and local29 (not local30))
								(localproc_0 30 85) ; "Your food is on the way."
							)
							(local36
								(if local23
									(waiterScript changeState: 6)
							...
							(else
								(localproc_0 30 86) ; "The waiter's in back flirting with the cook."
							)
						)
					)
					((Said '[order]/water,tea,coffee,coca')
						(if local23
							(localproc_0 30 87) ; "Your choice comes with the meal."
						else
							(localproc_0 30 88) ; "Sit down first."
						)
					)
					((Said '[order]/beer,booze,drink')
						(if local36
							(localproc_0 30 89) ; "Maybe a little later."
						else
							(localproc_0 30 90) ; "You feel like eating something before you have a drink."
						)
					)
					((Said 'eat[/chow,chow,meatloaf,loaf,rib,lobster]')
						(cond
							((and local30 local23 (not local35) (not local36))
								(marieScript changeState: 1)
							)
							((and (not local23) (not local36))
								(localproc_0 30 91) ; "Sit at the table in order to eat."
							)
							(local36
								(localproc_0 30 92) ; "You've already cleaned your plate."
							)
							(local35
								(localproc_0 30 93) ; "Can't you tell from the taste in your mouth that you're already eating?"
							)
							(else
								(localproc_0 30 94) ; "You don't have any food of your own yet."
							)
						)
					)
					((Said 'give/flower,rose,plant,bouquet,carnation')
						(cond
							((and local23 (not local25) (gEgo has: 11)) ; potted_plant
								(sonnyScript changeState: 2)
							)
							((and local23 local26)
								(localproc_0 30 95) ; "She already has them."
							)
							((not local23)
								(localproc_0 30 96) ; "Why don't you sit down first?"
							)
							((and local25 (gEgo has: 11)) ; potted_plant
								(localproc_0 30 97) ; "Wait until the waiter's taken your order."
							)
							(else
								(localproc_0 30 98) ; "You didn't buy them when you had a chance."
							)
						)
					)
					((Said 'sat[<down]')
						(cond
							((gEgo inRect: 203 109 233 120)
								(sonnyScript changeState: 0)
							)
							((gEgo inRect: 170 111 203 120)
								(localproc_0 30 99) ; "On her lap??! Try your own chair!"
							)
							(local23
								(localproc_0 30 100) ; "You can't sit down any farther!"
							)
							(else
								(localproc_0 30 101) ; "Why don't you sit with your girlfriend?"
							)
						)
					)
					(
						(or
							(Said 'say,talk/bye,cheeks')
							(Said '/bye')
							(Said '/cheeks<bye')
						)
						(= local33 1)
						(localproc_0 30 102) ; "Snif!"
					)
					((Said 'stand,(get<up)')
						(if (not local23)
							(localproc_0 30 103) ; "Get up from where? You're already standing!"
						else
...
(instance waiterScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(local0 stopUpd: (Print 30 104 #at 68 160)) ; ""Please find a table, Sir, and we'll be right with you," says the waiter."
				(self cue:)
				(User canControl: 1)
			)
			(3
			...
			(10
				...
				(if local36
					...
					(Print 30 105 #at 59 160 #time 6) ; "Good day sir," says the waiter..."Our specials of the day are meatloaf, prime rib, and lobster."
					(Print 30 106 #at 59 170) ; "Continuing he says, "Which would you prefer?""
					(= local34 1)
				)
			)
			(11
				(cond
					((and local23 local34 (not local27))
						(switch local40
							(3
								(localproc_0 30 107) ; "Very good, sir. The lobster is excellent this season. And what will you have, young lady?"
							)
							(1
								(localproc_0 30 108) ; "A wise choice....very frugal. And what will you have, young lady?"
							)
							(2
								(localproc_0 30 109) ; "Our beef comes only from contented steers. And what will you have, young lady?"
							)
						)
						(localproc_0 30 110) ; ""I'll have the lobster!" says Marie."
						(= local27 1)
						(= local18 300)
						(= local19 450)
						(self cue:)
					...
					(local27
						(localproc_0 30 111) ; "You've already ordered food."
					)
					((not local34)
						(localproc_0 30 112) ; "Wait for the waiter."
					)
					(else
						(localproc_0 30 113) ; "You must be seated at a table if you want to order."
					)
				)
				(User canControl: 1)
			)
			(12
				(localproc_0 30 114) ; "Thank you very much sir" the waiter says, "your order will be ready shortly."
			...
			(16
				(localproc_0 30 115 25 3) ; "Here comes the chow!"
				(HandsOff)
				(local0
					view: 44
					setLoop: 5
			...
			(20
				(local0 stopUpd:)
				(= local30 1)
				(localproc_0 30 116 25 3) ; "Your dinner, sir. Please enjoy."
				(local0
					view: 44
					loop: 1
					cel: 0
			...
			(24
				...
				(HandsOff)
				(= local38 1)
				(localproc_0 30 117) ; "What kind of turkey are you, leaving without paying?"
				(self cue:)
			)
			(25
				(local0
			...
			(27
				(localproc_0 30 118) ; "Here is the bill, sir"
				(self cue:)
			)
			(28
				(User canInput: 1)
				(if (or local30 local36)
					(if (> global107 local39)
						(localproc_0 30 119) ; "Paying your bill, you thank the waiter for the fine food and service."
						(-= global107 local39)
						(= local38 1)
						(SetScore 2)
					else
						(localproc_0 30 120) ; "Uh-oh! It seems you've spent too much of your ready cash. Even worse than that, you're overextended on your credit cards."
						(localproc_0 30 121) ; "Embarrassed, because you're broke, you ask the waiter if he has any dishes to wash."
					)
				else
					(localproc_0 30 78) ; "Most people wait until they've finished eating."
				)
...
(instance marieScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(localproc_0 30 122 25 3) ; "Hungry, you consume the meal in record time."
				(= seconds 6)
			)
			(3
			...
			(5
				...
				(cond
					((== local44 2)
						(SetScore 2)
						(localproc_0 30 123) ; "WOW! You're some kisser, Sonny!"
					)
					((== local44 3)
						(localproc_0 30 124) ; "I don't know how much more of this I can take, Sonny!"
					)
					((> local44 3)
						(localproc_0 30 125) ; "Marie says, "Listen, Sonny...we'd better go somewhere more private if you're going to keep this up.""
						(self changeState: 7)
					)
				)
				(= seconds 1)
			...
			(6
				...
				(if (== local44 1)
					(SetScore 2)
					(localproc_0 30 126) ; "Oh, by the way," she says..."How do you like my new lipstick? It's called Pink Rapture."
					(localproc_0 30 127) ; "I really like it" she says, "It's my favorite. It's so PINK!"
				)
			)
			(7
				(if (> global107 local39)
...
(instance sonnyScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local22 1)
				(localproc_0 30 128 83) ; "Marie says, "Oh Sonny. I've been so worried for you.""
				(localproc_0 30 129 83) ; "I know that Jessie Bains is looking for revenge. I know he's out to get even, especially with you."
				(localproc_0 30 130 83) ; "I'm scared Sonny! Promise you'll stop in and see me sometime tomorrow. I need to know that you're all right."
			)
			(4
				(cond
					(local27
					...
					(local34
						(localproc_0 30 131) ; "Don't get up. Order your dinner."
					)
					(else
						(localproc_0 30 132) ; "Don't get up yet. You just got here."
					)
				)
			)
			(5
				(localproc_0 30 133 83) ; "Sonny! Where are you going, Sonny? Don't leave me!"
				(= local32 1)
				(User canControl: 1)
			)
			(2
			...
			(3
				(Print 30 134 #at 69 150 #time 5 #draw) ; "Oh, Sonny....you're WONDERFUL!!!"
			)
		)
	)
)
...
(instance day2Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(cond
					((and (== local44 0) (not local27) (not local24))
						(= global126 1)
						(gCurRoom newRoom: 105)
					)
					((and (== local44 0) (not local27) local24)
						(localproc_0 30 135 25 10) ; "Boy!" you think to yourself. "A romantic evening like this sure works up the old appetite."
						(day2Script changeState: 0)
					)
					((and (== local44 0) local27)
						(localproc_0 30 136 25 10) ; "You think to yourself..."What a wonderful time to get romantic, Sonny. Marie looks positively delicious!""
						(day2Script changeState: 0)
					)
					((and (> local44 0) (not local27))
						(localproc_0 30 135 25 10) ; "Boy!" you think to yourself. "A romantic evening like this sure works up the old appetite."
						(day2Script changeState: 0)
					)
					((not local38)
