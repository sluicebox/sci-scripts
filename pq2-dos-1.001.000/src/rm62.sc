		...
		(switch (event type:)
			...
			(evSAID
					...
					(cond
							...
							(cond
								...
								(
									(and
										(not global184)
										(Said
											'look,look,frisk,get,view/body,injury,scanner,neck'
										)
									)
						...
						(
							(and
								global184
								(Said
									'look,look,frisk,view/body,body,luis,injury,scanner,neck'
								)
							)
				...
				(cond
					...
					((Said 'frisk,move,(look,dig<through),(dig<in)/can,garbage')
						(if (gEgo inRect: 248 97 293 121)
							(if
								(and
