		...
		(cond
			((Said 'look,open,use/briefcase')
				(if local1
					...
					(Print 153 1 #at 184 11 #draw #mode 1 #width 110) ; "Your Detective's Field Kit is used to carry various things you will need in the course of your investigations:  Plastic Baggie  Small Camera  Casting Plaster  Glass Vial  Eye Dropper  Fingerprint Powder Fingerprint Brush  Fingerprint Tape"
				)
			)
