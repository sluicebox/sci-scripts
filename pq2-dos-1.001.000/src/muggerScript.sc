				...
				(cond
					...
					((Said 'interrogate,talk/man,mugger,punk,suspect')
						(cond
							...
							(local1
								(localproc_0 77 26) ; "He's off to jail, now. Besides, he wasn't a brilliant conversationalist the first time, anyway."
							)
							((and local0 (not local7))
								...
								(localproc_0 77 27) ; "The mugger looks at you and says..."Listen, Pig, I ain't talking to nobody! You understand that?""
								(= local7 1)
							)
							((and local0 local7)
								(localproc_0 77 28) ; ""Talk's cheap, man!" the mugger says."
							)
							((and local3 (not local0))
								(localproc_0 77 29) ; "It doesn't look like talking is this guy's specialty."
							)
						)
					)
				)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(if (not global236)
					(localproc_0 77 30) ; "You notice that a man is approaching you."
					(gEgo setMotion: 0)
			...
			(2
				(if (not (IsFlag 140))
					(localproc_0 77 31 83) ; "Threatening you, the man says..."Give me all your money, dude, or I'll rip you apart with my bare hands.""
					(SetFlag 140)
				)
				(gEgo setMotion: 0)
				(localproc_1 gEgo local2)
			...
			(3
				(HandsOff)
				(localproc_0 77 32 25 4) ; ""Let's have some fun, pal!" the mugger says."
				(self cue:)
			)
			(4
				(gEgo dispose:)
			...
			(7
				(localproc_0 77 33 83) ; "The mugger seems to have had a little extra adrenaline pumping. He has managed to slap you into a deep coma."
				(self cue:)
			)
			(8
				(EgoDead 77 34) ; "Next time, try to react a little faster. Use your equipment."
			)
			(9
				(User canControl: 1)
				(local2
			...
			(11
				(localproc_0 77 35 83) ; "Evidently, the mugger doesn't like cops."
				(if local5
					(= cycles 10)
				else
					(= local12 0)
			...
			(12
				(localproc_0 77 36 83 25 10) ; "You hear heavy breathing, hacking, and coughing as Keith escorts the would-be mugger back to you."
				(self cue:)
			)
			(13
				(gEgo
			...
			(16
				(User canInput: 1)
				(localproc_0 77 37 83) ; "Breathing heavily, Keith says..."Sonny, I'm getting too old for this kind of stuff.""
				(= cycles 100)
			)
			(17
				(if (not local7)
					(localproc_0 77 38 25 8) ; "Well," Keith says, "if you won't talk to him, I will!"
					(localproc_0 77 39) ; "The mugger says..."Listen, Pig, I ain't talking to nobody! You understand that?""
					(localproc_0 77 40 25 8) ; "Keith pipes up and says..."I'll take our little mugger friend and turn him over to Steelton PD.""
					(self cue:)
				else
					(localproc_0 77 40 25 10) ; "Keith pipes up and says..."I'll take our little mugger friend and turn him over to Steelton PD.""
					(self cue:)
				)
			)
			(18
