	...
	(cond
		((and (!= global169 0) (gEgo inRect: 240 180 287 192))
			(if (>= global169 2)
				...
				(Print 14 73) ; "Opening another car's door without proper cause would be breaking and entering."
			)
		)
	...
	(method (doit)
		(cond
			...
			((and (or (< (gEgo x:) -12) (> (gEgo x:) 332)) (not local0))
				(if (and (gCast contains: global112) (< (global112 x:) 50))
