		...
		(cond
			...
			((or (Said '/cole,willie,jerome,man,cop>') (Said 'hello>'))
				(cond
					...
					((Said 'look')
						(Print 6 15) ; "Willie is working industriously."
					)
					((or (Said 'talk') (Said 'hello'))
						(switch (Random 0 4)
							(0
								(Print 6 16) ; ""Sonny my man." says Detective William 'Willie' Jerome."
							)
							(1
								(Print 6 17) ; ""Ain't no murder suspects in here!" says Willie."
							)
							(2
								(Print 6 18) ; "Detective Jerome says, "What are you looking for?""
							)
							(3
								(Print 6 19) ; ""Homicide's down the hall son !" Jerome says."
							)
							(4
								(Print 6 20) ; "Well!" says Willie, "if it ain't the #1 homicide dick of Lytton."
							)
						)
					)
					((Said 'ask')
						(Print 6 21) ; "I'm sorry Sonny, but I can't help you with that."
					)
					(else
						(event claimed: 0)
					)
		...
		(cond
			...
			((or (Said '/lieutenant,bob,adams,man,cop>') (Said 'hello>'))
				(cond
					...
					((Said 'look')
						(Print 6 24) ; "Lieutenant Adams seems to be pondering what he will do when he retires."
					)
					((or (Said 'talk') (Said 'hello'))
						(switch (Random 0 2)
							(0
								(Print 6 25) ; "Lieutenant Adams tells you, "I could care less about this joint. I'm just sitting here biding my time, and waiting for my pension.""
							)
							(1
								(Print 6 26) ; "I don't know what I'm doing here," says the Lieutenant, "I'd rather sell motor homes in Siberia !"
							)
							(2
								(Print 6 27) ; "The Lieutenant says to you, "Hey Sonny, I'll trade you these lieutenant bars for a one way ticket to Mexico""
							)
						)
					)
					((Said 'ask')
						(Print 6 28) ; "I haven't been working any burglaries that have involved homicides, Sonny."
					)
					(else
						(event claimed: 0)
					)
		...
		(cond
			...
			((or (Said '/holt,woman,cop>') (Said 'hello>'))
				(cond
					...
					((Said 'look')
						(Print 6 33) ; "Laura works eagerly away on her current case."
					)
					((or (Said 'talk') (Said 'hello'))
						(switch (Random 0 2)
							(0
								(Print 6 34) ; "Hi, Sonny." says Laura, "long time no see."
							)
							(1
								(Print 6 35) ; "Detective Laura Gomez comments, "sure is nice to be out of traffic division and into burglary for a change.""
							)
							(2
								(Print 6 36) ; "Laura says, "Have you seen Marie lately? What a sweet girl she turned out to be.""
							)
						)
					)
					((Said 'kiss,pinch,fuck')
						(switch (Random 0 1)
							(0
								(Print 6 37) ; "In an angry tone of voice, Laura says, "Why, you crap house RAT! I oughta slap your eye balls out!""
							)
							(1
								(Print 6 38) ; "Detective Gomez varbally assaults you, "Listen gutter mouth!" she says, "the only reason I don't drop kick-you over this desk right now is because, no doubt, the obvious lack of oxygen to your brain has apparently rendered you a mental defect!""
							)
						)
					)
					((Said 'ask')
						(Print 6 39) ; "I'm sorry, but I can't help you with that."
					)
				)
			)
		)
