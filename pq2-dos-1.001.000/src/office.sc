	...
	(method (handleEvent event)
		...
		(cond
			...
			((Said 'use,dial,pick[<up]/phone')
				(Print 156 12) ; "You don't need to."
				(Print 156 13) ; "Go to your desk in the Homicide office."
			)
			((Said 'answer/phone')
				(Print 156 14) ; "It isn't ringing."
			)
			((Said 'turn/lamp')
				(Print 156 15) ; "You're wasting your time."
			)
			((Said 'climb/desk')
				(Print 156 16) ; "There is no reason to climb the desk"
			)
			((Said 'sat[<on]/bench,desk')
				(Print 156 17) ; "There is a chair and desk especially designated for you, but this ain't it."
			)
			((Said 'open/pane')
				(Print 156 18) ; "The air conditioner works fine."
			)
			((Said 'get/flyer,painting,book,newspaper,garbage,book')
				(Print 156 19) ; "It wouldn't help you."
			)
			((or (Said 'ask,talk') (Said '/hello'))
