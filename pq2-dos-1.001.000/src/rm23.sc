...
(procedure (localproc_2)
	...
	(switch local15
		(0
			...
			(Animate (gCast elements:) 0)
			(Display 23 4 100 20 7 106 300 117) ; "SUMMARY:   After a lengthy investigation, Officer Sonny Bonds successfully infiltrated the illegal gambling operation at the Hotel Delphoria. A confrontation with Bains ended in a shoot-out and his subsequent arrest. Suspect was convicted of first degree murder. Further: testimony provided by Woody Roberts, Marie Wilkans, and Don Colby was instrumental in convicting subject Bains on additional counts of narcotics trafficking and illegal gambling activities.   CONVICTED: 10/25/1983.  INCARCERATED: State Pen.  LOCATION: Wixsom.  SENTENCE: 97 years.  PAROLE DATE: None.  CASE STATUS: Closed END FILE:              (2)"
		)
		(1
			(mugShot2 posn: 0 0)
			(Animate (gCast elements:) 0)
