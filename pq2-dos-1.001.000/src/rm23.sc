...
(procedure (localproc_2)
	...
	(switch local15
		(0
			...
			(Animate (gCast elements:) 0)
			(Display 23 4 dsCOORD 20 7 dsWIDTH 300 117) ; "SUMMARY:   After a lengthy investigation, Officer Sonny Bonds successfully infiltrated the illegal gambling operation at the Hotel Delphoria. A confrontation with Bains ended in a shoot-out and his subsequent arrest. Suspect was convicted of first degree murder. Further: testimony provided by Woody Roberts, Marie Wilkans, and Don Colby was instrumental in convicting subject Bains on additional counts of narcotics trafficking and illegal gambling activities.   CONVICTED: 10/25/1983.  INCARCERATED: State Pen.  LOCATION: Wixsom.  SENTENCE: 97 years.  PAROLE DATE: None.  CASE STATUS: Closed END FILE:              (2)", p_draw
		)
		(1
			(mugShot2 posn: 0 0)
			(Animate (gCast elements:) 0)
				...
				(cond
					(local12
						(cond
							...
							(
								(Said
									'[look,see,read,turn,enter]/end,next,2,(page[<next,2nd])'
								)
								(if local9
									(localproc_2)
								else
							...
							(
								(Said
									'[look,see,read,turn,enter]/back,preceding,1,(page<(preceding,1st))'
								)
								(if local10
									(localproc_1)
								else
							...
							(
								(or
									(Said
										'[turn,enter,look]/(page<next,3rd),(3<page)'
									)
									(Said
										'read,look,see,turn/(page[<3rd]),(3<page)'
									)
								)
					...
					((Said 'talk/woman')
						(localproc_0 23 33) ; "There are no women in here."
					)
					(
						(or
							...
							((>= global100 1)
								(cond
									...
									(local2
										(cond
											(local8
												(localproc_0 23 34) ; "He's in the other room."
											)
											(local5
												(localproc_0 23 35) ; "You want to see the witness? You're looking at him!"
											)
											(else
												(localproc_0 23 28) ; "Walk right up to him, stare him in the eye, and try again."
											)
					...
					(
						...
						(cond
							...
							((>= global100 1)
								(cond
									(local3
										(if local5
											(if (IsFlag 70)
												(localproc_0 23 36) ; "C'mon, man. The dude made himself a knife, held it on the jailer, and pulled off a pretty slick escape. That's it!"
												(= local4 1)
												(= local3 0)
											else
												(SetScore 2 70)
												(witnessTalking play:)
												(localproc_0 23 37) ; "Oh yeah, the escape." he says..."That dude Bains did a number on your little jailer friend."
												(Print 23 38 #at -1 135) ; "Bains jumped your little rookie while being moved. It looked like he was holding some sort of knife to the jailer's throat."
												(Print 23 39 #at -1 135) ; "It looked so easy!" Saxton says, "I mean, he just grabbed the jailer, put a knife to his throat, and sashayed right out of the jail. Unbelievable!"
												(= local4 1)
												(= local3 0)
											)
										else
									...
									((> (gEgo x:) 210)
										(localproc_0 23 40) ; "I didn't see much myself, but we do have a witness to the incident. One of the prisoners was right there when it went down."
									)
									(local4
										(localproc_0 23 41) ; "Hey man!" Saxton says, "I've told you everything I saw."
									)
									(else
										(localproc_0 23 26) ; "The jailer says, "Are you talking to me? I'm over here, Bonds!""
									)
							...
							(else
								(localproc_0 23 42) ; "I'm not aware of anything like that, Bonds."
							)
						)
					)
					((Said '/yes')
						(if (and local2 (not local8))
							(localproc_0 23 43) ; "Ahh, c'mon. You've got to be kidding."
						else
							(localproc_0 23 44) ; "Yes....what?"
						)
					)
					((Said '/no')
						(if (and local2 (not local8))
							(localproc_0 23 45) ; "Yeah. I didn't think so."
						else
							(localproc_0 23 46) ; "No....what?"
						)
					)
					((Said 'open/door')
						(localproc_0 23 47) ; "The only door you're authorized to open is the one leading back into the garage."
					)
					(
						(or
							(Said 'talk/bains')
						...
						(if (< global100 1)
							(localproc_0 23 48) ; "The jailer tells you, "The last person he'd want to see right now is you, Bonds.""
							(Print 23 49 #at -1 135) ; "You'll have your second chance at him in court, Sonny, but for the moment, you'll have to wait. He's not allowed to see anyone, including you."
						else
							(localproc_0 23 50) ; "If you can find him, and you can get close enough to him without getting killed, you might be able to talk to him."
						)
					)
					(
						(or
						...
						(cond
							(local8
								(if (>= global100 1)
									(SetScore 1 110)
									(localproc_0 23 51) ; ""That's easy" he says, "Pate's car is a blue 1986 Corvette with personalized plates that say `WOW.'"
								else
									(localproc_0 23 25) ; "The jailer says, "I don't know what you're trying to talk about, Bonds.""
								)
							)
							(local5
								(if local3
									(localproc_0 23 52) ; "I don't know nothing about any car."
								else
									(localproc_0 23 26) ; "The jailer says, "Are you talking to me? I'm over here, Bonds!""
								)
							)
					...
					((Said 'open,unlock/cell,cage')
						(cond
							(local8
								(localproc_0 23 53) ; "Now you know I can't do that...even for you, Sonny."
							)
							(local3
								(localproc_0 23 54) ; "Yeah," Saxton grumbles, "I sure wish you would!"
							)
							(else
								(localproc_0 23 26) ; "The jailer says, "Are you talking to me? I'm over here, Bonds!""
							)
						...
						(cond
							(local8
								(if (and (not local1) (not local3) (not local4))
									(localproc_0 23 55) ; ""Which prisoner do you wanna talk to?" he says."
									(= local17 50)
								else
									(localproc_0 23 20) ; "He's not here."
								)
							...
							(local2
								(if local5
									(if local4
										...
										(localproc_0 23 56) ; "Hey, I don't know what you want to talk about."
									)
								else
									(localproc_0 23 28) ; "Walk right up to him, stare him in the eye, and try again."
								)
					...
					(
						...
						(cond
							(local8
								(if (>= global100 1)
									(localproc_0 23 58) ; "Yeah, that's right!" the jailer says. " I sure don't know where THAT came from!"
								else
									(localproc_0 23 59) ; "The jailer says: "Huh?""
								)
							)
							(local2
								(if local5
									(localproc_0 23 60) ; "Yeah, that's right!" Saxton chuckles. " I sure wish I knew where THAT came from!"
								else
									(localproc_0 23 28) ; "Walk right up to him, stare him in the eye, and try again."
								)
							)
					...
					(
						...
						(cond
								...
								(cond
									...
									((>= global100 1)
										(if
											...
											(if (> local13 1)
												(localproc_0 23 62) ; "OK, OK..." the jailer exclaims. "If you want to see his file, I'll get it for you."
											else
												(localproc_0 23 63) ; "Oh, yeah!" the jailer says. "Let me get Bains' file for you. I'm sure you'll want to take a look at it."
											)
											(= local15 0)
											(jailerScript changeState: 7)
										else
											(localproc_0 23 64) ; "Hey, Sonny. You gave it back to me and I put it away. Don't make me go get it again."
										)
									)
									((< global100 1)
										(localproc_0 23 48) ; "The jailer tells you, "The last person he'd want to see right now is you, Bonds.""
							...
							(local2
								(if local5
									(localproc_0 23 65) ; "I don't know nothin' about the dude, man. Really!"
								else
									(localproc_0 23 28) ; "Walk right up to him, stare him in the eye, and try again."
								)
							)
					...
					(
						...
						(cond
							(local8
								(cond
									((> local17 0)
										(localproc_0 23 66) ; "Pate? He's not a prisoner! He's the other jailer!"
									)
									((== global100 0)
										(localproc_0 23 67) ; "You mean Luis Pate, the rookie? He's on duty right now, Bonds."
									)
									((>= global100 1)
										(if
											(or
											...
											(if (> local14 1)
												...
												(localproc_0 23 68) ; "Oh, yeah!" the jailer says. "You'll want to look at Pate's file. I'll go get it for you."
											)
											(= local15 1)
											(SetScore 2 117)
											(jailerScript changeState: 7)
							...
							((or local3 local4)
								(if local5
									(localproc_0 23 69) ; "Never heard of anyone by that name, man."
								else
									(localproc_0 23 28) ; "Walk right up to him, stare him in the eye, and try again."
								)
							)
					...
					((Said 'show,flash/badge')
						(cond
							(local8
								(localproc_0 23 70) ; "OK, OK! I know who you are!"
							)
							(local3
								(if local5
									(localproc_0 23 70) ; "OK, OK! I know who you are!"
							...
							(else
								(localproc_0 23 71) ; "Nobody can see your badge."
							)
						)
					)
					(
					...
					((Said '[see,talk]/*')
						(if (> local17 0)
							(localproc_0 23 72) ; "We don't have a prisoner here by that name."
						else
							(event claimed: 0)
						)
					)
					(
						...
						(if local8
							(if (== ((gInventory at: 0) owner:) 23) ; hand_gun
								...
								(localproc_0 23 73) ; "What're you talking about?" says the jailer. "I don't have your gun. I sure hope YOU know where it is!"
							)
						else
							(localproc_0 23 26) ; "The jailer says, "Are you talking to me? I'm over here, Bonds!""
						)
					...
					(
						...
						(if local8
							(if (== ((gInventory at: 10) owner:) 23) ; field_kit
								(localproc_0 23 74) ; "You retrieve your kit."
								(gEgo get: 10) ; field_kit
								(jailerScript changeState: 12)
							else
								(localproc_0 23 75) ; "What are you talking about? I don't have your field kit, Bonds."
							)
						)
					)
					(
						...
						(localproc_0 23 76) ; "You don't have it."
					)
				)
			)
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(= local3 1)
				(if (IsFlag 70)
					(localproc_0 23 77 83) ; "You're sure keeping me busy, man. I don't know what else I can tell you."
				else
					(localproc_0 23 78 83) ; ""You here to get me out of this joint?" Saxton asks."
				)
			)
			(6
				(= local4 0)
...
(instance jailerScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (== global100 1)
					(Print 23 79 #at -1 135 #draw) ; "Obviously excited, the jailer says..."Bonds! I can't believe what's happened. I can't get over it! We've never had an officer kidnapped before.""
					(Print 23 80 #at -1 135 #draw) ; "Continuing..."Bains took Pate and escaped in Pate's car. I sure hope he's OK. Poor kid...he's just a rookie, you know.""
					(Print 23 81 #at -1 135 #draw) ; ""Heck, we just put together the file on Bains this morning, and he's gone already."
					(= local7 1)
					(= global138 0)
					(if (gEgo has: 0) ; hand_gun
						(localproc_0 23 82 83) ; "What a day THIS has been!....Hey, wait just a minute there, Bonds!"
					)
					(self cue:)
				else
					(self cue:)
			...
			(2
				(User canInput: 1)
				(if (gEgo has: 0) ; hand_gun
					(localproc_0 23 83 83) ; "The jailer walks up to you and says, "The bulge under your jacket here...that looks like a gun to me!""
					(localproc_0 23 84 83) ; "C'mon, Bonds!" the jailer demands. "You forgot to put it in the locker outside, didn't you? Stick to the regulations, Sonny!"
					(localproc_0 23 85 83) ; "The jailer relieves you of your Colt automatic and says..."
					(localproc_0 23 86 83) ; "Just contribute five bucks to our coffee fund on your way out, and you can have this back."
			...
			(3
				(if (gEgo has: 10) ; field_kit
					(Print 23 87 #at -1 135) ; "While I'm at it," the jailer continues, " give me your field kit to put behind the counter. You're not supposed to bring it in here, you know."
					(localproc_0 23 88) ; "You hand your field kit to the jailer."
					(gEgo put: 10 23) ; field_kit
				)
				(if (== ((gInventory at: 0) owner:) 23) ; hand_gun
					(localproc_0 23 89) ; "Now that THAT little piece of business is out of the way...."
				)
				(cond
					((>= global100 2)
						(Print 23 90 #at -1 135 #draw) ; "I hate to be rude, Bonds" he says, "but I'm really busy. Unless you have important business, just show yourself out."
						(= local7 1)
					)
					((< global100 1)
						(localproc_0 23 91 83) ; ""What can I do for you, Bonds?" the jailer asks."
						(= local7 1)
					)
				)
			)
			...
			(9
				(localproc_0 23 92 83) ; "Here you go, Bonds. The files have to stay here, so give 'em back before you leave."
				(if (== local15 0)
					(localproc_0 23 93 83) ; "The jailer hands you the file on Jessie Bains."
				else
					(localproc_0 23 94 83) ; "The jailer hands you the file on Luis Pate."
				)
				(= local12 1)
				(SetMenu 513 112 0)
			...
			(10
				(HandsOff)
				(localproc_0 23 95) ; "Having reviewed the file, you return it."
				(localproc_0 23 96) ; "The jailer puts the file away."
				(jailer setLoop: 0 setMotion: MoveTo 275 129 startUpd:)
				(= local16 20)
			)
			(11
			...
			(13
				(HandsOff)
				(localproc_0 23 97) ; "OK, Sonny" says the jailer. "Here's your weapon. Don't forget the five bucks for the coffee fund!"
				(localproc_0 23 98) ; "You donate the $5.00 to the coffee fund."
				(if (> global107 5)
					(-= global107 5)
				)
				(if (== ((gInventory at: 10) owner:) 23) ; field_kit
