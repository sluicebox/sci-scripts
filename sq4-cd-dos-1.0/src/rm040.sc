...
(instance theTank of Sq4Feature
	(properties
		...
		y 110
		sightAngle 45
		lookStr 1 ; "The structural warpage, and the enormous gaping hole indicate a violent end for this corroding battle machine."
	)
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(6 ; Smell
				(gNarrator say: 2) ; "It smells exactly like the hull of a useless, burnt out battle vehicle."
			)
			(7 ; Taste
				(gNarrator say: 3) ; "It needs salt."
			)
			(else
...
(instance bombScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gNarrator say: 4) ; "A very wise choice! Carefully placing the unstable ordnance back inside the tank, you decide some things are better left alone."
				(HandsOn)
				(client setScript: 0)
			)
		)
...
(instance theSupport of Sq4Feature
	(properties
		...
		y 154
		sightAngle 45
		lookStr 5 ; "The huge building supports miraculously still stand."
	)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator say: 5) ; "The huge building supports miraculously still stand."
			)
			(6 ; Smell
				(gNarrator say: 6) ; "You inhale the smell of the column and file it away in your brain under "Useful Information.""
			)
			(7 ; Taste
				(gNarrator say: 7) ; "Good thing it's not below freezing, or you'd end up spending the whole game with your tongue stuck to the frozen metal."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance thePurpleBldg of Sq4Feature
	(properties
		...
		sightAngle 45
		onMeCheck 8192
		lookStr 8 ; "A battered and boarded purple building stands silently now."
	)
)
...
(instance theLeftBldg of Sq4Feature
	(properties
		...
		y 123
		sightAngle 45
		lookStr 9 ; "Another of Xenon's ruined structures awaits the the final, slow assault of nature."
	)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(gNarrator say: 10) ; "The building is inaccessible."
			)
			(6 ; Smell
				(gNarrator say: 11) ; "It smells like hundreds of sweaty public servants once populated this building."
			)
			(7 ; Taste
				(gNarrator say: 12) ; "It tastes about like you'd expect it to taste, given how it smells."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance street1 of Sq4Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(1 ; Look
				(gNarrator say: 13) ; "It's a safe bet that tank had something to do with the end of traffic on this thoroughfare."
			)
			(6 ; Smell
				(gNarrator say: 14) ; "The pavement has lost that wonderful wet-tar smell you loved so much as a kid."
			)
			(7 ; Taste
				(gNarrator say: 15) ; "Okay, you scrape some taste buds off onto the street."
			)
			(9 ; rope
...
(instance sidewalk1 of Sq4Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(1 ; Look
				(gNarrator say: 16) ; "One thing THIS society can say is that no citizen lives on the streets. In fact, nothing seems to live anywhere. This place is definitely DOA."
			)
			(6 ; Smell
				(gNarrator say: 17) ; "The smell of devastation is everywhere."
			)
			(7 ; Taste
				(gNarrator say: 18) ; "The taste of devastation is everywhere."
			)
			(9 ; rope
				((ScriptID 705 4) doVerb: theVerb invItem) ; theRoom
			)
...
(instance theArea of Sq4Feature
	(properties
		nsBottom 200
		nsRight 320
		lookStr 19 ; "You are at the left edge of this area. More debris chokes off the west."
	)
...
(instance closeup of Sq4View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(if (== ((gInventory at: 2) owner:) 40) ; bomb
					(gNarrator say: 20) ; "This is the interior of a battle-scarred tank. A piece of unstable ordnance rests in the corner."
				else
					(gNarrator say: 21) ; "This is the interior of a battle-scarred tank."
				)
			)
			(10 ; bomb
				(theTank doVerb: theVerb)
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theBomb of Sq4Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator say: 22) ; "Surprisingly, no one has taken this small, innocuous-looking piece of unstable ordnance."
			)
			(4 ; Do
				(theBomb dispose:)
				(gEgo get: 2) ; bomb
				...
				(gNarrator say: 23) ; "Okay. You now have the unstable ordnance. Remember, it was your idea. Good luck."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theHole of Sq4Feature
	...
	(method (doVerb theVerb invItem)
		(cond
			((or (== theVerb 1) (== theVerb 4)) ; Look, Do
...
(instance cop1 of Sq4Actor
	(properties
		...
		view 7
		loop 2
		lookStr 24 ; "Oh No! Sequel Police!"
	)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator say: 24) ; "Oh No! Sequel Police!"
			)
			(else
