...
(instance theRoom of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(1 ; Look
				(gNarrator say: 1) ; "All around you stretch the stony outcroppings of the Estros buttes. A slender spire of angry red rock arches its way upward, poking searchingly into the sky and plunging down into the beautiful canyons of Estros. What lovely scenery!"
			)
			(else
				(super doVerb:)
			)
