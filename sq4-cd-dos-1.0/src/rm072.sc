...
(instance manholeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(20
				(gNarrator say: 1) ; "The manhole cover is getting heavy!"
				(manhole
					yStep: 2
			...
			(22
				(HandsOff)
				(gNarrator say: 2) ; "You slide down the slimy ladder as the manhole cover slams back into place."
...
(instance xenonLanding of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(15
				(sp3 moveSpeed: 1 setMotion: JumpTo local0 (- local1 4) sp3)
				(= cycles 12)
			)
			(16
				(sp4 moveSpeed: 1 setMotion: JumpTo local0 (- local1 4) sp4)
				(= cycles 12)
			)
			(17
				(gLongSong fade: self)
...
(instance manholeFeature of Sq4Feature
	(properties
		...
		nsRight 320
		onMeCheck 2
		lookStr 3 ; "The manhole cover is simply an incredibly heavy slab of metal trying to tamp you back into the tube."
	)
...
(instance ship of Sq4Actor
	(properties
		...
		signal 26640
		xStep 1
		lookStr 4 ; "A sleek patrol transport occupies the area presently."
	)
		...
		(switch theVerb
			(4 ; Do
				(if (== (gCurRoom script:) xenonLanding)
					...
					(gNarrator say: 5) ; "If you can do anything with the ship you certainly can't do it from here."
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance theGreenBldg of Sq4Feature
	(properties
		...
		nsRight 320
		onMeCheck 16
		lookStr 6 ; "There's that green building again."
	)
)
...
(instance theWhiteBldg of Sq4Feature
	(properties
		...
		nsRight 320
		onMeCheck 32
		lookStr 7 ; "That white building sits over yonder. You start to become properly oriented regarding your position."
	)
)
...
(instance theManhole of Sq4Feature
	(properties
		...
		nsRight 320
		onMeCheck 64
		lookStr 8 ; "The dank and slimy conduit calls to you."
	)
...
(instance rogersHead of Sq4Feature
	(properties
		...
		sightAngle 45
		onMeCheck 4
		lookStr 9 ; "Your head is unusually well suited to serve as a manhole cover coaster."
	)

	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(gNarrator say: 10) ; "The only thing you can do to avoid flattening your head any further is get in or get out."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theRoom of Sq4Feature
	(properties
		...
		nsRight 319
		sightAngle 180
		lookStr 11 ; "You have a low-level view of the street from your manhole perch."
	)
