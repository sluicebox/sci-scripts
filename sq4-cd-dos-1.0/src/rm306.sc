...
(instance theRoom of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(1 ; Look
				(gNarrator say: 1) ; "You're surrounded by spires of sand and rock. The ravages of wind, water and time have exposed strata in the butte which serve as steps to other areas.  Far below, the waters of Estros beckon to you."
			)
			(else
				(super doVerb:)
			)
