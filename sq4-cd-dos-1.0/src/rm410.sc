			...
			((StepOn gEgo 2)
				...
				(cond
					((OneOf (gEgo view:) 373 374)
						...
						(gNarrator modNum: 405 say: 1) ; "Real ladies don't go Zero-G swimming in a dress!"
						(HandsOn)
					)
...
(instance skater1 of Sq4Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 405 say: 2) ; "The Zero-G skaters look to be having fun. But don't get in their way. They enjoy playing "Spin the Dweeb" with anyone who wanders into their airspace."
			)
			(else
...
(instance enterAndShootEgo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(EgoDead 8 12) ; "Zero-G skating might be perfect for you, since you've got a Zero-IQ."
			)
			(9
				(= cycles 20)
			)
...
(instance skateorama of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 405 say: 3) ; "It's the Zero-G Skate-O-Rama. Here the gravity generators have no effect, providing an ideal and unique entertainment opportunity for the entire family."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance light of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 405 say: 4) ; "The Skate-O-Rama is illuminated by a nearby sun. This way, you can enjoy Zero-G skating while tuning up your tan."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance steps of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 405 say: 5) ; "These steps lead up to the rest of the Galaxy Galleria Mall."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance wall of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 405 say: 6) ; "The walls protect shoppers from wayward skaters."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance restOfMall of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 405 say: 7) ; "The rest of the Galaxy Galleria awaits the unwary and poorly-informed shopper."
			)
			(else
				(super doVerb: theVerb &rest)
			)
