...
(instance theLadder of Sq4Feature
	(properties
		...
		nsRight 100
		sightAngle 45
		lookStr 1 ; "A sturdy metal ladder is attached to the wall here. At the top of the ladder there appears to be something resembling the underside of a manhole cover."
	)
		...
		(switch (= state newState)
			...
			(1
				...
				(if
					...
					((ScriptID 702 2) moveSpeed: (- gGameSpeed 2)) ; theSlime
				)
				(NormalEgo)
				(HandsOn)
				(self dispose:)
