...
(instance policePod of Sq4View
	(properties
		...
		priority 5
		signal 16400
		lookStr 1 ; "It looks like you've got company Roger. Must be those armed tough guys you met on Magmetheus. Be careful!"
	)

	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator say: 1) ; "It looks like you've got company Roger. Must be those armed tough guys you met on Magmetheus. Be careful!"
			)
			(4 ; Do
				(gNarrator say: 2) ; "You can't do that."
			)
			(else
...
(instance shadowScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(tROGER say: 1 self 0 64 5 160) ; "Whoaahhh! What was that?"
				(if (IsObject policePod)
					(policePod setPri: 5)
				)
				(gEgo setPri: 8)
...
(instance theStairs of Sq4Feature
	(properties
		...
		nsRight 320
		onMeCheck 16384
		lookStr 3 ; "Sedimentary layers of rock form a stairway which winds its way down below."
	)

	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator say: 3) ; "Sedimentary layers of rock form a stairway which winds its way down below."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theRoom of Sq4Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(1 ; Look
				(gNarrator modNum: 310 say: 3) ; "As you look around at the towering rocks, immense formations carved over millions of years, you can't help but be overwhelmed by a sense of your own insignificance."
			)
			(else
				(super doVerb: &rest)
			)
