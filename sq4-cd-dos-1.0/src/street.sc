...
(instance deathDroid of Sq4Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 701 say: 1) ; "Droid-O-Death"
			)
			(else
...
(instance cyborg of Sq4Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(gNarrator modNum: 701 say: 2) ; "This is the only form of actual life that you've seen here! Its clothes are tattered and a grotesque metal contraption is clamped to its head which serves to hold the eyelids permanently open."
			)
			(2 ; Talk
				(gNarrator modNum: 701 say: 3) ; "He seems to be unaware of your existence, as though he is controlled by some other consciousness."
			)
			(6 ; Smell
				(gNarrator modNum: 701 say: 4) ; "Being downwind of the cyborg you are very aware that it smells like a slice of luncheon meat that's been walking around in the sun too long."
			)
			(7 ; Taste
				(gNarrator modNum: 701 say: 5) ; "Not with your tongue!"
			)
			(else
