...
(procedure (localproc_0 param1 param2 param3 param4 &tmp temp0 temp1 temp2)
	...
	(Graph grDRAW_LINE param1 param2 param3 param4 (proc0_18 global133 global143) -1 -1)
...
(instance startScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(tROGER ; "Hey! I wanna know what the..."
					init: 0 0 egoMouth
			...
			(6
				(tTIMERIPPER ; "Listen! I can't explain it all to you now! They've got a bead on our coordinates! We've got to move fast!"
					init: 0 0 trMouth
