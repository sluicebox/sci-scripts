...
(instance makeRain of Script
	...
	(method (changeState newState &tmp temp0 [temp1 50])
		(switch (= state newState)
			...
			(6
				(gMessager say: 1 0 9 1 self) ; "Fire in the cage!"
			)
			(7
			...
			(24
				(inEgo view: 582 setLoop: 5 cycleSpeed: 5 setCycle: End self)
			)
			(25
				(inEgo setCycle: End self)
			)
			...
			(51
				...
				(fire posn: 167 137 setLoop: 2)
				(gEgo reset: 1 setScale: Scaler 100 70 190 112 posn: 131 135)
				(headDruid posn: (headDruid x:) (headDruid y:) 0)
				(druid posn: (druid x:) (druid y:) 0)
				(druid2 posn: (druid2 x:) (druid2 y:) 0)
				(fire posn: (fire x:) (fire y:) 0)
				(gEgo posn: (gEgo x:) (gEgo y:) 0)
				(cage posn: (cage x:) (cage y:) 0)
				(= cycles 2)
			)
			(52
				(druidConv
