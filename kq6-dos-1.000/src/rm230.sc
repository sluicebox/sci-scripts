		...
		(switch (= state newState)
			...
			(3
				(Print
					posn: -1 10
					font: gUserFont
					addText: 1 0 13 2 ; "(DRAMATIC, AUTHORITATIVE)Magic paint, black as ink! Bring to life what I think! Make it real, what I draw! According to this spoken law!"
					modeless: 1
					ticks: 20
					init:
				)
		...
		(cond
			...
			((== theVerb 28) ; spellBook
				(if (IsFlag 24)
					...
					(Print addText: 6 28 10 1 init:) ; "Alexander opens the spell book."
