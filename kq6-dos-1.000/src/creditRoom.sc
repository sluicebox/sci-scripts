...
(local
	[local0 50]
	[local50 200]
	[local250 25] = [1 1 1 2 3 4 1 2 3 4 4 1 3 4 1 3 3 4 1 2 3 4 1 2 -1]
	[local275 25] = [98 100 380 240 150 480 650 520 450 580 160 490 730 690 790 770 260 750 220 470 410 510 210 290 -1]
	local300
	local301 = 1
	local302
	local303
...
(instance creditsScript of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(DrawPic [local275 local300] 9)
				(if (== [local275 local300] 98)
					(= cycles 2)
				else
					(setUpRoom doit: self)
				)
			...
			(1
				(if (and (== [local275 local300] 98) local304)
					(= local304 0)
			...
			(3
				(if local302
					(Message msgGET 94 1 0 0 local301 @local0)
					(Message msgGET 94 1 0 0 (++ local301) @local50)
				else
					(Message msgGET 94 0 0 0 local301 @local0)
					(Message msgGET 94 0 0 0 (++ local301) @local50)
				)
				(if (>= (++ local301) 32)
					(= local302 1)
					(= local301 1)
				)
				(switch [local250 local300]
					(1
