	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(31
				...
				(gGlobalSound number: 744 setLoop: -1 play:)
			)
			(32
			...
			(38
				((ScriptID 740 7) ; roomConv
					add: 743 1 0 8 1 ; "Why, I'm honored.... What do you think, Cassima?"
					add: 743 1 0 8 2 ; "!!!Removed this msg "What is it that you wish, Cassima?""
					add: 743 1 0 8 3 ; "I love my homeland, Alexander. I would be happy to stay and to serve it all my days."
					init: self
				)
			)
			(39
