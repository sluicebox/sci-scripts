	...
	(method (changeState newState &tmp destX destY)
		...
		(switch (= state newState)
			...
			(9
				...
				(= seconds (PrintLarry))
				(gEgo loop: 2)
				(Display 480 22 dsCOORD 0 180 dsCOLOR 4 dsFONT gUserFont) ; "F8 will bypass this scene."
			)
			(10
				(gEgo
					posn: 176 92
			...
			(45
				...
				(Printf 480 46 gExpletive) ; "%s" you reply, "I knew there was something I was supposed to do! I'll be right back!! Don't move!"
			)
			(46
