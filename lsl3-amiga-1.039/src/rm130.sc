...
(instance RoomScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Print 130 0 #at 10 5 #width 290 #time 12) ; "Since we last saw our intrepid hero Larry Laffer cavorting merrily with his newly-found true love on the sands of Nontoonyt Beach, this beautiful island has undergone extensive "improvements.""
				(= seconds 3)
			)
			(2
				(Print 130 1 #at 10 5 #width 290 #time 16) ; "Once pristine and primitive, covered by virgin rain forest, splashed by gurgling streams and washed by tropical rains, Nontoonyt has discovered (and been discovered by) modern civilization."
				(= seconds 3)
			)
			(3
				(Print 130 2 #at 10 5 #width 290 #time 22) ; "The villagers, eager to shed their Stone Age lifestyle, united themselves by forming "Natives, Inc.\05" to protect their interests and develop their island. Realizing they were sitting on a yuppie dream, a vein of gold they could mine through tourism, they took correspondence courses in business management, public administration, sales and marketing."
				(= seconds 3)
			)
			(4
				(Print 130 3 #at -1 120 #width 280 #dispose #time 9) ; "Learning modern construction techniques through self-help books and pirated videotapes of "This Old House," they began by building a hotel on this very same beach."
				(= seconds 7)
			)
			(5
				(= pixelsPerFloor 16)
			...
			(19
				(BuildHouse)
				(AddBuildingToPic)
				(Print 130 5 #at -1 120 #width 280 #dispose #time 9) ; "...but growth really exploded when they discovered the Holy Grail of modern marketing: the wonder of time-share!"
				(= cycles 15)
			)
			(20
				(BuildHouse)
			...
			(28
				(BuildHouse)
				(AddBuildingToPic)
				(Print 130 6 #at -1 120 #width 280 #dispose #time 9) ; "Ah, civilization! Who would want real palm trees when you never have to prune or water those new plastic models?"
				(= cycles 15)
			)
			(29
				(= pixelsPerFloor 0)
			...
			(35
				(Print 130 7 #at -1 120 #width 280 #time 12 #dispose) ; "Welcome to the paradise of the Pacific: the all-new, all-improved, totally-yuppiefied, "consumer-orientationalized" Nontoonyt Island!"
				(= cycles 15)
			)
			(36
				(gMusic fade:)
