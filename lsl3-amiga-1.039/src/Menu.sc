	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3 [temp4 220])
		(switch (= temp0 (super handleEvent: event))
			(257
				...
				(Print
					(Format @temp4 997 1 gVersion) ; "Sierra's Creative Interpreter by Jeff Stephenson, Bob Heitman, Pablo Ghenis, and Stuart Goldstein Music Composed and Performed by Mike Dana Sound Effects by Rob Atesalp Atari ST Translation by Corey Cole Amiga Translation by Robert Lindsley Quality Assurance led by Robin Bradley Version %s January 27, 1990"
					#font
					gSmallFont
					#mode
					1
