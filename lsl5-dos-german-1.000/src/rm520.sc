...
(procedure (Restore)
	(Display 520 13 dsRESTOREPIXELS dispSave1)
	(Display 520 13 dsRESTOREPIXELS dispSave2)
)
		...
		(switch (= state newState)
			(0
				(if (and (> ((Inv at: 14) state:) 1) (== gPrevRoomNum 525)) ; Membership_Tape
					(Say gEgo 520 11) ; "Hey! Come on! Gimme back my tape!"
					(TPrint 520 12) ; "That stupid machine ate your tape! You hope you won't need it again, Larry."
