...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(18
				(Say You_GDu_a 150 6 108 139 self) ; ""Why, my name is Larry; Larry Laffer," you reply."
			)
			(19
				(= ticks 123)
			)
			...
			(24
				(Say You_GDu_a 150 9 108 139 self) ; "Yes, I know," you offer proudly, "I'm the Chief Tape Rewinder and Sterilizer on this project!"
			)
			(25
				(= ticks 30)
			)
			...
			(34
				(Say You_GDu_a 150 15 108 139 self) ; "What? Audition three women? No problem, boss, I'm your guy!"
			)
			(35
				(= ticks 30)
			)
			...
			(41
				(Say You_GDu_a 150 19 108 139 self) ; "Wow, Mr. Scruemall," you say, unable to contain your excitement, "I can always use another pocket protector. Mine's getting really vintage!"
			)
			(42
				(= seconds 3)
			)
			...
			(45
				(You_GDu_a talkWidth: 160)
				(Say You_GDu_a 150 21 108 139 self) ; ""I knew that," you pretend."
			)
			(46
				(= seconds 3)
			)
			...
			(49
				(larryCam dispose:)
				(You_GDu_a talkWidth: 240)
				(Say You_GDu_a 150 23 108 139 self) ; ""I can handle it, Sir," you say excitedly."
			)
			(50
				(= seconds 3)
			)
			...
			(53
				...
				(You_GDu_a talkWidth: 240)
				(Say You_GDu_a 150 26 108 139 self) ; "I promise to give it everything I've got!"
			)
			(54
				(= ticks 123)
			)
