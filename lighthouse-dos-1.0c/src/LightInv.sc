...
(instance pbScrollerUp of PanelButton
	...
	(method (doVerb)
		(gGame panelObj: plane panelSelector: 578)
	)
)
...
(instance pbScrollerDown of PanelButton
	...
	(method (doVerb)
		(gGame panelObj: plane panelSelector: 575)
	)
)
...
(instance brightSlider of TrackingProp
	...
	(method (setCel param1)
		(PrintDebug {gBrightness = %d} global255)
...
(instance langButton of PanelProp ; UNUSED
	(properties
		x 315
		y 35
		view 1204
		...
		(switch theVerb
			(5 ; Do
				(if (and (>= (invInsetItem cel:) 6) (<= (invInsetItem cel:) 10))
					...
					(UpdateScreenItem invInsetItem)
					(invSound loop: 1 number: 11003 play:)
