...
(class EditablePolygon of Polygon
	...
	(method (dragPoint param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13)
		...
		(= temp9 0)
		(= temp10 (local0 plane:))
		(temp10 priority: (+ (GetHighPlanePri) 1))
...
(class PEditor of Set
	...
	(method (init)
		...
		((= local2 (DText new:))
			...
			setSize: 240
			setPri: 1000
			init: ((global107 casts:) at: 0)
		)
		(super init: &rest)
		(global107 priority: (+ (GetHighPlanePri) 1))
		(= plane global107)
		(= local0 self)
		(= finished 0)
	)
	...
	(method (dropAnchor param1 param2 &tmp temp0 temp1)
		(= temp1
			(AddLine plane param1 param2 param1 param2 1000 editColor 0 0 1)
		)
		(FrameOut)
		(= currentX param1)
		(= currentY param2)
	...
	(method (constructPolygon param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7)
		...
		(if scratch
			...
			(FrameOut)
			(currentPolygon name: (temp5 data:) type: 0)
			(temp6 dispose:)
		)
