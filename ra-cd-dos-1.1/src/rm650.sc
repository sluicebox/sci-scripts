...
(instance rm650 of LBRoom
	...
	(method (init)
		...
		(intercom init:)
		(shelf1 init: setOnMeCheck: 1 64 approachVerbs: 1 4) ; Look, Do
		(shelf2 init: setOnMeCheck: 1 128 approachVerbs: 1 4) ; Look, Do
		...
		(shelf7 init: setOnMeCheck: 1 512 approachVerbs: 1 4) ; Look, Do
		(shelf8 init: setOnMeCheck: 1 256 approachVerbs: 1 4) ; Look, Do
		(weapons1 init:)
		(weapons2 init:)
		(weapons3 init:)
		(weapons4 init:)
		...
		(southExit init:)
		(eastExit init:)
		(if (and (Random 0 1) (== gAct 4) (gEgo has: 16)) ; cheese
...
(instance sGetCheese of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(gEgo normalize: 831 setScale: Scaler 140 0 190 -30 loop: 1)
				(gGame handsOn:)
				(self dispose:)
			)
		)
...
(instance talkActions of Actions
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Talk
				(gMessager say: 3 0 88 1 0 1889) ; "ACHTUNG! Zis ist NOT ze public part of ze museum! Zis area is VERBOTEN to you and all of your kind! Leave now, before you force me to SHOOT you!"
				1
			)
			(else
				(return 0)
