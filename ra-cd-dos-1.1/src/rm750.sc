...
(procedure (localproc_0)
	(= local1
		(Print
			font: 69
			addText: 5 0 0 1 (Localize 0 0 42 0 0) 0 ; "Pick a Person"
			...
			addButton: 9 4 0 0 9 0 102 ; "Detective Ryan Hanrahan O'Riley"
...
(procedure (localproc_1)
	(= local2
		(Print
			addText: 5 0 0 2 (Localize 0 0 67 0 0) 0 ; "Match a Motive"
			addButton: 1 6 0 0 1 0 17 ; "Self defense"
			addButton: 2 6 0 0 2 (Localize 128 80 128 80 96) 17 ; "Fear"
			addButton: 3 6 0 0 3 0 34 ; "Jealousy"
			addButton: 4 6 0 0 4 (Localize 80 80 128 80 80) 34 ; "Mercy"
			addButton: 5 6 0 0 5 0 51 ; "Thrill"
			addButton: 6 6 0 0 6 (Localize 80 80 128 80 80) 51 ; "Revenge"
			...
			addButton: 10 6 0 0 10 (Localize 0 0 8 0 0) 119 ; "Cover another crime"
			addButton: 11 6 0 0 11 0 136 ; "To protect a loved one"
			addButton: 12 6 0 0 12 0 153 ; "Accident"
			addButton: 13 6 0 0 13 (Localize 48 48 64 48 80) 153 ; "Had a bad day"
			init:
		)
	)
)
	...
	(method (changeState newState &tmp [temp0 100])
		(switch (= state newState)
			...
			(4
				(cond
					((== global126 1)
						(gGameMusic2 number: 750 flags: 1 loop: 1 play:) ; sCrowdCheer
						(reporterHeads setCycle: End self)
					)
					((or (== global126 2) (== global126 4))
						(gGameMusic2 number: 751 flags: 1 loop: 1 play:) ; sCrowdSmallClaps
						(reporterHeads setCycle: End self)
					)
					(else
						(gGameMusic2 number: 752 flags: 1 loop: 1 play:) ; sCrowdMutter
						(= seconds 4)
					)
				)
			)
