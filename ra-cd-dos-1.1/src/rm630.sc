	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(sFX number: 631 flags: 1 play:) ; sRefridgerator
			)
			(2
				(fridgeDoor stopUpd:)
...
(instance sCloseFridge of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(sFX number: 632 flags: 1 play:) ; sRefridgerator
				(fridgeDoor stopUpd:)
				(ClearFlag 14)
				(gEgo loop: 1 normalize: 827 xStep: 4)
				(gGame handsOn:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(sFX number: 633 flags: 1 play:) ; sTrunkOpen
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(sFX number: 634 flags: 1 play:) ; sTrunkClose
			)
			(3
				(gEgo setCycle: Beg self)
			)
		...
		(switch (= state newState)
			(0
				(if (IsFlag 87)
					...
					(sFX number: 85 loop: 1 flags: 1 play:) ; Oh
					(SetFlag 87)
				)
			)
			(1
