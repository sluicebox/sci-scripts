...
(instance rm610 of LBRoom
	...
	(method (init)
		...
		(sink approachVerbs: 25 8 init: setOnMeCheck: 1 2) ; snakeOil, magnifier
		(desk approachVerbs: 25 8 init: setOnMeCheck: 1 4) ; snakeOil, magnifier
...
(instance sDumpIt of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gEgo normalize: 831 loop: 0 setScale: Scaler 123 0 190 88)
				(= cycles 1)
			)
			(4
