...
(instance dInvD of Dialog
	...
	(method (doit &tmp temp0)
		...
		(repeat
			...
			(gEgo get: -1 (Inv indexOf: (temp0 value:)))
		)
...
(instance showFeatureCode of Code
	...
	(method (doit param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11)
		...
		(Graph grDRAW_LINE (+ temp4 1) temp5 (+ temp4 1) temp6 global162)
		...
		(if (or (!= temp0 lastX) (!= temp1 lastY))
			...
			(= unders
				(Display
					...
					[global151 color]
					dsBACKGROUND
					(if color global151 else global157)
					dsFONT
					font
					dsSAVEPIXELS
				)
