	...
	(method (init)
		...
		(self
			add:
				...
				(iconMode theObj: gGame selector: #doit yourself:)
				iconHelp
...
(instance gcWin of SysWindow
	...
	(method (open &tmp temp0 [temp1 4] temp5 [temp6 20])
		...
		(DrawCel
			...
			0
			6
			(Localize 155 155 178 155 155)
			(Localize 42 45 45 45 45)
			temp5 ; UNINIT
		)
		(DrawCel 995 1 1 56 39 temp5) ; UNINIT
		(DrawCel 995 14 0 138 139 temp5) ; UNINIT
		(DrawCel 995 13 (== gMsgType 2) 208 145 temp5) ; UNINIT
		(DrawCel 995 1 0 146 73 temp5) ; UNINIT
		(DrawCel 995 1 0 186 73 temp5) ; UNINIT
		(DrawCel 995 1 0 226 73 temp5) ; UNINIT
		(DrawCel 995 0 4 116 (Localize 58 60 59 60 60) temp5) ; UNINIT
		(DrawCel
			995
			0
			3
			(Localize 145 154 154 154 154)
			(Localize 134 60 59 60 60)
			temp5 ; UNINIT
		)
		(DrawCel
			995
			0
			2
			(Localize 178 198 193 198 198)
			(Localize 58 60 59 60 60)
			temp5 ; UNINIT
		)
		(DrawCel 995 0 5 238 (Localize 134 60 59 60 60) temp5) ; UNINIT
...
(instance iconMode of ControlIcon
	...
	(method (doit &tmp temp0)
		(if 1
			...
			(Print font: gUserFont addText: {*** You're not playing a cd!} init:)
		)
		(self show:)
	)
)
