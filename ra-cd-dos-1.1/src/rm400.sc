...
(instance rm400 of LBRoom
	...
	(method (init &tmp [temp0 30])
		...
		(cashRegister setOnMeCheck: 1 16384 init: approachVerbs: 4) ; Do
		(middleShelves init:)
		(secondShelf init: approachVerbs: 4 1) ; Do, Look
		(glassCounter setOnMeCheck: 1 8192 init:)
		(fakeDaggers setOnMeCheck: 1 4096 init: approachVerbs: 4 1 8) ; Do, Look, magnifier
		(footedPot init: approachVerbs: 4 1 8) ; Do, Look, magnifier
		(largePicture setOnMeCheck: 1 2048 init: approachVerbs: 1) ; Look
		(littleThings setOnMeCheck: 1 1024 init: approachVerbs: 1) ; Look
		...
		(purplePots setOnMeCheck: 1 256 init: approachVerbs: 1) ; Look
		(rug setOnMeCheck: 1 128 init:)
		(rightShelves setOnMeCheck: 1 64 init: approachVerbs: 4 1) ; Do, Look
