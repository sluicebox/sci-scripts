...
(instance rm720 of LBRoom
	...
	(method (init &tmp temp0)
		...
		(if (not (gEgo has: 12)) ; workBoot
			(boot init: approachVerbs: 4 1 8) ; Do, Look, magnifier
		)
...
(instance sGunShots of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(sFX number: 52 loop: 1 flags: 1 play: self) ; sGunShot
			)
			(1
				(= ticks 30)
			)
...
(instance sO_RileyEnters of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(sFX number: 52 loop: 1 flags: 1 play:) ; sGunShot
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(sFX number: 722 flags: 1 play:) ; sNailSteve
			)
			(3)
			(4
				(sFX fade:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(sFX number: 721 flags: 1 play:) ; sHeavyStoneMoved
			)
			(3
				(sFX stop:)
				(stone stopUpd:)
