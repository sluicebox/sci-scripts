...
(instance rm440 of LBRoom
	...
	(method (init)
		...
		(if (and (> gAct 2) (not (== gAct 5)))
			((ScriptID 443 4) init: setOnMeCheck: 1 8192 approachVerbs: 4 1 8) ; armorPippin, Do, Look, magnifier
		else
			(armorPippin
				init:
				approachVerbs:
