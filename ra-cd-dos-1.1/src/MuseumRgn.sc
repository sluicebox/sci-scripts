					...
					(cond
						((IsFlag 134)
							(if (proc27_0 4 global364)
								(gMessager say: noun 6 1 0 0 modNum) ; "I'm a busy man. Don't take up my time by asking the same question twice."
							else
				...
				(switch temp0
					(267
						(cond
							...
							(else
								(gMessager say: noun 6 12 0 0 modNum) ; "Ahh, Monsieur Leach, he ees ze very honorable man, no? Of everyone here, I trust heem most of all. Hees pay, eet ees not very good, but I will fix that when I become ze museum President someday. In ze meantime, he must do ze extra work outside to pay hees bills."
					...
					(271
						(if (IsFlag 134)
							(gMessager say: noun 6 30 0 0 modNum) ; "Doctor Smeeth, he is very concerned about ze dagger. He has been trying to get eet back from Doctor Carter ever since he arrived."
						else
							(gMessager say: noun 6 16 0 0 modNum) ; "Doctor Smeeth, he is very concerned about ze dagger. He has been trying to get eet back from Doctor Carter ever since he arrived."
						)
					)
					(263
