...
(instance sPartysOver of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				((ScriptID 90 5) setMotion: PolyPath 350 182) ; aWatney
			...
			(7
				((ScriptID 90 1) setMotion: PolyPath 350 182) ; aCountess
			...
			(9
				((ScriptID 90 6) setMotion: PolyPath 350 182 self) ; aYvette
			)
			(10
