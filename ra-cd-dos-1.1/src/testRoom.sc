...
(procedure (localproc_0 param1 param2 param3)
	(switch param1
		(1782
			(param2 nsLeft: 42 nsTop: 17)
			(param3 nsLeft: 47 nsTop: 30)
		)
		(1791
			(param2 nsLeft: 60 nsTop: 20)
			(param3 nsLeft: 60 nsTop: 31)
		)
		(1786
			(param2 nsLeft: 44 nsTop: 17)
			(param3 nsLeft: 42 nsTop: 24)
		)
		(1785
			(param2 nsLeft: 26 nsTop: 17)
			(param3 nsLeft: 26 nsTop: 24)
		)
		(1793
			(param2 nsLeft: 33 nsTop: 16)
			(param3 nsLeft: 31 nsTop: 24)
		)
		(1790
			(param2 nsLeft: 43 nsTop: 17)
			(param3 nsLeft: 34 nsTop: 25)
		)
		(1788
			(param2 nsLeft: 45 nsTop: 18)
			(param3 nsLeft: 44 nsTop: 28)
		)
		(1783
			(param2 nsLeft: 63 nsTop: 18)
			(param3 nsLeft: 63 nsTop: 32)
		)
		(1784
			(param2 nsLeft: 28 nsTop: 21)
			(param3 nsLeft: 25 nsTop: 27)
		)
		(1792
			(param2 nsLeft: 63 nsTop: 20)
			(param3 nsLeft: 63 nsTop: 28)
		)
		(1787
			(param2 nsLeft: 63 nsTop: 19)
			(param3 nsLeft: 57 nsTop: 28)
		)
		(1781
			(param2 nsLeft: 81 nsTop: 21)
			(param3 nsLeft: 78 nsTop: 28)
		)
	)
)
...
(instance tkrParty1 of Talker
	...
	(method (init)
		...
		(= textX (* (- x 10) -1))
		(= textY (- (Localize 108 108 108 108 120) y))
		(= font gUserFont)
