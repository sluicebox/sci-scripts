	...
	(method (fade param1 param2 param3 param4 param5 &tmp temp0)
		...
		(cond
			((and mySound (mySound handle:))
				(if temp0
					(mySound fade: param1 param2 param3 param4 temp0)
				else
					(mySound fade: param1 param2 param3 param4)
				)
			)
			(temp0
				(temp0 cue:)
			...
			(script
				(cond
					((and (script next:) (script scratch:))
						(script next: 0 state: 2)
						((script scratch:)
							pause: 0
							fade: ((script scratch:) scratch:) 4 2 0 script
						)
					)
					((not argc)
