...
(instance RoomScript of Script
		...
		(cond
			...
			(
				(or
					...
					(Said 'get/woman/building')
					(Said
						'ask,go//area,drop,comedian,club,date,exit,bar,show,dance'
					)
					(Said
						'ask,go/area,drop,comedian,club,date,exit,bar,show,dance'
					)
			...
			((Said 'talk/woman')
				(cond
					((not gEgoIsHunk)
						(PrintL (Format @string 395 33 gLaffer)) ; ""Hello, beautiful," you say, %s"
						(PrintP 395 34) ; "My, my! Your body is certainly ready for one of my workouts!"
					)
					((TestFlag 8)
						(Printf 395 33 gLaffer) ; ""Hello, beautiful," you say, %s"
					...
					(else
						...
						(switch (++ talkCount)
							...
							(2
								(PrintL 395 39) ; "So? How's it going?"
								(PrintP 395 17) ; "Not well. With so many workout tapes in today's marketplace, I'm having trouble coming up with that certain little something that will make mine different, establishing my competitive edge!"
							)
							(else
								(PrintL 395 40) ; "Say, I used to be in marketing. Perhaps I could help you?"
								(PrintP 395 41) ; "Gosh, Larry! That would be wonderful. If you could, I'd be eternally grateful!"
							)
						)
					)
				)
			)
			((or (Said 'enjoy/you') (Said '/enjoy/you'))
				(PrintL 395 42) ; "Baby, I thinks I loves ya!"
				(PrintP 395 43) ; "I'm sure you would!"
				(React 5 44)
			)
			(
				(or
			...
			((Said 'look>')
				(cond
					((Said '/calf')
						(PrintP 395 44) ; "Oh, Larry!" smiles Bambi. "Stop looking at me like that!"
						(React 3 22)
					)
					((Said '/bracelet')
						(Print 395 45) ; "Her pearly white wrist passes through an expensive golden bracelet."
					)
					((Said '/ear')
						(Print 395 46) ; "You predict there is little or nothing between Bambi's ears."
					)
					((or (Said '/tape') (Said '//tape'))
						(PrintL 395 47) ; "Bambi, is there any way I could see what you've done so far?"
						(PrintP 395 48) ; "Not really, Larry. I haven't yet figured out the hook that will make my tape different from all the others on the market."
					)
					((Said '/boob')
						(Print 395 49) ; ""My, what a tasty little pair of hooters!" you think to yourself."
						(PrintP 395 50) ; "Oh, Larry!" smiles Bambi. "Stop looking at me there!"
						(React 6 12)
					)
					((Said '[/area,woman]')
						(Print 395 51) ; "You feel certain you could learn to fawn over Bambi."
						(PrintP 395 52) ; ""Hello," says Bambi with her doe-eyed smile."
						(React 2 33)
					)
				)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(HandsOff)
				(PrintL 395 53) ; "Bambi! I've got it! I know just the angle that will sell that video of yours!"
				(PrintP 395 54) ; "Oh, really? What could that be, Larry?"
				(React 2 22)
				(= cycles 22)
			)
			(8
				...
				(PrintL 395 55) ; "SEX!"
				(PrintP 395 56) ; "Of course! Why didn't I think of that? If sex sells toothpaste, it surely should sell aerobics!"
				(React 2 22)
				(= cycles 22)
			)
			(9
				(PrintL 395 57) ; "We'll be the first aerobics video to use sexual positions for our exercises. Can you do it, Bambi? Can you make it interesting?"
				(PrintP 395 58) ; "Interesting?! I should say! Watch this!!"
				(React 2 22)
				(= cycles 22)
				(gMusic fade:)
			)
			...
			(11
				(PrintL 395 59) ; "I can't wait to see you work out again, Bambi!"
				(PrintP 395 60) ; "Come back when you feel helpful, Larry!"
				(React 2 33)
				(= cycles 22)
			)
			(12
