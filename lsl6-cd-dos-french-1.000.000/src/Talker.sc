...
(class Narrator of Prop
	...
	(method (display theBuf &tmp temp0 temp1 [temp2 500])
		(if (> (+ x talkWidth) 318)
			(= temp0 (- 318 x))
		else
			(= temp0 talkWidth)
		...
		(Print window: temp1 posn: x y font: font width: temp0 modeless: 1)
		(if (& gMsgType $0002)
			(Message
				msgGET
				(WordAt theBuf 0)
...
(class Talker of Narrator
	...
	(method (display theBuf &tmp temp0 temp1 temp2 temp3 [temp4 500])
	...
	(method (startAudio theKeys &tmp temp0 temp1 temp2 temp3 temp4 temp5)
		(self show:)
		(if mouth
			...
			(if (ResCheck rsSYNC36 temp0 temp1 temp2 temp3 temp4)
				...
				(= temp5 (super startAudio: theKeys))
			else
				(= temp5 (super startAudio: theKeys))
