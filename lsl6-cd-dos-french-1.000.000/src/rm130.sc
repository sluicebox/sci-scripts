		...
		(switch (= state newState)
			...
			(7
				...
				(switch (gGame printLang:)
					(33
						(Print addTitle: {Le Roi Des Muscl\82s})
					)
					(49
						(Print addTitle: {Muskelprotz})
					)
					(else
			...
			(8
				...
				(switch (gGame printLang:)
					(33
						(Print addTitle: {Le Roi De La Plage})
					)
					(49
						(Print addTitle: {Strand Adonis})
					)
					(else
			...
			(9
				...
				(switch (gGame printLang:)
					(33
						(Print addTitle: {Le Roi Des Bronz\82s})
					)
					(49
						(Print addTitle: {Starker Hannes})
					)
					(else
