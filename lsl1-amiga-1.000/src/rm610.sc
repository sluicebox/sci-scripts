...
(procedure (ReviveActors)
	(aTuna init: cycleSpeed: global101 moveSpeed: global101)
	(aShark init: cycleSpeed: global101 moveSpeed: global101)
	(aFish1 init: cycleSpeed: global101 moveSpeed: global101)
	(aFish2 init: cycleSpeed: global101 moveSpeed: global101)
	(aFish3 init: cycleSpeed: global101 moveSpeed: global101)
	(alEyes init: cycleSpeed: (+ 40 global101) setCycle: RandCycle)
	(rightGuyEyes init: cycleSpeed: (+ 40 global101) setCycle: RandCycle)
	(rogerHead init: cycleSpeed: (+ 90 global101) setCycle: RandCycle)
	(aShark init: cycleSpeed: global101 moveSpeed: global101)
	(= sharkTimer 300)
	(= fish1Timer 500)
	(= fish2Timer 200)
		...
		(switch theVerb
			...
			(2 ; Look
				(cond
					...
					((not (IsFlag 13))
						(Print 610 13) ; "There's a gorgeous blonde sitting at the table, and she's all alone!"
