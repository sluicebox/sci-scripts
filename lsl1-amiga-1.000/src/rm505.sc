...
(instance sCallSierra of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Print 505 33) ; "We're not open at night, but if you'd call during business hours (and stop using this pretend telephone) we would be happy to sell you a copy of any of Al Lowe's other games!"
				(= seconds 2)
			)
			(3
