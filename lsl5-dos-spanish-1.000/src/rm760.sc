...
(instance sLanaTalks of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(Say Lana_Luscious_a 760 44 108) ; ""If you like that, you should drop by the `Tramp This! Mud Wrestling' Show. I go on in just a few minutes!" the says with a wink."
				(= ticks 60)
			)
			(8)
			(9
