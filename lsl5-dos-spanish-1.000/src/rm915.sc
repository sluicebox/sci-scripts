	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(10 ; Zipper
				(switch (Random 1 2)
					(1
						(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 3 108) ; "Don't rush me, Big Guy!" says Chi Chi. "You've still got a little plaque on those bicuspids."
					)
					(2
						(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 4 108) ; "Perhaps... if you'll just hold still a little while."
					)
				)
			)
			(3 ; Do
	...
	(method (changeState newState)
		(switch (= state newState)
				...
				(switch (++ talkCounter)
					...
					(3
						(Say ; ""Oh, I do hope illegal actions don't bother you, Larry!" says Chi Chi."
							Chi_Chi_Lambada_SChi_Chi_Lambada
							915
							9
							108
							139
			...
			(3
				(switch talkCounter
					(1
						(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 12 108) ; "Yes."
						(= ticks 123)
					)
					(2
						(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 13 108) ; ""Well, I suppose I've heard worse!" she responds."
						(= ticks 123)
					)
					(3
					...
					(4
						(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 15 108) ; "Have you ever considered dental floss an aphrodisiac?"
						(= ticks 123)
					)
					(5
			...
			(4
				(switch talkCounter
					...
					(3
						(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 18 108) ; "Oh, nothing much, I suppose. I really meant to jump in on that amnesty deal a few years ago, but I just forgot, I guess."
						(= ticks 123)
					)
					(4
			...
			(6
				(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 21 108 139 self) ; "Yes, I guess I am," she replies. "Although I'd do anything for the man who could help me become a citizen."
			)
			(7
				(= ticks 60)
			)
			(8
				(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 22 108 139 self) ; "Say," she pauses and looks deep into your eyes, "you wouldn't have any ideas about this, would you?"
			)
			(9
				(= ticks 60)
			)
...
(instance Chi_Chi_Lambada_SChi_Chi_Lambada of Talker
	(properties
...
(instance sBackToWork of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 26 108 139 self) ; "If you've stared at me long enough, Mr. Laffer, it's time for me to get back into your mouth!"
			)
			(2
				(= ticks 30)
			)
...
(instance sHideBoobs of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 27 108 139 self) ; "Hey! Just a minute here! If anybody's going to undo my button, it's me!"
			)
			(2
				(boobs hide:)
				(gTheIconBar enable:)
...
(instance sStopThat of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 28 108 139 self) ; "Hey! What do you think you're doing?!"
			)
			(2
				(= ticks 20)
			)
...
(instance sGiveGreen of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Say Chi_Chi_Lambada_SChi_Chi_Lambada 915 30 108 139 self) ; "Could I?" says Chi Chi. "Oh, Larry! You've made me the happiest woman in Miami. Now I'll be able to move to Central California!"
			)
			(4
				(herMouth dispose:)
				(herEye dispose:)
