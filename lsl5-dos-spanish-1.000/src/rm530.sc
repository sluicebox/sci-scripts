			...
			(5 ; Talk
				(switch (++ michelleCount)
					(1
						...
						(Say Michelle_Milken 530 30 108) ; "Hi, Larry," she says with a friendly smile, "new in town?"
					)
					(2
					...
					(4
						...
						(Say Michelle_Milken 530 35 108) ; ""Yes, and dining isn't the only thing I don't enjoy doing alone!" she responds with a smile."
					)
					(else
