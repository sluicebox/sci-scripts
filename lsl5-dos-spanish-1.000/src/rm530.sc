				...
				(switch register
					(0
						(Say ; ""Nearly as many times as I'm here," she responds."
							Michelle_Milken_SMichelle_Milken
							530
							1
							108
							139
...
(instance sOpenCurtain of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(1
				(Say Michelle_Milken_SMichelle_Milken 530 7 108) ; ""Allow me to make our booth just a little more private," says Michelle, standing up."
		...
		(switch theVerb
			...
			(5 ; Talk
				(if (not talkedToTable1)
					(HandsOff)
					(Say gEgo 530 20 67 -1 185) ; ""Excuse me, may I join you?" you ask the couple at the left table."
					(TPrint 530 21 108 drape1) ; "No. I'm sorry, but we're eating." replies the wit at the table. "And I don't want to lose my appetite."
				else
		...
		(switch theVerb
			...
			(5 ; Talk
				(if (not talkedToTable2)
					(HandsOff)
					(Say gEgo 530 22 67 -1 185) ; "Excuse me," you shout to that far table, "but can you explain why I don't talk to that lovely woman sitting all alone at that table in the corner?"
					(TPrint 530 23 108 drape2) ; "Could your head be up your..."
				else
					(super doVerb: theVerb invItem)
				)
			)
		...
		(switch theVerb
			...
			(5 ; Talk
				(if (not talkedToTable3)
					(HandsOff)
					(Say gEgo 530 24 67 -1 185 108 drape3) ; ""Hi, folks; I'm from out of town!" you yell to the diners at the table across the room."
				else
					(super doVerb: theVerb invItem)
				)
			)
		...
		(switch theVerb
			...
			(5 ; Talk
				(switch (++ michelleCount)
					(1
						(Say gEgo 530 28 67 -1 185) ; "Hello, Lovely Lonely Lady," you say to the gorgeous babe sitting all alone in the booth near you. "Allow me to introduce myself. My name is Larry; Larry Laffer."
						(TPrint 530 29) ; "You hope she doesn't just ignore you."
						(Say Michelle_Milken_SMichelle_Milken 530 30 108) ; "Hi, Larry," she says with a friendly smile, "new in town?"
					)
					(2
						(Say gEgo 530 31 67 -1 185) ; "Remembering your boss' warning not to reveal your identity, you decide to begin with a casual opener, "Do you come here often?" you ask."
						(gCurRoom setScript: sTalk 0 0)
					)
					(3
						(Say gEgo 530 32 67 -1 185) ; "Perhaps I could mention her "power clothes," you think to yourself. A compliment on her apparel might be appropriate..."
						(Say gEgo 530 33 67 -1 185) ; "What a lovely dress you're almost wearing," you tell her. "And you certainly look good in it!"
						(gCurRoom setScript: sTalk 0 1)
					)
					(4
						(Say gEgo 530 34 67 -1 185) ; ""I notice you're dining alone," you try again."
						(Say Michelle_Milken_SMichelle_Milken 530 35 108) ; ""Yes, and dining isn't the only thing I don't enjoy doing alone!" she responds with a smile."
					)
					(else
						(Say gEgo 530 36 67 -1 185) ; ""I was wondering: may I join you for dinner?" you ask."
...
(instance Michelle_Milken_SMichelle_Milken of Talker
	(properties
