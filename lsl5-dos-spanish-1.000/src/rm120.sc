...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(16
				(Say Bruno_b 120 6 108 139 self 67 -1 170) ; "We attempted to counter this trend with a heavy investment in rap music, thinking teenagers' continuous exposure to pornographic lyrics would help sales of our wider product line."
			)
			(17
				(= ticks 60)
			)
