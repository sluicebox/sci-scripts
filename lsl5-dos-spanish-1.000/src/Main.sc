...
(procedure (TPrint arg1 arg2 &tmp [str 500] theTime saveCursor)
	(if gModelessDialog
...
(procedure (Say who arg1 arg2 &tmp disposeOrNot who2Cue i [buffer 370])
	(cond
		((u< arg1 1000)
...
(procedure (proc0_28 param1 param2 param3 param4 param5)
	(return
...
(procedure (proc0_29)
	(proc0_28 1026 1040 1051 1051 995)
)

(procedure (proc0_26)
	(= global204 (gGame parseLang:))
	(gGame parseLang: 1)
)

(procedure (proc0_27)
	(gGame parseLang: global204)
)
...
(class LL5IconItem of IconI
	(properties
		helpModule 25
	)
)

(class LL5Slider of Slider
	(properties
		helpModule 25
	)
)

(class LL5ControlIcon of ControlIcon
	(properties
		helpModule 25
	)
)
...
(instance LSL5 of Game
	...
	(method (init &tmp temp0 [temp1 5] [temp6 15] temp21 temp22 temp23)
		(StrSplit @temp1 @temp6 0)
		(Format @temp6 0 1 10) ; "%d.scr"
		(if (FileIO fiEXISTS @temp6)
			(= gDebugging 1)
		)
		(= gSGrooper stopGroop)
		StopWalk
		...
		(pointsSound owner: self)
		(= gTheTimer ll5Timer)
		(= gChargeTimer camcorderTimer)
		(if (not (FileIO fiEXISTS {memory.drv}))
			((= temp23 (SysWindow new:)) color: gColBlack back: gColWhite)
			(Print 0 2 #window temp23 #font 0) ; "Can't load MEMORY.DRV"
			(= gQuit 1)
			(return 0)
		)
		(= gVersion {x.yyy.zzz})
		...
		(= temp22 (FileIO fiOPEN {version} 1))
		(FileIO fiREAD_STRING gVersion 11 temp22)
		(FileIO fiREAD_STRING gVersionDate 20 temp22)
		(FileIO fiREAD_STRING gVersionPhone 20 temp22)
		(FileIO fiREAD_STRING gVersionIntPhone 20 temp22)
		(FileIO fiCLOSE temp22)
		((= gTheIconBar IconBar)
		...
		(cond
			...
			(gDebugging
				...
				(if
					(and
						(== temp0 200)
						(PrintD {sex?} 106 81 {Larry} 0 106 81 {Patti} 1)
					)
					(= temp21 24)
				)
				(= gRestartRoom temp0)
	...
	(method (pragmaFail &tmp theVerb theItem [str 70])
		...
		(return
			(and
				...
				(switch (= theVerb ((User curEvent:) message:))
					(2
						(TPrint 0 3) ; "It's not much to look at."
					)
					(5
						(TPrint 0 4) ; "To whom were you trying to speak?"
					)
					(3
						(TPrint 0 5) ; "There's nothing to do there."
					)
					(10
						(cond
							((gCurRoom script:)
							...
							(gEgoIsLarry
								(TPrint 0 7) ; "You coyly turn your back and relieve yourself. You quickly feel much better. The hint of a smile crosses your lips."
							)
							(else
								(TPrint 0 8) ; "Visions of cucumbers dance through your head."
							)
						)
					)
					(4
						...
						(if gEgoIsLarry
							(switch theItem
								(0
									(TPrint 0 9) ; "Good thinking! Shoot a little tape of that!"
									(TPrint 0 10 67 -1 185) ; "(But is your pocket camcorder working?)"
								)
								(6
									(TPrint 0 11) ; "You wave your napkin in the air. How fun!"
								)
								(7
									(TPrint 0 12) ; "That's one more place that won't accept your AeroDork Gold Card!"
								)
								(10
									(TPrint 0 13) ; "That doesn't look like a vending machine!"
								)
								(12
									(TPrint 0 14) ; "Stop flashing your money around, Larry!"
								)
								(16
									(TPrint 0 15) ; "That's not something you should set afire!"
								)
								(22
									(TPrint 0 16) ; "Your doily would look lovely there, but you'd better keep it instead."
								)
								(else
									(if 1
										(= global200
										...
										(Format @str 0 17 global200 global203) ; "Try finding some place else to place %s."
							...
							(switch theItem
								(3
									(TPrint 0 18) ; "You wave the fax in the air. You have fun."
									(TPrint 0 19 67 -1 185) ; "(But not much!)"
								)
								(4
									(TPrint 0 20) ; "That's not a good place to pour out your champagne."
								)
								(5
									(TPrint 0 21) ; "Your gold record would get scratched there."
								)
								(7
									(TPrint 0 22) ; "You wave the fax in the air. You have fun."
									(TPrint 0 19 67 -1 185) ; "(But not much!)"
								)
								(13
									(TPrint 0 23) ; "You briefly contemplate firing your bra at that, but decide to hold your "fire.""
								)
								(else
									(if 1
										(= global200
	...
	(method (quitGame &tmp [str1 10] [str2 8] theFile)
		...
		(if
			...
			(if (theFile open: 2)
				(Format @str2 0 25 gPokerJackpot) ; "%d"
				(theFile
					writeString: @str1
					writeString: {\n}
					writeString: @str2
		...
		(switch (event type:)
			(evKEYBOARD
				...
				(switch (event message:)
					...
					(else
						(if gDebugging
							((ScriptID 10) handleEvent: event) ; MISSING SCRIPT
						)
					)
				)
			)
...
(instance ll5DoVerbCode of Code
	...
	(method (doit theVerb theObj &tmp objDesc theItem [str 115])
		...
		(switch theVerb
			...
			(2
				(if (theObj lookStr:)
					...
					(if 1
						...
						(Format @str 0 28 global200 global203) ; "Why, look! It's %s."
						(Memory memFREE global200)
						(Memory memFREE global203)
					)
					(TPrint @str)
			...
			(5
				(if 1
					...
					(= global203 (Memory memALLOC_CRIT (StrLen objDesc)))
					(StrSplitInTwo global200 global203 objDesc)
					(Format @str 0 29 global200 global203) ; "You engage in a short, but personally meaningful, conversation with %s."
					(Memory memFREE global200)
					(Memory memFREE global203)
				)
				(TPrint @str)
			...
			(3
				(if 1
					...
					(= global203 (Memory memALLOC_CRIT (StrLen objDesc)))
					(StrSplitInTwo global200 global203 objDesc)
					(Format @str 0 30 global200 global203) ; "That feels exactly like %s."
					(Memory memFREE global200)
					(Memory memFREE global203)
				)
				(TPrint @str)
			...
			(4
				...
				(if 1
					...
					(Format @str 0 31 global201 global200 global204 global203) ; "It seems %s just doesn't work with %s."
					(Memory memFREE global200)
			...
			(10
				(if 1
					...
					(= global203 (Memory memALLOC_CRIT (StrLen objDesc)))
					(StrSplitInTwo global200 global203 objDesc)
					(Format @str 0 32 global200 global203) ; "Don't do that to %s!"
					(Memory memFREE global200)
					(Memory memFREE global203)
				)
				(TPrint @str)
...
(instance gcWin of SysWindow
	...
	(method (open &tmp [temp0 2] temp2 temp3 temp4 temp5 temp6 temp7 [temp8 4] temp12 temp13 [temp14 30] [temp44 4])
		(= temp12 -1)
		(self
			top: (/ (- 200 (+ (CelHigh (proc0_29) 1 1) 6)) 2)
			left: (/ (- 320 (+ 191 (CelWide (proc0_29) 0 1))) 2)
			bottom:
				(+
					(CelHigh (proc0_29) 1 1)
					6
					(/ (- 200 (+ (CelHigh (proc0_29) 1 1) 6)) 2)
				)
			right:
				(+
					191
					(CelWide (proc0_29) 0 1)
					(/ (- 320 (+ 191 (CelWide (proc0_29) 0 1))) 2)
				)
			priority: temp12
		)
		(super open:)
		(DrawCel
			...
			(+
				(/
					(-
						(-
							(+ 191 (CelWide (proc0_29) 0 1))
							(+ 4 (CelWide (proc0_29) 1 1))
						)
						(CelWide (proc0_29) 0 6)
					)
					2
				)
				4
				(CelWide (proc0_29) 1 1)
			)
			6
			temp12
		)
		(DrawCel (proc0_29) 1 1 4 3 temp12)
		(DrawCel (proc0_29) 1 0 94 38 temp12)
		(DrawCel (proc0_29) 1 0 135 38 temp12)
		(DrawCel (proc0_29) 1 0 175 38 temp12)
		(DrawCel (proc0_29) 0 4 63 (- 37 (+ (CelHigh (proc0_29) 0 4) 3)) temp12)
		(DrawCel
			(proc0_29)
			0
			3
			101
			(- 37 (+ (CelHigh (proc0_29) 0 4) 3))
			temp12
		)
		(DrawCel
			(proc0_29)
		...
		(= temp5 (+ (= temp2 (+ 46 (CelHigh (proc0_29) 0 1))) 13))
		(= temp4
			(+
				(= temp3 (+ 10 (CelWide (proc0_29) 1 1)))
				(-
					(+ 191 (CelWide (proc0_29) 0 1))
					(+ 10 (CelWide (proc0_29) 1 1) 6)
				)
			)
		)
		(= temp6 0)
		...
		(Format @temp14 0 33 gScore gPossibleScore gScore gPossibleScore) ; "Score: %d of %d"
		(TextSize @temp44 @temp14 999 0)
		(Display
			@temp14
			dsFONT
			999
			...
			(+ 46 (CelHigh (proc0_29) 0 1) 3)
		)
	)
)

(instance detailSlider of LL5Slider
	(properties
		loop 0
		cel 1
		nsLeft 67
...
(instance volumeSlider of LL5Slider
	(properties
		loop 0
		cel 1
		nsLeft 107
...
(instance speedSlider of LL5Slider
	(properties
		loop 0
		cel 1
		nsLeft 147
...
(instance textSlider of LL5Slider
	(properties
		loop 0
		cel 1
		nsLeft 187
...
(instance iconSave of LL5ControlIcon
	(properties
		loop 2
		cel 0
		nsLeft 8
...
(instance iconRestore of LL5ControlIcon
	(properties
		loop 3
		cel 0
		nsLeft 8
...
(instance iconRestart of LL5ControlIcon
	(properties
		loop 4
		cel 0
		nsLeft 8
...
(instance iconQuit of LL5ControlIcon
	(properties
		loop 5
		cel 0
		nsLeft 8
...
(instance iconAbout of LL5ControlIcon
	(properties
		loop 6
		cel 0
		nsLeft 8
...
(instance iconHelp of LL5IconItem
	(properties
		loop 7
		cel 0
		nsLeft 34
...
(instance iconOk of LL5IconItem
	(properties
		loop 8
		cel 0
		nsLeft 8
