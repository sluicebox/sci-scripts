		...
		(switch (= state newState)
			...
			(2
				(Say ; "Well, thank you, gentlemen. I promise your CONSIDERABLE contribution will not be wasted!"
					President_of_C_A_N_E__SPresidente_de_P_I_C_H_I_
					205
					17
					108
					139
		...
		(switch (= state newState)
			...
			(6
				(Say ; "Yeah, okay, Senator, we've got it. Here's the deal: there's plenty more where this comes from, as long as we see some progress on that bill to tighten regulation of the airwaves."
					A_C_A_N_E__er_SUn_partidario_del_P_I_C_H_I_
					205
					27
					108
					139
...
(instance President_of_C_A_N_E__SPresidente_de_P_I_C_H_I_ of Talker
	(properties
...
(instance A_C_A_N_E__er_SUn_partidario_del_P_I_C_H_I_ of Talker
	(properties
		name {A C.A.N.E.-er}
		x 1
		y 140
