...
(instance sRoom of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Say You_ST_ 420 1 108 139 self) ; "But, Inspector," you say worriedly, "I know nothing of spying."
			)
			(4
				(= ticks 60)
			)
			...
			(10
				(Say You_ST_ 420 5 108 139 self) ; "All right, Inspector Desmond," you say. "But what places and what times?"
			)
			(11
				(= ticks 60)
			)
			...
			(21
				(Say You_ST_ 420 11 108 139 self) ; "But to Desmond you say, "Well, all right, Inspector, but I'm hardly an expert in subliminal recordings or rap music!"
			)
			(22
				(= ticks 60)
			)
			...
			(29
				(Say You_ST_ 420 15 108 139 self) ; "Okay, boss, I'm on! Now, how do I begin?"
			)
			(30
				(= ticks 60)
			)
			...
			(35
				(Say You_ST_ 420 18 108 139 self) ; "First class, of course?"
			)
			(36
				(= ticks 60)
			)
			...
			(39
				(Say You_ST_ 420 20 108 139 self) ; ""Yes, of course!" you agree, afraid now that you're in way over your head."
			)
			(40
				(= ticks 60)
			)
