...
(instance airElemental of Elemental
	...
	(method (init theX)
		(gMiscSound number: 580 loop: -1 priority: 3 play:)
	...
	(method (wander &tmp theDir theAngle bailOut)
		(= bailOut 0)
		(cond
			((or (>= gDay 10) (IsFlag 90) (IsFlag 88)) ; fLevitating, fClimbingRope
				(= theAngle 359)
	...
	(method (changeState newState &tmp theX theY theLoop)
		(switch (= state newState)
			...
			(6
				...
				(gMiscSound stop: number: 342 loop: 0 priority: 15 play:)
			)
			(7
