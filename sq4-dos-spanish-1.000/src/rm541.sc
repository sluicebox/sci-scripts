...
(instance beam0 of Prop
	...
	(method (init)
		...
		(if loop
			(= lookStr
				{The beams glow dully in the smoky air.}
			)
		else
			(= lookStr
				{You see what looks like beam emitters, but no beams.}
			)
		)
	)
	...
	(method (handleEvent event)
		(cond
			...
			((and (== (event type:) evKEYBOARD) (== (event message:) KEY_RETURN))
				(cond
					((MousedOn oneBut event)
						(oneBut doit:)
					)
					((MousedOn twoBut event)
						(twoBut doit:)
					)
					((MousedOn threeBut event)
						(threeBut doit:)
					)
					((MousedOn fourBut event)
						(fourBut doit:)
					)
					((MousedOn fiveBut event)
						(fiveBut doit:)
					)
					((MousedOn sixBut event)
						(sixBut doit:)
					)
					((MousedOn sevenBut event)
						(sevenBut doit:)
					)
					((MousedOn eightBut event)
						(eightBut doit:)
					)
					((MousedOn nineBut event)
						(nineBut doit:)
					)
					((MousedOn zeroBut event)
						(zeroBut doit:)
					)
					(else
						(self doit:)
