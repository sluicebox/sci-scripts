	...
	(method (init &tmp temp0 temp1)
		...
		(cond
			((and (!= gPrevRoomNum 381) (not (IsFlag 10)))
				(gLongSong2 number: 381 loop: -1 playBed: 0)
			)
			((IsFlag 10)
...
(instance door of PicView
	...
	(method (doVerb theVerb)
		(switch theVerb
			(11 ; Smell
				(Print 380 0) ; "This store seems to be closed. A security door blocks the entrance."
			)
			(else
...
(instance tallGuy of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 380 1) ; "Geez! This guy could be a whole basketball team!"
			)
			(11 ; Smell
				(Print 380 2) ; "He smells a little like vermicelli."
			)
			(10 ; Taste
				(Print 380 3) ; "What, and moisten his new Size 15 Extra Tall Jumpsuit??"
			)
			(5 ; Talk
				(Print 380 4) ; "After thinking hard, you remember an off-color tall joke. But just as you begin to open your mouth, your strong will to live overcomes your juvenile impulse (i.e. you keep your trap shut)."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance bush of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 380 5) ; "This is a fine example of the wonders of fabricated flora."
			)
			(3 ; Do
				(Print 380 6) ; "Don't bother. The fake plants are bolted down because of people like you."
			)
			(11 ; Smell
				(Print 380 7) ; "There's a powerful eucalyptus odor coming from the plant."
			)
			(10 ; Taste
				(Print 380 8) ; "You lick the plant. You don't learn anything, but your sinuses are clearer."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance BigTallSign of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 380 9) ; "The sign reads "BIG and Tall"."
			)
			(3 ; Do
				(Print 380 10) ; "Forget it. You'll only get hurt."
			)
			(11 ; Smell
				(Print 380 11) ; "It smells like expensive cologne, leather and tobacco."
			)
			(10 ; Taste
				(Print 380 12) ; "It tastes like sewage, vinyl and tobacco."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance OutsideTheShop of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 380 13) ; "You are outside the Big and Tall Alien store."
			)
			(11 ; Smell
				(Print 380 14) ; "The mall has that high-rent, low-occupancy smell...like any office building in downtown Los Angeles."
			)
			(10 ; Taste
				(Print 380 15) ; "It's against the Third Law of Mall Security to be caught licking mall components."
			)
			(2 ; Look
...
(instance store of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 380 16) ; "This place sells body covers for the big, tall, and otherwise bizarre alien."
			)
			(11 ; Smell
				(Print 380 11) ; "It smells like expensive cologne, leather and tobacco."
			)
