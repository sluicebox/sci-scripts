...
(instance store of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 375 6) ; "Ah! An arcade!. It's "Buckazoid Bill's Arcade and Sushi Bar.""
			)
			(11 ; Smell
				(Print 375 5) ; "It smells like the kind of place where unwashed teen-agers stand around smoking, sweating and performing other unmentionable teen-age acts."
			)
...
(instance bush1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 375 7) ; "This is a fine example of the wonders of fabricated flora."
			)
			(11 ; Smell
				(Print 375 8) ; "There's a fresh woodsy scent coming from the plants."
			)
			(10 ; Taste
				(Print 375 9) ; "Urp...somebody's dumped their potpourri on these plants."
			)
			(3 ; Do
				(Print 375 10) ; "Get some taste! These are phoney mall plants!"
			)
			(else
				(super doVerb: theVerb &rest)
			)
