		...
		(switch theVerb
			...
			(5 ; Talk
				(if (not talkedToTable1)
					(HandsOff)
					(Say gEgo 530 19 #at -1 185) ; ""Excuse me, may I join you?" you ask the couple at the left table."
					(TPrint 530 20 #dispose drape1) ; "No. I'm sorry, but we're eating." replies the wit at the table. "And I don't want to lose my appetite."
				else
		...
		(switch theVerb
			...
			(5 ; Talk
				(if (not talkedToTable2)
					(HandsOff)
					(Say gEgo 530 21 #at -1 185) ; "Excuse me," you shout to that far table, "but can you explain why I don't talk to that lovely woman sitting all alone at that table in the corner?"
					(TPrint 530 22 #dispose drape2) ; "Could your head be up your..."
				else
					(super doVerb: theVerb invItem)
				)
			)
		...
		(switch theVerb
			...
			(5 ; Talk
				(if (not talkedToTable3)
					(HandsOff)
					(Say gEgo 530 23 #at -1 185 #dispose drape3) ; ""Hi, folks; I'm from out of town!" you yell to the diners at the table across the room."
				else
					(super doVerb: theVerb invItem)
				)
			)
		...
		(switch theVerb
			...
			(5 ; Talk
				(switch (++ michelleCount)
					(1
						(Say gEgo 530 27 #at -1 185) ; "Hello, Lovely Lonely Lady," you say to the gorgeous babe sitting all alone in the booth near you. "Allow me to introduce myself. My name is Larry; Larry Laffer."
						(TPrint 530 28) ; "You hope she doesn't just ignore you."
						(Say Michelle_Milken 530 29 #dispose) ; "Hi, Larry," she says with a friendly smile, "new in town?"
					)
					(2
						(Say gEgo 530 30 #at -1 185) ; "Remembering your boss' warning not to reveal your identity, you decide to begin with a casual opener, "Do you come here often?" you ask."
						(gCurRoom setScript: sTalk 0 0)
					)
					(3
						(Say gEgo 530 31 #at -1 185) ; "Perhaps I could mention her "power clothes," you think to yourself. A compliment on her apparel might be appropriate..."
						(Say gEgo 530 32 #at -1 185) ; "What a lovely dress you're almost wearing," you tell her. "And you certainly look good in it!"
						(gCurRoom setScript: sTalk 0 1)
					)
					(4
						(Say gEgo 530 33 #at -1 185) ; ""I notice you're dining alone," you try again."
						(Say Michelle_Milken 530 34 #dispose) ; ""Yes, and dining isn't the only thing I don't enjoy doing alone!" she responds with a smile."
					)
					(else
						(Say gEgo 530 35 #at -1 185) ; ""I was wondering: may I join you for dinner?" you ask."
