...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(43
				(Say Silas_Scruemall_a 150 20 108 139 self) ; "Lipper, you fool! This is no ordinary pocket protector! It's a brand new, imported, miniaturized, merely disguised as some dork's Pocket Protector!"
			)
			(44
				(= ticks 123)
			)
