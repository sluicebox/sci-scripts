...
(instance cannister of PicView
	...
	(method (init)
		(= view (proc0_28 273 273 273 2731 273))
		(super init: &rest)
	)
...
(instance blonde of Actor
	...
	(method (doVerb theVerb invItem &tmp [temp0 280])
		(switch theVerb
			(2 ; Look
				(Format ; "It's %s, AeroDork's blonde bombshell. Once she was a highly motivated employee. Once she was a highly trained professional. Once she never forgot to ask, "Didya wan'sum fries wit' dat?""
					@temp0
					270
					19
					(blonde description:)
			...
			(3 ; Do
				(Format ; "%s was once a ticket agent here. Now her only responsibility is to the few remaining employees: she fires them!"
					@temp0
					270
					20
					(blonde description:)
			...
			(4 ; Inventory
				(Format ; "Get that away from me, dork!" shouts %s. "Anything YOU have, I don't want!"
					@temp0
					270
					23
					(blonde description:)
...
(instance redHead of Actor
	...
	(method (doVerb theVerb invItem &tmp [temp0 160])
		(switch theVerb
			(2 ; Look
				(Format ; "It's %s. Once she was AeroDork's red-headed, red-blooded, red-hot, temptress of the flight path."
					@temp0
					270
					24
					(redHead description:)
...
(instance sStealChange of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(1
				(TPrint 270 30) ; "There goes your chance for a "Larry's Kids" telethon!"
...
(instance door of Door
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(TPrint 270 31) ; "This door leads to the exclusive AeroDork Airline V.I.P. Chartreuse Carpet Lounge."
			)
			(3 ; Do
				(TPrint 270 32) ; "You can't open this door. It's secured from within. If only you had some form of identification to prove you really belong inside."
			)
			(5 ; Talk
				(TPrint 270 33) ; "Hello!" you shout. "Is there anyone inside?"
				(TPrint 270 34 67 -1 185) ; "(You hear no response."
			)
			(else
				(super doVerb: theVerb invItem &rest)
			)
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(switch gLarryLoc
					(0
						(TPrint 270 35) ; "While you're here in Los Angeles, be sure to visit wonderful "Wizneyland." Your children will be terrified when they see their favorite cartoon characters running up to them in enormous grinning overstuffed costumes... horrified when they ride through the bowel-loosening haunted house! Wizneyland! It's a million trips to the bathroom!!"
					)
					(1
						(TPrint 270 36) ; "It's Carefree Living in the Eurasian Style in new Exorbitania Townhouses. Only 1/2 block from Central Park, Broadway, Madison Square Garden, Statue of Liberty, UN Building, World Trade Center, Automat. One-bedrooms start at $10,000,000. Security locks, no pets. And no vacancies to the likes of you, either, buddy!"
					)
					(2
						(TPrint 270 37) ; "Where does the Moral Majority turn to promote censorship and creeping Fascism? "Slant," the Holier-Than-Thou Newsweekly. No liberal pandering, no pinko editorial cartoons, no objective journalism... just good ol' fashioned Fundamentalism. Printed on 100% recycled environmentalists."
					)
					(3
						(TPrint 270 38) ; "RIOT GEAR! Explosives, weapons, armor. Brass knuckles, nunchuks, pipe bombs, switchblades, guns, bazookas, tanks, stealth bombers (24-hours notice, please). Senior citizen discounts."
					)
				)
			)
			(else
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(switch gLarryLoc
					(0
						(TPrint 270 39) ; "The Los Angeles Chamber of Commerce welcomes YOU to Los Angeles! See Movie Stars' homes! See the Beverly Hills Wax Museum! See your favorite TV shows actually being taped for future broadcast! Some culture also available; call for details."
					)
					(1
						(TPrint 270 40) ; "Gay? Lesbian? Divorced? Single? Widowed? Depressed? Sorry, but the `Blecchnaven Center' offers weekly seminars for happy, straight couples only."
					)
					(2
						(Points 1 94)
						(TPrint 270 41) ; "For the biggest ride you've ever had, give us a call right now. Let us expose your blatant consumerist backside. "Tramp Limo Service, 553-4468""
					)
					(3
						(TPrint 270 42) ; "Luxury Accommodations are merely a brick's throw away at the Miami Fountainblooey Hotel. 28-story shatterproof glass atrium, fire-resistant deluxe suites. Every Thursday night is Singles Night at "The Castro Room." Valet parking, coat check, firearms rack."
					)
				)
			)
			(else
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(switch gLarryLoc
					(0
						(TPrint 270 43) ; "It's the second-most fun you've had getting wet! Visit MARINELAND, U. S. A.! See authentic U. S. Marines swimming, playing, doing tricks. Watch Porca, `The Killer Marine,' leap out of the water at feeding time for fishsticks!"
					)
					(1
						(TPrint 270 44) ; "Now through September 31st at Madison's Glare Garden! Monster Trucks! Funny Cars! Stupid Motorcycles! Mutant Mopeds! We've turned the floor of the coliseum into a giant mud bog! See audience members with necks twice as thick as their heads! Call Ticket-O-Rama for details."
					)
					(2
						(TPrint 270 45) ; "`Honest' Noah's Check-Cashing Service. The fastest way to get money when you've gambled away all your cash. Sorry, no second-party checks, third-party checks, bank checks, personal checks, out-of-state Czechs, wheat checks, rice checks. Plenty of corn checks!"
					)
					(3
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(switch gLarryLoc
					(0
						(TPrint 270 47) ; "How do busy executives stay on top of world finance? "Businessmen's Financial Hourly," of course. All the financial news you need, delivered to your home or office every hour on the hour, all day, all night. Latest markets. Millions of pages a year of the information YOU need every minute to keep your business from sinking like a rock."
					)
					(1
						(TPrint 270 48) ; "The NYC Ballet Company's 2015th production of "Sleeping Beauty" opens August 15th. The NYC Times called it, "A classic... never gets all that boring, even though you've seen it several hundred times." Opening September 20: the 2016th production of "Sleeping Beauty." Call The Ticketster for details."
					)
					(2
						(TPrint 270 49) ; "Gambleholic's Anonymous. Kick the gambling habit! We'll lay you 2 to 1 we can clean up even the worst gambling problem. Meetings held on best 2 out of 3 Thursdays each month. Ex-major league baseball players admitted FREE!"
					)
					(3
						(Points 1 93)
						(TPrint 270 50) ; "Misplace" something? "Lose" something important? "Can't find" that important documentation? Let us help. We're "Just Green Cards" and we're here to help any alien who has "lost" their card! Just call me, Carlos, at 554-1272! You'll get your "replacement" immediately. And remember: "We deliver!!"
					)
				)
			)
			(else
...
(instance camera of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(TPrint 270 51) ; "Hey! You're smudging the lens!"
			)
			(2 ; Look
				(TPrint 270 52) ; "You have the distinct feeling that someone is watching you."
			)
			(4 ; Inventory
				(switch invItem
					...
					(8 ; Boarding_Pass
						(TPrint 270 53) ; "While the boarding pass proves you have a flight on this airline, it doesn't prove you have enough class to be admitted to the exclusive AeroDork Chartreuse Carpet V.I.P. lounge."
					)
					(else
						(super doVerb: theVerb invItem &rest)
					)
