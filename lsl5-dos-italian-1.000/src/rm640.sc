...
(procedure (TalkFromBooth)
	...
	(Say Reverse_Biaz 640 59 108) ; "Hello, out there! You must be Passionate Patti! Everything's all ready for your cut-in session. Just come on into the studio, I'm waiting for you."
)
...
(instance sEnterElevator of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(Say Reverse_Biaz 640 21 108 139 self) ; "Patti, I promise you: you'll never work in this town again!"
			)
			(5
				(elevatorDing number: 622 play:)
				(elevator setCycle: Beg self)
