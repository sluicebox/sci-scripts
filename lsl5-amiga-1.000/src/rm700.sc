		...
		(switch (= state newState)
			(0
				...
				(if (not (gEgo has: 17)) ; Silver_Dollar
					(Say Cheri 700 7 #dispose #caller self) ; "Amazing! What a genius! What a coincidence! Congratulations, Sir! You have correctly guessed the number of which I have been thinking of. Here's your ten `Tramp Casino' lucky souvenir silver dollars."
				else
					(for
						((= num guess))
						(== guess num)
