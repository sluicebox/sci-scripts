...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say Desmond 380 0 108 139 self) ; "Well, Patti, I'm glad to see you made it back safely. I told you there was nothing to worry about!"
			)
			(2
				(= ticks 30)
			)
			...
			(5
				(Say Desmond 380 2 108 139 self) ; "Oh, you did fine! Now let's go over what you discovered through your investigations."
			)
			(6
				(= ticks 30)
			)
			(7
				(Say Desmond 380 3 108 139 self) ; "Let's begin with Baltimore and des Rever Records. What happened?"
			)
			(8
				(= ticks 30)
			)
			...
			(11
				(if (or (IsFlag 118) (IsFlag 119) (IsFlag 48)) ; fDirectorySol
					...
					(= state 24)
					(Say Desmond 380 9 108 139 self) ; "Oh, no. That's too bad. I thought Reverse Biaz was a major player. He might have been the key to breaking this case."
				)
			)
			(12
				(= ticks 120)
			...
			(18
				(Say Desmond 380 14 108 139 self) ; "Good going, Patti. Did you make the recording session I booked for you?"
			)
			(19
				(if (IsFlag 126)
			...
			(21
				(cond
					...
					(else
						(= state 24)
						(Say Desmond 380 20 108 139 self) ; "Too bad, Patti. I wish you could have found something there."
					)
				)
			)
			(22
			...
			(23
				(Say Desmond 380 21 108 139 self) ; "You really have a way with men, Patti!" he laughs. "Our agents could have never `obtained' evidence like you did."
			)
			(24
				(= ticks 120)
			)
			(25
				(Say Desmond 380 22 108 139 self) ; "So, did you discover anything at K-RAP radio?"
			)
			(26
				(if (IsFlag 150)
			...
			(28
				(if (IsFlag 150)
					(Say Desmond 380 25 108 139 self) ; "Nice job of sleuthing, Patti!"
				else
					(= state 38)
					(Say Desmond 380 26 108 139 self) ; "It's too bad you didn't get further into the K-RAP building, Patti. I think P. C. Hammer might well be crucial to this problem."
				)
			)
			(29
				(= ticks 60)
			...
			(32
				(Say Desmond 380 29 108 139 self) ; "Way to go, Patti. Nice work."
			)
			(33
				(= ticks 60)
			)
			...
			(36
				(if (IsFlag 156)
					(Say Desmond 380 32 108 139 self) ; "Great! Patti, you have proven yourself the right woman for the job!"
					(gEgo put: 12) ; Money
				else
					(Say Desmond 380 33 108 139 self) ; "Good, Patti. May I have the tape?"
				)
			)
			(37
				(if (not (IsFlag 156))
			...
			(38
				(if (not (IsFlag 156))
					(Say Desmond 380 35 108 139 self) ; "Oh, that's all right, Patti. Mistakes happen; even to super-spies!"
				else
					(= cycles 2)
				)
			)
			...
			(40
				(if
					...
					(Say Desmond 380 37 108 139 self) ; "Patti, you've done a wonderful job! I'm so proud of you!"
					(++ state)
				)
			)
			(41
				(Say Desmond 380 38 108 139 self) ; "You have such wonderful big, uh, er, eyes! Even though you weren't much help as a spy, I hoped you might feel something for me, too. So, here's a little favor."
			)
			(42
				(= ticks 30)
			)
			(43
				(if (IsFlag 100)
					...
					(Say Desmond 380 39 108 139 self) ; "I have a small souvenir for you, Patti--a little something for you to remember your experiences as an F.B.I. agent."
				)
			)
			(44
				(Say Desmond 380 40 108 139 self) ; "I want you to have Commander Twit's exploding bra--and every time you wear it, think of me!"
			...
			(47
				(Say Desmond 380 43 108 139 self) ; "In anticipation of your success, I made all the necessary arrangements for your White House..."
			)
			(48
				(DrawPic 1 100)
				(gTheMusic2 stop:)
