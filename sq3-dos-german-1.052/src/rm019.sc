...
(procedure (localproc_0 param1 param2)
	...
	(= local1 (Display param1 dsWIDTH 135 dsALIGN alCENTER dsCOORD 168 12 dsCOLOR param2 dsFONT 600 dsSAVEPIXELS))
	(SaveSubLang)
)
...
(instance rm019 of Rm
	...
	(method (init &tmp [temp0 50])
		...
		(Load rsVIEW (LangSwitch 49 309))
		(Load rsVIEW (LangSwitch 50 310))
		(Load rsVIEW 212)
		(Load rsSOUND 25)
		(super init:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(SaveSubLang)
				(= local2
					(Display 19 0 dsWIDTH 135 dsALIGN alCENTER dsCOORD 168 3 dsCOLOR 14 dsFONT 600 dsSAVEPIXELS)
				)
				(RestoreSubLang)
			...
			(2
				...
				(= local3
					(Display
						(cond
							((== global213 39) {NAME:\n_PLANET PHLEEBHUT\nSECTOR: 39\n\nLIGHT ATMOSPHERE\n1 KNOWN SETTLEMENT})
							((== global213 62) {NAME:\n_MONOLITH BURGER FAST FOOD DIVE\nSECTOR: 62\n\nA FINITE\nNUMBER SERVED})
							((== global213 69) {NAME:\n_PESTULON\nSECTOR: 69\nHABITANTS: UNKNOWN\nSURFACE UNCHARTED.\nIT FIGURES...})
							((== global213 82) {NAME:\n_PLANET ORTEGA\nSECTOR: 82\nHABITANTS: UNKNOWN\nVOLCANIC CRATER-STREWN\nSURFACE})
						)
						dsWIDTH
						(if (< global163 7) 200 else 91)
						dsCOORD
						(if (< global163 7)
							(+ (* (- global163 1) 25) 62)
						else
	...
	(method (changeState newState &tmp temp0 [temp1 49])
		(switch (= state newState)
			...
			(1
				...
				(SaveSubLang)
				(= local4
					(Display temp0 dsWIDTH 135 dsALIGN alCENTER dsCOORD 168 3 dsCOLOR 14 dsFONT 600 dsSAVEPIXELS)
				)
				(RestoreSubLang)
