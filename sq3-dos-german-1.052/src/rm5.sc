		...
		(switch (event type:)
			(evSAID
				(cond
						...
						(cond
							...
							(
								(or
									...
									(Said
										'[<at]/hand,appendage,head[<bone,android,menace[<metallic]]'
									)
								)
							...
							(
								(Said
									'/skull,finger,head,hand,appendage[<android,man]'
								)
					...
					((Said 'talk,talk/man,skull,android')
					...
					(
						(Said
							'get,get,explore,climb[<on,on,up]/bone,android,menace[<metallic]'
						)
