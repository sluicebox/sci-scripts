...
(instance rm071 of Rm
	...
	(method (handleEvent event)
		...
		(if (Said 'look,look[/area,around]')
			(if (== gPrevRoomNum 72)
				(Print 71 0) ; "The climb becomes less steep as you near the bottom of the volcano."
			else
				(Print 71 1) ; "The climb becomes steeper as you near the rim of the old volcano."
			)
		)
	)
)
