...
(instance riddleBookScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager say: 1 27 0 2 self 0) ; "The book contains riddles and has a page missing."
			)
			(2
				(gMessager say: 1 27 0 3 self 0) ; "Alexander glances at a few of the conundrums, but finds himself more curious about the one that is missing."
			)
			(3
				(gMessager say: 1 27 0 4 self 0) ; "What was the riddle, he wonders. More importantly, what was the answer?"
			)
			(4
				(gGame handsOn:)
