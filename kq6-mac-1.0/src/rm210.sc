...
(instance givePoemScr of CartoonScript
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(2
				(cond
					((and (OneOf register 25 26) (== gMsgType 2))
						(gMessager say: 4 32 register 2 giveItemToBirdScr)
					)
					((and (OneOf register 25 26) (!= gMsgType 2))
						(KQ6Print
							font: gUserFont
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(2
				(cond
					((and (OneOf register 25 26) (== gMsgType 2))
						(gMessager say: 4 70 register 2 giveItemToBirdScr)
					)
					((and (OneOf register 25 26) (!= gMsgType 2))
						(KQ6Print
							font: gUserFont
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(2
				(cond
					((and (OneOf register 25 26) (== gMsgType 2))
						(gMessager say: 4 71 register 2 giveItemToBirdScr)
					)
					((and (OneOf register 25 26) (!= gMsgType 2))
						(KQ6Print
							font: gUserFont
		...
		(switch (= state newState)
			...
			(2
				(KQ6Print
					font: gUserFont
					posn: 10 10
					addText: 4 37 10 2 ; "It plays its pleasant, tinny tune."
					init: self
				)
			)
			(3
				(KQ6Print
					font: gUserFont
					posn: 10 10
					addText: 4 37 10 3 ; "The living nightingale in the tree listens to the tune curiously."
					init: self
				)
			)
			(4
		...
		(switch (= state newState)
			...
			(6
				(KQ6Print
					font: gUserFont
					posn: 10 10
					addText: 4 37 11 2 ; "The mechanical nightingale sings a sweet, tinny tune. The real nightingale in the tree cocks her head and listens intently."
					init: self
				)
			)
			(7
			...
			(9
				(KQ6Print
					font: gUserFont
					posn: 10 10
					addText: 4 37 11 3 ; "The nightingale flies to a lower branch and looks at Alexander curiously as if she were deciding that this human might not be so bad."
					init: self
				)
			)
			(10
