		...
		(switch (= state newState)
			...
			(5
				(theConv
					...
					add: -1 4 13 6 5 ; "Things long forgotten are once more uncovered: his enslavement to this throne while still a man; the years of watching misery and horror and growing ever more numb to it; the seep of his own humanity; the slow descent into eternal dark."
