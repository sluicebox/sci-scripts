	...
	(method (doVerb theVerb)
		(if (gCast contains: redQueen)
			...
			(switch theVerb
				...
				(1 ; Look
					(if (and (not (-- local54)) (== gPrevRoomNum 99)) ; speedRoom
						(gEgo get: 6) ; coal
					)
					(super doVerb: theVerb &rest)
				)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(whiteKnight view: 4900 cel: 0 setLoop: 0 stopUpd:)
				(redKnight view: 4900 setLoop: 0 cel: 1 stopUpd:)
				(UnLoad 128 492)
				(UnLoad 128 493)
				(= cycles 2)
			)
			...
			(7
				(whiteKnight view: 4901 setLoop: 0 cel: 0 setCycle: End self)
				(redKnight view: 4901 setLoop: 1 cel: 0 setCycle: End self)
			)
			(8)
			(9
				(whiteKnight view: 4900 setLoop: 2 cel: 0 stopUpd:)
				(redKnight view: 4900 setLoop: 2 cel: 1 stopUpd:)
				(UnLoad 128 492)
				(UnLoad 128 493)
				(= cycles 2)
			)
			...
			(13
				(whiteKnight view: 4901 setLoop: 0 cel: 3 setCycle: Beg self)
				(redKnight view: 4901 setLoop: 1 cel: 3 setCycle: Beg self)
				(UnLoad 128 492)
				(UnLoad 128 493)
			)
			(14)
			(15
				(whiteKnight view: 4900 setLoop: 1 cel: 0 stopUpd:)
				(redKnight view: 4900 setLoop: 1 cel: 1 stopUpd:)
				(UnLoad 128 492)
				(UnLoad 128 493)
				(= cycles 2)
			)
...
(instance knightBoundForward of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= register 0)
				(redKnight view: 493 cel: 0 setLoop: 2 setCycle: End self)
				(whiteKnight view: 492 cel: 0 setLoop: 2 setCycle: End self)
			)
			(1)
			(2
				(= seconds 2)
...
(instance knightBoundBack of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= register 6)
				(redKnight view: 493 setLoop: 1)
				(whiteKnight view: 492 setLoop: 1)
				(= cycles 2)
			)
			(1
				(redKnight cel: register posn: [local34 register] 124)
			...
			(3
				(whiteKnight view: 4900 setLoop: 0 cel: 0 stopUpd:)
				(redKnight view: 4900 setLoop: 0 cel: 1 stopUpd:)
				(UnLoad 128 492)
				(UnLoad 128 493)
				(= cycles 2)
...
(instance White_Queen of Kq6Talker
	...
	(method (init)
		(if (IsFlag 59)
			...
			(self view: 497 loop: 3 x: 140 y: 80 textX: -127 textY: -73)
...
(instance queensLeave of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(redKnight view: 4900 setLoop: 0 cel: 1)
				(whiteKnight view: 4900 setLoop: 0 cel: 0)
				(= ticks 12)
			)
			(3
				(switch register
