...
(instance docoProtect of GatePanel
	...
	(method (init)
		...
		(gEgo view: 2002 loop: 0 cel: 0)
		(gate view: 2002 loop: 0 cel: 0)
		(torch1 view: 2002 loop: 0 cel: 0)
		(torch2 view: 2002 loop: 0 cel: 0)
		(shimmer1 view: 2002 loop: 0 cel: 0)
		(shimmer2 view: 2002 loop: 0 cel: 0)
		(super init: &rest)
	)
