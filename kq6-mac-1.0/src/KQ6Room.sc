...
(class KQ6Room of Rm
	...
	(method (setScript param1 &tmp temp0)
		(cond
			...
			((!= (gEgo view:) 900)
				(KQ6Print font: gUserFont posn: -1 10 say: 7 0 16 1 0 0 0 init:) ; MISSING MESSAGE
			)
			(
				(or
						...
						(cond
							(
								...
								(KQ6Print
									font: gUserFont
									posn: -1 10
									say: 0 0 88 1 0 0 899 ; MISSING MESSAGE
									init:
								)
							)
							((== gCurRoomNum 461) ; blackWidowInset
								(KQ6Print
									font: gUserFont
									posn: -1 10
									say: 0 0 5 1 0 0 899 ; MISSING MESSAGE
									init:
								)
							)
							((= temp0 (localproc_0))
