...
(instance rm480 of KQ6Room
	...
	(method (notify)
		(flower1 view: 4851 loop: 0 cel: 0 stopUpd:)
		(flower2 view: 4851 loop: 0 cel: 0 stopUpd:)
		(flower3 view: 4851 loop: 0 cel: 0 stopUpd:)
		(flower4 view: 4851 loop: 0 cel: 0 stopUpd:)
		(UnLoad 128 4852)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(gates cycleSpeed: 3 setCycle: End)
			)
			(4
...
(instance shyFlowers of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(1
				(gGlobalSound3 number: 484 setLoop: 1 play:)
			...
			(2
				(Face gEgo snap)
				(snap setCycle: Fwd)
				(gGlobalSound4 number: 482 setLoop: 2 play:)
				(= cycles 1)
			)
			(3
...
(instance snappy of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(gGlobalSound4 number: 482 setLoop: 1 play:)
				(snap setCycle: Fwd)
				(= cycles 1)
			)
			(5
...
(instance wallFlowerDance of Script
	...
	(method (handleEvent event)
		(if (OneOf (event type:) evMOUSEBUTTON evKEYBOARD evJOYDOWN)
			(cond
				((== state 9)
					(if gModelessDialog
				...
				((and (== state 11) (User controls:) (& (event type:) evMOVE))
					(event claimed: 1)
					(self cue:)
				)
				(else
	...
	(method (doit)
		(cond
			...
			((and register (== state 11))
				(self cue:)
			)
			((and (> state 6) (< state 12) (== (danceMusic prevSignal:) -1))
				(danceMusic prevSignal: 0)
				(= state 11)
				(gGame handsOn:)
				(self cue:)
			...
			((and (== (danceMusic prevSignal:) 10) (<= state 12) (>= state 6))
				(danceMusic prevSignal: 0)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if ((ScriptID 481 4) handle:) ; cryMusic
					(proc481_6)
					(myBottle setCycle: 0)
					(= local3 1)
				)
