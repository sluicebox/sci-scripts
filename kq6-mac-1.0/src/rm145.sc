...
(instance seqScr of Script
	...
	(method (changeState newState &tmp temp0 [temp1 100])
		(switch (= state newState)
			...
			(1
				(gCurRoom drawPic: 98 (if (== gHowFast 0) 9 else 12))
				(if (IsFlag 41)
			...
			(2
				...
				(genie init:)
				(vizier init:)
				(gCurRoom drawPic: 145 (if (== gHowFast 0) 9 else 11))
				(= cycles 1)
			)
			(3
				(cond
					...
					((== register 1)
						(roomConv
							...
							add: eyeGlintScr
							add: -1 1 0 1 6 ; "(ANGRY) What? I thought I took care of the only means of travel!"
							add: eyeGlintScr
							add: -1 1 0 1 7 ; "By my scimitar, I can't have him stirring things up now!"
							add: eyeGlintScr
							add: -1 1 0 1 8 ; "Get a hold of yourself and listen carefully, Shamir! Go to the other islands and tell them...."
							init: self
						)
						(++ state)
					)
			...
			(4
				(roomConv
					add: -1 1 0 2 7 ; "Confound it! That's the young man Cassima met at Mordack's castle!"
					add: eyeGlintScr
					add: -1 1 0 2 8 ; "The timing could not be worse. Tell me, what is he doing?"
					add: eyeGlintScr
					add: -1 1 0 2 9 ; "He was in the pawn shop buying a magic <hic> smap."
					add: eyeGlintScr
					add: -1 1 0 2 10 ; "Magic smap? What is this magic smap?"
					add: eyeGlintScr
					add: -1 1 0 2 11 ; "With the smap he can travel to the other islands, Master."
					add: eyeGlintScr
					add: -1 1 0 2 12 ; "That's a MAP, you dolt! Drat it all, I thought I took care of the only means of travel!"
					add: eyeGlintScr
					add: -1 1 0 2 13 ; "By my scimitar, I can't have him stirring things up! Not now!"
					add: eyeGlintScr
					add: -1 1 0 2 14 ; "Get a hold of yourself and listen carefully, Shamir! Go to the other islands and tell them...."
					init: self
				)
			)
			(5
