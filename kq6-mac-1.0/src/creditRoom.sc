...
(local
	...
	[local250 50]
	[local300 50]
	[local350 28] = [1 1 9 8 1 2 3 4 1 2 3 4 4 1 3 4 1 3 3 4 1 2 3 4 1 2 1 -1]
	[local378 28] = [98 100 25 130 380 240 150 480 650 520 450 580 160 490 730 690 790 770 260 750 220 470 410 510 210 290 660 -1]
	local406
	local407 = 1
	local408
	local409
		...
		(switch (= state newState)
			...
			(3
				(if local408
					...
					(Message msgGET 94 1 0 0 (++ local407) @local50)
				else
					(Message msgGET 94 0 0 0 local407 @local0)
					(Message msgGET 94 0 0 0 (++ local407) @local50)
				)
				(if (>= (++ local407) 32)
					(= local408 1)
					(= local407 1)
				...
				(switch [local350 local406]
					...
					(8
						(Message msgGET 94 3 0 0 1 @local250) ; "Macintosh Producers:   Dan Carver   Stuart Moulder"
						(Display
							@local250
							dsCOLOR
							7
						...
						(Message msgGET 94 3 0 0 2 @local300) ; "Macintosh Musicians:   Dan Kehler   Rudy Helm"
						(Display
							@local300
							dsCOLOR
							7
