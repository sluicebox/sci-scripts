...
(instance speedTest of Script
	...
	(method (changeState newState &tmp [temp0 200])
		(switch (= state newState)
			...
			(3
				(Message msgGET 98 0 0 0 1 @temp0) ; "This entire work is"
				(Display @temp0 dsCOORD 10 80 dsWIDTH 300 dsCOLOR 6 dsFONT 3110 dsALIGN alCENTER)
				(= seconds 3)
			)
			(4
				(Message msgGET 99 0 0 0 1 @temp0) ; "Copyright Sierra On-Line, Inc. 1992-93."
				(Display @temp0 dsCOORD 0 100 dsWIDTH 320 dsCOLOR 6 dsFONT 3110 dsALIGN alCENTER)
				(= seconds 5)
			)
			(5
				(startGame doit:)
