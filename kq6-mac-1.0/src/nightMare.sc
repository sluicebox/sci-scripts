...
(instance giveHorseBird of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gEgo loop: 2 cel: 0 setCycle: Beg self)
			)
			(6
...
(instance coldEmbers of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(KQ6Print say: 1 0 4 2 posn: 10 10 ticks: 120 modeless: 1 init:)
				(gEgo setCycle: Beg self)
			)
			(5
...
(instance catchNiteMare of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gEgo setLoop: 1 cel: 0 cycleSpeed: 8 setCycle: End self)
			)
			(6
			...
			(28
				(gGlobalSound number: 155 setLoop: -1 play:)
				(gGlobalSound2 fade:)
				(gGlobalSound3 fade:)
				(gGlobalSound4 fade:)
				(= ticks 4)
