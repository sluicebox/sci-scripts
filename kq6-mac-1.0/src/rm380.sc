		...
		(switch (= state newState)
			...
			(11
				(myConv
					...
					add: -1 1 0 1 11 ; "Fate is not like the cut of a blade, young one, but rather like the myriad of paths formed when a hammer cracks ice."
					add: -1 1 0 1 12 ; "I will tell you what I can, but what will actually come to pass is up to you."
					add: -1 1 0 1 13 ; "I see that any attempt to reach the girl will force you into battle, a struggle against a dark force. If you lose, your life will be forfeit."
					add: -1 1 0 1 14 ; "Who must I fight?"
					add: -1 1 0 1 15 ; "A great darkness surrounds your adversary, preventing me from seeing clearly.... I can only make out the shape of a black cloak."
					add: -1 1 0 1 16 ; "But before this final struggle, I see an infiltration--a dangerous game of hide and seek in corridors filled with enemies."
					add: -1 1 0 1 17 ; "The risks are high, but it is the only way to reach the one you seek."
					add: -1 1 0 1 18 ; "There is more than one way into this place. Your choice will dictate much."
					add: -1 1 0 1 19 ; "What else do you see, mighty Oracle?"
					init: self
				)
			)
			(12
			...
			(18
				(myConv
					add: -1 1 0 1 18 ; "There is more than one way into this place. Your choice will dictate much."
					add: -1 1 0 1 19 ; "What else do you see, mighty Oracle?"
					add: -1 1 0 1 20 ; "<gasp> Oooh.... Such pain! I see two restless spirits crying out for revenge."
					add: -1 1 0 1 21 ; "These shades could help you destroy the dark force if they were to be brought back from their spiritual form, yet this is only one possible path to your destiny."
					init: self
				)
			)
			(19
			...
			(20
				(gMessager say: 1 0 1 22 self) ; "I'm afraid this is getting beyond me. I know very little about the afterlife. I can only advise getting counsel from the Druids."
			)
			(21
			...
			(27
				(gMessager say: 1 0 1 23 self) ; "Be warned--the Druids are reclusive and dangerous. They might aid you or they might destroy you. Like their island, the Druid's nature is hidden in the mists."
			)
			(28
				(= cycles 6)
			)
			(29
				(gMessager say: 1 0 1 24 self) ; "There is nothing more I can do for you except to give you this...."
			)
			(30
				(SetFlag 3)
