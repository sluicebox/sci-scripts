...
(instance rm063 of Rm
	...
	(method (doit &tmp temp0)
		...
		(if (and global359 (not (IsFlag 65)) (!= local5 (GetTime 1))) ; SysTime12
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(1
				...
				(Say 73 63 9 67 30 10 25 6) ; "Good-bye, KING Graham of Daventry...heh, heh, heh!"
				(switch global351
					(135
						(= temp0 8)
					)
...
(instance robin of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 63 11) ; "Special thanks to Robin Bradley and the rest of the QA staff."
					(event claimed: 1)
				)
			)
		)
