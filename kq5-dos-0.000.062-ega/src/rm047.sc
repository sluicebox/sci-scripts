				...
				(cond
					((== (sailBoat loop:) 0)
						(cedric
							...
							cel: (if (IsFlag 55) 2 else 1)
						)
					)
					((== (sailBoat loop:) 1)
						(cedric
							posn: (- (sailBoat x:) 23) (+ (sailBoat y:) 4)
							cel: (if (IsFlag 55) 3 else 0)
						)
					)
					((== (sailBoat loop:) 5)
						(cedric
...
(instance rm047 of Rm
	...
	(method (init)
		...
		(if (and (gEgo has: 18) (not (IsFlag 108))) ; Beeswax
			(gEgo posn: 80 130)
			(sailBoat
				init:
				view: 259
...
(instance sink of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (and (not (IsFlag 55)) (not (IsFlag 56)))
					(Say 75 47 1 25 8) ; "Watch out, there's a hole in the boat!"
				)
				(= cycles 1)
			)
			(2
		...
		(switch (= state newState)
			...
			(3
				...
				(if (and (not (IsFlag 56)) (not (IsFlag 55)))
					(Say 75 47 2 25 4 67 8 8 70 160) ; "Graham! Watch out!"
				)
			)
			(4
...
(instance seaMonsterHead of Act
	(properties
		yStep 5
		view 621
		priority 15
...
(instance staticBoat of Act
	(properties
		view 648
	)
)

(instance staticCedric of Act
	(properties
		view 647
		loop 2
		cel 1
