	...
	(method (changeState newState &tmp [temp0 60])
		(switch (= state newState)
			...
			(2
				...
				(= local5
					(Display ; "Cindy Walker Deena Benz Tamra Dayton Dana Dean Roger Hardy, Jr. Harry McLaughlin Jennifer Shontz"
						123
						10
						dsCOORD
						145
			...
			(3
				...
				(Display 123 5 dsRESTOREPIXELS local3)
				(= local3
					(Display ; "Deanna Yhalkee Jim Larsen Cheryl Loyd Jerry Moore Cheryl Sweeney Eric Kasner Hector Martinez Richard D. Zeigler-Martin"
						123
						11
						dsCOORD
						90
			...
			(6
				...
				(= local3
					(Display ; "Robert E. Heitman Jeff Stephenson Pablo Ghenis"
						123
						17
						dsCOORD
						90
			...
			(7
				...
				(Display 123 5 dsRESTOREPIXELS local3)
				(= local3
					(Display ; "Corey Cole Dan Foy John Rettig John Hartin Larry Scott Eric Hart J. Mark Hood"
						123
						18
						dsCOORD
						90
