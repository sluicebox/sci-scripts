...
(instance intro3 of Rm
	...
	(method (init)
		...
		(owl posn: -20 -15 init:)
		(self setScript: sceneThreeScript)
	)
...
(instance sceneThreeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(PrintDC 102 0 #at 100 100 #dispose) ; "My castle! What has happened?"
				(= seconds 4)
			)
			(4
				(cls)
			...
			(8
				(PrintDC 102 1 #at 10 10 #dispose) ; "I can tell you what happened."
				(= seconds 1)
			)
			(9
