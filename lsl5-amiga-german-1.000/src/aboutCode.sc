...
(instance aboutCode of Code
	...
	(method (doit &tmp string)
		...
		(switch
			...
			(1
				(TPrint 15 1 #font gSmallFont #mode 1 #width 222 #title {Sierra Presents}) ; ""Leisure Suit Larry 5: Passionate Patti Does A Little Undercover Work" Executive Producer Ken Williams Creative Director Bill Davis Director Al Lowe Producer Guruka Singh Khalsa"
				(cycleIcon loop: 2)
				...
				(Format @local0 15 9) ; "If you're having a good time playing this game and would like to order other fun products from the Sierra family of computer games, just give our Order Desk a telephone call at 44 734-303322. (International customers call 209-683-4468.) Our friendly and courteous order takers are probably sitting around doing nothing right now and would love to have someone to talk to!"
				(TPrint
					@local0
					#font
					gSmallFont
