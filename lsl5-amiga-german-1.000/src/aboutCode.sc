...
(instance aboutCode of Code
	...
	(method (doit &tmp string)
		...
		(switch
			...
			(1
				(TPrint 15 1 33 gSmallFont 30 1 70 222 80 {Sierra Presents}) ; ""Leisure Suit Larry 5: Passionate Patti Does A Little Undercover Work" Executive Producer Ken Williams Creative Director Bill Davis Director Al Lowe Producer Guruka Singh Khalsa"
				(cycleIcon loop: 2)
