			...
			(3 ; Do
				(if
					...
					(if (== loop 2)
						...
						(TPrint 760 33 #at -1 185) ; "(You had no idea Donald Tramp's birthday was a local holiday!)"
					)
				else
					(gCurRoom
						handleEvent:
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(Say Lana_Luscious_b 760 35 #dispose) ; "Yes," she replies, hesitantly. "Who are you?"
				(= ticks 30)
			)
			(3
				(Say gEgo 760 36) ; "My name is Larry; Larry Laffer," you purr. "I've come a long way to meet you!"
				(Say Lana_Luscious_b 760 37 #dispose) ; "And meet me you have, Larry," says Lana. "Whaddaya say we sit down on that bench over there? These skates are killing me!"
				(= ticks 30)
			)
			(4
...
(instance sLanaTalks of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say Lana_Luscious_a 760 40 #dispose) ; ""Only when I'm trying to find a man," she says with a smile."
				(= ticks 60)
			)
			(2)
			(3
			...
			(4
				(Say Lana_Luscious_a 760 42 #dispose) ; ""Only when I'm here skating," she says with a smile."
				(= ticks 60)
			)
			(5)
			(6
			...
			(7
				(Say Lana_Luscious_a 760 44 #dispose) ; ""If you like that, you should drop by the `Tramp This! Mud Wrestling' Show. I go on in just a few minutes!" she says with a wink."
				(= ticks 60)
			)
			(8)
			(9
			...
			(10
				(Say Lana_Luscious_a 760 46 #dispose) ; "Why, it's in the Tramp Ballroom. The entrance is at the rear of the casino!" she says. "And if you bring a few hundred dollars with you, I'll make sure it's an experience you'll never forget!"
				(= ticks 60)
			)
			(11
				(TPrint 760 47 #at -1 185) ; "(You now understand why Lana was one of the top three finalists back at PornProdCorp!)"
				(= ticks 60)
			)
			(12)
			(13
			...
			(14
				(Say Lana_Luscious_a 760 49 #dispose) ; "Okay, Larry; I'll look forward to it!" she concludes, standing up. "Gotta go get out of my makeup!"
				(= ticks 60)
			)
			(15
				(TPrint 760 50 #at -1 185) ; "(Doesn't she mean "into?")"
				(= cycles 1)
			)
			(16
				(sMeetLana cue:)
...
(instance lanaFtr of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(3 ; Do
				(Say Lana_Luscious_a 760 52 #dispose) ; "Oh, Larry! You know that just drives me crazy!"
			)
			(10 ; Zipper
				(Say Lana_Luscious_a 760 53 #dispose) ; "Larry! Here?" says Lana. "Why don't you come by the Casino later when I'm mud wrestling?"
			)
			(4 ; Inventory
				(Say Lana_Luscious_a 760 54 #dispose) ; "Oh, I have no use for anything you could possibly offer me, Larry," says Lana. "Why, when I have total access to this sun-drenched boardwalk, the fresh ocean breezes caressing my hair, my smell of the salt water and ready access to all the mud I can roll in!"
			)
			(else
				(super doVerb: theVerb &rest)
			)
