...
(instance rm038 of MGRoom
		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					...
					init: 141 150 141 132 168 127 187 120 171 112 160 122 149 126 134 125 128 113 110 114 101 108 84 119 91 124 103 127 116 131 116 150
					yourself:
				)
		)
	...
	(method (handleEvent event)
		(if
			...
			(= global133 1)
			(= global161 1)
			(gEgo setMotion: PolyPath 130 137)
		)
	)
)
