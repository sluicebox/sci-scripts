...
(procedure (localproc_0 param1)
	(Print (proc932_8 16 101 param1 @local1) 33 310 67 -1 15 28 global207)
)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(Print (proc932_8 3 101 3 @local1) #at 112 132 #time 5 #dispose self)
			)
			(4 0)
			(5
				(localproc_1 5 90 80)
			...
			(6
				(gEgo setMotion: MoveTo 370 100 self)
				(Print (proc932_8 4 101 2 @local1) #at 64 28 #time 5 #dispose self)
			)
			(7 0)
			(8
				(localproc_1 5 80 70)
			...
			(9
				(gEgo setMotion: MoveTo 370 100 self)
				(Print (proc932_8 3 101 4 @local1) #at 112 132 #time 5 #dispose self)
			)
			(10 0)
			(11
				(localproc_1 5 70 60)
			...
			(12
				...
				(Print (proc932_8 4 101 3 @local1) #at 64 15 #time 10 #dispose self)
			)
			(13
				(localproc_1 5 50 40)
				(gEgo posn: -20 100 setMotion: MoveTo 80 100 self)
			...
			(14
				(gEgo setMotion: MoveTo 370 100 self)
				(Print (proc932_8 3 101 5 @local1) #at 112 132 #time 5 #dispose self)
			)
			(15 0)
			(16
				(localproc_1 5 40 30)
			...
			(17
				(gEgo setMotion: MoveTo 370 100 self)
				(Print (proc932_8 4 101 4 @local1) #at 64 28 #time 5 #dispose self)
			)
			(18 0)
			(19
				(localproc_1 5 30 0)
