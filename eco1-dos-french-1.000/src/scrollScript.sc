...
(instance scrollScript of Script
	...
	(method (changeState newState &tmp temp0 [temp1 40] [temp41 40])
		(switch (= state newState)
			...
			(2
				(if (HaveMouse)
					(proc932_8 99 5 221 @temp1)
					(proc932_8 99 5 222 @temp41)
					(Display @temp1 dsCOORD 3 50 dsWIDTH 75 dsCOLOR global213 dsALIGN alCENTER dsFONT 300)
					(Display
						@temp41
						dsCOORD
						242
					...
					(proc932_8 99 5 223 @temp1)
					(proc932_8 99 5 224 @temp41)
					(Display @temp1 dsCOORD 3 50 dsWIDTH 75 dsCOLOR global213 dsALIGN alCENTER dsFONT 300)
					(Display
						@temp41
						dsCOORD
