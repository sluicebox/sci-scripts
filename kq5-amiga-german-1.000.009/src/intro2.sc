...
(instance creditsScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(= local3
					(Display 101 5 dsCOORD 70 10 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Designed, Directed and Produced by"
				)
				(= local2
			...
			(6
				(= local3
					(Display 101 7 dsCOORD 121 24 dsWIDTH 195 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Art Designer"
				)
				(= local2
			...
			(10
				(= local3
					(Display 101 11 dsCOORD 11 75 dsWIDTH 140 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Composers"
				)
				(= local2
