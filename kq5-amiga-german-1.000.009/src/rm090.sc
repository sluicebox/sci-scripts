	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(11
				(localproc_0)
				(h3Mouth cue: 1)
				(PrintDC 90 10 #at 60 10 #dispose) ; "You are TOO!"
				(= seconds 2)
			)
			(12
				(localproc_0)
				(h1Mouth cue: 1)
				(PrintDC 90 11 #at 10 -1 #width 120 #dispose) ; "Oh, quit arguing, girls! Let's eat!"
				(= seconds 5)
			)
			(13
				(localproc_0)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(harpy1 setScript: 0)
				(h1Mouth cue: 1)
				(PrintDC 90 12 #at 10 -1 #width 120 #dispose) ; "Trying to escape, huh?"
				(= seconds 3)
			)
			(1
				(localproc_0)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(h3Mouth cue: 1)
				(PrintDC 90 13 #at 10 10 #width 120 #dispose) ; "What's he doing? What's that thing?"
				(= seconds 4)
			)
			(2
				(localproc_0)
				(h2Mouth cue: 1)
				(PrintDC 90 14 #at 225 100 #width 70 #dispose) ; "I don't know but I want it!"
				(= seconds 4)
			)
			(3
				(localproc_0)
			...
			(7
				...
				(h3Mouth cue: 1)
				(h4Mouth cue: 1)
				(PrintDC 90 15 #dispose) ; "Hey, that's not fair! Let's get her, girls!"
				(= seconds 4)
			)
			(8
				(localproc_0)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(localproc_0)
				(h3Mouth cue: 1)
				(PrintDC 90 16 #dispose) ; "What's that he's got?"
				(= seconds 3)
			)
			(1
				(localproc_0)
				(h4Mouth cue: 1)
				(PrintDC 90 17 #dispose) ; "I don't know, and I don't CARE!"
				(= seconds 3)
			)
			(2
				(localproc_0)
		...
		(switch (= state newState)
			...
			(1
				(if (gCast contains: harpy1)
					...
					(PrintDC 90 19) ; "Graham quickly bends down and rescues the fishhook from the ground."
				)
				(= register (gEgo view:))
				(if (== (gEgo view:) 2)
					((gEgo head:) hide:)
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(cls)
					(PrintDC 90 20) ; "Several hungry-looking harpies eye Graham greedily as he frantically looks for a route of escape. Horribly, he sees none."
					(event claimed: 1)
				)
				(3 ; Do
					(cls)
					(PrintDC 90 21) ; "The harpies are vicious creatures whom Graham could never overpower."
					(event claimed: 1)
				)
				(5 ; Talk
					(cls)
					(PrintDC 90 22) ; "The harpies aren't paying any attention to Graham at the moment."
					(event claimed: 1)
				)
			)
		)
			...
			(switch (event message:)
				(2 ; Look
					(if (gCast contains: harpy2)
						(PrintDC 90 23) ; "The sandy path ends at two narrow ledges overhanging the craggy island. Perched upon them, several monstrous harpies stare hungrily at Graham."
					else
						(PrintDC 90 24) ; "The sandy path ends at two narrow ledges overhanging the craggy island."
					)
					(event claimed: 1)
				)
				(4 ; Inventory
					(switch (gInventory indexOf: (gTheIconBar curInvIcon:))
						...
						(else
							(cond
								...
								((== local22 1000)
									(cls)
									(PrintDC 90 25) ; "The hideous harpies don't pay any attention to it."
									(event claimed: 1)
								)
								(else
									(HandsOff)
...
(instance island of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 90 26) ; "In the distance, Graham can see a few islands."
					(event claimed: 1)
				)
			)
		)
...
(instance fishhook of Prop
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 90 27) ; "Half-hidden in the coarse island grass Graham notices an old fishhook."
					(event claimed: 1)
				)
				(3 ; Do
					(HandsOff)
