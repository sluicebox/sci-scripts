...
(instance aboutCode of Code
	...
	(method (doit &tmp temp0 [temp1 300])
		...
		(Print (Format @temp1 0 13) #mode 1 #width 120) ; "Castle of Dr. Brain was: Programmed by Corey Cole Brett Miller Jack Magne' John Wentworth Steve Conrad"
		(Print (Format @temp1 0 14) #mode 1 #width 120) ; "Art and Animation by Andy Hoyos Dennis Lewis Douglas Herring Vasken Nokhoudian Dana Dean Jerry Jessurun Deena Krutak Arturo Sinclair Bob Gleason Jay Allan Friedmann Jon Bock Diana Wilson John Shroades"
		(Print (Format @temp1 0 15) #mode 1 #width 120) ; "Music and Sound Effects by Ken Allen Mark Siebert Chris Braymen Rob Atesalp Orpheus Hanley"
		(Print (Format @temp1 0 16) #mode 1 #width 120) ; "Development System by Jeff Stephenson Robert E. Heitman Pablo Ghenis J. Mark Hood Larry Scott Dan Foy Mark Wilden Eric Hart Terry McHenry John Rettig Chris Smith Chad Bye Ken Koch John Crane Steve Coallier Randy Moss"
		(Print (Format @temp1 0 17) #mode 1 #width 120) ; "Quality Assurance Lead by Sharon Simmons Dave Clingman"
		(Print (Format @temp1 0 18) #mode 1 #width 120) ; "Amiga Implementation by Steven Coallier Chris Carr Jerry Shaw"
		(Print (Format @temp1 0 19) #mode 1 #width 120) ; "Amiga Art Conversion by Phyllis Cucchiara"
		(Print (Format @temp1 0 20) #mode 1 #width 120) ; "Amiga Music Arrangement by Aubrey Hodges"
		(Print (Format @temp1 0 21) #mode 1 #width 120) ; "Amiga Quality Assurance by Robin Bradley Roger Clendenning, Jr. Gary Cox Judy Crites Jason Hickingbottom Joe Perry Mike Pickhinke"
		(Print 0 22 #width 250) ; "And if you think THIS was a challenge, try the "Quest for Glory" role-playing/adventure series by Lori and Corey Cole. In "Quest for Glory I: So You Want to Be a Hero", you are the only one who can fulfill a mysterious prophecy and save the town of Spielburg. In "Quest for Glory II: Trial By Fire", you travel to the magical lands of the Arabian Nights tales as you battle elemental creatures to help your friends and stop the growing darkness."
		(Print 0 23 #width 250) ; "Both games feature stunning graphics, fantastic music tracks, fascinating characters, and rich story lines. Not to mention a healthy dose of fun and general silliness. You play each game as your choice of a Fighter, Magic User, Thief, or hybrid character. Also watch for "Quest for Glory III: Wages of War", set in the African veldt, coming Summer 1992. But now, back to the Castle of Dr. Brain!"
