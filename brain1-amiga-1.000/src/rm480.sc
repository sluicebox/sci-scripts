...
(instance toonScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(Format @local16 480 1 [local7 (/ gScore 25)] gScore) ; "You've achieved the %s score of %d points on my little puzzles."
			...
			(10
				(Print 480 4 #at 63 136 #time 5 #dispose self) ; "Director/Designer/Lead Programmer, and my alter-ego:"
			)
			(11
				(display2 stopUpd:)
				(= cycles 1)
			...
			(12
				(= local4 (proc5_12 {Corey Cole} 67 0 47 28 18))
				(leftScreen setLoop: 1 setCycle: Osc)
				(= ticks 300)
			)
			(13
				(proc5_12 local4)
			...
			(14
				(localproc_1)
				(Print 480 5 #at 63 136 #time 5 #dispose self) ; "My esteemed Producer, who helped us to bring the castle in on time and under budget:"
			)
			(15
				(= local5 (proc5_12 {Stuart Moulder} 67 234 58 28 18))
			...
			(16
				(proc5_12 local5)
				(localproc_2)
				(Print 480 6 #at 63 136 #time 5 #dispose self) ; "My art Production Designer (we'll let him out soon):"
			)
			(17
				(= local4 (proc5_12 {Andy Hoyos} 67 -2 49 28 18))
				(leftScreen setLoop: 2 setCycle: Osc)
				(= ticks 240)
			)
			(18
				(proc5_12 local4)
				(localproc_1)
				(Print 480 7 #at 63 136 #time 4 #dispose self) ; "The Art Designer (he already got out!):"
			)
			(19
				(= local5 (proc5_12 {Douglas Herring} 67 224 53 28 18))
				(rightScreen setLoop: 2 setCycle: Osc)
				(= ticks 240)
			)
			(20
				(proc5_12 local5)
				(localproc_2)
				(Print 480 8 #at 93 136 #time 4 #dispose self) ; "My Composers: "Whadidya say? I can't see you?""
			)
			(21
				(= local4 (proc5_12 {Mark Seibert} 67 0 47 28 18))
				(= local5 (proc5_12 {Ken Allen} 67 255 58 28 18))
			...
			(22
				(proc5_12 local4)
				(proc5_12 local5)
				(= local4 (proc5_12 {Chris Braymen} 67 0 50 28 18))
				(= local5 (proc5_12 {Rob Atesalp} 67 255 58 28 18))
			...
			(24
				(localproc_1)
				(localproc_2)
				(Print 480 9 #at 63 136 #time 4 #dispose self) ; "Digitized sounds constructed by:"
			)
			(25
				(= local4 (proc5_12 {Orpheus Hanley} 67 0 47 28 18))
			...
			(26
				...
				(localproc_1)
				(localproc_2)
				(Print 480 10 #at 63 136 #time 6 #dispose self) ; "And here are some of my artist friends! They have helped me decorate this beautiful castle! The animators:"
			)
			(27
				(= local4 (proc5_12 {Vasken Nokhoudian} 67 0 50 28 18))
				(= local5 (proc5_12 {Dana Dean} 67 260 58 28 18))
			...
			(29
				(= local4 (proc5_12 {Deena Krutak} 67 0 47 28 18))
				(= local5 (proc5_12 {Arturo Sinclair} 67 264 58 28 18))
			...
			(31
				(= local4 (proc5_12 {Jerry Jessurun} 67 1 47 28 18))
				(= local5 (proc5_12 {Bob Gleason} 67 239 58 28 18))
			...
			(33
				(= local4 (proc5_12 {Jay Allan Friedmann} 67 -3 50 28 18))
				(= local5 (proc5_12 {Jon Bock} 67 227 58 28 18))
			...
			(35
				(= local4 (proc5_12 {Diana Wilson} 67 0 47 28 18))
			...
			(36
				(proc5_12 local4)
				(localproc_1)
				(Print 480 11 #at 63 136 #time 5 #dispose self) ; "And here are some MORE of my artist friends! The background artists:"
			)
			(37
				(= local4 (proc5_12 {Dennis Lewis} 67 0 47 28 18))
				(= local5 (proc5_12 {John Shroades} 67 249 58 28 18))
			...
			(38
				...
				(localproc_1)
				(localproc_2)
				(Print 480 12 #at 63 136 #time 6 #dispose self) ; "Let's not forget my number one Amiga artist. Without her, the castle would look like a pale shadow of its beautiful self:"
			)
			(39
				(= local4 (proc5_12 {Phyllis Cucchiara} 67 -4 50 28 18))
				(leftScreen view: 1001 setLoop: 2)
				(localproc_2)
				(= ticks 180)
			)
			(40
				(proc5_12 local4)
				(localproc_2)
				(Print 480 13 #at 63 136 #time 6 #dispose self) ; "I also know some programmers! Without them, I would have had a hard time putting my little challenges together!"
			)
			(41
				(= local4 (proc5_12 {Jack Magne'} 67 0 50 28 18))
				(= local5 (proc5_12 {Brett Miller} 67 262 58 28 18))
				(leftScreen view: 481 setLoop: 10 setCycle: Osc)
			...
			(43
				(= local4 (proc5_12 {John Wentworth} 67 -4 50 28 18))
				(= local5 (proc5_12 {Steve Conrad} 67 242 58 28 18))
				(leftScreen view: 481 setLoop: 11)
			...
			(45
				(localproc_1)
				(localproc_2)
				(Print 480 14 #at 63 136 #time 6 #dispose self) ; "Of course, it wouldn't be wise to build an Amiga castle without a Guru. Mine took two:"
			)
			(46
				(= local4 (proc5_12 {Steve Coallier} 67 242 58 28 18))
				(= local5 (proc5_12 {Jerry Shaw} 67 -4 50 28 18))
				(rightScreen view: 1000 setLoop: 2)
				(leftScreen view: 1001 setLoop: 0)
				(= ticks 300)
			)
			(47
				(proc5_12 local4)
			...
			(48
				(localproc_1)
				(localproc_2)
				(Print 480 15 #at 63 136 #time 5 #dispose self) ; "My Quality Assurance Leads: Making sure the castle is as clean as can be!"
			)
			(49
				(= local4 (proc5_12 {Dave Clingman} 67 -4 50 28 18))
				(= local5 (proc5_12 {Sharon Simmons} 67 242 58 28 18))
			...
			(51
				(= local4 (proc5_12 {Robin Bradley} 67 242 58 28 18))
				(= local5 (proc5_12 {Gary Cox} 67 -4 50 28 18))
				(rightScreen view: 1000 setLoop: 1)
				(leftScreen view: 1001 setLoop: 1)
				(= ticks 360)
			)
			(52
				(proc5_12 local4)
			...
			(53
				...
				(localproc_1)
				(localproc_2)
				(Print 480 16 #at 63 136 #time 5 #dispose self) ; "Finally, special credit for Design Assistance and Necessary Discipline must surely go to:"
			)
			(54
				(= local4 (proc5_12 {Lori Ann Cole} 67 -4 50 28 18))
			...
			(55
				...
				(proc5_12 local4)
				(localproc_1)
				(Print 480 17 #at 63 136 #time 5 #dispose self) ; "But now it's time for me to devise a new set of challenges for you, my clever lab assistant!"
			)
			(56
				(Print 480 18 #at 80 136 #time 5 #dispose self) ; "Which means I must be off to the ..."
			)
			(57
...
(instance trailerScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(= local6 (Display 480 19 dsCOORD 80 80 dsFONT 200 dsCOLOR 0 dsSAVEPIXELS)) ; "I ' L L  B E  B A C K !"
				(= ticks 60)
			)
			(14
				(gCMusic setVol: 6)
			...
			(16
				(Display 480 20 dsRESTOREPIXELS local6)
				(= gQuit 1)
			)
		)
	)
