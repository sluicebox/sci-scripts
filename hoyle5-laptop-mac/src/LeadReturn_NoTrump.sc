...
(class LeadReturn_NoTrump of BridgeDefense
	...
	(method (think param1 &tmp temp0 temp1 temp2 temp3 [temp4 3] temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14 temp15 temp16 temp17 temp18 temp19 temp20 temp21)
		(super think: &rest)
		(= temp20 (curPlyr RHO:))
		...
		(for ((= temp14 1)) (<= temp14 4) ((++ temp14))
			(= [local24 temp14] (curPlyr countSuit: temp14))
		)
		(cond
			((== (param1 size:) 1)
				(= theCard (param1 at: 0))
			...
			(
				(or
					(and (> [local0 1] 1) [local24 1] (= temp0 1))
					(and (> [local0 2] 1) [local24 2] (= temp0 2))
					(and (> [local0 3] 1) [local24 3] (= temp0 3))
					(and (> [local0 4] 1) [local24 4] (= temp0 4))
				)
				(if
					(or
						(< [local24 temp0] 3)
						(and
							...
							(> (pard countSuit: temp0) [local24 temp0])
						)
					)
					(self play: temp0 12)
				else
			...
			(
				(or
					(and
						(or
							(= temp21 (self gotSequence: curPlyr 1 10 2))
							(= temp21 (self gotSequence: curPlyr 1 0 2))
						)
						(= temp0 1)
					)
					(and
						(or
							(= temp21 (self gotSequence: curPlyr 3 10 2))
							(= temp21 (self gotSequence: curPlyr 3 0 2))
						)
						(= temp0 3)
					)
					(and
						(or
							(= temp21 (self gotSequence: curPlyr 2 10 2))
							(= temp21 (self gotSequence: curPlyr 2 0 2))
						)
						(= temp0 2)
					)
					(and
						(or
							(= temp21 (self gotSequence: curPlyr 4 10 2))
							(= temp21 (self gotSequence: curPlyr 4 0 2))
						)
						(= temp0 4)
					)
				)
