...
(class LeadSeat_Trump of BridgeDefense
	...
	(method (think &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13)
		...
		(for ((= temp3 1)) (<= temp3 4) ((++ temp3))
			(= [local17 temp3] (curPlyr countSuit: temp3))
		)
		(switch trumps
			(1
				(= temp8 topCl)
		...
		(cond
			...
			(
				(and
					(or
						(and (> [local6 1] 2) (== [local17 1] 1) (= temp0 1))
						(and (> [local6 2] 2) (== [local17 2] 1) (= temp0 2))
						(and (> [local6 3] 2) (== [local17 3] 1) (= temp0 3))
						(and (> [local6 4] 2) (== [local17 4] 1) (= temp0 4))
					)
					(localproc_2 curPlyr)
				)
				(self play: temp0)
			...
			(
				(or
					(and (> [local6 1] 2) (== [local17 1] 2) (= temp0 1))
					(and (> [local6 2] 2) (== [local17 2] 2) (= temp0 2))
					(and (> [local6 3] 2) (== [local17 3] 2) (= temp0 3))
					(and (> [local6 4] 2) (== [local17 4] 2) (= temp0 4))
				)
				(self play: temp0 12)
			)
			(
			...
			(
				(or
					(and (== [local6 1] 2) [local17 1] (= temp0 1))
					(and (== [local6 2] 2) [local17 2] (= temp0 2))
					(and (== [local6 3] 2) [local17 3] (= temp0 3))
					(and (== [local6 4] 2) [local17 4] (= temp0 4))
				)
				(if
					(or
						(= temp13 (self gotSequence: curPlyr temp0 10 2))
