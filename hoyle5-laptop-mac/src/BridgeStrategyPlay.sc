...
(class BridgeStrategyPlay of Code
		...
		(if
			(or
				(>
					(proc710_0 2 param2)
					(Max
						(LHO countSuit: param2)
						(RHO countSuit: param2)
					)
				)
				(>
					(proc710_0 3 param2)
	...
	(method (verifiedCard param1 &tmp temp0 temp1)
		(= temp0 (gTrick suitLead:))
		(= temp1 param1)
		(if (and param1 (curPlyr countSuit: temp0) (!= (param1 suit:) temp0))
			(= temp1 (self bottomCard: temp0))
		)
		(if (not param1)
			(if (curPlyr countSuit: temp0)
				(= temp1 (self bottomCard: temp0))
			else
				(= temp1 (curPlyr at: (Random 0 (- (curPlyr size:) 1))))
			)
		)
		(return temp1)
	)
