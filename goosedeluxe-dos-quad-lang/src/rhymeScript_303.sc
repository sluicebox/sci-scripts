				...
				(cond
					...
					((== gLanguage 2)
						(proc0_16
							(temp0
								format:
									{Petit Tom chantait pour gagner son repas}
							)
						)
					)
					((== gLanguage 3)
			...
			(10
				(cond
					...
					((== gLanguage 2)
						(proc0_16
							(temp0
								format: {On lui a donn$ du pain sec et de l'eau}
							)
						)
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {Ich kann auch spielen,}))
					)
					(else
						(proc0_16
							(temp0
				...
				(cond
					...
					((== gLanguage 2)
						(proc0_16
							(temp0
								format:
									{Comment couper son pain quand on n'a pas de couteau?}
							)
						)
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {die kleine Fl8te:}))
					)
					(else
						(proc0_16
							(temp0
				...
				(cond
					...
					((== gLanguage 2)
						(proc0_16
							(temp0
								format:
									{Et comment boire du vin quand on a que de l'eau!}
							)
						)
					)
					((== gLanguage 3)
						(proc0_16
							(temp0 format: {t9 t9 t9 t9, t9 t9 t9 t9 ...})
						)
					)
					(else
						(proc0_16
