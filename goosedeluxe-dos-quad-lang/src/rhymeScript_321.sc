		...
		(switch (= state newState)
			...
			(5
				(cond
					...
					((== gLanguage 1)
						(proc0_16 (temp0 format: {Hab^a una viejecita}))
					)
					((== gLanguage 2)
						(proc0_16 (temp0 format: {Il $tait une vieille femme}))
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {Kommt alle her zu Tisch!}))
					)
					(else
			...
			(6
				(if (< (rhymeSync prevSignal:) 20)
					...
					(cond
						...
						((== gLanguage 2)
							(proc0_16
								(temp0 format: {qui vivait dans une chaussure})
							)
						)
						((== gLanguage 3)
							(proc0_16
								(temp0 format: {Kommt alle her zu Tisch!})
							)
						)
						(else
				...
				(cond
					...
					((== gLanguage 2)
						(proc0_16
							(temp0
								format:
									{elle avait tout plein de p'tits enfants}
							)
						)
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {Brot und Kuchen essen wir;}))
					)
					(else
			...
			(8
				(cond
					...
					((== gLanguage 2)
						(proc0_16 (temp0 format: {et m3me pas de toiture.}))
					)
					((== gLanguage 3)
						(proc0_16
							(temp0 format: {Milch und Kaffee trinken wir.})
						)
					)
					(else
			...
			(9
				(cond
					...
					((== gLanguage 1)
						(proc0_16 (temp0 format: {Les dio un poco de consom$}))
					)
					((== gLanguage 2)
						(proc0_16
							(temp0 format: {Tous les soirs elle leur donnait})
						)
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {Kommt alle her zu Tisch!}))
			...
			(10
				(cond
					...
					((== gLanguage 2)
						(proc0_16
							(temp0 format: {un peu de soupe et des gXteaux})
						)
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {Kommt alle her zu Tisch!}))
			...
			(11
				(cond
					...
					((== gLanguage 1)
						(proc0_16 (temp0 format: {les bes& muy dulcemente,}))
					)
					((== gLanguage 2)
						(proc0_16
							(temp0 format: {en disant: "mes petits ch$ris})
						)
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {Kommt alle her zu Tisch!}))
			...
			(12
				(cond
					...
					((== gLanguage 1)
						(proc0_16 (temp0 format: {y les acost&.}))
					)
					((== gLanguage 2)
						(proc0_16
							(temp0 format: {c'est l'heure d'aller faire dodo!"})
						)
					)
					((== gLanguage 3)
						(proc0_16 (temp0 format: {Kommt alle her zu Tisch!}))
