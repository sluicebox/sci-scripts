...
(instance pickEgo of Room
	...
	(method (init &tmp temp0 temp1)
		...
		(switch gLanguage
			(1
				(= gMacSaveNumber (Save 5 {MGS} (temp1 data:) (temp0 data:))) ; GetSaveFiles
			)
			(2
				(= gMacSaveNumber (Save 5 {MGF} (temp1 data:) (temp0 data:))) ; GetSaveFiles
			)
			(3
				(= gMacSaveNumber (Save 5 {MGG} (temp1 data:) (temp0 data:))) ; GetSaveFiles
			)
			(0
				(= gMacSaveNumber (Save 5 {MGE} (temp1 data:) (temp0 data:))) ; GetSaveFiles
			)
		)
		(temp0 dispose:)
		(temp1 dispose:)
