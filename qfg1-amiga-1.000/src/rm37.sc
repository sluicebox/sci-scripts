					...
					((Said 'talk,ask>')
						...
						(cond
							...
							(
								(or
									(Said 'in<go,come')
									(Said '/portcullis,gate<open,lift')
								)
								(if (localproc_0)
									(= local11 0)
									(if local0
							...
							((Said '/daughter,elsa')
								(if (localproc_0)
									(HighPrint 37 53) ; "Elsa von Spielburg was a lovely young child with braided blond hair and bright blue eyes, like her mother, the Baroness, used to have."
							...
							((Said '/misfortune,curse')
								(if (localproc_0)
									...
									(HighPrint 37 60) ; "He spoke the words,  'Hear me, oh mighty Baron. Thou hast angered me, and thus you are cursed. All that you value you shall lose; all that you treasure shall be taken from you.' The captain then dissolved into a pool of sticky blackness."
								)
							)
							((Said '/jester,yorick')
								(if (localproc_0)
							...
							((Said '/baba')
								(if (localproc_0)
									(HighPrint 37 62) ; "This powerful Ogress is the cause of all the Baron's misfortune. She is a vile creature who knows much magic."
								)
							)
							((Said '/prize')
								(if (localproc_0)
