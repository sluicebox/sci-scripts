...
(instance sCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say gEgo 480 0 #dispose self #at -1 28) ; "Larry? What's that bulge in your leisure suit?"
			)
			(2
				(= ticks 30)
			)
			(3
				(TPrint 480 1 #title {Larry} #dispose self #at -1 28) ; "Oh, Patti! Oh. I know what you mean. Why those are just some miniature video tapes I recorded while on the road."
			)
			(4
				(= ticks 30)
			)
			(5
				(Say gEgo 480 2 #dispose self #at -1 28) ; "Hey, fun! That'll give us something to watch at Camp David!"
			)
			(6
				(= ticks 30)
			)
			(7
				(TPrint 480 3 #title {The Vice President} #dispose self #at -1 28) ; ""I just love home movies!" chimes in the Vice President."
			)
			(8
				(= ticks 30)
			)
			(9
				(TPrint 480 4 #title {Larry} #dispose self #at -1 28) ; "Uh, Patti, er, Sir, ah, I don't think... Oh, never mind," Larry says. "Grab your glasses everyone. Patti, I propose a toast to us--and to our wonderful future together!"
			)
			(10
				(= ticks 30)
			)
			(11
				(Say gEgo 480 5 #dispose self #at -1 28) ; "Excellent, Larry. Yes--to a great week-end!!"
			)
			(12
				(= ticks 30)
			)
			...
			(19
				(TPrint 480 6 #at -1 28) ; "And so, all's well that ends well?"
				(TPrint 480 7) ; "Well, well!"
				(= seconds 3)
			)
			(20
				(TPrint 480 8 #at -1 15 #width 280) ; "It seems all your "work" videotaping those girls was for naught. Silas Scruemall, producer of "America's Sexiest Home Videos," decided to "simplify the audition process" by magnanimously awarding the show's hostess gig to his current girlfriend."
			...
			(21
				(TPrint 480 10 #at -1 15 #width 280) ; "Congress never did get around to doing anything to "clean up the airwaves.""
			...
			(22
				(TPrint 480 12 #at -1 15 #width 280) ; "After a lengthy trial that increased tabloid sales nationwide, Julius Bigg was found innocent of all charges related to his incident at the White House dinner."
			...
			(23
				(TPrint 480 14 #at -1 15 #width 280) ; "Reverse Biaz soon found himself out of a job when des Rever Records went bankrupt."
			...
			(24
				(TPrint 480 16 #at -1 15 #width 280) ; "K-RAP became a national sensation when they expanded by buying a small television station outside of Atlanta and a 24-hour satellite channel."
			...
			(25
				(TPrint 480 18 #at -1 15 #width 280) ; "The Mob's pornography business continued its steady decline."
				(TPrint 480 19) ; "But they'll find newer, more profitable investments somewhere."
				(= seconds 3)
			)
			(26
				(TPrint 480 20 #at -1 15 #width 280) ; "Piano bars continue to change into karaoke bars and the entertainment industry remains exactly as honest as it has always been."
				(= seconds 3)
			)
			(27
			...
			(28
				(TPrint 480 22 #at -1 185) ; "...at least for the weekend!"
				(= seconds 3)
			)
			(29
			...
			(40
				(gCurRoom drawPic: 1 13)
				(if (DoSound sndGET_AUDIO_CAPABILITY)
					(TPrint 480 23 #title {AL says} #at -1 28) ; "Now would be an excellent time for you to save your game. We have a little surprise in store for you."
				)
				(= seconds 5)
			)
			(41
