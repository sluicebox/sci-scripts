...
(instance sWakeUpAthens of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(TPrint 320 19 #at -1 15 #width 280) ; "You awaken with a start to hear the stewardess say..."
...
(instance sWakeUpVenice of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				(TPrint 320 23 #at -1 15 #width 280 #dispose self) ; "Awakening from your dream, you realize you just filled your lap with complimentary beverage!"
			)
			(12
				(= ticks 30)
			)
...
(instance sDreamTaj of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(1
				(TPrint 320 24 #dispose self #at -1 15 #width 280) ; "In your dream, you are watching Passionate Patti perform a rock concert before the reflecting pool of the Taj Mahal! What a great musician! What a romantic setting! What a gorgeous babe!!"
			)
			(2
				(= ticks 90)
			)
...
(instance sWakeUpTaj of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(5
				(TPrint 320 26 #at -1 15 #width 280 #dispose) ; "You soon realize the snake is not the only thing Patti has charmed!"
...
(instance sDreamVenice of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(9
				(TPrint 320 31 #at -1 15 #width 280) ; "Deciding to seize the moment, you wriggle down beside your Patti, relying on the subtle canal currents to propel you through your night of love..."
				(= ticks 30)
			)
			(10
				(= dreaming 0)
