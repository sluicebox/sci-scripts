	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Say Michelle_Milken 535 26 #dispose) ; "Good evening, Lawrence," she says, "I'm Michelle Milken, program-trading specialist and sometime computer hobbyist."
			)
			(2
				...
				(Say Michelle_Milken 535 28 #dispose #caller self) ; "Oh, really?" asks Michelle. "Does that mean you have lots of money?"
			)
			(3
				...
				(Say Michelle_Milken 535 30 #dispose) ; "I laugh all the way to and from the bank!" she says with a grin. "I'm a junk bond dealer."
			)
			(4
				(Say gEgo 535 31 #at -1 185) ; ""So, what does a junk bond dealer do?" you ask."
				(Say Michelle_Milken 535 32 #dispose #caller self) ; ""Whatever she can," Michelle replies cryptically."
			)
			(5
				...
				(Say Michelle_Milken 535 34 #dispose) ; "Junk bonds, eh?" she warms perceptibly. "Why I was just telling a friend about them today. Yes, I think they would be perfect for someone like you!"
			)
			(6
				(Say gEgo 535 35 #at -1 185) ; "Really? I always thought investments like that were too risky for an ordinary guy like me!"
				(Say Michelle_Milken 535 36 #dispose #caller self) ; "Larry, no one I know would ever admit to thinking that you are in any way, shape, or form, `ordinary!'"
			)
			(7
				(Say Michelle_Milken 535 37 #dispose #caller self) ; "So, do you have any cash-equivalent funds lying about, just gathering whatever conservative interest rate you're presently earning?"
			)
			(8
			...
			(9
				...
				(Say Michelle_Milken 535 40 #dispose #caller self) ; "And consider it I do, Larry," Michelle replies. "In fact, perhaps I could open your account right now."
			)
			(10
				(Points 5 115)
...
(instance michelle of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(10 ; Zipper
				(Say Michelle_Milken 535 45 #dispose) ; "Hmmm," says Michelle, with a coy smile, "that's an idea!"
			)
			(4 ; Inventory
				(switch invItem
					(12 ; Money
					...
					(else
						(Say Michelle_Milken 535 47 #dispose) ; "Oh, no thanks, Larry," responds Michelle. "I have no idea what I'd do with that."
					)
				)
			)
			(5 ; Talk
...
(instance tits of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Say Michelle_Milken 535 48 #dispose) ; "You really enjoy staring at me there, don't you, Larry?"
			)
			(3 ; Do
