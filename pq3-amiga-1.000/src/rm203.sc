...
(procedure (localproc_2 param1 param2 param3 param4 param5 &tmp [temp0 200])
	(if (u< param1 1000)
		(GetFarText param1 param2 @temp0)
	else
		(StrCpy @temp0 param1)
		...
		(switch (= state newState)
			...
			(1
				(if local8
					...
					(localproc_0 504 (+ local6 1) 62 30 200 global125)
					(localproc_0 ; "SUSPECT -"
						203
						7
						190
					...
					(localproc_0 504 (+ 5 local6) 239 30 40 global125)
					(localproc_0 ; "DATE -"
						203
						8
						10
					...
					(localproc_0 504 (+ 3 local6) 127 40 30 global125)
					...
					(localproc_0 504 (+ 4 local6) 250 40 60 global125)
		...
		(switch (= state newState)
			...
			(1
				(if local8
					...
					(if (IsFlag 74)
						(localproc_0 504 (+ 12 local6) 239 30 75 global125)
					else
						(localproc_0 504 (+ 5 local6) 239 30 40 global125)
					)
					(localproc_0 ; "DATE -"
		...
		(switch (= state newState)
			...
			(1
				(if local8
					...
					(localproc_0 504 (+ 5 local6) 239 30 70 global125)
					(localproc_0 ; "DATE -"
						203
						8
						10
...
(instance touchPad of Feature
	...
	(method (init param1)
		(no1 init: param1 stopUpd:)
		(no2 init: param1 stopUpd:)
		(no3 init: param1 stopUpd:)
		(no4 init: param1 stopUpd:)
		(no5 init: param1 stopUpd:)
		(no6 init: param1 stopUpd:)
		(no7 init: param1 stopUpd:)
		(no8 init: param1 stopUpd:)
		(no9 init: param1 stopUpd:)
		(no10 init: param1 stopUpd:)
		(super init:)
	)
		...
		(switch (= state newState)
			...
			(5
				(cond
					...
					(else
						(localproc_2 203 30 20 170 200) ; "No Match"
						(= cycles 1)
					)
				)
			)
