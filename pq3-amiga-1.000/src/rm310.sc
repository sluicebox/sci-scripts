...
(instance endScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(localproc_1 {Phyllis Cucchiara} {AMIGA CONVERSION ARTIST:\n})
				(= seconds 3)
			)
			(7
				(localproc_1
			...
			(8
				(localproc_1 {Dan Kehler} {AMIGA MUSIC AND SOUND ARRANGEMENT:})
				(= seconds 3)
			)
			(9
			...
			(11
				(localproc_1 {Dave Fleming} {QUALITY ASSURANCE:\n\n})
				(= seconds 3)
			)
			(12
				(localproc_1
					{Robin Bradley\nMike Brosius\nRoger Clendenning, Jr.\nDave Clingman\nGary Cox\nJudy Crites\nJason Hickingbottom\nJoe Perry}
