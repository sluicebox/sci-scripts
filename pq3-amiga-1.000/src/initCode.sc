...
(instance initCode of Code
	...
	(method (doit param1 param2 param3)
		...
		(if (and (>= (= global102 (Graph grGET_COLOURS)) 2) (<= global102 32))
			(ClearFlag 2)
		else
			(SetFlag 2)
		)
		...
		(param1
			color: global118
			back: (proc0_15 global123 global120 global120)
			topBordColor: global125
			lftBordColor: (proc0_15 global124 global125 global125)
			rgtBordColor: (proc0_15 global122 global121 global119)
			botBordColor: (proc0_15 global121 global121 global119)
		)
		(param3
			color: global119
			back: (proc0_15 global123 global120 global120)
		...
		(param2
			color: global119
			back: (proc0_15 global121 global120 global120)
			topBordColor: (proc0_15 global123 global125 global125)
			lftBordColor: (proc0_15 global122 global125 global125)
			rgtBordColor: (proc0_15 global120 global121 global119)
			botBordColor: (proc0_15 global119 global121 global119)
			insideColor: global155
			topBordColor2: global119
			lftBordColor2: global119
			botBordColor2: (proc0_15 global123 global125 global125)
			rgtBordColor2: (proc0_15 global124 global125 global125)
			botBordHgt: 25
		)
		(DisposeScript 879)
	)
