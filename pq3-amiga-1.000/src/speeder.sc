...
(instance theCar of Actor
	(properties
		...
		approachY 133
		_approachVerbs 24
		lookStr {The convertible has only one occupant. There's nothing unusual looking about him.}
		view 337
		signal 16384
	)
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(3 ; Do
				(Print 887 15) ; "What are you going to do? Kick the tires?"
			)
			(else
				(super doVerb: theVerb)
			)
