...
(instance gcWin of SysWindow
	...
	(method (open &tmp temp0 [temp1 4] temp5 [temp6 20] temp26)
		...
		(DrawCel 995 2 1 (proc0_16 148 152 154 151 151) (- local2 12) 15)
		(DrawCel
			995
			2
			2
			(proc0_16 164 177 179 195 195)
			(proc0_16
				(+ local1 3)
				(+ local1 2)
				(+ local1 3)
		...
		(DrawCel 995 2 3 (proc0_16 214 212 213 232 232) (- local2 12) 15)
