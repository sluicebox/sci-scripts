...
(local
	...
	[local143 105] = [55 104 130 176 224 114 153 195 230 67 96 155 155 183 232 259 259 148 179 205 234 119 172 214 253 46 78 106 175 208 226 274 274 116 140 190 215 124 142 171 211 47 94 107 156 186 221 276 276 82 130 177 230 86 139 198 236 103 120 134 152 189 189 202 213 110 129 129 160 191 210 210 210 79 123 145 208 219 229 239 97 129 147 147 178 208 228 228 228 96 113 163 175 206 228 228 228 228 228 228 228 325 325 325 325]
	[local248 105] = [55 121 152 198 235 102 135 211 252 43 69 143 143 202 231 253 278 138 174 220 243 95 144 205 257 56 93 118 153 195 238 265 265 122 160 186 219 98 131 191 227 68 84 129 163 186 209 237 237 131 167 213 231 74 109 169 240 42 81 114 159 190 232 268 268 103 128 128 161 196 219 219 219 68 97 135 165 186 207 249 86 122 146 146 180 215 237 237 237 99 129 155 171 217 217 217 217 217 217 217 217 325 325 325 325]
	[local353 105] = [55 120 175 219 235 97 127 184 242 49 65 65 118 148 194 236 236 140 171 207 228 60 148 212 258 87 96 104 119 138 182 227 227 127 157 185 209 88 120 193 223 32 42 84 115 182 215 272 272 116 182 230 250 69 138 190 235 42 71 95 131 166 232 270 270 103 128 128 161 196 219 219 219 71 123 164 202 226 236 246 86 122 146 146 180 215 237 237 237 78 107 146 168 225 225 225 225 225 225 225 225 325 325 325 325]
	[local458 100]
	[local558 100]
	[local658 200]
)
...
(instance rm170 of FPRoom
	...
	(method (init)
		...
		(cond
			((<= gScore 939)
				(Message msgGET 170 2 0 0 2 @local558) ; "out of 999 points! Not bad fer a tenderfoot!"
			)
			((and (>= gScore 940) (<= gScore 998))
				(Message msgGET 170 2 0 0 3 @local558) ; "out of 999 points! Hold yer head up high, Buckaroo!"
			)
			((>= gScore 999)
				(Message msgGET 170 2 0 0 4 @local558) ; "out of 999 points! Yer mama'd be so proud!"
			)
		)
		(Message msgGET 170 2 0 0 1 @local458) ; "Copyright (c) 1993 Sierra On-Line. Copyright (c) 1993 Screw Loose Amusements. Thank you for playing FREDDY PHARKAS, FRONTIER PHARMACIST.  You done REAL good, kid!  Yer final score wuz"
		(Format @local658 {%s %d %s\n} @local458 gScore @local558)
		(SetQuitStr @local658)
		...
		(if (and (event type:) (== gCurRoomNum gNewRoomNum))
			...
			(switch
				(Print
					...
					addButton: 2 3 0 0 2 (proc0_16 54 58 54 60 60) 0 170 ; "Restart"
					addButton: 0 3 0 0 3 (proc0_16 125 162 125 120 120) 0 170 ; "Continue"
					addButton: 3 3 0 0 4 (proc0_16 179 220 179 179 179) 0 170 ; "Quit"
					init:
				)
				(0
					(gGameMusic1 pause: 0)
