	...
	(method (changeState newState &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 [temp10 40] [temp50 40] [temp90 40] [temp130 40] [temp170 40] [temp210 40] [temp250 40] [temp290 40] [temp330 40] [temp370 40])
		(switch (= state newState)
			...
			(1
				...
				(= temp0 (localproc_0 (proc0_16 110 98 92 110 110) @temp10 1207))
				(= temp1 (localproc_0 (proc0_16 110 98 92 110 110) @temp50 1207))
				(= temp2 (localproc_0 (proc0_16 110 98 92 110 110) @temp90 1207))
				(= temp3
					(localproc_0 (proc0_16 110 98 92 110 110) @temp130 1207)
				)
				(= temp4
					(localproc_0 (proc0_16 110 98 92 110 110) @temp170 1207)
				)
				(= temp5
					(localproc_0 (proc0_16 110 98 92 110 110) @temp210 1207)
				)
				(= temp6
					(localproc_0 (proc0_16 110 98 92 110 110) @temp250 1207)
				)
				(= temp7
					(localproc_0 (proc0_16 110 98 92 110 110) @temp290 1207)
				)
				(= temp8
					(localproc_0 (proc0_16 110 98 92 110 110) @temp330 1207)
				)
				(= temp9
					(localproc_0 (proc0_16 110 98 92 110 110) @temp370 1207)
				)
				(= local2 global135)
				(if
					(==
						(= global135
							(Print
								...
								addButton:
									...
									@temp170
									temp4
									(proc0_16 60 69 70 60 60)
								addButton:
									185
									@temp210
									temp5
									(proc0_16 75 84 85 75 75)
								addButton:
									548
									@temp250
									temp6
									(proc0_16 90 99 100 90 90)
								addButton:
									323
									@temp290
									temp7
									(proc0_16 105 114 115 105 105)
								addButton:
									501
									@temp330
									temp8
									(proc0_16 120 129 130 120 120)
								addButton:
									660
									@temp370
									temp9
									(proc0_16 135 144 145 135 135)
								init:
							)
						)
						0
