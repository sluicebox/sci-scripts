...
(procedure (localproc_0 param1 param2 param3)
	(if (<= (GetDistance param2 (- param3 10) (param1 x:) (param1 y:)) local6)
		(return 1)
	else
		(return 0)
	)
			...
			(1
				...
				(switch
					(Print
						...
						addButton: 1 15 0 0 1 (proc0_16 0 20 30 0 0) 0 550 ; "Pardner, I could outgun the Magnificent Seven! Bring 'em on!"
						addButton: ; "Well, I won at tiddly-winks the other day. I'll give it m'best shot."
							2
							15
							0
							0
							2
							(proc0_16 0 5 20 0 0)
							(proc0_16 30 30 42 30 30)
							550
						addButton: ; "Let's face it, I'm a wuss."
							3
							15
							0
							0
							3
							(proc0_16 0 40 20 0 0)
							(proc0_16 72 60 84 60 60)
							550
						init:
					)
					(0
