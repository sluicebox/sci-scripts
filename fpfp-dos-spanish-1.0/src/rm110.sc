			...
			(7
				...
				(switch
					(Print
						...
						addButton: 2 19 0 0 6 (proc0_16 47 55 55 55 55) 0 0 ; "Prologue"
				...
				(if local1
					(switch
						(Print
							...
							addButton: 1 4 0 0 1 (proc0_16 0 40 0 0 0) 0 110 ; "Sierra Customer Service"
							addButton: 2 5 0 0 1 (proc0_16 0 65 0 0 0) 17 110 ; "Sierra Sales"
							addButton: 3 6 0 0 1 (proc0_16 0 55 0 0 0) 34 110 ; "Sierra Technical Support"
							addButton: ; "Technical Trouble-Shooting Tips"
								4
								7
								0
								0
								1
								(proc0_16 0 55 0 0 0)
								(proc0_16 51 51 63 51 51)
								110
							addButton: ; "Warranty Information"
								5
								8
								0
								0
								1
								(proc0_16 0 25 0 0 0)
								(proc0_16 68 68 80 68 68)
								110
							addButton: ; "Game Hints"
								6
								9
								0
								0
						...
						(1
							(gMessager say: 11 0 0 0 self) ; "Call Sierra Customer Service for inquiries about returned merchandise, back orders, defective merchandise, company policy, and general game information. You can call Sierra Customer Service at |c2|(800) 743-7725|c|, 8:15 A.M. - 4:45 P.M. Pacific time, Monday-Friday."
						)
						(2
							(gMessager say: 12 0 0 0 self) ; "To place an order with Sierra On-Line, call |c2|(800) 326-6654|c| from 7:00 a.m. through 7:00 p.m. Pacific Time, Monday through Friday, for convenient, person-to-person service."
						)
						(3
							(gMessager say: 13 0 0 0 self) ; "Technical assistance is only a telephone call away. Call |c2|(209) 683-8989|c| for convenient, person-to-person service. If you prefer, you may request assistance by fax |c0|(209) 683-3633|c| or mail."
						)
						(4
