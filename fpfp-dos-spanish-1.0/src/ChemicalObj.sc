...
(procedure (proc625_0 param1 &tmp [temp0 100] [temp100 4])
		...
		(cond
			((and (== (param1 objName:) 41) (== (param1 form:) 29))
				(switch (gGame printLang:)
					(34
						(Format @temp0 {%s (3 %s)} (param1 name:) {p\a1ldoras})
					)
					(else
	...
	(TextSize @[temp100 0] @temp0 2107 -1 0)
							...
							((and (== objType 4) (!= objName 40))
								...
								(switch gCurPuzzle
									...
									(8
										(ClearFlag 104)
										(= global143 1)
										(gMessager say: 34 0 33 0 self) ; "Frederick! Oh, Frederick!"
									)
									(9
										(if
											(and
