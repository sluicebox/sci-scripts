			...
			(1
				...
				(switch
					(Print
						...
						addButton: 1 4 0 0 1 (proc0_16 0 22 28 0 0) 0 540 ; "I'm one bad hombre! Do your worst!"
						addButton: ; "I'm feelin' pretty tough. But don't bust my chops."
							...
							0
							2
							(proc0_16 0 15 28 0 0)
							(proc0_16 30 30 18 18 18)
							540
						addButton: ; "I had too much tequila last night! Go easy!"
							...
							0
							3
							(proc0_16 0 22 20 0 0)
							(proc0_16 72 60 48 48 48)
							540
						init:
					)
					(0
