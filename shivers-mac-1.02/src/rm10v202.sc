...
(instance efExitBack of ExitFeature
	...
	(method (init)
		(self
			createPoly: 0 0 73 77 171 5 192 15 188 70 127 140 119 139 81 120 73 77 0 0 0 143 263 143 263 0
		)
		(super init: &rest)
	)
)
...
(instance hsPurseOpen of HotSpot
	...
	(method (init)
		(self
			createPoly: 121 140 69 115 56 70 87 48 92 51 103 87 162 38 153 27 91 50 87 48 151 1 155 1 184 20 186 65 184 72 127 138
		)
		(super init: &rest)
	)
