...
(instance hsStage of HotSpot
	...
	(method (init)
		(self
			createPoly: 82 117 82 88 88 82 88 32 82 28 82 12 182 12 182 28 177 33 177 83 183 88 183 117
		)
		(super init: &rest)
	)
...
(instance efExitCloseUp of ExitFeature ; UNUSED
	...
	(method (init)
		(self
			createPoly: 74 21 74 35 86 42 87 92 76 101 76 128 184 128 184 102 173 92 174 42 186 37 186 22 75 22
		)
		(super init: &rest)
	)
)
