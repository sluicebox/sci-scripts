...
(instance efExitForward of ExitFeature
	...
	(method (init)
		(self
			createPoly: 133 141 132 192 134 43 64 43 64 118 71 118 75 123 71 132 70 141 133 141
		)
		(super init: &rest)
	)
)
...
(instance efExitDesk of ExitFeature
	...
	(method (init)
		(self
			createPoly: 135 132 134 95 204 94 206 88 221 91 216 97 240 105 240 132 135 132
		)
		(super init: &rest)
	)
)
