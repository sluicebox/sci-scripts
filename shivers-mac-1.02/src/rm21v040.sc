...
(instance efExitForwardPlaque of ExitFeature
	...
	(method (init)
		(self
			createPoly: 128 85 148 85 147 116 156 118 158 120 158 122 156 125 137 126 122 123 122 120 124 117 127 116 128 85
		)
		(super init: &rest)
	)
)
...
(instance efExitForwardLeftPlaque of ExitFeature
	...
	(method (init)
		(self
			createPoly: 22 130 30 137 30 141 2 146 0 145 0 90 9 90 21 101 21 105 11 107 11 129 21 130
		)
		(super init: &rest)
	)
)
