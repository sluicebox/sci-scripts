...
(instance efExitForwardRight of ExitFeature
	...
	(method (init)
		(self
			createPoly: 166 38 220 38 220 45 207 112 206 141 135 141 135 45 158 45 166 38
		)
		(super init: &rest)
	)
)
...
(instance efExitForwardLeft of ExitFeature
	...
	(method (init)
		(self
			createPoly: 130 45 129 142 54 142 48 70 54 52 52 46 63 32 123 32 124 37 130 44
		)
		(super init: &rest)
	)
)
