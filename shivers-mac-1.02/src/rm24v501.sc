...
(instance efExitBack of ExitFeature
	...
	(method (init)
		(self
			createPoly: 0 1 261 1 261 143 1 143 0 2 32 11 32 94 229 94 229 11 32 11
		)
		(super init: &rest)
	)
)
...
(instance efExitBook of ExitFeature
	...
	(method (init)
		(self
			createPoly: 161 15 127 18 130 44 156 47 151 73 174 68 201 66 219 52 225 43 163 15 160 15
		)
		(super init: &rest)
	)
)
...
(instance efExitMerrPointing of ExitFeature
	...
	(method (init)
		(self
			createPoly: 93 41 152 48 147 74 142 77 128 77 124 47 98 50 92 44 92 41
		)
		(super init: &rest)
	)
)
