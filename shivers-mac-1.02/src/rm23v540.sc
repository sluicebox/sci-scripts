...
(instance efExitForward of ExitFeature
	...
	(method (init)
		(self
			createPoly: 157 134 159 127 168 119 166 109 178 83 178 19 75 27 74 107 67 118 80 131 155 131
		)
		(super init: &rest)
	)
)
...
(instance efExitPlaque of ExitFeature
	...
	(method (init)
		(self
			createPoly: 0 94 29 91 39 104 23 107 27 137 40 142 13 142 16 137 0 109 0 95
		)
		(super init: &rest)
	)
)
