...
(instance efExitRight of ExitFeature
	...
	(method (init)
		(self
			createPoly: 192 143 191 125 198 123 203 109 243 112 243 0 263 0 263 143
		)
		(super init: &rest)
	)
)
...
(instance efExitForward of ExitFeature
	...
	(method (init)
		(self
			createPoly: 107 135 106 51 133 52 167 56 178 56 178 104 175 104 171 111 161 109 139 111 139 117 149 119 149 138
		)
		(super init: &rest)
	)
)
