...
(instance efExitBack of ExitFeature
	...
	(method (init)
		...
		(self
			createPoly: 0 0 34 0 34 140 237 140 237 114 224 105 224 16 213 2 263 2 263 143 0 143 0 0
		)
		(super init: &rest)
	)
)
...
(instance hsNote of HotSpot
	...
	(method (init)
		(self
			createPoly: 35 0 35 139 236 139 236 115 223 105 223 17 212 3 212 0 35 0
		)
		(super init: &rest)
	)
