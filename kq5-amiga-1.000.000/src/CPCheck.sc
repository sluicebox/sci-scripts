...
(procedure (localproc_3 param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14 temp15 temp16 temp17 temp18 [temp19 2] [temp21 504])
	(gGame setCursor: (if (HaveMouse) 999 else gNarrator) 1)
	...
	(repeat
		...
		(while
			(and
				(not (& (= temp7 ((= temp6 (Event new:)) type:)) evMOUSEBUTTON))
...
(instance CPCheck of Code
	...
	(method (doit param1 param2 &tmp temp0 [temp1 250] temp251)
		(= temp251 (gGame setCursor: gNormalCursor))
		(if (u< param1 1000)
