...
(instance johnnyBoss of Script
	...
	(method (doit)
		(if (and local0 (not (-- local0)))
			(Print 377 0) ; "You can play by moving the cursor with your direction keys and then hitting ENTER. Also, you can move the cursor using a mouse and then click for the ENTER."
		)
		(super doit:)
	)
