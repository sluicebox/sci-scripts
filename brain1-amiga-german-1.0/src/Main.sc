...
(procedure (proc0_1 param1 param2 param3)
	(if (< param1 0)
		(= param1 0)
	)
	(if (> param1 255)
...
(instance Brain of Game
	...
	(method (init &tmp [temp0 15])
		...
		(gTheIconBar
			...
			eachElementDo: #lowlightColor (proc0_1 21 9 29)
			helpIconItem: icon9
		)
		...
		(gGameControls
			...
			add:
				...
				iconHelp
			eachElementDo: #highlightColor 0
			eachElementDo: #lowlightColor (proc0_1 19 3 29)
	...
	(method (startRoom param1)
		...
		(if
			(and
				...
				(proc5_9 0 3 81 {Who cares} 0 81 {Debug} 1)
			)
			(SetDebug)
		)
...
(instance gcWin of BorderWindow
	...
	(method (open &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 [temp14 25] [temp39 4])
		(self
			...
			back: (proc0_1 21 11 29)
			topBordColor: (proc0_1 23 31 20)
			lftBordColor: (proc0_1 23 31 20)
			rgtBordColor: (proc0_1 18 8 28)
			botBordColor: (proc0_1 17 8 28)
			priority: 15
		)
		(super open:)
		(DrawCel
		...
		(= temp12 15)
		(= temp6 0)
		(= temp8 (proc0_1 17 7 28))
		(= temp11 (proc0_1 18 7 28))
		(= temp10 (proc0_1 22 8 29))
		(= temp9 (proc0_1 23 8 29))
		(= temp1 3)
		(= temp7 3)
		...
		(proc5_18)
		(Format @temp14 0 9 gScore gPossibleScore gScore gPossibleScore) ; "Score: %d of %d"
		...
		(Display
			...
			999
			dsCOLOR
			(proc0_1 21 global130 global130)
			dsCOORD
			(+
				10
				(CelWide (proc0_4) 1 1)
	...
	(method (doit &tmp temp0 temp1 [temp2 700])
		(switch
			...
			(1
				...
				(gSystemWindow back: (proc0_1 44 11 29))
				(Print (Format @temp2 0 13) #mode 1 #width 120) ; "German Amiga Version: Producer: Sabine Duvall Programmed by: Gary Kamigawachi Sean T. Mooney William R. Shockley Translation: J\81rg Baumann Gaby Kohli Quality Assurance: Gordon B. Owens Roger M. Pyle"
				(Print (Format @temp2 0 14) #mode 1 #width 120) ; "Amiga Version: Programmed by: Steven Coallier Chris Carr Jerry Shaw Art Conversion Phyllis Cucchiara Music Arrangement Aubrey Hodges"
				(Print (Format @temp2 0 15 gVersion gVersion) #mode 1 #width 120) ; "Castle of Dr. Brain Version %s Designed and Directed by Corey Cole Art Design by Andy Hoyos Lead Artist Douglas Herring"
				(Print (Format @temp2 0 16) #mode 1 #width 120) ; "Castle of Dr. Brain was: Programmed by Corey Cole Brett Miller Jack Magne' John Wentworth Steve Conrad"
				(Print (Format @temp2 0 17) #mode 1 #width 120) ; "Art and Animation by Andy Hoyos Dennis Lewis Douglas Herring Vasken Nokhoudian Dana Dean Jerry Jessurun Deena Krutak Arturo Sinclair Bob Gleason Jay Allan Friedmann Jon Bock Diana Wilson John Shroades"
				(Print (Format @temp2 0 18) #mode 1 #width 120) ; "Music and Sound Effects by Ken Allen Mark Siebert Chris Braymen Rob Atesalp Orpheus Hanley"
				(Print (Format @temp2 0 19) #mode 1 #width 120) ; "Development System by Jeff Stephenson Robert E. Heitman Pablo Ghenis J. Mark Hood Larry Scott Dan Foy Mark Wilden Eric Hart Terry McHenry John Rettig Chris Smith Chad Bye Ken Koch John Crane Steve Coallier Randy Moss"
				(Print (Format @temp2 0 20) #mode 1 #width 120) ; "Quality Assurance Lead by Sharon Simmons Dave Clingman"
				(Print 0 21 #width 255) ; "And if you think THIS was a challenge, try the "Quest for Glory" role-playing/adventure series by Lori and Corey Cole. In "Quest for Glory I: So You Want to Be a Hero", you are the only one who can fulfill a mysterious prophecy and save the town of Spielburg. In "Quest for Glory II: Trial By Fire", you travel to the magical lands of the Arabian Nights tales as you battle elemental creatures to help your friends and stop the growing darkness."
				(Print 0 22 #width 255) ; "Both games feature stunning graphics, fantastic music tracks, fascinating characters, and rich story lines. Not to mention a healthy dose of fun and general silliness. You play each game as your choice of a Fighter, Magic User, Thief, or hybrid character. Also watch for "Quest for Glory III: Wages of War", set in the African veldt, coming Summer 1992. But now, back to the Castle of Dr. Brain!"
