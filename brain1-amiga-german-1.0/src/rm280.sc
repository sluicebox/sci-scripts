		...
		(cond
			((== theVerb 2)
				(if 1
					...
					(proc5_14 280 36 global408 global409)
					(Memory memFREE global408)
					(Memory memFREE global409)
				)
			)
	...
	(method (dispatchEvent event &tmp temp0 temp1 temp2)
		(if (== (event type:) evKEYBOARD)
			...
			(switch (event message:)
				...
				(KEY_q
					(Print 280 52 #at 68 96 #width 200) ; "KEYBOARD COMMANDS: f - Forward......o - turn On b - Backward......t - Turn off l - Left......d - Delete r - Right......i - Insert s - Save......p - Previous command c - Clear......n - Next command q - Quick look at this list"
				)
				(else
					(= temp1 0)
				)
