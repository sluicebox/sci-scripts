...
(instance toonScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(12
				(= local4 (proc5_12 {Sabine Duvall} 67 -4 50 28 18))
			...
			(15
				(= local4 (proc5_12 {Gary Kamigawachi} 67 -10 45 28 18))
			...
			(19
				(= local4 (proc5_12 {William R. Shockley} 67 -4 50 28 18))
				(= local5 (proc5_12 {Sean T. Mooney} 67 240 55 28 18))
			...
			(21
				...
				(localproc_2)
				(leftReels stopUpd:)
				(Print 480 7 #at 63 136 #time 5 #dispose self #mode 1) ; "German Translator:"
			)
			(22
				(= local4 (proc5_12 {J\81rg Baumann} 67 -4 50 28 18))
				(leftScreen view: 483 setLoop: 8 setCycle: Osc)
				(= ticks 300)
			)
			(23
				(proc5_12 local4)
			...
			(25
				(= local4 (proc5_12 {Gordon Owens} 67 -4 50 28 18))
...
(instance trailerScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(= local6 (Display 480 22 dsCOORD 80 80 dsFONT 200 dsCOLOR 0 dsSAVEPIXELS)) ; "I ' L L  B E  B A C K !"
				(= ticks 60)
			)
			(14
				(gCMusic setVol: 6)
