...
(instance rm720 of LarryRoom
	...
	(method (init &tmp temp0)
		(super init: &rest)
		(ClearFlag 100)
		(gNarrator x: 10 y: 100 talkWidth: 295)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo put: 5) ; bracelet
				(gMessager sayRange: 1 16 0 1 11 self) ; "Shamara, I brought you this sterling silver bracelet. I hope you like it."
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo put: 28) ; orchid
				(gMessager sayRange: 1 13 0 1 5 self) ; "I want you to have this flower."
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo put: 29) ; pearl
				(gMessager sayRange: 1 29 0 1 14 self) ; "Shamara, I think you should have this pearl."
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo put: 10) ; diamond
				(gMessager sayRange: 1 23 0 1 5 self) ; "Shamara, I hope you like this diamond. It was a "gift" from a "friend" of mine."
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gMessager sayRange: 1 28 0 1 6 self) ; "I have this, uh, object..."
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gMessager sayRange: 1 53 0 1 4 self) ; "Shamara, there's something I simply must tell you. May I whisper in your ear?"
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(gEgo put: 23) ; lamp
				(gMessager sayRange: 1 41 0 1 3 self) ; "For you, Shamara!"
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Palette 2 80 254 register) ; PalIntensity
				(= ticks 2)
			)
			(2
				(self dispose:)
...
(instance giveChampagneScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager sayRange: 1 20 1 2 15 self) ; "Oh yes, Larry, I would love to. I just hope that I can somehow find a way to express my appreciation for all you've done for me."
			)
			(3
				(gMessager say: 1 20 1 16 self) ; "You're a virgin!!"
			)
			(4
				(gMessager sayRange: 1 20 1 17 24 self) ; "(DOES TAKE TO CAMERA) (Heh, heh, heh.)"
			)
			(5
				(if
					(or
...
(instance windSFX of Sound ; UNUSED
	(properties
		flags 1
		number 270
		loop -1
