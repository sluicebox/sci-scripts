...
(instance impressSoap of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gMessager sayRange: 27 50 12 1 2 self 85) ; "Good idea. That lifeguard will never notice you making an impression of his key in your bar of soap from this height!"
			)
			(2
				(soapInset setLoop: 1)
				(= seconds 3)
