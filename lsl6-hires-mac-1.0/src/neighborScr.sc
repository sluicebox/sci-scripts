...
(instance poundScr1 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= register 6)
				(proc79_11 1002 1144 421)
				(= cycles 2)
			)
			(1
				(switch register
					(6
						(sfx number: 1002 loop: 1 play:)
					)
					(4
