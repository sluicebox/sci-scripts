...
(instance rm320 of LarryRoom
	...
	(method (init &tmp temp0)
		...
		(vacuum init:)
		(motorRope init:)
		(grease init: approachVerbs: 4 2 5 6 39) ; Do, Talk, Take, Zipper, lamp
		(hose init:)
		(fan init: approachVerbs: 4 2 5 6 setPri: 30) ; Do, Talk, Take, Zipper
		(cond
...
(instance fan of Prop
	...
	(method (doVerb theVerb &tmp temp0)
		...
		(if (Message msgGET 320 2 theVerb 0 1 (temp0 data:))
...
(instance stenchTimer of Timer
	...
	(method (cue)
		(if (not (proc79_14))
			(if (not (Random 0 1))
				(gMessager say: 0 0 2 0 0 320) ; "Jai! Carrrrrumba! I think you need me!"
			else
				(gMessager say: 0 0 10 0 0 390) ; "Ei! Carrumba!! What is that horrrrrible ca-ca smell?"
			)
			(SetFlag 108)
		else
			(self setReal: self 3)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(if (and (IsFlag 55) (not (IsFlag 108)))
...
(instance getEnemaScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(19
				(gEgo view: 324 setLoop: 1 1 setCel: 0)
				(UnLoad 128 900)
				(rose setMotion: MoveTo 281 134 self)
			)
			(20
				(UnLoad 128 324)
				(gEgo view: 900 setLoop: -1 loop: 8 setCel: 0)
			...
			(31
				(gEgo view: 328 setLoop: 0 1 setCel: 0 setCycle: 0)
				(UnLoad 128 900)
				(= cycles 2)
			)
			(32
			...
			(33
				(gMessager sayRange: 12 0 1 7 8 self) ; "I will make you experience feelings you never knew before!"
			)
			(34
			...
			(36
				(rose view: 323 setLoop: 0 1 setCel: 0 setCycle: CT 1 1 self)
			)
			(37
				(motorRope hide:)
			...
			(43
				(gMessager sayRange: 12 0 1 9 10 self) ; "You'll feel like a new man!"
			)
			(44
			...
			(69
				(gMessager sayRange: 12 0 1 11 13 self) ; "Are you ready for a good time?"
			)
			(70
				(= ticks 120)
			)
			...
			(76
				(UnLoad 128 323)
				(gEgo view: 903 setLoop: 0 1 setCel: 0 setCycle: End self)
			)
			(77
				(SetFlag 74)
			...
			(78
				...
				(UnLoad 128 903)
				(gEgo view: 321 setLoop: 0 1 setCel: 0 setCycle: CT 5 1 self)
			)
			(79
				(gEgo setPri: 120 setCycle: End self y: 88)
			...
			(81
				(gMessager sayRange: 12 0 1 15 16 self) ; "Finally, Larry!"
			)
			(82
				(gEgo view: 326 setLoop: 0 1 setCel: 0 setCycle: CT 3 1 self)
			)
			(83
			...
			(91
				...
				(gMessager say: 12 0 1 18 self) ; "AAAAAEEEEEAAAAA!!!"
				(= register 5)
				(= ticks 60)
			)
			(92
				(UpdateScreenItem ((ScriptID 92 3) view: 1903 loop: 0 cel: 1)) ; larryTBust
				(UnLoad 128 326)
				(gEgo
					view: 327
					setLoop: 0 1
			...
			(104
				...
				(Print
					font: gUserFont
					addText: 12 0 1 20 5 1 320 ; "A Few Hours Later..."
					modeless: 2
					init:
				)
				(= ticks 300)
			...
			(105
				...
				(hose init:)
				(rose view: 329 setLoop: 0 setCel: 0 x: 154 y: 120 setCycle: 0)
				(wirlpool
					view: 320
					setLoop: 10
					setCel: 0
			...
			(107
				(gMessager sayRange: 12 0 1 21 24 self) ; "Rose, I've never felt more emotions in such a short period of time!"
			)
			(108
				(rose setCycle: CT 2 1 self)
			)
			(109
				(gMessager say: 12 0 1 25 self) ; "Why, Rose, what a beautiful orchid. It's... it's... it's so "prom night!""
			)
			(110
				(rose setCycle: End self)
			)
