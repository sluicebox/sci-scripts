...
(procedure (localproc_0)
	...
	((= gGameControls fakeControl)
		...
		okIconItem: iconOKF
		add:
			(volumeSliderF theObj: gGame selector: #masterVolume yourself:)
			(playerSpeedSliderF
			...
			(attitudeSliderF theObj: attitudeSliderF selector: #doit yourself:)
			(iconVolumeHotF theObj: iconVolumeHotF selector: #doit yourself:)
			(iconResponseHotF
	...
	(if (not (or global916 global921))
		(gGameControls
			add:
				(iconNoFrillsF theObj: iconNoFrillsF selector: #doit yourself:)
				(iconCharactersF
