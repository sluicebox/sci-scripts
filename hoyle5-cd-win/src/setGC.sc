...
(procedure (localproc_1)
	...
	(gGameControls
		...
		add:
			...
			(iconResponseHot theObj: iconResponseHot selector: #doit yourself:)
			(iconPaceHot theObj: iconPaceHot selector: #doit yourself:)
			(attitudeSlider theObj: attitudeSlider selector: #doit yourself:)
			(iconAttitudeHot theObj: iconAttitudeHot selector: #doit yourself:)
			(iconNoFrills theObj: iconNoFrills selector: #doit yourself:)
			(iconCharacters theObj: iconCharacters selector: #doit yourself:)
