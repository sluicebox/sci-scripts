...
(procedure (proc402_0 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8)
	...
	(for ((= temp4 0)) (< temp4 (gWL size:)) ((++ temp4))
		...
		(if (temp1 rating:)
			...
			(if
				(or
					(and (> gGinRummyTurnCount 4) (>= temp2 10))
					(and (> gGinRummyTurnCount 5) (>= temp2 9))
					(and (> gGinRummyTurnCount 6) (>= temp2 8))
					(and (> gGinRummyTurnCount 7) (>= temp2 7))
				)
				(temp1 offRating: (- (temp1 offRating:) (- gGinRummyTurnCount 4)))
			)
		)
	)
)
