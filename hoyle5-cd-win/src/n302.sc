...
(procedure (localproc_0)
	(return
		(or
			(and
				(!= (global501 cardList:) (global117 at: 1))
				(== ((global117 at: 1) takeAllPlayer:) (global501 cardList:))
			)
			(and
				(!= (global501 cardList:) (global117 at: 2))
				(== ((global117 at: 2) takeAllPlayer:) (global501 cardList:))
			)
			(and
				(!= (global501 cardList:) (global117 at: 3))
				(== ((global117 at: 3) takeAllPlayer:) (global501 cardList:))
			)
		)
	)
)
...
(procedure (localproc_4 param1 &tmp temp0 temp1)
	...
	(while (< temp1 global527)
		(if
			(and
				(!= temp1 (global117 indexOf: (global501 cardList:)))
...
(procedure (localproc_5 &tmp temp0 temp1 temp2)
	(= temp0 0)
	(for
		((= temp1 (+ (global117 indexOf: (Dealer curPlayer:)) 1)))
		(<= temp1 (+ (global117 indexOf: (Dealer curPlayer:)) 3))
		((++ temp1))
		...
		(if
			(and
				((global117 at: temp2) outOf: 3)
				(or
					(global501 queenSpades:)
					global503
					((global117 at: temp2) outOf: 0)
				)
			)
			(++ temp0)
		)
...
(procedure (localproc_14 &tmp temp0 temp1 temp2)
	...
	(for ((= temp2 0)) (< temp2 global527) ((++ temp2))
		(if
			(and
				(!= (= global520 (global117 at: temp2)) global501)
				global520
