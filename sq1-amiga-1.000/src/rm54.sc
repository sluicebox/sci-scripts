	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(Print 54 11) ; "Fearing discovery by one of the ship's residents, you cleverly decide to hide in the trunk. As you close the lid, you hear the sounds of someone, or thing, entering the room."
				(vent hide:)
				(gCurRoom drawPic: 99 7)
				(Print 54 12) ; "Suddenly the trunk begins to move!"
...
(instance egoTestVent of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(Print 54 13) ; "Your hands by themselves are incapable of opening it."
				(gEgo
...
(instance cantReachIt of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 54 14) ; "You feel a fresh breeze coming through the grill of the vent. If you were a lot taller, you could touch the grill itself."
				(gEgo setCycle: Beg self)
			)
			(4
				(proc703_1)
...
(instance killEgoTimeOut of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Print 54 15) ; "It sounds like someone (or something) is approaching."
				(= seconds 20)
			)
			(2
				(Print 54 16) ; "You hear footsteps approaching and they're getting close. You might only have seconds to do something!"
				(= seconds 10)
			)
			(3
				(= local0 1)
...
(instance killEgo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(EgoDead 945 0 0 54 17) ; "Bingo! He got you. You might consider not being around when these guys are shooting. Those things hurt."
				(self dispose:)
			)
		)
	)
