...
(instance driveCloseUp of View
	...
	(method (init)
		(= view (proc0_19 150 1100 150 150 150))
		(super init:)
...
(class CompProp of Prop
	...
	(method (init)
		(self view: (proc0_19 150 1100 150 150 150))
		(super init: &rest)
	)
)
