...
(procedure (localproc_0)
	(if (== global927 0)
		(hand1 startRank: 3 cardsUp: 7)
		(hand2 startRank: 3 cardsUp: 7)
		(hand3 startRank: 3 cardsUp: 7)
		(hand4 startRank: 3 cardsUp: 7)
		(hand5 startRank: 3)
		(hand6 startRank: 3)
		(hand7 startRank: 3)
		(hand8 startRank: 3)
	else
		(hand1 startRank: 1 cardsUp: 6)
		(hand2 startRank: 1 cardsUp: 6)
		(hand3 startRank: 1 cardsUp: 6)
		(hand4 startRank: 1 cardsUp: 6)
		(hand5 startRank: 1)
		(hand6 startRank: 1)
		(hand7 startRank: 1)
		(hand8 startRank: 1)
...
(instance eightoff of HoyleRoom
	(properties
		style 14
	)
	...
	(method (dispose &tmp temp0)
		...
		(res1Hand release: dispose:)
		(res2Hand release: dispose:)
		(res3Hand release: dispose:)
		(res4Hand release: dispose:)
		(res5Hand release: dispose:)
		(res6Hand release: dispose:)
		(res7Hand release: dispose:)
		(res8Hand release: dispose:)
		(theHands dispose:)
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(5
				...
				(res5Empty setPri: 1 init: show:)
				(res6Empty setPri: 1 init: show:)
				(res7Empty setPri: 1 init: show:)
				(res8Empty setPri: 1 init: show:)
				(if (== global927 0)
					(res1Empty setPri: 1 init: show:)
					(res2Empty setPri: 1 init: show:)
					(res3Empty setPri: 1 init: show:)
					(res4Empty setPri: 1 init: show:)
				else
					(res1Empty setPri: 1 init: hide:)
					(res2Empty setPri: 1 init: hide:)
					(res3Empty setPri: 1 init: hide:)
					(res4Empty setPri: 1 init: hide:)
				)
				(handleEventList
					add: hand1 hand2 hand3 hand4 hand5 hand6 hand7 hand8
				)
