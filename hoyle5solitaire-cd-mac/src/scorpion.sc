...
(procedure (localproc_0 &tmp temp0 temp1 temp2 temp3)
	(for ((= temp2 0)) (< temp2 7) ((++ temp2))
		(if (!= ((gTheHands at: temp2) size:) 0)
			(if
				(and
					(== (((gTheHands at: temp2) at: 0) rank:) 13)
					(== ((gTheHands at: temp2) size:) 13)
					(((gTheHands at: temp2) at: 0) faceUp:)
				)
				(= temp0 (((gTheHands at: temp2) at: 0) suit:))
				(= temp1 (((gTheHands at: temp2) at: 0) rank:))
				(for ((= temp3 1)) (< temp3 13) ((++ temp3))
					(if
						(and
							(==
								(((gTheHands at: temp2) at: temp3) rank:)
								(- temp1 1)
							)
							(== (((gTheHands at: temp2) at: temp3) suit:) temp0)
						)
						(= temp1 (((gTheHands at: temp2) at: temp3) rank:))
					else
						(return 0)
					)
				)
...
(procedure (localproc_1 &tmp temp0 temp1 temp2 temp3 temp4 temp5)
	(= temp5 0)
	(for ((= temp2 0)) (< temp2 (gTheHands size:)) ((++ temp2))
		(if ((gTheHands at: temp2) size:)
			(= temp0 (((gTheHands at: temp2) at: 0) suit:))
			(= temp1 (((gTheHands at: temp2) at: 0) rank:))
		)
		(= temp4 2)
		(for ((= temp3 1)) (< temp3 ((gTheHands at: temp2) size:)) ((++ temp3))
			(if
				(and
					(((gTheHands at: temp2) at: (- temp3 1)) faceUp:)
					(((gTheHands at: temp2) at: temp3) faceUp:)
					(== temp0 (((gTheHands at: temp2) at: temp3) suit:))
					(== temp1 (+ 1 (((gTheHands at: temp2) at: temp3) rank:)))
				)
				(+= temp5 temp4)
				(= temp4 1)
			else
...
(instance scorpion of HoyleRoom
	(properties
		style 14
	)
...
(instance roomScript of Script
	...
	(method (doit &tmp temp0 temp1 temp2 [temp3 2] temp5 [temp6 4])
		...
		(if (and local13 (== state 5))
			...
			(if (and (== global928 52) (localproc_0))
				(= local22 1)
				(if global250
					(= local16 global248)
					(if
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(4
				...
				(= global243 0)
				(if (== global927 0)
					(hand1 cardsDown: 2 cardsUp: 5 startRank: 3)
					(hand2 cardsDown: 2 cardsUp: 5 startRank: 3)
					(hand3 cardsDown: 2 cardsUp: 5 startRank: 3)
					(hand4 cardsDown: 2 cardsUp: 5 startRank: 3)
					(hand5 startRank: 3)
					(hand6 startRank: 3)
					(hand7 startRank: 3)
				else
					(hand1 cardsDown: 3 cardsUp: 4 startRank: 1)
					(hand2 cardsDown: 3 cardsUp: 4 startRank: 1)
					(hand3 cardsDown: 3 cardsUp: 4 startRank: 1)
					(hand4 cardsDown: 3 cardsUp: 4 startRank: 1)
					(hand5 startRank: 1)
					(hand6 startRank: 1)
					(hand7 startRank: 1)
				)
			...
			(5
				...
				(global419 init: client: hand1 active: 1 size: 3 addKeyMouse:)
				(theStock adjust:)
				(for ((= temp1 0)) (< temp1 (gTheHands size:)) ((++ temp1))
