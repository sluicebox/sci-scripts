		...
		(switch (= state newState)
			...
			(2
				(if (== gHeroType 3) ; Paladin
					(gMessager say: 17 6 3 0 self) ; "This is a dangerous place. (You probably knew that.) Handle with care. An incredible sensation of evil emmanates from over by the book. That seems like an excellent thing to avoid."
				else
					(= ticks 2)
				)
			)
				...
				(cond
					...
					((IsFlag 318)
						(if (IsFlag 317)
							...
							(gMessager say: 2 4 9) ; "You rifle through the Mad Monk's desk and find the diary of Amon Tillado. Boy, was this guy whacko! Reading this makes your head hurt. It does give you some information about the Dark One Rituals, however."
						else
		...
		(switch theVerb
			(1 ; Look
				(if (IsFlag 317)
					...
					(gMessager say: 2 1 9) ; "You rifle through the Mad Monk's desk and find the diary of Amon Tillado. Boy, was this guy whacko! Reading this makes your head hurt. It does give you some information about the Dark One Rituals, however."
				else
