...
(instance debugRoom of Feature
	...
	(method (handleEvent event &tmp temp0 temp1 [temp2 2] temp4 temp5 temp6 temp7 temp8 [temp9 7] temp16)
		(if (event claimed:)
			(return)
		)
		(switch (event type:)
			(evKEYBOARD
				...
				(switch (event message:)
					...
					(KEY_ALT_o
						(Prints
							{Sorry, they couldn't get Poly Editor working, use SCI16}
						)
					)
					(KEY_ALT_f)
					(KEY_ALT_g
