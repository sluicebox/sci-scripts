...
(instance fDavy of Feature
	...
	(method (doVerb theVerb)
		(if (== theVerb 1) ; Look
			(gMessager say: 22 1 0 0) ; "Blackjack Davy shifts his gaze between you and the fortuneteller from time to time. He obviously holds her in great respect."
		else
			(super doVerb: theVerb)
		)
	)
