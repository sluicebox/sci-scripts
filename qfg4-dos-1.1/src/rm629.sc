...
(instance sEnterItemsDone of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gGlory handsOff:)
				(gMessager say: 4 6 17 0 self 620) ; "You hear voices at the bottom of the stair."
			)
			(6
				(gGlory handsOn:)
				(= seconds 8)
...
(instance pGoon1 of Prop
	...
	(method (doVerb theVerb)
		(if (== theVerb 2) ; Talk
			(gMessager say: 4 6 19 0 0 620) ; "Right. There are these two guards about the size of thousand-year-old redwood trees guarding the stairs, and you want to talk to them. Why don't you just walk down the stairs and meet them close up while you're at it?"
		else
			(super doVerb: theVerb)
		)
	)
