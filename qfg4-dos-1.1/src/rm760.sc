...
(instance rm760 of GloryRm
	...
	(method (init)
		...
		(= local6 (IntArray with: 154 78 22 0 16 25 61 0 0 215 174 0 0 0))
		(= local7 (IntArray with: 49 48 62 0 107 119 183 0 0 179 187 0 0 0))
		(= local8 (IntArray with: 187 109 51 0 25 52 63 0 0 250 215 0 0 0))
		(= local9 (IntArray with: 44 51 48 0 119 119 163 0 0 177 179 0 0 0))
...
(instance senseOrgan2 of Feature
	(properties
		noun 6
		nsLeft 212
		nsTop 163
