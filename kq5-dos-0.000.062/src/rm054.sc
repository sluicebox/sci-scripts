...
(local
	...
	[local12 14] = [13 189 91 144 117 122 164 120 164 0 0 0 0 189]
...
(instance conversation of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say 75 54 0 67 10 10 25 5) ; "See? Dead end! Let's go back now!"
				(Say 160 54 1 67 100 10 25 6) ; "No! I'll figure this out!"
				(= cycles 1)
			)
			(2
				(HandsOn)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(if (not (IsFlag 56))
					(Say 75 54 2 67 20 20 25 3) ; "No, don't...!"
				)
				(= cycles 1)
			)
			(1
...
(instance enterGrate of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(if (not (IsFlag 56))
					(Say 75 54 3 67 10 10 25 7) ; "You're crazy to go down into that dark hole; you don't know what's down there!"
					(Say 160 54 4 67 100 10 25 5) ; "Well, do you have any better ideas?"
					(Say 75 54 5 67 10 10 25 5) ; "No...uh, mind if I wait for you here?"
					(Say 160 54 6 67 100 10 25 7) ; "No, that's a good idea, Cedric. You be the lookout out here!"
					(Say 75 54 7 67 10 10 25 5) ; "Yes...I'll be the lookout. Be careful, Graham!"
				)
				(= cycles 1)
			)
			(3
