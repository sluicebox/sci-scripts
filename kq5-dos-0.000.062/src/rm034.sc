...
(instance talkEagleScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say 165 34 1 67 10 10 25 4) ; "What's wrong, Mr....uh, Eagle?"
				(Say 161 34 2 67 110 10 25 9) ; "I'm so weak from hunger. I haven't been able to catch any food for days. I can barely fly anymore."
				(Say 165 34 3 67 10 10 25 7) ; "I'd love to help you...let me see what I can do."
				(Say 161 34 4 67 110 10 25 5) ; "Thank you. I need food...(cough, cough)."
				(HandsOn)
				(client setScript: 0)
			)
		)
...
(instance feedEagle of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Say 165 34 5 67 10 10 25 7) ; "Here, take this. Perhaps it will help you."
				((gEgo head:) hide:)
				(gEgo
					normal: 0
					view: 530
			...
			(6
				(Say 161 34 6 67 110 10 25 10) ; "You are a kind man to share your meager food with a poor bird...especially up here, in the snowy mountains."
				(Say 165 34 7 67 10 10 25 10) ; "Well, I couldn't just stand there and let you starve to death! What kind of person would I be?"
				(Say 161 34 8 67 110 10 25 10) ; "You have shown yourself to be a kind, compassionate man and I will not forget what you did for me. Good-bye, dear friend."
				(eagleHead dispose:)
				(eagleWing dispose:)
				(eagle setScript: 0)
