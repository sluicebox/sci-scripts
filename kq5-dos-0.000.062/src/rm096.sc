...
(instance rm096 of Rm
	...
	(method (init)
		...
		(gEgo init: hide:)
		((gEgo head:) hide:)
		(cassimaEyes init: setScript: girlBlinkScript)
...
(instance cartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(cassimaLips setLoop: 0 setCycle: RandCycle cycleSpeed: 2)
			...
			(2
				...
				(PrintDC 96 1 #at 120 130 #dispose) ; "You wouldn't believe me if I told you. Tell me, who are you...and how did you come to be here?"
				(= seconds 10)
			)
			(3
				(egoFace setScript: 0 setCel: 0)
				(cassimaLips setCycle: RandCycle)
				(PrintDC 96 2 #at 18 130 #width 260 #dispose) ; "My name is Princess Cassima from the Kingdom of the Green Isles. My father, the King, employs a horrible Vizier who befriended Mordack. When Mordack saw me, he immediately wished to marry me and bring me here."
				(= seconds 15)
			)
			(4
				(cls)
			...
			(7
				(cassimaLips setCycle: RandCycle)
				(PrintDC 96 4 #at 18 130 #dispose) ; "He says he will never let me go...that a scullery girl I will remain until I agree to marry him. But the thought revolts me! What am I to do?!"
				(= seconds 12)
			)
			(8
				(cls)
