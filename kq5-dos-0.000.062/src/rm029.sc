...
(local
	...
	[local34 30] = [0 127 57 119 121 103 149 88 144 81 190 69 189 62 107 62 99 51 120 39 181 35 189 28 273 31 257 0 0 0]
)
...
(instance rm029 of Rm
	...
	(method (init)
		...
		(switch gPrevRoomNum
			(west
				(gEgo offset: 2 view: 2 posn: 6 151)
				(= local0 1)
			...
			(else
				(gGlobalSound number: 5 loop: -1 play:)
				(gEgo offset: 3 view: 2 posn: 6 151)
				(= local0 1)
			)
		)
	...
	(method (doit &tmp temp0)
		(cond
			...
			((& (gEgo onControl: 0) $2000)
				(Say 75 29 1 67 10 10 25 5) ; "No! Stay away from the edge...!"
...
(instance timedMess of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(proc0_16 (Format @global185 29 4)) ; "A few hours later....."
				(= seconds 30)
			)
			(1
				(proc0_16 0)
