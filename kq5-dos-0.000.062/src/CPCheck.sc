...
(procedure (localproc_0 param1 &tmp temp0 temp1 temp2 temp3 temp4)
	(= [local20 (+ param1 4)] (^ [local20 (+ param1 4)] $0001))
...
(procedure (localproc_1 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6)
	...
	(if (< local155 5)
		(= [local20 (+ param1 4)] (^ [local20 (+ param1 4)] $0002))
...
(procedure (localproc_3 param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14 temp15 temp16 temp17 [temp18 2] [temp20 504])
	...
	(= local156 (gMyWindow color:))
	(= local157 (gMyWindow back:))
	(= temp1 (DText new:))
	(cond
		((u< [param2 0] 1000)
			(GetFarText [param2 0] [param2 1] @temp20)
		)
		([param2 0]
			(StrCpy @temp20 [param2 0])
		)
		(else
			(= temp20 0)
		)
	)
	(temp1 text: @temp20 font: gUserFont setSize:)
	(temp0 add: temp1)
	...
	(for ((= temp4 (= temp16 (= temp17 0)))) (< temp4 26) ((++ temp4))
		(= temp14 (* temp4 5))
		(TextSize @[local20 temp14] @temp18 0)
		(= [local20 (+ temp14 4)] 0)
		(StrAt @temp18 0 66)
		(if (< temp4 13)
			(+= temp16 (+ [local20 (+ temp14 3)] 4))
		else
			(+= temp17 (+ [local20 (+ temp14 3)] 4))
		)
	)
	...
	(while (< temp4 27)
		...
		(Display @temp18 dsCOORD temp11 temp12 dsWIDTH 10 dsFONT 0 dsCOLOR local156)
		(StrAt @temp18 0 (+ 65 temp4))
		(= temp14 (* (- temp4 1) 5))
		(= [local20 (+ temp14 0)] temp12)
		(= [local20 (+ temp14 1)] temp11)
		(= [local20 (+ temp14 2)] (+ [local20 (+ temp14 2)] temp12))
		(= [local20 (+ temp14 3)] (+ [local20 (+ temp14 3)] temp11))
		(++ temp4)
		(+= temp11 temp10)
	)
	(-= temp12 (+ 21 temp9))
	...
	(repeat
		(if (not (& global71 $0040))
			(while
				(or
					(not
						(proc0_15 (= temp7 ((= temp6 (Event new:)) type:)) 4 64)
					)
				...
				(if (and (== temp7 $0040) (proc0_15 temp8 1 5 3 8 7 6)) ; direction
					(localproc_0 temp14)
					(switch temp8
						(1
							(cond
