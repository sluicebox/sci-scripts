...
(instance rEar of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(10 ; Taste
				(Print 391 33) ; "I know you're lonely, but licking a robot's ear?"
			)
			(11 ; Smell
				(Print 391 28) ; "The robot has your typical mechanical aromas."
			)
...
(instance theMouth of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 391 34) ; "The salesbot flashes you a grin."
			)
			(10 ; Taste
				(Print 391 35) ; "Everyone knows that licking a salesbot on the mouth is like plugging your tongue into a wall socket."
			)
			(11 ; Smell
				(Print 391 36) ; "Ozone oozes from his frantically flashing lips."
			)
			(3 ; Do
				(Print 391 37) ; "You should stay out of the mouths of others."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance roboHead of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 391 38) ; "There's probably not much in this robot's head."
			)
			(10 ; Taste
				(Print 391 29) ; "Your sense of appropriate public behavior leaves a lot to be desired."
			)
			(11 ; Smell
				(Print 391 39) ; "Smells like he put too much "Lube-Ina-Tube" on this morning."
			)
			(3 ; Do
				(Print 391 40) ; "Hey! Leave the head alone!"
			)
			(5 ; Talk
				(Print 391 41) ; "This model is not programmed to talk with the customers. You must interact with him through his touch-screen chest monitor."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance chest of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(10 ; Taste
				(Print 391 42) ; "The friendly salesbot smiles at you and thanks you for licking his chest monitor clean."
			)
			(11 ; Smell
				(Print 391 43) ; "It smells dusty - like old electronics."
			)
			(else
