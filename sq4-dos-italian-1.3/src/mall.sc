		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(4 ; battery
						(Print 700 14) ; "No way! That would be assualt with intent to emit battery!"
					)
					(6 ; paper_with_gum
...
(instance belts of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 700 18) ; "This belt way is great! No more tired, aching feet. No more walking just for the sake of going somewhere."
			)
			(3 ; Do
				(Print 700 19) ; "Your index digit scrapes the interesting coating that now resides on the surface of the belt. Just think, there's probably toe jam from all corners of the universe wedged up under your fingernail!"
			)
			(11 ; Smell
				(Print 700 20) ; "You attempt to smell the moving walkway and end up filing down your nose slightly."
			)
			(10 ; Taste
				(Print 700 21) ; "Very well, you give the moving walkway a warm kiss. Now you both feel special."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance restOfMall of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 700 22) ; "It's just another integral, vital part of the Galaxy Galleria Shopping Mall."
			)
			(11 ; Smell
				(Print 700 23) ; "The mall has that high-rent, low-occupancy smell...like any office building in downtown Los Angeles."
			)
			(10 ; Taste
				(Print 700 24) ; "It's against the Third Law of Mall Security to be caught licking mall components."
			)
			(else
