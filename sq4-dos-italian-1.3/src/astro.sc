...
(class astroChicken of Actor
	...
	(method (init &tmp [temp0 5])
		...
		(= local13 (proc0_12 {Score:} 67 237 178 28 global136))
		(if local1
			(proc0_12 local1)
		)
		(= local1
			(proc0_12 (Format @temp0 {%d} local8) 67 288 178 28 global136 70 25)
		)
	)
	...
	(method (incScore param1 &tmp temp0 temp1)
		(if (> param1 1)
			(+= local8 param1)
		else
			(= temp1 (/ y 20))
			(if param1
				(+= local8 [local14 temp1])
			else
				(+= local8 [local20 temp1])
			)
		)
		(self showPts:)
	)
...
(instance startScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= local9 (proc0_12 290 1 67 15 122 28 global129 29 global132))
			)
			(1
				(proc0_12 local9)
				(gCurRoom drawPic: 290)
