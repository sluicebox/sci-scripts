...
(local
	...
	[local182 13] = [99 0 9 18 24 34 40 48 54 61 63 67 69]
	[local195 12] = [99 0 9 18 26 34 41 49 56 61 64 69]
	local207
	local208 = 1
	local209 = 14
	[local210 14]
...
(procedure (localproc_1 param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 [temp5 500])
	(if (OneOf param1 0 5 11 17 23 28 33 38 40 45 49 54 56 63 65 67)
		(localproc_5 param1 param2 local207)
		(GetFarText 708 param1 @temp5)
		(TextSize @local2 @temp5 30 140)
		(= temp1 (- (+ local207 [local2 0]) 3))
		(= temp2 (- (+ param2 [local2 1]) 3))
		(= temp4 (+ local207 [local2 2]))
		...
		(Display 708 69 dsFONT 30 dsCOORD (- param2 12) (- local207 1)) ; "\04"
		(= [local210 (++ local224)]
			((bulletFeat new:)
				x: (- param2 9)
				y: (+ local207 2)
...
(procedure (localproc_2 &tmp temp0 [temp1 2] [temp3 100])
	...
	(Format @temp3 708 70 local208 local208) ; "Page %d   SQIV HintBook"
	(Display @temp3 dsFONT 30 dsCOORD 5 3)
	(Format @temp3 708 70 (+ local208 1) (+ local208 1)) ; "Page %d   SQIV HintBook"
	...
	(= local207 14)
	(for
		((= temp0 (localproc_6 local208)))
		(< temp0 (localproc_6 (+ local208 1)))
		((++ temp0))
...
(instance hintBookScript of Script
	...
	(method (doit)
		...
		(if (and 39 (!= local227 (gGame printLang:)))
			(-- local208)
			(= local227 (gGame printLang:))
			(localproc_2)
		)
		(super doit:)
	)
...
(instance prevBut of Feature
	...
	(method (init)
		...
		(= nsTop 178)
		(= nsRight (proc0_19 96 54 59 72 49))
		(= nsBottom 188)
		(super init: &rest)
	)
...
(instance nextBut of Feature
	...
	(method (init)
		(= nsLeft (proc0_19 101 63 64 79 54))
		(= nsTop 178)
		(= nsRight (proc0_19 156 97 93 126 74))
		(= nsBottom 188)
		(super init: &rest)
	)
	...
	(method (doVerb theVerb &tmp temp0)
		...
		(if (and temp0 (< local208 (localproc_7)))
			(++ local208)
			(localproc_2)
		)
	)
