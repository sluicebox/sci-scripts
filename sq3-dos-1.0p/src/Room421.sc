	...
	(method (handleEvent event)
		...
		(if (== (event type:) evSAID)
			(cond
				...
				((Said 'board,pull,hold/pulley,rope,hook')
					(Print 421 28) ; "That wouldn't do much good."
				)
				((Said 'swing,get,press,use/pulley,block,rope,hook')
					(switch local3
						(0
				...
				((Said '/pulley,hook,rope,cog,device,engine')
