	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				...
				(mMouth setCycle: Fwd)
				(Print 116 0 #title {Mark} #dispose #at -1 156 #width 320) ; "Greetings Earthling. We are the Two Guys From Andromeda, Universally famous software authors."
				(= seconds 8)
			)
			(12
				(cls)
				...
				(Print 116 1 #title {Roger} #dispose #at -1 156 #width 320) ; "And I am Roger Wilco, Space age swashbuckler and all around nice guy."
				(= seconds 8)
			)
			(13
				(cls)
				...
				(rMouth setCel: 0)
				(kMouth setCycle: Fwd)
				(Print 116 2 #title {Ken Williams} #dispose #at -1 156 #width 320) ; "Hello, I'm Ken Williams, President and founder of Sierra On-line. Sooo... You two guys are software authors heh? What are your credits?"
				(= seconds 10)
			)
			(14
				(cls)
			...
			(18
				...
				(mMouth setCycle: Fwd)
				(sMouth setCycle: Fwd)
				(Print 116 7 #title {Scott and Mark} #dispose #at -1 156 #width 320 #mode 1) ; "Sounds great! How many buckazoids does it pay?"
				(= seconds 5)
			)
			(19
				(cls)
