	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(ShakeScreen 3)
				(= local0
					(Display 155 0 dsWIDTH 250 dsCOORD 36 100 dsALIGN alCENTER dsFONT 300 dsCOLOR 14 dsSAVEPIXELS) ; "The small pod is jarred by a sudden shock which triggers the Sleep Chamber's Revive Mode. As the glass shroud slides back, Roger slowly begins to regain consciousness."
				)
			)
			(2
				(Display 155 1 dsRESTOREPIXELS local0)
