	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(if (not global174)
					(Print 18 2) ; "With your shield depleted, the final hit shreds the side of your ship. In the sudden vacuum, your body fluids expand beyond the capacity of your tissues. Your desicated body will drift forever, a grim testament to your blundering stupidity."
				else
					(Print 18 3) ; "Having the correct shield up could have prevented this!  The final shot shreds the side of your ship. In the sudden vacuum, your body fluids expand beyond the capacity of your tissues. Your desicated body will drift forever, a grim testament to your blundering stupidity."
				)
				(EgoDead 0 0 4 5)
			)
		)
...
(instance HButton of DIcon
	...
	(method (doit)
		(Print 18 4) ; "When the enemy ship comes from behind, you will automatically begin tracking. Use the direction keys or mouse to move the target cross-hairs onto the target. When you are locked on, use the space bar to fire."
	)
)
