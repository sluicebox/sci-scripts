...
(instance rm43 of Rm
	...
	(method (newRoom newRoomNumber)
		(if (or (== script 0) (== script tActions))
		...
		(switch (event type:)
			(evSAID
				(cond
					...
					(
						(Said
							'look/box,table,glass,animal,animal,devil,slime,show'
						)
					...
					((Said 'read,look/sign[<neon,flashing]')
						(if
							(and
								(gCast contains: door)
...
(instance orld of View
	...
	(method (init)
		(super init:)
		(self view: 70 setLoop: 0 setCel: 0 posn: 116 35 setPri: 14)
	)
)
...
(instance o of View
	...
	(method (init)
		(super init:)
		(self view: 70 setLoop: 0 setCel: 1 posn: 155 36 setPri: 14)
	)
)
...
(instance wonder of View
	...
	(method (init)
		(super init:)
		(self view: 70 setLoop: 0 setCel: 2 posn: 178 61 setPri: 14)
	)
)
