...
(instance rm540 of Room
	...
	(method (init)
		(gGame handsOff:)
		(cond
			((or (== gPrevRoomNum 545) (== gPrevRoomNum 560))
...
(instance desk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(1 ; Look
				(gMessager say: noun theVerb 0) ; "It's your very own desk."
				(if (& (gEgo signal:) $0800)
					(gCurRoom newRoom: 560)
				else
					(gEgo setScript: sitDown 0 1)
...
(instance thruDoorScr of Script
	...
	(method (doit)
		(super doit:)
		(if (and (OneOf state 0 2) (OneOf (gEgo cel:) 5 8))
			(knockSnd play:)
		)
	)
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(3
				(cond
					((== local3 73)
						(gMessager say: 2 73 0 1) ; "Hal, here's the Hickman Crime Scene log. It was prepared by Officer Woodbury from the 77th."
					)
					(
						(and
						...
						(gMessager say: 3 67 16 1) ; "Here you go, Hal, my follow-up report on last night's events."
					)
					(else
						(gMessager say: 2 67 0 1) ; "Here you go, Hal."
					)
				)
				(hal view: 543 loop: 0 cel: 0 setCycle: End self)
			)
			(4
				(if (== local3 67)
					(if
...
(instance halTalks of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(if (and caller (== caller goSeeBlock))
...
(instance ringer of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(sFx number: 937 setLoop: 1 1 play: self)
			)
			(1
				(= ticks 200)
			)
...
(instance firstEntranceDay3 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(hal view: 541 loop: 3 cel: 0 setScript: yak)
				(gEgo setMotion: PolyPath 163 118 self)
			)
			(1
				(gEgo setScript: sitDown self)
			...
			(2
				(hal setScript: 0 setCycle: End self)
			)
			(3
