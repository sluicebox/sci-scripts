		...
		(cond
			((== theVerb 4) ; Do
				(if (not (gCast contains: recept))
					...
					(gMessager say: noun theVerb 0) ; "You open the door to Social Services."
			...
			((== theVerb 46) ; keys
				(if (not (gCast contains: recept))
					(gMessager say: noun theVerb 1 0) ; "You don't have keys to a County facility, besides, it's open."
				else
