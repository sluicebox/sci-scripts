...
(procedure (localproc_0 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6) ; UNUSED
	...
	(if
		...
		(Message msgGET 64994 6 0 0 1 (temp4 data:)) ; "Insert the %s disk in drive %s."
		(Message msgGET 64994 7 0 0 1 (temp5 data:)) ; "SAVE GAME"
		(Message msgGET 64994 8 0 0 1 (temp6 data:)) ; "GAME"
		...
		(Message msgGET 64994 4 0 0 1 (temp5 data:)) ; "Cancel"
		(Message msgGET 64994 5 0 0 1 (temp6 data:)) ; "Change Directory"
		(if
			(==
				(= temp0
					(if param1
...
(class Game of Obj
	...
	(method (detailLevel theLevel)
		(if argc
			...
			(gPlanes eachElementDo: #checkDetail theLevel)
		)
		(return _detailLevel)
	)
