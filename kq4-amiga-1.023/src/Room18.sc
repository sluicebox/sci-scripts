...
(instance z4Actions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(local0 setMotion: 0 view: 266 cel: 0 setCycle: Beg self)
			...
			(10
				(HandsOff)
				(= global105 17)
				(zTheme stop: number: 21 play:)
				(gEgo view: 36 cel: 255 setCycle: End self)
			...
			(12
				(= global120 (Print 18 42 #at -1 0 #dispose)) ; "To wander forever is now your fate."
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(local1 setMotion: 0 view: 268 cel: 0 setCycle: Beg self)
			)
			(5
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(local2 setMotion: 0 view: 260 cel: 0 setCycle: Beg self)
			)
			(5
