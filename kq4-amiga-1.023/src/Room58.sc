...
(instance Room58 of Rm
	...
	(method (init)
		...
		((View new:) view: 521 loop: 2 cel: 0 posn: 102 74 setPri: 4 addToPic:)
		((View new:) view: 521 loop: 2 cel: 1 posn: 231 74 setPri: 4 addToPic:)
		((= local5 (Prop new:))
			view: 521
			loop: 3
			posn: 104 58
		...
		((= local2 (Prop new:)) view: 521 loop: 1 posn: 181 95 setPri: 5 init:)
		(if global193
...
(instance standOrgan of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(gEgo cel: 255 loop: 5 setCycle: End)
				(local0 cel: 255 loop: 4 setCycle: End self)
			)
			(1
