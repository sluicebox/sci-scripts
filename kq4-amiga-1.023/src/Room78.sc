	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(if (== (gEgo loop:) 2)
					(gEgo cel: 255 setLoop: -1 loop: 4 setCycle: End self)
				else
					(gEgo cel: 255 setLoop: -1 loop: 5 setCycle: End self)
				)
			)
			(5
				(jumpSound play:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(10
				...
				(gEgo viewer: 0)
				(if (< (gEgo x:) 194)
					(local21 cel: 255 setLoop: 2 setCycle: End self)
				else
					(local21 cel: 255 setLoop: 3 setCycle: End self)
				)
			)
			(11
				(gEgo
			...
			(20
				...
				(gSounds eachElementDo: #stop 0)
				(charm init: play: self)
				(local21 setLoop: 4 setCycle: Fwd)
				(= local22 2)
			)
			(21
				(Print 78 29 #at -1 10) ; "Nervously, you raise the flute to your mouth and begin to play a melodic tune to the big cobra, who begins to sway with the music. Soon, the snake is mesmerized by it, and falls into an hypnotic trance."
				(gEgo view: 2 setCycle: Walk)
				(local27 dispose:)
				(= global105 12)
				(= seconds 15)
...
(instance boardActions of Script
	...
	(method (doit)
		(super doit:)
		(if (== state 3)
			(if (gEgo inRect: 101 (- (local24 y:) 3) 150 (+ (local24 y:) 3))
				(= global132 1)
			else
				(= global132 0)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(HandsOff)
				(gEgo view: 21 loop: 0 cel: 255 setCycle: End self)
				(if (not global201)
					(= global201 1)
					(gGame changeScore: 2)
				)
...
(instance fruitActions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(local23 cel: 255 setCycle: End self)
			)
			(2
				(local23 cel: 0)
				(self changeState: 0)
