...
(instance egoActions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(local3 stopUpd:)
				(= global120 (Print 692 0 #at -1 10 #dispose)) ; "...I now pronounce you man and wife! Edgar, you may kiss the bride."
				(= seconds 12)
			)
			(7
				(cls)
			...
			(13
				(Print 692 1 #at -1 10 #time 15) ; "Fainting isn't going to help, Rosella. There's no getting out of this one. You're stuck being Mrs. Edgar for the rest of your life."
				(cls)
				(= seconds 4)
			)
			(14
				(Print 692 2 #at -1 10 #time 15) ; "Not to mention having old Lolotte for a mother-in-law! Good luck...you're going to need it!"
				(cls)
