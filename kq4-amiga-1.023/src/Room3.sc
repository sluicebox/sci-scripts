		...
		(cond
			((and (== local3 0) (== local4 0))
				(cond
					...
					((and (== (gEgo onControl: 1) 1) (!= (gEgo view:) 21))
						(gEgo view: 2)
					)
...
(instance doCupid of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(local9 setLoop: 2 cel: 255 setCycle: End self)
			)
			(4
				(local9
					ignoreActors: 1
			...
			(22
				(local9 view: 164 cel: 255 setLoop: 1 setCycle: End self)
			)
			(23
				(local9
					view: 161
			...
			(31
				...
				(local9 view: 166 setLoop: 1 cel: 255 setCycle: End self)
			)
			(32
			...
			(42
				...
				(local9 view: 163 loop: 0 cel: 255 setCycle: CT 5 1 self)
			)
			(43
				(local7 dispose:)
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(HandsOff)
				(LookAt gEgo local7)
				(gEgo view: 21 setMotion: 0 cel: 255 setCycle: End self)
			)
			(2
				(= global182 1)
				(local7 dispose:)
			...
			(11
				(= seconds 5)
				(= global120 (Print 3 36 #at -1 10 #dispose)) ; "You kneel down and drink some of the pool water. At least it quenches your thirst."
			)
			(12
				(gEgo setCycle: Beg self)
			)
