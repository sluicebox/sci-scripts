...
(instance Room76 of Rm
	...
	(method (init)
		...
		(if (== gPrevRoomNum 73)
			(gEgo posn: 189 118 init:)
		else
			(gEgo posn: 20 161 init:)
		)
				...
				((Said '(place,lay)[<down]/board')
					(cond
						((not (gEgo has: 22)) ; Board
							(Print 76 5 #at -1 10 #time 5) ; "You don't have the board."
						)
...
(instance fallChasm of Script
	...
	(method (init param1)
		(HandsOff)
		(Notify 605 4)
		(gEgo view: 936 setPri: 10 setCycle: Fwd)
		(super init: param1)
	)
