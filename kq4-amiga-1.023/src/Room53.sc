...
(instance Room53 of Rm
	...
	(method (init)
		...
		(= global189 1)
		(super init:)
		((View new:) view: 676 loop: 3 cel: 0 posn: 230 76 setPri: 4 addToPic:)
		((View new:) view: 676 loop: 3 cel: 1 posn: 42 87 setPri: 10 addToPic:)
	...
	(method (handleEvent event)
		...
		(cond
			...
			((or (Said 'get<in,on/bed') (Said 'sleep,lay[<down,on,in]'))
				(Print 53 15) ; "You have better things to do."
			)
		)
	)
)
...
(instance cleanBedroom of Script
	...
	(method (init param1)
		(super init: param1)
		(gEgo illegalBits: 0 ignoreActors: 1 setCycle: Walk setLoop: -1)
	)
...
(instance chaseEgo of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Print 53 16) ; "Oh, oh! You've been caught trespassing! You are unceremoniously ordered out by an angry dwarf."
				(gEgo
					illegalBits: 0
					setAvoider: Avoid
