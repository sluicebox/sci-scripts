...
(instance Room90 of Rm
	...
	(method (init)
		...
		(if (or (== gPrevRoomNum 91) (== gPrevRoomNum 0))
			...
			(= local0 0)
			(if global175
				(Print 90 0 #at -1 10 #font gSmallFont) ; "I don't know how you did it, but you managed to escape Lolotte's henchman. You might not be so lucky next time. Watch Out!!"
				(= global175 0)
			)
		)
		(if (== gPrevRoomNum 85)
