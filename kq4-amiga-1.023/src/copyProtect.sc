...
(instance copyProtect of Rm
	...
	(method (doit)
		...
		(= global205 0)
		(Print
			(Format @global228 701 0 local1) ; "In order to verify your legal ownership, please use your "King's Quest IV" manual to answer the following question: %s"
			#at
			7
			5
			#font
		...
		(if (== local35 local2)
			...
			(Print 701 1) ; "Sorry, what you just typed does not match the "King's Quest IV" manual. You must have the manual to play this game."
			(= gQuit 1)
		)
	)
)
