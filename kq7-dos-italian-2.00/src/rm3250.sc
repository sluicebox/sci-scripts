	...
	(method (changeState newState)
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(3
					(if (not (IsFlag 102))
						(drownSound number: 3252 setLoop: 1 play:)
					)
					(gKqMusic1 stop:)
					(cond
						((or (IsFlag 106) (OneOf gPrevRoomNum 3300 3050))
						...
						((== gValOrRoz -3) ; Roz
							(if (IsFlag 102)
								...
								(gKqSound1 number: 907 setLoop: 1 play:)
							else
								(gEgo
									view: 8383
									loop: 0
				...
				(5
					(if (IsFlag 102)
						(drownSound number: 811 setLoop: -1 play:)
						(cond
							(
								(or
									(IsFlag 106)
						...
						(if (and (not (IsFlag 106)) (not (== gValOrRoz -3))) ; Roz
							(drownSound number: 902 setLoop: 1 play:)
						else
							(gKqMusic1 play:)
						)
						(cond
				...
				(9
					(if (IsFlag 103)
						(gKqSound1 number: 894 setLoop: -1 play:)
					)
					(if (and (not (IsFlag 106)) (not (== gValOrRoz -3))) ; Roz
						(gKqMusic1 play:)
					)
		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(1
					(= local1 1)
					(gKqMusic1 mute: 1)
					(birdSound number: 3254 setLoop: -1 play:)
					(gEgo
						view: 8132
						posn: 31 115
						loop: 0
		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(9
					((ScriptID 13 0) hide_mouth: 0) ; aEgoTalker
					(= local1 8)
					(birdSound number: 3255 setLoop: 1 play:)
					(bird
						moveSpeed: 6
						posn: 25 38
						ignoreActors: 1
		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(7
					...
					(nectarSound number: 893 setLoop: 1 play:)
				)
				(8
					(gEgo
						posn: 130 127
				...
				(16
					...
					(fannySound number: 3256 setLoop: 1 play:)
					(rainbowBridge
						view: 3257
						loop: 9
						cel: 0
				...
				(25
					(SetFlag 104)
					(nectarSound number: 3261 setLoop: 1 play:)
					(fannySound number: 3212 setLoop: 1 play:)
	...
	(method (changeState newState)
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(1
					(nectarSound number: 852 setLoop: 1 play: self)
					(Load rsSOUND 864)
				)
				(2
					(fannySound number: 865 setLoop: 1 play:)
		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				(0
					...
					(gEgo view: 8495 setCel: 0 setCycle: End self)
				)
				(1
					(= ticks 150)
				)
...
(instance sAmbrosia of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gKqMusic1 stop:)
				(nectarSound number: 834 setLoop: 1 play: self)
				(Load rsSOUND 3263)
			)
			(3
				(nectarSound number: 3263 setLoop: 1 play:)
