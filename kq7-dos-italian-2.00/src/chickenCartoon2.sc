		...
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(9
					...
					((ScriptID 5300 1) setScript: (ScriptID 5302 22) 0 10) ; chickenPetite, chickenTimerScript
					(gGame handsOn:)
					(self dispose:)
				)
			)
...
(instance openingScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				((ScriptID 5300 5) setScript: (ScriptID 5301 3) self) ; archDuke, dukeWalkOut
	...
	(method (changeState newState)
		(if (not (IsFlag 539))
			(switch (= state newState)
				(0
					(gGame handsOff: 1)
					(proc11_3 gEgo (ScriptID 5300 1) self) ; chickenPetite
				)
				(1
					((ScriptID 5300 30) hide_mouth: 0) ; chickenTalker
				...
				(2
					((ScriptID 5300 1) ; chickenPetite
						...
						setCycle: Fwd
						ignoreActors: 1
						setMotion: PolyPath 400 ((ScriptID 5300 1) y:) self ; chickenPetite
					)
				)
				(3
			...
			(gEgo normalize: 2)
			((ScriptID 5300 1) setCycle: 0 setMotion: 0) ; chickenPetite
			(proc5300_4)
			(gGame handsOn:)
			(self dispose:)
		)
...
(instance glintScript of Script
	...
	(method (init)
		((ScriptID 5300 14) init: hide:) ; glint2
		((ScriptID 5300 15) init: hide:) ; glint3
		(super init: &rest)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				((ScriptID 5300 13) show: cel: 0 setCycle: End self) ; glint1
			)
			(1
				((ScriptID 5300 13) hide:) ; glint1
				((ScriptID 5300 14) show: cel: 0 setCycle: End self) ; glint2
			)
			(2
				((ScriptID 5300 14) hide:) ; glint2
				(= state -1)
				((ScriptID 5300 15) show: cel: 0 setCycle: End self) ; glint3
			)
		)
	)
)
