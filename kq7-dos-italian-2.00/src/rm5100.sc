...
(instance rm5100 of KQRoom
	...
	(method (newRoom)
		...
		(gKqMusic1 setLoop: 0 setVol: 127 stop:)
		(partyChatter stop:)
		(gKqSound1 stop:)
		(super newRoom: &rest)
	)
	...
	(method (changeState newState)
		(if (not (IsFlag 539))
			(switch (= state newState)
				...
				(8
					(gKqMusic1 number: 5108 setLoop: 1 play: self)
				)
				(9
					(gKqMusic1 number: 5105 setLoop: -1 play:)
				...
				(21
					(gKqMusic1 pause: 1)
					(gKqSound1 number: 5310 setLoop: -1 play:)
				...
				(23
					...
					(gKqMusic1 number: 5110 setLoop: -1 play:)
