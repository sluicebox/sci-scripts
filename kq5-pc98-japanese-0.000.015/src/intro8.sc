...
(instance a2s2Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(= global380 1)
				(PrintDC 107 0 #at 100 10 #dispose) ; "\81u\82n\82j\81I\81@\82\b3\82\a0\81A\8ds\82\ad\82\bc\81I\81I\81v"
				(= cycles 1)
			)
			(5
...
(instance owlFlying of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(PrintDC 107 1 #at 10 10 #dispose) ; "\81u\82\b1\82\c1\82\bf\82\c5\82\b7\82\e6\81I\81@\82\b3\82\a0\82\cd\82\e2\82\ad\81I\81v"
				(owl
					setLoop: 10
					moveSpeed: 1
					setCycle: Fwd
