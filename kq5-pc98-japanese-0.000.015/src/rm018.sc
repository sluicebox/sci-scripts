		...
		(switch (= state newState)
			...
			(1
				(if (gCurRoom script:)
					...
					(PrintDC 18 1 #at 150 10 #dispose) ; "The exit door is about to close!"
					(if (gEgo script:)
						(= seconds 2)
					else
						(= seconds 4)
...
(instance bottle of Prop
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 18 4) ; "Near the door sits an old, tarnished brass bottle.#\90_\93a\82\cc\94\e0\82\cc\8b\df\82\ad\82\c9\81A\8c\c3\82\ad\82\c4\90F\82\cc\95\cf\82\ed\82\c1\82\bd\90^\82\bf\82\e3\82\a4\82\cc\82\d1\82\f1\82\aa\92u\82\a2\82\c4\82\a0\82\e9\81B"
					(event claimed: 1)
				)
				(3 ; Do
					(HandsOff)
