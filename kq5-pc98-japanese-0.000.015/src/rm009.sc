...
(instance rm009 of KQ5Room
	...
	(method (init)
		...
		(= global321 83)
		(= global325
			{"Come on, Graham. Let's go someplace else!"}
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(RedrawCast)
				(PrintDC 9 5 #at 145 10 #width 158 #dispose) ; "Everything's wrong! Can't you tell? I'm not really a tree...I'm really a princess. (Sigh.) You see, my fiance and I were walking through this wood when a nasty old witch came along and was instantly charmed by my handsome prince."
				(wFace setScript: mouthMove)
