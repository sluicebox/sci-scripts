	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				...
				(PrintDC 110 0 #at 30 10 #dispose) ; "Pearl, this man needs your help. He needs you to lead him to Mordack's island. It's a real 'mergency. Mordack's holdin' his family hostage."
				(= seconds 10)
			)
			(9
			...
			(10
				(hermit_mouth setCycle: RandCycle)
				(PrintDC 110 1 #at 30 10 #dispose) ; "Pearl cain't speak human talk but she's agreed to help you. Just get on into your boat and folla her."
				(= seconds 7)
			)
			(11
				(hermit_mouth setCycle: 0)
			...
			(12
				...
				(cls)
				(hermit_mouth setCycle: RandCycle)
				(PrintDC 110 4 #at 30 10 #dispose) ; "Don't worry about who I am. You just get on over to that there island and take care of your family."
				(= seconds 7)
			)
			(13
				(hermit_mouth setCycle: 0)
