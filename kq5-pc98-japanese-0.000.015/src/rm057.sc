...
(instance scaredTalk of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(proc0_28 101 57 0 67 10 10 25 5) ; "Don't come near me! Leave me alone!"
				(proc0_28 160 57 1 67 100 10 25 6) ; "I would never hurt you. I'd like to help you."
				(proc0_28 101 57 2 67 10 10 25 5) ; "I don't believe you! You're probably one of...THEM!"
				(proc0_28 160 57 3 67 100 10 25 5) ; "I'm not; believe me."
				(proc0_28 101 57 4 67 10 10 25 6) ; "Just go away...pleasssee! I don't want to talk to you anymore."
				(= cycles 1)
			)
			(2
...
(instance friendTalk of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(proc0_28 101 57 5 67 10 10 25 6) ; "By the way, who are you?"
				(proc0_28 160 57 6 67 100 10 25 6) ; "I'm King Graham of Daventry."
				(proc0_28 101 57 7 67 10 10 25 10) ; "I think I know where that is! It's very far from my home, though. Ohhhhhhh!"
				(proc0_28 160 57 8 67 100 10 25 10) ; "Don't worry. Somehow...I'll get you home again. But first, I've got to save my family."
				(proc0_28 101 57 9 67 10 10 25 10) ; "Yes, well...(sniff), I'll stand by you, King Graham. I'll help you if I can."
				(proc0_28 160 57 10 67 100 10 25 6) ; "Thanks. I may need it."
				(proc0_28 101 57 11 67 10 10 25 10) ; "Well, I'd better get back to work. And you should keep out of sight!"
				(proc0_28 160 57 12 67 100 10 25 6) ; "Aye, aye, m'lady."
				(= seconds 2)
			)
			(2
				(cls)
...
(instance noThanks of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(2
				(proc0_28 101 57 31 67 10 10 25 5) ; "Take that away from me! I don't want it!"
				(= seconds 1)
			)
			(3
