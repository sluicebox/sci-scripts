	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(= local1
					(Display ; "Designed and Produced by"
						101
						5
						dsCOORD
						69
			...
			(8
				...
				(= local2
					(Display 101 10 dsCOORD 21 27 dsWIDTH 240 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Tomoyuki Shimada"
				)
				(= local1
			...
			(12
				(= local3
					(Display 101 13 dsCOORD 11 25 dsWIDTH 300 dsALIGN alCENTER dsCOLOR 0 dsFONT 600 dsSAVEPIXELS) ; "Japanese PC-9801 Version staffs"
				)
				(= local2
					(Display 101 14 dsCOORD 11 41 dsWIDTH 300 dsALIGN alCENTER dsCOLOR 0 dsFONT 8 dsSAVEPIXELS) ; "Gary Kamigawachi Akiko Maeda Skjellerup"
				)
				(= local1
					(Display ; "Japanese PC-9801 Version staffs"
						101
						13
						dsCOORD
						10
				...
				(= local0
					(Display ; "Gary Kamigawachi Akiko Maeda Skjellerup"
						101
						14
						dsCOORD
						10
