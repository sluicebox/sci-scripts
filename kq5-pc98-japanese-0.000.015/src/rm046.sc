	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(switch global362
					(0
						(proc0_28 104 46 40 67 20 20 25 6) ; "Eh? What's that you say?"
					)
					(1
						(proc0_28 104 46 41 67 20 20 25 4) ; "Eh? I cain't hear ya!"
					)
					(2
						(proc0_28 104 46 42 67 20 20 25 4) ; "What's that you say?"
					)
					(3
						(proc0_28 104 46 43 67 20 20 25 4) ; "What? Speak louder, boy!"
					)
					(4
						(proc0_28 104 46 44 67 20 20 25 4) ; "Eh? What's that?"
					)
					(5
						(proc0_28 104 46 45 67 20 20 25 4) ; "I cain't understand ya!"
					)
					(6
						(proc0_28 104 46 46 67 20 20 25 4) ; "Gotta speak up, boy!"
					)
					(7
						(proc0_28 104 46 47 67 20 20 25 4) ; "Eh?"
					)
					(8
						(proc0_28 104 46 48 67 20 20 25 4) ; "What? I cain't understand!"
					)
					(else
						(proc0_28 104 46 49 67 20 20 25 4) ; "I cain't hear ya! Speak up!"
					)
				)
				(= cycles 1)
			)
			...
			(4
				(HandsOff)
				(if (== global362 1)
					(proc0_28 104 46 50 67 20 20 25 9) ; "Can't understand a thing you said. Gotta speak up boy! Now, get on outta here!"
				)
				(= cycles 1)
			)
			(5
