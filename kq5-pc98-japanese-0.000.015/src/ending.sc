...
(instance cartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(15
				(PrintDC 120 1 #at 110 (LangSwitch 140 100) #dispose) ; "Oh...Princess Cassima! Well, I did it. Mordack is dead."
				(= seconds 7)
			)
			(16
				(cls)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				...
				(PrintDC 120 11 #at 110 (LangSwitch 140 155) #dispose) ; "All right! Now that we're done with the formalities, let's get on with business, shall we?"
				(= seconds 7)
			)
			(12
				(crispin setLoop: 7)
			...
			(18
				...
				(crispin setCycle: RandCycle)
				(PrintDC 120 13 #at 110 (LangSwitch 120 150) #dispose) ; "Be assured that your castle is right back where it belongs...and the right size too! But NOW, it's time that everyone return to their homes...with MY help, of course."
				(= seconds 12)
			)
			(19
				(if
			...
			(25
				...
				(crispin setCycle: RandCycle)
				(PrintDC 120 16 #at 110 (LangSwitch 160 155) #dispose) ; "What? Where IS Cedric?"
				(= seconds 5)
			)
			(26
				(crispin setCycle: Beg self)
			...
			(53
				...
				(crispin setLoop: 9)
				(crispin setCycle: RandCycle)
				(PrintDC 120 26 #at 110 (LangSwitch 140 160) #dispose) ; "Okay, Cassima. Let's send you home first. Wasn't that the Land of the Green Isles?"
				(= seconds 7)
			)
			(54
				(crispin setCycle: Beg self)
