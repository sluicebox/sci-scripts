...
(instance rm012 of KQ5Room
	...
	(method (init)
		...
		(= global321 51)
		(= global325
			{"Let's go! There isn't anything to do here!"}
		)
		...
		(cond
			...
			((= local0 (self edgeToRoom: (gEgo edgeHit:)))
				(if (== local0 (gCurRoom west:))
					...
					(gEgo loop: 1)
					(RedrawCast)
					(proc0_28 75 12 0 67 10 10 25 10) ; "There's nothing but a hot, dry desert further west. Most people avoid it, because there are bandits out there! If you insist on going, I'll wait for you HERE!"
					(gGlobalSound fade:)
					(HandsOn)
...
(instance relievedScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(proc0_28 75 12 2 67 20 100 25 5) ; "Well, there you are! I was starting to get concerned!"
				(proc0_28 160 12 3 67 20 20 25 5) ; "Don't worry about me, Cedric. I'm used to this kind of thing."
				(= cycles 1)
			)
			(3
				(HandsOn)
...
(instance antDance of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(proc0_28 75 12 4 67 10 10 25 4) ; "Is that a new dance, Graham? The BUG-a-loo?"
				(HandsOn)
				(client setScript: 0)
			)
		)
...
(instance throwStick of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(PrintDC 12 5 #at 103 10 #dispose) ; "Here, boy!"
				((gEgo head:) hide:)
				(gEgo
					normal: 0
					view: 296
			...
			(10
				...
				(PrintDC 12 6 #at 20 20 #width 120 #dispose) ; "Allow me to introduce myself. I'm King Antony the Great. May I ask who you are?"
				(= seconds 7)
			)
			(11
				(cls)
				...
				(theMouth setCycle: 0)
				(RedrawCast)
				(proc0_28 160 12 7 67 15 70 25 20 70 280) ; "Why certainly. I'm King Graham of Daventry and this is my friend, Cedric. We're seeking a way to cross the Great Mountains to the ocean on the other side."
				(RedrawCast)
				(= cycles 1)
			)
			(12
				(PrintDC 12 8 #at 10 10 #width 120 #dispose) ; "That is a very perilous undertaking. I wish you would reconsider. But if you shall not, in return for rescuing our home from that flea-bitten cur I wish to offer you our help if perchance you may ever need it."
			...
			(13
				...
				(theMouth setCycle: 0)
				(RedrawCast)
				(proc0_28 160 12 9 67 15 80 70 280 25 15) ; "Thank you very much, King Antony. Cedric and I appreciate your kind offer. We look forward to meeting you again."
		...
		(switch (= state newState)
			(0
				(if (not register)
					(++ register)
					(cls)
					(proc0_28 75 12 10 67 20 20 25 7) ; "Oh, Graham! That dog looks mean! I don't like dogs!"
				)
				(dog loop: 0)
...
(instance wagon of Prop
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 12 19) ; "A gypsy wagon can be seen in the distance to the north.#\96k\82\cc\95\fb\82\c9\81A\83W\83v\83V\81[\82\cc\82\d9\82\eb\94n\8e\d4\82\aa\8c\a9\82\a6\82\e9\81B"
					(event claimed: 1)
				)
			)
		)
