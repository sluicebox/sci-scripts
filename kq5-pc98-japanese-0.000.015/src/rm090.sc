	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(2
				(localproc_0)
				(h4Mouth cue: 1)
				(PrintDC 90 2 #at 220 27 #width 80 #dispose) ; "Don't be so picky. I'm tired of fish. I haven't had a man in months."
				(= seconds 6)
			)
			(3
				(localproc_0)
				(h3Mouth cue: 1)
				(PrintDC 90 3 #at 10 27 #width 120 #dispose) ; "Yes, you did. I saw you steal a man off a raft just last week!"
				(= seconds 5)
			)
			(4
				(localproc_0)
				(h4Mouth cue: 1)
				(PrintDC 90 4 #at 220 27 #width 80 #dispose) ; "Oh, he doesn't count! He was already picked over by the time I got to him!"
				(= seconds 5)
			)
			(5
				(localproc_0)
			...
			(7
				(localproc_0)
				(h3Mouth cue: 1)
				(PrintDC 90 7 #at 10 27 #width 120 #dispose) ; "Oh, you're ALWAYS ready to eat. That's why you're so fat!"
				(= seconds 6)
			)
			(8
				(localproc_0)
			...
			(9
				(localproc_0)
				(h3Mouth cue: 1)
				(PrintDC 90 9 #at 60 27 #dispose) ; "You are TOO!"
				(= seconds 2)
			)
			(10
				(localproc_0)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(h3Mouth cue: 1)
				(PrintDC 90 12 #at 10 27 #width 120 #dispose) ; "What's he doing? What's that thing?"
				(= seconds 4)
			)
			(2
				(localproc_0)
		...
		(switch (= state newState)
			...
			(1
				(if (gCast contains: harpy1)
					(PrintDC 90 17) ; "While keeping a sharp eye out for the harpies, Graham quickly bends down and rescues the fishhook from the ground."
				else
					(PrintDC 90 18) ; "Graham quickly bends down and rescues the fishhook from the ground."
				)
				(= register (gEgo view:))
				(if (== (gEgo view:) 2)
					((gEgo head:) hide:)
