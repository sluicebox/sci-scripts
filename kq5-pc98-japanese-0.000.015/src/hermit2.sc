...
(instance hermit2 of KQ5Room
	...
	(method (init)
		(LoadMany rsVIEW 832 626 1042 828 1041 826 0 824)
...
(instance cartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(cls)
				(PrintDC 111 0 #at 30 10 #dispose) ; "Lay him on the bed there."
				(= seconds 4)
			)
			(2
			...
			(11
				...
				(PrintDC 111 1 #at 30 10 #dispose) ; "These poultices should fix the little feller up good as new."
				(= seconds 4)
			)
			(12
				(putDownOwl cue:)
			...
			(23
				(hermit_mouth setCycle: Fwd)
				(PrintDC 111 3 #at 30 10 #dispose) ; "Eh? What was that?"
				(= seconds 3)
			)
			(24
			...
			(26
				(cls)
				(hermit_mouth setCycle: Fwd)
				(PrintDC 111 5 #at 30 10 #dispose) ; "Gifts from the sea, lad. Gifts from the sea. Ain't nothin' special. You just gotta know how to use 'em. I don't think he'd find them particularly interestin'."
				(= seconds 11)
			)
			(27
				(cls)
