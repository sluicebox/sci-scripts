...
(procedure (proc0_13 param1 param2 param3 param4 param5)
	(return
...
(class Rain of Game
	...
	(method (startRoom roomNum &tmp temp0 temp1 temp2 temp3)
		...
		(if (and (FileIO fiEXISTS {abc123}) global134 (not (OneOf 500 roomNum)))
			((ScriptID 98) init:) ; debugRm
		)
		(gTheIconBar enable:)
...
(instance statusCode of Code
	...
	(method (doit &tmp [temp0 75] [temp75 75])
		(if (not (OneOf gCurRoomNum 10 40)) ; speedRoom, intro
			...
			(Format @temp75 @temp0 gScore)
			(DrawStatus @temp75 67 0)
		)
	)
)
...
(instance writeEcorderData of Code
	...
	(method (doit param1 param2 param3 &tmp temp0 temp1 [temp2 50] [temp52 50])
		(if (and (== param2 55) (not (IsEcorderFlag param3)))
			...
			(Message msgGET 50 13 0 temp0 temp1 @temp52)
			(gSystemWindow color: 8 back: 23)
			(Print addTextF: @temp2 @temp52 ticks: 5 init: ticks: 0)
