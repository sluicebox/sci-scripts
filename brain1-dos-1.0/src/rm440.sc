...
(local
	...
	local215
	local216
	[local217 15] = [0 5 43 5 0 46 5 13 45 5 0 0 6 0 58]
	[local232 15] = [0 27 27 49 0 49 71 71 71 93 0 0 115 0 115]
	[local247 15] = [0 4 42 4 0 45 4 13 44 4 0 0 5 0 57]
	[local262 15] = [0 13 51 13 0 54 12 21 53 13 0 0 14 0 66]
	[local277 15] = [0 0 7 6 0 0 5 0 2 3 0 0 4 0 0]
)
...
(procedure (localproc_5 &tmp temp0 temp1)
	(for ((= temp0 0)) (< temp0 15) ((++ temp0))
		(cond
			((not (= temp1 [local277 temp0]))
				(= [local137 temp0] 0)
			)
			((< temp1 5)
				([local130 (- temp1 1)]
					cel: 0
					nsTop: [local232 temp0]
					nsLeft: [local217 temp0]
					value: temp0
				)
				(= [local137 temp0] 1)
			)
					...
					(
						...
						(for
							...
							(if
								(and
									[local247 temp6]
									(> temp1 [local247 temp6])
									(< temp1 [local262 temp6])
								)
								(= temp7 temp6)
							)
						)
						(cond
							...
							(else
								...
								(Animate (bookCast elements:) 1)
								(local129
									nsLeft: [local217 temp7]
									nsTop: [local232 temp7]
									loop: local277
									value: temp7
									cel: 0
									show:
...
(instance dummyBook of CodeIcon
	...
	(method (select &tmp temp0)
		...
		(moveBook x: (+ nsLeft 60) y: (+ nsTop 5) loop: loop show:)
		(gGame setCursor: 50)
		(Animate (bookCast elements:) 1)
