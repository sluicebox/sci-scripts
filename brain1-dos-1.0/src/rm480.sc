...
(instance rm480 of Rm
	...
	(method (init)
		(Load rsSCRIPT 939)
		(LoadMany rsVIEW 480 481 482 485 486 490)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(38
				...
				(localproc_1)
				(localproc_2)
				(Print 480 12 #at 63 136 #time 6 #dispose self) ; "I also know some programmers! Without them, I would have had a hard time putting my little challenges together!"
			)
			(39
			...
			(43
				(localproc_1)
				(localproc_2)
				(Print 480 13 #at 63 136 #time 5 #dispose self) ; "My Quality Assurance Lead: Making sure the castle is as clean as can be!"
			)
			(44
			...
			(45
				(proc5_12 local5)
				(localproc_2)
				(Print 480 14 #at 63 136 #time 5 #dispose self) ; "Finally, special credit for Design Assistance and Necessary Discipline must surely go to:"
			)
			(46
			...
			(47
				...
				(proc5_12 local4)
				(localproc_1)
				(Print 480 15 #at 63 136 #time 5 #dispose self) ; "But now it's time for me to devise a new set of challenges for you, my clever lab assistant!"
			)
			(48
				(Print 480 16 #at 80 136 #time 5 #dispose self) ; "Which means I must be off to the ..."
			)
			(49
...
(instance trailerScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(= local6 (Display 480 17 dsCOORD 80 80 dsFONT 200 dsCOLOR 0 dsSAVEPIXELS)) ; "I ' L L  B E  B A C K !"
				(= ticks 60)
			)
			(14
				(gCMusic setVol: 6)
			...
			(16
				(Display 480 18 dsRESTOREPIXELS local6)
				(= gQuit 1)
			)
		)
	)
