...
(procedure (proc821_0 param1 param2 param3 &tmp [temp0 4])
	(if (proc821_1 (if (>= argc 3) param3 else {}) 38 param1 param2 &rest)
		(StrLen param1)
	)
)

(procedure (proc821_1 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 [temp12 6] temp18 temp19 temp20 [temp21 1002] temp1023 temp1024 temp1025 temp1026 temp1027 temp1028 temp1029 temp1030)
	(= temp1026 0)
	(= temp1027 0)
	(= temp6 (= temp7 -1))
	(= temp1030
	...
	((= temp0 (EcoDialog new:)) window: gSystemWindow name: {PrintD})
	(cond
		((u< [param1 0] 1000)
...
(procedure (localproc_0 param1 param2 &tmp [temp0 40]) ; UNUSED
	(= temp0 0)
	(if (> argc 1)
		(Format @temp0 821 0 param2) ; "%d"
	)
	(return
		(if (proc821_0 @temp0 5 param1)
			(ReadNumber @temp0)
		else
			-1
		)
...
(procedure (proc821_3 param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14)
	(= temp10 (= temp11 -1))
	(= temp3 (= temp4 (= temp5 (= temp6 0))))
	(= temp12 0)
	(= temp14 0)
	((= temp1 (EcoDialog new:)) window: gSystemWindow)
