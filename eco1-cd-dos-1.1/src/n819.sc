...
(procedure (NormalEgo param1 param2 param3 &tmp temp0)
	...
	(gEgo
		...
		moveSpeed: global252
		cycleSpeed:
			(* global252 (if (OneOf gNewRoomNum 320 321 322 335) 2 else 1))
	)
	(cond
		((OneOf gCurRoomNum 380 400 381)
			(gEgo view: 800 setCycle: StopWalk temp0 setStep: 2 2)
		)
		((OneOf gCurRoomNum 320 321 322 335)
			(gEgo view: 822 setCycle: Smopper 818 668 0 (* global252 2))
		)
		(else
			(gEgo
				view: 802
...
(procedure (IsFlag param1)
	(return (& [global152 (/ param1 16)] (>> $8000 (mod param1 16))))
)

(procedure (SetFlag param1 &tmp temp0)
	(= temp0 (IsFlag param1))
	(|= [global152 (/ param1 16)] (>> $8000 (mod param1 16)))
	(return temp0)
)
...
(procedure (proc819_8 param1 param2) ; UNUSED
	(if (< param1 0)
		(= param1 0)
	)
	(if (> param1 255)
