...
(instance firstKelpTalk of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				((ScriptID 2 0) init: 1 0 0 2 1 self) ; Delphineus, "No, it's not that. I think there was something in that garbage we swam through. It interfered with my sonar - you know, my direction-finding senses."
			)
			(4
				(= cycles 30)
			)
