...
(instance getWater of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gEgo setHeading: 0 self get: 14) ; waterBottle
			)
			(1
...
(instance getBeaker of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gEgo setHeading: 0 self get: 13) ; beaker
			)
			(1
				(gEgo view: 402 loop: 0 cel: 0 setCycle: CT 5 1 self)
			)
...
(instance getSodaCan of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gEgo setHeading: 0 self get: 10) ; sodaCan
			)
			(1
				(gEgo view: 402 loop: 0 cel: 0 setCycle: CT 5 1 self)
			)
			...
			(3
				(SetScore 2 213)
				(EcoNarrator posn: 160 20 init: 3 0 0 67 self) ; "Adam picks up the empty soda can."
			)
			(4
				(NormalEgo 3)
				(self dispose:)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(SetFlag 64)
				(SetScore 5 204)
				(gEgo setHeading: 0 self get: 12 get: 11) ; card, certificate
			)
			(1
...
(instance getEnvelopeToToss of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(EcoNarrator posn: 160 20 init: 3 0 0 68 self) ; "Adam picks up the torn envelope."
			)
			(4
...
(instance disposeSodaCan of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Load rsVIEW 406)
				(gEgo setHeading: 0 self put: 10) ; sodaCan
			)
			(1
				(SetFlag 63)
				(gEgo
