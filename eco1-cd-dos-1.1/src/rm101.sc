...
(instance cetusRide of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(EcoNarrator posn: -1 16 init: 1 0 0 1 self) ; "In a true champion's welcome, Adam rides on the back of King Cetus in a slow procession to the city!"
			)
			(3
				(whale setMotion: MoveTo 140 79 self)
			)
			(4
				(EcoNarrator posn: -1 16 init: 1 0 0 2 self) ; "Cetus bellows an announcement of their triumphant return!"
			)
			(5
			...
			(8
				(EcoNarrator posn: -1 16 init: 1 0 0 3 self) ; "Adam slips off the back of the mighty whale and swims to join the happy Elurians."
			)
			(9
				(gEgo
					setLoop: 2
...
(instance conchCeremony of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Superfluous init: 3 0 0 1 1 self) ; "Congratulations <sob>, Adam! Oh, I'm so moved <boo hoo>!"
			)
			(2
				(= cycles 1)
			)
			...
			(5
				(Hippocrates init: 4 0 0 1 1 self) ; "Bravo! I knew a strapping lad like you could do it!"
			)
			(6
				(= ticks 120)
			)
			...
			(8
				(Epidermis init: 5 0 0 1 1 self) ; "Like, unbelievably radical, Adam dude! Major way to go!"
			)
			(9
				(= ticks 120)
			)
			...
			(11
				(Demeter init: 6 0 0 1 1 self) ; "You have proven yourself one with the greens, Adam."
			)
			(12
				(= ticks 120)
			)
			...
			(14
				(Erroneous init: 7 0 0 1 1 self) ; "Good show, old boy! Quite spectacular indeed!"
			)
			(15
				(= ticks 120)
			)
			...
			(17
				(Gregarious init: 8 0 0 1 1 self) ; "Yer a real he-ro now, Adam! <a-hyuh>"
			)
			(18
				(= ticks 120)
			)
			...
			(20
				(Narcissus init: 9 0 0 1 1 self) ; "Eet is as well that you deed the job, Adam, since I deed not have zee time <ho-hum>. You deed almost as well as I would have, mon ami!"
			)
			(21
				(= ticks 120)
			)
			...
			(23
				(Olympia init: 10 0 0 1 1 self) ; "You were very, very brave, Adam."
			)
			(24
				(= ticks 120)
			)
			...
			(26
				(Oracle init: 11 0 0 1 1 self) ; "Child of man, to you we owe our lives, our thanks we now bestow."
			)
			(27
				(= ticks 120)
			)
			...
			(41
				((ScriptID 2 1) init: 12 0 0 1 1 self) ; Adam, "Thank you, great Cetus. I have learned much from all of you too."
			)
			(42
				(cushionFish
					init:
			...
			(56
				((ScriptID 2 1) init: 12 0 0 2 1 self) ; Adam, "Poseidon's conch! Wow! Thank you, your Majesty!"
			)
			(57
				(= ticks 180)
			)
			...
			(60
				((ScriptID 2 0) init: 13 0 0 1 1 self) ; Delphineus, "Yes Sir, your Majesty! Grab a fin, Adam!"
			)
			(61
...
(instance delphDialog of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(EcoNarrator init: 1 0 0 4 self) ; "Adam bids farewell to Eluria and King Cetus and, grabbing onto Delphineus' dorsal fin, hangs on tight for the long ride home."
			)
			(2
			...
			(3
				...
				((ScriptID 2 1) init: 12 0 0 3 1 self) ; Adam, "Delphineus?"
			)
			(4 0)
			(5
				(localproc_1 5 90 80)
			...
			(6
				(gEgo setMotion: MoveTo 370 100 self)
				((ScriptID 2 0) init: 13 0 0 2 1 self) ; Delphineus, "Yeah, Adam?"
			)
			(7 0)
			(8
				(localproc_1 5 80 70)
			...
			(9
				(gEgo setMotion: MoveTo 370 100 self)
				((ScriptID 2 1) init: 12 0 0 4 1 self) ; Adam, "Will I ever see you again?"
			)
			(10 0)
			(11
				(localproc_1 5 70 60)
			...
			(12
				...
				((ScriptID 2 0) init: 13 0 0 3 1 self) ; Delphineus, "What, are you kiddin? You and your dad? Diver Dans? You'll see a hundred dolphins in your lifetime, Adam. One of these days, one of those dolphins will be me."
			)
			(13
				(localproc_1 5 50 40)
				(gEgo posn: -20 100 setMotion: MoveTo 80 100 self)
			...
			(14
				(gEgo setMotion: MoveTo 370 100 self)
				((ScriptID 2 1) init: 12 0 0 5 1 self) ; Adam, "...I love you, Delphineus."
			)
			(15 0)
			(16
				(localproc_1 5 40 30)
			...
			(17
				(gEgo setMotion: MoveTo 370 100 self)
				((ScriptID 2 0) init: 13 0 0 4 1 self) ; Delphineus, "Aw, get out of here, ya nut ya! <sniff> ...I love you, too."
			)
			(18 0)
			(19
				(localproc_1 5 30 0)
...
(instance eye1 of EcoActor ; UNUSED
	(properties
		x 139
		y 63
		view 660
...
(instance fin of EcoActor ; UNUSED
	(properties
		x 18
		y 70
		view 660
...
(instance eye3 of EcoActor ; UNUSED
	(properties
		x 129
		y 71
		view 662
...
(instance eye4 of EcoActor ; UNUSED
	(properties
		x 129
		y 71
		view 662
...
(instance eye2 of EcoActor ; UNUSED
	(properties
		x 129
		y 71
		view 662
...
(instance eye5 of EcoActor ; UNUSED
	(properties
		x 129
		y 71
		view 662
...
(instance eye6 of EcoActor ; UNUSED
	(properties
		x 129
		y 71
		view 662
...
(instance brow of EcoActor ; UNUSED
	(properties
		x 119
		y 73
		view 662
...
(instance egogetshell of EcoActor ; UNUSED
	(properties
		x 163
		y 94
		view 853
...
(instance fish1b of EcoActor ; UNUSED
	(properties
		x 133
		y 147
		view 851
...
(instance fish2a of EcoActor ; UNUSED
	(properties
		x 218
		y 131
		view 851
...
(instance cushionFishB of EcoActor ; UNUSED
	(properties
		x 152
		y 97
		view 853
...
(instance conchB of EcoActor ; UNUSED
	(properties
		x 186
		y 88
		view 853
