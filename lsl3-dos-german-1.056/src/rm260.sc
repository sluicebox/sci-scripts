				...
				(cond
					...
					((Said 'talk,talk')
						(cond
							...
							((== 707 (gEgo view:))
								(Print 260 75) ; "Oh, wow!" exclaims Tawni, without looking up. "SOUVENIRS! Whacha selling?"
								(Print 260 76) ; "Larry! She doesn't recognize you in your clever disguise. Now if you only had something to sell her!"
							)
							((== gBeachState 4)
								(Print 260 75) ; "Oh, wow!" exclaims Tawni, without looking up. "SOUVENIRS! Whacha selling?"
								(Print 260 77) ; "She turns her head and recognizes you. "Oh, it's you, again! Leave me alone, you creep!""
								(Print 260 78 #at -1 144) ; "(Obviously she still remembers you, Larry. If only you had some sort of disguise...)"
							)
							(else
