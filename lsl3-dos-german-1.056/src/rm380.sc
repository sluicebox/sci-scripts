...
(instance RoomScript of Script
	...
	(method (handleEvent event)
		...
		(cond
			...
			(
				(or
					(Said 'use,do,class/equipment<pull,pull,bar')
					(Said 'use,do,class/bar,pull,pull')
					(Said 'use,do,class/pull,pull<bar')
					(Said 'pull,pull/bar')
				)
				(cond
					(curMachine
			...
			(
				(or
					(Said 'use,do,class/equipment<curl,curl')
					(Said 'curl,curl')
					(Said 'use,do,class/curl,curl')
				)
				(cond
					(curMachine
						(Print 380 0) ; "You are already exercising!"
			...
			(
				(or
					(Said 'use,do,class/equipment<pull,barstool')
					(Said 'pull,bell')
					(Said 'barstool<pull/')
					(Said 'get,get<on/barstool')
					(Said 'increase,use,do,class/pull,bell,bell')
				)
				(cond
					(curMachine
						(Print 380 0) ; "You are already exercising!"
			...
			(
				(or
					(Said 'use,do,class/equipment<up,pullup,pull,pull')
					(Said 'use,do,class/up<pull,pull')
					(Said 'pullup')
					(Said '(up<pull,pull)')
					(Said 'use,do,class/pullup')
				)
				(cond
					(curMachine
						(Print 380 0) ; "You are already exercising!"
