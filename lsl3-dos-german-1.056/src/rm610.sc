...
(instance RoomScript of Script
	...
	(method (handleEvent event)
		...
		(if (Said 'look,look>')
			(cond
				...
				((Said '[/drop,drop,buffet,backstage,area]')
	...
	(method (changeState newState)
		...
		(switch (= state newState)
			...
			(1
				(Print 610 5 #at 10 10 #width 290) ; "Meanwhile, back at the Sierra Studios, workers are busy filming yet another exciting episode in the never-ending saga of Sonny Bonds and the citizens of Lytton, California, U.S.A."
				(= seconds 3)
			)
			(2
			...
			(4
				(Print 610 8 #time (LangSwitch 2 2 4 4)) ; "Lights!"
				(= seconds 3)
			)
			(5
				(Print 610 9 #time (LangSwitch 2 2 4 4)) ; "Camera!"
				(aCamera setCycle: Fwd)
				(= seconds 3)
			)
			(6
				(Print 610 10 #time (LangSwitch 2 2 4 4)) ; "Action!"
				(= seconds 3)
			)
			(7
			...
			(13
				...
				(cls)
				(Print 610 13 #at 100 10 #dispose) ; "Watch out, Godzilla Larry, or you'll destroy the City of Lytton!!"
