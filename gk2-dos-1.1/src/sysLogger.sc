			...
			(and
				(or
					...
					(Print
						...
						addEdit: cfgPath 30 0 72 cfgPath
						init:
					)
				)
				(cfgPath at: 0)
			...
			(and
				...
				(or
					...
					(Print
						font: 999
						addText: str
						addButtonBM: 64990 2 0 0 {Append to it} 0 28
						addButtonBM: 64990 2 0 1 {Overwrite it} 150 28
						init:
					)
				)
			)
		...
		(if (== -1 logHandle)
			...
			(Log
				...
				(Print
					...
					addButtonBM: 64990 2 0 {Fatal} {FATAL} 0 28
					addButtonBM: 64990 2 0 {Moderate} {MODERATE} 140 28
					addButtonBM: 64990 2 0 {Minor} {MINOR} 280 28
					init:
				)
			)
			(Log
				...
				(Print
					...
					addButtonBM: 64990 0 0 {Yes} {YES} 0 28
					addButtonBM: 64990 0 0 {No} {NO} 110 28
					addButtonBM: 64990 2 0 {Intermittent} {INTERMIT.} 220 28
					init:
				)
			)
			(= i 1)
			...
			(while (<= i 10)
				...
				(str format: {SUMMARY LINE %d of %d:} i 10)
				(if commented
			...
			(Log
				...
				(Print
					...
					addButtonBM: 64990 0 0 {Art} {ART} 0 28
					addButtonBM: 64990 0 0 {Programming} {PROG} 110 28
					addButtonBM: 64990 0 0 {Audio} {AUDIO} 220 28
					addButtonBM: 64990 0 0 {Music} {MUSIC} 330 28
					addButtonBM: 64990 0 0 {Design} {DESIGN} 440 28
					init:
				)
			)
