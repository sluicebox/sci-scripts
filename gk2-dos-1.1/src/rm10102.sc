...
(instance rm10102 of ExitRoom ; "Alt\99tting: Chapel"
	...
	(method (init)
		...
		(if (IsFlag 724)
			...
			(gUser canControl: 0)
			((gUser hotCursor:) delete: vPriest)
	...
	(method (notify)
		...
		(madonnaCloseup init:)
		(altar init:)
		((gUser hotCursor:) add: vPriest)
		(vPriest view: 20798)
		((gUser hotCursor:) add: vGiftBox)
		(vGiftBox view: 30780)
		(gGame handsOn: 1)
	)
...
(instance doorCue of CueObj
	...
	(method (cue)
		((gUser hotCursor:) delete: vPriest)
		(vPriest view: 21798)
		((gUser hotCursor:) delete: vGiftBox)
		(vGiftBox view: 30800)
