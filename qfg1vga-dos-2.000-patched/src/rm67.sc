...
(instance rm67 of Rm
	...
	(method (init)
		...
		(if (not local10)
			(eyes1 setPri: 15 init: stopUpd: setScript: peekABooScript1)
			(eyes2 setPri: 15 init: stopUpd: setScript: peekABooScript2)
		)
	)
