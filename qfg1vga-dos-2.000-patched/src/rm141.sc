...
(instance egoEnters of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gEgo init: posn: 299 184 setMotion: MoveTo 155 162 self)
			)
			(2
				(Face gEgo baron)
				(= local50 (gEgo cycleSpeed:))
				(= seconds 2)
			)
			(3
				(gEgo
