...
(instance egoSez of Code
	...
	(method (doit param1 &tmp temp0 temp1 temp2)
		(switch param1
			...
			(22
				(gMessager say: 1 22 0 0 0 120) ; "The drink soothes as it goes down."
				(TakeDamage (- (/ (MaxHealth) 2)))
				(= local1 2)
				(gEgo setScript: cueIt)
			)
			(23
				(gMessager say: 1 23 0 0 0 120) ; "The drink burns as it goes down."
				(UseMana (- (/ (MaxMana) 2)))
				(= local1 3)
				(gEgo setScript: cueIt)
			)
			(24
				(gMessager say: 1 24 0 0 0 120) ; "The drink is invigorating."
				(UseStamina (- (MaxStamina)))
				(= local1 4)
				(gEgo setScript: cueIt)
			)
			(25
				(gMessager say: 1 25 0 0 0 120) ; "You don't feel anything. Perhaps this was not the correct way to use this potion."
				(= local1 5)
				(gEgo setScript: cueIt)
			)
			(29
				(gMessager say: 1 29 0 0 0 120) ; "You feel a tingling sensation as you rub the unguent all over your body."
				(SetFlag 168)
				(ClearFlag 164)
				(= global200 150)
				(= local1 6)
			...
			(32
				(gMessager say: 1 32 0 0 0 120) ; "You eat some of the apples. They actually taste quite good."
				(localproc_0)
				(= local1 7)
				(gEgo setScript: cueIt)
			)
			(33
				(gMessager say: 1 33 0 0 0 120) ; "You eat some vegetables. You think they would have been better saved for cows or horses. Real Heroes eat preserved dry rations."
				(localproc_0)
				(= local1 8)
				(gEgo setScript: cueIt)
			)
			...
			(39
				(gMessager say: 1 39 0 0 0 120) ; "You drink the clear water from the flask, draining it completely."
				(= local1 9)
				(gEgo setScript: cueIt)
			)
			(40
...
(instance mushScript of Script
	...
	(method (doit)
		...
		(if (and (IsFlag 286) (> global195 16) (not (IsFlag 360)))
