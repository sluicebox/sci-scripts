...
(instance rm321 of Rm
	...
	(method (init)
		...
		(LoadMany rsSOUND 8 13 83 (SoundFX 52) (SoundFX 35))
		(super init:)
		(SolvePuzzle 630 5 2)
		(self
			setFeatures:
		...
		(switch (= state newState)
			...
			(6
				(cond
					...
					((IsFlag 194)
						(miscMusic stop:)
						(gMessager say: 15 0 8) ; "Otto, even in his sleepy state, winds the music box and closes the lid before he heads back to bed."
