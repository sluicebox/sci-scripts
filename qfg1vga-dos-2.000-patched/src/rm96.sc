...
(procedure (localproc_2 &tmp temp0)
	(for ((= temp0 0)) (< temp0 6) ((++ temp0))
		(= [local10 temp0] (Clone (ScriptID 98 28))) ; theFly
		([local10 temp0]
			ignoreActors:
			posn: [local17 temp0] [local24 temp0]
			init:
			setLoop: 9
			setPri: 15
		)
	...
	(method (init)
		...
		(gFeatures
			add:
				...
				(ScriptID 98 2) ; Dor2
				(ScriptID 98 3) ; Dor6
				(ScriptID 98 5) ; lttleButton
				(ScriptID 98 31) ; theHandle
				littleSign
				(ScriptID 98 33) ; Dor15
				(ScriptID 98 34) ; Chain1
				(ScriptID 98 35) ; Chain2
			eachElementDo: #init
			doit:
		)
		(if (< gHowFast 3)
		...
		((ScriptID 98 30) init: posn: 500 500 setLoop: 8 stopUpd:) ; ball2
		(EgoGait 0 0) ; walking
		(NormalEgo)
	...
	(method (doit)
				...
				(switch (gEgo onControl: 1)
					...
					(16
						...
						(if (gEgo inRect: 66 95 84 105)
							(SetFlag 256)
							((ScriptID 98 13) setScript: trapFall 0 3) ; theTrap1
						else
		...
		(if (and (not (IsFlag 263)) (not (IsFlag 257)))
			(cond
				...
				((and (gEgo inRect: 11 45 33 56) (not (gEgo script:)))
					(SetFlag 263)
	...
	(method (doVerb theVerb)
		(if (OneOf theVerb 51 50 77 78 80 81 82 79) ; openSpell, detectMagicSpell, triggerSpell or Pickup Inventory, dazzleSpell, calmSpell, flameDartSpell, fetchSpell, zapSpell
			(if (and (IsObject yorick) (not local8))
				...
				(gMessager say: 7 81 1) ; "Your magic has no effect. It must be something about this room."
				(return 1)
			)
		else
...
(instance fallUpscreen of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Palette palSET_INTENSITY 71 255 0)
				(gEgo
					setPri:
						(cond
							((< (gEgo y:) 107) 6)
			...
			(2
				(Palette palSET_INTENSITY 71 255 100)
				(if (not (TakeDamage 5))
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gEgo view: 536 setLoop: 1 cel: 0 setCycle: CT 2 1 self)
			)
			(1
				(Palette palSET_INTENSITY 71 255 0)
				(gEgo
...
(instance rollOut of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gEgo setPri: 15 setMotion: MoveTo 318 116 self)
...
(instance happyFace of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				((ScriptID 98 30) posn: 500 500 stopUpd:) ; ball2
				(= ticks 30)
			)
			(6
				(if (not (IsFlag 259))
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(if (not (IsFlag 259))
					((ScriptID 98 32) dispose:) ; theHead
					(yorick view: 298 setLoop: 0 setCel: 0 setCycle: End self)
				else
					(= ticks 1)
				)
			)
			...
			(2
				(if (IsFlag 268)
					(gMessager say: 7 0 6) ; "Elsa is right next door. I'll go set up the secret exit for your escape."
				)
				(yorick setLoop: 1 setCel: 0 setCycle: MCyc @local56 self)
			)
			(3
				(yorick dispose:)
				(client view: 292 loop: 0 setCel: 0 setCycle: End self)
			)
			(4
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(cond
					(
						...
						(gEgo setPri: 15)
						(= register 1)
						((ScriptID 98 20) view: 291 loop: 10 setCel: 0) ; dor7
						(= ticks 12)
					)
			...
			(4
				...
				((ScriptID 98 20) setCycle: End self) ; dor7
			)
			(5
				((ScriptID 98 20) view: 96 loop: 1 setCel: 3) ; dor7
				(if register
					(= ticks 30)
				else
					(self changeState: 10)
			...
			(7
				((ScriptID 98 20) setCycle: Beg self) ; dor7
			)
			(8
			...
			(9
				((ScriptID 98 19) dispose:) ; bhindDoor7
				(gMessager say: 7 0 3) ; "What a miserable experience!"
				(= ticks 1)
			)
			(10
				(if (not (gEgo script:))
