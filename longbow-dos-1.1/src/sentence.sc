...
(local
	...
	[local9 16] = [1420 88 1 1 2 1 1 2 1 1 1 0 1420 96 1 0]
	[local25 4] = [1420 97 1 0]
	[local29 17] = [1420 98 1 1 2 1 1 1 1 1 2 1 2 1 3 1 0]
	[local46 15] = [1420 114 1 1 2 1 1 2 1 2 1 1 1 1 0]
	[local61 7] = [1420 126 1 2 1 2 0]
	[local68 11] = [1420 132 1 1 2 1 1 2 1 1 0]
)
...
(instance deliverJudgement1 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				(Converse 1 @local25 @local0 3 self) ; "And rise the Earl of Huntingdon!"
			)
			(12
				(= ticks 30)
			)
			...
			(14
				(Converse 3 @local29 @local0 1 3 0 21 3 self) ; "Furthermore, my present Sheriff of Nottingham is hereby under arrest for treason!"
			)
			(15
				(= ticks 120)
			)
...
(instance deliverJudgement2 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Converse 2 @local46 @local0 1 3 2 self) ; "Robin Hood, I find you innocent of all charges brought against you."
			)
			(3
				(Converse 2 @local61 2 2 @local0 3 self) ; "My Lord, there is one thing more I would humbly beg of you."
			)
			(4
				(gAddToPics eachElementDo: #dispose)
				(gCast eachElementDo: #dispose)
...
(instance deliverJudgement3 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Converse 2 @local68 @local0 3 3 2 self) ; "Robin Hood, I find you innocent of all charges brought against you."
			)
			(3
				(gAddToPics eachElementDo: #dispose)
				(gCast eachElementDo: #dispose)
