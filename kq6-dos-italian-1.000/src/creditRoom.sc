...
(local
	[local0 100]
	[local100 250]
	[local350 30] = [1 1 1 2 3 4 1 2 3 4 4 1 3 4 1 3 3 4 1 2 3 4 1 2 1 1 3 1 1 -1]
	[local380 30] = [98 100 380 240 150 480 650 520 450 580 160 490 730 690 790 770 260 750 220 470 410 510 210 290 660 200 135 240 130 -1]
	local410
	local411 = 1
	local412
	local413
...
(instance creditsScript of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(DrawPic [local380 local410] 9)
				(if (== [local380 local410] 98)
					(= cycles 2)
				else
					(setUpRoom doit: self)
				)
			...
			(1
				(if (and (== [local380 local410] 98) local414)
					(= local414 0)
			...
			(3
				(if local412
					(Message msgGET 94 1 0 0 local411 @local0)
					(Message msgGET 94 1 0 0 (++ local411) @local100)
				else
					(Message msgGET 94 0 0 0 local411 @local0)
					(Message msgGET 94 0 0 0 (++ local411) @local100)
				)
				(if (>= (++ local411) 32)
					(= local412 1)
					(= local411 1)
				)
				(switch [local350 local410]
					(1
						(Display @local0 dsCOLOR 0 dsCOORD 64 11 dsWIDTH 300 dsFONT 3110 dsALIGN alCENTER)
						(Display
							@local100
							dsCOLOR
							0
						...
						(Display @local0 dsCOLOR 7 dsCOORD 63 10 dsWIDTH 300 dsFONT 3110 dsALIGN alCENTER)
						(Display
							@local100
							dsCOLOR
							7
...
(instance showScore of Script
	...
	(method (changeState newState &tmp [temp0 200] [temp200 200])
		(switch (= state newState)
			(0
				(Message msgGET 94 0 0 0 33 @temp0)
				(Format
					@temp200
					@temp0
					gScore
				...
				(KQ6Print font: gUserFont addText: @temp200 init:)
				(= cycles 1)
			)
			(1
				(if (<= gScore 230)
