			...
			(18
				...
				(if (!= global286 3)
					(cond
						...
						((== (EScore theyTricksWon:) 5)
							(if global284
								(switch (Random 2 4)
									(2
										(gChar1
											say: 1000 1 23 0 (Random 1 2) 462
										)
									)
									(3
										(gChar2
											say: 1000 1 23 0 (Random 4 5) 464
										)
									)
									(4
										(gChar3
						...
						(else
							...
							(switch (Random 1 6)
								(2
									(gChar1
										say: 1000 1 23 0 (Random 3 5) 464
									)
								)
								(3
									(gChar2
					...
					(if
						...
						(cond
							((>= (EScore wePoints:) global283)
								(gChar2 say: 1000 1 23 0 (Random 1 2) 462)
							)
							((Random 0 1)
								(gChar1 say: 1000 1 23 0 (Random 1 2) 462)
							)
							(else
								(gChar3 say: 1000 1 23 0 (Random 1 2) 462)
							)
						)
					)
					(proc800_1)
			...
			((gTrick southPlayer:)
				...
				(cond
					((OneOf global429 hand2 hand4)
						...
						(if (== (EScore weTricksWon:) 3)
							(gChar1 say: 1000 1 23 0 (Random 4 5) 464)
							(= global253 109)
						)
					)
					((== (EScore weTricksWon:) 5)
