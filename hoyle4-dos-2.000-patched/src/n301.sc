...
(procedure (localproc_4 param1 &tmp temp0 temp1 temp2 temp3)
	(for
		((= temp1 (+ (= temp3 (global117 indexOf: (Dealer curPlayer:))) 1)))
		(<= temp1 (+ temp3 3))
		((++ temp1))
		...
		(if
			(and
				((global117 at: temp2) outOf: param1)
				(or
					(not ((global117 at: temp2) outOf: 3))
					(and
						(not (global501 queenSpades:))
						(not global503)
						(not ((global117 at: temp2) outOf: 0))
					)
				)
			)
			(return 0)
	...
	(for ((= temp6 0)) (<= temp6 (if global521 3 else 2)) ((++ temp6))
		...
		(cond
			...
			(global504
				...
				(= temp2 (- global527 1))
				(for
					((= temp7 (+ (global117 indexOf: (Dealer curPlayer:)) 1)))
					(<= temp7 (+ (global117 indexOf: (Dealer curPlayer:)) 3))
					((++ temp7))
					...
					(if ((global117 at: temp3) outOf: temp6)
						(-- temp2)
					)
				)
				(if (> temp2 temp1)
