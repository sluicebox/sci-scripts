	...
	(repeat
		(switch local4
			...
			(else
				...
				(myPrint
					addIcon: deathViewIcon 0 0 2 (proc0_21 35 35 35 35 22)
					width: local50
					font: 0
					addText:
						0
...
(instance quest of GameControls
	...
	(method (init)
		...
		((= window (GloryWindow new:))
			top: 50
			left: (proc0_21 65 65 65 65 85)
			bottom: 125
			right: (proc0_21 255 255 255 255 235)
			priority: 15
			yourself:
		)
...
(instance titleIcon of IconI
	...
	(method (show &tmp [temp0 20])
		...
		(Display @temp0 dsCOORD (proc0_21 20 20 20 20 5) 3 dsCOLOR 17)
	)
)
