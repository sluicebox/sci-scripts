...
(instance rm11302 of ExitRoom ; "Wittelsbacher Theater: Side Hallway"
	(properties
		modNum 1130
		noun 1
		picture 11302
	...
	(method (init)
		...
		(ClearFlag 814)
		(if (IsFlag 739)
			(Palette 1 (= global249 257)) ; PalLoad
		else
			(Palette 1 (= global249 258)) ; PalLoad
		)
		(super init: &rest)
		(west3Exit init:)
		(west2Exit init:)
...
(instance officeExit of ExitFeature
	(properties
		sightAngle 40
		x 333
		y 150
