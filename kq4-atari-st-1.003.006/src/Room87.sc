			...
			((== (event type:) evSAID)
				(cond
					...
					((Said 'get/candelabra,candle')
						(Print 87 9 #at -1 20) ; "It's not for you."
					)
					((Said 'bang/door')
						(if (gEgo inRect: 111 118 140 123)
							(Print 87 10 #at -1 20) ; "There's nobody there..."
						else
					...
					((Said 'open/door')
						(cond
							((!= (local6 cel:) 0)
								(Print 87 11 #at -1 20) ; "It is already open."
							)
					...
					((Said '/goon,man>')
						(cond
							((Said 'talk')
								(Print 87 14 #at -1 20) ; "Lolotte's henchmen must not speak, as you only hear them utter guttural sounds."
							)
							((Said 'get,capture')
								(Print 87 15 #at -1 20) ; "Why would you want one?!"
							)
							((Said 'kiss')
								(Print 87 16 #at -1 20) ; "That's an AWFUL thought!"
							)
							((Said 'give')
								(Print 87 17 #at -1 20) ; "The henchmen are not interested in your offering."
							)
						)
					)
				)
