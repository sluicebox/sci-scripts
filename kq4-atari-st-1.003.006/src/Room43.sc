...
(instance bridleActions of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 43 49 #at -1 20) ; "You look at the ground inside the wrecked boat. What is this?! Why, it's a golden bridle! You pick it up and carry it with you."
...
(instance deathTimer of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(16
				(Print 43 52 #at -1 20) ; "It looks like exposure and thirst have done you in, Rosella."
				((ScriptID 0 4) setReal: self 6) ; timer1
			)
			(17
				(= gDeathFlag 1)
