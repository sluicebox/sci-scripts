...
(instance rm043 of PQRoom
	...
	(method (init)
		...
		(attorneyChair init: stopUpd:)
		(reporter view: 473 loop: 4 cel: 0 x: 243 y: 175)
		(districtAttorney init: stopUpd:)
		(calendar init: stopUpd:)
		(gavel init: stopUpd:)
		(boxChair init: stopUpd:)
		(witnessBox init:)
		(SetFlag 29)
		(HandsOff)
...
(instance speechScript of rmnScript
	...
	(method (changeState newState &tmp [temp0 200] temp200)
		(switch (= state newState)
			...
			(4
				(reporter setCycle: RandCycle checkDetail:)
				(= cycles 1)
			)
			(5
				(self dispose:)
...
(instance egoGoSit of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(localproc_6 self)
				(reporter setLoop: 2 cel: 0 stopUpd:)
...
(instance notGuilty of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(defenseAttorney loop: 4 cel: 0 setPri: -1 stopUpd:)
				(= cycles 2)
			)
			(5
...
(instance ruiz of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 43 31) ; "Ruiz refuses to meet your eyes."
			)
			(5 ; Talk
				(Print 43 32) ; "Ruiz isn't any more interested in talking to you than you are in talking to him."
			)
			(4 ; Inventory
				(switch invItem
					(1 ; gun
						(Print 43 33) ; "What? In a court of law?"
					)
					(2 ; handcuff
						(Print 43 33) ; "What? In a court of law?"
					)
					...
					(else
						(Print 43 34) ; "This is a court proceeding, not a swap meet!"
					)
				)
			)
			(else
...
(instance judge of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 43 35) ; "The judge looks serious and competent."
			)
			(5 ; Talk
				(if local5
					(Print 43 36) ; "Please answer the question, sir."
				else
					(Print 43 37) ; "When the judge wants your opinion, she'll ask for it."
				)
			)
			(4 ; Inventory
				(switch invItem
...
(instance bailiff of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 43 38) ; "The bailiff doesn't look like the sort to tolerate any nonsense in his courtroom."
			)
			(3 ; Do
				(Print 43 38) ; "The bailiff doesn't look like the sort to tolerate any nonsense in his courtroom."
			)
			(5 ; Talk
				(Print 43 39) ; "The bailiff doesn't want to talk to you."
			)
			(4 ; Inventory
				(switch invItem
					(1 ; gun
...
(instance defenseAttorney of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 43 40) ; "The defense attorney is an aggressive lawyer. He would clearly like to make you look bad."
			)
			(4 ; Inventory
				(switch invItem
					(1 ; gun
...
(instance districtAttorney of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 43 41) ; "The Deputy District Attorney looks as though he's seen it all during his career. He doesn't miss a trick."
			)
			(5 ; Talk
				(cond
					(local1
					...
					(local6
						(Print 43 42) ; "Just hand him the calibration chart."
					)
					(else
						(switch local2
							(1
			...
			(4 ; Inventory
				(switch invItem
					(10 ; calibration
						(cond
							(local4
								(Print 43 43) ; "The D.A. has already seen that."
							)
							(local3
								(HandsOff)
							...
							(else
								(Print 43 44) ; "When the D.A. wants the calibration chart, he'll ask for it."
							)
						)
					)
					(1 ; gun
...
(instance reporter of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 43 45) ; "The court reporter makes a record of all court proceedings."
			)
			(5 ; Talk
				(Print 43 46) ; "The court reporter is too busy to talk to you now."
			)
			(3 ; Do
				(Print 43 47) ; "The court reporter is busy."
			)
			(4 ; Inventory
				(switch invItem
					(1 ; gun
...
(instance egoChair of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(if (== (gEgo view:) 460)
					(Print 43 48) ; "You're happy with the seat you're in."
				else
					(Print 43 49) ; "You'll need to sit up front at the prosecutor's table."
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance attorneyChair of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(if (== (gEgo view:) 460)
					(Print 43 50) ; "You're happy with the seat you're in."
				else
					(Print 43 49) ; "You'll need to sit up front at the prosecutor's table."
				)
			)
...
(instance door of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 43 51) ; "That door must lead to the judge's chambers."
			)
			(3 ; Do
				(Print 43 52) ; "You can't go in there while court is in session."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance calendar of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 43 53) ; "The judge's court calendar is on her desk."
			)
			(3 ; Do
				(Print 43 54) ; "You don't need the calendar."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance gavel of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 43 55) ; "Don't even think of messing with the Judge's gavel."
			)
			(3 ; Do
				(Print 43 56) ; "If you want a nice gavel like that, you'll just have to go to law school."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance witnessBox of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 43 57) ; "The witness box is located next to the judge's bench."
			)
			(3 ; Do
				(if local5
					(Print 43 58) ; "You're already in the witness box."
				else
					(Print 43 59) ; "The court will call you when your testimony is needed."
				)
			)
			(else
				(super doVerb: theVerb)
