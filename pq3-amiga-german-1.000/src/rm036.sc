	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(if (== (gCurRoom script:) egoPickupChart)
					(gCurRoom script: 0)
				)
				(localproc_7 self)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(20
				...
				(Say insetDoctor 36 35) ; "I don't understand this at all. I can't believe our staff could make such a serious error!."
				(SetFlag 41)
				(= seconds 12)
			)
			(21
				...
				(Say insetDoctor 36 36) ; "I have readjusted the IV. Perhaps Marie will feel better now."
				(= seconds 12)
			)
			(22
				(if gModelessDialog
...
(instance giveMusicBox of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 36 37 #at 40 115 #dispose) ; "Marie's eyelids flutter, almost as though she could hear her music box."
				(= cycles 1)
			)
			(4
...
(instance giveRose of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(Print 36 38 #at 40 115 #dispose) ; "You could swear that you just saw Marie's finger move!"
				(= seconds 7)
			)
			(5
				(if gModelessDialog
...
(instance giveLocket of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 36 39 #at 40 115 #dispose) ; "Marie's mouth moves slightly."
				(= seconds 5)
			)
			(4
...
(instance marieWakes of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(Print 36 40 #at 40 115 #dispose) ; "Marie's eyes finally open. The warmth of her smile gives you hope for the first time since her attack.  You're a lucky man, Sonny Bonds. Marie is alive and whole."
				(= seconds 13)
			)
			(7
				(if gModelessDialog
...
(instance pushButton of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(= save1 1)
				(Say nurse 36 41) ; "Do you need something, Sergeant Bonds?"
				(= seconds 3)
			)
			(10
				(if gModelessDialog
...
(instance waitForTalk of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(= save1 1)
				(Say nurse 36 42) ; "If there is nothing else, I have to get back to work."
				(= seconds 8)
			)
			(3
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(switch (Random 0 4)
					(0
						(Say egoOffScreen 36 43) ; "I never lost hope! I just knew that somehow, someway, you would come back to me."
					)
					(1
						(Say egoOffScreen 36 44) ; "It was your strength and your will to live that brought you back."
					)
					(2
						(Say egoOffScreen 36 45) ; "You're going to be fine now sweetness. You'll be up and around in no time."
					)
					(3
						(Say egoOffScreen 36 46) ; "There's no doubt in my mind, somebody up there is looking out for you."
					)
					(4
						(Say egoOffScreen 36 47) ; "We're real close to nailing the animals that caused this."
					)
				)
				(= seconds 6)
			)
...
(instance seeIV of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(= save1 1)
				(Print 36 48 #at 40 115) ; "The digital readout indicates Marie's IV dosage."
				(SetFlag 43)
				(= cycles 1)
			)
			(3
...
(instance doctor of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 36 49) ; "The doctor looks tired but sympathetic."
			)
			(5 ; Talk
				(Print 36 50 #at 40 115) ; "One moment, Sir."
			)
			(3 ; Do
				(Print 36 51) ; "That won't help Marie come back. They're doing all they can."
			)
			(4 ; Inventory
				(switch invItem
					(19 ; wallet
						(Print 36 52) ; "You've already introduced yourself to the hospital staff."
					)
					(1 ; gun
						(Print 36 51) ; "That won't help Marie come back. They're doing all they can."
					)
...
(instance nurse of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 36 53) ; "The nurse looks competent and sturdy."
			)
			(5 ; Talk
		...
		(switch theVerb
			(3 ; Do
				(if (> gDay 1)
					...
					(Print 36 54) ; "Marie is resting gently. You don't want to disturb her."
				)
			)
			(5 ; Talk
				(localproc_3)
				...
				(switch invItem
					...
					(36 ; rose
						(if (not (> ((gInventory at: 36) state:) 0)) ; rose
							...
							(Print 36 55) ; "You gently place a fresh rose in Marie's hand.  However, there is no response. Nice try Sonny."
							(gEgo put: 36) ; rose
						)
					)
					(37 ; locket
					...
					(1 ; gun
						(Print 36 56) ; "Marie's condition might yet be reversible. Don't give up without a fight."
					)
					(else
						(super doVerb: theVerb &rest)
					)
...
(instance chart of Feature
	...
	(method (doVerb theVerb)
		(if (== theVerb 2) ; Look
			(Print 36 57) ; "That's where the doctor hangs the patient's chart."
		else
			(super doVerb: theVerb &rest)
		)
	)
...
(instance chartView of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 58) ; "It's Marie's hospital chart."
			)
			(3 ; Do
				(HandsOff)
...
(instance ivStand of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 36 59) ; "You can't change the medication by yourself."
			)
			(2 ; Look
				(HandsOff)
...
(instance hospitalWindow of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 60) ; "The window overlooks the hospital parking lot."
			)
			(3 ; Do
				(Print 36 61) ; "The room temperature is monitored carefully by the staff.  You don't need to open the window."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance bed of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (>= (mariesEyes cel:) 1)
					(Print 36 62 #at 40 115) ; "Marie lies awake in the bed."
				else
					(Print 36 63 #at 40 115) ; "Marie lies motionless on the hospital bed."
				)
			)
			(3 ; Do
				(Print 36 64) ; "The hospital bed does not need adjustment."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance ekgMonitor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (>= (mariesEyes cel:) 1)
					(Print 36 65) ; "Words cannot discribe the joy you feel seeing Marie awake from her coma."
				else
					(Print 36 66 #at 40 115) ; "The EKG monitor registers your wife's vital signs.  Its steady beep in response to her pulse gives you some small comfort."
				)
			)
			(3 ; Do
				(if (>= (mariesEyes cel:) 1)
					(Print 36 67) ; "The Monitor's beep reminds you that although Marie is awake, she is not out of the woods yet."
				else
					(Print 36 68) ; "Leave the monitor alone. It will alert the staff if Marie goes into distress."
				)
			)
			(else
				(super doVerb: theVerb &rest)
...
(instance metalStand of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 69) ; "The rolling metal stand provides a moving table for the nurses or your wife - if she were conscious to use it."
			)
			(3 ; Do
				(Print 36 70) ; "You do not need the metal stand."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance cabinet of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 71) ; "The cabinet contains general hospital issue plastics and a few personal items belonging to your wife."
			)
			(3 ; Do
				(Print 36 72) ; "There's nothing in the cabinets that would be of use to you."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance visitorsChair of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 73) ; "That chair is provided for the patient's visitors."
			)
			(3 ; Do
				(if
					(not
					...
					(Print 36 74) ; "You're too upset by the sight of Marie to even think about sitting down."
				else
					(Print 36 75) ; "You don't feel like sitting right now."
				)
			)
			(else
				(super doVerb: theVerb &rest)
...
(instance curtains of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 76) ; "The curtains are there to provide privacy for Marie during examinations and medical procedures."
			)
			(3 ; Do
				(Print 36 77) ; "There's no reason to draw the curtains right now."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance wall of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 78) ; "The walls in here are depressingly bare."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance floor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 79) ; "The linoleum is shiny and clean."
			)
			(else
				(super doVerb: theVerb &rest)
			)
		...
		(switch theVerb
			...
			(5 ; Talk
				(cond
					...
					(else
						(Print 36 80 #at 40 115) ; "You talk gently to your wife, hoping that some part of her hears you."
					)
				)
			)
			(2 ; Look
				(if (>= (mariesEyes cel:) 1)
					(Print 36 81 #at 40 115) ; "You are overjoyed to see your wife recovered."
				else
					(Print 36 82 #at 40 115) ; "Your beloved wife lies motionless in a coma. You wish there was some way to know what she's thinking... if she's thinking."
				)
			)
			(4 ; Inventory
				(switch invItem
					...
					(36 ; rose
						(if (not (> ((gInventory at: 36) state:) 0)) ; rose
							...
							(Print 36 83 #at 40 115) ; "You gently place a fresh rose in Marie's hand.  However, there is no response."
							(gEgo put: 36) ; rose
						)
					)
					(37 ; locket
					...
					(19 ; wallet
						(Print 36 84 #at 40 115) ; "Marie's proud of your career as a police officer, but she's not interested in your badge right now."
					)
					(1 ; gun
						(Print 36 85 #at 40 115) ; "Marie's condition might yet be reversable. Don't give up without a fight."
					)
					(else
						(super doVerb: theVerb &rest)
					)
...
(instance ekg of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(if (>= (mariesEyes cel:) 1)
					(Print 36 65 #at 40 115) ; "Words cannot discribe the joy you feel seeing Marie awake from her coma."
				else
					(Print 36 66 #at 40 115) ; "The EKG monitor registers your wife's vital signs.  Its steady beep in response to her pulse gives you some small comfort."
				)
			)
			(3 ; Do
				(if (>= (mariesEyes cel:) 1)
					(Print 36 86) ; "You shouldn't mess with things you know nothing about."
				else
					(Print 36 68) ; "Leave the monitor alone. It will alert the staff if Marie goes into distress."
				)
			)
...
(instance light of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 87) ; "The light casts a clinical glare over Marie's face."
			)
			(3 ; Do
				(Print 36 88) ; "There's no reason to turn off the light."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance nurseButton of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 89) ; "It's a call button."
			)
			(3 ; Do
				(if (IsFlag 41)
					(Print 36 90) ; "You don't need the nurse now."
				else
					(Print 36 91 #at 40 115) ; "You press the call button and hope that the nurse is on the way."
...
(instance roseInset of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 92) ; "The rose is still fresh and beautiful."
			)
			(3 ; Do
				(Print 36 93) ; "Let Marie keep her rose."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance musicboxInset of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 94) ; "Marie's music box lies next to her on the bed."
			)
			(3 ; Do
				(Print 36 95) ; "Let Marie keep her music box."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance locketInset of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 36 96) ; "It's Marie's lovely locket."
			)
			(3 ; Do
				(Print 36 97) ; "Let Marie keep her locket."
			)
			(else
				(super doVerb: theVerb &rest)
			)
