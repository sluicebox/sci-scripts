...
(instance fireHydrant of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 49 7) ; "There's a fire hydrant on the sidewalk."
			)
			(3 ; Do
				(Print 49 8) ; "Since you're not a dog, I'll ignore that request."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance tree of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 49 9) ; "The tree looks lonely amid all that brick and concrete."
			)
			(3 ; Do
				(Print 49 10) ; "Not having a green thumb, you leave the tree alone."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance coronerSign of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 49 11) ; "The sign reads "Coroner"."
			)
			(3 ; Do
				(Print 49 12) ; "There's nothing you can do with the sign."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance building of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 49 13) ; "This building houses the County Coroner's office."
			)
			(3 ; Do
				(Print 49 14) ; "Just use the front door."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance sidewalk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 49 15) ; "Like all county buildings,the sidewalks are kept clean and tidy."
			)
			(3 ; Do
				(Print 49 16) ; "There's nothing you can do with the sidewalk."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance street of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 49 17) ; "The asphalt looks hot and dry."
			)
			(3 ; Do
				(Print 49 18) ; "Ok Bonds,... Lets try and keep our mind on our work!"
			)
			(else
				(super doVerb: theVerb)
			)
