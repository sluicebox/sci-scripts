...
(instance cushion of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 52 11) ; "A sofa cushion is on the floor."
			)
			(3 ; Do
				(Print 52 12) ; "The cushion doesn't interest you."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance bluePatch of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 52 13) ; "Just something else that was melted by the intense heat of the fire."
			)
			(3 ; Do
				(Print 52 14) ; "The melted glob doesn't interest you."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance hallway of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 52 15) ; "A hallway leads off from what's left of the living room."
			)
			(3 ; Do
				(Print 52 16) ; "Just walk there."
			)
			(else
				(super doVerb: theVerb &rest)
			)
