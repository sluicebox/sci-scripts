...
(instance rm201 of Rm
	...
	(method (init &tmp temp0)
		...
		(rArrow init:)
		(trashBut
			view: (proc0_20 2005 2004 2004 2004 2004)
			x: (proc0_20 28 23 23 23 23)
			init:
		)
		(quitBut
			view: (proc0_20 2005 2004 2004 2004 2004)
			x: (proc0_20 299 296 296 296 296)
			init:
		)
		(helpBut
			view: (proc0_20 2005 2004 2004 2004 2004)
			x: (proc0_20 250 255 255 255 255)
			init:
		)
		(searchBut
			view: (proc0_20 2005 2004 2004 2004 2004)
			x: (proc0_20 90 72 72 72 72)
			init:
		)
		(lFace init:)
		(cFace init:)
	...
	(method (handleEvent event)
		(switch (event type:)
			(evKEYBOARD
				(if
					(or
						(== (event message:) (proc0_20 108 99 99 99 99))
						(== (event message:) (proc0_20 76 67 67 67 67))
					...
					(or
						(and
							...
							(or
								(==
									(event message:)
									(proc0_20 118 115 115 115 115)
								)
								(== (event message:) (proc0_20 86 83 83 83 83))
							)
						)
						(and
							(== (event message:) KEY_RETURN)
