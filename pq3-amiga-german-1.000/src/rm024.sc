...
(instance tracker of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 49) ; "It is a tracking device."
			)
			(3 ; Do
				(HandsOff)
...
(instance cabinet of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 50) ; "That's Mike's cabinet."
			)
			(3 ; Do
				(Print 24 51) ; "Don't look through Mike's cabinet."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance deskD of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 52) ; "That's Mike's desk."
			)
			(3 ; Do
				(HandsOff)
...
(instance banks of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 53) ; "The size of the department's main computer banks always astounds you."
			)
			(3 ; Do
				(Print 24 54) ; "You're not qualified to screw around with the mainframe."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance desk of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(3 ; Do
				(Print 24 55) ; "There's nothing for you on the desk right now."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance computer of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 56) ; "That's Mike's computer."
			)
			(3 ; Do
				(Print 24 57) ; "Mike's very protective of his computers."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance table of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 58) ; "The table holds various computer magazines - none of which interest you."
			)
			(3 ; Do
				(Print 24 59) ; "The computer magazines are of little interest."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance glass of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 60) ; "The glass wall divides dispatch from the computer facilities."
			)
			(3 ; Do
				(Print 24 61) ; "Don't rap on the window and disturb dispatch!"
			)
			(4 ; Inventory
				(Print 24 62) ; "You have an evil mind."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance floor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 63) ; "The elevated floor consists of individual movable tiles. All the computer cables run underneath the tiles."
			)
			(3 ; Do
				(Print 24 64) ; "You don't need to get at the computer cables and Mike wouldn't let you anyway."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance inOut of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 65) ; "That is Mike's In\Out basket."
			)
			(3 ; Do
				(Print 24 66) ; "It is empty."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 24 67) ; "The third floor is home to the computer facilities and dispatch."
			)
			(else
				(super doVerb: theVerb)
			)
