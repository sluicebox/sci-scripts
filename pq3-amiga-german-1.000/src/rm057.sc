		...
		(switch theVerb
			(4 ; Inventory
				(switch invItem
					(1 ; gun
						(if local2
							(Print 57 4) ; "It's too late for that!"
						else
							(HandsOff)
							(if ((gInventory at: 1) state:) ; gun
								(self setScript: 0)
					...
					(else
						(Print 57 5) ; "That will really stop him."
					)
				)
			)
			(3 ; Do
				(Print 57 6) ; "You think you're superman?"
			)
			(else
...
(instance stairs of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 57 7) ; "The stairs lead back up to the living room"
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance shelves of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 57 8) ; "The shelves have various supplies."
			)
			(3 ; Do
				(Print 57 9) ; "You don't want to disturb the evidence."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance table of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 57 10) ; "The table is covered with various tools to make drugs."
			)
			(3 ; Do
				(Print 57 9) ; "You don't want to disturb the evidence."
			)
...
(instance barrels of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 57 11) ; "The barrels contain chemicals to make drugs."
			)
			(3 ; Do
				(Print 57 9) ; "You don't want to disturb the evidence."
			)
...
(instance theRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 57 12) ; "The basement is a seedy looking place, with all the aroma of a drug lab."
			)
			(else
				(super doVerb: theVerb)
			)
