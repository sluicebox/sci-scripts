...
(instance fireplace of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 14) ; "A large fireplace dominates the room."
			)
			(3 ; Do
				(Print 56 15) ; "You examine the fireplace but do not find anything of interest."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance tv of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 56 16) ; "You don't have time for that now!"
			)
			(4 ; Inventory
				(switch invItem
					(43 ; remoteControl
						(if (gCast contains: fireplace)
							...
							(Print 56 17) ; "You already have the passage open."
						)
					)
					(else
						(super doVerb: theVerb)
			...
			(3 ; Do
				(Print 56 18) ; "You examine the TV but find nothing unusual."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance bains of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 56 19) ; "A second suspect is surrendering. It takes you a moment to realize it's... it's Michael Bains!"
			)
			(4 ; Inventory
				(switch invItem
					(2 ; handcuff
			...
			(3 ; Do
				(Print 56 20) ; "You better restrain him first."
			)
			(5 ; Talk
				(HandsOff)
...
(instance dog of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 21) ; "Spike looks agitated. He seems to have found something."
			)
			(3 ; Do
				(Print 56 22) ; "Spike prefers not to be petted while he's concentrating."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance cushion of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 23) ; "A scuffed up cushion sits on the couch."
			)
			(3 ; Do
				(cond
					((gEgo has: 43) ; remoteControl
						(Print 56 24) ; "There is nothing more under the cushion."
					)
					((gCast contains: bains)
						(Print 56 25) ; "Now is not the time to snoop around."
					)
					(else
						(HandsOff)
...
(instance stairs of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 26) ; "Part of the fireplace has moved away to reveal a hidden staircase."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theDoor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 27) ; "The ruined steel door lies useless on the floor."
			)
			(3 ; Do
				(Print 56 28) ; "Now that the door's been knocked in, it doesn't interest you."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance thePaper of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 29) ; "Newspapers are scattered around the floor."
			)
			(3 ; Do
				(Print 56 30) ; "You see nothing of interest."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance thePicture of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 31) ; "She's from December, if you remember correctly."
			)
			(3 ; Do
				(Print 56 32) ; "Marie wouldn't approve of you taking that picture home."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theWalls of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 33) ; "The walls are cracked and peeling."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theWindow of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 34) ; "There are bars on the windows."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theCouch of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 35) ; "The old couch has a few cushions on it."
			)
			(3 ; Do
				(Print 56 36) ; "There's nothing under that cushion."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 56 37) ; "You're in the alleged crack house."
			)
			(else
				(super doVerb: theVerb)
			)
