...
(instance candles of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 53 11) ; "Large white candles mark the points of a large pentagram painted on the floor."
			)
			(3 ; Do
				(Print 53 4) ; "Even the idea of touching this sicko stuff disgusts you."
			)
...
(instance pipe of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 53 12) ; "The pipe doesn't interest you."
			)
			(2 ; Look
				(Print 53 13) ; "Exposed water pipes and charred studs are all that remain of some of the interior walls."
			)
			(else
				(super doVerb: theVerb &rest)
			)
