	...
	(method (doit)
		(cond
			...
			((& (gEgo onControl: 1) $0008)
				(HandsOff)
				(self x: 182 y: 108 setScript: (ScriptID 896 2) 0 18) ; sWO
			)
		)
		(super doit:)
	)
...
(instance briefDoor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 0) ; "That's the door to the Briefing Room."
			)
			(3 ; Do
				(HandsOff)
			...
			(4 ; Inventory
				(Print 19 1) ; "That's unnecessary. Just walk through the door."
			)
			(else
...
(instance psychDoor of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 2) ; "That's the door to the Criminal Psychologist's office."
			)
			(3 ; Do
				(HandsOff)
			...
			(4 ; Inventory
				(Print 19 3) ; "That's unnecessary. Just open the door."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance lockDoor of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 4) ; "That's the door to Vice."
			)
			(3 ; Do
				(Print 19 5) ; "The Vice door is locked."
			)
			(4 ; Inventory
				(Print 19 6) ; "That won't get you anywhere."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance nightWin of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 7) ; "The window overlooks scenic downtown Lytton."
			)
			(3 ; Do
				(Print 19 8) ; "You don't need to open the window."
			)
			(4 ; Inventory
				(Print 19 6) ; "That won't get you anywhere."
			)
...
(instance briefWindow of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 9) ; "The window is in the Vice Office."
			)
			(3 ; Do
				(Print 19 8) ; "You don't need to open the window."
			)
...
(instance psychWindow of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 10) ; "The window is in the Psychologist's Office. The blinds are shut."
			)
			(3 ; Do
				(Print 19 8) ; "You don't need to open the window."
			)
...
(instance smokeAlarm of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 11) ; "It's a smoke detector! A small label on the side reads: "For best results, hold directly over flame"."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theCarpet of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 12) ; "Hmm, 'policeman blue'."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 19 13) ; "You're in the hallway of the second level of the Lytton Police Station. Several office doors line the hallway."
			)
			(else
				(super doVerb: theVerb)
			)
