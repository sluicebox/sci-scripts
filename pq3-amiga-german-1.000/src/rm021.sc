		...
		(switch theVerb
			...
			(2 ; Look
				(cond
					...
					((< (Random 0 100) 5)
						(Print 21 117) ; "Herein lies the names of the programmers who without undo fanfare brought you this game. Doug Oldfield, Chris Hoyt, Kim Bowdish, Mike Larsen, and Chris Carr."
					)
					(else
