...
(instance oliver of Feature
	...
	(method (doVerb theVerb)
		(cond
			(2
				(Print 32 11) ; "It's one of the paramedics."
			)
			(5
				((= local0 oMouth) init:)
...
(instance marie of Feature
	...
	(method (doVerb theVerb)
		(cond
			(2
				(Print 32 12) ; "Marie has no color in her face and is breathing very shallow."
			)
			(5
				(Print 32 13) ; "You try waking her, but she doesn't respond."
			)
			(else
				(super doVerb: theVerb)
			)
