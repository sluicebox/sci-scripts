...
(instance rm203 of Rm
	...
	(method (init)
		...
		(reviewBut
			view: (proc0_20 1971 197 197 197 197)
			x: (proc0_20 51 48 48 48 48)
			init:
			stopUpd:
		)
		(newBut
			view: (proc0_20 1971 197 197 197 197)
			x: (proc0_20 144 151 515 151 151)
			init:
			stopUpd:
		)
		(numBut
			view: (proc0_20 1971 197 197 197 197)
			x: (proc0_20 202 204 204 204 204)
			init:
			stopUpd:
		)
		(gTheIconBar disable:)
		...
		(if (not (gCurRoom script:))
			(switch (event type:)
				(evKEYBOARD
					(if
						(or
							(== (event message:) (proc0_20 119 99 99 99 99))
							(== (event message:) (proc0_20 87 67 67 67 67))
							(and
								(== (event message:) KEY_RETURN)
								(MousedOn self event)
							)
