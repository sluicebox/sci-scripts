		...
		(cond
			...
			((& (gEgo onControl: 0) $0002)
				(if (not (IsFlag 1))
					...
					(self x: 239 y: 103 setScript: (ScriptID 896 2) 0 19) ; sWO
				)
			)
...
(instance OIC of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 22 38) ; "That's Officer Kevin Miller. He's one of the old-school cops."
			)
			(3 ; Do
				(Print 22 39) ; "Hands off, Bonds!"
			)
			(5 ; Talk
				(HandsOff)
				(gCurRoom setScript: oicScript)
			...
			(4 ; Inventory
				(switch invItem
					(1 ; gun
						(Print 22 40) ; "Sonny Bonds wouldn't do that in a million years."
					)
					(19 ; wallet
						(Print 22 41) ; "They KNOW who you are, Bonds."
					)
					(else
...
(instance cop1 of Actor
	...
	(method (doVerb theVerb invItem &tmp temp0)
		(switch theVerb
			(2 ; Look
				(Print 22 42) ; "That's Officer Carl Law. Carl's a real cut-up."
			)
			(3 ; Do
				(Print 22 39) ; "Hands off, Bonds!"
			)
...
(instance cop2 of Prop
	...
	(method (doVerb theVerb invItem &tmp temp0)
		(switch theVerb
			(2 ; Look
				(Print 22 43) ; "That's Officer Joseph Banks. Young, smart, and takes his job very seriously."
			)
			(3 ; Do
				(Print 22 39) ; "Hands off, Bonds!"
			)
...
(instance clipBoard of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 44) ; "The clipboard contains the notes for today's briefing."
			)
			(3 ; Do
				(if (not (IsFlag 1))
					(HandsOff)
					...
					(Print 22 45) ; "This afternoon's briefing is already concluded."
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance pat of Actor
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 22 46) ; "The female officer is Pat Morales. You hear she's a tough cookie."
			)
			(3 ; Do
				(Print 22 47) ; "Not a chance."
			)
			(5 ; Talk
				(HandsOff)
			...
			(4 ; Inventory
				(switch invItem
					...
					(1 ; gun
						(Print 22 48) ; "Surely you can think of better ways to handle a woman - even an arrogant one!"
					)
					(19 ; wallet
						(Print 22 41) ; "They KNOW who you are, Bonds."
					)
...
(instance pChair of View
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 49) ; "The chairs are for the officers attending the briefing."
			)
			(3 ; Do
				(Print 22 50) ; "You don't need to sit down."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance door of PicView
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 51) ; "The door leads back to the hall."
			)
			(3 ; Do
				(Print 22 52) ; "Just walk out."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance chalkboard of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 54) ; "The chalkboard has nothing important on it at this time."
			)
			(3 ; Do
				(Print 22 55) ; "Sorry, no chalk."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance podium of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 56) ; "The podium is used for giving briefings."
			)
			(3 ; Do
				(Print 22 57) ; "You can't give the briefing that way."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance messageBoard of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 58) ; "The message board is where the daily briefing notes are posted after the briefing."
			)
			(3 ; Do
				(Print 22 59) ; "Those postings need to stay up for public consumption."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance tables of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 60) ; "The tables are for the officers attending the briefing."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance briefingRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 22 61) ; "This is the briefing room. The junior officers meet here for news, reminders, and the occasional reprimands."
			)
			(else
				(super doVerb: theVerb)
			)
