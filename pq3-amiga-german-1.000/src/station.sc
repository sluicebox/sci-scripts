		...
		(switch (= state newState)
			...
			(3
				(cond
					...
					((IsFlag 54)
						(EgoDead 8) ; "Your failure to respond to the Aspen Falls call resulted in a suspension. An officer who doesn't report to assigned calls puts the public in danger."
					)
					((IsFlag 8)
