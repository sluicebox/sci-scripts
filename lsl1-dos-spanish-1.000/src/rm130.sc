...
(instance rm130 of LLRoom
	...
	(method (init &tmp foo)
		...
		(if (ObjInRoom 4)
			(theSparkle cycleSpeed: gHowFast init: approachVerbs: 3 4 10 11 2) ; Do, Inventory, Zipper, Taste/Smell, Look
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(overflow init: cycleSpeed: (+ 3 gHowFast) setCycle: End self)
