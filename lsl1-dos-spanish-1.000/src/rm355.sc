		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(12 ; wine
						(Print 355 59) ; "Oh, no, thanks. It is against regulations for security guards to drink while on duty."
					)
					(13 ; magazine
						(Print 355 60) ; "Faith has her own "Jugs," Larry!"
					)
					(14 ; hammer
						(Print 355 61) ; "You'd better not threaten me, Buddy! My weapons are bigger than yours!"
					)
					(15 ; pills
						(HandsOff)
					...
					(else
						(if 1
							...
							(Printf 355 62 global314 global323) ; "I'm sorry, Sir, but I'm on duty right now, and even if I were off-duty, I'd still have no use whatsoever for %s!"
