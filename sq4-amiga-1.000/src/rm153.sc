	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(localproc_0 0 {Well... what have we here?})
				(= seconds 4)
			)
			(2
				(theMouth hide:)
			...
			(4
				(localproc_0 1 {He had just aided Wilco in escaping.})
				(= seconds 5)
			)
			(5
				(localproc_0
			...
			(6
				(localproc_0 1 {...into this time sector as you feared.})
				(= seconds 5)
			)
			(7
				(theMouth setCel: 0 show: setCycle: ForwardCounter 5)
				(theEyes show: setCycle: ForwardCounter 3)
				(localproc_0 0 {That is no longer a concern.})
				(= seconds 4)
			)
			(8
