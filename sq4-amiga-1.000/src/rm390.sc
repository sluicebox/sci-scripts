	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(self
					save1:
						(proc0_12 {I am in pursuit of Wilco.} 67 175 80 70 140)
				)
				(= seconds 5)
			)
			(4
			...
			(5
				...
				(self
					save1:
						(proc0_12
							{He is must be hiding in a store.}
							67
							175
							70
							70
			...
			(8
				...
				(self
					save1:
						(proc0_12
							{Good. I will cover the the opposite direction.}
							67
							30
							130
							28
...
(instance hideEgoInStore of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(Print 390 0) ; "These guys mean business, alright. But they sure aren't Harvard graduates."
				(HandsOn)
...
(instance store of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 390 1) ; "It feels just like a store with hot dogs and pickles stuck to it."
			)
			(11 ; Smell
				(Print 390 2) ; "It smells like all the other 15,000,000,000 Radio Shocks all throughout the Greater Crab Nebula Metro Area."
			)
			(10 ; Taste
				(Print 390 3) ; "It's like licking a battery."
			)
			(else
...
(instance steps of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(11 ; Smell
				(Print 390 4) ; "They smell like used foot powder, ground sole dust, and an interesting potpourri of granules from the various items that hitched free rides on said shoes."
			)
			(10 ; Taste
				(Print 390 5) ; "Oh, this doesn't taste good! YUCK!"
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance bush1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(3 ; Do
				(Print 390 6) ; "They're bolted down. Maybe you're not the first one to try stealing these decorative PermaShrubs."
			)
			(else
				(super doVerb: theVerb &rest)
			)
