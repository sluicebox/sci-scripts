...
(local
	...
	[local272 36] = [123 210 154 164 185 210 118 210 111 152 50 210 219 210 249 142 274 210 78 210 66 146 20 210 327 20 287 52 327 52 -7 27 29 73 -7 73]
)
			...
			(3 ; Do
				(cond
					...
					(
						...
						(Print 705 6) ; "You start to give the rope a tug, but come to the realization that the puny little strand wouldn't have much effect on him. Besides, why would you want to catch this grotesque dude anyway?"
					)
					(else
