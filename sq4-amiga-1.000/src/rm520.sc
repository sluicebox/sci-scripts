...
(instance rm520 of SQRoom
	...
	(method (init)
		...
		(switch (brain level:)
			(1
				(brain
					makePolygon: 0 159 60 159 95 180 208 180 246 162 246 105 210 121 210 156 96 156 96 118 63 106 63 134 0 134 0 0 319 0 319 189 0 189
				)
			)
			(2
				(brain
	...
	(method (doVerb theVerb)
		(switch theVerb
			(5 ; Talk
				(Print 520 0) ; "You'd better not. Something might answer."
			)
			(else
