				...
				(cond
					((OneOf (gEgo view:) 373 374)
						(self
							save1:
								(proc0_12
									{I am dearly sorry, Miss. This is a male clothing store.}
									67
									0
									20
									28
		...
		(switch (= state newState)
			...
			(1
				(self
					save1:
						(proc0_12
							{I see. Well, alright, let me get your measurements.}
							67
							0
							20
							28
			...
			(3
				...
				(if
					...
					(gEgo ignoreActors: 0 setMotion: PolyPath 140 90 self)
				)
			)
			(5
				(if local1
			...
			(10
				(self
					save1:
						(proc0_12
							{I assume you'll be wanting something in the generic space hero line.}
							67
							0
							20
							28
			...
			(14
				(self
					save1:
						(proc0_12
							{These will do for you. Try them on in the dressing room here, if you wish.}
							67
							0
							20
							28
		...
		(switch (= state newState)
			(0
				(if (not (IsFlag 17))
					...
					(Print 381 3) ; "You start to talk to the clerk but realize there is nothing else in here that would fit, much less be useful."
					(self dispose:)
				)
			)
			(2
		...
		(switch (= state newState)
					...
					(10
						(if
							...
							(self
								save1:
									(proc0_12
										{I am sorry, we don't accept ATM cards.}
										67
										0
										20
										28
			...
			(4
				...
				(self
					save1:
						(proc0_12
							{Thank you so much for shopping with us, sir. Do come back soon.}
							67
							0
							20
							28
...
(instance theShop of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; Smell
				(Print 381 4) ; "The store smells very much like a clothing store."
			)
			(else 0)
		)
	)
...
(instance dressingRoom of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(11 ; Smell
				(Print 381 5) ; "Grabbing a whiff confirms the suspicion that others have changed clothing here. Now if they'd only change socks..."
			)
			(10 ; Taste
				(Print 381 6) ; "There is nothing here you'd want to lay the old buds on."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance BargainShelf of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; Smell
				(Print 381 7) ; "You gather in the various fragrances offered by the menage of useless items stored here. You learn only that you don't want to do it again."
			)
			(10 ; Taste
				(Print 381 8) ; "Hey, there really is a difference in taste between the bargain brands and name brands!"
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance alienSuit1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(10 ; Taste
				(Print
					{Do that and your anal-retentive host might have a stroke.}
				)
			)
			(3 ; Do
				(Print
					{The suits are protected inside glass cases. Besides, none of them would fit you.}
				)
			)
			(else
				(super doVerb: theVerb)
...
(instance shelves of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 381 9) ; "I'm sure the clerk would almost be glad to help you."
			)
			(11 ; Smell
				(Print 381 7) ; "You gather in the various fragrances offered by the menage of useless items stored here. You learn only that you don't want to do it again."
			)
			(10 ; Taste
				(Print 381 10) ; "Want more fiber in your diet?"
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance CashRegister of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(3 ; Do
				(Print 381 11) ; "You start to mess with the register but quickly cease when you notice a sign which reads "Warning! Unauthorized users will be killed on sight!" These Beancounter folks take your money seriously."
			)
			(11 ; Smell
				(Print 381 12) ; "The heady scent of currency emanates from the revenue collection device."
			)
			(10 ; Taste
				(Print 381 13) ; "The dull taste of cold metal leaves you wanting for more."
			)
			(else
				(super doVerb: theVerb)
			)
