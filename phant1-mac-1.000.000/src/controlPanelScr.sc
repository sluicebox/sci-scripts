...
(instance titleBarButton of Prop
	...
	(method (doVerb)
		(if (localproc_0 self 1)
			(if (== (titleBarHilite cel:) 1)
				(screams number: 33533 init: setVol: 127 setLoop: -1 play:)
				(= local39 1)
...
(instance titleBarHilite of View
	...
	(method (init)
		(self setPri: 199 ignoreActors: 1 cel: 1)
		(super init: &rest)
	)
)
