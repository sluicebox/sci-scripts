...
(procedure (localproc_0)
	(if (< (textScroller maxItems:) (++ local1))
		(textScroller maxItems: local1)
	)
	(textScroller addString: (local2 data:) 0 24 1)
)
...
(instance rm45 of Room
	...
	(method (init &tmp temp0 temp1)
		...
		(= local0 (Str new: 132))
		(= local2 (Str new: 132))
		(= temp1 (Str newWith: 10 {pdoco.txt}))
		(KString 5 (local2 data:) 0 132 0) ; StrFill
		(KString 5 (local0 data:) 0 132 0) ; StrFill
	...
	(method (doit)
		(if (== (DoAudio audPOSITION 102 0 0 0 1) -1)
