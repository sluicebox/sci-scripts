...
(instance startingCartoon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager say: 11 0 34 1) ; "(ON PHONE AS GABE COMES OUT OF STUDIO IN THE MORNING)Mmmm-hmmm. I bet. Just a minute."
			...
			(4
				(gMessager say: 11 0 34 2) ; "(TO GABRIEL)It lives, I see. Do you want to speak with 'Lolita?'"
				(gEgo setLoop: 2 setSpeed: 11 setCycle: End self)
			)
			(5
				(gEgo setLoop: 3 setSpeed: 10 setCycle: Osc 1 self)
			)
			(6
			...
			(26
				...
				((ScriptID 210 1) view: 213 setCel: 0 setLoop: 2 setCycle: End) ; graceProp
			)
			(27
				(ClearFlag 361)
				((ScriptID 210 1) setCel: 4 setCycle: 0) ; graceProp
