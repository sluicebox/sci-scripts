	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(gMessager say: 26 0 4 3 self) ; "I am the proprietor, Dr. John. If you have any questions I will be happy to assist."
			)
			(6
				(drJohnHead posn: 269 76 dispose:)
				(gMessager say: 26 0 4 4 self) ; "Great. My name is Knight, and I'll probably take you up on that."
			)
			(7
...
(instance flipTheSwitch of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gGkSound1 number: 2601 setLoop: -1 play:)
				(gGkMusic2 number: 262 setLoop: -1 play:)
			...
			(9
				(gGkSound1 number: 2671 loop: 1 play:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(gMessager say: 10 60 18 1) ; "(RRCC. SKIPPED. SLY, HUSHED)Gabriel slips the signal device into the sekey madoul\82."
			)
			(5
				(gGkSound1 number: 2604 setLoop: 1 play:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(gEgo setCel: 3 setLoop: 1 setCycle: CT 7 1 self)
			)
			(4
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				(gMessager say: 26 0 9 4) ; "Uh-oh."
			)
			(7
				7
				(gEgo loop: 1 cel: 0 setCycle: End self)
				(gMessager say: 26 0 9 5) ; "!!!Blank msg"
			)
			(8
				8
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(gGkSound1 number: 2671 setLoop: 1 play:)
				(fan
					view: 2651
					setLoop: 0
					setCel: 12
			...
			(10
				...
				(gEgo
					normalize: 1 900
					ignoreActors: 1
					setMotion: PolyPath 117 122 self
				)
			)
			(11
				(gGkMusic2 fade: 0 10 25 1)
				(gEgo
