...
(instance case1 of Feature
	...
	(method (init)
		(self
			createPoly: 196 96 164 92 164 85 183 78 198 81 218 72 237 74 237 100 197 118
		)
		(super init:)
	)
)
...
(instance case3 of Feature
	...
	(method (init)
		(self
			createPoly: 136 145 71 145 66 134 82 127 82 121 71 116 100 106 136 112
		)
		(super init:)
	)
)
...
(instance case4 of Feature
	...
	(method (init)
		(self
			createPoly: 70 145 33 145 30 140 35 135 33 126 27 123 42 118 66 123 66 125 63 128
		)
		(super init:)
	)
)
...
(instance shelf1 of Feature
	...
	(method (init)
		(self
			createPoly: 219 145 268 120 277 122 281 132 264 141 259 135 245 134 240 138 239 145
		)
		(super init:)
	)
)
...
(instance shelf2 of Feature
	...
	(method (init)
		(self
			createPoly: 173 145 155 144 157 140 244 95 255 95 256 99 175 140 174 145
		)
		(super init:)
	)
)
...
(instance garlic of Feature
	...
	(method (init)
		(self
			createPoly: 42 22 46 40 35 43 42 50 40 58 34 63 41 69 39 72 47 80 39 90 31 86 25 96 32 99 33 109 24 122 35 129 35 136 31 139 33 145 0 145 0 21
		)
		(super init:)
	)
)
...
(instance crocBody of Feature
	...
	(method (init)
		(self
			createPoly: 269 88 273 66 263 74 258 72 265 64 271 57 266 40 287 21 303 38 291 46 304 59 295 74 297 96 288 103 277 103 275 99 269 98
		)
		(super init:)
	)
...
(instance ouangaBags of Feature
	...
	(method (init)
		(self
			createPoly: 48 103 48 96 54 84 56 73 52 75 45 73 43 64 45 58 43 54 43 47 52 38 51 29 57 22 84 22 87 29 78 34 79 39 71 44 75 49 74 53 65 59 60 57 60 65 61 69 58 74 56 83 62 85 64 95 65 105 55 106
		)
		(super init:)
	)
)
...
(instance foreJars of Feature
	...
	(method (init)
		(self
			createPoly: 189 145 192 138 200 137 202 133 211 132 212 126 221 126 224 121 231 121 235 115 240 115 242 112 248 111 252 107 259 106 259 102 268 101 269 99 274 99 277 102 277 109 270 111 269 114 261 116 259 119 251 120 251 123 244 125 243 129 234 130 233 134 223 135 222 140 213 142 212 144
		)
		(super init:)
	)
)
