...
(instance bookCase of PuzzleBar
	...
	(method (showHelp)
		(super showHelp: &rest)
		(proc15_0 self (+ local3 2) 1 0 1 0 [local79 global114])
	)
	...
	(method (buyClue &tmp temp0 temp1 temp2 [temp3 20] [temp23 30])
		(if (super buyClue: &rest)
			...
			(Message msgGET [local79 global114] 1 1 (temp2 message:) 1 @local59)
		...
		(cond
			...
			(param1
				...
				(Print
					...
					x: (+ nsLeft 80)
					y: (+ nsTop 14)
					addText: 1 4 message modifiers 0 0 [local79 global114]
					init:
				)
			)
...
(instance shelf of CodeIcon
	...
	(method (init param1 &tmp temp0 temp1)
		...
		(= [local26 param1] (proc15_6 [local79 global114] 1 4 message))
		(= [local20 param1] self)
	)
	...
	(method (show &tmp temp0 temp1 temp2 [temp3 10] temp13)
		...
		(Message msgGET [local79 global114] 1 1 message 1 @temp3)
