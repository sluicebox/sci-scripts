...
(instance showFeatureCode of Code
	...
	(method (doit param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11)
		(if param2
			...
			(Graph grDRAW_LINE temp0 temp1 temp0 temp2 29)
			(Graph grDRAW_LINE temp3 temp1 temp3 temp2 29)
			(Graph grDRAW_LINE temp0 temp1 temp3 temp1 29)
			(Graph grDRAW_LINE temp0 temp2 temp3 temp2 29)
		else
			(= temp0 (param1 nsTop:))
			(= temp1 (param1 nsLeft:))
			(= temp3 (param1 nsBottom:))
			(= temp2 (param1 nsRight:))
			(Graph grDRAW_LINE temp0 temp1 temp0 temp2 11)
			(Graph grDRAW_LINE temp3 temp1 temp3 temp2 11)
			(Graph grDRAW_LINE temp0 temp1 temp3 temp1 11)
			(Graph grDRAW_LINE temp0 temp2 temp3 temp2 11)
		)
		(= temp4 (- (param1 y:) 1))
		(= temp5 (- (param1 x:) 1))
		(= temp7 (+ (param1 y:) 1))
		(= temp6 (+ (param1 x:) 1))
		(Graph grDRAW_LINE temp4 temp5 temp4 temp6 7)
		(Graph grDRAW_LINE (+ temp4 1) temp5 (+ temp4 1) temp6 7)
		(Graph grDRAW_LINE temp7 temp5 temp7 temp6 7)
			...
			(if (= temp0 (OnMeAndLowY theObj:))
				(cond
					((and (temp0 onMeCheck:) (!= (temp0 onMeCheck:) 26505))
						(Format @temp42 805 0 (temp0 onMeCheck:)) ; "[control $%x]"
					)
...
(class JustifyText of Obj
	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3 temp4 temp5 [temp6 25])
		...
		(cond
			((== temp3 evKEYBOARD)
				(switch temp4
					(KEY_ESCAPE
						(Display 805 4 dsRESTOREPIXELS unders)
						(self dispose:)
					)
					(KEY_RETURN
	...
	(method (showCoord param1 &tmp [temp0 20])
		(Print addTextF: @temp0 {Position: %d, %d} (param1 x:) (param1 y:) init:)
		(self dispose:)
	)
