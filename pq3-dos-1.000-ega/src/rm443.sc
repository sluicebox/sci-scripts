...
(instance judgeBench of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 443 11) ; "You're not allowed up there."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance witnessBox of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 443 12) ; "Quit fooling around and stick to the matter at hand."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance flag of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 443 13) ; "You patriotically salute the flag."
			)
			(else
				(super doVerb: theVerb)
			)
