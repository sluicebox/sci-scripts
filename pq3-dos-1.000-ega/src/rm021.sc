		...
		(switch theVerb
			...
			(2 ; Look
				(cond
					...
					((< (Random 0 100) 5)
						(Print 21 99) ; "Herein lies the names of the programmers who without undo fanfare brought you this game. Doug Oldfield, Chris Hoyt, Kim Bowdish and Mike Larsen."
					)
					(else
