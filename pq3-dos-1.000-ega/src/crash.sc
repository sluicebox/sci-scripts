		...
		(switch theVerb
			(2 ; Look
				(if (gCast contains: body)
					(Print 880 33) ; "The car is overturned, smashed up, and generally mutilated.  A body slumps from the driver's side. So much for questioning the suspect."
				else
					(Print 880 34) ; "The car is overturned, smashed up, and generally mutilated."
				)
			)
			(else
				(super doVerb: theVerb)
