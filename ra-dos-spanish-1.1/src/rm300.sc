			...
			(8
				(switch
					(Print
						...
						addButton: 1 14 0 0 1 5 (Localize 25 25 25 25 20) ; "Sorry. My mistake."
						addButton: 2 14 0 0 2 5 (Localize 43 43 43 43 38) ; "Let me in, or I'll scream."
						addButton: 3 14 0 0 3 5 (Localize 61 61 61 61 56) ; "Wait! I know the secret word!"
						init:
					)
					(1
						(= cycles 1)
