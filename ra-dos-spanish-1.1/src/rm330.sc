		...
		(self
			addObstacle:
				((Polygon new:)
					...
					init: 0 143 0 169 62 162 106 158 178 152 196 144 288 140 300 137 319 137 319 127 277 128 270 134 239 134 212 116 166 116 150 116 154 131 110 140 62 144 32 139 0 141
					yourself:
				)
		)
		(larch init:)
