...
(class EcoInvI of InvI
	...
	(method (doVerb theVerb &tmp [temp0 30] [temp30 20] [temp50 20])
		...
		(switch theVerb
			...
			(else
				...
				(Message msgGET 99 1 theVerb 0 1 @temp30)
				(Message msgGET 99 1 (self message:) 0 1 @temp50)
				(Print addTextF: @temp0 @temp30 @temp50 init:)
			)
		)
	)
)
