...
(procedure (localproc_0)
	...
	(Display @local16 dsFONT 9777 dsCOORD (box x:) (+ (box y:) 1) dsCOLOR 8)
	(= local6 1)
)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(localproc_6 1)
				(localproc_8)
				(localproc_2 117 62 8 98 local15 local2)
				(localproc_2 160 32 8 48 local9 local2)
				(= ticks 30)
			)
			(2
				(gUser canInput: 1)
