...
(procedure (localproc_1 &tmp [temp0 40] [temp40 11] [temp51 11] [temp62 20] [temp82 11] [temp93 11] [temp104 200])
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(cond
					((> global241 2)
						(gMessager say: 6 40 45 1 self) ; "Thank you, but I have enough mushrooms."
					)
					((IsFlag 148)
