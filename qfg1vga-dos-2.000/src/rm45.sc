		...
		(switch theVerb
			(1 ; Look
				(switch whichGoblin
					...
					(else
						(gMessager say: 1 1 12) ; "You've seen one dead Goblin, you've seen 'em all."
					)
				)
			)
			(4 ; Do
				(cond
					((and (== whichGoblin 1) (not local107))
						(gMessager say: 1 4 4) ; "You find 5 silvers concealed in a pouch. You take the silvers."
						(= local107 1)
						(= local115 1)
						(gEgo setScript: cueItScript)
					)
					((and (== whichGoblin 2) (not local108))
