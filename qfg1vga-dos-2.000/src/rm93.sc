...
(instance rm93 of Rm
	...
	(method (newRoom newRoomNumber)
		(SetFlag 83)
		(if (== newRoomNumber 425) ; minotaurArena
			(= global279 425)
		else
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(4 ; Do
				(cond
					(local10
						(gMessager say: 5 4 13 0 self) ; "As you attempt the search, the sleeping Minotaur awakes, and..."
					)
					((IsFlag 237)
						(if local14
...
(instance openGate of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				1
				(if (== gPrevRoomNum 425) ; minotaurArena
					(gCurRoom
						addObstacle:
							((Polygon new:)
								type: PBarredAccess
...
(instance noEscape of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gMessager say: 13 0 28) ; "Before you can escape, the Minotaur is upon you!"
			)
		)
	)
)
