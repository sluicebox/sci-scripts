			...
			(and
				...
				(or
					...
					(Print
						font: 999
						addText: str
						addButtonBM: 64990 2 0 0 {Append to it} -30 12
						addButtonBM: 64990 2 0 1 {Overwrite it} 175 12
						init:
					)
				)
			)
		...
		(if (== -1 logHandle)
			...
			(Log
				...
				(Print
					...
					addButtonBM: 64990 2 0 {Fatal} {FATAL} -40 12
					addButtonBM: 64990 2 0 {Moderate} {MODERATE} 90 12
					addButtonBM: 64990 2 0 {Minor} {MINOR} 200 12
					saveCursor: 1
					init:
				)
			)
			(Log
				...
				(Print
					...
					addButtonBM: 64990 0 0 {Yes} {YES} -40 12
					addButtonBM: 64990 0 0 {No} {NO} 80 12
					addButtonBM: 64990 2 0 {Intermittent} {INTERMIT.} 200 12
					saveCursor: 1
					init:
				)
			)
			...
			(Log
				...
				(Print
					...
					addButtonBM: 64990 0 0 {Art} {ART} -30 12
					addButtonBM: 64990 0 0 {Programming} {PROG} 80 12
					addButtonBM: 64990 0 0 {Music} {MUSIC} 160 12
					addButtonBM: 64990 0 0 {Design} {DESIGN} 250 12
					saveCursor: 1
					init:
				)
			)
