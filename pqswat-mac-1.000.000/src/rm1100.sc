...
(instance setUpElement of Code
	...
	(method (doit param1)
		(switch param1
			...
			(1)
			(2
				(tello view: 11024 loop: 0 cel: 2 posn: 0 278 init:)
				(denton view: 11024 loop: 0 cel: 0 posn: 0 278 init:)
				(carmike view: 11024 loop: 0 cel: 1 posn: 0 278 init:)
			)
			(3
				(tello view: 11025 loop: 0 cel: 2 posn: 0 368 init:)
				(denton view: 11025 loop: 0 cel: 0 posn: 0 368 init:)
				(carmike view: 11025 loop: 0 cel: 1 posn: 0 368 init:)
			)
			(4
				(tello view: 11026 loop: 0 cel: 2 posn: 0 368 init:)
				(denton view: 11026 loop: 0 cel: 0 posn: 0 368 init:)
				(carmike view: 11026 loop: 0 cel: 1 posn: 0 368 init:)
			)
			(5
