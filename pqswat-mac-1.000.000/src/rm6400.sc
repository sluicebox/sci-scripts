...
(procedure (localproc_0 &tmp [temp0 3])
	(proc4_17 1810 108 65)
)
...
(instance level1 of View
	...
	(method (init)
		(= x (proc4_16 489 481 489 489 489))
		(self setPri: 100)
		(super init: &rest)
	)
)
...
(instance level2 of View
	...
	(method (init)
		(= x (proc4_16 486 472 486 486 486))
		(super init: &rest)
	)
)
...
(instance level3 of View
	...
	(method (init)
		(= x (proc4_16 487 476 487 487 487))
		(super init: &rest)
	)
)
...
(instance level4 of View
	...
	(method (init)
		(= x (proc4_16 0 468 0 0 0))
		(= y (proc4_16 0 78 0 0 0))
		(self setPri: 100)
		(super init: &rest)
	)
)
