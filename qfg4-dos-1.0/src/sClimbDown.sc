			...
			(16
				...
				(gCurRoom
					addObstacle:
						((Polygon new:)
							type: PBarredAccess
							init: 0 189 0 0 319 0 319 189 150 189 150 184 266 185 284 161 258 161 221 161 210 154 210 140 138 140 138 189
							yourself:
						)
				)
				(= cycles 2)
			...
			(5
				(gCurRoom
					addObstacle:
						((Polygon new:)
							type: PBarredAccess
							init: 271 47 293 58 271 64 286 68 304 63 315 45 293 36 319 11 319 189 0 189 0 0 267 0 302 19 284 35 241 37 248 43 202 43 202 47
							yourself:
						)
				)
				((ScriptID 710 2) setPri: -1) ; torchEff
