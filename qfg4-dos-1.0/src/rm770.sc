...
(instance rm770 of GloryRm
	...
	(method (init)
		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 185 96 142 106 99 105 71 89 101 77 162 68 159 65 138 56 177 56 177 53 135 53 135 57 157 67 102 74 70 87 0 87 0 0 319 0 319 189 0 189 0 108 47 118 28 137 110 170 222 170 298 124 297 104 271 96 236 90 224 97 196 93 208 80 204 75
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(81 ; detectMagicSpell
				(gMessager say: 2 81 4) ; "There is a faint glow of magic on all of the bones, stronger near the altar. The torch scones beside the altar have some magic, and the altar itself radiates a strong magical aura."
			)
			(10 ; Jump
				(if local5
				...
				(if (== gHeroType 2) ; Thief
					...
					(gCurRoom
						addObstacle:
							((Polygon new:)
								type: PBarredAccess
								init: 142 106 99 105 70 93 93 77 161 67 159 64 138 56 177 56 177 53 135 53 135 57 156 66 93 74 67 87 0 87 0 0 319 0 319 189 0 189 0 108 47 118 28 137 110 170 222 170 298 124 297 104 271 96 236 90 224 97 195 93
								yourself:
							)
							((Polygon new:)
								type: PBarredAccess
...
(instance sPlaceTorch of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager say: 7 6 4 0 self) ; "You put the torch back in the scone."
			)
			(3
				(ClearFlag 302)
				...
				(4 ; Do
					(cond
						...
						((not (gEgo has: 5)) ; theThrowdagger
							(gMessager say: 5 4 26) ; "Your fingers are a little to big to pry the valve open; you need something with a sharp edge to free the valve."
						)
					)
				)
				(10 ; Jump
