	...
	(method (init)
		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 15 90 18 99 44 150 64 166 122 180 319 178 319 189 0 189 0 0 319 -1 319 124 271 108 239 105 155 82 62 78 66 82 106 87 174 102 173 113 249 113 250 145 235 152 139 152 122 133 93 126 95 132 105 142 113 151 124 158 147 160 175 168 176 172 153 170 132 169 112 164 97 155 78 137 71 113 64 90
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
...
(instance sDoorScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(= local2 1)
				(gMessager say: 19 6 26 1 self) ; "What I don't get is why de Adda Bees guy brings da stake down dere. Why give a weapon to de enemy, even if you gots him chained up?"
			)
			(2
				(gGlory handsOn:)
				(self dispose:)
...
(instance pMainDoor of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			((and (== theVerb 4) (not local4)) ; Do
				(if local1
					(gMessager say: 17 6 16) ; MISSING MESSAGE
				else
					(gMessager say: 17 6 14 0) ; "You hear the sound of voices on the other side of the door."
					(= local1 1)
				)
			)
			(80 ; openSpell
