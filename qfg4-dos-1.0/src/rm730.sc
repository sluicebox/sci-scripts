...
(instance sAdavisDies of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(if (IsFlag 360)
					(gMessager say: 6 6 16 0) ; "A voice forms in the air around you, seemingly coming from your glowing staff: "It is time for you to fulfill my final destiny. You must use me to release my master from her imprisonment!""
				)
...
(instance sBurnUpGrapnel of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(local0 dispose:)
				(gEgo use: 16 normalize:) ; theGrapnel
				(= ticks 6)
			)
			(5
...
(instance sThrowYourWeapon of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(gMessager say: 6 6 16 0 self) ; "A voice forms in the air around you, seemingly coming from your glowing staff: "It is time for you to fulfill my final destiny. You must use me to release my master from her imprisonment!""
			)
			(7
