...
(procedure (localproc_0 param1)
	(switch param1
		(0
			(blob1 signal: (& (blob1 signal:) $fffe) setCycle: 0)
			(blob2 signal: (& (blob2 signal:) $fffe) setCycle: 0)
			(tent1 signal: (& (tent1 signal:) $fffe) setLoop: 2 setCycle: 0)
			(tent2 signal: (& (tent2 signal:) $fffe) setLoop: 7 setCycle: 0)
			(tent3 signal: (& (tent3 signal:) $fffe) setLoop: 10 setCycle: 0)
			(tent4 setLoop: 4 setCycle: 0)
			(tent5 setLoop: 8 setCycle: 0)
		)
		(1
			(notes number: 1005 play:)
			(blob1 signal: (| (blob1 signal:) $0001) setLoop: 1 setCycle: Fwd)
			(blob2 signal: (| (blob2 signal:) $0001) setLoop: 6 setCycle: Fwd)
			(tent1 signal: (| (tent1 signal:) $0001) setLoop: 4 setCycle: Fwd)
			(tent2 signal: (| (tent2 signal:) $0001) setLoop: 9 setCycle: Fwd)
			(tent3 signal: (| (tent3 signal:) $0001) setLoop: 12 setCycle: Fwd)
			(tent4 setLoop: 7 setCycle: Fwd)
			(tent5 setLoop: 11 setCycle: Fwd)
		)
		(2
			(notes number: 1006 play:)
			(blob1 signal: (| (blob1 signal:) $0001) setLoop: 0 setCycle: Fwd)
			(blob2 signal: (| (blob2 signal:) $0001) setLoop: 5 setCycle: Fwd)
			(tent1 signal: (| (tent1 signal:) $0001) setLoop: 3 setCycle: Fwd)
			(tent2 signal: (| (tent2 signal:) $0001) setLoop: 8 setCycle: Fwd)
			(tent3 signal: (| (tent3 signal:) $0001) setLoop: 11 setCycle: Fwd)
