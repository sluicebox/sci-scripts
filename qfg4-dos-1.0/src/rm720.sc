	...
	(method (init)
		...
		(self
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 25 138 55 174 115 189 0 189 0 0 319 0 319 189 150 189 283 171 313 109 296 109 284 123 257 120 234 102 257 90 259 82 245 73 228 73 215 80 224 97 197 103 140 89 144 79 113 61 122 54 108 54 100 60 105 82 78 82 68 79 56 79 77 92 68 98 52 100 56 110 36 118
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
		...
		(if (and (== local4 1) (!= gPrevRoomNum 810) (OneOf gHeroType 1 2)) ; combat, Magic User, Thief
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gEgo x: 145 y: 240 setMotion: PolyPath 145 190 self)
			)
			(1
				(gGlory handsOn:)
				(self dispose:)
