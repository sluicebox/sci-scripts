	...
	(method (init)
		(gCurRoom
			addObstacle:
				...
				((Polygon new:)
					type: PBarredAccess
					init: 267 95 228 95 207 102 167 102 144 83 162 72 162 0 319 0 319 189 237 189 258 178 266 156 224 156 224 147 280 114 267 110
					yourself:
				)
		)
		...
		(if (IsFlag 35)
			...
			(= south 0)
			((ScriptID 51 1) init: posn: 220 160 setHeading: 315) ; nec1
		)
