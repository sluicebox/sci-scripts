...
(instance rm510 of GloryRm
	...
	(method (init)
		...
		(guy1 init: approachVerbs: 4) ; Do
		(guy2 init: approachVerbs: 4) ; Do
		(guy3 init: approachVerbs: 4) ; Do
		(if (IsFlag 253)
			(guy4 view: 511 loop: 2 cel: 0)
			(if (IsFlag 252)
				(guy4 loop: 1 cel: 5)
			)
		)
		(guy4 init: approachVerbs: 4) ; Do
		(guy5 init: approachVerbs: 4 42 29 28) ; Do, theToolkit, theKeyRing, theLockpick
		(crestF init: approachVerbs: 4 1) ; Do, Look
		(relief1F init: approachVerbs: 4) ; Do
		(relief1Teller init: relief1F 510 21 155 7)
		(relief2F init: approachVerbs: 4) ; Do
		(relief2Teller init: relief2F 510 21 155 8)
		(relief3F init: approachVerbs: 4) ; Do
		(relief3Teller init: relief3F 510 21 155 9)
		(relief4F init: approachVerbs: 4) ; Do
		(relief4Teller init: relief4F 510 21 155 10)
		(relief5F init: approachVerbs: 4) ; Do
		(relief5Teller init: relief5F 510 21 155 11)
		(reaper1F init: approachVerbs: 4) ; Do
		(reaper2F init:)
		(reaper3F init:)
		(scythe1F init:)
		(scythe2F init:)
		(scythe3F init:)
		(exitReaper init: setPri: 116 approachVerbs: 4) ; Do
		(gCurRoom
			addObstacle:
				((Polygon new:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(gEgo normalize: 6)
				(if (== register 2)
					(gEgo setMotion: PolyPath 268 140 self)
				else
					(self cue:)
				)
			)
			(4
				(gEgo setMotion: PolyPath 318 110 self)
			)
			(5
				(if (or (!= (gEgo x:) 318) (!= (gEgo y:) 110))
					(gEgo setMotion: MoveTo 318 110 self)
				else
					(self cue:)
				)
			)
