	...
	(method (init)
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 0 0 319 0 319 189 293 189 293 167 257 167 257 155 272 155 298 143 298 137 263 129 263 118 215 118 215 101 125 105 90 96 65 96 34 69 0 69
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
					init: 0 189 0 173 133 173 133 189
					yourself:
				)
		)
		...
		(gCurRoom
			addPoly:
				((Polygon new:)
					init: 0 147 32 147 80 111 122 111 257 142 319 126 319 189 0 189
					yourself:
				)
				60
