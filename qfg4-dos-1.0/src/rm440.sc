	...
	(method (init)
		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 319 189 276 189 276 176 224 176 224 162 282 158 282 148 163 161 69 147 47 130 104 90 134 86 171 100 198 85 179 74 237 66 227 47 198 47 158 56 90 78 107 86 93 89 34 129 40 142 59 151 169 169 205 189 0 189 0 0 319 0
					yourself:
				)
		)
		(super init: &rest)
				...
				(gCurRoom
					...
					addObstacle:
						((Polygon new:)
							...
							init: 114 103 135 103 157 107 165 111 189 111 206 104 226 111 243 111 243 105 255 105 270 109 293 115 266 136 168 149 139 145 86 118
							yourself:
						)
				)
				(if register
			...
			(-80 ; openSpell (part 2)
				(if (and (gCast contains: tulip) (not local2))
					...
					(if (== ((ScriptID 13) state:) 4) ; castOpenScript
						((ScriptID 13) cue:) ; castOpenScript
					)
				)
			)
			(22 ; theCandle
