	...
	(method (init)
		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 0 152 0 0 319 0 319 146 317 137 295 137 287 148 263 148 253 135 231 135 208 147 191 147 171 153 112 153 103 148 69 139 77 125 38 125
					yourself:
				)
		)
		(super init: &rest)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(= local1 1)
				(gEgo normalize:)
				(gMessager say: 6 4 20 1 0 640) ; "In the chest you find a small flask labelled "Healing" and 25 Crowns. Pretty nice for a few minutes work!"
				(self cue:)
			)
			(6
				(SetFlag 187)
