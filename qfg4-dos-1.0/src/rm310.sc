...
(instance rm310 of GloryRm
	...
	(method (init)
		...
		(clocks init: approachVerbs: 4) ; Do
		...
		(frames init: approachVerbs: 4) ; Do
		(smallPot init: approachVerbs: 4) ; Do
		(bluePot init: approachVerbs: 4) ; Do
		(ewer1 init: approachVerbs: 4) ; Do
		(brownPot1 init: approachVerbs: 4) ; Do
		(brownPot2 init: approachVerbs: 4) ; Do
	...
	(method (showCases)
		(super
			showCases:
				...
				(== local2 1)
				26 ; Monastery
				(and (== local2 1) (not (IsFlag 83)))
				27 ; Burned Monastery
				(and (IsFlag 83) (not (IsFlag 100)))
				23 ; Old Man
