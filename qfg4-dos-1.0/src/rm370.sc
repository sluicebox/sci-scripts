			...
			((OneOf local2 4 7 8 10)
				...
				(gCurRoom
					addObstacle:
						((Polygon new:)
							type: PBarredAccess
							init: 244 184 244 164 177 180 87 180 87 175 60 175 0 175 0 0 319 0 319 189 0 189 0 184
							yourself:
						)
				)
			)
			...
			(else
				(gCurRoom
					addObstacle:
						((Polygon new:)
							type: PBarredAccess
							init: 244 184 244 165 177 180 66 180 66 174 110 161 139 161 139 157 110 157 38 175 0 175 0 0 319 0 319 189 0 189 0 184
							yourself:
						)
				)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(switch local2
					(1
						...
						(gMessager say: 1 6 2) ; "Quickly, Igor, the fluid! I must have the fluid!"
					)
					(3
						(gMessager say: 1 6 7) ; "Ah, you are just in time to witness a magnificent scientific experiment! I have managed to harness the very primal force of lightning at my beck and call. Now I shall use it to create life itself!"
					)
					(5
						(gMessager say: 1 6 8) ; "I believe I am on the verge of a major discovery! It came to me last night -- I believe that there is a formula which can be used to create a Rehydration Solution!"
					)
					(7
						(gMessager say: 1 6 9) ; "I have made substantial progress with my Frankie since your last visit. With the M.E.S.S. recalibrated, I was able to focus the initial stimulation and have achieved the first traces of independent muscular coordination."
					)
					(9
						(gMessager say: 1 6 10) ; "I have done it! The world shall not soon forget the genius of Dr. Cranium! The experiment is a success! Behold... Frankie!"
					)
					(11
						(gMessager say: 1 6 11) ; "I have been preparing a research report to tell the world about my process for reanimating dead tissue. It is proving very difficult. I must omit no detail or the more skeptical of my fellows will doubt my results."
					)
					(13
						(proc0_17 1 6 18)
					)
			...
			(4
				(switch local2
					(3
						(self setScript: sCraniumZapped self)
					)
					(7
						(self setScript: sFrankieAlive self)
					)
					(9
						(self setScript: sFrankieReveal self)
					)
					(else
						(= cycles 1)
					)
				...
				(if register
					(cond
						...
						((OneOf (craniumTeller iconValue:) 53 52)
							...
							(gMessager say: 25 6 106 0 craniumTeller) ; "Yes, that sounds just right! However, it will take me some time to distill this marvelous solution. Please return tomorrow."
						)
						(else
							(craniumTeller cue:)
						)
