		...
		(if gNight
			(gCurRoom
				addObstacle:
					...
					((Polygon new:)
						type: PBarredAccess
						init: 319 189 202 189 202 174 245 174 268 167 288 154 297 133 277 133 236 113 236 105 158 105 158 0 319 0
						yourself:
					)
			)
		else
			(gCurRoom
				addObstacle:
					...
					((Polygon new:)
						type: PBarredAccess
						init: 319 189 101 189 101 174 245 174 268 167 288 154 297 133 277 133 236 113 236 105 158 105 158 0 319 0
						yourself:
					)
			)
		)
