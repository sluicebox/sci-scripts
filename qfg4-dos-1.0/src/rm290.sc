		...
		(if gDebugging
			...
			(= local2
				(cond
					...
					((and gNight (not (IsFlag 79)) (> gDay 2)) 1)
		...
		(if (== gPrevRoomNum 340)
			(gCurRoom
				addObstacle:
					((Polygon new:)
						type: PBarredAccess
						init: 82 189 0 189 0 1 319 1 319 189 230 189 184 137 158 136 159 112 205 124 219 124 220 119 201 118 195 118 181 114 180 102 199 101 214 90 180 91 200 66 184 68 174 89 150 90 110 100 86 113 40 100 31 125 57 126 58 154
						yourself:
					)
			)
		)
		(if gNight
				...
				((IsFlag 81)
					(gCurRoom
						addObstacle:
							((Polygon new:)
								type: PBarredAccess
								init: 0 186 0 0 319 0 319 188 238 188 180 137 149 133 149 117 173 118 207 124 211 122 180 116 182 104 212 86 203 85 189 71 183 72 183 83 129 94 87 111 47 96 26 106 26 138 60 149 77 186
								yourself:
							)
					)
				)
				((IsFlag 80)
					(gCurRoom
						addObstacle:
							((Polygon new:)
								type: PBarredAccess
								init: 0 189 0 0 319 0 319 189 231 189 184 137 163 136 151 130 151 118 166 98 200 101 213 90 193 91 162 90 151 90 108 101 87 113 40 100 31 125 57 126 58 154 83 189
								yourself:
							)
					)
				)
				(else
					(gCurRoom
						addObstacle:
							((Polygon new:)
								type: PBarredAccess
								init: 0 189 0 0 319 0 319 189 231 189 184 137 163 136 157 124 157 105 181 102 200 101 213 90 193 91 162 90 151 90 108 101 87 113 40 100 31 125 57 126 58 154 83 189
								yourself:
							)
					)
				)
			...
			(gCurRoom
				addObstacle:
					((Polygon new:)
						type: PBarredAccess
						init: 0 189 0 0 319 0 319 189 238 189 180 137 149 133 149 117 173 118 207 124 211 122 180 116 182 104 212 86 203 85 189 71 183 72 183 83 129 94 87 111 47 96 26 106 26 138 60 149 80 189
						yourself:
					)
			)
		)
