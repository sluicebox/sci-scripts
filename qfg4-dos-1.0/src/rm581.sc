	...
	(method (init)
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 0 143 38 143 72 160 121 160 139 168 171 168 181 176 265 176 265 153 221 153 221 148 281 113 267 104 277 93 191 105 145 90 177 68 177 0 319 0 319 189 0 189
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
					init: 0 0 127 0 127 87 155 102 135 103 104 98 84 106 101 115 33 130 0 130
					yourself:
				)
		)
		...
		(gCurRoom
			addPoly:
				((Polygon new:)
					init: 319 69 319 189 36 189 102 121 184 123 194 100 125 93 114 75
					yourself:
				)
				60
				((Polygon new:) init: 0 57 40 64 38 114 0 122 yourself:)
				60
		)
