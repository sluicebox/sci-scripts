			...
			(switch (= state newState)
				(0
					...
					(if (IsFlag 143)
						...
						(proc1111_7 9831 -13 -40 0 -1 1)
					else
						(proc1111_7 9830 -14 -41 0 10 1)
					)
					(lid1 dispose:)
					(lid2 dispose:)
		...
		(if (IsFlag 390)
			...
			(switch (= state newState)
				(0
					...
					(bigLidView init:)
					(proc1111_7 7250 -11 -39 0 115)
					(lid1 dispose:)
					(lid2 dispose:)
					(gCurRoom drawPic: 22340)
				)
				(1
					(proc1111_7 7251 -7 -38 0 1)
				)
				(2
					(bigLidView dispose:)
					(proc1111_7 7252 -13 -39 0)
					(gCurRoom drawPic: 22390)
				)
				(3
					(bigLidView init:)
					(proc1111_7 7253 -11 -38 0 -1 1)
					(gCurRoom drawPic: 22340)
				)
				(4
					(if (IsFlag 135)
	...
	(method (changeState newState &tmp temp0)
		(if (IsFlag 390)
			...
			(switch (= state newState)
				...
				(1
					(bigLidView init:)
					(proc1111_7 7231 -10 -42 0)
				)
				(2
					(bigLidView dispose:)
					(proc1111_7 7232 -11 -40 0)
					(gCurRoom drawPic: 22390)
				)
				(3
					(bigLidView init:)
					(proc1111_7 7234 -79 -32 0 150)
					(gCurRoom drawPic: 22340)
				)
				(4
					(if (or (IsFlag 142) (IsFlag 143))
						(gGame handsOff:)
						(proc1111_7 9822 55 31 0)
					else
						(gGDacSound number: 22071 play:)
						(proc1111_7 9821 55 31 0)
					)
					(bigLidView dispose:)
					(lid1 init:)
			...
			(switch (= state newState)
				...
				(2
					(if (or (IsFlag 142) (IsFlag 143))
						...
						(gGDacSound number: 22071 setLoop: 1 play:)
						(proc1111_7 9821 55 31 0 -1 1)
					)
