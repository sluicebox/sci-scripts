...
(class ScrollableInventory of Inv
	...
	(method (drawInvWindow param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14 temp15 temp16 temp17 temp18 temp19 temp20 temp21)
		...
		(if (not (items size:))
			(gMessager say: 37 0 5 1 0 0) ; "Pepper has nothing in her pockets."
			(if (IsObject items)
				(items dispose:)
			)
			(return 0)
		...
		(= temp10 (Max (+ 4 temp5) (* numColumns (+ 4 temp2))))
	...
	(method (advance param1 &tmp temp0 temp1 temp2 temp3 [temp4 20])
		...
		(repeat
			...
			(if
				(or
					(and (< (temp0 nsBottom:) 0) (< (temp0 nsTop:) 0))
					(& (temp0 signal:) $0004)
				)
				(++ temp3)
			else
	...
	(method (retreat param1 &tmp temp0 temp1 temp2 temp3 [temp4 20])
		(= temp1 (if argc param1 else 1))
