...
(instance showFeatureCode of Code
	...
	(method (doit param1 param2 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11)
		(cond
			...
			((not (param1 isKindOf: Inset))
				(= temp0 (param1 nsTop:))
				(= temp1 (param1 nsLeft:))
				(= temp3 (param1 nsBottom:))
				(= temp2 (param1 nsRight:))
				(Graph grDRAW_LINE temp0 temp1 temp0 temp2 global118)
				(Graph grDRAW_LINE temp3 temp1 temp3 temp2 global118)
				(Graph grDRAW_LINE temp0 temp1 temp3 temp1 global118)
				(Graph grDRAW_LINE temp0 temp2 temp3 temp2 global118)
			)
		)
		(= temp4 (- (param1 y:) 1))
		(= temp5 (- (param1 x:) 1))
		...
		(while (not (self handleEvent: (= temp41 (Event new:))))
			...
			(if (= temp0 (OnMeAndLowY theObj:))
				(cond
					(
						(and
							(not (temp0 isKindOf: Inset))
							(temp0 onMeCheck:)
							(!= (temp0 onMeCheck:) 26505)
						)
						(Format @temp42 881 0 (temp0 onMeCheck:)) ; "[control $%x]"
					)
	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3 temp4 temp5 [temp6 25])
		...
		(cond
			((== temp3 evKEYBOARD)
				(switch temp4
					(KEY_ESCAPE
						(Display 881 4 dsRESTOREPIXELS unders)
						(self dispose:)
					)
					(KEY_RETURN
		...
		(if (or (!= temp0 lastX) (!= temp1 lastY))
			...
			(= unders
				(Display
					...
					global118
					dsBACKGROUND
					(if color global118 else global125)
					dsFONT
					font
					dsSAVEPIXELS
				)
