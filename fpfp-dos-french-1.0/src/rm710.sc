		...
		(switch (= state newState)
			...
			(6
				...
				(if (IsFlag 38)
					...
					(gMessager say: 36 0 1 2 4 self) ; "Thanks, pardner! But 'cha know what? Sumptin sweet would shore taste good right now!"
				)
			)
			(7
			...
			(9
				(if (IsFlag 38)
					...
					(gMessager say: 36 0 1 5 self) ; "Whey, shore, son. Here. Have a box o' these Remingtons! No charge; they're on the County."
				)
			)
			(10
