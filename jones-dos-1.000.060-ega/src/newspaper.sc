...
(procedure (localproc_0) ; UNUSED
	...
	(Format @global100 215 26) ; "MORE FAST FOOD PLACES USING SOY BEANS"
	...
	(Format @global100 215 48) ; "AMELDA M. LOOKING FOR A FEW GOOD SHOES"
	(Format @global100 215 49) ; "NANCY IS LOOKING FOR A NEW DRESS"
	(Format @global100 215 50) ; "TYpEsETTrs U ion goe oN STR KE!"
	...
	(Format @global100 215 55) ; "SOL. WE NEED A HEADLINE HERE!"
...
(instance newspaper of Dialog
	...
	(method (init param1 &tmp temp0 temp1)
		(if (not global518)
			...
			(self window: global59 add: background doneButton newsPaper)
			(self
				eachElementDo: #init
