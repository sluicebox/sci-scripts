...
(procedure (localproc_0 &tmp temp0 temp1 temp2 [temp3 5])
	...
	(if
		(<
			...
			(+ (global302 maxExperience:) (global302 expCredit:))
		)
	...
	(if (global302 rentOwed:)
		...
		(if (== (global302 worksAt:) 1)
			(proc201_1)
			(proc104_1
				(Format @global100 108 4 (- temp0 temp1)) ; "I'm sorry. I had to garnish $%d."
				310
				global413
				global440
				global441
			...
			(proc104_1
				(Format @global100 108 5 (- temp0 temp1)) ; "Your Landlord garnished $%d."
				310
				global413
				global440
				global441
