...
(procedure (localproc_0) ; UNUSED
	...
	(Format @global100 232 3) ; "You spent the weekend baking oatmeal cookies."
	...
	(Format @global100 232 8) ; "You and some friends had a Hottub party this weekend."
	...
	(Format @global100 232 12) ; "You read your dictionary all weekend. Boy, that was fun."
	(Format @global100 232 13) ; "You read your atlas and commited the population of 43 countries to memory. OH WOW!!!"
...
(procedure (localproc_2 param1 param2)
	...
	(Display 232 param1 dsFONT 4 dsCOORD 13 47 dsBACKGROUND -1 dsCOLOR 0 dsWIDTH 155 dsALIGN alCENTER)
	(if (proc0_11)
		(if (< (proc0_11) param2)
			(= param2 (proc0_11))
		)
		(Display
			(Format @global100 232 61 param2) ; "You spent $%d."
			dsFONT
			4
			dsCOORD
			59
...
(instance weekendText of DText
	...
	(method (draw &tmp [temp0 54])
		...
		(cond
			...
			(else
				(while (== global421 (= local8 (Random 17 60)))
					1
				)
				(= global421 local8)
				(if (>= local8 58)
