			...
			(8
				(if local1
					...
					(switch
						...
						(1
							(gMessager say: 11 0 0 0 self) ; "Call our friendly Customer Service folks about returned merchandise, back orders, defective merchandise, company policy, and general game information."
						)
						(2
							(gMessager say: 12 0 0 0 self) ; "To order copies of any other fine Al Lowe game (or even a non-Al game), call our direct sales lines:   U.S.A. (800) 757-7707  U.K. 44 734 303 362  Europe 33 146 01 4600"
						)
						(3
							(gMessager say: 13 0 0 0 self) ; "Technical assistance is merely a phone call away. Call for convenient, person-to-person service at:   U.S.A. (206) 644-4343  U.K. 44 734 303 171  Europe 33 146 01 4600"
						)
						(4
							(gMessager say: 14 0 0 0 self) ; "If you're experiencing any type of technical difficulties with your program, here are some suggestions you might try."
						)
						(5
							(gMessager say: 15 0 0 0 self) ; "If you need a replacement diskette, or are dissatisfied with this product in any way, see your Sierra Game Manual."
						)
						(6
