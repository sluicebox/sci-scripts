...
(instance momsDoor of Door
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(4 ; Do
				(if (> gCurPuzzle 17)
					(gMessager say: 6 4 6) ; "It's locked! Mom's is closed! Sheriff Shift strikes again! Stomachs all over town are heaving... but this time it's sighs of relief!"
				else
					(gCurRoom north: 660)
					(super doVerb: theVerb)
				)
		...
		(switch theVerb
			(1 ; Look
				(if (IsFlag 1)
					...
					(gMessager say: 26 1) ; "Apparently Mom's jumping on the comedy bandwagon. The banner reads, "Coming soon -- Open Megaphone Night. Take your best shot! You'll die laughing!""
				)
			)
			(40 ; Nitrous_Oxide
				(if (< (gEgo y:) 75)
