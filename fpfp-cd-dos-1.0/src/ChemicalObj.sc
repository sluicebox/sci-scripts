				...
				(switch objType
					...
					(4
						(cond
							...
							(amount
								(gGameMusic2 number: 2926 loop: 1 flags: 1 play:)
								(gMessager say: 50 73 11) ; "The medicine containers are for finished medications only. Once you've placed something in a container, you must discard it before starting over. Mix chemicals in a mixing device only."
							)
							(else
								((= contents (List new:))
									addToEnd:
									...
									(9
										(if
											...
											(if
												...
												(gGame points: 5 154)
												(= global143 1)
												(gMessager say: 34 0 26 0 self) ; "You carefully label the jar, "Aminophyllic Citrate." Congratulations. You've just created your first batch of "Pharkas' Deflatulizer\04.""
											else
												(if (gEgo has: 13) ; Deflatulizer
													(gEgo put: 13) ; Deflatulizer
												)
												(= global143 1)
												(gMessager say: 34 0 21 0 self) ; "Well, that was a fun experiment, but it's not going to help you out of your present mess! You throw it all away as you leave your lab table."
											)
										else
											(if (gEgo has: 13) ; Deflatulizer
												(gEgo put: 13) ; Deflatulizer
