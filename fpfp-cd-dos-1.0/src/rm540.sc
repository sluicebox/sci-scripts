	...
	(method (changeState newState &tmp temp0 temp1 temp2)
		(switch (= state newState)
			...
			(1
				...
				(switch
					(Print
						...
						addButton: 2 4 0 0 2 0 18 540 ; "I'm feelin' pretty tough. But don't bust my chops."
						addButton: 3 4 0 0 3 0 48 540 ; "I had too much tequila last night! Go easy!"
						init:
					)
					(0
						(= local9 1)
			...
			(3
				...
				(gMessager say: 6 0 0 0 self) ; "Okee the dokee, Freddy Pharkas! First, we shall see if you can successfully strike the bottles from afar with the bullets of your pistol. Then I will toss the bottles up in the air and you may try to hit them in flight. Good luck and may the best man win."
			)
			(4
				(self dispose:)
			)
...
(instance srini of Prop
	...
	(method (doVerb)
		(gMessager say: noun 47) ; "Srini dodges your bullet!"
	)
)
