...
(instance rm150 of FPRoom
	...
	(method (init)
		...
		(Load rsSYNC 2998)
		(Load rsMESSAGE 150)
		(balladText init: show:)
		(vignette init: hide:)
		(vignette1 init: hide:)
		(super init:)
		(MusicSync init: 2998 self)
		(gGameMusic2 number: 2998 flags: 1 loop: 1 prevSignal: 0 play:)
		(= global147 (GetTime))
	)
	...
	(method (doit &tmp temp0 [temp1 8] [temp9 64])
		(super doit:)
		(cond
			((== (= temp0 (gTheSync prevCue:)) local8) 0)
			(gFastCast 0)
			(
				(OneOf
					temp0
				...
				(if (<= local7 35)
					...
					(Message msgGET 150 2 0 0 (- local7 35) @temp9)
				)
				(= local12
			...
			(0
				...
				(switch
					(Print
						...
						addButton: 0 19 0 0 7 55 0 0 ; "Restart"
			...
			(1
				(if local6
					...
					(switch
						...
						(1
							(gMessager say: 11 0 0 0 self 110) ; "Call our friendly Customer Service folks about returned merchandise, back orders, defective merchandise, company policy, and general game information."
						)
						(2
							(gMessager say: 12 0 0 0 self 110) ; "To order copies of any other fine Al Lowe game (or even a non-Al game), call our direct sales lines:   U.S.A. (800) 757-7707  U.K. 44 734 303 362  Europe 33 146 01 4600"
						)
						(3
							(gMessager say: 13 0 0 0 self 110) ; "Technical assistance is merely a phone call away. Call for convenient, person-to-person service at:   U.S.A. (206) 644-4343  U.K. 44 734 303 171  Europe 33 146 01 4600"
						)
						(4
							(gMessager say: 14 0 0 0 self 110) ; "If you're experiencing any type of technical difficulties with your program, here are some suggestions you might try."
						)
						(5
							(gMessager say: 15 0 0 0 self 110) ; "If you need a replacement diskette, or are dissatisfied with this product in any way, see your Sierra Game Manual."
						)
						(6
