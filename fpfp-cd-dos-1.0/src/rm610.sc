		...
		(switch theVerb
			...
			(1 ; Look
				(cond
					...
					(else
						(gMessager say: noun 1 0) ; "It's an interesting drawer. You wonder if it's made any famous sketches!"
					)
				)
			)
			(45 ; Desk_Key
