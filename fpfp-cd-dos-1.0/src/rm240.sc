	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(gMessager say: 18 0 0 0 self) ; "The stage wuz set fer Freddy's showdown. Wait, did I say "slowdown?" I meant "showdown. No, I DID say "showdown," didn't I? I thought I did, I warn't sure."
			)
			(3
