...
(class Narrator of Prop
	...
	(method (say param1 param2 param3 param4 param5 param6 param7)
		...
		(if (& gMsgType $0002)
			(if (DoAudio audWPLAY param3 param4 param5 param6 param7)
	...
	(method (startText theBuf &tmp strLength)
		(= ticks (Max 60 (* (/ gTextSpeed 4) (= strLength (StrLen theBuf)))))
		(if gModelessDialog
	...
	(method (dispose dWD &tmp [temp0 3])
		(= ticks -1)
...
(class Talker of Narrator
	...
	(method (show &tmp pnv)
		(if (not underBits)
			(= local0 (Graph grSAVE_BOX nsTop nsLeft nsBottom nsRight 2))
	...
	(method (startAudio param1 param2 param3 param4 param5 &tmp temp0)
		(self show:)
		(= temp0 (super startAudio: param1 param2 param3 param4 param5))
		(if mouth
			(mouth setCycle: TalkRandCycle temp0 0 1)
		)
		(if (and eyes (not (eyes cycler:)))
			(eyes setCycle: Blink blinkSpeed)
		)
