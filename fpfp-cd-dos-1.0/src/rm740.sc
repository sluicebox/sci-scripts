...
(instance rm740 of FPRoom
	...
	(method (init)
		...
		(penelope init: cycleSpeed: 7 setScale: -1 gEgo)
...
(instance sStartTheFight of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(penelope view: 740 setLoop: 2 setCel: 0)
				(gEgo
					view: 741
					setLoop: 3
					setCel: 0
			...
			(4
				(penelope setLoop: (Random 0 1) setCycle: End self)
				(= local3 0)
				(= ticks 60)
			)
			(5
...
(instance sFreddyDies of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if local8
					(gMessager say: 50 0 0 0 self) ; "He who fights and runs away... gets skewered!"
				else
					(= cycles 2)
				)
			)
...
(instance sKennyEnters of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGameMusic1 pause: 1)
				(gGameMusic2 number: 724 loop: 1 play: self)
				(kenny
					view: 810
					moveSpeed: 7
					cycleSpeed: 7
			...
			(4
				(gMessager say: 19 0 0 1 2 self) ; "Why, it's you! I recognize you now! From the old neighborhood. Freddy something!"
			)
			(5
			...
			(10
				(if (gEgo has: 49) ; Sharp_Ear
					...
					(gMessager say: 19 0 4 1 self) ; "No, not my hair, Kenny, but THIS!"
...
(instance sFreddyKillsKenny of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(LoadMany rsSOUND 2763 2765 2766)
			...
			(4)
			(5
				(freddySound number: 2766 play: self)
				(kenny loop: 1 cel: 0 setCycle: End self)
			)
			(6)
			(7
				(kenny stopUpd:)
				(gMessager say: 19 0 4 2 self) ; "Hurling your sharpened ear like a Chinese throwing star, you whip it at Kenny, catching him right in the throat!"
			)
			(8
				(gGame points: 35 0 self)
			)
...
(instance penelope of Actor
	...
	(method (handleEvent event &tmp temp0)
		...
		(if (and (not local3) (== gTheCursor 94))
			...
			(gEgo
				setLoop: (if (<= (event y:) temp0) 0 else 1)
