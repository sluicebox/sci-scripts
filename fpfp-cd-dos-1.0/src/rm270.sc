...
(instance sDieInSwamp of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(gMessager say: 8 0 1 0 self) ; "Could I have misjudged the surface tension?"
			)
			(6
				(gEgo
					view: 271
...
(instance swamp of Feature
	...
	(method (doVerb theVerb)
		(if (not (OneOf theVerb 3 4 2 7 8)) ; ???, Do, Talk, ???, icon10
			(gMessager say: 16 6) ; "Chances are you'll need that. Don't be tossing it into the swamp."
		else
