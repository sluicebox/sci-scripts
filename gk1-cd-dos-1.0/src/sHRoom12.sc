...
(instance keypad of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(8 ; Operate
				(sHRoom12 setScript: sExitToHounfour)
			)
			(else
			...
			(8 ; Operate
				(cond
					((not (IsFlag 338))
						(SetFlag 338)
						(SetFlag 341)
						(sHRoom12 setScript: sOpenBathroom)
					)
					((and (IsFlag 338) (not (IsFlag 341)))
						(SetFlag 341)
						(sHRoom12 setScript: sOpenBathroom 0 1)
					)
					(else
