...
(instance rhymeScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(mouse setLoop: 2 setCel: 0 posn: 145 75)
			)
			(6
...
(instance kooKooKlock of PicView
	(properties
		x 78
		y 95
		view 241
...
(instance shelfClocks of PicView
	(properties
		x 189
		y 135
		view 241
...
(instance caseClocks of PicView
	(properties
		x 104
		y 124
		view 241
