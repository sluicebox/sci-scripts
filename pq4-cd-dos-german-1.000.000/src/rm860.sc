...
(instance house of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(38 ; caseChalk
				(gMessager say: 3 38 0 0 0) ; "Is there a new crime scene here, Carey? No? Then put the chalk away."
			)
			(12 ; evidenceCase
				(gMessager say: 7 12 0 0 0) ; "What in your homicide case do you need, Detective?"
			)
			(52 ; notebook
				(gMessager say: 0 52 0 0 0 0) ; "What is it you wish to notate?"
			)
			(else
		...
		(switch theVerb
			(65 ; caseGlassJar
				(if (gEgo has: 20) ; shoe
					...
					(gMessager say: noun theVerb 6) ; "If you suspect hidden evidence, Carey, you'll need to look closer to confirm and collect."
				)
			)
			(52 ; notebook
				(if (gEgo has: 20) ; shoe
					...
					(gMessager say: noun theVerb 6) ; "What about the flower bed deserves notation, Detective?"
				)
			)
			(else
				(super doVerb: theVerb)
		...
		(switch theVerb
			...
			(2 ; Talk
				(if (gPqFlags test: 103)
					...
					(gMessager say: 2 2 5 0 thruDoorScr) ; "Yo Money's busy. If you wanna to see him, you'll have to come back."
				else
					(thruDoorScr seconds: 0 register: 1)
					(if (gPqFlags test: 28)
...
(instance showBadge of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gMessager say: 2 27 0 0 self) ; "I know you're a cop. Whadda you want?"
			)
			(3
...
(instance thruDoorScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				6
				(gMessager say: 2 2 4 0 self) ; "Yeah, you want somethin'?"
			)
			(7
				7
				(= seconds 11)
