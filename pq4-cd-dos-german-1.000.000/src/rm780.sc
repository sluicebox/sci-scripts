...
(instance trunk of Feature
	...
	(method (doVerb theVerb)
		(cond
			((== theVerb 4) ; Do
				(gMessager say: noun theVerb 0) ; "Your car trunk is locked, Detective."
			)
			((== theVerb 46) ; keys
...
(instance cantLeaveScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gMessager say: 0 0 7) ; "Don't wander off, Carey. There's work to be done!"
				(= cycles 2)
			)
			(1
				(gEgo
