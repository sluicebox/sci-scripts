				...
				(while 1
					...
					(if (not (screenText text:))
						...
						(screenText
							text: (temp4 data:)
							font: (if (IsHiRes) 999 else 1999)
							posn: (+ 72 (proc45_3 2 8 8 8 8)) 99
							mode: 0
							setSize: (proc45_3 171 165 165 165 165)
							fore: 13
							back: 0
							skip: 0
							init:
					...
					(if (Message msgSIZE 550 4 51 iconValue (+ temp2 1))
						(myPrint
							addButton: ; "Next"
								...
								(if (> temp2 3)
									(if (IsHiRes)
										(proc45_3 48 54 54 54 54)
									else
										(proc45_3 54 54 65 54 54)
									)
								else
									19
								)
			...
			(1
				...
				(= register
					(myPrint
						...
						addEdit: local1 10 5 (proc45_3 24 12 24 12 12) local1
						addButton: -1 0 0 16 1 100 65 550 ; "Cancel"
