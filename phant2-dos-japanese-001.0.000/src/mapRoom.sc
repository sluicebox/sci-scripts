...
(instance aptPoly of Polygon
	...
	(method (init)
		(super
			init: 118 136 134 124 139 147 184 139 190 156 169 163 177 196 144 203 139 175 122 176
		)
		(return self)
	)
)
...
(instance harburgPoly of Polygon
	...
	(method (init)
		(super
			init: 225 99 225 77 279 66 286 85 342 66 348 82 241 126 213 149 203 106
		)
		(return self)
	)
)
...
(instance dreamTreePoly of Polygon
	...
	(method (init)
		(super
			init: 383 85 490 90 490 106 467 109 469 129 411 134 424 151 391 165 380 131
		)
		(return self)
	)
)
