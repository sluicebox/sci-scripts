...
(procedure (proc5_19 param1 param2 param3 param4 &tmp temp0 [temp1 250])
...
(procedure (proc5_22 param1 param2 param3 param4 param5 param6 &tmp temp0 temp1 temp2 temp3 temp4) ; UNUSED
	(if (>= argc 6)
		(= temp4 param6)
	else
		(= temp4 gUserFont)
	...
	(Display param1 dsCOORD (+ param3 1) param4 dsCOLOR param2 dsALIGN alLEFT dsFONT temp4 &rest)
	(Display param1 dsCOORD param3 param4 dsCOLOR param2 dsALIGN alLEFT dsFONT temp4 &rest)
)
...
(procedure (proc5_14 &tmp [temp0 750])
	(Format @temp0 &rest)
	(Print @temp0 #at -1 12)
)
...
(procedure (proc5_21 &tmp [temp0 750])
	(Format @temp0 &rest)
	(Print @temp0 #at -1 170)
)
