	...
	(method (doit &tmp temp0 temp1 [temp2 700])
		(switch
			...
			(1
				...
				(Print (Format @temp2 0 13) #mode 1 #width 120) ; "Spanish Version Producer/Director Sabine Duvall Programmed by Gary Kamigawachi Translation Randall A. Mage Quality Assurance Roger Pyle Joe Carper"
				(Print (Format @temp2 0 14 gVersion gVersion) #mode 1 #width 120) ; "Castle of Dr. Brain Version %s Designed and Directed by Corey Cole Art Design by Andy Hoyos Lead Artist Douglas Herring"
