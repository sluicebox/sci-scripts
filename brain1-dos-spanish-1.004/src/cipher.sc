...
(instance row_Sfila of CodeIcon
	(properties
		name {row}
		view 381
		loop 3
...
(instance letter_Sletra of CodeIcon
	(properties
		name {letter}
		view 381
		loop 3
