...
(procedure (localproc_0 param1 param2 param3 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 [temp9 250])
	...
	(= temp1
		(if (== param3 1)
			...
			(proc0_3 221 221 221 221 223)
		)
	)
	(= temp2 92)
	(proc5_19
		0
		(proc0_3 3 300 300 300 300)
		(proc0_3 82 84 82 82 82)
		[local114 (* 2 temp3)]
		[local114 (+ (* 2 temp3) 1)]
	)
	(= temp5 (- temp1 3))
...
(instance alienIcon of CodeIcon
	...
	(method (new)
		(= view (proc0_3 426 429 426 426 426))
		(super new: &rest)
	)
...
(instance noMatch of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(proc5_11 427 18 106 (proc0_3 90 70 90 90 90)) ; "That match won't work out. Please try again."
				(= cycles 1)
			)
			(1
				(localproc_5)
