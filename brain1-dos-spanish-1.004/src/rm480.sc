...
(instance toonScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(drHeadOnScreen view: 491 loop: 0 cel: 0 stopUpd:)
			...
			(6
				(if 1
					...
					(Format @local16 480 1 global408 gScore global409 gScore) ; "You've achieved the %s score of %d points on my little puzzles."
			...
			(15
				(= local4 (proc5_12 {Gary Kamigawachi} 67 -10 49 28 28))
			...
			(17
				(localproc_1)
				(localproc_2)
				(Print 480 6 #at 63 136 #time 5 #dispose self #mode 1) ; "Spanish Translator:"
			)
			(18
				(= local4 (proc5_12 {Ernesto F.-Maquieira} 67 -4 50 28 28))
				(leftScreen view: 483 setLoop: 9 setCycle: Osc)
				(= ticks 300)
			)
			(19
				(proc5_12 local4)
			...
			(20
				(localproc_1)
				(Print 480 7 #at 63 136 #time 5 #dispose self #mode 1) ; "Quality Assurance Team Lead:"
			)
			(21
				(= local4 (proc5_12 {Roger Pyle} 67 -4 50 28 28))
				(= local5 (proc5_12 {Joe Carper} 67 240 50 28 28))
				(leftScreen view: 483 setLoop: 10 setCycle: Osc)
				(rightScreen view: 483 setLoop: 11 setCycle: Osc)
				(= ticks 300)
			)
			(22
				(proc5_12 local4)
			...
			(23
				(localproc_1)
				(localproc_2)
				(Print 480 8 #at 63 136 #time 5 #dispose self) ; "Director/Designer/Lead Programmer, and my alter-ego:"
			)
			(24
			...
			(26
				(localproc_1)
				(Print 480 9 #at 63 136 #time 5 #dispose self) ; "My esteemed Producer, who helped us to bring the castle in on time and under budget:"
			)
			(27
			...
			(29
				...
				(localproc_1)
				(localproc_2)
				(Print 480 10 #at 63 136 #time 5 #dispose self) ; "My art Production Designer (we'll let him out soon):"
			)
			(30
			...
			(31
				(proc5_12 local4)
				(localproc_1)
				(Print 480 11 #at 63 136 #time 4 #dispose self) ; "The Art Designer (he already got out!):"
			)
			(32
			...
			(33
				(proc5_12 local5)
				(localproc_2)
				(Print 480 12 #at 93 136 #time 4 #dispose self) ; "My Composers: "Whadidya say? I can't see you?""
			)
			(34
			...
			(37
				(localproc_1)
				(localproc_2)
				(Print 480 13 #at 63 136 #time 4 #dispose self) ; "Digitized sounds constructed by:"
			)
			(38
			...
			(39
				...
				(localproc_1)
				(localproc_2)
				(Print 480 14 #at 63 136 #time 6 #dispose self) ; "And here are some of my artist friends! They have helped me decorate this beautiful castle! The animators:"
			)
			(40
			...
			(49
				(proc5_12 local4)
				(localproc_1)
				(Print 480 15 #at 63 136 #time 5 #dispose self) ; "And here are some MORE of my artist friends! The background artists:"
			)
			(50
			...
			(51
				...
				(localproc_1)
				(localproc_2)
				(Print 480 16 #at 63 136 #time 6 #dispose self) ; "I also know some programmers! Without them, I would have had a hard time putting my little challenges together!"
			)
			(52
			...
			(56
				(localproc_1)
				(localproc_2)
				(Print 480 17 #at 63 136 #time 5 #dispose self) ; "My Quality Assurance Leads: Making sure the castle is as clean as can be!"
			)
			(57
			...
			(59
				...
				(localproc_1)
				(localproc_2)
				(Print 480 18 #at 63 136 #time 5 #dispose self) ; "Finally, special credit for Design Assistance and Necessary Discipline must surely go to:"
			)
			(60
			...
			(61
				...
				(proc5_12 local4)
				(localproc_1)
				(Print 480 19 #at 63 136 #time 5 #dispose self) ; "But now it's time for me to devise a new set of challenges for you, my clever lab assistant!"
			)
			(62
				(Print 480 20 #at 80 136 #time 5 #dispose self) ; "Which means I must be off to the ..."
			)
			(63
...
(instance trailerScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(= local6
					(Display 480 21 dsCOORD 20 80 dsALIGN alCENTER dsWIDTH 280 dsFONT 200 dsCOLOR 0 dsSAVEPIXELS) ; "I ' L L  B E  B A C K !"
				)
				(= ticks 60)
			)
			(14
			...
			(16
				(Display 480 22 dsRESTOREPIXELS local6)
				(= gQuit 1)
			)
		)
	)
...
(instance titleWipeOn of Prop
	...
	(method (init)
		(= view (proc0_3 486 487 486 486 486))
		(super init: &rest)
	)
)
