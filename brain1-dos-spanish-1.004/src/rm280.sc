...
(local
	...
	[local104 10] = [{} {ADELANTE} {IZQUIERDA} {ATRAS} {DERECHA} {ENCENDER} {APAGAR} {INICIAR} {FINALIZAR} {}]
...
(instance programmer of PuzzleBar
	...
	(method (init &tmp temp0)
		...
		(self add: (printIcon init: yourself:))
	...
	(method (dispatchEvent event &tmp temp0 temp1 temp2)
		(if (== (event type:) evKEYBOARD)
			...
			(switch (event message:)
				...
				(KEY_q
					(Print 280 53 #at 68 98 #width 200) ; "KEYBOARD COMMANDS: f - Forward...o - turn On b - Backward..t - Turn off l - Left......d - Delete r - Right.....i - Insert s - Save......p - Previous command c - Clear.....n - Next command q - Quick look at this list"
				)
				(else
					(= temp1 0)
				)
...
(instance printIcon of CodeIcon
	...
	(method (init)
		(= view (proc0_3 295 296 295 295 295))
		(super init: &rest)
	)
