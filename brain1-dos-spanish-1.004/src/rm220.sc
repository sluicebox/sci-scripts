...
(local
	...
	[local56 5] = [{(A) Multiplicar...} {(B) Aplicar CPU...} {(C) Tiene ra\a1ces cuadradas...} {(D) Para evitar cortocircuitos...} {(E) Un orde\a4ador...}]
	[local61 20] = [{What's special about the} {way a robot plant grows?} { } {} {What kind of computer} {does a dairy farmer use?} {} {} {Why do robots always take} {take the longest path} {between two points?} { } {What do robot rabbits do} {best?} {} {} {What should you do when a} {robot is having a heart} {attack?} {}]
	local81
)
...
(procedure (localproc_5 &tmp temp0 temp1)
	(Graph grFILL_BOX 40 24 80 162 1 [local0 2] -1 -1)
	(= temp0 0)
	(= temp1 (* global402 4))
	(Graph grFILL_BOX 40 24 80 162 1 [local0 3] -1 -1)
	(Graph grUPDATE_BOX 40 24 80 162 1)
...
(instance robotJokes of PuzzleBar
	...
	(method (init &tmp temp0 temp1)
		...
		(self
			add:
				(nextIcon init: highlightColor: [local0 7] yourself:)
...
(instance nextIcon of CodeIcon
	...
	(method (init)
		(= view (proc0_3 225 227 225 225 225))
		(super init: &rest)
	)
