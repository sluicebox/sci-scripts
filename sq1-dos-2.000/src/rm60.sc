...
(local
	...
	[local25 32] = [0 0 319 0 319 173 261 173 270 167 250 167 234 173 137 173 137 167 151 163 151 96 116 96 116 164 129 167 129 173 0 174]
	[local57 8] = [319 185 319 189 0 189 0 184]
	local65
	local66
)
...
(instance rm60 of SQRoom
	...
	(method (init)
		...
		(lp points: @local25 size: 16)
		(lp2 points: @local57 size: 4)
		...
		(switch (= state newState)
			(0
				...
				(gEgo
					...
					setMotion: JumpTo local65 local66
				)
			)
			(1
