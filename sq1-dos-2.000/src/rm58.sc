...
(instance counterTop of RegionFeature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(2 ; Look
				(Print 58 11) ; "This is a long S-shaped counter top that runs from one end of the armory to the other. At one end there is an opening, probably used to allow access to the other side of counter."
			)
			(11 ; Taste
