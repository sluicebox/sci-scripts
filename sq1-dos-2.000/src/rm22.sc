		...
		(if (== global166 2)
			(self
				addObstacle:
					...
					((Polygon new:)
						type: PBarredAccess
						init: 139 189 136 184 127 181 109 177 96 162 114 147 107 143 92 144 76 136 62 136 25 129 29 119 22 105 10 100 15 86 84 78 65 44 77 37 78 25 56 0 147 0 289 83 309 134 302 146 277 149 263 163 270 168 281 189
						yourself:
					)
			)
		else
