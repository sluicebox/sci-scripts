...
(local
	...
	local7
	local8
	[local9 46] = [0 0 319 0 319 189 247 189 319 139 295 121 269 123 256 108 218 106 200 98 162 93 129 95 91 105 71 116 110 122 105 132 56 133 88 146 75 156 21 159 11 153 24 142 0 148]
		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(16 ; Plant
						(Print 28 16) ; "Does he look like a vegatarian to you?"
					)
					(else
