	...
	(method (init)
		...
		(switch
			(if global170
				...
				(= global170 (Random 1 (if (not (IsFlag 11)) 2 else 3)))
			)
			(1
			...
			(2 ; Look
				(Printf ; "This is a seedy little place. Galactic riff-raff are seated at the bar. %s. There is a slot machine standing near the bar. You notice a sweeper in the corner of the room. It must get messy here. No one seems to notice or care that you have entered the bar."
					...
					(switch global170
						...
						(3 {On stage, a strangely attired woman performs her act (if that's what you want to call it). You haven't had a girlfriend for a long time (more like forever), but even that's not enough to make here attractive.})
					)
				)
			)
			(12 ; Smell
				...
				(if
					(or
						(and
							...
							(Print 43 6 #at 10 10 #button { Yes } 1 #button { No } 0) ; "Do you want a beer? It costs 2 Buckazoids."
						)
						(and
							(< 0 global169 5)
							(or (and gModelessDialog (gModelessDialog dispose:)) 1)
							(Print 43 7 #at 10 10 #button { Yes } 1 #button { No } 0) ; "Want another drink?"
						)
						(and
							(== global169 5)
							(or (and gModelessDialog (gModelessDialog dispose:)) 1)
...
(instance moveEgoToBar of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(beerMug show: posn: 264 136 setMotion: MoveTo 291 136 self)
				(= global188 0)
				(gEgo setCycle: End)
			)
			(8
		...
		(switch theVerb
			...
			(5 ; Talk
				(if local0
					...
					(Print 43 28 #at 170 101) ; "Hi. The name's Wilco. Roger Wilco. What's yours?"
			...
			(12 ; Smell
				(Print 43 33) ; "Could be Rid-O-Fleaz Shampoo, or just a really manly after- shave."
			)
			(4 ; Inventory
				(switch invItem
					(10 ; buckazoid
		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(11 ; Jetpack
						(Print 43 55) ; "You show him your jet pack. He shrugs. It's sort of a slug shrug. Spooky!"
					)
					(17 ; Bar_Coupon
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(5 ; Talk
				...
				(Print 43 60 #at 224 130) ; "Get outta my face, Pinky."
			...
			(4 ; Inventory
				(switch invItem
					...
					(11 ; Jetpack
						(Print 43 69) ; "She's pretty nearly as interested in your jet pack as she is in you, which is to say not much."
					)
					(17 ; Bar_Coupon
...
(instance fenris of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(5 ; Talk
				(Print 43 72 #at 175 68) ; ""Can I offer you a Milk-Bone?" you inquire in an attempt to be friendly."
				(Print 43 73 #at 224 149) ; "Grrrrrrr!"
				(Print 43 74) ; "You decide you just can't make friends with everybody."
			)
			(12 ; Smell
				(Print 43 75) ; "Pretty much like wet dog."
			)
			(4 ; Inventory
				(switch invItem
					(10 ; buckazoid
						(Print 43 76) ; "This doesn't seem wise, even to you."
					)
					(0 ; Cartridge
						(Print 43 77) ; "He shows absolutely no interest in the cartridge."
					)
					(15 ; Widget
						(Print 43 78) ; "He seems less interested in the widget than in that cute drink in his paw."
					)
					(2 ; Gadget
						(Print 43 79) ; "Since he isn't inclinded to talk to you, there's not much point trying to translate."
					)
					(4 ; Knife
						(Print 43 80) ; "On second thought, maybe you'd just better keep it in your pocket."
					)
					(5 ; Dehydrated_Water
						(Print 43 81) ; "He seems well taken care of in the drink department."
					)
					(11 ; Jetpack
						(Print 43 82) ; "You wonder why you're offering this giant hairball your new jet pack and are forced to admit you don't know."
					)
					(17 ; Bar_Coupon
						(Print 43 83) ; "You wisely decide that flashing your coupons at fur-face here would be a serious waste of your time."
					)
					(18 ; Droids-B-Us_coupon
						(Print 43 83) ; "You wisely decide that flashing your coupons at fur-face here would be a serious waste of your time."
					)
...
(instance bartender of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 43 84) ; "You decide you'd rather live."
			)
			(5 ; Talk
				(cond
					((not local0)
			...
			(4 ; Inventory
				(switch invItem
					...
					(0 ; Cartridge
						(Print 43 85) ; "He doesn't seem willing to accept this in trade for a beer."
					)
					(15 ; Widget
						(Print 43 86) ; "The bartender only wants money."
					)
					(2 ; Gadget
						(Print 43 87) ; "He doesn't want this - he wants money."
					)
					(4 ; Knife
						(Print 43 88) ; "Threatening the bartender will probably get you Laze-O-Toasted. Try buying a drink instead."
					)
					(5 ; Dehydrated_Water
						(Print 43 89) ; "No, dummy - he's supposed to gieve YOU drinks."
					)
					(11 ; Jetpack
						(Print 43 90) ; "The bartender does not recognize your jet pack as currency. He wants to see Buckazoids."
					)
					(else
			...
			(11 ; Taste
				(Print 43 91) ; "Try it and this guy is likely to use his beer tap on your head."
			)
			(12 ; Smell
				(Print 43 92) ; "His armpits could etch glass."
			)
			(else
				(super doVerb: theVerb invItem &rest)
			)
...
(instance chp_dail of Prop
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 43 93) ; "Maybe you'd better buy your own beer"
			)
			(11 ; Taste
				(Print 43 58) ; "Most extraterrestrials won't do that on the first date. Maybe you should just listen to them."
			)
			(5 ; Talk
				(Print 43 94) ; "What's the use? You can't understand a word they're saying."
			)
			(12 ; Smell
				(Print 43 95) ; "Sniffing others is a ritual best left to dogs and other four-legged creatures."
			)
			(4 ; Inventory
				(switch invItem
					(10 ; buckazoid
						(Print 43 96) ; "The little purple guy doesn't seem to understand your offer of money."
					)
					(0 ; Cartridge
						(Print 43 97) ; "The cartridge doesn't interest him in the least."
					)
					(15 ; Widget
						(Print 43 98) ; "He seems not to care about the widget."
					)
					(2 ; Gadget
						(Print 43 99) ; "Even translated, his speech is gibberish."
					)
					(4 ; Knife
						(Print 43 100) ; "He doesn't seem to be either interested or threatened by your knife."
					)
					(5 ; Dehydrated_Water
						(Print 43 101) ; "He doesn't seem to be thristy."
					)
					(11 ; Jetpack
						(Print 43 102) ; "Careful! You don't want to hurt the little guy."
					)
					(17 ; Bar_Coupon
						(Print 43 103) ; "The little guy shows no interest in your coupon. Did you think he would?"
					)
					(18 ; Droids-B-Us_coupon
						(Print 43 103) ; "The little guy shows no interest in your coupon. Did you think he would?"
					)
...
(instance sweeper of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(11 ; Taste
				(Print 43 104) ; "The robot observes that your teeth haven't been cleaned in a long time."
			)
			(12 ; Smell
				(Print 43 105) ; "The robot observes that your nostril hairs could use trimming."
			)
		)
	)
)
...
(instance lightCannon of Feature ; UNUSED
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 43 106) ; "You'll only hurt yourself"
			)
			(12 ; Smell
				(Print 43 107) ; "A faint odor of ozone lingers in the air near the business end of the device."
			)
			(11 ; Taste
				(Print 43 108) ; "It's not likely you could taste it from here, or would want to, for that matter."
			)
			(else
				(super doVerb: theVerb &rest)
			)
	...
	(method (doVerb theVerb invItem)
		...
		(switch theVerb
			(3 ; Do
				(cond
					((IsFlag 63)
						(Print 43 109) ; "The "Slots-O-Death" machine seems to have met its match. It will no longer be a deadly temptation for unsuspecting space-farers such as yourself."
					)
					((not (gCurRoom script:))
			...
			(11 ; Taste
				(Print 43 110) ; "Watch it or you'll get zapped."
			)
			(12 ; Smell
				(Print 43 111) ; "Hmmm...It smells vaguely like burnt flesh."
			)
			(2 ; Look
				(if (IsFlag 63)
					(Print 43 109) ; "The "Slots-O-Death" machine seems to have met its match. It will no longer be a deadly temptation for unsuspecting space-farers such as yourself."
