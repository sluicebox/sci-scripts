		...
		(if (!= style 8)
			(self
				addObstacle:
					((Polygon new:)
						type: PBarredAccess
						init: 319 179 289 176 260 170 230 161 194 142 173 140 173 150 136 150 136 128 108 126 100 119 95 107 84 107 87 97 0 97 0 0 319 0
						yourself:
					)
			)
		)
...
(instance robbie of Actor
	(properties
		...
		lookStr {This robot is a very old model.  Somehow, he looks tired and depressed.}
		view 449
		loop 1
		signal 16384
		cycleSpeed 8
