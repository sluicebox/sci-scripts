		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(11 ; Jetpack
						(Print 48 1) ; "A shodily manufactured jet pack is certainly not worth the price of one of these fine previously-owned droids. My advice, sir, is to come up with the cash or walk."
					)
					...
					(else
						(localproc_0
							{I'm afraid that item can not be exchanged for enough money to purchase one of our quality products. Is sir financially embarassed, or might there be cash in one of those pockets?}
						)
					)
				)
			)
...
(instance robotHead of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(5 ; Talk
				(Print 48 2) ; "The robot doesn't speak, but you think you can see a bloodthirsty gleam in his metallic eye."
			)
			(else
