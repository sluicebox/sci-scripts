...
(local
	[local0 36] = [0 0 319 0 319 189 0 189 0 74 32 67 257 67 263 48 188 48 184 50 169 50 169 28 154 28 154 50 139 50 135 45 31 45 0 52]
...
(instance lowerDoor of Elevator
	...
	(method (doVerb theVerb)
		(if (== global166 level)
			(switch theVerb
				(2 ; Look
					(Print 5 12) ; "This is an elevator to one of the upper levels."
				)
				(else
					(super doVerb: theVerb &rest)
				)
