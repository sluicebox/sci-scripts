			...
			(11
					...
					(cond
						((== (temp3 type:) 0)
							(if (> gAttitudeSetting 1)
								(Characters
									sayPN: 1000 2 83 0 (Random 1 5) 719 1
								)
							)
						)
						((> gAttitudeSetting 1)
							((temp3 owner:)
								sayPN: 1000 2 82 0 (Random 1 5) 719 1
							)
						)
					)
				else
				...
				(if (>= (+ (temp3 total:) (temp3 tempTotal:)) 100)
					(cond
						...
						((> gAttitudeSetting 1)
							((temp3 owner:) sayReg: 1000 2 64 0 1 719 1)
						)
					)
				)
				(= ticks 1)
			...
			((and (not local3) (discardPile conditionSet:))
				...
				(if (== ((Dealer curPlayer:) type:) 0)
					(switch (discardPile condition:)
						...
						(8
							(Characters sayPN: 1000 2 82 0 (Random 1 5) 719 1)
							(= local3 1)
						)
						(12
							(if (not (Random 0 1))
					...
					(switch (discardPile condition:)
						(2
							(temp0 sayPN: 1000 2 83 0 (Random 1 5) 721 1)
							(= local3 1)
						)
						(4
							(if (not (Random 0 3))
				...
				(cond
					...
					((not (Random 0 temp1))
						(((Dealer curPlayer:) owner:)
							sayPN: 1000 2 83 0 (Random 1 5) 721 1
						)
						(= local3 1)
					)
				)
		...
		(if (self isValid: param1)
			...
			(switch global403
				...
				(3
					...
					(= global920 1)
					(if gAttitudeSetting
						(Characters sayReg: 100 15 60 0 (Random 1 2))
					else
						(Characters say: 100 15 60 0 2)
					)
				)
				(7
					(proc0_12 905)
				...
				(8
					...
					(= global920 1)
					(if gAttitudeSetting
						(Characters sayReg: 100 15 57 0 (Random 1 2))
					else
						(Characters say: 100 15 57 0 2)
					)
				)
				(12
					(proc0_12 905)
