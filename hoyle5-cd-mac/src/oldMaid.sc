			...
			(3
				...
				(if (Random 0 1)
					...
					(switch register
						...
						(hand3
							(gChar2 sayPN: 1000 2 82 0 (Random 1 5) 719 1)
						)
						(hand4
							(gChar3 sayPN: 1000 2 82 0 (Random 1 5) 719 1)
						)
					)
				)
			...
			(6
				...
				(if local11
					(cond
						((== (local11 view:) 6)
							(local11
								sayReg: 1000 2 63 0 (Random 1 2) 721 1 self
							)
						)
		...
		(if
			...
			(cond
				((and (gCast contains: pairButton) (not owner))
					(proc0_12 904)
					(Characters say: 200 19 0 0 1 719)
					(return 1)
				)
				...
				(
					...
					(cond
						((!= self hand4)
							...
							(= temp1 (hand4 owner:))
							(temp1
								sayReg: 200 (+ (proc200_3 temp1) 1) 70 0 1 719
							)
							(return 1)
						)
...
(instance pairButton of TrackingView
	...
	(method (init &tmp temp0 temp1 temp2)
		...
		(KList 22 (temp1 elements:) 768 0) ; Sort
		(= temp2 0)
