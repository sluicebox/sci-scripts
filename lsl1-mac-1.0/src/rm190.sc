...
(instance rm190 of LLRoom
	...
	(method (init)
		...
		(typist1 init: cycleSpeed: (+ 2 global101) setCycle: Fwd)
		(typist2 init: cycleSpeed: (+ 3 global101) setCycle: Fwd)
		(smallScreen init: cycleSpeed: (+ 4 global101) setCycle: Fwd)
		(nudeLady init: cycleSpeed: (+ 3 global101) setCycle: Osc)
		(gGame setSpeed: 3)
		(blenderLid cycleSpeed: global101 init: stopUpd:)
		(shaft1 cycleSpeed: global101 init:)
		(platform1 cycleSpeed: global101 init:)
		(shaft2 cycleSpeed: global101 init: stopUpd:)
		(platform2 cycleSpeed: global101 init: stopUpd:)
		(deadLarry cycleSpeed: global101 init:)
