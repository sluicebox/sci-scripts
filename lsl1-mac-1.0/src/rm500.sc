	...
	(method (init)
		...
		(if (and (ObjInRoom 11) (> (gEgo x:) 50) (!= gPrevRoomNum 505))
			(if (IsFlag 99) ; fBumTgl
				...
				(aBumHead cycleSpeed: (+ 3 global101) init:)
			)
			(ToggleFlag 99)
		)
		...
		(switch (= state newState)
			...
			(3
				(if (== bumVerb 1)
					(switch register
						(11
							(Print 500 12) ; "Cheezzzz! This guy could make that dog smell refreshing!"
						)
						(3
							(Print 500 13) ; "You search the bum diligently and find nothing but a strong aroma, which you allow him to keep!"
						)
					)
				)
				(self cue:)
			...
			(4
				(if (== bumObj 1)
					(switch register
						(4
							(Print 500 14) ; "Here ya go, pal. Take my diamond ring! A guy like me doesn't need commitment!"
						)
						(6
							(Print 500 15) ; ""I got this from a fella that reminds me of you," you say to the bum."
						)
						(7
							(Print 500 16) ; ""Peace, baby!" you say, handing the flower to the bum."
						)
						(9
							(Print 500 17) ; ""Want a piece?" you say."
						)
						(13
							(Print 500 18) ; "Have you seen the kind of filth they're selling inside this convenience store!" you state, indignantly. "Why, it's an outrage!"
						)
						(15
							(Print 500 19) ; "Take this bottle of pills," you tell the bum. "I'm sure I'll have no use for any aphrodisiacs this evening. After all, I only hung on the side of a fire escape dangling from a velveteen ribbon to get these babies!"
						)
						(5
							(Print 500 20) ; "Here take a swig of this gramps."
						)
					)
				)
				(self cue:)
			...
			(6
				(if (== bumVerb 1)
					(switch register
						(3
							(Print 500 21) ; "Ssshay, buddy," grins the bum, "I kinda enjoyed that!"
						)
						(5
							(Print 500 22) ; "Howsha 'bout a drink, Shonney?"
						)
						(10
							(Print 500 23) ; "HEY! I may be down, but I ain't THAT out!"
						)
					)
				)
				(self cue:)
				...
				(if (== bumObj 1)
					(switch register
						(6
							...
							(Print 500 24) ; "Hey, thankshh, Misshter. Now I can go visshit that hooker!"
						)
						(7
							(gEgo put: 7) ; rose
							(Print 500 25) ; ""Make love, not war!" he replies, pocketing your rose."
						)
						(9
							(gEgo put: 9) ; candy
							(Print 500 26) ; ""I'm trying to cut back," the bum replies."
						)
						(13
							(gEgo put: 13) ; magazine
							(Print 500 27) ; "Yeah. I'll give it further ssshtudy back at my placessh."
						)
						(15
							(gEgo put: 15) ; pills
							(Print 500 28) ; "Thanks. How droll."
						)
						(4
							(gEgo put: 4) ; ring
							(Print 500 29) ; "Thankshh Does thissh mean we're engashhged?"
						)
						(5
							(gEgo put: 5) ; whiskey
							(Print 500 30) ; "Burp. Thanks, I needed that! See ya 'round!!"
						)
					)
				)
				(self cue:)
...
(instance sBumLeaves of Script
	...
	(method (doit)
		...
		(if (and (== state 2) (!= aBumThreat 1) (aBum isBlocked: 1))
			(= aBumThreat 1)
			(Print 500 31) ; "Outta my way shhonney, I know marssshhal artshhh!"
		)
	)
...
(instance darkAlley of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(5 ; Talk
				(Print 500 33) ; "Hello!" you cry into the darkness, "is there anybody back there?"
			)
			(else
				(super doVerb: theVerb invItem &rest)
			)
...
(instance fWindow of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 500 34) ; "It does feel like glass."
			)
			(5 ; Talk
				(Print 500 35) ; "They could hear you better if you went inside the store."
			)
			(4 ; Inventory
				(switch invItem
					(4 ; ring
						(Print 500 36) ; "You swipe the diamond ring across the Quiki-Mart window, leaving a giant scratch in the glass. You hope you were not observed!"
					)
					(else
...
(instance fSign of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 500 37) ; "That sign is too high for you to reach."
			)
			(else
				(super doVerb: theVerb invItem &rest)
			)
...
(instance fTelephone of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Points 86 1)
				(Print 500 38) ; "There are some numbers scribbled on the side of the telephone. The only thing legible (and printable) is: "555-6969.""
			)
			(3 ; Do
				(HandsOff)
...
(instance fArtGallery of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(3 ; Do
				(Print 500 39) ; "The locked gate effectively prevents you from any cultural enlightenment by entering the Art Gallery."
			)
			(5 ; Talk
				(Print 500 40) ; "You have no wish to talk to a bunch of paintings."
			)
			(else
				(super doVerb: theVerb invItem &rest)
			)
		...
		(switch theVerb
			...
			(4 ; Inventory
				...
				(switch invItem
					...
					(0 ; wallet
						(Print 500 41) ; "You fish a dollar out of your wallet and hand it to the bum. "Gossshhh thanssskks, buddy," he says sarcastically. "With all thisssh money, maybe I can finally invessst in sssome sssmall company, growth mutual fundsssh!""
						(-= gLarryDollars 1)
						(aBum setScript: sBumLeaves)
					)
					(1 ; breathSpray
						(Print 500 42) ; "Although the bum IS in need of an industrial-strength deodorant, your breath spray doesn't have enough horsepower to kill that aroma!"
					)
					(2 ; watch
						(Print 500 43) ; ""Say, would you like a watch?" you yell to the bum."
						(Print 500 44) ; "No," he responds, "would you like TO watch?"
					)
					(3 ; apple
						(Print 500 45) ; ""An apple a day keeps the doctor away!" you pontificate."
						(Print 500 46) ; ""A gallon a day keeps the pink elephants away," he mutters."
					)
					(4 ; ring
						(aBum setScript: sBumInteraction 0 invItem)
					)
					...
					(8 ; lubber
						(Print 500 47) ; "No, Larry. You'd better keep that for yourself."
					)
					(9 ; candy
						(aBum setScript: sBumInteraction 0 invItem)
					)
					...
					(else
						(Printf 500 48 ((Inv at: invItem) description:)) ; "That bum has no need for %s."
					)
				)
			)
			(else
