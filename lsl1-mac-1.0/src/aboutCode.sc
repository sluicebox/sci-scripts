...
(instance aboutCode of Code
	...
	(method (doit &tmp string)
		...
		(Print ; "Macintosh Lead Programmer Krishnan Shankar Macintosh Systems Programmer Randy Moss Quality Assurance Bill Hilton Jason Hickingbottom Music Robert Holmes Artist Phyllis Cucchiara Producer Stuart Moulder"
			811
			4
			#font
			gSmallFont
