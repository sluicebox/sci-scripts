...
(local
	...
	[local87 26] = [128 108 128 109 128 109 128 103 128 74 128 100 128 103 128 89 128 90 128 93 128 103 128 100 128 137]
	[local113 24] = [128 146 128 147 128 147 128 144 128 154 128 140 128 143 128 149 128 150 128 153 128 163 128 160]
	[local137 24] = [128 201 128 188 128 188 128 203 128 233 128 199 128 204 128 208 128 209 128 212 128 222 128 221]
	local161
	local162
	local163
	local164
	...
	(switch local170
		...
		(2
			(cond
				...
				((InRect 324 347 453 365 param1)
					(return 7)
				)
				((InRect 308 377 461 403 param1)
					(return 8)
				)
				(else
					(return -1)
