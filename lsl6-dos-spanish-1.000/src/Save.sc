...
(procedure (GetDirectory where &tmp result [newDir 33] [str 100] [saveParseLang 50])
	(repeat
		...
		(if (ValidPath @newDir)
			...
			(Print font: gUserFont addText: @str init:)
		)
	)
)
...
(procedure (NeedDescription)
	(Print font: gUserFont addText: 3 0 0 1 0 0 990 init:) ; "You must type a description for the game."
)
...
(class SRDialog of Dialog
	...
	(method (doit theComment &tmp temp0 temp1 temp2 [temp3 361] [temp364 21] [temp385 100])
