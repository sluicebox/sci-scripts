...
(instance menuBar of Class_912_0
	...
	(method (init)
		...
		(AddMenu
			...
			(switch (gGame printLang:)
				(34 {Control :Teclado F\a0cil :Servicio al Cliente :Libro de Pistas :-! :Puedes Disfrutar :Sobre Larry 6 })
				(49 {Oberfl\84che :Tastatur Spass :Kundendienst :L\94sungsheft :-! :Weitere Spiele :\9aber Larry 6 })
				(33 {Interface :Dr\93les de Touches :Service Conseil :Livre de Suggestions :-! :Vous Appr\82ciez :A Propos de Larry 6 })
				(else {Interface :Keyboard Fun :Customer Service :Hint Book :-! :You May Enjoy :About Larry 6 })
			)
		)
	)
...
(instance aboutScr of Script
	...
	(method (changeState newState &tmp [temp0 200])
		(switch (= state newState)
			...
			(1
				(Message msgGET 93 8 0 0 13 @temp0) ; "November 8, 1993 Version %s"
