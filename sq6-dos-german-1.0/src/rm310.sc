		...
		(self
			addObstacle:
				((Polygon new:)
					...
					init: 311 116 294 111 294 104 277 104 264 106 129 87 40 98 74 114 123 108 165 110 170 118 225 135 311 135
					yourself:
				)
		)
		(super init: &rest)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(nitroKeg posn: 123 88 approachX: 134 approachY: 93 show:)
