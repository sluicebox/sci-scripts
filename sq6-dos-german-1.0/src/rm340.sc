...
(procedure (localproc_0 param1 param2 param3 param4)
	...
	(Text 0 (local1 data:) (local13 data:) 340 60) ; TextSize
	((= local2 (DText new:))
...
(instance rm340 of SQRoom
	...
	(method (init)
		...
		(if (IsFlag 0)
			...
			(Load rsVIEW 342)
			(Load rsVIEW 345)
			(Load rsVIEW 3431 3430)
			(Load rsVIEW 209)
			(Load rsVIEW 3431)
			(Load 140 340 327 342 344) ; WAVE
			(Lock 140 344 1) ; WAVE
			(Load 140 346) ; WAVE
			(Lock 140 346 1) ; WAVE
			(Load 140 348 350) ; WAVE
			(bicycle init:)
		else
		...
		(switch gPrevRoomNum
			...
			(480
				...
				(gGSound1 number: 330 setLoop: -1 setVol: 127 play:)
				(gEgo hide:)
	...
	(method (doit &tmp temp0)
		(cond
			((<= (= temp0 (GetDistance (gEgo x:) (gEgo y:) 150 107)) 11)
				(PalVary 0 345 0 (- 110 (* temp0 10)) 64 79) ; PalVaryStart
			)
			((<= (= temp0 (GetDistance (gEgo x:) (gEgo y:) 253 125)) 22)
				(PalVary 0 345 0 (- 110 (* temp0 5)) 64 79) ; PalVaryStart
			)
		)
		(super doit:)
	)
...
(instance sBeamUp of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gGSound2 loop: 0 number: 344 play:)
				(gEgo
					view: 345
					setCel: 0
					setLoop: 1
...
(instance sHangOn of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(tallWalker hide:)
				(gGSound2 number: 326 loop: 0 play:)
				(gEgo cycleSpeed: local8 setCycle: End self)
			)
			(5
				(gEgo
			...
			(7
				...
				(gGSound2 number: 327 loop: 0 play:)
			)
			(8
				(gGSound2 number: 34004 loop: 0 play:)
