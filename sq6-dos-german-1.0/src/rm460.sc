...
(procedure (localproc_4 param1 param2 param3 param4 param5 param6)
	...
	(cond
		...
		(
			...
			(localproc_5 6 50 0 1 {1.} 1 (proc0_16 6 8 8 8 8))
			(localproc_5 6 49 0 1 {2.} 2 (proc0_16 22 20 20 20 20))
			(localproc_6 1)
			(= local59 1)
		)
		(
			...
			(localproc_5 6 39 0 1 {1.} 1 (proc0_16 6 8 8 8 8))
			(localproc_5 6 49 0 1 {2.} 2 (proc0_16 22 20 20 20 20))
			(localproc_6 2)
			(= local59 2)
		)
		(else
			(localproc_5 6 50 0 1 {1.} 1 (proc0_16 0 2 2 2 2))
			(localproc_5 6 39 0 1 {2.} 2 14)
			(localproc_5 6 49 0 1 {3.} 3 (proc0_16 29 27 27 27 27))
			(if local63
				(localproc_6 2)
			else
				(localproc_6 1)
...
(instance rm460 of SQRoom
	...
	(method (init &tmp temp0)
		...
		(= local44 (Str newWith: 120 {}))
		(= local45 (Str newWith: 120 {}))
		(= local47 (Str newWith: 120 {}))
