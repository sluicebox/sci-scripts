	...
	(method (handleEvent event)
		...
		(cond
			(
				(or
					(Said 'look,look/area')
					(Said 'look,look<stop,away')
					(Said 'stop/look,look')
					(Said 'look,look<stop/awning')
					(Said 'exit,stop')
					(Said 'drop/binocular')
				)
				(Ok) ; "O.K."
			...
			((Said 'look,look[/woman]')
				(switch stripperState
					(1
						(Printf 206 8 gEgoName gEgoName) ; "%s! You're looking into a woman's hotel room!"
					)
					(2
