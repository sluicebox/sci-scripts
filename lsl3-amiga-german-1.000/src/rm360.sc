...
(instance RoomScript of Script
	...
	(method (handleEvent event)
		...
		(cond
			...
			((Said '/blouse')
				(Print 360 6) ; "You'd rather order a "Leisure Suit Larry 3" T-shirt from Sierra. Just call 1 (800) 326-6654 (or 1 (209) 683-4468) to buy yours today!! (It helps, when you speak English...)"
			)
			((Said 'get,get/soap')
			...
			((Said 'look,look>')
				(cond
					...
					((Said '/buffet,buffet<behind,back,back')
						(if (gCast contains: aRobin)
