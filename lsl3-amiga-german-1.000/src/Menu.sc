	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3 [temp4 560] temp564 temp565 temp566)
		...
		(switch (= temp0 (super handleEvent: event))
			(257
				...
				(Format @temp4 997 3 gVersion gVersion) ; "Sierra's Creative Interpreter by Jeff Stephenson, Bob Heitman, Pablo Ghenis, and Stuart Goldstein Mark Hood Music Composed and Performed by Mike Dana Sound Effects by Rob Atesalp Atari ST Translation by Corey Cole Amiga Translation by Robert Lindsley Quality Assurance led by Robin Bradley Version %s January 7, 1991"
				(PrintSplit
					@temp4
					33
					gSmallFont
			...
			(1281
				(if (HaveMem 2048)
					...
					(DoSound sndMASTER_VOLUME global591)
					(DisposeScript 987)
				)
			)
			(1282
