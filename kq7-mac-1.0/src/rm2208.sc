...
(instance rm2208 of KQRoom
	...
	(method (init)
		(super init: &rest)
		(steam init: number: 2201 setLoop: -1 play: setVol: 127)
		(self
			addObstacle:
				((Polygon new:)
		...
		(Load rsMESSAGE 2200)
		(Load rsVIEW 2241 2242 2213 2214 2215 2216)
		(gEgo disableHotspot:)
		(extraSnd init:)
...
(instance grandFinale of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gKqSound1 number: 2264 setLoop: 1 play:)
			...
			(6
				(gEgo view: 2242 setLoop: 0 cel: 0 setCycle: Fwd)
				(king posn: 209 117 setLoop: 2 setCel: 0 setCycle: Fwd)
				(gKqSound1 number: 2265 setLoop: 1 play:)
				(= ticks 340)
			)
			(7
			...
			(9
				(king posn: 210 114 view: 2215 setLoop: 5 setCel: 0)
				(gKqSound1 number: 2268 setLoop: 1 play:)
				(= ticks 30)
			)
			(10
				(UnLoad 140 2265)
				(gKqSound1 number: 2267 setLoop: 1 play:)
				(king setCycle: End)
				(val posn: 216 133 setLoop: 2 setCel: 0 setCycle: CT 5 1 self)
				(edger
					view: 2215
					loop: 1
					cel: 0
			...
			(13
				(gEgo posn: 101 121 setLoop: 4 setCel: 0 setCycle: End self)
			)
			(14
				(UnLoad 140 2267)
				(gEgo
			...
			(20
				(edger posn: 124 118 setLoop: 2 setCel: 0 setCycle: CT 2 1 self)
			)
			(21
				(gEgo hide:)
				(edger cel: 3 setCycle: End self)
			...
			(23
				...
				(gKqSound1 stop: number: 816 setLoop: 1 play: setVol: 127)
				(gKqMusic1 number: 941 setLoop: -1 play: setVol: 127)
			)
			(24
				(malicia posn: 230 133 view: 2218 setLoop: 0 setCel: 0)
				(UpdateScreenItem malicia)
				(edger posn: 128 117 setLoop: 4 setCel: 0 setCycle: End self)
			)
			(25
			...
			(31
				(malicia posn: 248 128 setLoop: 2 setCel: 0)
				(Load rsVIEW 2219)
				(Load 140 845 2271 2269 22690) ; WAVE
				(Load rsSOUND 2270)
				(= ticks 60)
			)
			(32
				(malicia posn: 251 130 setLoop: 3 setCel: 0 setCycle: End self)
			)
			(33
				(edger
					posn: 138 134
			...
			(34
				(gKqSound1 number: 2269 setLoop: 1 play:)
			...
			(37
				...
				(gKqSound1 number: 2271 setLoop: 1 play:)
				(UnLoad 140 845)
			)
			(38
				(edger setCycle: End)
			...
			(40
				...
				(gKqSound1 stop:)
				(malicia hide:)
				(blast cel: 7 setCycle: End self)
				(UpdateScreenItem blast)
				(UnLoad 140 2271)
			)
			(41
				(blast dispose:)
				(malicia show: posn: 233 132 setLoop: 4 setCel: 0)
				(= ticks 20)
			)
			(42
			...
			(45
				(edger posn: 103 132 setLoop: 6 setCel: 0 setCycle: CT 4 1 self)
			)
			(46
				(gEgo hide:)
				(edger cel: 5 setCycle: End self)
				(UpdateScreenItem edger)
			)
			(47
				(malicia
			...
			(50
				...
				(malicia posn: 246 131 setLoop: 2 setCel: 0 setCycle: End)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gKqSound1 number: 2272 setLoop: 1 play:)
			)
			(1
				(client
					view: 2221
			...
			(3
				(gKqSound1 number: 22720 setLoop: -1 play:)
				(client
					view: 2203
					posn: 174 128
					setLoop: 1
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(gKqSound1 number: 2281 setLoop: 1 play: setVol: 127)
			)
			(6
				(edger
					view: 2228
			...
			(13
				(oberon init: cel: 0 setCycle: End)
				(edger
					view: 2230
					loop: 0
					cel: 0
			...
			(14
				(titania view: 2230 loop: 1 cel: 0 posn: 141 131 setCycle: End)
			...
			(15
				(gEgo posn: 102 115 normalize: 4 2241)
				(edger loop: 2 cel: 0 posn: 140 126 setCycle: CT 4 1 self)
			)
			(16
				(= cycles 6)
			)
			...
			(18
				(edger loop: 3 cel: 0 posn: 138 128 setCycle: End self)
			)
			(19
				(oberon loop: 3 cel: 0 posn: 228 134 setCycle: End self)
			)
			(20
				(edger
					view: 22305
				...
				(titania loop: 4 cel: 0 posn: 138 128 show: setCycle: End)
			)
			(21
				(= cycles 6)
			)
			...
			(24
				...
				(valTalker view: (val view:) loop: 28)
			...
			(28
				(king setCycle: 0 posn: 210 114 view: 2215 setLoop: 5)
			...
			(35
				...
				(gKqSound1 number: 2284 setLoop: 1 play: self)
			)
			(36)
			(37
			...
			(38
				(gKqSound1 number: 2277 setLoop: 1 play:)
				(edger
					view: 2231
					loop: 0
					cel: 0
				...
				(oberon view: 2230 loop: 5 cel: 11 posn: 167 118 show:)
			)
			(39
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(gKqSound1 number: 2280 setLoop: 1 play:)
			)
			(2
			...
			(3
				...
				(king posn: 210 114 view: 2215 setLoop: 5)
			...
			(5
				(edger hide:)
				(titania cel: 51 setCycle: End self)
				(UpdateScreenItem titania)
			)
			(6
				(gKqSound1 number: 2286 setLoop: 1 play: setVol: 127)
				(titsMouth
					init:
			...
			(7
				(oberon loop: 2 cel: 0 posn: 191 128 setCycle: End self)
			)
			(8
				(oberon loop: 3 cel: 0 posn: 141 130 setCycle: End self)
			)
			(9
				(= ticks 90)
			)
			(10
				(oberon loop: 6 cel: 0 posn: 127 128 setCycle: CT 2 1 self)
			)
			(11
				(titsMouth setCycle: 0 hide: dispose:)
				(oberon cel: 3 setCycle: End)
				(gKqSound1 stop:)
				(titania loop: 5 cel: 0 posn: 148 126 setCycle: CT 4 1 self)
			)
			(12
			...
			(13
				(titania loop: 7 cel: 0 posn: 158 120 setCycle: End self)
				(oberon loop: 8 cel: 0 posn: 157 148 setCycle: End)
			)
			(14
				(oberon
					view: 22305
			...
			(25
				...
				(gKqSound1 number: 2287 setLoop: 1 play:)
			)
			(26
...
(instance titsSobs of Script ; UNUSED
	(properties)
...
(instance unplugDevice of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gEgo normalize: 7 2241 setHeading: 90 self)
			)
			(3
				(gGame handsOn:)
				(self dispose:)
...
(instance fizzleOut of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gKqSound1 number: 2274 setLoop: 1 play: setVol: 127)
				(fizzle init: cel: 0 setCycle: End self)
			)
			(1
				(fizzle hide: dispose:)
				(= cycles 2)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gKqSound1 stop: number: 2275 setLoop: 1 play:)
			)
			(1
				(deviceBlast hide:)
				(malicia
			...
			(2
				(malicia loop: 1 cel: 0 x: 152 y: 145 setCycle: End self)
			)
			(3
			...
			(5
				(gEgo normalize: 4 2241 setScale: scaleX: 115 scaleY: 115)
				(= cycles 2)
			)
			(6
				(Load 140 4006 2277 4463 2278 2513 935) ; WAVE
				(gKqSound1 number: 935 setLoop: -1 play: setVol: 127)
				(cuddles init: cel: 0 setPri: 122 setCycle: End self)
			)
			(7
				(cuddles loop: 1 cel: 0 posn: 146 150 setCycle: End self)
			)
			(8
				(gKqSound1 number: 4006 setLoop: 1 play: self)
			)
			(9
				(extraSnd number: 2277 setLoop: 1 play: self)
				(cuddles loop: 2 cel: 0 posn: 157 148 setCycle: End)
			)
			(10
				(cuddles loop: 3 cel: 0 posn: 159 149 setCycle: Fwd)
				(gKqSound1 number: 4463 setLoop: 1 play: self)
			)
			(11
				(malicia hide:)
				(cuddles
				...
				(gKqSound1 number: 22770 setLoop: 1 play: setVol: 127)
			)
			(12
				(= cycles 6)
			)
			(13
				(cuddles cel: 15 setCycle: End self)
				(malicia show:)
			)
			(14
				(gGame handsOn:)
				...
				(gKqSound1 number: 2513 setLoop: -1 play: setVol: 127)
				(= seconds 8)
			)
			(15
				(gGame handsOff:)
				...
				(gKqSound1 stop: number: 2278 play:)
			)
			(16
				(cuddles hide:)
				(gKqSound1 stop:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(gKqSound1 number: 2275 setLoop: 1 play:)
			)
			(2
				...
				(gKqSound1 number: 825 setLoop: 1 play:)
			)
			(3
				(deviceBlast hide: dispose:)
				(gKqSound1 number: 954 setLoop: 1 play: self)
			)
			(4
				(gKqSound1 number: 2277 setLoop: 1 play: self)
			)
			(5
				(cuddles
					view: 2225
				...
				(gKqSound1 number: 948 setLoop: -1 play:)
			)
			(6
...
(instance malKills of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(malicia view: 2203 posn: 209 128 setLoop: 1 setCycle: End self)
				(gKqSound1 number: 843 setLoop: 1 play: setVol: 127)
			)
			(2
				(malicia hide:)
				(gEgo
			...
			(3
				...
				(malicia view: 2218 setLoop: 1 setCel: 0 posn: 225 140 show:)
			)
			(4
				((ScriptID 13 0) hide_mouth: 0) ; aEgoTalker
				(EgoDead 43 self)
			...
			(5
				(if
					(and
						(or (IsFlag 257) (IsFlag 182))
						(not (gEgo has: 60)) ; Fragrant_Flower
					)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(gKqMusic1 stop: number: 2207 setLoop: 1 play: setVol: 127)
			)
			(3
				(Load 140 922) ; WAVE
				(king setCycle: CT 8 -1 self)
				(extraSnd stop: number: 947 play:)
			)
			(4
...
(instance kingApplauds of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Load rsVIEW 2216)
				(gKqSound1 number: 22810 setLoop: 1 play: setVol: 127)
				(king
					posn: 187 116
					view: 2216
					setLoop: 3
