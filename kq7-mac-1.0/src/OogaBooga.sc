	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(theTroll view: 41114 init: hide:)
				(thePoof view: 4503 init: hide:)
				(theGargoyle view: 4132 init: hide:)
				(if (gEgo scaler:)
			...
			(2
				...
				(= local1 (gEgo y:))
				(gEgo
					view: (if (IsFlag 151) 41115 else 41114)
					setLoop: 5 1
					setCel: 0
			...
			(7
				...
				(gEgo
					view: (if (IsFlag 151) 41325 else 4132)
					setLoop: 1 1
					cel: 0
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(firecrackerTimer setCycle: firecrackerTimer 6000)
				(self dispose:)
			)
		)
	)
