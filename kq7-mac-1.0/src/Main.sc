...
(class KQ7CD of Game
	...
	(method (play &tmp temp0 temp1 temp2 temp3)
		(Platform 0 0 997 999 989 990 991 992 21000 14610)
		(= gGame self)
		(= gCurSaveDir (Str new:))
		(= gSysLogPath (Str new:))
	...
	(method (init &tmp [temp0 12] temp12)
		(ScriptID 64982)
		DText
		DButton
		Print
	...
	(method (smallSave &tmp [temp0 4] temp4 [temp5 2])
		(= temp4 (Platform 0 4))
	)
	...
	(method (replay &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10)
		(FrameOut)
		(for
