...
(class SelectGameRoom of Room
	...
	(method (init &tmp [temp0 8] temp8 [temp9 7])
		(super init: &rest)
		...
		(gThePlane dispose:)
		(= gThePlane temp8)
		(gInventory eachElementDo: #hide global108)
	...
	(method (readSaveDir &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6)
		(= temp2 (Str newWith: 40 {}))
		...
		(if (FileIO fiEXISTS (local19 data:))
			...
			(while (!= (temp2 at: 0) -1)
				...
				([local5 (- local15 1)] fileName: temp6)
				(temp0 read: temp2 2)
			)
...
(instance iconPlay of SelectScaryIcon
	...
	(method (doVerb &tmp [temp0 3] temp3 temp4)
		(= temp3 0)
		...
		(if (self onMe: temp4)
			...
			(if enabled
				(gGame smallRestore: ([local5 local17] fileNumber:))
			)
		)
	)
)
...
(instance iconCancel of SelectScaryIcon ; UNUSED
	(properties
		x 214
		y 139
		view 980
