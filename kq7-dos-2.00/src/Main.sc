...
(class OptionSelectView of View
	(properties
		view 9850
		loop 1
		optionShowX 0
...
(class KQ7CD of Game
	...
	(method (showOptions param1 &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9)
		(= global400 -1)
		(gNormalCursor view: 999 loop: 0 cel: 0 init:)
		(= temp8 (Set new:))
		(= temp0 gCast)
		(= temp3 gThePlane)
		(= gThePlane (Plane new:))
		(gThePlane
			setRect: 53 5 271 126
			back: 0
			picture: -2
			priority: 3000
			init:
		...
		((View new:) view: 9850 loop: 0 cel: 0 x: 0 y: 0 init: setPri: 200)
		(for ((= temp1 1)) (< temp1 6) ((++ temp1))
			(= temp5 (OptionSelectView new:))
			(switch temp1
				(1
					(temp5 x: 77 y: 38 optionShowX: 24)
				)
				(2
					(temp5 x: 77 y: 52 optionShowX: 24)
				)
				(3
					(temp5 x: 76 y: 67 optionShowX: 23)
				)
				(4
					(temp5 x: 77 y: 82 optionShowX: 24)
				)
				(5
					(temp5 x: 139 y: 98 optionShowX: 86)
				)
			)
			(temp5 loop: temp1 cel: 0 setPri: 201 init: z: 1000)
			(temp8 add: temp5)
		)
		(= temp4 0)
		...
		(theNormalCursor view: 999 loop: 0 cel: 0 setCycle: 0)
