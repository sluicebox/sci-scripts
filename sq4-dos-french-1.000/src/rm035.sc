...
(instance theRubble2 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(3 ; Do
				(Print 35 1) ; "The rubble is rough and jagged. Your hide wasn't designed to traverse this kind of terrain."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance theStreet of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 35 2) ; "It tastes like you've just scraped your tongue to shreds on the pavement."
			)
			(11 ; Smell
				(Print 35 3) ; "The rich aroma of hovercar exhaust fills your sinuses."
			)
			(4 ; Inventory
...
(instance sidewalk1 of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 35 4) ; "It looks like a surface suited for foot travel."
			)
			(10 ; Taste
				(Print 35 5) ; "It tastes like all the other sidewalks you've ever tasted."
			)
			(11 ; Smell
				(Print 35 6) ; "It smells mostly of dust and dirt."
			)
			(4 ; Inventory
				((ScriptID 705 4) doVerb: theVerb invItem) ; theRoom
			)
