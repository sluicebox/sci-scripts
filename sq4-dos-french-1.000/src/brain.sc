...
(procedure (localproc_1 &tmp temp0)
	(switch (= temp0 (brain formatting:))
		...
		(3000
			(StrCpy @local112 (LangSwitch {VERY GOOD} {TRES BIEN}))
		)
		(2000
			(StrCpy @local112 (LangSwitch {GOOD} {BIEN}))
		)
		(1500
			(StrCpy @local112 (LangSwitch {FAIR} {ASSEZ BIEN}))
		)
		(1000
		...
		(500
			(StrCpy @local112 (LangSwitch {CRITICAL} {TRES DANGEREUX}))
			(= local11 global143)
		)
	)
	...
	(if (and temp0 (!= gCurRoomNum 544) (!= (gCurRoom curPic:) 699))
		...
		(proc0_12 local10)
		(= local10
			(proc0_12 (Format @local12 704 0 temp0) 67 130 180 70 25 28 local11) ; "%d"
		)
	)
)
