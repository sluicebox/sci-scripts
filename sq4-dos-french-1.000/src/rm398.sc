			...
			(1
				(switch local5
					(1
						(= local6
							(Display
								{From the folks who brought\nyou Astro Chicken! When it comes to stimulating chickens, Cluck Egger is the expert...and now YOU can learn from him! Design the chicken of your choice (over 40 options, including lips/no lips and laying frequency) and take your creation for a wild ride over real barnyard scenery. Based on an authentic flight model of a chicken. You're in for a peck of fun now!}
								dsWIDTH
								160
								dsCOORD
								160
					...
					(4
						...
						(= local7
							(Display
								{unless you have this hint book. Want to know how to get the dog into the hanging basket? Want to find out how to attach the melon? Buy this hintbook and it all becomes obvious. You'll hit your head and say, "Boy, how stupid could I have been? A moron could've figured this out. I must be a real dimwit, a pathetic nimnal, a wretched, idiotic excuse}
								dsWIDTH
								170
								dsCOORD
								150
						...
						(= local8
							(Display
								{for a human being not to have figured out these simple puzzles in the first place."\nTry it and see!}
								dsWIDTH
								170
								dsCOORD
								150
