...
(instance timeToTimeWarpS of Script
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(7
				(gCurRoom drawPic: 531 overlay: 529)
				(= cycles 1)
			)
			(8
				(= temp1 529)
...
(instance exitButn of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(10 ; Taste
				(Print 531 13) ; "Licking switches is never a good idea unless you are into the kind of buzz that causes you to loose all control of your muscle system. This could results in the loss of control of all bodily functions."
			)
			(else
				(super doVerb: theVerb)
			)
