...
(instance roboVerbTalkStuff of rmnScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(self save1: (proc0_12 381 14 67 0 20 30 1 70 319))
				(= seconds 10)
			)
			(6
			...
			(9
				(self save1: (proc0_12 381 15 67 0 20 30 1 70 319))
				(= seconds 10)
			)
			(11
				(self
			...
			(13
				(self save1: (proc0_12 381 17 67 0 20 30 1 70 319 67 0 10))
				(= seconds 10)
			)
			(15
				(self
...
(instance shelves of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; Smell
				(Print 381 42) ; "You gather in the various fragrances offered by the menage of useless items stored here. You learn only that you don't want to do it again."
			)
			(10 ; Taste
				(Print 381 43) ; "Want more fiber in your diet?"
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance CashRegister of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 381 44) ; "It's a Beancounter 200 revenue collection device."
			)
			(4 ; Inventory
				(if (not (rmnProp script:))
					(rmnProp setScript: roboVerbUseStuff 0 invItem)
			...
			(3 ; Do
				(Print 381 45) ; "You start to mess with the register but quickly cease when you notice a sign which reads "Warning! Unauthorized users will be killed on sight!" These Beancounter folks take your money seriously."
			)
			(11 ; Smell
				(Print 381 46) ; "The heady scent of currency emanates from the revenue collection device."
			)
			(10 ; Taste
				(Print 381 47) ; "The dull taste of cold metal leaves you wanting for more."
			)
			(else
				(super doVerb: theVerb)
			)
...
(instance light1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 381 48) ; "Small fixtures emit rays of visible light greatly aiding the sighted shopper."
			)
			(else
				(super doVerb: theVerb)
			)
