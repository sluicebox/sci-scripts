...
(instance bush2 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 385 19) ; "This is a fine example of the wonders of fabricated flora."
			)
			(11 ; Smell
				(Print 385 16) ; "It smells a little like Julanar, the enchanted plant woman from QUEST FOR GLORY II."
			)
			...
			(3 ; Do
				(Print 385 20) ; "Hey! They had to be bolted to the super-structure because of people like you."
			)
			(else
				(super doVerb: theVerb &rest)
			)
