...
(instance light1 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(11 ; Smell
				(Print 375 5) ; "It smells like the kind of place where unwashed teen-agers stand around smoking, sweating and performing other unmentionable teen-age acts."
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance light2 of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 375 6) ; "These lights are hypnotic. Maybe they're some of those "subliminal optic stimulators" you've read about. As you gaze into their glare, you become very hungry for sushi."
			)
			(11 ; Smell
				(Print 375 5) ; "It smells like the kind of place where unwashed teen-agers stand around smoking, sweating and performing other unmentionable teen-age acts."
			)
...
(instance store of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 375 7) ; "Ah! An arcade!. It's "Buckazoid Bill's Arcade and Sushi Bar.""
			)
			(11 ; Smell
				(Print 375 5) ; "It smells like the kind of place where unwashed teen-agers stand around smoking, sweating and performing other unmentionable teen-age acts."
			)
...
(instance bush1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 375 8) ; "This is a fine example of the wonders of fabricated flora."
			)
			(11 ; Smell
				(Print 375 9) ; "There's a fresh woodsy scent coming from the plants."
			)
			(10 ; Taste
				(Print 375 10) ; "Urp...somebody's dumped their potpourri on these plants."
			)
			(3 ; Do
				(Print 375 11) ; "Get some taste! These are phoney mall plants!"
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance bush2 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Print 375 12) ; "This is a fine example of the wonders of fabricated flora."
			)
			(11 ; Smell
				(Print 375 9) ; "There's a fresh woodsy scent coming from the plants."
			)
			(10 ; Taste
				(Print 375 13) ; "Urp...somebody's dumped their potpourri on these plants."
			)
			(3 ; Do
				(Print 375 11) ; "Get some taste! These are phoney mall plants!"
			)
