...
(class DocReader of DText
	...
	(method (init &tmp temp0 temp1 temp2 temp3)
		...
		(docPlane
			...
			init: 285 62 600 (+ local3 62) 285 62 600 (- (+ 62 local4) 6)
			addCast: docCast
		)
		(self
			x: 0
...
(class VidmailChoices of DSelector
	...
	(method (init param1 param2 param3)
		...
		(= lastCurrent -1)
		(self leading: 3 width: 180 setSize: 1 length: 5 move: 0 42)
...
(class ChoiceManager of Obj
	...
	(method (init param1)
		...
		(choicesPlane
			...
			init: 5 40 209 300
			posn: 5 40 ((ScriptID 44 0) plane:) ; thighComputer
		)
