...
(instance HumanPlazaRegion of RamaRegion
	(properties)
	...
	(method (setKeep)
		(= keep (or (<= 5202 gNewRoomNum 5215) (<= 5401 gNewRoomNum 5419))) ; humanPlazaRm2, NY_Human_Plaza_15, NY_Subway_1, puzzleIconCU
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= start state)
				(SoundManager
					playMusic: self 1 (if (IsFlag 230) 5010 else 8001)
				)
