	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(gEgo stopUpd:)
				((ScriptID 23) posn: 330 125 init: setCycle: StopWalk 155) ; Tuck
				(if (>= gHowFast 2)
					((ScriptID 23) setMotion: MoveTo 240 125) ; Tuck
					(= cycles 1)
				else
					((ScriptID 23) setMotion: MoveTo 240 125 self) ; Tuck
				)
			)
			(1
				((ScriptID 19) posn: -10 75 init: setCycle: StopWalk 152) ; John
				(if (>= gHowFast 2)
					((ScriptID 19) setMotion: MoveTo 95 70) ; John
					(= cycles 1)
				else
					((ScriptID 23) stopUpd:) ; Tuck
					((ScriptID 19) setMotion: MoveTo 95 70 self) ; John
				)
			)
			(2
				(if (< gHowFast 2)
