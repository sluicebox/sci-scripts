	...
	(method (init)
		...
		(if (or (== gPrevRoomNum 562) (== gPrevRoomNum 460)) ; tunnel3
			...
			(if (and (!= gDay 10) (or (IsFlag 125) (IsFlag 56)))
				(sonHal setLoop: 4 posn: 18 175 init: stopUpd:)
				(sonHob setLoop: 2 posn: 77 167 init: stopUpd:)
				(sonDicken setLoop: 0 posn: 130 155 init: stopUpd:)
			)
			(switch gPrevRoomNum
				(562 ; tunnel3
			...
			(SetFlag 106)
			(if (and (!= gDay 10) (or (IsFlag 125) (IsFlag 56)))
				(sonHal loop: 3 cel: 4 posn: 159 178 init: stopUpd:)
				(sonHob loop: 1 posn: 190 179 init: stopUpd:)
				(sonDicken loop: 1 posn: 223 185 init: stopUpd:)
			)
			(switch gPrevRoomNum
				(570
...
(instance comeWithSonsFrom560 of Script ; UNUSED
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(sonHal loop: 3 posn: 293 189 init: stopUpd:)
				(sonHob loop: 3 posn: 267 189 init: stopUpd:)
				(sonDicken loop: 3 posn: 241 188 init: stopUpd:)
			)
			(1
			...
			(2
				(gEgo stopUpd:)
				(sonHal setMotion: PolyPath 211 188 self)
			)
			(3
				(sonHal stopUpd:)
				(sonHob setMotion: PolyPath 179 179 self)
			)
			(4
				(sonHob stopUpd:)
				(sonDicken setMotion: PolyPath 156 176 self)
			)
			(5
				(gEgo setHeading: 180 self)
