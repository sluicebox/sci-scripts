...
(instance initGame of Code
	...
	(method (doit param1 param2 param3 &tmp temp0 temp1 [temp2 20] temp22)
		(= global102 1)
		(param1 color: global187 back: global186)
		...
		(param2
			back: global187
			topBordColor: (if temp22 global184 else global180)
			lftBordColor: (if temp22 global187 else global182)
			rgtBordColor: (if temp22 global188 else global172)
			botBordColor: global189
		)
		(param3
			back: global190
			topBordColor: (if temp22 global184 else global185)
			lftBordColor:
				(switch global202
					(256 global187)
					(64 28)
			...
			rgtBordColor: (if temp22 global188 else global177)
			botBordColor: (if temp22 global189 else global177)
