...
(instance begScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(beg setLoop: 2 cel: 5 ignoreActors: 1 stopUpd:)
				(gCurRoom
					addObstacle:
						((Polygon new:)
							type: PBarredAccess
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			...
			(15
				...
				((ScriptID 19) loop: 1 posn: 229 71 forceUpd:) ; John
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(16
				...
				(beg view: 130 posn: 158 81 setLoop: 1 forceUpd:)
				(= gDisguiseNum 1) ; beggar
				(gInventory eachElementDo: #perform (ScriptID 125 3)) ; putStuff
				(gEgo loop: 1 posn: 191 79 forceUpd:)
				(NormalEgo)
				(gCast eachElementDo: #hide)
				(gCurRoom drawPic: 803 -32762)
				(= ticks 60)
			...
			(17
				((ScriptID 20) dispose:) ; Will
				((ScriptID 19) loop: 1 posn: 214 60 stopUpd:) ; John
				((ScriptID 23) loop: 0 posn: 138 76 stopUpd:) ; Tuck
				(gCurRoom drawPic: 120 -32761)
				(gCast eachElementDo: #show)
				(proc121_0)
				(= ticks 12)
