	...
	(method (doit &tmp [temp0 2] temp2)
		(if
			(and
				...
				(or
					(and (< temp2 80) (or (== gEgoEdgeHit 1) (== gEgoEdgeHit 3)))
					(and (< temp2 60) (or (== gEgoEdgeHit 2) (== gEgoEdgeHit 4)))
				)
				(not (OneOf (gEgo view:) 792 132 218))
			)
			(= local27 1)
			(switch gDisguiseNum
				(0 ; outlaw
