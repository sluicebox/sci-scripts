...
(instance resc of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(gEgo stopUpd:)
				(hal setMotion: PPath @local95 self)
			)
			(9
				(hal stopUpd:)
				(hob setMotion: PPath @local95 self)
			)
			(10
				(hob stopUpd:)
				(dick setMotion: PPath @local95 self)
			)
			(11
			...
			(16
				(hal setMotion: MoveTo 193 138 self)
			)
			(17
				(hal stopUpd:)
				(hob setMotion: MoveTo 193 138 self)
			)
			(18
				(hob stopUpd:)
				(dick setMotion: MoveTo 193 138 self)
			)
			(19
				(dick stopUpd:)
