...
(instance rm670 of Rm
	...
	(method (init &tmp temp0 temp1)
		...
		(switch temp0
			...
			(1
				(gEgo posn: 95 230 init: stopUpd:)
				((ScriptID 625 2) loop: 1 cel: 3 posn: 206 169 init: stopUpd:) ; prior
...
(instance meetTheMonk of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(gEgo stopUpd:)
				((ScriptID 625 1) setCycle: Walk setMotion: MoveTo 126 180 self) ; chip
			)
			(4
				((ScriptID 625 1) stopUpd:) ; chip
...
(instance freeFulk of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				((ScriptID 15) setPri: -1 forceUpd:) ; fulk
				(pulleySound stop:)
				(ropeSound stop:)
				(NormalEgo)
