...
(local
	...
	local23
	[local24 520]
	[local544 4] = [1621 0 1 0]
	[local548 8] = [1621 1 1 0 1621 3 1 0]
	[local556 4] = [1621 4 1 0]
	[local560 4] = [1621 5 1 0]
	local564
)
		...
		(repeat
			...
			(if (& (temp0 type:) evMOUSEKEYBOARD)
				(if
					...
					(if gFastCast
						(gFastCast eachElementDo: #handleEvent temp0)
					)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(switch local13
					(0
						(= local17 (GetFarText 1621 6 @local24)) ; "I will seek out the devil where he lies and I will cross many seas to do so. Then I shall blast him with fire from heaven."
					)
					(1
						(= local17 (GetFarText 1621 7 @local24)) ; "Demons dance to my call. I am a thief none can catch. No sharp blade worries me. What do I have?"
					)
					(2
						(= local17 (GetFarText 1621 8 @local24)) ; "I would comfort a friend who is ill and fears that death will come upon him without warning. But if death should come, let my gifts guide him beyond demon's reach and to new life. What should I give him?"
					)
					(3
						(= local17 (GetFarText 1621 9 @local24)) ; "I have a fever which has driven me to madness. My teeth loosen and I taste blood in my mouth."
					)
					(4
						(= local17 (GetFarText 1621 10 @local24)) ; "I am old and my hearing fails me, I am ill and wonder when death will come for me, my mouth is dry. What would you give me?"
					)
					(5
						(= local17 (GetFarText 1621 11 @local24)) ; "I must go into battle where I may well be wounded. Then I will know great thirst and my eyes will burn."
					)
					(6
						(= local17 (GetFarText 1621 12 @local24)) ; "Sadness weighs upon my soul. My heart aches to be filled. Would that I could steal into my love's chamber unseen."
					)
					(7
						(= local17 (GetFarText 1621 13 @local24)) ; "I have three fears: I fear travelling by ship; I fear my wife will be unfaithful: I fear the lies of men. What should I take with me?"
					)
					(8
						(= local17 (GetFarText 1621 14 @local24)) ; "I'll build a ship to carry me skyward. If it falls, I'll not be harmed. But I will never tell how it is done. What do I have?"
					)
					(9
						(= local17 (GetFarText 1621 15 @local24)) ; "A piece of sky fell to my feet and I picked it up. Where it touched me, it raised boils. I fear it poisons me. What would you give me?"
					)
					(10
						(= local17 (GetFarText 1621 16 @local24)) ; "My trees are heavy with fruit, my heart is full of all desires, and my wife gives birth to a holy child. What do I have?"
					)
					(11
						(= local17 (GetFarText 1621 17 @local24)) ; "The drought lengthens, the corn withers in my field, and a witch curses me with a glance. What would you give me?"
					)
					(12
						(= local17 (GetFarText 1621 18 @local24)) ; "I must ride upon a fiery horse, through valleys filled with adders and seek the fate that awaits me. What should I take with me?"
					)
					(13
						(= local17 (GetFarText 1621 19 @local24)) ; "In summer, my ice does not melt. The red eye becomes clear. Demons run when I raise my hand. What do I have?"
					)
					(14
						(= local17 (GetFarText 1621 20 @local24)) ; "Alas, sadness clothes me like a leaden cloak. A wicked woman lies to me, but I fear danger will come upon me by surprise. What would you give me?"
					)
					(15
						(= local17 (GetFarText 1621 21 @local24)) ; "I lie dying, cut deeply by the sword, my flesh burns, spirits of Hades hover to take my soul. What would you give me?"
					)
				)
				(= cycles 2)
			)
			...
			(0
				(switch local14
					(1
						...
						(Converse 1 @local556 11 2) ; "Your first choice is correct, Brother. Choose you now two more."
					)
					(2
						(Converse 1 @local560 11 2) ; "Aye, the second stone is correct. Choose your last stone for this riddle."
					)
					(3
