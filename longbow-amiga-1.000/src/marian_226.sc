...
(instance marianAttack of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(marian stopUpd:)
				(monk view: 16 loop: 0 forceUpd:)
				(= ticks 12)
			)
			(9
				(mariansSong dispose:)
				(monk loop: 2 forceUpd:)
				(= ticks 24)
			)
			(10
				(if gModelessDialog
			...
			(11
				(gEgo actions: marianHornBlow stopUpd:)
				(if (== gEgoEdgeHit 2)
...
(instance skewerMonk of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(monk
					setLoop: (if (== gEgoEdgeHit 2) 3 else 2)
					setCel: 0
					forceUpd:
				)
...
(instance suicide of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(monk view: 585 setLoop: 0 setCel: 0 setCycle: End self)
			)
			(4
				(monk stopUpd:)
				(= ticks 25)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				...
				(if (== gEgoEdgeHit 2)
					((ScriptID 20) y: (- ((ScriptID 20) y:) 1) forceUpd:) ; Will, Will
