...
(instance dayOne of TScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(if (< gHowFast 1)
					((ScriptID 23) setCycle: 0 stopUpd:) ; Tuck
					((ScriptID 21) setCycle: 0 stopUpd:) ; Alan
				)
				(gEgo stopUpd:)
		...
		(switch (= state newState)
			...
			(9
				...
				(if (< gHowFast 2)
					((ScriptID 19) ; John
						setCycle: Walk
						setMotion: PolyPath 232 115 self
					)
				else
					(= cycles 1)
				)
			...
			(21
				((ScriptID 19) setMotion: PolyPath 320 70 self) ; John
				((ScriptID 20) setMotion: PolyPath -15 131 self) ; Will
			)
			(22 0)
			(23
				((ScriptID 19) stopUpd:) ; John
				...
				((ScriptID 21) ; Alan
					...
					setMotion: PolyPath -15 188 self
				)
			)
			(24
				((ScriptID 21) stopUpd:) ; Alan
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(= ticks 30)
				(gEgo get: 5 get: 6 put: 5 140 put: 6 140) ; pipe, gems, pipe, gems
			)
			(1
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gEgo stopUpd:)
				(Face (ScriptID 21) gEgo) ; Alan
				(Face (ScriptID 23) gEgo self) ; Tuck
			)
			(3
				((ScriptID 23) stopUpd:) ; Tuck
				((ScriptID 21) stopUpd:) ; Alan
