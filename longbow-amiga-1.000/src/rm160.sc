...
(procedure (localproc_1)
	(log init: addToPic:)
	(gEgo view: 147 loop: 8 x: 250 y: 154 init: stopUpd:)
	(tuckView view: 155 loop: 3 x: 204 y: 185 init: stopUpd:)
	(willView view: 161 loop: 0 x: 162 y: 174 init: stopUpd:)
	(alanView view: 147 loop: 4 x: 234 y: 152 init: stopUpd:)
	(johnView view: 143 loop: 4 x: 177 y: 147 init: stopUpd:)
	(muchView view: 147 loop: 5 cel: 1 x: 144 y: 153 init: stopUpd:)
...
(procedure (localproc_2)
	(log init: addToPic:)
	(gEgo view: 143 loop: 5 x: 169 y: 151 init: stopUpd:)
	(tuckView view: 155 loop: 3 x: 202 y: 180 init: stopUpd:)
	(willView view: 161 loop: 1 x: 259 y: 172 init: stopUpd:)
	(alanView view: 147 loop: 4 x: 234 y: 152 init: stopUpd:)
	(johnView view: 143 loop: 4 cel: 5 x: 115 y: 155 init: stopUpd:)
	(muchView view: 147 loop: 5 x: 153 y: 185 init: stopUpd:)
	(alanView setCycle: Fwd)
...
(instance rm160 of Rm
	...
	(method (dispose &tmp temp0)
		...
		(gRgnMusic stop:)
		(gSFX fade: 0 30 8 1)
		(gTheIconBar enable: 8 curIcon: (= temp0 (gTheIconBar at: 0)))
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(tuckView view: 143 loop: 0 x: 257 y: 153 init: stopUpd:)
				(johnView view: 143 loop: 4 x: 132 y: 169 init: stopUpd:)
				(willView x: 212 y: 180 init: stopUpd:)
				(alanView
					view: 147
					loop: 4
				...
				(muchView x: 159 y: 188 init: stopUpd:)
				(= cycles 2)
			)
			(2
				(localproc_3)
...
(instance night9 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(localproc_2)
				(gEgo view: 147 loop: 7 x: 251 y: 149 forceUpd:)
				(marian view: 147 loop: 6 cel: 0 x: 233 y: 146 init: stopUpd:)
				(alanView view: 147 loop: 4 x: 81 y: 142 setPri: 15 forceUpd:)
				(willView view: 161 loop: 0 x: 140 y: 149 forceUpd:)
				(= cycles 2)
			)
			(2
				(Converse
...
(instance night10 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(if (IsFlag 62)
					(Converse 4 @local353 1 0 15 1 14 2 13 3 self)
				else
					(Converse 3 @local345 2 0 14 1 13 2 self)
				)
			)
			(3
				(localproc_0)
...
(instance noPass of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Converse 3 @local401 1 0 14 1 13 2 self)
			)
			(1
				(localproc_0)
				(= ticks 90)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(switch register
					(0
						(Converse 5 @local391 1 0 14 1 17 2 13 3 15 1 self)
						(AddOutlaws -1)
						(+= state 2)
					)
					(2
						(Converse 4 @local364 3 0 15 1 14 2 13 3 self)
					)
					(1
						(localproc_3)
						(Converse 5 @local377 1 0 15 1 14 2 13 3 16 3 self)
						(+= state 2)
					)
				)
			)
			(3
				(gEgo cycleSpeed: 10 setCycle: Osc 1 self)
			)
			(4
				(gEgo stopUpd:)
				(Converse @local371 3 0 self)
			)
			(5
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(Converse 4 @local408 1 0 15 3 17 1 13 2 self)
			)
			(3
				(gEgo get: 9) ; message
				(Converse 5 @local415 1 0 15 3 17 1 13 2 14 2 self)
			)
			(4
				(Converse 1 @local423 14 2 self)
			)
			(5
				(localproc_0)
				(= ticks 90)
