...
(instance anim8 of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(2
				(eastman view: 15017 setCel: 0 setLoop: 0 setCycle: End self)
				(uniformDude view: 15017 setCel: 0 setLoop: 1 setCycle: End)
			)
			(3
				(eastman view: 15018 setCel: 0 setLoop: 0 setCycle: End self)
				(uniformDude view: 15018 setCel: 0 setLoop: 1 setCycle: End)
			)
			(4
				(gTheDoits delete: (uniformDude dispose: yourself:))
				(gTheDoits delete: (eastman dispose: yourself:))
