	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(2
				(gGame handsOff:)
				(hector dispose:)
				(allen cel: 187 setCycle: CT 202 1 self)
			)
			(3
				(gFxSound number: 2991 loop: 0 play:)
				(allen cel: 203 setCycle: CT 210 1 self)
			)
			(4
...
(instance allenDanceWithHector of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(allen cel: 0 setCycle: ROsc -1 0 185)
				(hector cel: 0 setCycle: ROsc -1 0 185)
			)
			(1
				(allen setCycle: CT 186 1)
...
(instance enterFromStairs of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(hector setCycle: CT 29 1 self)
			)
			(2
				(gGame handsOn:)
				(hector setPri: -1 setCel: 30 setCycle: ROsc -1 30 198)
				(allen
					view: 32907
					loop: 0
					cel: 30
			...
			(3
				(hector setCycle: CT 199 1 self)
				(allen setCycle: CT 199 1 self)
			)
			(4
				(gGame handsOff:)
				(hector setCycle: CT 200 1 self)
				(allen setCycle: End self)
			)
			(5
				(gFxSound number: 2991 loop: 1 play:)
				(hector setCycle: CT 218 1 self)
			)
			(6
				(gFxSound number: 54 loop: 1 play:)
				(hector setCycle: End self)
...
(instance sFlashBang of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(8
				(gGame handsOff:)
				(allen setCycle: CT 165 1 self)
			)
			(9
				(gFxSound number: 2991 loop: 1 play:)
				(allen setCycle: CT 167 1 self)
			)
			(10
