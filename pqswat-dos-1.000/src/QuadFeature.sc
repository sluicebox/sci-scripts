...
(class QuadFeature of Feature
	...
	(method (onMe param1 &tmp temp0)
		...
		(= whichQuad
			(or
				(and (localproc_0 self 917 Polygon) (_quad1 onMe: param1) 1)
				(and (localproc_0 self 918 Polygon) (_quad2 onMe: param1) 2)
				(and (localproc_0 self 919 Polygon) (_quad3 onMe: param1) 3)
				(and (localproc_0 self 920 Polygon) (_quad4 onMe: param1) 4)
			)
		)
		(if temp0
	...
	(method (setupDetail)
		(if (localproc_0 self 917 Feature)
			(_quad1 init: plane)
		)
	...
	(method (clearDetail)
		(if (localproc_0 self 917 Polygon)
			(_quad1 dispose:)
		)
...
(class GalleryRoom of PQRoom
	...
	(method (showVMD param1 param2 &tmp temp0 temp1)
		...
		(PlayVMD 1 134 76) ; Put
		(PlayVMD 21 30 30 500 320) ; Black
