...
(instance movieTrans of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(denton setCycle: CT 80 -1 self)
			)
			(3
				(denton setCycle: ROsc -1 80 90 -1)
				(carmichael
					view: 33311
					loop: 0
					cel: 0
			...
			(5
				...
				(wixell setCycle: CT 36 -1 self)
			)
			(6
				(wixell setCycle: ROsc -1 36 44 -1)
				(Load rsVIEW 33321)
				(Load rsVIEW 33322)
			)
			(7
			...
			(10
				...
				(global112 startPath: 81 3330)
				(denton view: 33315 loop: 0 cel: 0 posn: 667 116 setPri: 1)
			...
			(12
				...
				(wixell view: 33324 cel: 0 posn: 252 116 setCycle: End self)
			)
			(13
				(wixell
					view: 33325
			...
			(14
				(wixell setPri: 1 posn: 216 108 setCycle: CT 87 1 self)
			)
			(15
				(wixell setCycle: ROsc -1 87 106)
			)
			(16
				(gGame handsOff:)
				(global112 stopPath:)
			...
			(17
				(wixell setCycle: CT 140 -1 self)
			)
			(18
				(wixell setCycle: ROsc -1 140 149)
				(Load rsVIEW 33317)
				(Load rsVIEW 33326)
			)
			(19
				(denton view: 33317 posn: 440 180 cel: 0 setCycle: CT 58 1 self)
			)
			(20
...
(instance wixSlicePit of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(wixell setPri: 350 setCycle: CT 70 1 self)
			)
			(2
...
(instance dentonMoves of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(denton view: 33316 cel: 0 posn: 610 111 setCycle: End self)
			)
			(1
				(denton setCycle: CT 167 -1 self)
			)
			(2
				(denton setCycle: ROsc -1 167 177)
				(self dispose:)
			)
		)
	)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(proc4_5)
				(allen dispose:)
				(wixell view: 33308 loop: 0 cel: 0 posn: 333 264 init:)
				(pacmeyer view: 33308 loop: 1 cel: 0 posn: 404 249 init:)
				(denton
					view: 33308
					loop: 2
					cel: 0
