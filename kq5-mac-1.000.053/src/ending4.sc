	...
	(method (changeState newState &tmp [temp0 60])
		(switch (= state newState)
			...
			(2
				...
				(Display 123 8 dsCOORD 35 80 dsWIDTH 130 dsALIGN alCENTER dsCOLOR local10 dsFONT local8) ; "Ernie Chan Douglas Herring Jeff Crowe William D. Skirvin Maurice F. Morgan Vasken Nokhoudian Barry T. Smith"
				(Display 123 8 dsCOORD 34 79 dsWIDTH 130 dsALIGN alCENTER dsCOLOR local9 dsFONT local8) ; "Ernie Chan Douglas Herring Jeff Crowe William D. Skirvin Maurice F. Morgan Vasken Nokhoudian Barry T. Smith"
			...
			(3
				...
				(Display 123 11 dsCOORD 145 80 dsWIDTH 130 dsALIGN alCENTER dsCOLOR local10 dsFONT local8) ; "Daryle Smith Jerry Jessurun Frances Powell Hector Martinez Richard D. Zeigler-Martin"
				(Display 123 11 dsCOORD 144 79 dsWIDTH 130 dsALIGN alCENTER dsCOLOR local9 dsFONT local8) ; "Daryle Smith Jerry Jessurun Frances Powell Hector Martinez Richard D. Zeigler-Martin"
				(= seconds 8)
			)
			(4
				(localproc_0)
				(Display 123 12 dsCOORD 90 60 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local10 dsFONT local8) ; "Programmed by:"
				(Display 123 12 dsCOORD 89 59 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local9 dsFONT local8) ; "Programmed by:"
			...
			(10
				...
				(= local4
					(Display ; "John Crane Randy Moss John Rettig Steven Coallier Chris Carr"
						123
						28
						dsCOORD
						90
