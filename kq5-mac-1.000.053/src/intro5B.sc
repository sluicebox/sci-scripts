	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(PrintDC 114 0 #at 140 100 #dispose #width 150) ; "Perhaps I can help you. My employer also happens to be a wizard, which is why I recognized Mordack. Unlike Mordack, though, my employer is a very good wizard."
				(= seconds (LangSwitch 10 15))
			)
			(3
				(cls)
				(PrintDC 114 1 #at 140 100 #dispose #width 150) ; "His name is Crispinophur...but we all call him Crispin for short. The only problem is, you see...,"
				(= seconds (LangSwitch 4 4))
			)
			(4
				(= local0 0)
				(intro_eyes hide:)
			...
			(18
				...
				(PrintDC 114 3 #at 140 100 #dispose #width 150) ; "Ahem! Anyway...where was I? Oh yes."
				(= seconds (LangSwitch 4 6))
			)
			(19
				(cls)
				(PrintDC 114 4 #at 140 100 #dispose #width 150) ; "The only problem is that Crispin is getting on in years and tends to be a bit forgetful."
			...
			(21
				(cls)
				(gEgo setCycle: Fwd)
				(PrintDC 114 5 #at 10 10 #dispose) ; "I don't know. This doesn't sound as if it would work."
				(= seconds (LangSwitch 6 9))
			)
			(22
			...
			(23
				...
				(PrintDC 114 6 #at 140 100 #dispose #width 150) ; "Oh, sure it would! Crispin is a very qualified wizard...one of the best. He just gets a little forgetful now and again, that's all."
				(= seconds (LangSwitch 10 15))
			)
			(24
				(intro_mouth setCycle: End self)
			...
			(25
				(PrintDC 114 7 #at 140 100 #dispose #width 150) ; "Now where is it? I know I brought it with me. Aha! Here it is!"
				(intro_eyes hide:)
				(= local0 0)
				(intro_mouth hide:)
				(rWing hide:)
			...
			(29
				(cls)
				(gEgo setCycle: Fwd)
				(PrintDC 114 8 #at 10 10 #dispose) ; "What is that?"
			...
			(31
				...
				(cls)
				(intro_mouth show: setCycle: Fwd cycleSpeed: 2)
				(PrintDC 114 9 #at 140 100 #dispose #width 150) ; "Well! It is my opinion that you don't stand a chance against the likes of Mordack."
				(= seconds (LangSwitch 6 9))
			)
			(32
				(cls)
				(PrintDC 114 10 #at 140 100 #dispose #width 150) ; "Excuse me for saying, Your Majesty...but you don't have a choice. You MUST come with me. I'm sure Crispin can help you!"
			...
			(41
				(gEgo setCycle: Fwd)
				(PrintDC 114 11 #at 129 51 #dispose) ; "What is that stuff?"
			...
			(44
				(PrintDC 114 12 #at 140 10 #width 150 #dispose) ; "Oh, just some old, left-over fairy dust I've been carrying around. It'll help you to fly."
				(= seconds (LangSwitch 6 9))
			)
			(45
				(cls)
				(= global380 1)
				(PrintDC 114 13 #at 170 10 #dispose #width 100) ; "You can follow me to the land of Serenia, where Crispin and I live. It's MUCH too far to walk, you know. I think the fairy dust is still good."
