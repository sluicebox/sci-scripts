...
(instance frigginCheaters of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gMessager say: 3 4 13 1 self) ; "Now, now, now (PATRONIZING)... what have we here? You haven't found the clue to this file's existence, yet somehow you know ... Perhaps subtracting a few hundred points from your score will teach you!"
			)
			(1
				(if (> gScore 200)
					(= local413 200)
