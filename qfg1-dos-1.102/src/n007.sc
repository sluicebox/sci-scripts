...
(procedure (EgoSleeps theHour theMin &tmp sleptHours oldTime)
	(if (not (CanSleep))
		...
		(if
			...
			(EgoDead 7 2 82 800 1 0 80 {Night Gaunt Got ya.}) ; "While you were asleep, something decided to make a meal of you. You're not sure what it was, but you don't really care at this point. You shouldn't go to sleep where the creatures of the night can get you."
		)
	)
	(DisposeScript 7)
)
