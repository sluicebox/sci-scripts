		...
		(switch (= state newState)
			...
			(7
				(if (IsFlag 470)
					...
					(if (== (Platform) 1)
						(ShowMovie {PAN1.SEQ} 7)
						(ShowMovie {SNAKE.SEQ} 7)
						(ShowMovie {PAN2.SEQ} 7)
					else
