	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(xDJ room: 900)
				(if (== (xDJ room:) (gCurRoom curLoc:))
					((ScriptID 900 0) setScript: (ScriptID 900 1)) ; sCeremonialRoom, sGabeDies
					(self dispose:)
				else
					(= seconds local9)
				)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gEgo normalize: 1)
				(if (theDoor unlocked:)
					(gMessager say: 20 123 15 0 self) ; "This door isn't locked."
					(gGame handsOff:)
					(self dispose:)
				else
					...
					(theDoor unlocked: 1)
					(gGkSound1 setLoop: 1 number: 813 play:)
					(if (not local8)
						(= local8 1)
...
(instance sBeatTheShitOutOfGabeR of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(gEgo view: 8121 setCel: 0 setLoop: 0 setCycle: End self)
			)
			(10
				(gEgo
					view: 813
			...
			(11
				(gEgo view: 8131 setCel: 0 setLoop: 0 setCycle: Fwd)
				(= seconds 4)
			)
			(12
				(gEgo
			...
			(13
				(gEgo view: 815 setCel: 0 setLoop: 0 setCycle: End self)
			)
			(14
...
(instance sBeatTheShitOutOfGabeL of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(gEgo view: 8121 setCel: 0 setLoop: 1 setCycle: End self)
			)
			(10
				(gEgo
					view: 813
			...
			(11
				(gEgo view: 8131 setCel: 0 setLoop: 1 setCycle: Fwd)
				(= seconds 4)
			)
			(12
				(gEgo
			...
			(13
				(gEgo view: 815 setCel: 0 setLoop: 1 setCycle: End self)
			)
			(14
