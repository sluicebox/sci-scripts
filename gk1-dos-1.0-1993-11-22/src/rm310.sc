...
(instance rm310 of Room
	...
	(method (init)
		...
		(face init:)
		(snakeM init:)
		(plaque1 init: approachVerbs: 7) ; Look
		(plaque2 init: approachVerbs: 7) ; Look
		(plaque3 init: approachVerbs: 7) ; Look
		(plaque4 init: approachVerbs: 7) ; Look
		(plaque5 init: approachVerbs: 7) ; Look
		(plaque6 init: approachVerbs: 7) ; Look
