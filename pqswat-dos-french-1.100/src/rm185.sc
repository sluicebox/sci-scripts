...
(instance rm185 of PQRoom
	...
	(method (init)
		...
		(myBigUp init:)
		(myBigDown init:)
		(selectUp x: (proc4_16 455 455 430 430 430) init:)
		(selectDown x: (proc4_16 455 455 430 430 430) init:)
		(selectTopic init:)
		(sliderObj init:)
...
(instance ourSelector of DSelector
	...
	(method (init param1)
		(= width (proc4_16 267 267 242 242 242))
	...
	(method (setSize param1 &tmp temp0 temp1 temp2 temp3 temp4)
		...
		(= nsLeft 218)
		(= nsTop 307)
		(= nsRight (proc4_16 447 447 422 422 422))
		(= nsBottom 336)
	)
)
