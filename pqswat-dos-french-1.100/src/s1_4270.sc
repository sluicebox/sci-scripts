...
(instance showTeamEnter of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(6
				(denton setPri: 350 cycleSpeed: (proc4_16 12 12 6 6 12) init:)
				(proc4_5)
				(roomTimer setReal: 1 roomTimer 30)
				(self dispose:)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(denton
					setPri: 350
					cycleSpeed: (proc4_16 12 12 6 6 12)
					init:
					setCycle: CT (proc4_16 16 16 33 33 16) 1 self
				)
				(proc4_5)
			)
			(7
			...
			(8
				(denton setCycle: CT (proc4_16 56 56 113 113 56) 1 self)
			)
			(9
				(denton
					setPri: 5
					setCycle: CT (proc4_16 60 60 120 120 60) 1 self
				)
			)
			(10
