...
(instance comeAboardScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				((gEgo looper:) caller: 0)
				(Print 23 10 #at 25 10) ; ""Request permission to come aboard, sir." you ask the Officer of the Deck."
				...
				(Print 23 13 #at 25 10) ; "After confirming your orders, the Officer of the Deck retains them and says..."
				(gEgo put: 0) ; Envelope
				(= cycles 1)
			)
			(3
			...
			(4
				(Print 23 16 #at 25 10) ; ""The Captain is expecting you, Sir." he continues."
				(= cycles 5)
			)
			(5
