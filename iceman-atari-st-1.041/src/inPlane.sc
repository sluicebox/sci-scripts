...
(instance flyToHawaiiScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Display 44 0 dsRESTOREPIXELS local0)
				(= local0 (Display 44 6 dsALIGN alLEFT dsCOORD 10 10 dsWIDTH 300 dsCOLOR 15 dsSAVEPIXELS)) ; "As the big 747 soars westward at 480 knots, you continue in thought, "It's amazing," you think, "this one cowardly act of kidnapping an Ambassador has brought two superpowers to each other's throats.""
				(= seconds 10)
			)
			(3
				(Display 44 0 dsRESTOREPIXELS local0)
