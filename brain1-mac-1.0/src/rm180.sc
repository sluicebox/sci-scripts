...
(instance elevatorScript of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(proc5_9 180 34) ; "Good going! You're now punched in and ready for work. The back door opens to reveal... an elevator car."
	...
	(method (doVerb theVerb)
		(if (== theVerb 3)
			(if (IsFlag 1)
				...
				(proc5_9 180 35) ; "A special security feature prevents the elevator doors from being opened until you've punched in."
			)
		else
			(super doVerb: theVerb &rest)
		)
