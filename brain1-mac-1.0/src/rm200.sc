	...
	(method (doVerb theVerb &tmp temp0)
		(cond
			...
			((& [local3 local0] local146)
				(cond
					((== local146 64)
						...
						(Wait 0)
						(Wait 45)
						(Print 200 2) ; "You leave the maze through the north exit."
					...
					((== local146 128)
						...
						(Wait 0)
						(Wait 45)
						(Print 200 3) ; "You leave the maze through the south exit."
			...
			((& [local3 local0] local142)
				...
				(Print 200 4 #time 5 #dispose #at -1 12) ; "Try as you might, you just can't crash through the wall."
			)
			(else
				(gCMusic2 number: 922 setLoop: 1 play:)
	...
	(method (doVerb theVerb)
		(cond
			...
			(else
				...
				(Print 200 5 #time 5 #dispose #at -1 12) ; "Try as you might, you just can't bump through the floor."
			)
		)
		(self cel: 1)
	)
	...
	(method (doVerb theVerb)
		(cond
			...
			(else
				...
				(gCMusic2 number: 920 setLoop: 1 play:)
				(ShakeScreen 2 ssUPDOWN)
				(Print 200 6 #time 5 #dispose #at -1 12) ; "Try as you might, you just can't bump through the ceiling."
			)
		)
		(self cel: 1)
	)
