...
(procedure (localproc_3 param1 &tmp temp0 temp1 temp2 temp3 [temp4 3])
	...
	(if (!= local51 2)
		(if local52
			(Display 240 11 dsRESTOREPIXELS [local39 (+ param1 5)])
		)
...
(procedure (localproc_6 &tmp temp0 temp1 temp2 temp3 [temp4 3])
	...
	(for ((= temp0 0)) (<= temp0 4) ((++ temp0))
		(if local52
			(Display 240 11 dsRESTOREPIXELS [local39 temp0])
		)
		(Format @temp4 240 16 [local34 temp0]) ; "%d"
		(= [local39 temp0]
...
(instance rm240 of Rm
	...
	(method (init &tmp temp0)
		...
		(c4 init:)
		(c5 init:)
		(tView posn: -100 -100 hide: init: stopUpd:)
		(= local49 (IsFlag 16))
		(= local50 (IsFlag 17))
		(if local49
			(electricalArc play:)
