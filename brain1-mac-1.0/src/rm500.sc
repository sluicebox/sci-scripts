...
(instance rm500 of Rm
	...
	(method (init)
		...
		(gTheIconBar disable:)
		(Load rsSCRIPT 939)
		(LoadMany rsPIC 500 510 520)
		(LoadMany rsVIEW 481 501 500)
		(LoadMany rsSOUND 100 101 102 103)
		(sparkle1 init: stopUpd:)
		(sparkle2 init: stopUpd:)
		(lightning init: hide: stopUpd:)
		(bridgeZap init: hide: stopUpd:)
		(bridgeZap2 init: hide: stopUpd:)
		(zapCastle init: stopUpd:)
		(zapLeft init: stopUpd:)
		(zapRight init: stopUpd:)
		(electrons init: hide: stopUpd:)
		(drip init: hide: stopUpd:)
		(lightBulb init: hide: stopUpd:)
		(clock init: hide: stopUpd:)
		(eyeBalls init: hide: stopUpd:)
		(poles init: hide: stopUpd:)
		(windupKey init: hide: stopUpd:)
		(telescope init: hide: stopUpd:)
...
(instance opening2 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(bridgeZap show: cycleSpeed: 7 setCycle: End self)
			)
			(6
				(gCurRoom drawPic: 500 9)
				(bridgeZap hide: stopUpd:)
				(bridgeZap2 hide: stopUpd:)
