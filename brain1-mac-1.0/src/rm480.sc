...
(procedure (localproc_1)
	(leftScreen setLoop: 0 setCycle: Fwd)
)

(procedure (localproc_2)
	(rightScreen setLoop: 0 setCycle: Fwd)
)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(24
				...
				(localproc_1)
				(localproc_2)
				(Print 480 9 #at 93 136 #time 4 #dispose self) ; "My Macintosh Composer:"
			)
			(25
				(= local5 (proc5_12 {Aubrey Hodges} 67 242 58 28 28))
				(rightScreen view: 482 setLoop: 0 setCycle: Osc)
				(= ticks 180)
			)
			(26
				(proc5_12 local5)
				(localproc_1)
				(localproc_2)
				(Print 480 10 #at 63 136 #time 4 #dispose self) ; "Digitized sounds constructed by:"
			)
			(27
			...
			(28
				...
				(localproc_1)
				(localproc_2)
				(Print 480 11 #at 63 136 #time 6 #dispose self) ; "And here are some of my artist friends! They have helped me decorate this beautiful castle! The animators:"
			)
			(29
			...
			(38
				(proc5_12 local4)
				(localproc_1)
				(Print 480 12 #at 63 136 #time 5 #dispose self) ; "And here are some MORE of my artist friends! The background artists:"
			)
			(39
			...
			(45
				(localproc_1)
				(localproc_2)
				(Print 480 14 #at 63 136 #time 6 #dispose self) ; "Of course, it wouldn't be wise to build a Macintosh castle without a Guru. Mine took two:"
			)
			(46
				(= local4 (proc5_12 {Krishnan Shankar} 67 -4 50 28 28))
				(= local5 (proc5_12 {Jason Hickingbottom} 67 242 58 28 28))
				(rightScreen view: 1000 setLoop: 1 setCycle: Osc)
				(leftScreen view: 1001 setLoop: 1 setCycle: Osc)
				(= ticks 300)
			)
			(47
				(proc5_12 local4)
			...
			(50
				...
				(rightScreen view: 482 setLoop: 10)
				(= ticks 300)
			)
			(51
				(proc5_12 local4)
