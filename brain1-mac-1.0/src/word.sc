...
(local
	[local0 20] = [49 10 43 30 40 50 60 52 21 43 1 4 11 14 3 1 5 0 7 11]
...
(procedure (localproc_4 &tmp [temp0 200])
	(cond
		...
		(else
			(Format @temp0 325 20 local422 (- local455 local422)) ; "You have located %d words; you have %d left to go."
			(Print @temp0 #at 65 6)
		)
	)
)
...
(procedure (localproc_5)
	(proc5_9 325 21) ; "This is a word search puzzle. Find words of four or more letters relating to sports and games in the grid. Select the words by dragging the mouse from the first to the last letter of each word."
		...
		(for ((= temp0 0)) (< temp0 30) ((+= temp0 2))
			...
			(for ((= temp1 0)) (< temp1 15) ((++ temp1))
				...
				(if (and (== temp20 0) (!= temp1 14))
					(Graph grDRAW_LINE 22 (- temp18 2) 156 (- temp18 2) [local0 0] -1 -1)
			...
			(+= temp19 9)
			(if (!= temp0 28)
				(Graph grDRAW_LINE (- temp19 2) 4 (- temp19 2) 168 [local0 0] -1 -1)
