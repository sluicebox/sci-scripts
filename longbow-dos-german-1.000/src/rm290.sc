		...
		(switch theVerb
			...
			(5 ; Talk
				(if (> (gEgo y:) 100)
					...
					(SetMessageColor 21)
					(Say ; "Shhh, I be listening to the Doomsayer."
						1290
						32
						80
						{Mistress Baker}
		...
		(switch theVerb
			...
			(5 ; Talk
				(if (> (gEgo y:) 100)
					...
					(SetMessageColor 21)
					(Say ; "If you want to gamble, show your coins."
						1290
						38
						80
						{Robert of Mallory}
			...
			(4 ; Inventory
				(switch invItem
					(0 ; bucks
						(SetMessageColor 21)
						(Say ; "Place your wager with me mate, Robert of Fischbach. He's the gent on the right."
							1290
							39
							80
							{Robert of Mallory}
...
(instance gamble of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(SayModeless ; "Patch's wager is laid. I'll throw first."
					1290
					50
					self
					80
			...
			(3
				(SayModeless ; "A good throw! Best that if you can, Patch. Here's the dice."
					1290
					51
					self
					80
			...
			(7
				(SayModeless ; "You lose. Next wager?"
					1290
					52
					self
					80
