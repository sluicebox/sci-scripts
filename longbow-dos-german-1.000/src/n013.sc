...
(procedure (Say param1 param2 param3)
	(if gModelessDialog
		(gModelessDialog dispose:)
	)
	(= local6 (== gTheCursor 5))
	(GetFarText param1 param2 @local7)
	(= local0 (+ global162 (* global163 (StrLen @local7))))
	(cond
		((< argc 3)
			(gGame setCursor: 5 (not (HaveMouse)))
			(proc13_0 @local7 67 -1 5)
			(proc13_7)
		)
		...
		(else
			(gGame setCursor: 5 (not (HaveMouse)))
			(proc13_0 @local7 67 -1 5 param3 &rest)
			(proc13_7)
		)
	)
)

(procedure (SayModeless param1 param2 param3)
	(if gModelessDialog
		(gModelessDialog dispose:)
	)
	(= local6 (== gTheCursor 5))
	...
	(cond
		...
		((and (IsObject param3) (param3 respondsTo: #notKilled))
			(if (not (param3 notKilled:))
				...
				(gGame setCursor: 5 (not (HaveMouse)))
				(stopMessage init: param3)
				(proc13_2 @local7 108 stopMessage 25 (/ local0 60) &rest)
			)
		)
		((IsObject param3)
			(gGame setCursor: 5 (not (HaveMouse)))
			(stopMessage init: param3)
			(proc13_2 @local7 25 (/ local0 60) 108 stopMessage &rest)
		)
		((== param3 1)
			(gGame setCursor: 5 (not (HaveMouse)))
			(stopMessage init: 0)
