...
(instance person8 of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(5 ; Talk
				(SetMessageColor 21)
				(Say ; "Get your second-hand armour here! Crusade cast-offs!"
					1310
					34
					80
					{Christopher Shankarmour}
				)
				(Say ; "Minor dints, dings and dents! No charge for bloodstains!"
					1310
					35
					80
					{Christopher Shankarmour}
				)
				(Say ; "Impress the ladies! Free tale of gallantry with each purchase!"
					1310
					36
					80
					{Christopher Shankarmour}
