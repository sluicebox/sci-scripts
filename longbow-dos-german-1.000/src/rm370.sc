...
(procedure (localproc_0)
	(Say &rest 67 3 15 70 95)
)

(procedure (localproc_1)
	(SetMessageColor 20)
	(Say &rest 67 220 15 70 100)
	(SetMessageColor 0)
)
...
(instance rm370 of Rm
	...
	(method (init)
		...
		(if (gEgo has: 15) ; comb
			(Say 1370 0 70 100) ; "***If you wish to return to Lobb's shop... Click anywhere in the room."
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(SetMessageColor 20)
				(Say 1370 1 self 67 220 15 70 100) ; "Forgive my caution, but the Sheriff has spies everywhere and I need to be sure of you."
				(SetMessageColor 0)
			)
			(2
			...
			(17
				...
				(lobbsHead setCycle: Osc 20)
				(SetMessageColor 20)
				(Say 1370 17 self 67 220 15 70 100) ; "Aye! The Prince conspires with the Sheriff and Abbot of Nottingham."
				(SetMessageColor 0)
			)
			(18
				(lobbsHead setCycle: Osc 20)
