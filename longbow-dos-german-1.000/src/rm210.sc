...
(local
	...
	[local219 6] = [1210 129 1 1 1 0]
	[local225 6] = [1210 132 2 1 1 0]
	[local231 12] = [1210 135 1 2 1 1 1 2 1 1 1 0]
	[local243 14] = [1210 144 2 1 1 2 2 1 1 2 1 2 1 0]
	[local257 5] = [1210 155 2 2 0]
	[local262 5] = [1210 158 1 1 0]
	[local267 9] = [1210 160 2 1 2 1 2 1 0]
	[local276 7] = [1210 166 2 1 1 2 0]
	[local283 5] = [1210 180 1 2 0]
	[local288 10] = [1210 182 2 1 2 2 1 1 2 0]
	[local298 4] = [1210 189 1 0]
	[local302 9] = [1210 173 2 1 2 2 1 2 0]
	[local311 9] = [1210 190 2 2 1 1 2 2 0]
	[local320 4] = [1210 196 1 0]
	[local324 7] = [1210 197 2 2 1 2 0]
	[local331 8] = [1210 201 2 1 2 1 2 0]
	[local339 4] = [1210 206 1 0]
	[local343 4] = [1210 207 1 0]
	[local347 5] = [1210 208 2 1 0]
	[local352 5] = [1210 210 1 2 0]
	[local357 5] = [1210 212 2 1 0]
	[local362 5] = [1210 214 2 1 0]
	[local367 6] = [1210 216 2 1 2 0]
	[local373 14] = [1210 220 2 1 2 1 2 1 2 1 2 1 2 0]
	[local387 6] = [1210 231 2 1 2 0]
	[local393 7] = [1210 234 2 1 1 2 0]
	[local400 4] = [1210 239 1 0]
	[local404 4] = [1210 240 1 0]
	[local408 4] = [1210 45 1 0]
	[local412 4] = [1210 46 1 0]
	[local416 4] = [1210 3 1 0]
	[local420 5] = [1210 243 1 1 0]
	local425
	[local426 4]
	local430
	local431
	local432
	local433
	[local434 4] = [1211 0 1 0]
	[local438 4] = [1211 1 1 0]
	[local442 4] = [1211 2 1 0]
	[local446 7] = [1211 3 1 2 1 2 0]
	[local453 5] = [1211 7 1 1 0]
	[local458 4] = [1211 9 1 0]
	[local462 6] = [1211 10 1 2 1 0]
	[local468 6] = [1211 13 1 2 1 0]
	[local474 5] = [1211 16 1 1 0]
	[local479 4] = [1211 20 1 0]
	[local483 4] = [1211 21 1 0]
	[local487 4] = [1211 22 1 0]
	[local491 6] = [1211 23 2 1 1 0]
	[local497 4] = [1317 12 1 0]
	[local501 4] = [1210 170 1 0]
	[local505 3] = [-1 0 0]
	[local508 3] = [-1 {Willows} 5]
)
...
(procedure (localproc_0)
	...
	(cond
		...
		((and (== gDisguiseNum 0) local431) ; outlaw
...
(procedure (localproc_1 param1)
	(Display {} dsRESTOREPIXELS local425)
	(StrCat @local426 param1)
	(= local425 (Display @local426 dsCOORD 115 35 dsCOLOR global187 dsBACKGROUND global186 dsSAVEPIXELS))
)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (IsFlag 179)
					(ClearFlag 179)
					(Converse @local420 @local505 0 self) ; "Thank the Blessed Virgin! The sprite's spell has worn off!"
				else
					(self cue:)
				)
			)
				...
				(if (gCast contains: marian)
					(switch gDay
						(4
							(switch global149
								(0
									(Converse @local347 1 22 self) ; "Bring no weapons into this sacred place."
								)
								(1
									(= cycles 1)
								)
								(2
									(Converse @local362 1 22 self) ; "Come, stand here in the center."
								)
							)
						)
						(7
			...
			(5
				(switch global149
					(1
						(Converse @local357 1 22 self) ; "You seem confused and uncertain. I'll try to be patient with you."
					)
					(else
						(= cycles 1)
					)
			...
			(6
				(switch gDay
					(4
						(switch global149
							(0
								(Converse @local352 1 22 self) ; "I'm most pleased to see you again. I beg you to stay longer this time."
							)
							(2
								(Converse @local367 1 22 self) ; "Now stand fast in that place, until our business here is done."
								(= local12 1)
							)
							(else
								(= cycles 1)
					...
					(7
						(switch global149
							(0
								(Converse @local373 1 22 self) ; "'Tis good to see you safe, Robin."
							)
							(1
								(Converse @local387 1 22 self) ; "I wish you wouldn't leave like that when we've so much yet to discuss."
							)
							(else
								(Converse @local393 1 22 self) ; "By the Blessed Lady, Robin, if you leave here one more time--"
								(= local12 1)
							)
						)
					)
		...
		(switch (= state newState)
			(0
				...
				(if (IsFlag 155)
					...
					(Say 1210 219 self) ; "Such is the power of this grove, I feel compelled to lay down my weapons before I enter."
				)
				(SetFlag 155)
			)
			(1
...
(instance groveClosed of Code
	...
	(method (doit)
		(if (& (gEgo onControl: 1) $0004)
			...
			(Say
				1210
				(if (and (== gDisguiseNum 4) (== gDay 8)) 249 else 250) ; yeoman
				1
			)
		)
	)
...
(instance waitToDie of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(Converse @local416 2 0 self) ; "I was too slow! She's dead! Dead!"
			)
			(3
				(Load rsVIEW 501)
	...
	(method (doit &tmp temp0)
		(super doit:)
		(if (and (= temp0 (& (gEgo onControl: 1) $0002)) (not local431))
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					(1 ; horn
						(Converse @local408 22) ; "I've no need for such a man's toy."
					)
					(0 ; bucks
						(Converse @local412 22) ; "'Tis kind of you to offer, but I've quite enough money of my own."
					)
					(2 ; halfHeart
						(switch gDay
							(4
					...
					(14 ; amethyst
						(Converse @local283 1 22) ; "If you'd care to have this piece of amethyst--"
					)
					(12 ; puzzleBox
						(if local8
							(Converse 1 @local298 22 3) ; "Please, I insist you keep it."
						else
							(= local8 1)
							(Converse @local288 1 22) ; "Is that the Abbot's?!"
						)
					)
					(10 ; fireRing
						(if (== gDay 7)
							(if local9
								(Say 1210 171) ; "I won't show it to her again after the distress it caused her."
							else
								(Converse @local302 1 22) ; "I care not for the feel of that ring."
							)
						)
					)
					(17 ; handScroll
						(if (IsFlag 34)
							(Converse 1 @local501 22 3) ; "You must give it to the Queen's spy."
						else
					...
					(18 ; waterRing
						(switch gDay
							(7
								(if local11
									(Converse 1 @local339 22 3) ; "I charge you to guard it for the King."
								else
									(Converse @local331 1 22) ; "This ring has a wondrous good feel to it."
								)
							)
							(10
								(Say 1210 179) ; "Alas, the ring has no power to heal."
							)
						)
					)
					(4 ; net
						(Converse 1 @local343 22 3) ; "'Tis good the Widow has given you this. You'll have need of it."
					)
					(else
						(super doVerb: theVerb &rest)
					)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(= local2 (= local1 0))
				(marian dispose:)
				((gCurRoom obstacles:) delete: local433)
				(local433 dispose:)
				(localproc_0)
				(self dispose:)
			)
...
(instance heal of Script
	...
	(method (changeState newState &tmp [temp0 125] [temp125 75] [temp200 150])
		(switch (= state newState)
			(0
				(HandsOff)
				(marian setScript: 0)
			...
			(8
				(GetFarText 1210 96 @temp0) ; "I cannot rest until I tell you. The Queen's Knight will know you when you spell out the word"
				(GetFarText 1317 (+ -10 global140) @temp125)
				(if 1
					...
					(if (== (gGame printLang:) 49)
						(Format @temp200 210 0 global221 global223) ; "%s%s"
					else
						(Format @temp200 210 0 global216 global218) ; "%s%s"
					)
				...
				(if ((= register (ScriptID 851 3)) underBits:) ; talker2
					(register say: @temp200 0 0 0 self)
				else
					(= cycles 1)
				)
			)
		...
		(switch theVerb
			...
			(4 ; Inventory
				(switch invItem
					...
					(10 ; fireRing
						(Say 1210 172 1) ; "The ring protected us from the flames, but it can do nothing to heal her."
					)
					(18 ; waterRing
						(Say 1210 179 1) ; "Alas, the ring has no power to heal."
					)
					(else
			...
			(5 ; Talk
				(Say 1210 251 1) ; "She cannot speak. She is dying!"
			)
			(else
				(gDoVerbCode doit: theVerb &rest)
			)
...
(instance giveScroll of TScript
	...
	(method (changeState newState &tmp [temp0 130] [temp130 55] [temp185 150])
		(switch (= state newState)
			(0
				(HandsOff)
				(if (not (& (gEgo onControl: 1) $0004))
			...
			(9
				(= notKilled 1)
				(Converse @local219 22 0 self) ; "Long ago the Druids devised this Hand Code."
			)
			(10
				(marian setCycle: Beg self)
				(rustleSound play:)
			...
			(13
				(Converse @local225 22 1 self) ; "The letters are branded in my mind. I close my eyes and see them still."
			)
			(14
				(if notKilled
			...
			(30
				(gEgo stopUpd:)
				(marian stopUpd:)
				(Converse @local231 22 1 self 0) ; "Keep the scroll safe."
			)
			(31
				(Converse @local243 22 3 self 0) ; "Mayhap he will mingle freely enough, but you've said naught of how I shall perform this miracle."
			)
			(32
				(Converse @local257 22 1 self 0) ; "I'll take care not to endanger you."
			)
			(33
				(GetFarText 1210 157 @temp0) ; "Aye, and he'll be testing you as well. When you speak with him, you must ask him to show you the coat-of-arms of The"
				(GetFarText 1317 global123 @temp130)
				(if 1
					(= global216 (Memory memALLOC_CRIT (StrLen @temp0)))
					(= global218 (Memory memALLOC_CRIT (StrLen @temp130)))
					(= global221 (Memory memALLOC_CRIT (StrLen @temp0)))
					(= global223 (Memory memALLOC_CRIT (StrLen @temp130)))
					(StrSplitInTwo global216 global221 @temp0)
					(StrSplitInTwo global218 global223 @temp130)
					(if (== (gGame printLang:) 49)
						(Format @temp185 210 0 global221 global223) ; "%s%s"
					else
						(Format @temp185 210 0 global216 global218) ; "%s%s"
					)
					(Memory memFREE global216)
					(Memory memFREE global218)
					(Memory memFREE global221)
				...
				(SetMessageColor 9)
				((= register (ScriptID 851 2)) show: say: @temp185 0 0 0 self) ; talker1
				(SetMessageColor 0)
			)
			(34
				(if (not notKilled)
				...
				(Converse @local262 22 1 self 0) ; "He'll open his book and show you coats-of-arms. You must be sure he shows you the right one."
			)
			(35
				(Converse @local267 22 3 self 0) ; "And after the fair, shall I meet you here again? Or will you come to my camp and meet my men?"
			)
			(36
				(Converse @local276 22 1 self) ; "I know the grove and the oak well. You seem most anxious about this."
			)
			(37
				(marian signal: 0)
				(= local12 0)
			...
			(3
				(cond
					((gEgo has: 10) ; fireRing
						(Converse @local324 1 22 self) ; "These are most interesting verses. I know this hand."
						(gEgo put: 16) ; fulkScroll
					)
					(local10
						(Converse 1 @local320 22 3 self) ; "I can make no sense of his doggerel. I wish you luck in deciphering it."
					)
					(1
						(= local10 1)
						(Converse @local311 1 22 self) ; "These are most interesting verses. I know this hand."
					)
				)
			)
			(4
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(HandsOff)
				(if (== gDay 10)
					(Say 1210 242 self) ; "My men are scattered and some may still be fighting. It would be futile to wind my horn, perhaps even dangerous."
					(= local2 0)
				else
					(++ state)
					(= cycles 1)
			...
			(2
				(if (= register (gCast contains: marian))
					(Converse 1 @local400 22 3 self) ; "Surely you don't mean to wind that horn here?"
				else
					(Say 1210 241 self) ; "I cannot bring myself to shatter the silence of this sacred grove."
				)
			)
			(3
				(= cycles 1)
			...
			(4
				(Converse @local404 1 0 self) ; "Your pardon, Marian. Since it disturbs you, I will not."
			)
			(5
				(localproc_0)
				(self dispose:)
...
(instance willowTalk of TScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Converse @local446 @local508 999 self 0) ; "What would you ask of us?"
			)
			(2
				(Converse register @local508 999 self)
			)
			(3
				(self dispose:)
				(localproc_0)
			...
			(4
				(-= state 2)
				(Converse 1 register @local508 0 self)
			)
			(5
				(-= state 3)
...
(instance spillBeans of TScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(Converse @local491 @local508 999 self 0) ; "Did Marian whisper a password to you?"
			)
			(1
				(= [local497 1] (+ -10 global140))
				(Converse @local497 @local508 999 self) ; "LIONS."
				(SetFlag 51)
			)
			(2
				(self dispose:)
