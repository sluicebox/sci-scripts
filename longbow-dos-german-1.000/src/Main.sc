...
(procedure (proc0_10 param1 param2 param3 param4 param5)
	(return
...
(procedure (proc0_11)
	(proc0_10 1026 1040 1050 1051 950)
)
...
(class RHSlider of Slider
	(properties
		helpModule 888
	)
)

(class RHControlIcon of ControlIcon
	(properties
		helpModule 888
	)
)
...
(instance statLine of Code
	...
	(method (doit &tmp [temp0 35] [temp35 45] [temp80 8] [temp88 12] [temp100 10] [temp110 6] [temp116 4] [temp120 4] [temp124 4] [temp128 4] [temp132 4] temp136)
		...
		(StrCpy @temp124 (LangSwitch { of } { / }))
		(Format @temp128 0 1 gPossibleScore) ; "%d"
		...
		(TextSize @temp132 @temp0 0 -1)
		(StrCpy @temp35 {\06})
		(for
			((= temp136 (/ (- 326 (- [temp132 3] [temp132 1])) 2)))
			(> temp136 0)
			((-- temp136))
...
(instance Longbow of Game
	...
	(method (init &tmp temp0 temp1)
		...
		(gInventory
			normalHeading: (LangSwitch {I am carrying} {Ich trage})
			empty: (LangSwitch {nothing.} {nichts.})
			init:
			add:
				bucks
				horn
...
(instance invLook of RHIconItem
	(properties
		view 900
		loop 2
		cel 0
...
(instance invHand of RHIconItem
	(properties
		view 900
		loop 0
		cel 0
...
(instance invHelp of RHIconItem
	(properties
		view 900
		loop 1
		cel 0
...
(instance invSelect of RHIconItem
	(properties
		view 900
		loop 4
		cel 0
...
(instance bucks of InvI
	...
	(method (doVerb theVerb &tmp [temp0 32] [temp32 35] [temp67 35] [temp102 23] [temp125 26] [temp151 95])
		(switch (gPennies number:)
			(0
				(Format @temp0 0 6)
			)
			(1
				(Format @temp0 (LangSwitch {1 penny} {1 Penny}))
			)
			(else
				(if (== (gGame printLang:) 1)
					(Format @temp0 0 7 (gPennies number:)) ; "%d pennies"
				else
					(Format @temp0 0 8 (gPennies number:)) ; "%d Penny's"
				)
			)
		)
		(switch (gHapennies number:)
			...
			(1
				(Format @temp32 (LangSwitch {1 ha'penny} {1 Halbpenny}))
			)
			(else
				(if (== (gGame printLang:) 1)
					(Format @temp32 0 9 (gHapennies number:)) ; "%d ha'pennies"
				else
					(Format @temp32 0 10 (gHapennies number:)) ; "%d Halbpenny's"
				)
			)
		)
		(switch (gFarthings number:)
			...
			(1
				(Format @temp67 (LangSwitch {1 farthing} {1 Viertelpenny}))
			)
			(else
				(if (== (gGame printLang:) 1)
					(Format @temp67 0 11 (gFarthings number:)) ; "%d farthings"
				else
					(Format @temp67 0 12 (gFarthings number:)) ; "%d Viertelpenny's"
				)
			)
		)
		(cond
			((and (gPennies number:) (gHapennies number:) (gFarthings number:))
				(Format @temp102 0 13) ; ","
				(Format @temp125 (LangSwitch {, and } {, und }))
			)
			(
				(and
					(gPennies number:)
				...
				(Format @temp102 (LangSwitch { and } { und }))
				(Format @temp125 0 6)
			)
			(
				(and
			...
			(2 ; Look
				(cond
					(
						...
						(proc13_1 0 14) ; "I have nothing."
					)
					((== (gGame printLang:) 1)
						(proc13_1
							(Format ; "I have %s%s%s%s%s."
								@temp151
								0
								15
								@temp0
...
(instance detailSlider of RHSlider
	(properties
		loop 0
		cel 1
		nsLeft 89
...
(instance volumeSlider of RHSlider
	(properties
		loop 0
		cel 1
		nsLeft 135
...
(instance moveSpeedSlider of RHSlider
	(properties
		loop 0
		cel 1
		nsLeft 181
...
(instance arcadeSlider of RHSlider
	(properties
		loop 0
		cel 1
		nsLeft 227
...
(instance iconSave of RHControlIcon
	(properties
		loop 2
		cel 0
		nsLeft 25
...
(instance iconRestore of RHControlIcon
	(properties
		loop 3
		cel 0
		nsLeft 25
...
(instance iconRestart of RHControlIcon
	(properties
		loop 4
		cel 0
		nsLeft 25
...
(instance iconQuit of RHControlIcon
	(properties
		loop 5
		cel 0
		nsLeft 43
...
(instance iconHelp of RHIconItem
	(properties
		loop 6
		cel 0
		nsLeft 25
...
(instance iconAbout of RHControlIcon
	(properties
		loop 8
		cel 0
		nsLeft 25
...
(instance gcWindow of BorderWindow
	...
	(method (open &tmp temp0 temp1)
		...
		(= temp0 (PicNotValid))
		(PicNotValid 1)
		(DrawCel (proc0_11) 1 2 0 0 temp1)
		(DrawCel (proc0_11) 1 2 54 0 temp1)
		(DrawCel (proc0_11) 1 2 108 0 temp1)
		(DrawCel (proc0_11) 1 2 162 0 temp1)
		(DrawCel (proc0_11) 1 2 216 0 temp1)
		(DrawCel (proc0_11) 1 2 0 47 temp1)
		(DrawCel (proc0_11) 1 2 54 47 temp1)
		(DrawCel (proc0_11) 1 2 108 47 temp1)
		(DrawCel (proc0_11) 1 2 162 47 temp1)
		(DrawCel (proc0_11) 1 2 216 47 temp1)
		(DrawCel (proc0_11) 1 2 0 94 temp1)
		(DrawCel (proc0_11) 1 2 54 94 temp1)
		(DrawCel (proc0_11) 1 2 108 94 temp1)
		(DrawCel (proc0_11) 1 2 162 94 temp1)
		(DrawCel (proc0_11) 1 2 216 94 temp1)
		(DrawCel (proc0_11) 0 5 (proc0_10 130 146 146 146 146) 9 temp1)
		(DrawCel (proc0_11) 1 1 14 17 temp1)
		(DrawCel (proc0_11) 1 0 119 50 temp1)
		(DrawCel (proc0_11) 1 0 165 50 temp1)
		(DrawCel (proc0_11) 1 0 211 50 temp1)
		(DrawCel (proc0_11) 0 4 85 (proc0_10 29 33 33 33 33) temp1)
		(DrawCel
			(proc0_11)
			0
			3
			(proc0_10 129 128 128 128 128)
			(proc0_10 29 33 33 33 33)
			temp1
		)
		(DrawCel
			(proc0_11)
		...
		(Graph
			...
			0
			0
			(+ 94 (CelHigh (proc0_11) 1 2))
			(+ 216 (CelWide (proc0_11) 1 2))
			1
		)
		(PicNotValid temp0)
	)
