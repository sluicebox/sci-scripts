...
(local
	[local0 7] = [1180 19 1 1 1 1 0]
	[local7 13] = [1180 23 1 2 1 1 2 1 1 1 1 1 0]
	[local20 5] = [1180 37 1 1 0]
	[local25 4] = [1180 39 1 0]
	[local29 4] = [1180 43 1 0]
	[local33 5] = [1180 44 1 1 0]
	[local38 5] = [1180 80 1 1 0]
	[local43 4] = [1180 35 1 0]
	[local47 7] = [1180 58 2 1 1 1 0]
	[local54 7] = [1180 62 1 1 1 1 0]
	[local61 5] = [1180 40 1 1 0]
	[local66 4] = [1180 9 1 0]
	[local70 4] = [1180 10 1 0]
	[local74 4] = [1180 11 1 0]
	[local78 4] = [1180 12 1 0]
	[local82 4] = [1180 13 1 0]
	[local86 4] = [1180 14 1 0]
	[local90 4] = [1180 15 1 0]
	[local94 4] = [1180 16 1 0]
	[local98 4] = [1180 17 1 0]
	[local102 6] = [1180 47 2 1 1 0]
	[local108 5] = [1180 50 2 1 0]
	[local113 4] = [1180 52 1 0]
	[local117 4] = [1180 46 1 0]
	[local121 4] = [1180 66 1 0]
	[local125 4] = [1180 67 1 0]
	[local129 4] = [1180 71 1 0]
	[local133 4] = [1180 72 1 0]
	[local137 4] = [1180 68 1 0]
	[local141 5] = [1180 69 1 1 0]
	[local146 10] = [1180 73 2 1 1 1 1 1 1 0]
	[local156 4] = [1180 84 1 0]
	[local160 5] = [1180 82 1 1 0]
	[local165 4] = [1180 87 1 0]
	[local169 5] = [1180 56 2 1 0]
	[local174 5] = [1180 88 1 1 0]
	[local179 4] = [1180 105 1 0]
...
(procedure (localproc_0)
	(switch local730
		(0
			(localproc_1 (GetFarText 1180 0 @local209) 100 5 2 106 120) ; "I am the heart that does not beat; if cut, I bleed without blood, I can fly, but have no wings, I can float, but have no fins, I can sing, but have no mouth."
		)
		(1
			(localproc_1 (GetFarText 1180 1 @local209) 100 5 2 106 120) ; "High born, my touch is gentle, purest white is my lace, silent, silent is my kingdom, green is the colour of my death."
		)
		(2
			(localproc_1 (GetFarText 1180 2 @local209) 100 5 2 106 120) ; "I am the outstretched fingers that seize and hold the wind, wisdom flows from me in other hands, upon me are sweet dreams dreamt, my merest touch brings laughter."
		)
		(3
			(localproc_1 (GetFarText 1180 3 @local209) 100 5 2 106 120) ; "Golden treasures I contain, guarded by hundreds and thousands, stored in a labyrinth where no man walks, yet men come often to seize my gold, by smoke I am overcome and robbed, then left to build my treasure anew."
		)
		(4
			(localproc_1 (GetFarText 1180 4 @local209) 100 5 2 106 120) ; "My first master has four legs, my second master has two legs, my first I serve in life, my second I serve in death, Cure me and I live beyond my death. Tough I am, yet soft beside, 'gainst ladies' cheeks I oft reside."
		)
		(5
			(localproc_1 (GetFarText 1180 5 @local209) 100 5 2 106 120) ; "Metal or bone I may be, many teeth I have and always bared, yet my bite harms no one, and ladies delight in my touch."
		)
		(6
			(localproc_1 (GetFarText 1180 6 @local209) 100 5 2 106 120) ; "Not born but from a mother's body drawn, I hang until half of me is gone, I sleep in a cave until I grow old, then valued for my hardened gold."
		)
		(7
			(localproc_1 (GetFarText 1180 7 @local209) 100 5 2 106 120) ; "I am two-faced but bear only one face, I have no legs but travel widely, men spill much blood over me, kings leave their imprint upon me, I have greatest power when given away, yet lust for me keeps me locked away."
		)
		(8
			(localproc_1 (GetFarText 1180 8 @local209) 100 5 2 106 120) ; "I am a window, I am a lamp, I am clouded, I am shining, I am coloured, set in white, I fill with water and overflow, I say much, but have no words."
		)
	)
	(= local735 0)
)
...
(procedure (localproc_1 param1 param2)
	(Display param1 param2 &rest 105 3 102 7 103 33 106 100)
)
...
(instance callVainly of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(1
				(Say 1180 36 self) ; "I didn't think that would work."
			)
			(2
				(HandsOn)
				(self dispose:)
...
(instance blowIt of Script
	...
	(method (changeState newState &tmp [temp0 2])
		(switch (= state newState)
			(0
				(HandsOff)
				(Say 1180 42 self) ; "That was a waste of breath."
			)
			(1
				(HandsOn)
				(self dispose:)
...
(instance sprite of Actor
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Say 1180 18 1) ; "'Tis a wood sprite"
			)
			(else
		...
		(switch theVerb
			(2 ; Look
				(if (and (> cel 0) (IsFlag 118))
					(Say 1180 33 1) ; "The green Man has flesh of wood, skin of bark, hair of leaves."
				else
					(Say 1180 54 1) ; "This is the most ancient and sacred oak of the forest."
				)
			)
			(3 ; Do
				(if (or (== cel 0) (and (not (IsFlag 118)) (not (IsFlag 34))))
					(Say 1180 55 1) ; "This is a sacred oak. I'll not take bark, branch or leaf from this tree."
				else
					(Say 1180 34 1) ; "I don't think the Green Man would take kindly to being plucked."
				)
			)
			(5 ; Talk
				(cond
					...
					((and (not (IsFlag 118)) (not (IsFlag 34)))
						(Say 1180 86 1) ; "I cannot think of what to say to an oak tree."
					)
					((!= gDisguiseNum 0) ; outlaw
						(Say 1180 85 1) ; "It would seem the Green Man will not answer me in this guise."
					)
			...
			(10 ; Longbow
				(cond
					((IsFlag 35)
						(Say 1180 106 1) ; "I would be foolish indeed to fire an arrow at the very being who gave me his blessing!"
					)
					((== gDisguiseNum 0) ; outlaw
			...
			(4 ; Inventory
				(cond
					...
					((== invItem 2) ; halfHeart
						(Say 1180 90 1) ; "Whatever the power of this emerald may be, it has no effect upon the Grandfather Oak."
					)
					(else
...
(instance oakTree of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Say 1180 54 0) ; "This is the most ancient and sacred oak of the forest."
			)
			(3 ; Do
				(Say 1180 55 0) ; "This is a sacred oak. I'll not take bark, branch or leaf from this tree."
			)
			(10 ; Longbow
				(cond
					((IsFlag 35)
...
(instance grove1 of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Say 1180 53 0) ; "All the trees within this grove are oaks."
			)
			(else
				(super doVerb: theVerb &rest)
			)
