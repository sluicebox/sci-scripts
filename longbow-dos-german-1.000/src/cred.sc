...
(instance theMumble of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(grin setCel: 1 setPri: 0 addToPic:)
				(= ticks 34)
			)
			(5
				(gCurRoom overlay: 96)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Graph grDRAW_LINE 30 139 159 139 local3 0 0)
				(Graph grDRAW_LINE 70 136 119 136 local3 0 0)
				(Graph grDRAW_LINE 90 133 99 133 local3 0 0)
				(Graph grDRAW_LINE 30 144 159 144 local4 0 0)
				(Graph grDRAW_LINE 70 147 119 147 local4 0 0)
				(Graph grDRAW_LINE 90 150 99 150 local4 0 0)
				(Graph grDRAW_LINE 0 142 189 142 local3 0 0)
				(Graph grDRAW_LINE 0 141 189 141 local4 0 0)
			...
			(3
				(= local0 (Graph grSAVE_BOX 0 132 189 141 1))
				(= local1 (Graph grSAVE_BOX 0 143 189 151 1))
				(Graph grDRAW_LINE 30 139 159 139 local4 0 0)
				(Graph grDRAW_LINE 30 144 159 144 local3 0 0)
				(Graph grREDRAW_BOX 0 64 189 148)
				(= ticks 4)
			)
			(4
