	...
	(method (handleEvent event &tmp temp0 temp1 [temp2 201] temp203 temp204 temp205 temp206 temp207 temp208)
		...
		(switch temp0
			(257
				...
				(Print
					(Format @temp2 997 1) ; "PRODUCER Guruka Singh Khalsa DEVELOPMENT SYSTEM BY: Jeff Stephenson, Robert E. Heitman, Pablo Ghenis QUALITY ASSURANCE BY: Mindy Wynn: QA Team Leader Robin Bradley, Oliver Brelsford, Steve Coallier, Tate Deloach, Mike Harian, Dennis Jonathan, Dean Larocca, Sharon Simmons"
					#title
					{  Conquests of Camelot Credits  }
					#mode
					1
