...
(procedure (localproc_0 param1)
	(Message msgGET 101 2 0 0 param1 @local1)
	(Print @local1 30 310 64 -1 15 25 global207)
)
...
(instance cetusRide of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(Narrator posn: -1 16 init: 1 0 0 1 self) ; "In a true champion's welcome, Adam rides on the back of King Cetus in a slow procession to the city!"
			)
			(3
				(whale setMotion: MoveTo 140 79 self)
			)
			(4
				(Narrator posn: -1 16 init: 1 0 0 2 self) ; "Cetus bellows an announcement of their triumphant return!"
			)
			(5
			...
			(8
				(Narrator posn: -1 16 init: 1 0 0 3 self) ; "Adam slips off the back of the mighty whale and swims to join the happy Elurians."
			)
			(9
				(gEgo
					setLoop: 2
...
(instance conchCeremony of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Superfluous init: 3 0 0 1 1 self) ; "Congratulations <sob>, Adam! I'm so moved <boo hoo>!"
			)
			(2
				(= cycles 1)
			)
			...
			(8
				(Epidermis init: 5 0 0 1 1 self) ; "Like, unbelievably radical, Adam! Major way to go!"
			)
			(9
				(= ticks 120)
			)
...
(instance delphDialog of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(Narrator init: 1 0 0 4 self) ; "Adam bids farewell to Eluria and King Cetus and, grabbing onto Delphineus' dorsal fin, hangs on tight for the long ride home."
			)
			(2
			...
			(3
				...
				(Message msgGET 101 12 0 0 3 @local1) ; "Delphineus?"
				(Print @local1 #at 112 132 #time 5 #dispose self)
			)
			(4 0)
			(5
				(localproc_1 5 90 80)
			...
			(6
				(gEgo setMotion: MoveTo 370 100 self)
				(Message msgGET 101 13 0 0 2 @local1) ; "Yeah, Adam?"
				(Print @local1 #at 64 28 #time 5 #dispose self)
			)
			(7 0)
			(8
				(localproc_1 5 80 70)
			...
			(9
				(gEgo setMotion: MoveTo 370 100 self)
				(Message msgGET 101 12 0 0 4 @local1) ; "Will I ever see you again?"
				(Print @local1 #at 112 132 #time 5 #dispose self)
			)
			(10 0)
			(11
			...
			(12
				...
				(Message msgGET 101 13 0 0 3 @local1) ; "What, are you kiddin? You and your Dad? Diver Dans? You'll see a hundred dolphins in your lifetime, Adam. One of these days, one of those dolphins will be me."
				(Print @local1 #at 64 15 #time 10 #dispose self)
			)
			(13
				(localproc_1 5 50 40)
				(gEgo posn: -20 100 setMotion: MoveTo 80 100 self)
			...
			(14
				(gEgo setMotion: MoveTo 370 100 self)
				(Message msgGET 101 12 0 0 5 @local1) ; "...I love you, Delphineus."
				(Print @local1 #at 112 132 #time 5 #dispose self)
			)
			(15 0)
			(16
			...
			(17
				(gEgo setMotion: MoveTo 370 100 self)
				(Message msgGET 101 13 0 0 4 @local1) ; "Aw, get out of here, ya nut ya! <sniff> ...I love you, too."
				(Print @local1 #at 64 28 #time 5 #dispose self)
			)
			(18 0)
			(19
