...
(instance rm381 of EcoRoom
	...
	(method (doVerb theVerb)
		(if (== theVerb 2) ; Look
			(Narrator posn: 160 20 init: 5 0 0 1 0 380) ; "The Lab has a specially designed room for treating stranded or injured animals."
		else
...
(instance labDoor of Prop
	...
	(method (doVerb theVerb invItem)
		(if (not (IsFlag 70))
			...
			(Narrator posn: 160 20 init: 5 0 0 69 0 380) ; "Adam must go inside to do that."
		)
	)
)
...
(instance outsideGateLever of Prop
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Inventory
				(Narrator posn: 160 20 init: 6 0 0 32 0 380) ; "The lever for the hatch is operated by hand. It's not necessary to use anything on the lever."
			)
			(2 ; Look
				(Narrator init: 5 0 0 lookStr 0 380)
			)
...
(instance starFish of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(2 ; Look
				(Narrator posn: 160 20 init: 5 0 0 lookStr 0 380)
			)
			(3 ; Do
				(Narrator posn: 160 20 init: 5 0 0 lookStr 0 380)
			)
			...
			(switch theVerb
				...
				(3 ; Do
					(if (gEgo has: 9) ; airTanks
						(Narrator posn: 160 20 init: 5 0 0 60 0 380)
					else
...
(instance boats of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(3 ; Do
				(Narrator init: 5 0 0 2 0 380) ; "The Lab uses the speedboats as little as possible. The gasoline really hurts the reef."
			)
			(else
				(super doVerb: theVerb invItem &rest)
			)
...
(instance safeFood of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(3 ; Do
				(Narrator posn: 160 20 init: 5 0 0 58 0 380)
			)
			(else
				(super doVerb: theVerb &rest)
			)
...
(instance dock of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(3 ; Do
				(Narrator init: 5 0 0 27 0 380) ; "The docks are in good repair."
			)
			(5 ; Talk
				(dolphin doVerb: 5)
			)
...
(instance tFrisbee of PicView
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Narrator posn: 160 20 init: 5 0 0 96 0 380)
			)
			(3 ; Do
				(Narrator posn: 160 20 init: 6 0 0 16 0 380) ; "Adam doesn't need that anymore. The dolphin has lost interest in frisbee."
			)
			(else
				(super doVerb: theVerb invItem &rest)
			)
...
(instance startUp of Script
	...
	(method (changeState newState &tmp [temp0 250])
		(switch (= state newState)
			...
			(3
				(Narrator init: 5 0 0 84 self 380)
			)
			(4
				(delphBackDrop init:)
				(= seconds 2)
...
(instance leaveRoom of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(1
				(Narrator init: 6 0 0 18 self 380) ; "Adam empties his pockets."
			)
			(2
...
(instance getGearOn of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				(Narrator init: 6 0 0 30 self 380) ; "He puts on his fins, gloves, and mask and jumps into the water."
			)
			(10
				(self dispose:)
			)
