	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(Narrator posn: 45 142 init: 3 0 0 55 self)
			)
			(6
				(scaredInset init:)
				(egoScared init:)
			...
			(8
				(Narrator posn: 45 142 init: 3 0 0 18 self) ; "Adam looks up in terror as a huge black shape glides like a cloud above him, blocking the surface light."
			)
			(9
				(= seconds 3)
			)
			(10
				(Narrator posn: 45 142 init: 3 0 0 19 self) ; "The water tingles with a feeling of danger and evil. Adam is frozen in place with fear, unable to move a flipper!"
			)
			(11
				(scaredInset dispose:)
				(egoScared dispose:)
			...
			(21
				(Narrator posn: 45 142 init: 3 0 0 20 self) ; "The black monster finishes its pass and slowly glides away."
			)
			(22
				(gLongSong fade:)
				(manta init:)
			...
			(32
				((ScriptID 2 0) init: 1 0 0 7 1 self) ; Delphineus, "We call him Flesh-Eater <shudder>. He's the biggest, meanest manta anybody's ever seen! Most mantas are gentle, but this one's a real bone-grinder!"
			)
			(33
