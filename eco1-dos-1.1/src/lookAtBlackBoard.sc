...
(instance cageView of Prop
	...
	(method (doVerb theVerb)
		...
		(switch theVerb
			(2 ; Look
				(Narrator posn: -1 140 init: 5 0 0 lookStr 0 380)
			)
			(3 ; Do
				(Narrator posn: -1 140 init: 6 0 0 23 0 380) ; "The cages need to stay where they are to protect animals who swim too close."
			)
			(else
...
(instance blackBoardInset of Prop
	...
	(method (doVerb theVerb)
		...
		(switch theVerb
			(2 ; Look
				(Narrator posn: -1 140 init: 6 0 0 4 0 380) ; "A set of instructions insures that all helpers treat the dolphin alike."
			)
			(3 ; Do
