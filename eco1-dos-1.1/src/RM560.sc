...
(instance RM560 of EcoRoom
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(10 ; Recycle
				(Narrator init: 1 0 0 39) ; "The divers removed the worst of the contaminated materials. The rest will decompose over time."
			)
			(3 ; Do
...
(instance deadPlant of Feature
	...
	(method (doVerb theVerb)
		...
		(switch theVerb
			(3 ; Do
				(Narrator init: 1 0 0 (if (mod x 2) 30 else 31))
			)
			(10 ; Recycle
				(Narrator init: 1 0 0 39) ; "The divers removed the worst of the contaminated materials. The rest will decompose over time."
			)
