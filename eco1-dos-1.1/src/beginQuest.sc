...
(instance beginQuest of Script
	...
	(method (changeState newState &tmp [temp0 500])
		(switch (= state newState)
			...
			(1
				((ScriptID 2 0) init: 1 0 0 15 0 self) ; Delphineus, "I think you need to talk to the Oracle. The Oracle of Eluria can see into the future. If anyone would know what you should do to help the city, it'd be her. I'd better go see what's been going on since I left."
			)
			(2
			...
			(6
				(Narrator posn: 10 100 talkWidth: 150 init: 3 0 0 54)
			)
			(7
				(HandsOn)
				(gDelph dispose:)
