...
(procedure (localproc_0 param1 param2 param3 param4 &tmp temp0 [temp1 100])
	(Message msgGET param1 param2 0 2 (- param3 72) @temp1)
	(= temp0 (+ 2 (/ (StrLen @temp1) 12)))
	(Print @temp1 #at -1 5 #time temp0 #dispose param4)
)
