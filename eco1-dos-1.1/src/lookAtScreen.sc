...
(instance lookAtScreen of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				((ScriptID 2 1) init: 2 0 0 30 1 self) ; Adam, "I'd love to play King's Quest V for a while, but I've got things to do!"
			)
			(2
				(= seconds 3)
			)
			...
			(5
				...
				(gAddToPics add: (ScriptID 400 12) eachElementDo: #init doit:) ; book
