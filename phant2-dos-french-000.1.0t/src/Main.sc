...
(instance p2 of P2Game
	...
	(method (init &tmp [temp0 5] temp5)
		...
		(= global227
			(if (and (== (Platform 2) 2) (!= (Platform 0) 1)) 1 else 20)
		)
		...
		(if (!= (= temp5 (FileIO fiOPEN {version} 1)) -1)
			(FileIO fiREAD_STRING gVersion temp5 9)
		)
		(FileIO fiCLOSE temp5)
		(= global216 1)
...
(instance p2Cursor of HotCursor
	...
	(method (show)
		(Lock rsPALETTE 149 0)
		(UnLoad 139 149)
		(Load rsPALETTE 149)
		(Lock rsPALETTE 149 1)
		(super show: &rest)
	)
)
