	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 105 0 #width 230 #at 10 110 #dispose) ; "He conjured up a terrible whirlwind that swirled faster and faster around the castle. With another incantation Mordack then caused the wind to draw the castle up into the sky and out of sight. Oh, it was something to see, all right!"
