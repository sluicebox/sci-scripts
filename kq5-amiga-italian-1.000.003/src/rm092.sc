...
(instance rm092 of KQ5Room
	...
	(method (init)
		...
		(switch gPrevRoomNum
			...
			(else
				(gEgo loop: 3 cel: 3 posn: 135 157 stopUpd:)
				(HandsOff)
		...
		(if (>= (gGame detailLevel:) 2)
			(cedric setScript: (ScriptID 202 3)) ; rotate
		else
			(cedric stopUpd:)
		)
		(gEgo
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				...
				(wolf1 hide:)
				(wolf2 hide:)
				(gEgo loop: 12 cel: 1 posn: 10 171 stopUpd:)
			...
			(17
				...
				(wolf1 setMotion: 0 setCycle: 0 stopUpd:)
				(wolf2 setMotion: 0 setCycle: 0 stopUpd:)
			...
			(26
				...
				(iceQueen cel: 0 setCycle: 0 stopUpd:)
				(wolf1 setCycle: Beg self)
			)
			(27
				(cls)
