	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				...
				(3 ; Do
					(PrintDC 53 7) ; "The chasm between the trail and the front gate of the castle is too wide to jump across. Graham will have to find another way to enter the castle."
					(event claimed: 1)
				)
			)
		)
...
(instance path2 of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 53 8) ; "A wide chasm separates the narrow trail from the castle's massive front gate. Graham ponders the situation but can't find a way to solve it."
					(event claimed: 1)
				)
				(3 ; Do
					(PrintDC 53 7) ; "The chasm between the trail and the front gate of the castle is too wide to jump across. Graham will have to find another way to enter the castle."
...
(instance path3 of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 53 9) ; "A wide chasm separates the narrow trail from the castle's massive front gate. Graham ponders the situation but can't find a way to solve it."
					(event claimed: 1)
				)
				(3 ; Do
					(PrintDC 53 7) ; "The chasm between the trail and the front gate of the castle is too wide to jump across. Graham will have to find another way to enter the castle."
