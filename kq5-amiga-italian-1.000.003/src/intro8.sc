...
(instance intro8 of Rm
	...
	(method (init)
		...
		(self setScript: a2s2Script setRegions: 769) ; introtoonRegion
		(super init:)
	)
...
(instance a2s2Script of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(= global380 1)
				(PrintDC 107 0 #at 100 10 #dispose) ; "Okay...here I come!"
				(= cycles 1)
			)
			(5
...
(instance owlFlying of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(PrintDC 107 1 #at 10 10 #dispose) ; "There it is! Down here! Come on!"
				(owl
					setLoop: 10
					moveSpeed: 1
					setCycle: Fwd
