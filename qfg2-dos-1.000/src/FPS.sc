	...
	(method (handleEvent event)
		(cond
			...
			((Said 'tell,talk,talk//elemental<air')
				(if (gEgo has: 35) ; EmptyPot
					(event claimed: 0)
					(super handleEvent: event)
				else
					(gEgo get: 35 3) ; EmptyPot
					(Say self 315 13) ; "If you think that earthenware pots might help you, I will gladly give you three small, unglazed ones. Here."
				)
			)
			(else
				(super handleEvent: event)
...
(instance poemS of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(Say omar self 315 14) ; "And they ask, "What is a Hero?",   though the answer's very clear, He's the one who faces danger   when the darkness hovers near."
			)
			(2
				(Say omar self 315 15) ; "He will face the fiercest foe  when another needs his aid, He will dare to defy Death  even though he is afraid, He works not just for glory  and he does it not for gain, But because he knows that others  will be spared a greater pain."
			)
			(3
				(Say omar self 315 16) ; "He won't always follow orders,  for he dares to answer, "Why?", And unless he likes the reason,  he refuses to comply, He will brave the battle boldly  even though he may not win, He will face his fate unflinching,  for he is a Paladin."
			)
			(4
