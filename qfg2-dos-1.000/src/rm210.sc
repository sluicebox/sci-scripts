...
(procedure (WhoPrint who &tmp thisWin thisTitle whichWindow)
	...
	(Print &rest #title [windowParams thisTitle] #width 300 #window whichWindow)
)
...
(procedure (BadReaction)
	(switch whichQuestion
		(1
			...
			(WhoPrint 11 210 87) ; "We do not accept liars in our tower."
			(gCurRoom setScript: zapEgoOutS)
		)
		(2
			(WhoPrint 11 210 88) ; "We do not accept intruders in our tower."
			(gCurRoom setScript: zapEgoOutS)
		)
		(3
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(if (WhoPrint 11 210 56 81 {Yes} 1 81 {No} 0) ; "You will be presented with a series of four tests. They will require all your intelligence and magic. Should you fail, your very life may be endangered. Will you accept the challenge and walk the path of Wizardry?"
					(self cue:)
				else
					(WhoPrint 11 210 57) ; "Then you may leave, mere user of magic."
	...
	(method (changeState newState &tmp [tmpStr 120])
		(switch (= state newState)
			...
			(2
				(sparkle dispose:)
				(RedrawCast)
				(WhoPrint 12 210 58) ; "You have proven yourself worthy of the Wizard's Institute of Technocery and Erasmus' faith. Congratulations. You are now a Wizard Initiate."
				(WhoPrint 14 210 59) ; "Now you have outgrown the childish Hero business and can devote yourself to years of metaphysical musings and esoteric exercises designed to invigorate your intellect and to manipulate your mental and magical muscles."
				(WhoPrint 13 210 60) ; "You have passed this day from the lesser mortal plane into the Realm of Wizards. You are now qualified to begin your post-graduate magical training. In fifteen or twenty years, you will be ready to return to the world of mere men. Until that time, you will bask in the sunshine and security of academia, knowing you shall receive the best of all possible educations."
				(WhoPrint 15 210 61) ; "Ahead of you are the wonders of Wizardry. Behind you are all the petty problems inherent in the mundane land. You have passed beyond those weaklings who depended upon your skills and dared to call you "friend." You will now learn the real Magic of the Wizard's Institute of Technocery -- knowledge gained through careful study."
				(if (WhoPrint 16 210 62 81 {Yes} 1 81 {No} 0) ; "Walk away from the world of those fools who needed you. You are more than just a Hero now. You are a scholar! You have only to take the oath that you will ignore and forget about those who needed you in the land of Shapeir and devote yourself to the improvement of your mind and magic. Will you take the oath?"
					(self cue:)
				else
					(self changeState: 5)
				)
			...
			(3
				(WhoPrint 16 210 63) ; "Welcome to the Wizard's Institute of Technocery, Wizard."
				(gEgo setMotion: MoveTo 160 155 self)
			)
			(4
				(Print 210 64) ; "You walk the hallowed halls of the ivory towers of WIT and devote the next twenty years of your life to learning. You become one of the greatest scholars upon the subject of "Scrying Scrolls.""
				(Print 210 65) ; "You never did return to Shapeir again, because, for some reason the WIT Wizards were unable to explain, the door to that land became permanently closed. They believe it had something to do with the land being destroyed."
				(EgoDead
					1
			...
			(5
				(SolvePuzzle 685 7 1)
				(WhoPrint 16 210 66) ; "Well, it is obvious you think being a Hero is more important than being a scholar. Perhaps someday when you have matured a bit, you will comprehend the enormity of the education you have ignored! The Wizard's Institute of Technocery is for real Wizards rather than the real world!"
				(wiz1 setCycle: End)
				(wiz2 setCycle: End)
				(wiz3 setCycle: End)
			...
			(6
				(WhoPrint 0 (Format @tmpStr 210 67 @gUserName)) ; "Congratulations, Wizard %s. You have shown exceptional intelligence by refusing to take their silly oath. After all, what good is magic or knowledge unless you use it?"
				(WhoPrint 0 210 68) ; "My graduation present for you is the "Reversal" Spell. You may recall the Kobold's use of it against you in Spielburg."
				(WhoPrint 0 210 69) ; "Cast Reversal and magical attacks directed at you will rebound to their caster. But take care -- it will not help against the indirect effects of other spells."
				(gEgo learn: 29 10) ; invisibility
				(HighPrint 210 70) ; "You feel the thrill of knowledge. Now you know how to cast the Spell of "Reversal.""
				(WhoPrint 0 210 71) ; "You should now return to Shapeir. They really need a real Wizard-Hero like you there. And, remember, "Those who can, do.""
				(WhoPrint 1 210 72) ; "Those that can't, tell others what to do?"
				(WhoPrint 0 210 73) ; "Fenrus, when is a rat not a rat?"
				(WhoPrint 1 210 74) ; "When it turns into its rathole?"
				(WhoPrint 0 210 75) ; "No, when it's e'rat'icated. What did the rat say as he fell 12,000 feet straight down?"
				(WhoPrint 1 210 76) ; "It's a long way to tip a ratty? Or maybe, "Cheese it, I Swiss I hadn't gone this Whey." Oh, all right, what did the rat say?"
				(WhoPrint 0 210 77) ; "I'm not sure either, but I know a way to find out. Care to volunteer?"
				(WhoPrint 1 210 78) ; "I guess I Bleu it. I'd Chedder be Gouda for awhile, right?"
				(WhoPrint 0 210 79) ; "Right. At any rate, Wizard-Hero, good luck and farewell!"
				(client setScript: zapEgoOutS)
			)
		)
	)
...
(instance playItAgainS of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(WhoPrint 16 210 80) ; "Walk the path of Wizardry."
				(gEgo setMotion: MoveTo 160 155 self)
			)
			(1
				(door setCycle: End self)
...
(instance failedPretestS of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(WhoPrint 11 210 81) ; "Magister Erasmus of Zauberberg, Archmage Extraordinaire, your would-be initiate has returned."
				(= cycles 8)
			)
			(1
				(WhoPrint 0 210 82) ; "Very good. Now, young Hero of Spielburg, remember: To try and fail there is no shame ..."
				(WhoPrint 1 210 83) ; "As long as you can pass the blame?"
				(WhoPrint 0 210 84) ; "As long as you improve your aim."
				(WhoPrint 1 210 85) ; "Just don't make your excuses lame. Heh, heh!"
...
(instance gotoPreTestS of HandsOffScript
	...
	(method (changeState newState &tmp whichBell)
		(switch (= state newState)
			...
			(1
				(WhoPrint 0 210 86) ; "Ouch! My nose!"
