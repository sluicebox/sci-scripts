...
(procedure (EgoGait newGait gaitMsg &tmp theView walkNorm walkStop)
	...
	(switch gEgoGait
		(1 ; running
			(gEgo view: 1 xStep: 6 yStep: 3 setCycle: gEgoStopWalk 4)
		)
		(2 ; sneaking
			(gEgo view: 2 xStep: 2 yStep: 2 setCycle: gEgoWalk)
		)
		(3 ; riding
			(gEgo view: 12 xStep: 5 yStep: 3 setCycle: gEgoWalk)
		)
		(4 ; holdingLamp
			(gEgo view: 585 xStep: 4 yStep: 2 setCycle: gEgoWalk)
		)
		(else
			(gEgo view: walkNorm xStep: 4 yStep: 2 setCycle: gEgoStopWalk walkStop)
		)
	)
)
