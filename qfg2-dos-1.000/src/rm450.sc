...
(instance ugarteArrest of HandsOffScript
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				(HighPrint 450 7 80 {Guard:} 25 3) ; "Do not interfere!"
				(= seconds 1)
			)
			(5
				(ugarte
			...
			(8
				(ugartePrint 450 8) ; "Hero, you must help me! Do something!"
				(LowPrint 450 9) ; "The swords of the guards press deeper into your skin."
				(khaveenPrint 450 10) ; "There are no heroes in this town. You of all men should know that, Ugarte."
				(= seconds 1)
			)
			(9
				(ugartePrint 450 11) ; "I know very little. What is going on? I am innocent of any wrong-doing."
			...
			(13
				(khaveenPrint 450 12) ; "If you are so innocent, then what is this?"
				(= cycles 4)
			)
			(14
			...
			(17
				(ugartePrint 450 13 80 {Ugarte:} 35 uWin) ; "I don't know how that water bag could have gotten there. Someone must have planted it on me."
				(InitAddToPics wawa)
			...
			(19
				(khaveenPrint 450 14) ; "Waterskins under your tunic, Ugarte? You know that smuggling water is a crime against the State. You also know what we do to criminals like you."
				(HighPrint 450 15 80 {Ugarte:} 35 uWin) ; "No, no, please. I am innocent! I do not know how it got there. No!"
				(HighPrint 450 16 80 {Ugarte:} 35 uWin) ; "Hero....    Help!....."
				(= cycles 4)
			)
			(20
				(rGuard2
			...
			(26
				(khaveenPrint 450 17) ; "This is the fate of anyone who breaks the rules of the city. Remember this, and see that you do not suffer the same fate."
				(= seconds 2)
			)
			(27
				(khaveen
			...
			(28
				(HighPrint 450 18 80 {Guard:} 103 25 6) ; "I hope you are smart enough to learn this lesson. You do not want to see the dungeons of Raseir."
				(= cycles 4)
			)
			(29
				(NormalEgo)
