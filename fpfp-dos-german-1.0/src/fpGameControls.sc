...
(instance gcWin of SysWindow
	...
	(method (open &tmp temp0 [temp1 4] temp5 [temp6 20] temp26)
		(= local0 (proc0_16 117 113 113 113 113))
		...
		(DrawCel 995 2 1 (proc0_16 148 151 151 151 151) (- local2 12) 15)
		(DrawCel
			995
			2
			2
			(proc0_16 164 195 195 195 195)
			(proc0_16
				(+ local1 3)
				(- local2 12)
				(- local2 12)
		...
		(DrawCel 995 2 3 (proc0_16 214 232 232 232 232) (- local2 12) 15)
