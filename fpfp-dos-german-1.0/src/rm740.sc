			...
			(0
				...
				(switch
					(Print
						...
						addButton: 2 24 0 0 2 0 (proc0_16 30 18 18 18 18) 740 ; "Hmmm. I dunno. That was a pretty impressive half-gainer."
						addButton: 3 24 0 0 3 0 (proc0_16 60 48 48 48 48) 740 ; "Oh, my God.   I'm going to die. Give me a break!"
						init:
					)
					(0
						(= local7 1)
