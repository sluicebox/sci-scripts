		...
		(if (and local7 (event type:) (== gCurRoomNum gNewRoomNum))
			...
			(switch
				(Print
					...
					addButton: 2 4 0 0 2 (proc0_16 43 60 60 60 60) 0 790 ; "Restart"
					addButton: 0 4 0 0 3 (proc0_16 103 120 120 120 120) 0 790 ; "Continue"
					addButton: 3 4 0 0 4 179 0 790 ; "Quit"
					init:
				)
				(0
					(gGameMusic1 pause: 0)
