	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Print
					posn: (proc0_16 70 100 100 100 100) 70
					font: gUserFont
					window: SysWindow
					addTitle: 62 0 0 2 671
					addText: 62 0 0 3 2 2 671 ; "Be Kind! Please Rewind!"
					addButton: 0 62 0 0 1 (proc0_16 100 70 70 70 70) 20 671 ; "Rewind"
					init:
				)
				(= cycles 1)
			)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(client view: 696 setCycle: End self)
			)
			(5
				(client setScript: sRewindLines)
				(self dispose:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(client view: 697 setCycle: End self)
			)
			(5
				(client setScript: sRewindLines)
				(self dispose:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(client view: 698 setCycle: End self)
			)
			(6
				(client setScript: sRewindLines)
				(self dispose:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(4
				...
				(shwing hide:)
				(deadSound number: 2801 play:)
				(client view: 699 setCycle: End self)
			)
			(5
				(client setScript: sRewindLines)
				(self dispose:)
