...
(local
	...
	local23
	local24
	[local25 4] = [1621 0 1 0]
	[local29 8] = [1621 1 1 0 1621 3 1 0]
	[local37 4] = [1621 4 1 0]
	[local41 4] = [1621 5 1 0]
)
			...
			(0
				(switch local14
					(1
						...
						(Converse 1 @local37 11 2) ; "Your first choice is correct, Brother. Choose you now two more."
					)
					(2
						(Converse 1 @local41 11 2) ; "Aye, the second stone is correct. Choose your last stone for this riddle."
					)
					(3
