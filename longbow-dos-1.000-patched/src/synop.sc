			...
			(0
				(switch global146
					...
					(30
						(AddOutlaws 0)
						(SetScore 500)
						(Say 1179 24) ; "Little John's flanking attacks decimated the soldiers and cleared the way long enough to free Marian from the stake. So efficient was his plan, we lost no men."
