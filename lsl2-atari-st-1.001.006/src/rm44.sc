		...
		(if (Said 'look>')
			...
			(if (Said '/mirror')
				(if (== gCurrentEgoView 100)
					...
					(Print 44 8 #at -1 152) ; "(You just scared yourself silly!)"
				)
			)
			...
			(if (Said '/cup')
				...
				(Print 44 23 #at -1 152) ; "(Unlike you, Larry!)"
			)
			(if (Said '/beach')
			...
			(cond
				...
				((and (gEgo has: 15) (gEgo has: 16)) ; Bikini_Top, Bikini_Bottom
					(if (gEgo inRect: 176 100 199 115)
						...
						(gEgo view: 150)
						(gGame changeScore: 5)
						(Print 44 42 #at -1 152) ; "(Boy, do you look sweet!)"
					else
		...
		(if (Said 'get/match')
			(cond
				...
				(else
					...
					(Print 44 49 #at -1 152) ; "(Gee, Larry; at last you've found your match!)"
					(theSound play:)
		...
		(if (Said 'get/soap')
			(cond
				...
				(else
					...
					(Print 44 52 #at -1 152) ; "(You have always been terminally cheap!)"
				)
			)
		)
		(if
			...
			(cond
				...
				((gEgo inRect: 176 100 199 115)
					...
					(Print 44 55 #at -1 152) ; "(Are you sure you want to do this?)"
				)
				(else
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				...
				(Print 44 59 #at -1 152) ; "(She says she's the maid!)"
				(= seconds 8)
			)
			(4
