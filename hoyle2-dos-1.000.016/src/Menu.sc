	...
	(method (handleEvent event &tmp temp0 temp1 temp2 temp3 temp4)
		...
		(switch (= temp0 (super handleEvent: event))
			(257
				...
				(Print
					(Format @global100 997 1) ; "DEVELOPMENT SYSTEM BY:   Jeff Stephenson  Robert E. Heitman  Pablo Ghenis  John Hartin  Dan Foy  John Rettig  Corinna Abdul  Corey Cole Version 1.000.016"
					81
					{ OK }
					70
					180
