	...
	(method (init)
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
					init: 105 189 105 178 275 179 292 147 278 121 291 118 276 110 199 108 123 108 77 112 52 106 52 0 319 0 319 189
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
					init: 0 168 0 0 43 0 43 104 57 112 87 115 122 110 210 110 251 113 262 127 254 144 152 168
					yourself:
				)
		)
		(super init: &rest)
...
(instance egoNorthOverKnightScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				(gEgo posn: (- (gEgo x:) 10) (- (gEgo y:) 12) reset: 3)
				(= cycles 1)
			)
			(3
				(if
...
(instance egoSouthOverKnightScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gEgo setLoop: 2 setMotion: JumpTo 261 137 self)
			)
			(2
				(gEgo setLoop: -1)
				(= local18 0)
