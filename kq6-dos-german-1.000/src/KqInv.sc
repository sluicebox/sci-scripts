...
(instance KqInv of Inv
	(properties
		normalHeading {Alexander ne transporte}
		empty {rien.}
	)
		...
		(switch theVerb
			(1 ; Look
				(if (and (not (gEgo has: 4)) (not (IsFlag 93))) ; hair
					(Print
						font: gUserFont
						addText: noun theVerb 0 0 0 0 modNum ; "Beauty's old clothes are very ragged and heavy. They consist of a long, thick dress, and a headpiece which covers the hair and most of the face."
						posn: -1 10
						init:
					)
					(Print
						font: gUserFont
						addText: noun theVerb 36 0 0 0 modNum ; "A long strand of Beauty's blond hair is caught in the mantle."
						posn: -1 10
						init:
					)
				else
			...
			(5 ; Do
				(if
					...
					(Print
						font: gUserFont
						addText: noun theVerb 36 0 0 0 modNum ; "Alexander searches through Beauty's clothes and finds a long strand of blond hair."
						posn: -1 10
						init:
					)
					(pageCode init: local1)
				...
				(cond
					...
					((& state $0004)
						...
						(if (& state $0001)
							(Print
								font: gUserFont
								addText: noun theVerb 41 0 0 0 modNum ; "Alexander puts the strand of hair into the skull containing the embers and the spoiled egg."
								posn: -1 10
								init:
							)
						else
							(Print
								font: gUserFont
								addText: noun theVerb 39 0 0 0 modNum ; "Alexander puts the strand of hair into the skull."
								posn: -1 10
								init:
							)
						)
			...
			(19 ; egg
				(cond
					...
					((and (& state $0004) (& state $0002))
						...
						(Print
							font: gUserFont
							addText: noun theVerb 40 1 0 0 modNum ; "Alexander cracks the spoiled egg, and dumps it into the skull containing the embers and the strand of hair."
							posn: -1 10
							init:
						)
						(if (& state $0008)
							(Print
								font: gUserFont
								addText: noun theVerb 39 2 0 0 modNum ; "The spoiled egg hisses as it makes contact with the hot embers! Zounds, the steam! Phew, the smell of sulfur!"
								posn: -1 10
								init:
							)
						else
							(Print
								font: gUserFont
								addText: noun theVerb 39 3 0 0 modNum ; "The embers, having grown cold since Alexander collected them, mix with the foul contents of the spoiled egg to make a stinky, mucky mess. Somehow, this just doesn't look quite right."
								posn: -1 10
								init:
							)
						)
					...
					((& state $0004)
						...
						(Print
							font: gUserFont
							addText: noun theVerb 39 1 0 0 modNum ; "Alexander cracks the spoiled egg and dumps it into the skull containing the embers."
							posn: -1 10
							init:
						)
						(if (& state $0008)
			...
			(1 ; Look
				(cond
					...
					((and (& state $0004) (& state $0001) (& state $0002))
						(Print
							font: gUserFont
							addText: noun theVerb 42 1 0 0 modNum ; "Alexander is carrying a human skull filled with oak embers, a strand of hair, and a spoiled egg."
							posn: -1 10
							init:
						)
						(if (& state $0008)
							(Print
								font: gUserFont
								addText: noun theVerb 41 2 0 0 modNum ; "The embers are glowing hot. A foul, sulfurous-smelling steam rises from the spoiled egg and embers mixture."
								posn: -1 10
								init:
							)
						else
							(Print
								font: gUserFont
								addText: noun theVerb 41 3 0 0 modNum ; "The embers have grown cold, and the mixture has coagulated into a foul mess."
								posn: -1 10
								init:
							)
						)
					...
					((and (& state $0004) (& state $0002))
						(Print
							font: gUserFont
							addText: noun theVerb 40 1 0 0 modNum ; "Alexander is carrying a human skull filled with embers and a strand of hair."
							posn: -1 10
							init:
						)
						(if (& state $0008)
							(Print
								font: gUserFont
								addText: noun theVerb 39 3 0 0 modNum ; "The embers are glowing with heat."
								posn: -1 10
								init:
							)
						else
							(Print
								font: gUserFont
								addText: noun theVerb 39 2 0 0 modNum ; "The embers are cold."
								posn: -1 10
								init:
							)
						)
					...
					((and (& state $0004) (& state $0001))
						(Print
							font: gUserFont
							addText: noun theVerb 41 1 0 0 modNum ; "Alexander is carrying a human skull filled with oak embers and the contents of a spoiled egg."
							posn: -1 10
							init:
						)
						(if (& state $0008)
					...
					((& state $0004)
						(Print
							font: gUserFont
							addText: noun theVerb 39 1 0 0 modNum ; "Alexander is carrying a human skull filled with embers."
							posn: -1 10
							init:
						)
						(if (& state $0008)
		...
		(switch theVerb
			(1 ; Look
				(Print
					font: gUserFont
					posn: -1 10
					addText: noun theVerb 0 0 0 0 modNum ; "Alexander is carrying an old, battered hunter's lamp."
					init:
				)
				(cond
					((== global161 0)
			...
			(24 ; sacredWater
				(cond
					...
					((and (IsFlag 77) (== global161 0))
						...
						(Print
							font: gUserFont
							addText: noun theVerb 16 0 0 0 modNum ; "Alexander pours the contents of the Oracle's vial into the hunter's lamp. The vial, now empty of its sacred fluid, disintegrates."
							posn: -1 10
							init:
						)
					...
					((and (IsFlag 77) (== global161 4))
						...
						(Print
							font: gUserFont
							addText: noun theVerb 17 0 0 0 modNum ; "Alexander pours the contents of the Oracle's vial into the hunter's lamp with the baby's tears. The vial, now empty of its sacred fluid, disintegrates."
							posn: -1 10
							init:
						)
						(pageCode init: local1)
		...
		(switch theVerb
			(1 ; Look
				(if (or (gEgo has: 4) (gEgo has: 16) (IsFlag 112)) ; hair, cassimaHair
					...
					(Print
						font: gUserFont
						posn: -1 10
						addText: noun theVerb 0 0 0 0 907 ; "The lady's hair ribbon is made of the finest red velvet."
						init:
					)
					(Print
						font: gUserFont
						posn: -1 10
						addText: noun theVerb 33 0 0 0 907 ; "A long strand of black hair is caught in the ribbon."
						init:
					)
				)
			)
			(5 ; Do
				(if
					...
					(Print
						font: gUserFont
						addText: noun theVerb 33 0 0 0 modNum ; "Alexander examines the red ribbon and finds a strand of long, black hair."
						posn: -1 10
						init:
					)
					(pageCode init: local1)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(1 ; Look
				(Print
					font: gUserFont
					addText: noun theVerb 0 0 0 0 modNum ; "The little china teacup is made of fine porcelain."
					posn: -1 10
					init:
				)
				(cond
					((IsFlag 23)
						(Print
							font: gUserFont
							addText: noun theVerb 32 0 0 0 modNum ; "The teacup contains the residue of black paint."
							posn: -1 10
							init:
						)
					)
					((IsFlag 22)
						(Print
							font: gUserFont
							addText: noun theVerb 31 0 0 0 modNum ; "The teacup contains a thick, black, paint-like mixture."
							posn: -1 10
							init:
						)
					)
					(
						...
						(Print
							font: gUserFont
							addText: noun theVerb 27 0 0 0 modNum ; "The teacup is empty."
							posn: -1 10
							init:
						)
					)
					(
						...
						(Print
							font: gUserFont
							addText: noun theVerb 28 0 0 0 modNum ; "The teacup contains swamp ooze."
							posn: -1 10
							init:
						)
					)
					((and (IsFlag 68) (IsFlag 58) (not (IsFlag 22)))
						(Print
							font: gUserFont
							addText: noun theVerb 30 0 0 0 modNum ; "The teacup contains swamp ooze and water from the River Styx."
							posn: -1 10
							init:
						)
					)
					(
						...
						(Print
							font: gUserFont
							addText: noun theVerb 29 0 0 0 modNum ; "The teacup contains water from the River Styx."
							posn: -1 10
							init:
						)
					)
