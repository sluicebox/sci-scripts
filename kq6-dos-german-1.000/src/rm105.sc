		...
		(switch (= state newState)
			...
			(24
				(if global83
					...
					(= local401
						(Display @local1 dsCOORD 23 150 dsWIDTH 300 dsCOLOR 98 dsFONT 1 dsSAVEPIXELS)
					)
				else
					(Display 105 1 dsRESTOREPIXELS local401)
					(Message msgGET 105 1 0 0 10 @local1) ; "Alexander.... I feel so alone. I don't know what to do.... Alexander, I wish you were here...."
			...
			(25
				(if global83
					...
					(= local401
						(Display @local1 dsCOORD 23 5 dsWIDTH 300 dsCOLOR 98 dsFONT 1 dsSAVEPIXELS)
					)
				else
					(Display 105 1 dsRESTOREPIXELS local401)
					(Message msgGET 105 1 0 0 11 @local1) ; "Cassima! Wait!"
			...
			(28
				...
				(if global83
					...
					(= local401
						(Display @local1 dsCOORD 23 5 dsWIDTH 300 dsCOLOR 98 dsBACKGROUND 0 dsFONT 1 dsSAVEPIXELS)
					)
				else
					(Display 105 1 dsRESTOREPIXELS local401)
					(Message msgGET 105 1 0 0 12 @local1) ; "MOTHER! MOTHER, COME QUICK!"
			...
			(32
				...
				(= local401
					(Display @local1 dsCOORD 12 75 dsWIDTH 300 dsCOLOR 98 dsFONT 3110 dsALIGN alCENTER dsSAVEPIXELS)
				)
				((ScriptID 107 2) doit: 0 self) ; fadeThePic
			)
			(33
			...
			(42
				...
				(Display 105 1 dsRESTOREPIXELS local401)
				(= local401
					(Display @local1 dsCOORD 12 70 dsWIDTH 300 dsCOLOR 98 dsFONT 3110 dsALIGN alCENTER dsSAVEPIXELS)
				)
				(= cycles 1)
			)
			(43
