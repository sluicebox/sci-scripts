					...
					(= temp0
						(if local0
							(Print
								...
								posn: 75 60
								font: 4
								addButton: 1 0 0 1 0 0 0 908 ; "About King's Quest I-V"
								addButton: 2 0 0 2 0 0 18 908 ; "About King's Quest VI"
								addButton: 3 0 0 4 0 0 36 908 ; "Tips for playing King's Quest VI"
								addButton: 4 0 0 3 0 0 54 908 ; "Beginner Walk-Thru"
		...
		(switch (= state newState)
			...
			(1
				(Print
					addTextF:
						@temp0
						{King's Quest VI\nVersion:\t%s\nDas ganze Werk steht unter Copyright 1992\nSierra On-Line, Inc. Alle Rechte vorbehalten.}
						gVersion
					init:
				)
				(= cycles 1)
