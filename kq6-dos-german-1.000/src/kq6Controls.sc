...
(instance controlWin of Kq6Window
	...
	(method (open &tmp temp0 [temp1 49] temp50 temp51 temp52 temp53)
		...
		(DrawCel 946 0 4 75 (+ (- 37 (+ (CelHigh 946 0 4) 3)) 25) -1 0)
		(DrawCel 946 0 3 106 (+ (- 37 (+ (CelHigh 946 0 4) 3)) 100) -1 0)
		(DrawCel 946 0 2 138 (+ (- 37 (+ (CelHigh 946 0 4) 3)) 25) -1 0)
		(PicNotValid local0)
		(= temp0 (GetPort))
		(SetPort 0)
