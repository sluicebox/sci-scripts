...
(local
	[local0 100]
	[local100 250]
	[local350 28] = [1 1 1 2 3 4 1 2 3 4 4 1 3 4 1 3 3 4 1 2 3 4 1 2 1 2 3 -1]
	[local378 28] = [98 100 380 240 150 480 650 520 450 580 160 490 730 690 790 770 260 750 220 470 410 510 210 290 660 380 240 -1]
	local406
	local407 = 1
	local408
	local409
...
(instance creditsScript of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(DrawPic [local378 local406] 9)
				(if (== [local378 local406] 98)
					(= cycles 2)
				else
					(setUpRoom doit: self)
				)
			...
			(1
				(if (and (== [local378 local406] 98) local410)
					(= local410 0)
			...
			(3
				(if local408
					(Message msgGET 94 1 0 0 local407 @local0)
					(Message msgGET 94 1 0 0 (++ local407) @local100)
				else
					(Message msgGET 94 0 0 0 local407 @local0)
					(Message msgGET 94 0 0 0 (++ local407) @local100)
				)
				(if (>= (++ local407) 32)
					(= local408 1)
					(= local407 1)
				)
				(switch [local350 local406]
					(1
...
(instance showScore of Script
	...
	(method (changeState newState &tmp [temp0 200] [temp200 200])
		(switch (= state newState)
			(0
				(Message msgGET 94 0 0 1 1 @temp0) ; "You received out of points. You've completed approximately  percent of the main-path puzzles in King's Quest VI."
				(Format
					@temp200
					@temp0
					gScore
				...
				(Print font: gUserFont addText: @temp200 init:)
				(= cycles 1)
			)
			(1
				(if (<= gScore 230)
