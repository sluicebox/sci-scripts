		...
		(cond
			...
			((Said 'look>')
				(cond
					...
					((Said '/bush')
						(Print 310 3) ; "There are a few beautiful flowers clinging tenaciously to a steep escarpment."
					)
					((Said '/flower,boulder,wall')
						(Print 310 4) ; "There are some beautiful flowers here."
					)
					((Said '[/area]')
						(Print 310 5) ; "You are outside the legal offices of Dewey, Cheatem & Howe, the best Corporation of Associated Legal Professionals on the island of Nontoonyt!"
						(Print 310 6 #at -1 144) ; "(Also the ONLY!)"
					)
				)
			)
			((Said 'get/bush')
				(Print 310 7) ; "The only plants here that catch your eye are those hanging on that sheer rock cliff."
			)
			((Said 'get,pick/flower')
				(Print 310 8) ; "While these flowers are beautiful, they just don't "lei" right!"
			)
		)
	)
)
