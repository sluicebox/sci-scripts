	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(33
				...
				(Print 216 44 #icon 217 3 0 #at -1 10) ; "Ripping opening the envelope, you discover your new credit card. And, look! It's in your name only! Kalalau can't claim this is community property!"
				(= seconds 3)
			)
			(34
				(NormalEgo 3)
...
(instance KandBBScript of Script
	...
	(method (handleEvent event)
		...
		(if (Said 'talk/woman,woman,exwife')
		...
		(if (Said 'look/woman,woman,exwife')
			(if (> gFilthLevel 3)
