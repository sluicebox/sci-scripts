...
(procedure (localproc_0)
	((= gTheIconBar IconBar)
		sel_210: (ScriptID 12 0) ; unknown_12_1
		sel_110:
		sel_118:
			(ScriptID 12 0) ; unknown_12_1
			(ScriptID 12 1) ; unknown_12_2
			(ScriptID 12 2) ; unknown_12_3
			(ScriptID 12 3) ; unknown_12_4
			(ScriptID 12 4) ; unknown_12_5
		sel_119: 110
		sel_215: (ScriptID 12 4) ; unknown_12_5
	)
)
	...
	(if
		...
		(if (not (HaveMouse))
			(if (and (!= gTheCursor 20) (!= gTheCursor 981))
				(= global183 (unknown_0_17 sel_1:))
				(= global184 (unknown_0_17 sel_0:))
...
(class Class_0_0 of BorderWindow
	(properties
		sel_20 -1
	)
...
(class Class_0_4 of View
	...
	(method (sel_447 param1 &tmp [temp0 500] [temp500 4] temp504)
		...
		(unknown_0_0 sel_125:)
		(unknown_0_0 sel_118: sel_439)
		(Class_9_0 sel_430: self)
		(TextSize @[temp500 0] temp504 gUserFont 0)
		(Class_0_5 sel_119: 159 self)
		(proc0_1)
		(if (< [temp500 3] 60)
			(Print @temp0 32 Class_9_0 22 sel_442 182 unknown_0_1 67 80 27 1)
		else
			(Print @temp0 32 Class_9_0 22 sel_442 182 unknown_0_1)
		)
		(unknown_0_0 sel_81: sel_439)
		(if global108
			(self global108:)
		else
...
(instance unknown_0_0 of Set
	(properties
		sel_20 -1
	)
)

(instance unknown_0_1 of Code
	(properties
		sel_20 -1
	)

	(method (sel_57)
		(if (unknown_0_0 sel_86:)
			(Animate (unknown_0_0 sel_24:) 1)
		)
	)
)

(instance unknown_0_2 of Class_0_4
	(properties)
)

(instance unknown_0_3 of Class_0_4
	(properties)
)

(instance unknown_0_4 of Class_0_4
	(properties)
)

(instance unknown_0_5 of Prop
	(properties
		sel_20 -1
		sel_60 7
	)
...
(instance unknown_0_8 of Script
	(properties
		sel_20 -1
	)
...
(instance unknown_0_9 of Script
	(properties
		sel_20 -1
	)
...
(instance unknown_0_10 of Script
	(properties
		sel_20 -1
	)
...
(instance unknown_0_11 of Ego ; UNUSED
	(properties
		sel_20 -1
	)
)

(instance unknown_0_12 of Game
	(properties
		sel_20 -1
	)
	...
	(method (sel_110 &tmp temp0)
		...
		(localproc_1)
		(= gEatMice (= gSpeed 0))
		(= gSystemWindow Class_0_0)
		(gSystemWindow sel_25: 0 sel_26: 53)
		(= gUnknown_0_25 unknown_0_25)
		(= gUseSortedFeatures 1)
		(User sel_309: (= gEgo Ego))
		(= gUnknown_0_20 unknown_0_20)
		((= gUnknown_0_18 unknown_0_18) sel_118:)
		((= gAbsoluteCast absoluteCast) sel_118:)
		((= gKeyDownHandler unknown_0_14) sel_118:)
		((= gMouseDownHandler unknown_0_13) sel_118:)
		((= gDirectionHandler unknown_0_15) sel_118:)
		((= gUnknown_0_16 unknown_0_16) sel_118:)
		(= gUnknown_0_17 unknown_0_17)
		(unknown_0_17 sel_1: 319)
		(unknown_0_17 sel_0: 199)
		(version sel_57:)
		(= gVersion @global541)
		((= gGame_opt game_opt) sel_57: 2)
		(gKeyDownHandler sel_118: self)
		(gMouseDownHandler sel_118: self)
		(Class_7_0 sel_110: sel_423: gUnknown_0_16)
		(super sel_110:)
		DItem
		(Load rsVIEW 700)
		(Load rsVIEW 701)
		(Load rsVIEW 980)
		(ScriptID 700 1) ; unknown_700_0
		GameControls
		IconBar
		(Load rsVIEW 997)
		(Lock rsVIEW 997)
		...
		(localproc_0)
		(proc700_0)
		((ScriptID 12 5) sel_57:) ; unknown_12_0
		(proc0_3)
		(Class_0_5
			sel_118:
				(= gUnknown_0_2 unknown_0_2)
				(= gUnknown_0_3 unknown_0_3)
				(= gUnknown_0_4 unknown_0_4)
		)
		(gUnknown_0_2 sel_439: unknown_0_5 sel_440: unknown_0_8)
		(gUnknown_0_3 sel_439: unknown_0_6 sel_440: unknown_0_9)
		(gUnknown_0_4 sel_439: unknown_0_7 sel_440: unknown_0_10)
		(= gSong song)
		(= gSound sound)
		(= gSound2 sound2)
	...
	(method (sel_132 param1)
		...
		(param1 sel_148:)
		(unknown_0_17 sel_1: (param1 sel_1:) sel_0: (param1 sel_0:))
	)

	(method (sel_100 &tmp [temp0 5] [temp5 5])
		(if (Print 0 1 78 (Format @temp0 99 6) 1 78 (Format @temp5 99 7) 0) ; "Quit Laura Bow?", "Yes", "No"
			(super sel_100:)
		)
	)
	...
	(method (sel_359 param1)
		...
		(if global538
			(= global538 0)
			(gGame
				sel_191: gNormalCursor 1 (unknown_0_17 sel_1:) (unknown_0_17 sel_0:)
			)
		else
...
(instance unknown_0_13 of EventHandler
	(properties
		sel_20 -1
	)
...
(instance unknown_0_14 of EventHandler
	(properties
		sel_20 -1
	)
...
(instance unknown_0_15 of EventHandler
	(properties
		sel_20 -1
	)
...
(instance unknown_0_16 of Set
	(properties
		sel_20 -1
	)
)

(instance unknown_0_17 of Actor
	(properties
		sel_20 -1
	)
)

(instance unknown_0_18 of EventHandler
	(properties
		sel_20 -1
	)
)
...
(class Class_0_7 of Class_0_3
	...
	(method (sel_436)
		(if (and gClass_0_7 (!= gClass_0_7 self))
			(gClass_0_7 sel_461:)
		)
		(if (== gClass_0_7 self)
			(self sel_461:)
