	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				...
				(jebba setMotion: PolyPath 153 73 self)
			)
			(1
				(jebba setMotion: MoveTo 153 78 self)
			)
			(2
				(jebbaHead
					x: (jebba x:)
				...
				(jebba setScript: jebbaAtBeakers)
...
(instance jebbaAtBeakers of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(jebbaHead z: 0)
				(jebba view: 384 setLoop: 0 1 setCel: 0)
				(= seconds (Random 15 30))
			)
			(1
				(jebba view: 385 setLoop: 0 1 setCel: 0 setCycle: End self)
				(jebbaHead z: 1000)
			)
			(2
				(= state -1)
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(gGame handsOff:)
				(jebbaHead z: 0)
				(jebba setScript: 0 view: 384 setLoop: 0 setCel: 0)
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				...
				(jebba setMotion: PolyPath 164 123 self)
			)
			(1
				(jebba setPri: 122 setMotion: MoveTo 164 109 self)
			)
			(2
				(jebba view: 3850 setLoop: 0 setCel: 0 setScript: jebbaCycle)
				(Doctor setScript: controlDoc)
			)
		)
	)
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				...
				(jebba setMotion: PolyPath 260 80 self)
			)
			(1
				(jebba
					view: 3850
...
(instance jebbaCycle of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(jebba setCel: 0 setCycle: End self)
			)
			(1
				(= seconds (Random 4 20))
			)
		...
		(switch (= state newState)
			...
			(1
				...
				(switch temp0
					...
					(1
						(if (and (== (jebba view:) 3850) (== (jebba loop:) 1))
							(self cue:)
						else
...
(instance jebbaHead of Prop
	...
	(method (init)
		(= approachX (jebba approachX:))
		(= approachY (jebba approachY:))
		(self approachVerbs: 2) ; Talk
		(super init: &rest)
	)

	(method (doVerb theVerb)
		(jebba doVerb: theVerb &rest)
	)
)
...
(instance jebbaTalker of SmallTalker
	(properties
		talkView 385
		talkLoop 2
	)
