	...
	(method (changeState newState &tmp temp0 temp1 temp2)
		(switch (= state newState)
			...
			(4
				...
				(gGSound1 number: 150 loop: -1 play:)
				(gTheCursor hide:)
			...
			(12
				(= temp1 (Str new:))
				(Message msgGET 0 18 0 0 13 (temp1 data:)) ; "Copyright (c) 1995 Sierra On-Line, Inc.  Thank you for playing "Space Quest 6."  Roger Wilco has left the computer! I repeat; Roger has left the computer!"
...
(instance scrollUpCode of Code
	...
	(method (doit param1 &tmp temp0)
		...
		(if (>= local1 (listOStrings size:))
			...
			(Text 0 (local0 data:) (param1 data:) 70 0) ; TextSize
			(= temp0
				(Bitmap
					0 ; Create
