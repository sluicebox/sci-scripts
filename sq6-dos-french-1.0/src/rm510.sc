...
(instance sDoTransport of Script
	...
	(method (changeState newState &tmp temp0 temp1)
		(switch (= state newState)
			...
			(2
				(= temp0 (Str newWith: 200 {}))
				(= temp1 (Str format: {Roger\n}))
				(gTextScroller addString: (temp1 data:) 50 84 0)
				(temp1 dispose:)
				(Message msgGET 510 0 0 22 1 (temp0 data:))
				(= temp1 (Str format: {%s\n\n} temp0))
				(= register
					(gTextScroller addString: (temp1 data:) gUserFont 82 0 0)
				)
				(temp1 dispose:)
				(temp0 dispose:)
...
(instance kielbasaTalker of SmallTalker
	(properties
		bodyView 512
		bodyLoop 2
		talkView 512
