...
(procedure (localproc_5)
	(gTheCursor view: 953 setLoop: 0 setCel: 0 init:)
)
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(if (== (gTheCursor view:) 953)
					(self hide:)
					(gTheCursor view: view setLoop: loop setCel: cel init:)
					(dataSound number: 953 play:)
					(if (<= gMouseX 180)
...
(instance dentiumFeature of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(if (== (gTheCursor view:) 953)
					(gTheCursor view: 894 setLoop: 0 setCel: 0 init:)
...
(instance repentiumFeature of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(if (== (gTheCursor view:) 953)
					(gTheCursor view: 894 setLoop: 1 setCel: 1 init:)
...
(instance fermentiumFeature of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(if (== (gTheCursor view:) 953)
					(gTheCursor view: 894 setLoop: 2 setCel: 2 init:)
...
(instance dimtelFeature of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(if (== (gTheCursor view:) 953)
					(gTheCursor view: 894 setLoop: 3 setCel: 3 init:)
...
(instance spentiumFeature of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			(4 ; Do
				(if (== (gTheCursor view:) 953)
					(gTheCursor view: 894 setLoop: 4 setCel: 4 init:)
