...
(instance rm320 of SQRoom
	...
	(method (doit)
		(if (<= (= local3 (GetDistance (gEgo x:) (gEgo y:) 115 109)) 20)
			(PalVary 0 325 0 (- 100 (* local3 5)) 64 79) ; PalVaryStart
		)
		(cond
			(script)
			(local1)
...
(instance sAlleyThingInCans of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(gGSound2 loop: 0 number: 34004 play:)
			...
			(4
				(gGSound2 loop: 0 number: 343 play:)
