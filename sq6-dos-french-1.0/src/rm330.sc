...
(instance rm330 of SQRoom
	...
	(method (doit &tmp temp0)
		...
		(= local4 0)
		(cond
			((<= (= temp0 (GetDistance (gEgo x:) (gEgo y:) 132 106)) 20)
				(PalVary 0 336 0 (- 100 (* temp0 5)) 64 79) ; PalVaryStart
			)
			((<= (= temp0 (GetDistance (gEgo x:) (gEgo y:) 310 98)) 10)
				(PalVary 0 336 0 (- 100 (* temp0 10)) 64 79) ; PalVaryStart
			)
			((<= (= local3 (GetDistance (gEgo x:) (gEgo y:) 61 116)) 25)
				(PalVary 0 335 0 (- 100 (* local3 4)) 64 79) ; PalVaryStart
			)
			((<= (= local4 (GetDistance (gEgo x:) (gEgo y:) 207 90)) 20)
				(PalVary 0 330 0 (- 100 (* local4 5)) 64 79) ; PalVaryStart
			)
			(else
...
(instance bouncerTalker of SmallTalker
	(properties
		talkView 331
		talkLoop 2
	)
...
(instance sSignalAction of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(if (== (client cel:) 10)
					(gGSound2 number: 337 loop: 0 play:)
					(client setCycle: Beg self)
					(airCar cue:)
				else
					(gGSound2 number: 337 loop: 0 play:)
