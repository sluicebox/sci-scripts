		...
		(switch theVerb
			(1 ; Look
				(if (IsFlag 16)
					...
					(gMessager say: noun theVerb 1 0) ; "This shady little alcove looks like it would be a nice place to stop, pitch a tent, and camp out for awhile--if only you weren't running for your life at the moment."
				)
			)
			(else
