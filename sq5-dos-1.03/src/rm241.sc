		...
		(switch (= state newState)
			...
			(2
				(if (OneOf register 4 1)
					...
					(gSq5Music1 stop:)
					(EgoDead 46) ; "Bea is dead. In an alternate future she would've borne your son. In the future past of Space Quest 4, your son would've saved your life. But she didn't so he couldn't--therefore you aren't."
				)
			)
			(3
				(gSq5Music1 stop:)
