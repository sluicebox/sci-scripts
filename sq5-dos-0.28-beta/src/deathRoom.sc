...
(local
	...
	local284
	local285
	[local286 50] = [8 7 7 7 3 3 2 2 3 1 3 2 2 3 3 3 7 2 2 4 2 2 2 2 1 6 6 0 3 1 1 8 1 1 5 2 7 8 8 2 1 6 7 7 7 8 8 8 7 1]
)
		...
		(switch (= state newState)
			(0
				...
				(if (< global119 37)
					...
					(Message msgGET 20 1 0 0 (- global119 36) @local0)
				)
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(rogPart3 dispose:)
				(iWannaQuit dispose:)
				(iWannaRestore dispose:)
				(iWannaRestart dispose:)
				(if (> global119 48)
					(++ state)
				)
				(Printf {%d} global119)
