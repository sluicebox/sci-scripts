...
(instance sWD40Attacks of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(gMessager say: 1 0 0 2 self 208) ; "We're caught in some kind of tractor beam, Captain!"
			)
			(8
			...
			(18
				(gMessager say: 1 0 0 3 self 208) ; "Helm not responding, sir. Weapons systems inoperative!"
			)
			(19
				(self setScript: (ScriptID 201 8) self) ; sTurnDrooleBack
			)
			...
			(21
				(gMessager say: 1 0 0 4 self 208) ; "We're being hailed, sir. I'm putting it on screen."
			)
			(22
			...
			(25
				(eureka state: 3 damaged: 1 hits: 1)
