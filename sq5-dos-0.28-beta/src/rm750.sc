...
(instance rm750 of Rm
	...
	(method (init)
		...
		(if (not (IsFlag 22))
			...
			(gGame setCursor: 982)
			(gTheIconBar disable: 4 5 6 0 3)
		else
			(gTheIconBar disable: 4 5 2 6 3)
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(Display @local8 dsALIGN alCENTER dsCOORD 28 109 dsFONT 2510 dsWIDTH 290 dsCOLOR 12)
				(Message msgGET 750 2 0 0 4 @local8) ; "00:00"
				(Display @local8 dsALIGN alCENTER dsCOORD 62 125 dsFONT 4115 dsWIDTH 220 dsCOLOR 12)
				(Message msgGET 750 2 0 0 5 @local8) ; "JETTISON COMPLETE"
				(Display @local8 dsALIGN alCENTER dsCOORD 61 145 dsFONT 2510 dsWIDTH 220 dsCOLOR 12)
				(= cycles 1)
			)
			(2
				(= cycles 4)
...
(instance sDoSecurity1 of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(gMessager say: 1 0 0 0 self 753) ; "It's about time Cliffy fixed that damn transporter..."
			)
			(7
				(SetFlag 26)
				(gGame handsOn:)
...
(instance topWords of View ; UNUSED
	(properties
		x 64
		y 12
		view 627
