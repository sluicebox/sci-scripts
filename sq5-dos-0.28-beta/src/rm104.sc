...
(instance sCaptainsLog of Script
	...
	(method (handleEvent event)
		(if (and (== state 0) (& (event type:) $4005)) ; evVERB | evMOUSEKEYBOARD
			(self changeState: 1)
			(event claimed: 1)
			(return)
		else
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(Display @local13 dsCOORD 40 15 dsCOLOR 254 dsFONT 1307 dsWIDTH 240)
				(= seconds 24)
			)
			(1
				(= seconds 0)
				(Display @local13 dsCOORD 40 15 dsCOLOR 0 dsFONT 1307 dsWIDTH 240)
...
(instance sAttack of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(13
				(gMessager say: 2 0 0 5 self) ; "Wilco! What in the name of the Seventh Star Cluster are you doing in the bridge simulator?!"
			)
			(14
				(gMessager say: 2 0 0 6 self) ; "Get your sorry carcass out of there and get back to class where you belong, cadet!"
			)
			(15
				(DrawPic 8 9 1)
				(= local417 0)
