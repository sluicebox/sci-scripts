...
(instance rm110 of Rm
	...
	(method (init)
		...
		(gSq5Music1 number: 104 setLoop: -1 play:)
		(gSq5Music2 number: 106 setLoop: 1 play:)
		(theMusic3 flags: 1 number: 105 setLoop: -1 play:)
		(simulator init:)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(2
				...
				(leftLight dispose:)
				(rightLight dispose:)
				(theMusic3 number: 109 setLoop: 1 play:)
				(= seconds 1)
			)
			(3
				(Palette palSET_FROM_RESOURCE 601 2)
				(= seconds 4)
			)
			(4
				(Palette palSET_FROM_RESOURCE 602 2)
				(= seconds 4)
			)
			(5
				(gEgo
				...
				(simulator view: 105 setLoop: 0 setCel: 0)
				(bottomLeft
					setLoop: 1
					setCel: 4
					init:
