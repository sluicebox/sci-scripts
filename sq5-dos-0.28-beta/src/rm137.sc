...
(instance sTest of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(= local0 [local5 global114])
				(= local1 [local15 global114])
				(= local2 [local25 global114])
				(= local3 [local35 global114])
				(= local4 [local45 global114])
				(box1 init:)
				(= state global114)
				(= cycles 1)
			)
			(1
				...
				(Display @local75 dsCOORD 38 55 dsCOLOR 39 dsBACKGROUND 1 dsFONT 1605 dsWIDTH 240)
			...
			(6
				...
				(Display @local75 dsCOORD 55 local1 dsCOLOR 36 dsBACKGROUND 1 dsFONT 1605 dsWIDTH 235)
				(Message msgGET 137 7 0 0 4 @local75) ; "C) Put a live mouse in with each meal so you can more easily determine when it is done."
				(Display @local75 dsCOORD 55 local2 dsCOLOR 36 dsBACKGROUND 1 dsFONT 1605 dsWIDTH 235)
