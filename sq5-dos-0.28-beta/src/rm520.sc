...
(instance sTalker of Talker
	...
	(method (init)
		(= font gUserFont)
		(= gSystemWindow gSpeakWindow)
		(gSystemWindow tailX: 112 tailY: 50 xOffset: 100 isBottom: 1)
		(self cel: 0 loop: 1)
...
(instance qTalker of Talker
	...
	(method (init)
		(= font gUserFont)
		(= gSystemWindow gSpeakWindow)
		(gSystemWindow tailX: 110 tailY: 31 xOffset: 105 isBottom: 1)
		(switch local1
			(3
				(self loop: 1 cel: 0)
			)
...
(instance dTalker of Talker
	...
	(method (init)
		(= font gUserFont)
		(= gSystemWindow gSpeakWindow)
		(gSystemWindow tailX: 195 tailY: 40 xOffset: -70 isBottom: 1)
		(= talkWidth 200)
...
(instance fTalker of Talker
	...
	(method (init)
		(= font gUserFont)
		(= gSystemWindow gSpeakWindow)
		(gSystemWindow tailX: 71 tailY: 48 xOffset: 60 isBottom: 1)
