...
(procedure (localproc_1 param1 param2 &tmp [temp0 20])
	(Format @temp0 213 8 param2) ; "$%d"
	(Format param1 213 9 @temp0) ; "%6s"
)

(procedure (localproc_2 param1 param2 &tmp [temp0 20])
	(Format @temp0 213 10 param2) ; "$%s"
	(Format param1 213 11 @temp0) ; "%7s"
)
...
(instance notEnoughCash of Obj
	...
	(method (doit)
		(Print 213 0) ; "You do not have enough cash."
	)
)
...
(instance broker of Dialog
	...
	(method (init param1 &tmp temp0 temp1 temp2)
		(if (not global518)
			...
			(if (== (global302 playing:) 29)
				(= local31 0)
				(self setScript: computerScript 0)
				(computerScript cue:)
			)
			(self
				window: global59
	...
	(method (draw &tmp [temp0 20] temp20)
		...
		(Display 213 1 dsFONT 10 dsCOORD 112 8 dsBACKGROUND temp20 dsCOLOR 0) ; "Market"
		(Display 213 2 dsFONT 10 dsCOORD 115 16 dsBACKGROUND temp20 dsCOLOR 0) ; "Value"
		(Display 213 3 dsFONT 10 dsCOORD 154 8 dsBACKGROUND temp20 dsCOLOR 0) ; "Your"
		(Display 213 4 dsFONT 10 dsCOORD 147 16 dsBACKGROUND temp20 dsCOLOR 0) ; "Holdings"
		(Display
