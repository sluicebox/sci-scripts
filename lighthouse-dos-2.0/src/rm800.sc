...
(procedure (localproc_0)
	(cond
		...
		(
			(if (IsFlag 355)
				(and (not (IsFlag 354)) (== global242 11))
			)
			(= global251 1)
			(pBlueLights cel: 1)
			(pScreen init: setCycle: Fwd)
...
(instance rm800 of LightRoom
	...
	(method (init)
		(if
			(if (and (not (IsFlag 349)) (not (IsFlag 351)))
				(not (IsFlag 172))
			)
			(= global250 0)
			(= global252 0)
	...
	(method (changeScene param1)
		...
		(switch param1
			...
			(855
				...
				((ScriptID 1 1) ; exitForward
					newRoom: 270
					createPoly: 261 56 288 70 302 102 305 158 298 195 286 204 250 210 240 199 234 142 228 81 241 59
				)
			...
			(869
				...
				((ScriptID 1 1) ; exitForward
					newRoom: 270
					createPoly: 112 84 134 66 161 60 198 75 213 105 209 233 189 247 123 248 111 241
				)
				((ScriptID 1 2) newPic: 852 9) ; exitBack
			)
			(994
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			...
			(3
				(for ((= temp0 0)) (< temp0 (gPanels size:)) ((++ temp0))
					(if
						(if (== (gPanels at: temp0) (ScriptID 9 3)) ; PlCompass
...
(instance pWheel of TrackingProp
	...
	(method (cue)
		(self setCel: 0)
		(if
			(if (and (>= global252 2) (== global250 1))
				(IsFlag 272)
			)
			(= global250 2)
		)
...
(instance pCrank of TrackingProp
	...
	(method (cue)
		(self setCel: 0)
		(if
			(if (and (>= global253 3) (== global250 4))
				(IsFlag 272)
			)
			(= global250 5)
		)
...
(instance vDoctor of View
	...
	(method (doVerb theVerb)
		(if
			(if (and (OneOf (gCurRoom scene:) 844 848) (not local1))
				(IsFlag 416)
			)
			(switch theVerb
				(93 ; invAmanda
...
(instance fBluePrints of Feature
	...
	(method (init)
		(self
			createPoly: 194 206 211 192 226 205 235 196 251 194 265 201 280 189 294 238 194 238
		)
		(super init: &rest)
	)
...
(instance moveGateLeft of ExitFeature
	...
	(method (init)
		(= arrowStyle 8)
		(self
			createPoly: 0 30 43 66 68 98 98 150 121 195 126 239 125 271 118 299 0 299
		)
		(super init: &rest)
	)
