...
(instance spellBookScr of Script
	...
	(method (changeState newState &tmp temp0 temp1 [temp2 40])
		(switch (= state newState)
			(0
				(switch local9
					(0
			...
			(4
				...
				(if (== local9 2)
					(= temp1 (proc913_5 49 49 49 54 49))
				else
					(= temp1 (proc913_5 40 40 40 46 40))
				)
				(Display @local16 dsCOORD 45 temp1 dsWIDTH local14 dsCOLOR 98 dsFONT 1111)
				(Message msgGET 190 3 0 22 1 @temp2) ; "INCANTATION"
				(Display @temp2 dsCOORD 178 27 dsWIDTH 100 dsCOLOR 98 dsFONT 1111)
