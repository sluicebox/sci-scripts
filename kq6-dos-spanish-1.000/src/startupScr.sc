...
(instance startupScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(gMessager say: 1 0 1 3 self oneOnly: 0) ; "That was the last he's seen of his crew. Debris from the shipwreck is scattered along the shore, but of the life boats and his men, there is thankfully no trace."
			)
			(7
				(gGame handsOn:)
