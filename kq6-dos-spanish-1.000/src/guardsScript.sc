		...
		(switch (= state newState)
			...
			(2
				(Print
					...
					width: 250
					posn: 20 139
					addText: 6 1 24 11 ; "I heard him in the hall the other day. He was speakin' to that door--black magic, is what I say! I heard him say 'Ali,' but then Bay came up and started yapping at me."
					modeless: 1
					init:
				)
				(= seconds 10)
