				...
				(repeat
					(switch
						(= temp0
							(Print
								window: DeathWindow
								addText: ; MISSING MESSAGE
									8
									0
									0
									4
									(proc913_5 60 60 60 74 60)
									0
									690
								posn: 63 130
								addButton: 1 8 0 0 1 0 15 690 ; MISSING MESSAGE
								addButton: 2 8 0 0 2 70 15 690 ; MISSING MESSAGE
								addButton: 3 8 0 0 3 140 15 690 ; MISSING MESSAGE
								init:
							)
						)
						(1
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(gNarrator
					x: (proc913_5 10 10 10 5 10)
					y: (proc913_5 10 10 10 5 10)
					talkWidth: (proc913_5 100 100 100 120 100)
				)
