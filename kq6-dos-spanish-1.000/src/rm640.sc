				...
				(repeat
					(switch
						(KQ6Print
							...
							addButton: 1 12 0 0 1 0 78 640 ; MISSING MESSAGE
							addButton: 2 12 0 0 2 67 78 640 ; MISSING MESSAGE
							addButton: 3 12 0 0 3 134 78 640 ; MISSING MESSAGE
							init:
						)
						(1
							(gGame restore:)
...
(instance keyDanceScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gGlobalSound pause:)
				(KQ6Print font: gUserFont posn: -1 10 say: 0 6 5 3 3 init: self) ; "The skeletons are overcome with the musical call of the bones. They begin to jiggle, then to dance!""
			)
			(2
