				...
				(switch
					(= temp0
						(if local0
							...
							(Print
								width: (proc913_5 0 0 0 210 0)
								mode: 1
								posn: 75 75
								font: 4
								addButton: ; "About King's Quest I-V"
									1
									0
									0
									1
									0
									(proc913_5 24 39 24 24 24)
									0
									908
								addButton: ; "About King's Quest VI"
									2
									0
									0
									2
									...
									18
									908
								addButton: ; "Tips for playing King's Quest VI"
									3
									0
									0
									4
									...
									36
									908
								addButton: ; "Beginner Walk-Thru"
									4
									0
									0
									3
									0
									(proc913_5 32 47 32 8 32)
									(proc913_5 54 54 54 63 54)
									908
								init:
							)
						)
		...
		(switch (= state newState)
			(0
				(switch (gGame printLang:)
					(34
						(Printf
							{King's Quest VI\nVersion:\t%s\nTodo el programa es Copyright 1992\nSierra On-Line, Inc. Todos los derechos reservados.}
							gVersion
						)
					)
					(39
						(Printf
							{King's Quest VI\nVersione:\t%s\nQuesto prodotto \8a Copyright 1992\nSierra On-Line, Inc. Tutti i diritti riservati.}
							gVersion
						)
					)
					(else
						(Printf
							{King's Quest VI\nVersion:\t%s\nThis entire work is Copyright 1992\nSierra On-Line, Inc. All rights reserved.}
							gVersion
						)
					)
				)
