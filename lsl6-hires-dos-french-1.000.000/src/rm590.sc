	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(gMessager sayRange: 9 18 0 1 4 self) ; "Oh, Shablee! I hope you love this gown. I really think it's you!"
			)
			(2
				(if (gEgo has: 8) ; condom
					(gMessager sayRange: 9 18 0 5 6 self oneOnly: 0) ; "I say: I'll be there!"
					0
					self
				else
					(gGame handsOn:)
...
(instance shabArm of Feature
	...
	(method (doVerb theVerb)
		(if (== theVerb 4) ; Do
			(gMessager say: 2 4 0 1) ; "Shablee's arms are so smooth and sexy, they remind you of your cousin, Monique!"
		else
			(super doVerb: theVerb)
		)
	)
