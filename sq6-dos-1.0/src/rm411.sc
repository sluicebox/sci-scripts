				...
				(switch (event message:)
					...
					(else
						(cond
							...
							((OneOf (event message:) KEY_ALT_b KEY_ALT_b)
								(if (act9 onMeCheck:)
									(if (> local29 0)
										(-- local29)
									)
							...
							((OneOf (event message:) KEY_ALT_f KEY_ALT_f)
								(if
									(and
										(act9 onMeCheck:)
										(< local29 (- local28 1))
							...
							((OneOf (event message:) KEY_ALT_k KEY_ALT_k)
								(cond
									(local3
										(= local3 0)
										(= local6 2)
							...
							((OneOf (event message:) KEY_ALT_o KEY_ALT_o)
								...
								(if (and (!= local32 -1) (ResCheck 150 local32)) ; ROBOT
							...
							((OneOf (event message:) KEY_e KEY_E KEY_ALT_p KEY_ALT_p)
								(cond
									((act9 onMeCheck:)
										(= local4 0)
										(RobotFeature setNowSeen:)
