...
(instance rm400 of SQRoom
	...
	(method (doit)
		(if
			...
			(gGSound2 loop: 0 number: 406 play:)
		)
		(if
			(and
				(== (gEgo cel:) 2)
			...
			(gGSound2 loop: 0 number: 407 play:)
		)
...
(instance sRunProgram of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gGSound2 number: 401 setLoop: 0 play: self)
				(projector
					show:
					setLoop: 0
					setCel: 0
			...
			(2)
			(3
				(gGSound2 number: 923 setLoop: 0 play:)
				(ptooie
					setLoop: 1
					setCel: 0
					cycleSpeed: local4
			...
			(18
				(gGSound2 number: 408 setLoop: 0 play:)
				(ptooie cycleSpeed: local4 setCycle: CT 9 1 self)
			)
			(19
				(gGSound2 number: 404 setLoop: 0 play:)
			...
			(24)
			(25
				(gGSound2 number: 403 setLoop: 0 play: self)
				(ptooie hide:)
				(victim hide:)
				(projector
					setLoop: 0
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gGame handsOff:)
				(screen setCel: 1)
				(gGSound2 number: 356 loop: 0 play: self)
			)
			(2
				(screen setCel: 0)
				(= ticks 10)
