...
(instance rm440 of SQRoom
	...
	(method (init)
		...
		(Load 140 44015 265) ; WAVE
		(Load 140 441 423 941 926 44010 44012 44013 44014) ; WAVE
...
(instance sMagnumMorph of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				(sound1 number: 44011 loop: 0 play:)
...
(instance sChesbroSurvey of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				(chesbro view: 444 loop: 2 cel: 0 setSpeed: 22 setCycle: Fwd)
				(= ticks (Random 180 240))
			)
			(1
				(= local13 1)
