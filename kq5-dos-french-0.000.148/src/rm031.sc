...
(instance jumping of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(6
				(PrintDC 31 3 #at 20 20 #dispose) ; "Aaaaiiiieeeeeeee!!"
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 4) ; "As with the path below, the now-frozen waterfall has also washed away parts of this upper trail which skirts the mountain edge and then heads off to the east."
					(event claimed: 1)
				)
				(3 ; Do
...
(instance path31b of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 5) ; "As with the path below, the now-frozen waterfall has also washed away parts of this upper trail which skirts the mountain edge and then heads off to the east."
					(event claimed: 1)
				)
				(3 ; Do
...
(instance path31c of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 6) ; "As with the path below, the now-frozen waterfall has also washed away parts of this upper trail which skirts the mountain edge and then heads off to the east."
					(event claimed: 1)
				)
				(3 ; Do
					(if (== local0 6)
...
(instance step1 of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 7) ; "Graham can see tempting rock outcroppings protruding from the frozen waterfall."
					(event claimed: 1)
				)
				(3 ; Do
...
(instance step2 of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 8) ; "Graham can see tempting rock outcroppings protruding from the frozen waterfall."
					(event claimed: 1)
				)
				(3 ; Do
					(if
...
(instance log of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 9) ; "An old log has fallen precariously across a washed-out portion of the narrow trail."
					(event claimed: 1)
				)
			)
		)
...
(instance waterFall of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 10) ; "As with the path below, the now-frozen waterfall has also washed away parts of this upper trail which skirts the mountain edge and then heads off to the east."
					(event claimed: 1)
				)
			)
		)
...
(instance rope of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 31 11) ; "Graham's rope dangles from a rocky overhang down to the path below."
					(event claimed: 1)
				)
				(3 ; Do
					(if (== local0 0)
						...
						(PrintDC 31 12) ; "Graham can't reach the rope from here."
					)
					(event claimed: 1)
				)
			)
