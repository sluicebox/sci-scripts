...
(instance counterTop of RFeature
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 206 61) ; "Delicious, mouthwatering custard pies lining the countertop attract Graham's eyes...and nose!"
					(event claimed: 1)
				)
				(3 ; Do
					(if (not (gCurRoom script:))
						(cond
							...
							(else
								(PrintDC 206 62) ; "Graham would love to buy a pie if he could."
								(event claimed: 1)
							)
						)
					)
