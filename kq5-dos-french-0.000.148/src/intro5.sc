	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 104 0 #at 140 100 #width 150 #dispose) ; "C'est Mordack qui a fait cela. J'\82tais en train de rendre visite \85 un vieil ami, quand, tout d'un coup, je le vois appara\8ctre. Bon sang, c'est heureux que LUI ne m'a pas vu!"
			...
			(3
				...
				(= global380 1)
				(gEgo setCycle: Fwd)
				(PrintDC 104 1 #at 10 30 #dispose) ; "Et puis quoi? Continue!"
				(= seconds 11)
			)
			(4
