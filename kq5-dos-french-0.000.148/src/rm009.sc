	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(if (gCast contains: willow)
						(PrintDC 9 28) ; "A graceful weeping willow tree grows beside a small pond created from...her tears? In her branch-like arms she clutches a beautiful harp as a child would a cherished toy."
					else
						(PrintDC 9 29) ; "A beautiful harp lies on the ground near the small pond."
					)
					(event claimed: 1)
				)
				(3 ; Do
