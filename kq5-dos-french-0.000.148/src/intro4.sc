	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 103 0 #at 10 10 #dispose) ; "Je sais ce qui est arriv\82 \85 votre ch\83teau. J'ai tout vu. Ah, \87a oui, j'ai tout vu!"
			...
			(2
				...
				(= global380 1)
				(PrintDC 103 1 #at 80 20 #dispose) ; "Vraiment?! Eh bien, ...que s'est-il pass\82?"
				(= seconds (LangSwitch 5 8))
			)
			(3
...
(instance sceneSevenScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(egoMouth setCycle: Fwd)
				(PrintDC 103 2 #at 10 130 #dispose) ; "Pourquoi? Pourquoi ce sorcier...ce Mordack...peut-il vouloir mon ch\83teau?"
			...
			(2
				...
				(owlFace setCycle: Fwd)
				(= global380 1)
				(PrintDC 103 3 #at 10 10 #width (LangSwitch 200 285) #dispose) ; "Cela, je ne le sais pas. Tout ce que je sais, c'est que c'est Mordack, celui qui s'est empar\82 de votre ch\83teau...et de votre famille."
