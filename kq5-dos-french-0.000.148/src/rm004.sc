	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(if (== ((gInventory at: 5) owner:) 4) ; Fish
						(PrintDC 4 20 #at 20 140) ; "Inside the barrel, Graham sees an old fish."
					else
						(PrintDC 4 9) ; "The inside of the barrel is empty."
					)
					(event claimed: 1)
				...
				(3 ; Do
					(if (== ((gInventory at: 5) owner:) 4) ; Fish
						...
						(PrintDC 4 21) ; "You couldn't carry around a big barrel."
					)
					(event claimed: 1)
				)
			)
...
(instance fish of Prop
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 4 22) ; "Inside the old barrel, Graham sees an old fish."
					(event claimed: 1)
				)
				(3 ; Do
					(HandsOff)
...
(instance walker1 of Actor
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 4 23) ; "The town is busy with people going about their daily chores."
					(event claimed: 1)
				)
				(3 ; Do
					(PrintDC 4 24) ; "The people are too caught up in their own business to pay much attention to Graham."
					(event claimed: 1)
				)
				(5 ; Talk
					(PrintDC 4 25) ; "The people are too busy to spend much time talking to Graham."
					(event claimed: 1)
				)
			)
		)
...
(instance walker2 of Actor
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 4 26) ; "The town is busy with people going about their daily chores."
					(event claimed: 1)
				)
				(3 ; Do
					(PrintDC 4 27) ; "The people are too caught up in their own business to pay much attention to Graham."
					(event claimed: 1)
				)
				(5 ; Talk
					(PrintDC 4 28) ; "The people are too busy to spend much time talking to Graham."
					(event claimed: 1)
				)
			)
		)
...
(instance walker3 of Actor
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 4 29) ; "The town is busy with people going about their daily chores."
					(event claimed: 1)
				)
				(3 ; Do
					(PrintDC 4 30) ; "The people are too caught up in their own business to pay much attention to Graham."
					(event claimed: 1)
				)
				(5 ; Talk
					(PrintDC 4 31) ; "The people are too busy to spend much time talking to Graham."
					(event claimed: 1)
				)
			)
		)
...
(instance walker4 of Actor
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 4 32) ; "The town is busy with people going about their daily chores."
					(event claimed: 1)
				)
				(3 ; Do
					(PrintDC 4 33) ; "The people are too caught up in their own business to pay much attention to Graham."
					(event claimed: 1)
				)
				(5 ; Talk
					(PrintDC 4 34) ; "The people are too busy to spend much time talking to Graham."
					(event claimed: 1)
				)
			)
		)
...
(instance glint of Prop
	...
	(method (handleEvent event)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 4 35) ; "Graham notices a shiny silver coin lying forgotten on the street near the broken wagon."
					(event claimed: 1)
				)
				(3 ; Do
					(HandsOff)
