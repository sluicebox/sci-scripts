...
(instance room of RFeature
	...
	(method (handleEvent event &tmp temp0)
		(if
			...
			(switch (event message:)
				(2 ; Look
					(PrintDC 2 8) ; "A worn dirt path wanders through a thick wood alive with the sound of many creatures. Between the trees, to the east, Graham can see the outline of a great mountain range."
					(event claimed: 1)
				)
			)
		)
