	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(5
				...
				(PrintDC 108 0 #at 10 10 #dispose) ; "On dirait que la poudre de f\82e ne fonctionne plus."
				(= seconds 3)
			)
			(6
			...
			(8
				...
				(PrintDC 108 1 #at 100 10 #dispose) ; "Cedric, o\97 \82tais-tu pass\82? J'ai essay\82 de t'appeler.!"
			)
			(9
			...
			(14
				(wizHead setCycle: Fwd)
				(PrintDC 108 2 #at 100 10 #dispose) ; "Bien, bien, qu'avons- nous ici?"
				(= seconds 5)
			)
			(15
				(cls)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				...
				(PrintDC 108 3 #at 10 110 #dispose) ; "Un peu maladroit, on dirait. Bon, venez dans la maison et s\8achez-vous. Aucune raison de rester ici dehors, comme un chien mouill\82."
				(= seconds 10)
			)
			(2
				(cls)
	...
	(method (changeState newState &tmp [temp0 100])
		(switch (= state newState)
			...
			(2
				...
				(wizHead setCycle: Fwd)
				(PrintDC 108 4 #at 100 10 #dispose) ; "Cedric, va dans la maison et pr\82pares- nous une bonne tasse de th\82, pour tous les deux."
				(= seconds 5)
			)
			(3
				(cls)
				...
				(crispin setCycle: 0)
				(owlMouth setCycle: Fwd)
				(PrintDC 108 5 #at 10 120 #dispose) ; "A vos ordres, Crispin."
				(= seconds 4)
			)
			(4
				(cls)
