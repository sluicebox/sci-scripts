			...
			(4 ; Inventory
				(cond
					((== (gInventory indexOf: (gTheIconBar curInvIcon:)) 28)
						(if (IsFlag 60)
							(PrintDC 0 27) ; "Graham waves Crispin's wand which now pulsates with renewed power, but nothing happens.Graham agite la ba guette magique de Crispin laquelle vibre a pr\82sent avec une \82nergie nouvelle, mais rein ne se produit"
						else
