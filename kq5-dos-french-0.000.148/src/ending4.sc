...
(instance creditsScript of Script
	...
	(method (changeState newState &tmp [temp0 60])
		(switch (= state newState)
			...
			(9
				(localproc_0)
				(Display 123 20 dsCOORD 90 60 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local2 dsFONT local0) ; "International Producer Sabine Duvall  Translator Anne Chiaradia"
				(Display 123 20 dsCOORD 89 59 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local1 dsFONT local0) ; "International Producer Sabine Duvall  Translator Anne Chiaradia"
				(= seconds 8)
			)
			(10
				(localproc_0)
				(Display 123 21 dsCOORD 90 60 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local2 dsFONT local0) ; "Foreign Languages Programming Gary Kamigawachi Sean Mooney William R. Shockley"
				(Display 123 21 dsCOORD 89 59 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local1 dsFONT local0) ; "Foreign Languages Programming Gary Kamigawachi Sean Mooney William R. Shockley"
				(= seconds 8)
			)
			(11
				(localproc_0)
				(Display 123 22 dsCOORD 90 60 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local2 dsFONT local0) ; "Quality Assurance Team Lead Dan Scott  Assistant Team Lead Keri Cooper"
				(Display 123 22 dsCOORD 89 59 dsWIDTH 140 dsALIGN alCENTER dsCOLOR local1 dsFONT local0) ; "Quality Assurance Team Lead Dan Scott  Assistant Team Lead Keri Cooper"
				(= seconds 8)
			)
			(12
				(localproc_0)
