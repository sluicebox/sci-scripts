		...
		(switch (= state newState)
			...
			(3
				(Print
					...
					addButton: 1 13 0 0 1 5 (Localize 20 20 25 20 25) ; "Not right now, but thank you for asking."
					addButton: 1 13 0 0 2 5 (Localize 55 55 55 55 50) ; "You must be referring to someone else. My name is Laura, not Dollface."
					init:
				)
