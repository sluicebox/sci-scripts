...
(instance exitButn of Feature
	...
	(method (doVerb theVerb)
		(switch theVerb
			...
			(10 ; Taste
				(Print 531 13) ; "Licking switches is never a good idea unless your into the kind of buzz that causes you to loose all control of your muscle system. This could results in the loss of control of all bodily functions."
			)
			(else
				(super doVerb: theVerb)
			)
