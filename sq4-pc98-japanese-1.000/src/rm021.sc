...
(procedure (localproc_1 param1 &tmp temp0)
	...
	(Display param1 dsCOLOR global132 dsCOORD 3 temp0 dsWIDTH 315 dsFONT 0 dsALIGN alCENTER)
)
...
(instance endScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(18
				(localproc_1 {International Producer\n\nSabine Duvall})
				(= seconds 1)
			)
			(19
				(gTheIconBar enable:)
			...
			(20
				(localproc_1 {Translator\n\nAkiko Maeda Skjellerup})
				(= seconds 1)
			)
			(21
				(gTheIconBar enable:)
			...
			(24
				(localproc_1 {Japanese PC-9801 Programming\n\nTomoyuki Shimada})
				(= seconds 1)
			)
			(25
				(gTheIconBar enable:)
