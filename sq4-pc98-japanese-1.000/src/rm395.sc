	...
	(method (changeState newState)
		(switch (= state newState)
			(0
				...
				(self
					save1:
						(proc0_12 395 8 67 2 5 28 global137 29 global129 30 1)
				)
				(= seconds 5)
			)
			(2
...
(instance b1 of Actor
	...
	(method (doVerb theVerb)
		(if (== theVerb 10) ; Taste
			(if (== (++ local8) 18)
				(Print 395 14) ; "Go Beavers!\8ds\82\af\81A\8ds\82\af\81A\83r\81[\83o\81[\81I\81I"
			)
...
(instance atm of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(11 ; Smell
				(Print 395 21) ; "It smells more like fresh Buckazoids than the other leading brand of ATMs."
			)
			(10 ; Taste
				(Print 395 21) ; "It smells more like fresh Buckazoids than the other leading brand of ATMs."
			)
