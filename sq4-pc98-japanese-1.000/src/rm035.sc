...
(instance theStreet of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(10 ; Taste
				(Print 35 1) ; "It tastes like you've just scraped your tongue to shreds on the pavement."
			)
			(11 ; Smell
				(Print 35 2) ; "The rich aroma of hovercar exhaust fills your sinuses."
			)
			(4 ; Inventory
...
(instance sidewalk1 of Feature
	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			(2 ; Look
				(Print 35 3) ; "It looks like a surface suited for foot travel."
			)
			(10 ; Taste
				(Print 35 4) ; "It tastes like all the other sidewalks you've ever tasted, weirdo."
			)
			(11 ; Smell
				(Print 35 5) ; "It smells mostly of dust and dirt."
			)
			(4 ; Inventory
				((ScriptID 705 4) doVerb: theVerb invItem) ; theRoom
			)
