	...
	(method (doVerb theVerb invItem)
		(switch theVerb
			...
			(11 ; Smell
				(switch (Random 0 6)
					(0
						(Print 706 14) ; "It's supposed to smell like a Wallmart Force Field Generating Unit, but we could only do 16 different odors in this version so it smells a lot like the time pod."
					)
					(1
