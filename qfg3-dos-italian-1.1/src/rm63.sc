...
(instance doCredits of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(97
				(local0 setMotion: MoveTo 160 (- 0 local6))
				(local1 setMotion: MoveTo 160 (- 0 local7) self)
			)
			(98
				(local0 dispose:)
				(local1 dispose:)
