...
(local
	...
	[local93 15] = [100 11 12 12 13 13 207 207 207 207 207 207 209 12 209]
	[local108 15] = [100 12 12 12 12 12 206 206 206 206 206 206 206 12 206]
	[local123 15] = [100 11 11 11 11 11 207 207 207 207 207 207 207 11 207]
	[local138 15] = [100 11 11 11 11 11 207 207 207 207 207 207 207 11 207]
	[local153 15] = [0 1 2 3 4 5 7 9 10 1 9 11 12 6 12]
	[local168 15] = [0 1 2 3 4 5 7 8 9 10 11 12 13 6 5]
	[local183 15] = [0 1 2 3 4 3 6 7 8 1 1 9 10 5 1]
	[local198 15] = [0 1 2 3 4 1 8 6 7 0 7 9 7 5 10]
	[local213 14] = [1 2 3 4 5 7 8 9 10 11 12 13 6 14]
	[local227 15] = [0 1 2 3 4 5 13 6 7 8 9 10 11 12 14]
	[local242 51] = [0 150 80 130 150 100 150 130 100 0 0 100 0 0 90 0 80 150 100 100 100 80 0 100 0 0 0 0 150 120 0 100 100 150 100 100 100 0 100 100 100 100 100 0 100 67 78 68 20 23 27]
	[local293 11] = [0 50 0 0 50 0 50 0 50 0 0]
	[local304 11] = [100 100 50 100 100 100 100 100 100 100 50]
	local315 = 1
	[local316 39]
	local355
	local356 = 50
	...
	local385 = 1
	local386
	[local387 6] = [71 159 245 71 159 245]
	[local393 6] = [42 42 42 44 46 45]
	local399
	[local400 10]
	[local410 10]
	[local420 5]
	...
	(cond
		((or (== gHeroType 3) (== gHeroType 0)) ; Paladin, Fighter
			(for ((= temp0 1)) (< temp0 15) ((++ temp0))
				(= [local242 temp0] [gEgoStats (- temp0 1)])
			)
		...
		((== gHeroType 1) ; Magic User
			...
			(while (< temp0 30) ; UNINIT
				(= [local242 temp0] [gEgoStats (- temp0 16)]) ; UNINIT
				(++ temp0) ; UNINIT
			)
			(= local315 1)
		)
		((== gHeroType 2) ; Thief
			...
			(while (< temp0 45) ; UNINIT
				(= [local242 temp0] [gEgoStats (- temp0 31)]) ; UNINIT
				(++ temp0) ; UNINIT
			)
			(= local315 2)
		)
	)
	(StrCpy @local316 @global157)
	(= local355 (StrLen @local316))
)
...
(procedure (localproc_2 &tmp [temp0 4] temp4)
	(for ((= temp4 1)) (< temp4 15) ((++ temp4))
		(= [gEgoStats (- temp4 1)] [local357 temp4])
	)
	...
	(Message msgGET 140 8 0 5 1 @local420) ; "%d"
	(Format @temp0 @local420 local356)
	(Display
		@temp0
		dsCOORD
	...
	(localproc_1
		170
		86
		(Format @temp0 @local420 (= [gEgoStats 16] (gEgo maxHealth:))) ; health
	)
	(DrawCel 145 6 0 287 159 15)
	(localproc_1
		157
		284
		(Format @temp0 @local420 (= [gEgoStats 17] (gEgo maxStamina:))) ; stamina
	)
	(DrawCel 145 6 0 287 172 15)
	(localproc_1
		170
		284
		(Format @temp0 @local420 (= [gEgoStats 18] (gEgo maxMana:))) ; mana
	)
	(DrawCel 145 6 0 285 (proc0_21 135 135 135 135 132) 15)
	(localproc_1
		(proc0_21 133 133 133 133 130)
		283
		(Format @temp0 @local420 [gEgoStats 14]) ; honor
	)
)
	...
	(switch local315
			...
			(if [gEgoStats 12] ; magic use
				(for ((= temp0 19)) (< temp0 30) ((++ temp0))
					(if (not [gEgoStats temp0])
						(= [gEgoStats temp0] [local293 (- temp0 19)])
					)
				)
			)
		)
		...
		(1
			...
			(if [gEgoStats 12] ; magic use
				(for ((= temp0 19)) (< temp0 30) ((++ temp0))
					(if (not [gEgoStats temp0])
						(= [gEgoStats temp0] [local304 (- temp0 19)])
					)
				)
			)
		)
...
(procedure (localproc_5 param1 &tmp temp0 temp1)
	...
	(if
		(or
			...
			(and (not (HaveMouse)) (not local386))
		)
		(gGame
			setCursor:
				999
...
(procedure (localproc_6 &tmp [temp0 4])
	(Message msgGET 140 1 6 2 1 @local400) ; "Yes"
	(Message msgGET 140 1 6 3 1 @local410) ; "No"
...
(instance rm140 of Rm
	...
	(method (handleEvent event)
		(if local385
			...
			(cond
				((or (event claimed:) (not local386)) 0)
				((& (event type:) $0040) ; direction
					(switch (event message:)
						(JOY_LEFT
							(event claimed: 1)
...
(instance selectChar of Script
	...
	(method (changeState newState &tmp temp0)
		(switch (= state newState)
			(0
				(= gBaseHeroType (= gHeroType local315))
				(gCurRoom picture: 145)
				(DrawPic 145)
				(= global157 0)
				(= cycles 2)
...
(instance startControls of GameControls
	...
	(method (init &tmp temp0)
			...
			(self
				add:
					((selectionIcon new:)
						...
						state: [local213 (- temp0 1)]
						yourself:
					)
			)
			(= [local371 temp0] [local242 (+ temp0 (* local315 15))])
			(= [local357 temp0] [local242 (+ temp0 (* local315 15))])
		)
		(self
			add:
				((selectionIcon new:)
		...
		(= [local371 13] [local242 (+ 13 (* local315 15))])
		(= [local357 13] [local242 (+ 13 (* local315 15))])
		...
		(= [local371 14] [local242 (+ 14 (* local315 15))])
		(= [local357 14] [local242 (+ 14 (* local315 15))])
...
(instance selectionIcon of IconI
			...
			(0
				(cond
					...
					(
						(and
							(== [local357 [local227 state]] 10)
							(not [local371 [local227 state]])
						)
						(= [local357 [local227 state]] 0)
						(+= local356 30)
					)
					(
						(and
						...
						(+= local356 (+ 20 [local357 [local227 state]]))
						(= [local357 [local227 state]] 0)
					)
					(
						(<
	...
	(method (highlight param1 &tmp temp0 [temp1 4] temp5 temp6)
		...
		(Message msgGET 140 8 0 5 1 @local420) ; "%d"
		(Display
			(Format @temp1 @local420 [local357 [local227 state]])
			dsCOORD
...
(instance startIcon of IconI
	...
	(method (select &tmp temp0 temp1)
		(if (& (startIcon signal:) $0004)
			...
			(= local1 0)
			(if (and local356 (localproc_6))
				(return 0)
			else
				(HandsOff)
				(localproc_4)
				(for ((= temp0 1)) (< temp0 15) ((++ temp0))
					(= [global211 (- temp0 1)] [local357 temp0])
				)
...
(instance namePlate of IconI
	...
	(method (select param1 &tmp [temp0 4])
		(TextSize @[temp0 0] @local316 3 0)
		(cond
			((== param1 8)
				(if local355
					(StrAt @local316 (-- local355) 0)
					(DrawCel
						maskView
						maskLoop
						maskCel
						(+ nsLeft (proc0_21 40 38 40 38 39))
						(- nsTop (proc0_21 2 2 3 1 1))
						15
					)
					(self highlight: 1)
				)
			...
			((<= [temp0 3] 150)
				(StrAt @local316 local355 param1)
				(StrAt @local316 (++ local355) 0)
				(self highlight: 1)
			)
			(else
...
(instance yesIcon of IconI
	...
	(method (show)
		...
		(Display @local400 dsCOORD 20 (+ nsTop 3) dsCOLOR 17)
		(if (& signal $0004)
			(self mask:)
		)
	...
	(method (highlight param1 &tmp temp0)
		...
		(Display @local400 dsCOORD 20 (+ nsTop 3) dsCOLOR temp0)
	)
)
...
(instance noIcon of IconI
	...
	(method (show &tmp [temp0 15])
		...
		(= nsBottom (+ nsTop 15))
		(DrawCel view loop cel nsLeft nsTop -1)
		(Display @local410 dsCOORD 20 (+ nsTop 3) dsCOLOR 17)
		(if (& signal $0004)
			(self mask:)
		)
		(if (and gPMouse (gPMouse respondsTo: #stop))
	...
	(method (highlight param1 &tmp temp0)
		...
		(Display @local410 dsCOORD 20 (+ nsTop 3) dsCOLOR temp0)
	)
)
