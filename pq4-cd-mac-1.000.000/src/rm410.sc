		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					...
					init: 16 146 128 146 127 161 177 162 178 146 303 146 303 126 239 126 239 145 74 145 74 126 16 126
					yourself:
				)
		)
		(super init: &rest)
	...
	(method (doVerb theVerb)
		(cond
			...
			((== theVerb 27) ; badge
				...
				(cond
					(local0
						(gMessager say: noun theVerb 28 0) ; "Detective, there is no need to show her your badge again. She has a fine memory."
					)
					(local5
						(= local0 1)
						(if (not (gPqFlags test: 94))
...
(instance badgeScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(1
				(gEgo view: 9126 setCycle: 0 setLoop: 3 heading: 0 cel: 0)
				(= cycles 8)
			)
			(2
				(gEgo cel: 1)
			...
			(6
				(switch register
					(1
						(gMessager say: 2 27 13 2 self) ; "Our manager is out of the office for the week, Detective. I'm Nora Bitteridge, may I be of assistance?"
					)
					(2
						(gMessager say: 2 27 11 2 self) ; "I'm sorry, detective, our manager is out for the week. I'm Nora Bitteridge, may I help you?"
					)
					(3
