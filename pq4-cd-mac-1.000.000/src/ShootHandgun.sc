	...
	(method (doit param1)
		(cond
			(
				...
				(gMessager say: 2 22 8 0 0 0) ; "Holster your weapon! There is no tactical rationale for deadly use of force."
				(if (> argc 6)
					([param1 6] cue:)
				)
			)
			...
			(0
				...
				(cond
					...
					((OneOf (gEgo view:) 9797 9798)
						(gEgo
							scaleY: (/ (* (gEgo scaleY:) 119) 100)
							scaleX: (/ (* (gEgo scaleX:) 119) 100)
							setScaler: 0
						)
					)
				)
