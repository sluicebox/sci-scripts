...
(class SRDialog of Dialog
	...
	(method (update theComment names nums &tmp temp0 temp1 temp2)
		...
		(switch theStatus
			(0
				(Message msgGET 64990 10 0 0 1 (temp1 data:))
			)
			(1
				(Message msgGET 64990 11 0 0 1 (temp1 data:))
			)
			(else
				(Message msgGET 64990 30 0 0 1 (temp1 data:))
			)
		)
		...
		(switch theStatus
			(0
				(Message msgGET 64990 26 0 0 1 temp0)
			)
			(1
				(Message msgGET 64990 28 0 0 1 temp0)
			)
			(else
				(Message msgGET 64990 25 0 0 1 temp0)
			)
		)
