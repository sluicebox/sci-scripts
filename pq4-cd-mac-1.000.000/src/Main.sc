...
(class pq4 of Game
	...
	(method (restore &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12 temp13 temp14)
		(gSounds eachElementDo: #pause 1)
		(= temp1 (gThePlane inLeft:))
		(= temp2 (gThePlane inTop:))
		(= temp3 (gThePlane inRight:))
		(= temp4 (gThePlane inBottom:))
		(= temp5 (gCurRoom picture:))
		(gThePlane picture: -1 back: 0 style: 0 setRect: 0 0 319 199 1)
		(= temp6 ((gTheIconBar at: 4) signal:))
		(= temp7 ((gTheIconBar at: 6) signal:))
		(= temp8 ((gTheIconBar at: 0) signal:))
		(= temp9 ((gTheIconBar at: 1) signal:))
		(= temp10 ((gTheIconBar at: 2) signal:))
		(= temp11 ((gTheIconBar at: 3) signal:))
		(= temp12 ((gTheIconBar at: 5) signal:))
		(= temp13 ((gTheIconBar at: 7) signal:))
		(= temp14 (gTheIconBar curInvIcon:))
		(gTheIconBar enable: 0 1 2 3 4 5 6 7)
		(if (gTheIconBar curInvIcon:)
			(gTheIconBar curInvIcon: 0 show: 0)
			(UpdatePlane (gTheIconBar plane:))
		)
		(gCast eachElementDo: #hide)
		(FrameOut)
		(RestoreGame name temp0 gVersion) ; UNINIT
		(gThePlane picture: temp5 style: 0 setRect: temp1 temp2 temp3 temp4 1)
		(if (& temp7 $0004)
			(gTheIconBar disable: 6)
		else
			(gTheIconBar enable: 6)
	...
	(method (replay &tmp temp0 temp1 temp2 temp3 temp4 temp5 temp6)
		...
		(if (gTheIconBar locked:)
			...
			(gTheIconBar locked: 0 hide: 1)
		else
			(gTheIconBar locked: 0 show: 1)
			(UpdatePlane (gTheIconBar plane:))
			(gTheIconBar locked: 0 hide: 1)
			(UpdatePlane (gTheIconBar plane:))
		)
	...
	(method (init &tmp temp0)
		...
		(self doRemap: 5 0 38)
		(self doRemap: 2 244 75)
		(self doRemap: 2 243 75)
	)
	...
	(method (restart param1 &tmp temp0 temp1 [temp2 2])
		(Platform 0 2 1)
		(= global179 gTheCursor)
		(gGame setCursor: gNormalCursor 1)
		(SetCursor 155 80)
