		...
		(switch theVerb
			(52 ; notebook
				(if (gPqPointFlags test: 32)
					(gMessager say: noun theVerb 5) ; "The information about the woman in red might be important, if it's true..."
				else
		...
		(switch theVerb
			...
			(74 ; candyBar
				(if (not (gPqPointFlags test: 16))
					...
					(gMessager say: noun theVerb 3) ; "I don't need your special treatment. My childre..., my child and I are doing just fine without charity."
				)
			)
			(29 ; coins
				(if (not (gPqPointFlags test: 16))
			...
			(2 ; Talk
				(cond
					...
					((and (gPqPointFlags test: 12) (gPqPointFlags test: 32))
						(gMessager say: 2 2 11 0) ; "Mrs. Washington, if there's anything the department, or I, can do, please call."
					)
					(
						(and
							(== gDay 2)
...
(instance knockScr of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(18
				(gEgo x: 71 y: 142 normalize: 0 setHeading: 235 z: 1000)
