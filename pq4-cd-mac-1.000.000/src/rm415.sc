...
(instance desk of Feature
	...
	(method (init)
		(self
			createPoly: 302 152 147 153 115 140 114 106 145 100 185 107 261 97 303 106
		)
		(super init: &rest)
	)
...
(instance bookShelf of Feature
	...
	(method (init)
		(self
			createPoly: 103 50 170 50 171 77 156 76 135 91 139 101 115 106 115 93 102 89
		)
		(super init: &rest)
	)
)
...
(instance insetBooks of Feature
	...
	(method (init)
		(self
			createPoly: 36 13 43 13 47 23 61 19 61 12 71 10 82 26 81 35 87 42 88 47 93 52 94 76 49 85 36 38
		)
		(super init: &rest)
	)
)
