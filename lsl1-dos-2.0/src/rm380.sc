...
(procedure (JetsOn)
	...
	(rimJet1 init: cycleSpeed: global101 setCycle: Fwd)
	(rimJet2 init: cycleSpeed: global101 setCycle: Fwd)
	(rimJet3 init: cycleSpeed: global101 setCycle: RandCycle)
	(aJet init: cycleSpeed: global101 setCycle: RandCycle)
	(bJet init: cycleSpeed: global101 setCycle: RandCycle)
	(cJet init: cycleSpeed: global101 setCycle: RandCycle)
	(dJet init: cycleSpeed: global101 setCycle: RandCycle)
	(eJet init: cycleSpeed: global101 setCycle: RandCycle)
)
...
(instance rm380 of LLRoom
	...
	(method (init)
		(LoadMany rsVIEW 381 382 380 803)
		(LoadMany rsSOUND 381 380 384)
		(gCurRoom
			addObstacle:
				((Polygon new:)
					type: PBarredAccess
