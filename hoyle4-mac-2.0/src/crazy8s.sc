		...
		(switch (= state newState)
			...
			(11
				...
				(if (not (temp3 tempTotal:))
					...
					(if (== (temp3 type:) 0)
						(Characters say: 1000 1 23 0 (Random 4 5) 466 1 self)
					else
						((temp3 owner:)
			...
			((and (not local3) (discardPile conditionSet:))
				...
				(if (== ((Dealer curPlayer:) type:) 0)
					(switch (discardPile condition:)
						(2
							(if (not (Random 0 5))
								(Characters say: 1000 1 23 0 2 464 1)
								(= local3 1)
							)
						)
						(4
							(if (not (Random 0 3))
								(Characters say: 1000 1 23 0 1 464 1)
								(= local3 1)
							)
						)
						(6
					...
					(switch (discardPile condition:)
						(2
							(if (not (Random 0 5))
								(temp0 say: 1000 1 23 0 4 466 1)
								(= local3 1)
							)
						)
						(4
							(if (not (Random 0 3))
								(temp0 say: 1000 1 23 0 5 466 1)
								(= local3 1)
							)
						)
						(6
				...
				(cond
					...
					((not (Random 0 temp1))
						(((Dealer curPlayer:) owner:)
							say: 1000 1 23 0 (Random 4 5) 466 1
						)
						(= local3 1)
					)
				)
	...
	(method (validPlay param1 &tmp temp0)
		...
		(if (self isValid: param1)
			...
			(cond
				...
				(
					...
					(if (and global422 (== (param1 rank:) 2))
						...
						(gSound play: 905)
						(Characters say: 100 0 50 0 1 464)
						(return 0)
					)
				)
				((== condition 12)
					(gSound play: 905)
					(Characters say: 100 0 51 0 1 464)
					(return 0)
				)
			)
			(if (& temp0 $0003)
			...
			(switch global403
				(1
					(gSound play: 905)
					(Characters say: 100 0 59 0 1 466)
				)
				(3
					(gSound play: 905)
				...
				(7
					(gSound play: 905)
					(Characters say: 100 0 53 0 1 464)
				)
				(2
					(gSound play: 905)
					(Characters say: 100 0 54 0 1 464)
				)
				(4
					(gSound play: 905)
					(Characters say: 100 0 55 0 1 464)
				)
				(6
					(gSound play: 905)
					(Characters say: 100 0 56 0 1 464)
				)
				(8
					(gSound play: 905)
					(Characters say: 100 0 57 0 1 464)
				)
				(12
					(gSound play: 905)
					(Characters say: 100 0 58 0 1 464)
				)
			)
			(if (& temp0 $0003)
				(param1 startUpd:)
...
(instance transition of Prop
	...
	(method (init param1)
		...
		(self
			...
			ignoreActors:
			setPri: 3
			posn: (+ (discardPile x:) 17) (+ (discardPile y:) 22)
			setCycle: End self
			show:
		)
		(super init:)
