...
(instance oldMaid of HoyleRoom
	...
	(method (init)
		...
		(handleEventList add:)
		(theDiscard add:)
		(gChar1 posn: 42 167 show: active: 1 init:)
		(gChar2 posn: 82 30 show: active: 1 init:)
		(gChar3 posn: 276 42 show: active: 1 init:)
				...
				(if
					...
					(cond
						((OneOf ((register owner:) view:) 9 15)
							((register owner:) say: 1000 1 23 0 1 464 1)
						)
						((== ((register owner:) view:) 4)
							((register owner:) say: 1000 1 23 0 2 464 1)
						)
						...
						(
							...
							((register owner:)
								say: 1000 1 23 0 (Random 1 2) 464 1
							)
						)
						((OneOf ((register owner:) view:) 2 14)
							((register owner:)
								say: 1000 1 23 0 (Random 1 3) 464 1
							)
						)
					)
				)
			...
			(7
				(cond
					(((Dealer curPlayer:) owner:)
						(((Dealer curPlayer:) owner:) say: 200 0 68 0 1 464 1)
					)
					((!= register gChar2)
				...
				(if (!= (theDiscard size:) 52)
					(if (== ((Dealer curPlayer:) type:) 0)
						(if (hand4 size:)
							...
							(Characters say: 200 0 60 0 1 466)
							(= state 9)
		...
		(switch (= state newState)
			...
			(6
				...
				(if local11
					(cond
						((== (local11 view:) 6)
							(local11 say: 1000 1 23 0 (Random 3 4) 466 1)
						)
						((OneOf (local11 view:) 2 5 7 8 10 12 14 16)
							(local11 say: 1000 1 23 0 (Random 4 5) 466 1)
						)
						((OneOf (local11 view:) 0 1 4 9 11 13 15 17)
							(local11 say: 1000 1 23 0 (Random 3 5) 466 1)
						)
					)
				)
				(= ticks 10)
		...
		(if
			...
			(cond
				((and (gCast contains: pairButton) (not owner))
					(gSound play: 904)
					(Characters say: 200 19 0 0 1 464)
					(return 1)
				)
				((and (or gTray (gCast contains: pairButton)) owner)
					(gSound play: 904)
					(owner say: 200 0 71 0 1 464)
					(return 1)
				)
				(
					(and
					...
					(cond
						((!= self hand4)
							...
							(gSound play: 904)
							((hand4 owner:) say: 200 0 70 0 1 464)
							(return 1)
						)
