		...
		(switch theVerb
			...
			(1 ; Look
				(if (IsFlag 1)
					...
					(gMessager say: 2 1 2 0) ; "This door leads to one of the academy's classrooms. Currently, the students in your Space Piloting 101 class are taking the StarCon Aptitude Test."
				)
			)
			(else
