...
(procedure (localproc_13 param1 param2 param3 param4 param5 param6 param7 &tmp [temp0 20])
	...
	(GetMessage 99 140 param7 @temp0)
		...
		(switch (= state newState)
			...
			(3
				...
				(switch global118
					(1
						(Print
							(GetMessage 1 gCurRoomNum 4 @temp0)
							#icon
							142
							0
							0
					...
					(2
						(Print
							(GetMessage 1 gCurRoomNum 8 @temp0)
							#icon
							142
							0
							0
					...
					(3
						(Print
							(GetMessage 1 gCurRoomNum 12 @temp0)
							#icon
							142
							0
							0
			...
			(6
				...
				(switch global118
					...
					(3
						(Oracle init: 13 0 self) ; "A mighty King was led astray, Tricked and lured into harm's way. With all his strength he cannot free, Himself from man's machinery. Our destiny now lies with he, Foretold within the prophecy."
						(SetFlag 4)
						(SetFlag 45)
					)
				)
