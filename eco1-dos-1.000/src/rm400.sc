		...
		(gCurRoom
			addObstacle:
				((Polygon new:)
					...
					init: 75 118 57 126 87 126 70 136 98 136 93 148 64 149 59 140 53 148 0 177 0 189 277 189 270 152 319 152 314 136 286 114 231 114 229 117 150 117 150 114 120 114 113 118
					yourself:
				)
				((Polygon new:)
					type: PBarredAccess
			...
			(switch theVerb
				...
				(4 ; Inventory
					(switch invItem
						...
						(else
							(gCurRoom setScript: (ScriptID 68 1) 0 invItem) ; lookAtBlackBoard
						)
					)
				)
				(2 ; Look
