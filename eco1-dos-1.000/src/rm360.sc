...
(instance rm360 of Rm
	...
	(method (init)
		(LoadMany rsVIEW 360 364 40 361 362 956 363 342)
	...
	(method (doit &tmp [temp0 60] [temp60 20] [temp80 20] [temp100 20])
		...
		(return
			(if local19
				(GetMessage 99 360 1 @temp0)
				(GetMessage 99 360 2 @temp60)
				(GetMessage 99 360 3 @temp80)
				(GetMessage 99 360 4 @temp100)
				(Sound pause: 1)
