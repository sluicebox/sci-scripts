...
(instance masterScript of Script
		...
		(switch (event type:)
			(evSAID
				(cond
					...
					((and (Said 'ask>') (gEgo inRect: 0 132 106 195))
						(= local9 100)
						(cond
							(local7
								(= local11 1)
								(cond
									...
									((Said '/hall,club')
										(HighPrint 311 39) ; "This is, of course, where an adventurer can find out where there is a need for someone brave and courageous. There are jobs on the bulletin board over there."
										(HighPrint 311 40) ; "It is also a good place to talk about adventures on a cold afternoon. We used to play cards here once a week, as well, but there are too few adventurers in Spielburg anymore. They all died at the hands of monsters or brigands, or they just became too old."
									)
									((Said 'board,bulletin')
										(HighPrint 311 39) ; "This is, of course, where an adventurer can find out where there is a need for someone brave and courageous. There are jobs on the bulletin board over there."
									)
									((Said '/monster,head')
										(HighPrint 311 41) ; "You can see some of the types of monsters that live around here if you look at our walls."
									)
									((Said '/bandit')
										(HighPrint 311 42) ; "There is a reward for anyone who can stop the brigands by capturing or killing their leaders. The information is on the bulletin board."
									)
									((Said '/saurus')
										(HighPrint 311 43) ; "Oh, those are nothing. Anyone can kill a Saurus."
									)
									((Said '/troll')
										(HighPrint 311 44) ; "It's been a while since Schultz and I killed the one on the wall. It is fortunate that few Trolls remain; they're deadly."
									)
									((Said '/cheetaur')
										(HighPrint 311 45) ; "Watch out for Cheetaurs. I bear the scars of my last fight with one to this day."
									)
									((Said '/griffin')
										(HighPrint 311 46) ; "I remember the day I killed one. It was the biggest one I had ever seen. It put up a tough fight, but I was tougher. You can see the result on the wall."
									)
									((Said '/dragon')
										(HighPrint 311 47) ; "One day, years ago, a pair of dragons tried to take over our valley. We adventurers rode out to meet them."
										(HighPrint 311 48) ; "I can still see Stefan von Spielburg charging forward on his black horse. He slew the one whose head adorns the wall above our fireplace. The other one flew off."
										(HighPrint 311 49) ; "People say that they can sometimes see that other dragon flying high overhead, but it has never dared attack us again."
									)
									((Said '/antwerp')
										(HighPrint 311 50) ; "One year, this valley was overrun by those odd and terrible monsters. Schultz and I fought long and hard to eliminate them completely. We might have failed even so, had it not been for those two peculiar tourists who came to our aid."
									)
									((Said '/moose')
										(HighPrint 311 51) ; "That was the most vicious moose I ever ran into. Nearly bit my nose off!"
									)
									((Said '/tourist')
										(HighPrint 311 52) ; "They certainly were strange."
									)
									((Said '/andromeda')
										(HighPrint 311 53) ; "That's where the tourists said they came from. Must be some place up North -- I sure never heard of it."
									)
									((Said '/halfwitten')
										(HighPrint 311 54) ; "Not much of an adventurer, but he did kill one Saurus before he made the mistake of tangling with an Ogre."
									)
									((Said '/ogre')
										(HighPrint 311 55) ; "Ogres are a lot like Goons, but even meaner. Not as bright, though."
									)
									((Said '/goon,otto,bouncer')
										(HighPrint 311 56) ; "A Goon is a lot like an Ogre, not as tough, but a little smarter. We have two Goons in town, Otto and Crusher."
									)
									((Said '/abenteuer,master,name')
										(HighPrint 311 57) ; "I am Wolfgang Abenteuer, Guild Master of this hall."
									)
									((Said '/hero')
										(HighPrint 311 58) ; "A real hero is someone who did not start out strong or powerful, but who uses his courage, brains, and skills to become the best he can be."
									)
									(
										(or
										...
										(HighPrint 311 59) ; "I'm sorry. I only know what's written on the poster."
									)
									((Said '/castle')
										(HighPrint 311 60) ; "The castle is just north of the Healer's house."
									)
									((Said '/heal,house')
										(HighPrint 311 61) ; "The Healer's house is just north of the crossroads outside of town."
									)
									((Said '/*')
										(= local11 0)
										(HighPrint 311 62) ; "You know, that reminds me very little of the time old Schultz and I......."
										(HighPrint 311 63) ; "Wait a minute. It'll come to me."
										(= local8 1)
									)
								)
								(if local11
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(7
				(HighPrint 311 64) ; "ZZZZZZZZZZZZZZZZ."
				(master
					loop: 2
			...
			(8
				(if local6
					...
					(= local6 1)
					(HighPrint 311 65) ; "Ach! I was so busy I didn't notice you come in. Welcome, welcome! It is so seldom that we have new adventurers here. Most people think this valley is cursed!"
				)
				(= local9 100)
				(= local5 (Random 1 4))
				(= local7 1)
