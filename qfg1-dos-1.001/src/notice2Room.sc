...
(instance notice2Room of Rm
	...
	(method (init)
		...
		(RedrawCast)
		(Display {Introduction} dsCOORD 213 76 dsALIGN alLEFT dsFONT 300 dsCOLOR 6)
		(Display {Start New Hero} dsCOORD 205 105 dsALIGN alLEFT dsFONT 300 dsCOLOR 6)
		(Display {Continue Quest} dsCOORD 206 139 dsALIGN alLEFT dsFONT 300 dsCOLOR 6)
		(Display {Introduction} dsCOORD 212 76 dsALIGN alLEFT dsFONT 300 dsCOLOR 0)
		(Display {Start New Hero} dsCOORD 204 105 dsALIGN alLEFT dsFONT 300 dsCOLOR 0)
		(Display {Continue Quest} dsCOORD 205 139 dsALIGN alLEFT dsFONT 300 dsCOLOR 0)
		(= local4 1)
		((= local3 (View new:))
			view: 100
			setLoop: 2
	...
	(method (handleEvent event &tmp temp0 temp1)
		(if (or (Said 'look/bug,scorpion') (MouseClaimed scorp event 3))
