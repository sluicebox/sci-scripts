...
(procedure (InitChapter &tmp temp0 temp1)
	...
	(switch gChapter
		(1
			(gTopMessage newText: {Kapitel Eins: Er\94ffnungsfilm})
			(= gEgo GabeEgo)
		...
		(2
			(gTopMessage newText: {Kapitel Zwei: Er\94ffnungsfilm})
			(= gEgo GraceEgo)
		...
		(3
			(gTopMessage newText: {Kapitel Drei: Er\94ffnungsfilm})
			(= gEgo GabeEgo)
			(gEgo
				get: 5 ; invTalisman
		...
		(4
			(gTopMessage newText: {Kapitel Vier: Er\94ffnungsfilm})
			(= gEgo GraceEgo)
		...
		(5
			(gTopMessage newText: {Kapitel F\81nf: Er\94ffnungsfilm})
			(= gEgo GabeEgo)
			(gEgo
				get: 5 ; invTalisman
				get: 15 ; invSpliceTape
		...
		(6
			(gTopMessage newText: {Kapitel Sechs: Er\94ffnungsfilm})
			(= gEgo GraceEgo)
