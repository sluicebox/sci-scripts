...
(instance introSc of Script
	...
	(method (changeState newState &tmp temp0)
		...
		(switch (= state newState)
			...
			(1
				(= local30 (Print 120 0 #at -1 10 #width 300 #dispose)) ; "With the return of his long-lost son, Alexander, and the rescue of his daughter, Rosella, from the terrible dragon, old King Graham decides it's time to pass on his adventurer's hat to younger blood."
			...
			(6
				(local19 setLoop: 0)
				(= local30 (Print 120 1 #width 300 #at -1 12 #dispose)) ; "He flings the battered hat toward his children while his wife, Queen Valanice, proudly looks on."
				(= seconds 11)
			)
			(7
			...
			(11
				...
				(= local30 (Print 120 2 #mode 1 #at -1 150 #dispose)) ; "The hat arches through the air."
			...
			(12
				...
				(= local30 (Print 120 3 #at -1 150 #dispose)) ; "Suddenly...!"
				(Timer setReal: self 3)
			)
			(13
				(if gModelessDialog
				...
				(= local30 (Print 120 4 #at -1 140 #dispose)) ; "King Graham experiences a terrible squeezing pain in his chest."
			...
			(14
				...
				(= local30 (Print 120 5 #title {King Graham} #at 53 155 #dispose)) ; ""Help me," he rasps."
			)
			(15
				(if gModelessDialog
					(gModelessDialog dispose:)
			...
			(16
				...
				(= local30 (Print 120 6 #at -1 152 #dispose)) ; "The adventurer's hat lies, unclaimed, upon the floor...forgotten."
			...
			(19
				...
				(= local30 (Print 120 7 #at -1 134 #dispose)) ; "King Graham lies weakly in bed, Father Death hovering near."
				(Timer setReal: self 7)
			)
			(20
				(cls)
				...
				(= local30 (Print 120 8 #at -1 10 #width 300 #dispose)) ; "Grief suddenly overwhelming her, Rosella runs from the room."
