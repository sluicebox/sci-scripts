...
(instance Ego_drinking_water of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			(1
				(HandsOff)
				(gEgo setMotion: 0 view: 21 cel: 255 setCycle: End self)
			)
			(2
				(= global120 (Print 36 30 #at -1 10 #dispose)) ; "You bend over and take a drink of the pond water. Yuck! It may look pretty, but it doesn't taste very good!"
