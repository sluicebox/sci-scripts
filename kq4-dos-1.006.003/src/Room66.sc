...
(instance Room66 of Rm
	...
	(method (init)
		...
		(super init:)
		((View new:) view: 512 loop: 1 cel: 0 posn: 208 79 setPri: 4 addToPic:)
		((Prop new:)
			view: 512
			loop: 0
			posn: 206 64
	...
	(method (doit)
		...
		(if (!= (self script:) stairTrip)
			...
			(if (and (& (gEgo onControl: 0) $0004) (not local1))
		...
		(if
			(and
				...
				(or
					(gEgo inRect: 92 14 128 36)
					(gEgo inRect: 74 13 112 48)
				)
			)
			(gEgo setPri: 7)
		)
