		...
		(cond
			...
			((Said 'look,look>')
				(cond
					...
					((Said '/face,eye,eye')
						(Print 266 8) ; "Before you speak, you look straight into her eyes..."
						(gCurRoom newRoom: 265)
					)
					((Said '/calf')
						(Print 266 9) ; "Her legs are as smooth as a shopping mall's parking lot."
					)
					((Said '[/area]')
						(Print 266 10) ; "Tawni stood up when you introduced yourself to her. Perhaps you should talk to her."
					)
				)
			)
			(else
