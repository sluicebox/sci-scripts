		...
		(cond
				...
				(cond
					...
					(else
						...
						(switch gLawyerState
							...
							(7
								(Print 320 23) ; ""Hi, Roger," you greet the clerk."
								(Format @local0 320 29) ; ""Hello again, Mr. Laffer. I bet I know why you're here!"%"
								(self changeState: 2)
							)
							(8
			...
			(
				...
				(cond
					...
					((!= local501 0)
						(Print 320 38) ; "The receptionist seems to be busy right now."
					)
					((== gLawyerState 0)
						(User canInput: 0)
						(Format @local0 320 39) ; ""That won't help, sir. There are simply no lawyers available at this time. Why don't you come back later?"%"
						(self changeState: 2)
					)
					((== gLawyerState 1)
						(User canInput: 0)
						(Format @local0 320 40) ; ""That's not necessary, sir. Ms. Cheatem, one of our finest attorneys, is available right now, and remember: here at Dewey, Cheatem and Howe your first consultation is always free of charge."%"
						(self changeState: 2)
					)
					((> gLawyerState 4)
						(User canInput: 0)
						(Format @local0 320 41) ; ""You've paid all you owe. No more money is necessary, Mr. Laffer."%"
						(self changeState: 2)
					)
					((!= gDollars 500)
						(Print 320 42) ; "Too bad, Larry. Ms. Cheatem instructed you to bring $500.00 with you to pay for your next visit, remember? Check your pockets, but you don't have it."
						(Print 320 43 #at -1 144) ; "(Yet.)"
					)
					(else
						(Ok) ; "O.K."
						(= gLawyerState 5)
						...
						(User canInput: 0)
						(Print 320 44 #icon 24 0 0) ; "Here's the five hundred dollars Ms. Cheatem requested," you tell the receptionist. "May I please meet with her to finalize my divorce now?"
						(Format @local0 320 45) ; ""Why, certainly, Mr. Laffer," replies the receptionist, "walk right in. Ms. Cheatem will be happy to talk with you now."%"
			...
			(
				...
				(cond
					...
					((!= local501 0)
						(Print 320 46) ; "The receptionist seems to be busy right now."
					)
					((== gLawyerState 0)
						(User canInput: 0)
						(Printf 320 47 global386 global387) ; ""Excuse me," you say, interrupting the man working at the counter. %s%"
						(Print 320 48) ; "I need a divorce. Is there anyone here that could help me?"
						(Format @local0 320 49) ; ""Good day, sir. Welcome to the legal offices of Dewey, Cheatem and Howe. You've come to the right place, but unfortunately, all of our attorneys are busy right now. Could you please return later when one of them is free?"%"
						(self changeState: 2)
					)
					((== gLawyerState 1)
						(User canInput: 0)
						(Printf 320 47 global386 global387) ; ""Excuse me," you say, interrupting the man working at the counter. %s%"
						(Print 320 50) ; "I'm in desperate need of a divorce. Is there anyone here that could help me?"
						(Format @local0 320 51) ; ""Hello, Mr. Laffer. It's a pleasure to meet you. Certainly, we here at Dewey, Cheatem and Howe would be most proud to satisfy all your legal needs. Currently, Mr. Dewey is in court, and Mr. Howe is taking depositions down at the court hut, but you are in luck: Ms. Cheatem is available. Go right on in; her door is just behind me. I'll tell her you're on your way in."%"
						(RoomScript changeState: 2)
						(self changeState: 2)
					)
					((== gLawyerState 2)
						(User canInput: 0)
						(Print 320 52) ; ""How can I get a divorce around here?" you ask the clerk."
						(Format @local0 320 53) ; ""Ms. Cheatem has given me complete instructions for the preparation of your land deed, but she mentioned nothing about a divorce. Have you paid your fee yet, Mr. Laffer?"%"
						(self changeState: 2)
					)
					((< gLawyerState 6)
						(User canInput: 0)
						(Print 320 54) ; ""Roger, I'd like to get this divorce business all straightened out. When could I meet with Ms. Cheatem again?" you ask."
						(Format @local0 320 55) ; ""You've already had your one (and only) free introductory consultation, Mr. Laffer. Suzi will be happy to meet with you again, but to complete your legal arrangements, you must pay me your $500.00 fee."%"
						(self changeState: 2)
					)
					((< gLawyerState 7)
						(User canInput: 0)
						(Print 320 56) ; ""Now may I get my divorce papers?" you ask Roger."
						(Format @local0 320 57) ; ""Geez, Larry. Give me a little time, will you? Your papers will be ready just as soon as I can prepare them."%"
						(self changeState: 2)
					)
					((> gLawyerState 7)
						(User canInput: 0)
						(Print 320 58) ; "It's nice to see you again, Roger."
						(Format @local0 320 59) ; ""So long, Larry!"%"
						(self changeState: 2)
					)
					(else
						(User canInput: 0)
						(Print 320 60) ; ""Aren't those divorce papers ready yet?" you ask Roger."
						(Format ; ""I'm glad you asked, Mr. Laffer! They're all set. Here you are. And, Ms. Cheatem told me to tell you it was a %s with you!"%"
							...
							(if (TestFlag 45)
								{ce fut une affaire, que de se faire plaisir avec vous}
							else
								{ce fut un vrai plaisir de faire des affaires avec vous}
							)
						)
						(= gLawyerState 8)
			...
			((or (Said '//deed,land') (Said '/deed,land'))
				(cond
					...
					((!= local501 0)
						(Print 320 62) ; "The receptionist seems to be busy right now."
					)
					((== gLawyerState 0)
						(User canInput: 0)
						(Printf 320 47 global386 global387) ; ""Excuse me," you say, interrupting the man working at the counter. %s%"
						(Print 320 63) ; "It is my understanding that island custom dictates automatic transference of ownership of any lands in a couple's possession to the husband upon a divorce. I'd like to begin such a proceeding. Is there anyone here that could help me?"
						(Format @local0 320 64) ; ""Good day, sir. Certainly, you've made the right choice by coming to Dewey, Cheatem and Howe! Unfortunately, all of our attorneys are busy at this time. Could you please return in a few minutes?"%"
						(self changeState: 2)
					)
					((== gLawyerState 1)
						(User canInput: 0)
