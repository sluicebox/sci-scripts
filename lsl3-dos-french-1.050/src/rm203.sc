...
(procedure (PrintPlaque)
	(SaveSubLang)
	(ShadowPrint (LangSwitch 54 64) 105 local90 1 (Format @local0 203 4)) ; "On this site, the great hero of our people%"
	(ShadowPrint 90 120 local90 9 (Format @local0 203 5)) ; "LARRY LAFFER"
	(ShadowPrint (LangSwitch 56 95) 140 local90 1 (Format @local0 203 6)) ; "singlehandedly saved our island from%"
	(ShadowPrint (LangSwitch 49 30) 155 local90 1 (Format @local0 203 7)) ; "our mortal enemy, the evil Dr. Nonookee.%"
	(RestoreSubLang)
)
