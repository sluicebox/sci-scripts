...
(instance RoomScript of Script
		...
		(cond
			...
			((Said 'look,look>')
				(cond
					...
					((Said '/barstool,book') gEgoName)
					((Said '/cup')
						(Print 350 19) ; "The view out the window looks much like the view immediately outside."
					)
					((Said '/flower')
						(Print 350 20) ; "Someone has reset your pins!"
					)
					((Said '/water,fountain,cascade')
						(Print 350 21) ; "Wow! Other offices just have water coolers. "Natives, Inc." has a bubbler of Perrier built into the floor!"
					)
					((Said '/buffet')
						(Print 350 22) ; "The table has four legs and rests on the floor."
					)
					((Said '/guard,guard,man,dave,attendant')
						(Print 350 23) ; "He's been behind that desk ever since you started working here."
					)
					((Said '/door')
						(Print 350 24) ; "The door to the outside is to the right. You remember vividly your last trip through the door to the left!"
					)
					((Said '[/area]')
						(Print 350 25) ; "The reception area of "Natives, Inc\05" contains a few chairs, a tigerskin rug, and a guard behind a large desk."
					)
				)
			)
		)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(Print 350 26) ; "Good morning, David," you tell the guard. "Another day, another dollar, eh?"
				(gEgo setMotion: MoveTo 225 166 self)
			)
			(4
				(Print 350 27) ; "Perhaps so, Larry," Dave replies, "but then again, perhaps not. Chairman Kenneth wants you to report to his office immediately."
				(gEgo setMotion: MoveTo 123 166 self)
			)
			(5
				(Print 350 28) ; ""Ok, David," you respond."
				(Print 350 29) ; "But to yourself you think, "Don't worry, it's probably nothing. I bet he wants to compliment me on my last big ad campaign.""
			...
			(12
				(Printf 350 30 global304 global305) ; ""%s" yells Chairman Kenneth, "another 7-10 split!"%"
				(= seconds 2)
			)
			(13
				(Print 350 31) ; "Davie boy," barks Kenneth, "load up my ramdisk; I'm gonna take the laptop out for a spin today!"
				(aKen setMotion: MoveTo 0 141 self)
			)
			(14
				(aKen dispose:)
				(aDoor setCycle: Beg self)
				(Print 350 32) ; "Well, well, Larry. It seems your ad campaign wasn't the only thing Chairman Kenneth didn't appreciate!"
				(Print 350 33) ; "Oh, well; you lived off your wits once, you can do it again..."
				(= seconds 3)
			)
			(15
			...
			(17
				(Print 350 34) ; "You shake the haze from your brain, slowly rise to your feet and stumble groggily outside..."
				(= gEgoState 4)
