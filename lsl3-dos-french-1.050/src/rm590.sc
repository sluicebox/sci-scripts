...
(instance RoomScript of Script
	...
	(method (handleEvent event)
		...
		(cond
			...
			((Said 'throw,cast,make,use/magic,magic,magic,magic')
			...
			((Said 'unfasten,grab,cut,cut/lasso,hemp,bamboo')
			...
			((or (Said 'enjoy,love') (Said '/enjoy,love'))
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(9
				...
				(aLarry setCel: 0)
				(gMusic fade:)
				(PrintSplit 590 23 67 10 5 70 290) ; "Oh, Larry, I just couldn't believe you left! You can't believe how it felt: to have finally found a perfect match and then to have you disappear into thin air! I awakened to an empty bed, rushed to the balcony, and saw you disappear through that horrible bamboo forest, so I started out after you. And I found you!! We're together again, at last, and this time, to stay!"
				...
				(PrintSplit 590 25 67 10 5 70 290) ; "You. You did, Patti. After the most fantastic night of my life, just as I was drifting away into a blissful sleep, I heard you murmur one word, `Arnold!' Why, Patti? If I'm so special, why would you speak someone else's name? Weren't you thinking of him while we made love?"
			...
			(21
				...
				((ScriptID 40) ; DyingScript
					caller: 595
					register: (Format @local0 590 33) ; "Mark my words, Patti: sometimes you must fight magic with magic!%"
					next: (Format @local350 590 34) ; "Boy, are you two stewed!%"
				)
			)
			(22)
			(23
			...
			(34
				(Format @local0 590 39 global304 global305) ; ""%s"%"
				(Print @local0 #at -1 10)
