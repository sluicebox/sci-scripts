					...
					(else
						...
						(switch (++ talkCount)
							...
							(2
								...
								(PrintP 395 40) ; ""Not well. With so many workout tapes in today's marketplace, I'm having trouble coming up with that certain little something that will make mine different, establishing my competitive edge!"%"
							)
							(else
