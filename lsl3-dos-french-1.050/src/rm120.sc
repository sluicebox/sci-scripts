...
(instance RoomScript of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(11
				(ShadowPrint (LangSwitch 146 160) 90 9 9 120 1) ; "Passionate Patti"
				(= cycles 10)
			)
			(12
				(ShadowPrint (LangSwitch 143 147) 110 9 9 120 2) ; "in Pursuit of the"
				(= cycles 10)
			)
			(13
				(ShadowPrint 132 130 9 9 120 3) ; "Pulsating Pectorals!"
				(= cycles 10)
			)
			(14
				(aThigh setCycle: Fwd)
